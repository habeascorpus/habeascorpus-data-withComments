...
,	TokenNameCOMMA	
"Futás közbeni bels? hiba a(z) ''{0}'' osztályban. "	TokenNameStringLiteral	Futás közbeni bels? hiba a(z) ''{0}'' osztályban. 
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
,	TokenNameCOMMA	
"Futás közbeni bels? hiba az <xsl:copy> végrehajtásakor."	TokenNameStringLiteral	Futás közbeni bels? hiba az <xsl:copy> végrehajtásakor.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
,	TokenNameCOMMA	
"Érvénytelen átalakítás ''{0}'' típusról ''{1}'' típusra."	TokenNameStringLiteral	Érvénytelen átalakítás ''{0}'' típusról ''{1}'' típusra.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
,	TokenNameCOMMA	
"A(z) ''{0}'' küls? függvényt az XSLTC nem támogatja."	TokenNameStringLiteral	A(z) ''{0}'' küls? függvényt az XSLTC nem támogatja.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
,	TokenNameCOMMA	
"Ismeretlen argumentumtípus található az egyenl?ségi kifejezésben."	TokenNameStringLiteral	Ismeretlen argumentumtípus található az egyenl?ségi kifejezésben.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
,	TokenNameCOMMA	
"A(z) ''{0}'' érvénytelen argumentumtípus a(z) ''{1}'' hívásához "	TokenNameStringLiteral	A(z) ''{0}'' érvénytelen argumentumtípus a(z) ''{1}'' hívásához 
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
,	TokenNameCOMMA	
"Kísérlet a(z) ''{0}'' formázására a(z) ''{1}'' mintával."	TokenNameStringLiteral	Kísérlet a(z) ''{0}'' formázására a(z) ''{1}'' mintával.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
,	TokenNameCOMMA	
"A(z) ''{0}'' iterátor nem klónozható."	TokenNameStringLiteral	A(z) ''{0}'' iterátor nem klónozható.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
,	TokenNameCOMMA	
"A(z) ''{0}'' tengelyre az iterátor nem támogatott."	TokenNameStringLiteral	A(z) ''{0}'' tengelyre az iterátor nem támogatott.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
/* * Note to translators: The following represents an internal error * situation in XSLTC. The processor attempted to create an iterator * for a particular axis (see definition above) that it does not * support. */	TokenNameCOMMENT_BLOCK	 Note to translators: The following represents an internal error situation in XSLTC. The processor attempted to create an iterator for a particular axis (see definition above) that it does not support. 
{	TokenNameLBRACE	
...
,	TokenNameCOMMA	
"A tipizált ''{0}'' tengelyre az iterátor nem támogatott."	TokenNameStringLiteral	A tipizált ''{0}'' tengelyre az iterátor nem támogatott.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
,	TokenNameCOMMA	
"Nem megfelel? típusú forrás DOM használatával jött létre a DOMAdapter."	TokenNameStringLiteral	Nem megfelel? típusú forrás DOM használatával jött létre a DOMAdapter.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
,	TokenNameCOMMA	
"A használt SAX értelmez? nem kezeli a DTD deklarációs eseményeket."	TokenNameStringLiteral	A használt SAX értelmez? nem kezeli a DTD deklarációs eseményeket.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
,	TokenNameCOMMA	
"A használt SAX értelmez? nem támogatja az XML névtereket."	TokenNameStringLiteral	A használt SAX értelmez? nem támogatja az XML névtereket.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
,	TokenNameCOMMA	
"Nem lehet feloldani a(z) ''{0}'' URI hivatkozást."	TokenNameStringLiteral	Nem lehet feloldani a(z) ''{0}'' URI hivatkozást.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
,	TokenNameCOMMA	
"A megadott ''{0}'' translet az XSLTC egy újabb verziójával készült, mint a használatban lév? XSLTC verzió. Újra kell fordítania a stíluslapot, vagy a translet futtatásához az XSLTC újabb verzióját kell használnia."	TokenNameStringLiteral	A megadott ''{0}'' translet az XSLTC egy újabb verziójával készült, mint a használatban lév? XSLTC verzió. Újra kell fordítania a stíluslapot, vagy a translet futtatásához az XSLTC újabb verzióját kell használnia.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
,	TokenNameCOMMA	
"Egy olyan attribútum, aminek az értéke csak QName lehet, ''{0}'' értékkel rendelkezett."	TokenNameStringLiteral	Egy olyan attribútum, aminek az értéke csak QName lehet, ''{0}'' értékkel rendelkezett.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
,	TokenNameCOMMA	
"A(z) ''{0}'' kiterjesztési függvény használata nem megengedett, ha biztonságos feldolgozás be van kapcsolva. "	TokenNameStringLiteral	A(z) ''{0}'' kiterjesztési függvény használata nem megengedett, ha biztonságos feldolgozás be van kapcsolva. 
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
BasisLibrary	TokenNameIdentifier	 Basis Library
