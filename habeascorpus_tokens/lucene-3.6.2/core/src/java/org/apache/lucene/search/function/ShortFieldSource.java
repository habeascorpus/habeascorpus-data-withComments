...
;	TokenNameSEMICOLON	
/** * Expert: obtains short field values from the * {@link org.apache.lucene.search.FieldCache FieldCache} * using <code>getShorts()</code> and makes those values * available as other numeric types, casting as needed. * * @lucene.experimental * * @see org.apache.lucene.search.function.FieldCacheSource for requirements * on the field. * * <p><b>NOTE</b>: with the switch in 2.9 to segment-based * searching, if {@link #getValues} is invoked with a * composite (multi-segment) reader, this can easily cause * double RAM usage for the values in the FieldCache. It's * best to switch your application to pass only atomic * (single segment) readers to this API.</p> */	TokenNameCOMMENT_JAVADOC	 Expert: obtains short field values from the {@link org.apache.lucene.search.FieldCache FieldCache} using <code>getShorts()</code> and makes those values available as other numeric types, casting as needed. * @lucene.experimental * @see org.apache.lucene.search.function.FieldCacheSource for requirements on the field. * <p><b>NOTE</b>: with the switch in 2.9 to segment-based searching, if {@link #getValues} is invoked with a composite (multi-segment) reader, this can easily cause double RAM usage for the values in the FieldCache. It's best to switch your application to pass only atomic (single segment) readers to this API.</p> 
...
;	TokenNameSEMICOLON	
/** * Create a cached short field source with default string-to-short parser. */	TokenNameCOMMENT_JAVADOC	 Create a cached short field source with default string-to-short parser. 
public	TokenNamepublic	
ShortFieldSource	TokenNameIdentifier	 Short Field Source
(	TokenNameLPAREN	
...
/** * Create a cached short field source with a specific string-to-short parser. */	TokenNameCOMMENT_JAVADOC	 Create a cached short field source with a specific string-to-short parser. 
public	TokenNamepublic	
ShortFieldSource	TokenNameIdentifier	 Short Field Source
(	TokenNameLPAREN	
String	TokenNameIdentifier	 String
