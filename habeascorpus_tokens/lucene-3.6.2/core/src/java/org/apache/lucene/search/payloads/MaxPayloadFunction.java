...
/** * Returns the maximum payload score seen, else 1 if there are no payloads on the doc. * <p/> * Is thread safe and completely reusable. * **/	TokenNameCOMMENT_JAVADOC	 Returns the maximum payload score seen, else 1 if there are no payloads on the doc. <p/> Is thread safe and completely reusable. *
...
;	TokenNameSEMICOLON	
float	TokenNamefloat	
maxPayloadScore	TokenNameIdentifier	 max Payload Score
=	TokenNameEQUAL	
(	TokenNameLPAREN	
numPayloadsSeen	TokenNameIdentifier	 num Payloads Seen
>	TokenNameGREATER	
...
(	TokenNameLPAREN	
"MaxPayloadFunction(...)"	TokenNameStringLiteral	MaxPayloadFunction(...)
)	TokenNameRPAREN	
;	TokenNameSEMICOLON	
return	TokenNamereturn	
expl	TokenNameIdentifier	 expl
