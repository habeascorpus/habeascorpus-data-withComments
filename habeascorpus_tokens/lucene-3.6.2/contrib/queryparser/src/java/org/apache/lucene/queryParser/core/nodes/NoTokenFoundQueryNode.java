...
;	TokenNameSEMICOLON	
/** * A {@link NoTokenFoundQueryNode} is used if a term is convert into no tokens * by the tokenizer/lemmatizer/analyzer (null). */	TokenNameCOMMENT_JAVADOC	 A {@link NoTokenFoundQueryNode} is used if a term is convert into no tokens by the tokenizer/lemmatizer/analyzer (null). 
...
"[NTF]"	TokenNameStringLiteral	[NTF]
;	TokenNameSEMICOLON	
}	TokenNameRBRACE	
@	TokenNameAT	
Override	TokenNameIdentifier	 Override
...
{	TokenNameLBRACE	
return	TokenNamereturn	
"<notokenfound/>"	TokenNameStringLiteral	<notokenfound/>
;	TokenNameSEMICOLON	
}	TokenNameRBRACE	
@	TokenNameAT	
Override	TokenNameIdentifier	 Override
