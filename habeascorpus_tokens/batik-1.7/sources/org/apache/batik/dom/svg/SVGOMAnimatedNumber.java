...
;	TokenNameSEMICOLON	
/** * This class implements the {@link SVGAnimatedNumber} interface. * * @author <a href="mailto:stephane@hillion.org">Stephane Hillion</a> * @version $Id: SVGOMAnimatedNumber.java 490655 2006-12-28 05:19:44Z cam $ */	TokenNameCOMMENT_JAVADOC	 This class implements the {@link SVGAnimatedNumber} interface. * @author <a href="mailto:stephane@hillion.org">Stephane Hillion</a> @version $Id: SVGOMAnimatedNumber.java 490655 2006-12-28 05:19:44Z cam $ 
...
;	TokenNameSEMICOLON	
/** * Whether the parsed number can be a percentage. */	TokenNameCOMMENT_JAVADOC	 Whether the parsed number can be a percentage. 
protected	TokenNameprotected	
boolean	TokenNameboolean	
allowPercentage	TokenNameIdentifier	 allow Percentage
;	TokenNameSEMICOLON	
...
;	TokenNameSEMICOLON	
/** * Creates a new SVGOMAnimatedNumber. * @param elt The associated element. * @param ns The attribute's namespace URI. * @param ln The attribute's local name. * @param val The default value, if the attribute is not specified. */	TokenNameCOMMENT_JAVADOC	 Creates a new SVGOMAnimatedNumber. @param elt The associated element. @param ns The attribute's namespace URI. @param ln The attribute's local name. @param val The default value, if the attribute is not specified. 
public	TokenNamepublic	
SVGOMAnimatedNumber	TokenNameIdentifier	 SVGOM Animated Number
(	TokenNameLPAREN	
...
/** * Creates a new SVGOMAnimatedNumber possibly parsing it as a percentage. * @param elt The associated element. * @param ns The attribute's namespace URI. * @param ln The attribute's local name. * @param val The default value, if the attribute is not specified. * @param allowPercentage Allows number specified as a percentage. */	TokenNameCOMMENT_JAVADOC	 Creates a new SVGOMAnimatedNumber possibly parsing it as a percentage. @param elt The associated element. @param ns The attribute's namespace URI. @param ln The attribute's local name. @param val The default value, if the attribute is not specified. @param allowPercentage Allows number specified as a percentage. 
public	TokenNamepublic	
SVGOMAnimatedNumber	TokenNameIdentifier	 SVGOM Animated Number
(	TokenNameLPAREN	
AbstractElement	TokenNameIdentifier	 Abstract Element
...
/** * <b>DOM</b>: Implements {@link SVGAnimatedNumber#getBaseVal()}. */	TokenNameCOMMENT_JAVADOC	 <b>DOM</b>: Implements {@link SVGAnimatedNumber#getBaseVal()}. 
public	TokenNamepublic	
float	TokenNamefloat	
...
/** * <b>DOM</b>: Implements {@link SVGAnimatedNumber#setBaseVal(float)}. */	TokenNameCOMMENT_JAVADOC	 <b>DOM</b>: Implements {@link SVGAnimatedNumber#setBaseVal(float)}. 
public	TokenNamepublic	
void	TokenNamevoid	
...
/** * <b>DOM</b>: Implements {@link SVGAnimatedNumber#getAnimVal()}. */	TokenNameCOMMENT_JAVADOC	 <b>DOM</b>: Implements {@link SVGAnimatedNumber#getAnimVal()}. 
public	TokenNamepublic	
float	TokenNamefloat	
