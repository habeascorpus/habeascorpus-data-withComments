...
;	TokenNameSEMICOLON	
/** * <P>IDREFDatatypeValidator - represents the IDREFS * attribute type from XML 1.0 recommendation. The * Value Space of IDREF is the set of all strings * that match the NCName production and have been * used in an XML Document as the value of an element * or attribute of Type ID. The Lexical space of * IDREF is the set of strings that match the NCName * production.</P> * <P>The Value space of IDREF is scoped to a specific * instance document</P> * * @xerces.internal * * @author Jeffrey Rodriguez, IBM * @author Sandy Gao, IBM * * @version $Id: IDREFDatatypeValidator.java 699892 2008-09-28 21:08:27Z mrglavas $ */	TokenNameCOMMENT_JAVADOC	 <P>IDREFDatatypeValidator - represents the IDREFS attribute type from XML 1.0 recommendation. The Value Space of IDREF is the set of all strings that match the NCName production and have been used in an XML Document as the value of an element or attribute of Type ID. The Lexical space of IDREF is the set of strings that match the NCName production.</P> <P>The Value space of IDREF is scoped to a specific instance document</P> * @xerces.internal * @author Jeffrey Rodriguez, IBM @author Sandy Gao, IBM * @version $Id: IDREFDatatypeValidator.java 699892 2008-09-28 21:08:27Z mrglavas $ 
