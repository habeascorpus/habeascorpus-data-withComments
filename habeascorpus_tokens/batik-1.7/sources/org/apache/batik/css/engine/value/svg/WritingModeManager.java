...
;	TokenNameSEMICOLON	
/** * This class provides a manager for the 'writing-mode' property values. * * @author <a href="mailto:stephane@hillion.org">Stephane Hillion</a> * @version $Id: WritingModeManager.java 478283 2006-11-22 18:53:40Z dvholten $ */	TokenNameCOMMENT_JAVADOC	 This class provides a manager for the 'writing-mode' property values. * @author <a href="mailto:stephane@hillion.org">Stephane Hillion</a> @version $Id: WritingModeManager.java 478283 2006-11-22 18:53:40Z dvholten $ 
public	TokenNamepublic	
class	TokenNameclass	
WritingModeManager	TokenNameIdentifier	 Writing Mode Manager
...
CSSConstants	TokenNameIdentifier	 CSS Constants
.	TokenNameDOT	
CSS_LR_VALUE	TokenNameIdentifier	 CSS  LR  VALUE
,	TokenNameCOMMA	
SVGValueConstants	TokenNameIdentifier	 SVG Value Constants
.	TokenNameDOT	
LR_VALUE	TokenNameIdentifier	 LR  VALUE
)	TokenNameRPAREN	
;	TokenNameSEMICOLON	
values	TokenNameIdentifier	 values
.	TokenNameDOT	
...
CSSConstants	TokenNameIdentifier	 CSS Constants
.	TokenNameDOT	
CSS_LR_TB_VALUE	TokenNameIdentifier	 CSS  LR  TB  VALUE
,	TokenNameCOMMA	
SVGValueConstants	TokenNameIdentifier	 SVG Value Constants
.	TokenNameDOT	
LR_TB_VALUE	TokenNameIdentifier	 LR  TB  VALUE
)	TokenNameRPAREN	
;	TokenNameSEMICOLON	
values	TokenNameIdentifier	 values
.	TokenNameDOT	
...
CSSConstants	TokenNameIdentifier	 CSS Constants
.	TokenNameDOT	
CSS_RL_VALUE	TokenNameIdentifier	 CSS  RL  VALUE
,	TokenNameCOMMA	
SVGValueConstants	TokenNameIdentifier	 SVG Value Constants
.	TokenNameDOT	
RL_VALUE	TokenNameIdentifier	 RL  VALUE
)	TokenNameRPAREN	
;	TokenNameSEMICOLON	
values	TokenNameIdentifier	 values
.	TokenNameDOT	
...
CSSConstants	TokenNameIdentifier	 CSS Constants
.	TokenNameDOT	
CSS_RL_TB_VALUE	TokenNameIdentifier	 CSS  RL  TB  VALUE
,	TokenNameCOMMA	
SVGValueConstants	TokenNameIdentifier	 SVG Value Constants
.	TokenNameDOT	
RL_TB_VALUE	TokenNameIdentifier	 RL  TB  VALUE
)	TokenNameRPAREN	
;	TokenNameSEMICOLON	
values	TokenNameIdentifier	 values
.	TokenNameDOT	
...
CSSConstants	TokenNameIdentifier	 CSS Constants
.	TokenNameDOT	
CSS_TB_VALUE	TokenNameIdentifier	 CSS  TB  VALUE
,	TokenNameCOMMA	
SVGValueConstants	TokenNameIdentifier	 SVG Value Constants
.	TokenNameDOT	
TB_VALUE	TokenNameIdentifier	 TB  VALUE
)	TokenNameRPAREN	
;	TokenNameSEMICOLON	
values	TokenNameIdentifier	 values
.	TokenNameDOT	
...
CSSConstants	TokenNameIdentifier	 CSS Constants
.	TokenNameDOT	
CSS_TB_RL_VALUE	TokenNameIdentifier	 CSS  TB  RL  VALUE
,	TokenNameCOMMA	
SVGValueConstants	TokenNameIdentifier	 SVG Value Constants
.	TokenNameDOT	
TB_RL_VALUE	TokenNameIdentifier	 TB  RL  VALUE
)	TokenNameRPAREN	
;	TokenNameSEMICOLON	
}	TokenNameRBRACE	
...
CSSConstants	TokenNameIdentifier	 CSS Constants
.	TokenNameDOT	
CSS_WRITING_MODE_PROPERTY	TokenNameIdentifier	 CSS  WRITING  MODE  PROPERTY
;	TokenNameSEMICOLON	
}	TokenNameRBRACE	
