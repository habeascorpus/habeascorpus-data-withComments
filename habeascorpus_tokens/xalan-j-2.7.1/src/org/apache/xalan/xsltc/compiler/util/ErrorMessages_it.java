...
/* * $Id: ErrorMessages_it.java 468649 2006-10-28 07:00:55Z minchau $ */	TokenNameCOMMENT_BLOCK	 $Id: ErrorMessages_it.java 468649 2006-10-28 07:00:55Z minchau $ 
...
,	TokenNameCOMMA	
"Più fogli di stile definiti nello stesso file."	TokenNameStringLiteral	Più fogli di stile definiti nello stesso file.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
,	TokenNameCOMMA	
"La maschera ''{0}'' già definita in questo foglio di lavoro."	TokenNameStringLiteral	La maschera ''{0}'' già definita in questo foglio di lavoro.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
,	TokenNameCOMMA	
"La maschera ''{0}'' non definita in questo foglio di lavoro."	TokenNameStringLiteral	La maschera ''{0}'' non definita in questo foglio di lavoro.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
,	TokenNameCOMMA	
"La variabile ''{0}'' è definita più volte nello stesso ambito."	TokenNameStringLiteral	La variabile ''{0}'' è definita più volte nello stesso ambito.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
,	TokenNameCOMMA	
"Variabile o parametro ''{0}'' non definito. "	TokenNameStringLiteral	Variabile o parametro ''{0}'' non definito. 
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
,	TokenNameCOMMA	
"Impossibile trovare la classe ''{0}''."	TokenNameStringLiteral	Impossibile trovare la classe ''{0}''.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
,	TokenNameCOMMA	
"Impossibile trovare il metodo esterno ''{0}'' (deve essere pubblico)."	TokenNameStringLiteral	Impossibile trovare il metodo esterno ''{0}'' (deve essere pubblico).
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
,	TokenNameCOMMA	
"Impossibile convertire il tipo di argomento/ritorno nella chiamata nel metodo ''{0}''"	TokenNameStringLiteral	Impossibile convertire il tipo di argomento/ritorno nella chiamata nel metodo ''{0}''
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
,	TokenNameCOMMA	
"File o URI ''{0}'' non trovato."	TokenNameStringLiteral	File o URI ''{0}'' non trovato.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
,	TokenNameCOMMA	
"URI non valido ''{0}''."	TokenNameStringLiteral	URI non valido ''{0}''.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
,	TokenNameCOMMA	
"Impossibile aprire il file o l''''URI ''{0}''."	TokenNameStringLiteral	Impossibile aprire il file o l''''URI ''{0}''.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
,	TokenNameCOMMA	
"Era previsto l'elemento <xsl:stylesheet> o <xsl:transform>."	TokenNameStringLiteral	Era previsto l'elemento <xsl:stylesheet> o <xsl:transform>.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
,	TokenNameCOMMA	
"Il prefisso dello spazio nome ''{0}'' non è dichiarato. "	TokenNameStringLiteral	Il prefisso dello spazio nome ''{0}'' non è dichiarato. 
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
,	TokenNameCOMMA	
"Impossibile risolvere la chiamata alla funzione ''{0}''."	TokenNameStringLiteral	Impossibile risolvere la chiamata alla funzione ''{0}''.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
,	TokenNameCOMMA	
"L''''argomento di ''{0}'' deve essere una stringa letterale. "	TokenNameStringLiteral	L''''argomento di ''{0}'' deve essere una stringa letterale. 
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
,	TokenNameCOMMA	
"Errore durante l''''analisi dell''''espressione XPath ''{0}''."	TokenNameStringLiteral	Errore durante l''''analisi dell''''espressione XPath ''{0}''.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
,	TokenNameCOMMA	
"Attributo ''{0}'' richiesto mancante. "	TokenNameStringLiteral	Attributo ''{0}'' richiesto mancante. 
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
,	TokenNameCOMMA	
"Carattere non valido ''{0}'' nell''''espressione XPath. "	TokenNameStringLiteral	Carattere non valido ''{0}'' nell''''espressione XPath. 
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
,	TokenNameCOMMA	
"Nome ''{0}'' non valido per l''''istruzione di elaborazione. "	TokenNameStringLiteral	Nome ''{0}'' non valido per l''''istruzione di elaborazione. 
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
,	TokenNameCOMMA	
"Attributo non valido ''{0}''."	TokenNameStringLiteral	Attributo non valido ''{0}''.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
,	TokenNameCOMMA	
"Import/include circolare. Foglio di lavoro ''{0}'' già caricato. "	TokenNameStringLiteral	Import/include circolare. Foglio di lavoro ''{0}'' già caricato. 
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
,	TokenNameCOMMA	
"Impossibile ordinare i frammenti della struttura ad albero dei risultati (elementi <xsl:sort> ignorati). È necessario ordinare i nodi quando si crea la struttura ad albero dei risultati."	TokenNameStringLiteral	Impossibile ordinare i frammenti della struttura ad albero dei risultati (elementi <xsl:sort> ignorati). È necessario ordinare i nodi quando si crea la struttura ad albero dei risultati.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
,	TokenNameCOMMA	
"La formattazione decimale ''{0}'' è già definita."	TokenNameStringLiteral	La formattazione decimale ''{0}'' è già definita.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
,	TokenNameCOMMA	
"La versione XSL ''{0}'' non è supportata da XSLTC."	TokenNameStringLiteral	La versione XSL ''{0}'' non è supportata da XSLTC.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
,	TokenNameCOMMA	
"Riferimento variabile/parametro circolare in ''{0}''."	TokenNameStringLiteral	Riferimento variabile/parametro circolare in ''{0}''.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
,	TokenNameCOMMA	
"Operatore sconosciuto per l'espressione binaria."	TokenNameStringLiteral	Operatore sconosciuto per l'espressione binaria.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
,	TokenNameCOMMA	
"Argomento(i) non valido(i) per la chiamata alla funzione."	TokenNameStringLiteral	Argomento(i) non valido(i) per la chiamata alla funzione.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
,	TokenNameCOMMA	
"Il secondo argomento di una funzione document() deve essere una serie di nodi."	TokenNameStringLiteral	Il secondo argomento di una funzione document() deve essere una serie di nodi.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
,	TokenNameCOMMA	
"È necessario almeno un elemento <xsl:when> in <xsl:choose>."	TokenNameStringLiteral	È necessario almeno un elemento <xsl:when> in <xsl:choose>.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
,	TokenNameCOMMA	
"Solo un elemento <xsl:otherwise> consentito in <xsl:choose>."	TokenNameStringLiteral	Solo un elemento <xsl:otherwise> consentito in <xsl:choose>.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
/* * Note to translators: "<xsl:otherwise>" and "<xsl:choose>" are * keywords and should not be translated. This message describes a * syntax error in the stylesheet. */	TokenNameCOMMENT_BLOCK	 Note to translators: "<xsl:otherwise>" and "<xsl:choose>" are keywords and should not be translated. This message describes a syntax error in the stylesheet. 
{	TokenNameLBRACE	
...
,	TokenNameCOMMA	
"<xsl:otherwise> può essere utilizzato solo all'interno di <xsl:choose>."	TokenNameStringLiteral	<xsl:otherwise> può essere utilizzato solo all'interno di <xsl:choose>.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
/* * Note to translators: "<xsl:when>" and "<xsl:choose>" are keywords * and should not be translated. This message describes a syntax error * in the stylesheet. */	TokenNameCOMMENT_BLOCK	 Note to translators: "<xsl:when>" and "<xsl:choose>" are keywords and should not be translated. This message describes a syntax error in the stylesheet. 
{	TokenNameLBRACE	
...
,	TokenNameCOMMA	
"<xsl:when> può essere utilizzato solo all'interno di <xsl:choose>."	TokenNameStringLiteral	<xsl:when> può essere utilizzato solo all'interno di <xsl:choose>.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
,	TokenNameCOMMA	
"Solo gli elementi <xsl:when> e <xsl:otherwise> sono consentiti in <xsl:choose>."	TokenNameStringLiteral	Solo gli elementi <xsl:when> e <xsl:otherwise> sono consentiti in <xsl:choose>.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
,	TokenNameCOMMA	
"<xsl:attribute-set> non contiene l'attributo 'name'."	TokenNameStringLiteral	<xsl:attribute-set> non contiene l'attributo 'name'.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
,	TokenNameCOMMA	
"Elemento child non valido."	TokenNameStringLiteral	Elemento child non valido.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
,	TokenNameCOMMA	
"Impossibile chiamare un elemento ''{0}''"	TokenNameStringLiteral	Impossibile chiamare un elemento ''{0}''
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
,	TokenNameCOMMA	
"Impossibile chiamare un attributo ''{0}''"	TokenNameStringLiteral	Impossibile chiamare un attributo ''{0}''
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
,	TokenNameCOMMA	
"Dati di testo al di fuori dell'elemento <xsl:stylesheet> di livello superiore."	TokenNameStringLiteral	Dati di testo al di fuori dell'elemento <xsl:stylesheet> di livello superiore.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
,	TokenNameCOMMA	
"Parser JAXP non configurato correttamente"	TokenNameStringLiteral	Parser JAXP non configurato correttamente
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
,	TokenNameCOMMA	
"Errore XSLTC interno non recuperabile: ''{0}''"	TokenNameStringLiteral	Errore XSLTC interno non recuperabile: ''{0}''
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
,	TokenNameCOMMA	
"Il documento di immissione non è un foglio di lavoro (lo namespace XSL non è dichiarato nell'elemento root)."	TokenNameStringLiteral	Il documento di immissione non è un foglio di lavoro (lo namespace XSL non è dichiarato nell'elemento root).
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
,	TokenNameCOMMA	
"Impossibile trovare la destinazione stylesheet ''{0}''."	TokenNameStringLiteral	Impossibile trovare la destinazione stylesheet ''{0}''.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
,	TokenNameCOMMA	
"Non implementato: ''{0}''."	TokenNameStringLiteral	Non implementato: ''{0}''.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
,	TokenNameCOMMA	
"Il documento di immissione non contiene un foglio di lavoro XSL."	TokenNameStringLiteral	Il documento di immissione non contiene un foglio di lavoro XSL.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
,	TokenNameCOMMA	
"Impossibile analizzare l''''elemento ''{0}''"	TokenNameStringLiteral	Impossibile analizzare l''''elemento ''{0}''
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
,	TokenNameCOMMA	
"L'attributo use di <key> deve essere node, node-set, string o number."	TokenNameStringLiteral	L'attributo use di <key> deve essere node, node-set, string o number.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
,	TokenNameCOMMA	
"La versione del documento XML di emissione deve essere 1.0"	TokenNameStringLiteral	La versione del documento XML di emissione deve essere 1.0
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
,	TokenNameCOMMA	
"Operatore sconosciuto per l'espressione relazionale"	TokenNameStringLiteral	Operatore sconosciuto per l'espressione relazionale
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
,	TokenNameCOMMA	
"Tentativo di utilizzare una serie di attributi ''{0}'' non esistente."	TokenNameStringLiteral	Tentativo di utilizzare una serie di attributi ''{0}'' non esistente.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
,	TokenNameCOMMA	
"Impossibile analizzare la maschera del valore di attributo ''{0}''."	TokenNameStringLiteral	Impossibile analizzare la maschera del valore di attributo ''{0}''.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
,	TokenNameCOMMA	
"Tipo di dati sconosciuto nella firma per la classe ''{0}''."	TokenNameStringLiteral	Tipo di dati sconosciuto nella firma per la classe ''{0}''.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
,	TokenNameCOMMA	
"Impossibile convertire il tipo di dati da ''{0}'' a ''{1}''."	TokenNameStringLiteral	Impossibile convertire il tipo di dati da ''{0}'' a ''{1}''.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
,	TokenNameCOMMA	
"Questa Templates non contiene una definizione di classe translet valida."	TokenNameStringLiteral	Questa Templates non contiene una definizione di classe translet valida.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
/* * Note to translators: "Templates" is a Java class name that should * not be translated. */	TokenNameCOMMENT_BLOCK	 Note to translators: "Templates" is a Java class name that should not be translated. 
{	TokenNameLBRACE	
...
,	TokenNameCOMMA	
"Questa Templates non contengono una classe con il nome ''{0}''."	TokenNameStringLiteral	Questa Templates non contengono una classe con il nome ''{0}''.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
,	TokenNameCOMMA	
"Impossibile caricare la classe translet ''{0}''."	TokenNameStringLiteral	Impossibile caricare la classe translet ''{0}''.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ErrorMsg	TokenNameIdentifier	 Error Msg
...
,	TokenNameCOMMA	
"Classe translet caricata, ma non è possibile creare l'istanza translet."	TokenNameStringLiteral	Classe translet caricata, ma non è possibile creare l'istanza translet.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
,	TokenNameCOMMA	
"Tentativo di impostare ErrorListener per ''{0}'' su null"	TokenNameStringLiteral	Tentativo di impostare ErrorListener per ''{0}'' su null
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
,	TokenNameCOMMA	
"Solo StreamSource, SAXSource e DOMSource sono supportati da XSLTC"	TokenNameStringLiteral	Solo StreamSource, SAXSource e DOMSource sono supportati da XSLTC
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
,	TokenNameCOMMA	
"L''oggetto Source passato a ''{0}'' non ha contenuto."	TokenNameStringLiteral	L''oggetto Source passato a ''{0}'' non ha contenuto.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
,	TokenNameCOMMA	
"Impossibile compilare il foglio di lavoro"	TokenNameStringLiteral	Impossibile compilare il foglio di lavoro
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
,	TokenNameCOMMA	
"TransformerFactory non riconosce l''''attributo ''{0}''."	TokenNameStringLiteral	TransformerFactory non riconosce l''''attributo ''{0}''.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
,	TokenNameCOMMA	
"setResult() deve essere richiamato prima di startDocument()."	TokenNameStringLiteral	setResult() deve essere richiamato prima di startDocument().
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
,	TokenNameCOMMA	
"Transformer non dispone di un oggetto translet incapsulato."	TokenNameStringLiteral	Transformer non dispone di un oggetto translet incapsulato.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
,	TokenNameCOMMA	
"Nessun programma di gestione dell'emissione definito per il risultato della trasformazione."	TokenNameStringLiteral	Nessun programma di gestione dell'emissione definito per il risultato della trasformazione.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
,	TokenNameCOMMA	
"Oggetto Result passato ''{0}'' non valido."	TokenNameStringLiteral	Oggetto Result passato ''{0}'' non valido.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
,	TokenNameCOMMA	
"Tentativo di accedere alla proprietà Transformer ''{0}'' non valida."	TokenNameStringLiteral	Tentativo di accedere alla proprietà Transformer ''{0}'' non valida.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
,	TokenNameCOMMA	
"Impossibile creare l''''adattatore SAX2DOM: ''{0}''."	TokenNameStringLiteral	Impossibile creare l''''adattatore SAX2DOM: ''{0}''.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
,	TokenNameCOMMA	
"XSLTCSource.build() richiamato senza che sia impostato un systemId (identificativo di sistema)."	TokenNameStringLiteral	XSLTCSource.build() richiamato senza che sia impostato un systemId (identificativo di sistema).
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ErrorMsg	TokenNameIdentifier	 Error Msg
...
,	TokenNameCOMMA	
"L'opzione -i deve essere utilizzata con l'opzione -o."	TokenNameStringLiteral	L'opzione -i deve essere utilizzata con l'opzione -o.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
,	TokenNameCOMMA	
"SYNOPSIS java org.apache.xalan.xsltc.cmdline.Compile [-o <output>] [-d <directory>] [-j <jarfile>] [-p <package>] [-n] [-x] [-u] [-v] [-h] { <stylesheet> | -i } OPTIONS -o <output> assegna il nome <output> al translet generato . Per impostazione predefinita, il nome translet è derivato dal nome <stylesheet>. Questa opzione viene ignorata se vengono compilati più fogli di stile. -d <directory> specifica una directory di destinazione per il translet -j <jarfile> raggruppa le classi translet in un file jar del nome specificato come <jarfile> -p <package> specifica un prefisso del nome pacchetto per tutte le classi translet generate. -n abilita l'allineamento della maschera (funzionamento predefinito migliore in media). -x attiva ulteriori emissioni dei messaggi di debug -u interpreta gli argomenti <stylesheet> come URL -i impone al programma di compilazione di leggere il foglio di lavoro da stdin -v stampa la versione del programma di compilazione -h stampa queste istruzioni sull'utilizzo "	TokenNameStringLiteral	SYNOPSIS java org.apache.xalan.xsltc.cmdline.Compile [-o <output>] [-d <directory>] [-j <jarfile>] [-p <package>] [-n] [-x] [-u] [-v] [-h] { <stylesheet> | -i } OPTIONS -o <output> assegna il nome <output> al translet generato . Per impostazione predefinita, il nome translet è derivato dal nome <stylesheet>. Questa opzione viene ignorata se vengono compilati più fogli di stile. -d <directory> specifica una directory di destinazione per il translet -j <jarfile> raggruppa le classi translet in un file jar del nome specificato come <jarfile> -p <package> specifica un prefisso del nome pacchetto per tutte le classi translet generate. -n abilita l'allineamento della maschera (funzionamento predefinito migliore in media). -x attiva ulteriori emissioni dei messaggi di debug -u interpreta gli argomenti <stylesheet> come URL -i impone al programma di compilazione di leggere il foglio di lavoro da stdin -v stampa la versione del programma di compilazione -h stampa queste istruzioni sull'utilizzo 
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
,	TokenNameCOMMA	
"SYNOPSIS java org.apache.xalan.xsltc.cmdline.Transform [-j <jarfile>] [-x] [-n <iterations>] {-u <document_url> | <document>} <class> [<param1>=<value1> ...] utilizza il translet <class> per convertire un documento XML specificato come <document>. Il translet <classe> si trova nella istruzione CLASSPATH dell'utente o nel <jarfile> eventualmente specificato. OPTIONS -j <jarfile> specifica un jarfile dal quale caricare il translet -x attiva ulteriori output dei messaggi di debug -n <iterations> esegue la trasformazione <iterazioni> e visualizza le informazioni relative al profilo -u <document_url> specifica il documento di immissione XML come URL "	TokenNameStringLiteral	SYNOPSIS java org.apache.xalan.xsltc.cmdline.Transform [-j <jarfile>] [-x] [-n <iterations>] {-u <document_url> | <document>} <class> [<param1>=<value1> ...] utilizza il translet <class> per convertire un documento XML specificato come <document>. Il translet <classe> si trova nella istruzione CLASSPATH dell'utente o nel <jarfile> eventualmente specificato. OPTIONS -j <jarfile> specifica un jarfile dal quale caricare il translet -x attiva ulteriori output dei messaggi di debug -n <iterations> esegue la trasformazione <iterazioni> e visualizza le informazioni relative al profilo -u <document_url> specifica il documento di immissione XML come URL 
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
,	TokenNameCOMMA	
"<xsl:sort> può essere utilizzato solo all'interno di <xsl:for-each> o <xsl:apply-templates>."	TokenNameStringLiteral	<xsl:sort> può essere utilizzato solo all'interno di <xsl:for-each> o <xsl:apply-templates>.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
,	TokenNameCOMMA	
"Codifica di emissione ''{0}'' non supportata in questa JVM."	TokenNameStringLiteral	Codifica di emissione ''{0}'' non supportata in questa JVM.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
,	TokenNameCOMMA	
"Errore di sintassi in ''{0}''."	TokenNameStringLiteral	Errore di sintassi in ''{0}''.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
,	TokenNameCOMMA	
"Impossibile trovare un costruttore esterno ''{0}''."	TokenNameStringLiteral	Impossibile trovare un costruttore esterno ''{0}''.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
,	TokenNameCOMMA	
"Il primo argomento della funzione Java non statica ''{0}'' non è un riferimento ad un oggetto valido. "	TokenNameStringLiteral	Il primo argomento della funzione Java non statica ''{0}'' non è un riferimento ad un oggetto valido. 
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
,	TokenNameCOMMA	
"Errore durante la verifica del tipo di espressione ''{0}''."	TokenNameStringLiteral	Errore durante la verifica del tipo di espressione ''{0}''.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
,	TokenNameCOMMA	
"Errore durante la verifica del tipo di espressione in una posizione sconosciuta."	TokenNameStringLiteral	Errore durante la verifica del tipo di espressione in una posizione sconosciuta.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
,	TokenNameCOMMA	
"L''''opzione della riga comandi ''{0}'' non è valida."	TokenNameStringLiteral	L''''opzione della riga comandi ''{0}'' non è valida.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
,	TokenNameCOMMA	
"Manca un argomento obbligatorio per l''''opzione della riga comandi ''{0}''. "	TokenNameStringLiteral	Manca un argomento obbligatorio per l''''opzione della riga comandi ''{0}''. 
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
,	TokenNameCOMMA	
"ATTENZIONE: ''{0}'' :{1}"	TokenNameStringLiteral	ATTENZIONE: ''{0}'' :{1}
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
,	TokenNameCOMMA	
"ATTENZIONE: ''{0}''"	TokenNameStringLiteral	ATTENZIONE: ''{0}''
}	TokenNameRBRACE	
,	TokenNameCOMMA	
/* * Note to translators: This message is used to indicate the severity * of another message. The substitution text contains two error * messages. The spacing before the second substitution text indents * it the same amount as the first in English. */	TokenNameCOMMENT_BLOCK	 Note to translators: This message is used to indicate the severity of another message. The substitution text contains two error messages. The spacing before the second substitution text indents it the same amount as the first in English. 
{	TokenNameLBRACE	
...
,	TokenNameCOMMA	
"ERRORE IRREVERSIBILE: ''{0}'' :{1}"	TokenNameStringLiteral	ERRORE IRREVERSIBILE: ''{0}'' :{1}
}	TokenNameRBRACE	
,	TokenNameCOMMA	
/* * Note to translators: This message is used to indicate the severity * of another message. The substitution text is an error message. */	TokenNameCOMMENT_BLOCK	 Note to translators: This message is used to indicate the severity of another message. The substitution text is an error message. 
{	TokenNameLBRACE	
...
,	TokenNameCOMMA	
"ERRORE IRREVERSIBILE: ''{0}''"	TokenNameStringLiteral	ERRORE IRREVERSIBILE: ''{0}''
}	TokenNameRBRACE	
,	TokenNameCOMMA	
/* * Note to translators: This message is used to indicate the severity * of another message. The substitution text contains two error * messages. The spacing before the second substitution text indents * it the same amount as the first in English. */	TokenNameCOMMENT_BLOCK	 Note to translators: This message is used to indicate the severity of another message. The substitution text contains two error messages. The spacing before the second substitution text indents it the same amount as the first in English. 
{	TokenNameLBRACE	
...
,	TokenNameCOMMA	
"ERRORE: ''{0}'' :{1}"	TokenNameStringLiteral	ERRORE: ''{0}'' :{1}
}	TokenNameRBRACE	
,	TokenNameCOMMA	
/* * Note to translators: This message is used to indicate the severity * of another message. The substitution text is an error message. */	TokenNameCOMMENT_BLOCK	 Note to translators: This message is used to indicate the severity of another message. The substitution text is an error message. 
{	TokenNameLBRACE	
...
,	TokenNameCOMMA	
"ERRORE: ''{0}''"	TokenNameStringLiteral	ERRORE: ''{0}''
}	TokenNameRBRACE	
,	TokenNameCOMMA	
/* * Note to translators: The substitution text is the name of a class. */	TokenNameCOMMENT_BLOCK	 Note to translators: The substitution text is the name of a class. 
{	TokenNameLBRACE	
...
,	TokenNameCOMMA	
"Trasformazione utilizzando il translet ''{0}'' "	TokenNameStringLiteral	Trasformazione utilizzando il translet ''{0}'' 
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
,	TokenNameCOMMA	
"Trasformazione utilizzando il translet ''{0}'' dal file jar ''{1}''"	TokenNameStringLiteral	Trasformazione utilizzando il translet ''{0}'' dal file jar ''{1}''
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
,	TokenNameCOMMA	
"Impossibile creare un''istanza della classe TransformerFactory ''{0}''."	TokenNameStringLiteral	Impossibile creare un''istanza della classe TransformerFactory ''{0}''.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
,	TokenNameCOMMA	
"Non è stato possibile utilizzare il nome ''{0}'' come nome della classe translet perché contiene dei caratteri che non sono consentiti nel nome della classe Java. È stato invece utilizzato il nome ''{1}''."	TokenNameStringLiteral	Non è stato possibile utilizzare il nome ''{0}'' come nome della classe translet perché contiene dei caratteri che non sono consentiti nel nome della classe Java. È stato invece utilizzato il nome ''{1}''.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
,	TokenNameCOMMA	
"Errori del programma di compilazione:"	TokenNameStringLiteral	Errori del programma di compilazione:
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
,	TokenNameCOMMA	
"Messaggi di avvertenza del programma di compilazione:"	TokenNameStringLiteral	Messaggi di avvertenza del programma di compilazione:
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
,	TokenNameCOMMA	
"Errori del translet:"	TokenNameStringLiteral	Errori del translet:
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
,	TokenNameCOMMA	
"Un attributo il cui valore deve essere un QName o un elenco separato da spazi vuoti di QName ha avuto il valore di ''{0}''"	TokenNameStringLiteral	Un attributo il cui valore deve essere un QName o un elenco separato da spazi vuoti di QName ha avuto il valore di ''{0}''
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
,	TokenNameCOMMA	
"L''''attributo del metodo di un elemento <xsl:output> aveva il valore ''{0}''. Il valore deve essere uno di ''xml'', ''html'', ''text'' o qname-but-not-ncname"	TokenNameStringLiteral	L''''attributo del metodo di un elemento <xsl:output> aveva il valore ''{0}''. Il valore deve essere uno di ''xml'', ''html'', ''text'' o qname-but-not-ncname
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ErrorMsg	TokenNameIdentifier	 Error Msg
