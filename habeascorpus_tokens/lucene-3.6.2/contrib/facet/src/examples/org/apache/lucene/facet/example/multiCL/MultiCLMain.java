...
{	TokenNameLBRACE	
/** * Driver for the multi sample. * * @throws Exception * on error (no detailed exception handling here for sample * simplicity */	TokenNameCOMMENT_JAVADOC	 Driver for the multi sample. * @throws Exception on error (no detailed exception handling here for sample simplicity 
public	TokenNamepublic	
