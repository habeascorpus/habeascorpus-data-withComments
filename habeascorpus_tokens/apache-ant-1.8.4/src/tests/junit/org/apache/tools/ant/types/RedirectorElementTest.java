...
RedirectorElementTest	TokenNameIdentifier	 Redirector Element Test
...
(	TokenNameLPAREN	
"src/etc/testcases/types/redirector.xml"	TokenNameStringLiteral	src/etc/testcases/types/redirector.xml
,	TokenNameCOMMA	
Project	TokenNameIdentifier	 Project
.	TokenNameDOT	
...
public	TokenNamepublic	
void	TokenNamevoid	
testLogInputString	TokenNameIdentifier	 test Log Input String
(	TokenNameLPAREN	
)	TokenNameRPAREN	
{	TokenNameLBRACE	
executeTarget	TokenNameIdentifier	 execute Target
(	TokenNameLPAREN	
"testLogInputString"	TokenNameStringLiteral	testLogInputString
)	TokenNameRPAREN	
;	TokenNameSEMICOLON	
if	TokenNameif	
(	TokenNameLPAREN	
...
(	TokenNameLPAREN	
"testLogInputString can-cat"	TokenNameStringLiteral	testLogInputString can-cat
)	TokenNameRPAREN	
...
(	TokenNameLPAREN	
"Using input string"	TokenNameStringLiteral	Using input string
)	TokenNameRPAREN	
;	TokenNameSEMICOLON	
}	TokenNameRBRACE	
}	TokenNameRBRACE	
public	TokenNamepublic	
void	TokenNamevoid	
testRefid	TokenNameIdentifier	 test Refid
(	TokenNameLPAREN	
)	TokenNameRPAREN	
{	TokenNameLBRACE	
executeTarget	TokenNameIdentifier	 execute Target
