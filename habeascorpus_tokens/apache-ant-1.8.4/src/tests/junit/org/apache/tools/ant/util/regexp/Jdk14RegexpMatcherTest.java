...
;	TokenNameSEMICOLON	
/** * Tests for the JDK 1.4 implementation of the RegexpMatcher interface. * */	TokenNameCOMMENT_JAVADOC	 Tests for the JDK 1.4 implementation of the RegexpMatcher interface. 
public	TokenNamepublic	
class	TokenNameclass	
Jdk14RegexpMatcherTest	TokenNameIdentifier	 Jdk14 Regexp Matcher Test
...
(	TokenNameLPAREN	
"Should trigger once fixed. {@since JDK 1.4RC1}"	TokenNameStringLiteral	Should trigger once fixed. {@since JDK 1.4RC1}
)	TokenNameRPAREN	
;	TokenNameSEMICOLON	
}	TokenNameRBRACE	
