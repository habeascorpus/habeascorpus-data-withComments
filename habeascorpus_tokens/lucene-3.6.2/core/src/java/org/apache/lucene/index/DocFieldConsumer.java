...
fieldInfos	TokenNameIdentifier	 field Infos
;	TokenNameSEMICOLON	
/** Called when DocumentsWriter decides to create a new * segment */	TokenNameCOMMENT_JAVADOC	 Called when DocumentsWriter decides to create a new segment 
abstract	TokenNameabstract	
void	TokenNamevoid	
...
IOException	TokenNameIdentifier	 IO Exception
;	TokenNameSEMICOLON	
/** Called when an aborting exception is hit */	TokenNameCOMMENT_JAVADOC	 Called when an aborting exception is hit 
abstract	TokenNameabstract	
void	TokenNamevoid	
...
IOException	TokenNameIdentifier	 IO Exception
;	TokenNameSEMICOLON	
/** Called when DocumentsWriter is using too much RAM. * The consumer should free RAM, if possible, returning * true if any RAM was in fact freed. */	TokenNameCOMMENT_JAVADOC	 Called when DocumentsWriter is using too much RAM. The consumer should free RAM, if possible, returning true if any RAM was in fact freed. 
abstract	TokenNameabstract	
