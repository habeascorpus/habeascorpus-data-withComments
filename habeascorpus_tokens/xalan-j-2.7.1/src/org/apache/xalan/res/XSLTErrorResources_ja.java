...
/* * $Id: XSLTErrorResources_ja.java 468641 2006-10-28 06:54:42Z minchau $ */	TokenNameCOMMENT_BLOCK	 $Id: XSLTErrorResources_ja.java 468641 2006-10-28 06:54:42Z minchau $ 
...
XSLTErrorResources_ja	TokenNameIdentifier	 XSLT Error Resources ja
...
ER_BAD_VAL_ON_LEVEL_ATTRIB	TokenNameIdentifier	 ER  BAD  VAL  ON  LEVEL  ATTRIB
,	TokenNameCOMMA	
"level ????????????: {0}"	TokenNameStringLiteral	level ????????????: {0}
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_PROCESSINGINSTRUCTION_NAME_CANT_BE_XML	TokenNameIdentifier	 ER  PROCESSINGINSTRUCTION  NAME  CANT  BE  XML
...
ER_PROCESS_ERROR	TokenNameIdentifier	 ER  PROCESS  ERROR
,	TokenNameCOMMA	
"StylesheetRoot.?????"	TokenNameStringLiteral	StylesheetRoot.?????
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_UNIMPLNODE_ERROR	TokenNameIdentifier	 ER  UNIMPLNODE  ERROR
...
ER_TEMPLATES_NEED_MATCH_OR_NAME_ATTRIB	TokenNameIdentifier	 ER  TEMPLATES  NEED  MATCH  OR  NAME  ATTRIB
,	TokenNameCOMMA	
"???????? match ??? name ??????????????"	TokenNameStringLiteral	???????? match ??? name ??????????????
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_NO_CLONE_OF_DOCUMENT_FRAG	TokenNameIdentifier	 ER  NO  CLONE  OF  DOCUMENT  FRAG
...
ER_NO_STYLESHEET_PI	TokenNameIdentifier	 ER  NO  STYLESHEET  PI
,	TokenNameCOMMA	
"XML ??????? PI ? {0} ?????????"	TokenNameStringLiteral	XML ??????? PI ? {0} ?????????
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_NOT_SUPPORTED	TokenNameIdentifier	 ER  NOT  SUPPORTED
...
INVALID_TCHAR	TokenNameIdentifier	 INVALID  TCHAR
,	TokenNameCOMMA	
"??????: {1} ? CHAR ??: {0} ?????????CHAR ????? 1 ?????????????"	TokenNameStringLiteral	??????: {1} ? CHAR ??: {0} ?????????CHAR ????? 1 ?????????????
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
INVALID_QNAME	TokenNameIdentifier	 INVALID  QNAME
,	TokenNameCOMMA	
"??????: {1} ? QNAME ??: {0} ?????????"	TokenNameStringLiteral	??????: {1} ? QNAME ??: {0} ?????????
}	TokenNameRBRACE	
,	TokenNameCOMMA	
// Note to translators: The following message is used if the value of 	TokenNameCOMMENT_LINE	Note to translators: The following message is used if the value of 
...
INVALID_ENUM	TokenNameIdentifier	 INVALID  ENUM
,	TokenNameCOMMA	
"??????: {1} ? ENUM ??: {0} ????????????: {2}?"	TokenNameStringLiteral	??????: {1} ? ENUM ??: {0} ????????????: {2}?
}	TokenNameRBRACE	
,	TokenNameCOMMA	
// Note to translators: The following message is used if the value of 	TokenNameCOMMENT_LINE	Note to translators: The following message is used if the value of 
...
INVALID_NMTOKEN	TokenNameIdentifier	 INVALID  NMTOKEN
,	TokenNameCOMMA	
"??????: {1} ? NMTOKEN ??: {0} ?????????"	TokenNameStringLiteral	??????: {1} ? NMTOKEN ??: {0} ?????????
}	TokenNameRBRACE	
,	TokenNameCOMMA	
// Note to translators: The following message is used if the value of 	TokenNameCOMMENT_LINE	Note to translators: The following message is used if the value of 
...
INVALID_NCNAME	TokenNameIdentifier	 INVALID  NCNAME
,	TokenNameCOMMA	
"??????: {1} ? NCNAME ??: {0} ?????????"	TokenNameStringLiteral	??????: {1} ? NCNAME ??: {0} ?????????
}	TokenNameRBRACE	
,	TokenNameCOMMA	
// Note to translators: The following message is used if the value of 	TokenNameCOMMENT_LINE	Note to translators: The following message is used if the value of 
...
INVALID_BOOLEAN	TokenNameIdentifier	 INVALID  BOOLEAN
,	TokenNameCOMMA	
"??????: {1} ? boolean ??: {0} ?????????"	TokenNameStringLiteral	??????: {1} ? boolean ??: {0} ?????????
}	TokenNameRBRACE	
,	TokenNameCOMMA	
// Note to translators: The following message is used if the value of 	TokenNameCOMMENT_LINE	Note to translators: The following message is used if the value of 
...
INVALID_NUMBER	TokenNameIdentifier	 INVALID  NUMBER
,	TokenNameCOMMA	
"??????: {1} ? number ??: {0} ?????????"	TokenNameStringLiteral	??????: {1} ? number ??: {0} ?????????
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
WG_CANNOT_LOAD_REQUESTED_DOC	TokenNameIdentifier	 WG  CANNOT  LOAD  REQUESTED  DOC
,	TokenNameCOMMA	
"????? doc: {0} ??????????"	TokenNameStringLiteral	????? doc: {0} ??????????
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
WG_CANNOT_FIND_COLLATOR	TokenNameIdentifier	 WG  CANNOT  FIND  COLLATOR
...
WG_ONE_DEFAULT_XSLDECIMALFORMAT_ALLOWED	TokenNameIdentifier	 WG  ONE  DEFAULT  XSLDECIMALFORMAT  ALLOWED
,	TokenNameCOMMA	
"?????? xsl:decimal-format ??? 1 ?????????????"	TokenNameStringLiteral	?????? xsl:decimal-format ??? 1 ?????????????
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
WG_XSLDECIMALFORMAT_NAMES_MUST_BE_UNIQUE	TokenNameIdentifier	 WG  XSLDECIMALFORMAT  NAMES  MUST  BE  UNIQUE
...
WG_EMPTY_SECOND_ARG	TokenNameIdentifier	 WG  EMPTY  SECOND  ARG
,	TokenNameCOMMA	
"????? 2 ??????????? nodeset ??????? node-set ??????"	TokenNameStringLiteral	????? 2 ??????????? nodeset ??????? node-set ??????
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
,	TokenNameCOMMA	
" [-PARSER parser liaison ?????????]"	TokenNameStringLiteral	 [-PARSER parser liaison ?????????]
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
...
,	TokenNameCOMMA	
" [-LF (LF (??) ????????? {?????? CR/LF})]"	TokenNameStringLiteral	 [-LF (LF (??) ????????? {?????? CR/LF})]
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
"optionCR"	TokenNameStringLiteral	optionCR
,	TokenNameCOMMA	
" [-CR (CR (??) ????????? {?????? CR/LF})]"	TokenNameStringLiteral	 [-CR (CR (??) ????????? {?????? CR/LF})]
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
...
,	TokenNameCOMMA	
" [-PARAM ??? (stylesheet ??????????)]"	TokenNameStringLiteral	 [-PARAM ??? (stylesheet ??????????)]
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
...
,	TokenNameCOMMA	
" [-URIRESOLVER ?????? (URI ???????????? URIResolver)]"	TokenNameStringLiteral	 [-URIRESOLVER ?????? (URI ???????????? URIResolver)]
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
