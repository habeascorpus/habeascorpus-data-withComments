...
ER_ILLEGAL_ATTRIBUTE	TokenNameIdentifier	 ER  ILLEGAL  ATTRIBUTE
,	TokenNameCOMMA	
"{0} hat ein unzulässiges Attribut {1}."	TokenNameStringLiteral	{0} hat ein unzulässiges Attribut {1}.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_NULL_SOURCENODE_APPLYIMPORTS	TokenNameIdentifier	 ER  NULL  SOURCENODE  APPLYIMPORTS
...
ER_CANNOT_ADD	TokenNameIdentifier	 ER  CANNOT  ADD
,	TokenNameCOMMA	
"{0} kann nicht {1} hinzugefügt werden."	TokenNameStringLiteral	{0} kann nicht {1} hinzugefügt werden.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_NULL_SOURCENODE_HANDLEAPPLYTEMPLATES	TokenNameIdentifier	 ER  NULL  SOURCENODE  HANDLEAPPLYTEMPLATES
...
ER_CANT_RESOLVE_NAME_AVT	TokenNameIdentifier	 ER  CANT  RESOLVE  NAME  AVT
,	TokenNameCOMMA	
"Namensvorlage für den Attributwert in xsl:call-template konnte nicht aufgelöst werden."	TokenNameStringLiteral	Namensvorlage für den Attributwert in xsl:call-template konnte nicht aufgelöst werden.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_REQUIRES_ATTRIB	TokenNameIdentifier	 ER  REQUIRES  ATTRIB
...
ER_MUST_HAVE_TEST_ATTRIB	TokenNameIdentifier	 ER  MUST  HAVE  TEST  ATTRIB
,	TokenNameCOMMA	
"{0} muss über ein Attribut ''test'' verfügen."	TokenNameStringLiteral	{0} muss über ein Attribut ''test'' verfügen.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_BAD_VAL_ON_LEVEL_ATTRIB	TokenNameIdentifier	 ER  BAD  VAL  ON  LEVEL  ATTRIB
,	TokenNameCOMMA	
"Falscher Wert für Ebenenattribut: {0}."	TokenNameStringLiteral	Falscher Wert für Ebenenattribut: {0}.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_PROCESSINGINSTRUCTION_NAME_CANT_BE_XML	TokenNameIdentifier	 ER  PROCESSINGINSTRUCTION  NAME  CANT  BE  XML
...
ER_PROCESSINGINSTRUCTION_NOTVALID_NCNAME	TokenNameIdentifier	 ER  PROCESSINGINSTRUCTION  NOTVALID  NCNAME
,	TokenNameCOMMA	
"Name der Verarbeitungsanweisung muss ein gültiges NCName-Format haben: {0}."	TokenNameStringLiteral	Name der Verarbeitungsanweisung muss ein gültiges NCName-Format haben: {0}.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_NEED_MATCH_ATTRIB	TokenNameIdentifier	 ER  NEED  MATCH  ATTRIB
,	TokenNameCOMMA	
"{0} muss über ein entsprechendes Attribut verfügen, wenn ein Modus vorhanden ist."	TokenNameStringLiteral	{0} muss über ein entsprechendes Attribut verfügen, wenn ein Modus vorhanden ist.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_NEED_NAME_OR_MATCH_ATTRIB	TokenNameIdentifier	 ER  NEED  NAME  OR  MATCH  ATTRIB
,	TokenNameCOMMA	
"{0} erfordert einen Namen oder ein Übereinstimmungsattribut."	TokenNameStringLiteral	{0} erfordert einen Namen oder ein Übereinstimmungsattribut.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_CANT_RESOLVE_NSPREFIX	TokenNameIdentifier	 ER  CANT  RESOLVE  NSPREFIX
,	TokenNameCOMMA	
"Präfix des Namensbereichs kann nicht aufgelöst werden: {0}."	TokenNameStringLiteral	Präfix des Namensbereichs kann nicht aufgelöst werden: {0}.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_ILLEGAL_VALUE	TokenNameIdentifier	 ER  ILLEGAL  VALUE
,	TokenNameCOMMA	
"xml:space weist einen ungültigen Wert auf: {0}"	TokenNameStringLiteral	xml:space weist einen ungültigen Wert auf: {0}
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_NO_OWNERDOC	TokenNameIdentifier	 ER  NO  OWNERDOC
...
ER_NULL_CHILD	TokenNameIdentifier	 ER  NULL  CHILD
,	TokenNameCOMMA	
"Es wird versucht, ein leeres Kind hinzuzufügen!"	TokenNameStringLiteral	Es wird versucht, ein leeres Kind hinzuzufügen!
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_NEED_SELECT_ATTRIB	TokenNameIdentifier	 ER  NEED  SELECT  ATTRIB
...
ER_NEED_TEST_ATTRIB	TokenNameIdentifier	 ER  NEED  TEST  ATTRIB
,	TokenNameCOMMA	
"xsl:when muss über ein Attribut 'test' verfügen."	TokenNameStringLiteral	xsl:when muss über ein Attribut 'test' verfügen.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_NEED_NAME_ATTRIB	TokenNameIdentifier	 ER  NEED  NAME  ATTRIB
,	TokenNameCOMMA	
"xsl:with-param muss über ein Attribut 'name' verfügen."	TokenNameStringLiteral	xsl:with-param muss über ein Attribut 'name' verfügen.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_NO_CONTEXT_OWNERDOC	TokenNameIdentifier	 ER  NO  CONTEXT  OWNERDOC
,	TokenNameCOMMA	
"Der Kontextknoten verfügt nicht über ein Eignerdokument!"	TokenNameStringLiteral	Der Kontextknoten verfügt nicht über ein Eignerdokument!
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_COULD_NOT_CREATE_XML_PROC_LIAISON	TokenNameIdentifier	 ER  COULD  NOT  CREATE  XML  PROC  LIAISON
...
ER_PROCESS_NOT_SUCCESSFUL	TokenNameIdentifier	 ER  PROCESS  NOT  SUCCESSFUL
,	TokenNameCOMMA	
"Xalan:-Prozess konnte nicht erfolgreich durchgeführt werden."	TokenNameStringLiteral	Xalan:-Prozess konnte nicht erfolgreich durchgeführt werden.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_NOT_SUCCESSFUL	TokenNameIdentifier	 ER  NOT  SUCCESSFUL
...
ER_ENCODING_NOT_SUPPORTED	TokenNameIdentifier	 ER  ENCODING  NOT  SUPPORTED
,	TokenNameCOMMA	
"Verschlüsselung wird nicht unterstützt: {0}."	TokenNameStringLiteral	Verschlüsselung wird nicht unterstützt: {0}.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_COULD_NOT_CREATE_TRACELISTENER	TokenNameIdentifier	 ER  COULD  NOT  CREATE  TRACELISTENER
...
ER_BAD_STYLESHEET_URL	TokenNameIdentifier	 ER  BAD  STYLESHEET  URL
,	TokenNameCOMMA	
"Formatvorlagen-URL-Adresse ist ungültig: {0}."	TokenNameStringLiteral	Formatvorlagen-URL-Adresse ist ungültig: {0}.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_FILE_NOT_FOUND	TokenNameIdentifier	 ER  FILE  NOT  FOUND
...
ER_NO_HREF_ATTRIB	TokenNameIdentifier	 ER  NO  HREF  ATTRIB
,	TokenNameCOMMA	
"(StylesheetHandler) Attribut ''href'' für {0} konnte nicht gefunden werden."	TokenNameStringLiteral	(StylesheetHandler) Attribut ''href'' für {0} konnte nicht gefunden werden.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_STYLESHEET_INCLUDES_ITSELF	TokenNameIdentifier	 ER  STYLESHEET  INCLUDES  ITSELF
,	TokenNameCOMMA	
"(StylesheetHandler) {0} schließt sich selbst direkt oder indirekt mit ein!"	TokenNameStringLiteral	(StylesheetHandler) {0} schließt sich selbst direkt oder indirekt mit ein!
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_PROCESSINCLUDE_ERROR	TokenNameIdentifier	 ER  PROCESSINCLUDE  ERROR
...
ER_TEMPLATES_NEED_MATCH_OR_NAME_ATTRIB	TokenNameIdentifier	 ER  TEMPLATES  NEED  MATCH  OR  NAME  ATTRIB
,	TokenNameCOMMA	
"Vorlagen müssen entweder ein Attribut 'match' oder 'name' haben."	TokenNameStringLiteral	Vorlagen müssen entweder ein Attribut 'match' oder 'name' haben.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_NO_CLONE_OF_DOCUMENT_FRAG	TokenNameIdentifier	 ER  NO  CLONE  OF  DOCUMENT  FRAG
...
ER_XMLSPACE_ILLEGAL_VALUE	TokenNameIdentifier	 ER  XMLSPACE  ILLEGAL  VALUE
,	TokenNameCOMMA	
"xml:space in der Quellen-XML hat einen ungültigen Wert: {0}."	TokenNameStringLiteral	xml:space in der Quellen-XML hat einen ungültigen Wert: {0}.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_NO_XSLKEY_DECLARATION	TokenNameIdentifier	 ER  NO  XSLKEY  DECLARATION
,	TokenNameCOMMA	
"Keine Deklaration xsl:key für {0} vorhanden!"	TokenNameStringLiteral	Keine Deklaration xsl:key für {0} vorhanden!
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_CANT_CREATE_URL	TokenNameIdentifier	 ER  CANT  CREATE  URL
,	TokenNameCOMMA	
"Fehler! URL kann nicht erstellt werden für: {0}"	TokenNameStringLiteral	Fehler! URL kann nicht erstellt werden für: {0}
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_XSLFUNCTIONS_UNSUPPORTED	TokenNameIdentifier	 ER  XSLFUNCTIONS  UNSUPPORTED
,	TokenNameCOMMA	
"xsl:functions wird nicht unterstützt."	TokenNameStringLiteral	xsl:functions wird nicht unterstützt.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_PROCESSOR_ERROR	TokenNameIdentifier	 ER  PROCESSOR  ERROR
...
ER_NOT_ALLOWED_INSIDE_STYLESHEET	TokenNameIdentifier	 ER  NOT  ALLOWED  INSIDE  STYLESHEET
,	TokenNameCOMMA	
"(StylesheetHandler) {0} nicht zulässig innerhalb einer Formatvorlage!"	TokenNameStringLiteral	(StylesheetHandler) {0} nicht zulässig innerhalb einer Formatvorlage!
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_RESULTNS_NOT_SUPPORTED	TokenNameIdentifier	 ER  RESULTNS  NOT  SUPPORTED
,	TokenNameCOMMA	
"result-ns wird nicht mehr unterstützt! Verwenden Sie stattdessen xsl:output."	TokenNameStringLiteral	result-ns wird nicht mehr unterstützt! Verwenden Sie stattdessen xsl:output.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_DEFAULTSPACE_NOT_SUPPORTED	TokenNameIdentifier	 ER  DEFAULTSPACE  NOT  SUPPORTED
,	TokenNameCOMMA	
"default-space wird nicht mehr unterstützt! Verwenden Sie stattdessen xsl:strip-space oder xsl:preserve-space."	TokenNameStringLiteral	default-space wird nicht mehr unterstützt! Verwenden Sie stattdessen xsl:strip-space oder xsl:preserve-space.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_INDENTRESULT_NOT_SUPPORTED	TokenNameIdentifier	 ER  INDENTRESULT  NOT  SUPPORTED
,	TokenNameCOMMA	
"indent-result wird nicht mehr unterstützt! Verwenden Sie stattdessen xsl:output."	TokenNameStringLiteral	indent-result wird nicht mehr unterstützt! Verwenden Sie stattdessen xsl:output.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_ILLEGAL_ATTRIB	TokenNameIdentifier	 ER  ILLEGAL  ATTRIB
,	TokenNameCOMMA	
"(StylesheetHandler) {0} hat ein ungültiges Attribut: {1}."	TokenNameStringLiteral	(StylesheetHandler) {0} hat ein ungültiges Attribut: {1}.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_UNKNOWN_XSL_ELEM	TokenNameIdentifier	 ER  UNKNOWN  XSL  ELEM
...
ER_XSLWHEN_NOT_PARENTED_BY_XSLCHOOSE	TokenNameIdentifier	 ER  XSLWHEN  NOT  PARENTED  BY  XSLCHOOSE
,	TokenNameCOMMA	
"(StylesheetHandler) Für xsl:when ist xsl:choose nicht als Elter definiert!"	TokenNameStringLiteral	(StylesheetHandler) Für xsl:when ist xsl:choose nicht als Elter definiert!
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_MISPLACED_XSLOTHERWISE	TokenNameIdentifier	 ER  MISPLACED  XSLOTHERWISE
...
ER_XSLOTHERWISE_NOT_PARENTED_BY_XSLCHOOSE	TokenNameIdentifier	 ER  XSLOTHERWISE  NOT  PARENTED  BY  XSLCHOOSE
,	TokenNameCOMMA	
"(StylesheetHandler) Für xsl:otherwise ist xsl:choose nicht als Elter definiert!"	TokenNameStringLiteral	(StylesheetHandler) Für xsl:otherwise ist xsl:choose nicht als Elter definiert!
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_NOT_ALLOWED_INSIDE_TEMPLATE	TokenNameIdentifier	 ER  NOT  ALLOWED  INSIDE  TEMPLATE
,	TokenNameCOMMA	
"(StylesheetHandler) {0} ist innerhalb einer Vorlage nicht zulässig!"	TokenNameStringLiteral	(StylesheetHandler) {0} ist innerhalb einer Vorlage nicht zulässig!
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_UNKNOWN_EXT_NS_PREFIX	TokenNameIdentifier	 ER  UNKNOWN  EXT  NS  PREFIX
,	TokenNameCOMMA	
"(StylesheetHandler) {0}: Erweiterung des Namensbereichspräfixes {1} ist unbekannt"	TokenNameStringLiteral	(StylesheetHandler) {0}: Erweiterung des Namensbereichspräfixes {1} ist unbekannt
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_IMPORTS_AS_FIRST_ELEM	TokenNameIdentifier	 ER  IMPORTS  AS  FIRST  ELEM
,	TokenNameCOMMA	
"(StylesheetHandler) Importe können nur als erste Elemente in der Formatvorlage auftreten!"	TokenNameStringLiteral	(StylesheetHandler) Importe können nur als erste Elemente in der Formatvorlage auftreten!
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_IMPORTING_ITSELF	TokenNameIdentifier	 ER  IMPORTING  ITSELF
...
ER_XMLSPACE_ILLEGAL_VAL	TokenNameIdentifier	 ER  XMLSPACE  ILLEGAL  VAL
,	TokenNameCOMMA	
"(StylesheetHandler) xml:space hat einen ungültigen Wert: {0}."	TokenNameStringLiteral	(StylesheetHandler) xml:space hat einen ungültigen Wert: {0}.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_PROCESSSTYLESHEET_NOT_SUCCESSFUL	TokenNameIdentifier	 ER  PROCESSSTYLESHEET  NOT  SUCCESSFUL
...
ER_FUNCTION_NOT_SUPPORTED	TokenNameIdentifier	 ER  FUNCTION  NOT  SUPPORTED
,	TokenNameCOMMA	
"Funktion nicht unterstützt!"	TokenNameStringLiteral	Funktion nicht unterstützt!
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_XSLT_ERROR	TokenNameIdentifier	 ER  XSLT  ERROR
...
ER_CURRENCY_SIGN_ILLEGAL	TokenNameIdentifier	 ER  CURRENCY  SIGN  ILLEGAL
,	TokenNameCOMMA	
"Ein Währungssymbol ist in der Formatmusterzeichenfolge nicht zulässig."	TokenNameStringLiteral	Ein Währungssymbol ist in der Formatmusterzeichenfolge nicht zulässig.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_DOCUMENT_FUNCTION_INVALID_IN_STYLESHEET_DOM	TokenNameIdentifier	 ER  DOCUMENT  FUNCTION  INVALID  IN  STYLESHEET  DOM
,	TokenNameCOMMA	
"Eine Dokumentfunktion wird in der Dokumentobjektmodell-Formatvorlage nicht unterstützt!"	TokenNameStringLiteral	Eine Dokumentfunktion wird in der Dokumentobjektmodell-Formatvorlage nicht unterstützt!
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_CANT_RESOLVE_PREFIX_OF_NON_PREFIX_RESOLVER	TokenNameIdentifier	 ER  CANT  RESOLVE  PREFIX  OF  NON  PREFIX  RESOLVER
,	TokenNameCOMMA	
"Präfix einer Auflösung ohne Präfix kann nicht aufgelöst werden!"	TokenNameStringLiteral	Präfix einer Auflösung ohne Präfix kann nicht aufgelöst werden!
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_REDIRECT_COULDNT_GET_FILENAME	TokenNameIdentifier	 ER  REDIRECT  COULDNT  GET  FILENAME
,	TokenNameCOMMA	
"Umleitungserweiterung: Dateiname konnte nicht abgerufen werden - Datei oder Attribut 'select' muss eine gültige Zeichenfolge zurückgeben."	TokenNameStringLiteral	Umleitungserweiterung: Dateiname konnte nicht abgerufen werden - Datei oder Attribut 'select' muss eine gültige Zeichenfolge zurückgeben.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_CANNOT_BUILD_FORMATTERLISTENER_IN_REDIRECT	TokenNameIdentifier	 ER  CANNOT  BUILD  FORMATTERLISTENER  IN  REDIRECT
...
ER_INVALID_PREFIX_IN_EXCLUDERESULTPREFIX	TokenNameIdentifier	 ER  INVALID  PREFIX  IN  EXCLUDERESULTPREFIX
,	TokenNameCOMMA	
"Präfix in exclude-result-prefixes ist nicht gültig: {0}."	TokenNameStringLiteral	Präfix in exclude-result-prefixes ist nicht gültig: {0}.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_MISSING_NS_URI	TokenNameIdentifier	 ER  MISSING  NS  URI
,	TokenNameCOMMA	
"Fehlende Namensbereichs-URI für angegebenes Präfix."	TokenNameStringLiteral	Fehlende Namensbereichs-URI für angegebenes Präfix.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_MISSING_ARG_FOR_OPTION	TokenNameIdentifier	 ER  MISSING  ARG  FOR  OPTION
,	TokenNameCOMMA	
"Fehlendes Argument für Option: {0}."	TokenNameStringLiteral	Fehlendes Argument für Option: {0}.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_INVALID_OPTION	TokenNameIdentifier	 ER  INVALID  OPTION
,	TokenNameCOMMA	
"Ungültige Option: {0}"	TokenNameStringLiteral	Ungültige Option: {0}
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_MALFORMED_FORMAT_STRING	TokenNameIdentifier	 ER  MALFORMED  FORMAT  STRING
...
ER_ILLEGAL_ATTRIBUTE_VALUE	TokenNameIdentifier	 ER  ILLEGAL  ATTRIBUTE  VALUE
,	TokenNameCOMMA	
"Attribut {0} weist einen ungültigen Wert auf: {1}"	TokenNameStringLiteral	Attribut {0} weist einen ungültigen Wert auf: {1}
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_CHOOSE_REQUIRES_WHEN	TokenNameIdentifier	 ER  CHOOSE  REQUIRES  WHEN
...
ER_NO_APPLY_IMPORT_IN_FOR_EACH	TokenNameIdentifier	 ER  NO  APPLY  IMPORT  IN  FOR  EACH
,	TokenNameCOMMA	
"xsl:apply-imports ist in xsl:for-each nicht zulässig."	TokenNameStringLiteral	xsl:apply-imports ist in xsl:for-each nicht zulässig.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_CANT_USE_DTM_FOR_OUTPUT	TokenNameIdentifier	 ER  CANT  USE  DTM  FOR  OUTPUT
,	TokenNameCOMMA	
"DTMLiaison kann nicht für einen Ausgabe-Dokumentobjektmodellknoten verwendet werden... Übergeben Sie stattdessen org.apache.xpath.DOM2Helper!"	TokenNameStringLiteral	DTMLiaison kann nicht für einen Ausgabe-Dokumentobjektmodellknoten verwendet werden... Übergeben Sie stattdessen org.apache.xpath.DOM2Helper!
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_CANT_USE_DTM_FOR_INPUT	TokenNameIdentifier	 ER  CANT  USE  DTM  FOR  INPUT
,	TokenNameCOMMA	
"DTMLiaison kann nicht für einen Eingabe-Dokumentobjektmodellknoten verwendet werden... Übergeben Sie stattdessen org.apache.xpath.DOM2Helper!"	TokenNameStringLiteral	DTMLiaison kann nicht für einen Eingabe-Dokumentobjektmodellknoten verwendet werden... Übergeben Sie stattdessen org.apache.xpath.DOM2Helper!
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_CALL_TO_EXT_FAILED	TokenNameIdentifier	 ER  CALL  TO  EXT  FAILED
...
ER_PREFIX_MUST_RESOLVE	TokenNameIdentifier	 ER  PREFIX  MUST  RESOLVE
,	TokenNameCOMMA	
"Das Präfix muss in einen Namensbereich aufgelöst werden: {0}"	TokenNameStringLiteral	Das Präfix muss in einen Namensbereich aufgelöst werden: {0}
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_INVALID_UTF16_SURROGATE	TokenNameIdentifier	 ER  INVALID  UT F16  SURROGATE
,	TokenNameCOMMA	
"Ungültige UTF-16-Ersetzung festgestellt: {0} ?"	TokenNameStringLiteral	Ungültige UTF-16-Ersetzung festgestellt: {0} ?
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_XSLATTRSET_USED_ITSELF	TokenNameIdentifier	 ER  XSLATTRSET  USED  ITSELF
...
ER_INVALID_KEY_CALL	TokenNameIdentifier	 ER  INVALID  KEY  CALL
,	TokenNameCOMMA	
"Ungültiger Funktionsaufruf: rekursive Aufrufe 'key()'sind nicht zulässig."	TokenNameStringLiteral	Ungültiger Funktionsaufruf: rekursive Aufrufe 'key()'sind nicht zulässig.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_REFERENCING_ITSELF	TokenNameIdentifier	 ER  REFERENCING  ITSELF
...
ER_ILLEGAL_DOMSOURCE_INPUT	TokenNameIdentifier	 ER  ILLEGAL  DOMSOURCE  INPUT
,	TokenNameCOMMA	
"Der Eingabeknoten kann für DOMSource für newTemplates nicht Null sein!"	TokenNameStringLiteral	Der Eingabeknoten kann für DOMSource für newTemplates nicht Null sein!
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_CLASS_NOT_FOUND_FOR_OPTION	TokenNameIdentifier	 ER  CLASS  NOT  FOUND  FOR  OPTION
,	TokenNameCOMMA	
"Klassendatei für Option {0} wurde nicht gefunden."	TokenNameStringLiteral	Klassendatei für Option {0} wurde nicht gefunden.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_REQUIRED_ELEM_NOT_FOUND	TokenNameIdentifier	 ER  REQUIRED  ELEM  NOT  FOUND
...
ER_INVALID_ELEMENT_NAME	TokenNameIdentifier	 ER  INVALID  ELEMENT  NAME
,	TokenNameCOMMA	
"Ungültiger Elementname angegeben {0}."	TokenNameStringLiteral	Ungültiger Elementname angegeben {0}.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_ELEMENT_NAME_METHOD_STATIC	TokenNameIdentifier	 ER  ELEMENT  NAME  METHOD  STATIC
...
ER_MORE_MATCH_CONSTRUCTOR	TokenNameIdentifier	 ER  MORE  MATCH  CONSTRUCTOR
,	TokenNameCOMMA	
"Mehrere passende Entsprechungen für Konstruktor für {0}."	TokenNameStringLiteral	Mehrere passende Entsprechungen für Konstruktor für {0}.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_MORE_MATCH_METHOD	TokenNameIdentifier	 ER  MORE  MATCH  METHOD
,	TokenNameCOMMA	
"Mehrere passende Entsprechungen für Methode {0}."	TokenNameStringLiteral	Mehrere passende Entsprechungen für Methode {0}.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_MORE_MATCH_ELEMENT	TokenNameIdentifier	 ER  MORE  MATCH  ELEMENT
,	TokenNameCOMMA	
"Mehrere passende Entsprechungen für Elementmethode {0}."	TokenNameStringLiteral	Mehrere passende Entsprechungen für Elementmethode {0}.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_INVALID_CONTEXT_PASSED	TokenNameIdentifier	 ER  INVALID  CONTEXT  PASSED
,	TokenNameCOMMA	
"Ungültiger Kontext zur Auswertung von {0} übergeben."	TokenNameStringLiteral	Ungültiger Kontext zur Auswertung von {0} übergeben.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_POOL_EXISTS	TokenNameIdentifier	 ER  POOL  EXISTS
...
ER_POOL_SIZE_LESSTHAN_ONE	TokenNameIdentifier	 ER  POOL  SIZE  LESSTHAN  ONE
,	TokenNameCOMMA	
"Poolgröße ist kleiner als Eins!"	TokenNameStringLiteral	Poolgröße ist kleiner als Eins!
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_INVALID_DRIVER	TokenNameIdentifier	 ER  INVALID  DRIVER
,	TokenNameCOMMA	
"Ungültiger Treibername angegeben!"	TokenNameStringLiteral	Ungültiger Treibername angegeben!
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_NO_STYLESHEETROOT	TokenNameIdentifier	 ER  NO  STYLESHEETROOT
...
ER_ILLEGAL_XMLSPACE_VALUE	TokenNameIdentifier	 ER  ILLEGAL  XMLSPACE  VALUE
,	TokenNameCOMMA	
"Ungültiger Wert für xml:space"	TokenNameStringLiteral	Ungültiger Wert für xml:space
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_PROCESSFROMNODE_FAILED	TokenNameIdentifier	 ER  PROCESSFROMNODE  FAILED
...
ER_BUFFER_SIZE_LESSTHAN_ZERO	TokenNameIdentifier	 ER  BUFFER  SIZE  LESSTHAN  ZERO
,	TokenNameCOMMA	
"Puffergröße <=0"	TokenNameStringLiteral	Puffergröße <=0
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_UNKNOWN_ERROR_CALLING_EXTENSION	TokenNameIdentifier	 ER  UNKNOWN  ERROR  CALLING  EXTENSION
...
ER_NO_NAMESPACE_DECL	TokenNameIdentifier	 ER  NO  NAMESPACE  DECL
,	TokenNameCOMMA	
"Präfix {0} hat keine entsprechende Namensbereichsdeklaration."	TokenNameStringLiteral	Präfix {0} hat keine entsprechende Namensbereichsdeklaration.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_ELEM_CONTENT_NOT_ALLOWED	TokenNameIdentifier	 ER  ELEM  CONTENT  NOT  ALLOWED
,	TokenNameCOMMA	
"Elementinhalt nicht zulässig für lang=javaclass {0}."	TokenNameStringLiteral	Elementinhalt nicht zulässig für lang=javaclass {0}.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_STYLESHEET_DIRECTED_TERMINATION	TokenNameIdentifier	 ER  STYLESHEET  DIRECTED  TERMINATION
,	TokenNameCOMMA	
"Formatvorlage hat die Beendigung übertragen."	TokenNameStringLiteral	Formatvorlage hat die Beendigung übertragen.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_ONE_OR_TWO	TokenNameIdentifier	 ER  ONE  OR  TWO
...
ER_COULD_NOT_LOAD_RESOURCE	TokenNameIdentifier	 ER  COULD  NOT  LOAD  RESOURCE
,	TokenNameCOMMA	
"{0} (CLASSPATH prüfen) konnte nicht geladen werden; es werden die Standardwerte verwendet."	TokenNameStringLiteral	{0} (CLASSPATH prüfen) konnte nicht geladen werden; es werden die Standardwerte verwendet.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_CANNOT_INIT_DEFAULT_TEMPLATES	TokenNameIdentifier	 ER  CANNOT  INIT  DEFAULT  TEMPLATES
,	TokenNameCOMMA	
"Standardvorlagen können nicht initialisiert werden."	TokenNameStringLiteral	Standardvorlagen können nicht initialisiert werden.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_RESULT_NULL	TokenNameIdentifier	 ER  RESULT  NULL
...
ER_CANNOT_TRANSFORM_TO_RESULT_TYPE	TokenNameIdentifier	 ER  CANNOT  TRANSFORM  TO  RESULT  TYPE
,	TokenNameCOMMA	
"Umsetzen in ein Ergebnis des Typs {0} ist nicht möglich"	TokenNameStringLiteral	Umsetzen in ein Ergebnis des Typs {0} ist nicht möglich
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_CANNOT_TRANSFORM_SOURCE_TYPE	TokenNameIdentifier	 ER  CANNOT  TRANSFORM  SOURCE  TYPE
,	TokenNameCOMMA	
"Umsetzen einer Quelle des Typs {0} ist nicht möglich"	TokenNameStringLiteral	Umsetzen einer Quelle des Typs {0} ist nicht möglich
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_NULL_CONTENT_HANDLER	TokenNameIdentifier	 ER  NULL  CONTENT  HANDLER
...
ER_NO_PARENT_FOR_FILTER	TokenNameIdentifier	 ER  NO  PARENT  FOR  FILTER
,	TokenNameCOMMA	
"Kein Elter für Filter vorhanden"	TokenNameStringLiteral	Kein Elter für Filter vorhanden
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_NO_STYLESHEET_IN_MEDIA	TokenNameIdentifier	 ER  NO  STYLESHEET  IN  MEDIA
,	TokenNameCOMMA	
"Keine Formatvorlage gefunden in: {0}, Datenträger= {1}."	TokenNameStringLiteral	Keine Formatvorlage gefunden in: {0}, Datenträger= {1}.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_NO_STYLESHEET_PI	TokenNameIdentifier	 ER  NO  STYLESHEET  PI
,	TokenNameCOMMA	
"Keine Verarbeitungsanweisung für xml-stylesheet gefunden in {0}."	TokenNameStringLiteral	Keine Verarbeitungsanweisung für xml-stylesheet gefunden in {0}.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_NOT_SUPPORTED	TokenNameIdentifier	 ER  NOT  SUPPORTED
,	TokenNameCOMMA	
"Nicht unterstützt: {0}"	TokenNameStringLiteral	Nicht unterstützt: {0}
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_PROPERTY_VALUE_BOOLEAN	TokenNameIdentifier	 ER  PROPERTY  VALUE  BOOLEAN
,	TokenNameCOMMA	
"Der Wert für Merkmal {0} sollte eine Boolesche Instanz sein."	TokenNameStringLiteral	Der Wert für Merkmal {0} sollte eine Boolesche Instanz sein.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_COULD_NOT_FIND_EXTERN_SCRIPT	TokenNameIdentifier	 ER  COULD  NOT  FIND  EXTERN  SCRIPT
...
ER_VALUE_SHOULD_BE_NUMBER	TokenNameIdentifier	 ER  VALUE  SHOULD  BE  NUMBER
,	TokenNameCOMMA	
"Der Wert für {0} sollte eine syntaktisch analysierbare Zahl sein."	TokenNameStringLiteral	Der Wert für {0} sollte eine syntaktisch analysierbare Zahl sein.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_VALUE_SHOULD_EQUAL	TokenNameIdentifier	 ER  VALUE  SHOULD  EQUAL
,	TokenNameCOMMA	
"Der Wert für {0} sollte ''''yes'''' oder ''''no'''' entsprechen."	TokenNameStringLiteral	Der Wert für {0} sollte ''''yes'''' oder ''''no'''' entsprechen.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_FAILED_CALLING_METHOD	TokenNameIdentifier	 ER  FAILED  CALLING  METHOD
...
ER_CHARS_NOT_ALLOWED	TokenNameIdentifier	 ER  CHARS  NOT  ALLOWED
,	TokenNameCOMMA	
"Zeichen sind an dieser Stelle im Dokument nicht zulässig."	TokenNameStringLiteral	Zeichen sind an dieser Stelle im Dokument nicht zulässig.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_ATTR_NOT_ALLOWED	TokenNameIdentifier	 ER  ATTR  NOT  ALLOWED
,	TokenNameCOMMA	
"Das Attribut "{0}" ist im Element {1} nicht zulässig!"	TokenNameStringLiteral	Das Attribut "{0}" ist im Element {1} nicht zulässig!
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_BAD_VALUE	TokenNameIdentifier	 ER  BAD  VALUE
,	TokenNameCOMMA	
"{0} ungültiger Wert {1} "	TokenNameStringLiteral	{0} ungültiger Wert {1} 
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_ATTRIB_VALUE_NOT_FOUND	TokenNameIdentifier	 ER  ATTRIB  VALUE  NOT  FOUND
...
ER_NULL_URI_NAMESPACE	TokenNameIdentifier	 ER  NULL  URI  NAMESPACE
,	TokenNameCOMMA	
"Es wird versucht, ein Namensbereichspräfix mit einer Null-URI zu erzeugen."	TokenNameStringLiteral	Es wird versucht, ein Namensbereichspräfix mit einer Null-URI zu erzeugen.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
ER_NUMBER_TOO_BIG	TokenNameIdentifier	 ER  NUMBER  TOO  BIG
,	TokenNameCOMMA	
"Es wird versucht, eine größere Zahl als die größte erweiterte Ganzzahl zu formatieren."	TokenNameStringLiteral	Es wird versucht, eine größere Zahl als die größte erweiterte Ganzzahl zu formatieren.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_CANNOT_FIND_SAX1_DRIVER	TokenNameIdentifier	 ER  CANNOT  FIND  SA X1  DRIVER
...
ER_NULL_ENTITY_RESOLVER	TokenNameIdentifier	 ER  NULL  ENTITY  RESOLVER
,	TokenNameCOMMA	
"Es ist keine Entitätenauflösungsroutine vorhanden."	TokenNameStringLiteral	Es ist keine Entitätenauflösungsroutine vorhanden.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_NULL_DTD_HANDLER	TokenNameIdentifier	 ER  NULL  DTD  HANDLER
,	TokenNameCOMMA	
"Es ist keine Steuerroutine für Dokumenttypbeschreibungen vorhanden."	TokenNameStringLiteral	Es ist keine Steuerroutine für Dokumenttypbeschreibungen vorhanden.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_NO_DRIVER_NAME_SPECIFIED	TokenNameIdentifier	 ER  NO  DRIVER  NAME  SPECIFIED
...
ER_POOLSIZE_LESS_THAN_ONE	TokenNameIdentifier	 ER  POOLSIZE  LESS  THAN  ONE
,	TokenNameCOMMA	
"Poolgröße ist kleiner als 1!"	TokenNameStringLiteral	Poolgröße ist kleiner als 1!
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_INVALID_DRIVER_NAME	TokenNameIdentifier	 ER  INVALID  DRIVER  NAME
...
ER_ASSERT_NO_TEMPLATE_PARENT	TokenNameIdentifier	 ER  ASSERT  NO  TEMPLATE  PARENT
,	TokenNameCOMMA	
"Programmierfehler! Der Ausdruck hat kein übergeordnetes Element ElemTemplateElement!"	TokenNameStringLiteral	Programmierfehler! Der Ausdruck hat kein übergeordnetes Element ElemTemplateElement!
}	TokenNameRBRACE	
,	TokenNameCOMMA	
// Note to translators: The following message should not normally be displayed 	TokenNameCOMMENT_LINE	Note to translators: The following message should not normally be displayed 
// to users. It describes a situation in which the processor has detected 	TokenNameCOMMENT_LINE	to users. It describes a situation in which the processor has detected 
...
ER_NOT_ALLOWED_IN_POSITION	TokenNameIdentifier	 ER  NOT  ALLOWED  IN  POSITION
,	TokenNameCOMMA	
"{0} ist an dieser Position in der Formatvorlage nicht zulässig!"	TokenNameStringLiteral	{0} ist an dieser Position in der Formatvorlage nicht zulässig!
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_NONWHITESPACE_NOT_ALLOWED_IN_POSITION	TokenNameIdentifier	 ER  NONWHITESPACE  NOT  ALLOWED  IN  POSITION
,	TokenNameCOMMA	
"Anderer Text als Leerzeichen ist an dieser Position in der Formatvorlage nicht zulässig!"	TokenNameStringLiteral	Anderer Text als Leerzeichen ist an dieser Position in der Formatvorlage nicht zulässig!
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
INVALID_TCHAR	TokenNameIdentifier	 INVALID  TCHAR
,	TokenNameCOMMA	
"Unzulässiger Wert {1} für CHAR-Attribut verwendet: {0}. Ein Attribut des Typs CHAR darf nur ein Zeichen umfassen!"	TokenNameStringLiteral	Unzulässiger Wert {1} für CHAR-Attribut verwendet: {0}. Ein Attribut des Typs CHAR darf nur ein Zeichen umfassen!
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
INVALID_QNAME	TokenNameIdentifier	 INVALID  QNAME
,	TokenNameCOMMA	
"Unzulässiger Wert {1} für QNAME-Attribut verwendet: {0}"	TokenNameStringLiteral	Unzulässiger Wert {1} für QNAME-Attribut verwendet: {0}
}	TokenNameRBRACE	
,	TokenNameCOMMA	
// Note to translators: The following message is used if the value of 	TokenNameCOMMENT_LINE	Note to translators: The following message is used if the value of 
...
INVALID_ENUM	TokenNameIdentifier	 INVALID  ENUM
,	TokenNameCOMMA	
"Unzulässiger Wert {1} für ENUM-Attribut verwendet: {0}. Folgende Werte sind gültig: {2}."	TokenNameStringLiteral	Unzulässiger Wert {1} für ENUM-Attribut verwendet: {0}. Folgende Werte sind gültig: {2}.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
// Note to translators: The following message is used if the value of 	TokenNameCOMMENT_LINE	Note to translators: The following message is used if the value of 
...
INVALID_NMTOKEN	TokenNameIdentifier	 INVALID  NMTOKEN
,	TokenNameCOMMA	
"Unzulässiger Wert {1} für NMTOKEN-Attribut verwendet: {0}. "	TokenNameStringLiteral	Unzulässiger Wert {1} für NMTOKEN-Attribut verwendet: {0}. 
}	TokenNameRBRACE	
,	TokenNameCOMMA	
// Note to translators: The following message is used if the value of 	TokenNameCOMMENT_LINE	Note to translators: The following message is used if the value of 
...
INVALID_NCNAME	TokenNameIdentifier	 INVALID  NCNAME
,	TokenNameCOMMA	
"Unzulässiger Wert {1} für NCNAME-Attribut verwendet: {0}. "	TokenNameStringLiteral	Unzulässiger Wert {1} für NCNAME-Attribut verwendet: {0}. 
}	TokenNameRBRACE	
,	TokenNameCOMMA	
// Note to translators: The following message is used if the value of 	TokenNameCOMMENT_LINE	Note to translators: The following message is used if the value of 
...
INVALID_BOOLEAN	TokenNameIdentifier	 INVALID  BOOLEAN
,	TokenNameCOMMA	
"Unzulässiger Wert {1} für BOOLEAN-Attribut verwendet: {0}. "	TokenNameStringLiteral	Unzulässiger Wert {1} für BOOLEAN-Attribut verwendet: {0}. 
}	TokenNameRBRACE	
,	TokenNameCOMMA	
// Note to translators: The following message is used if the value of 	TokenNameCOMMENT_LINE	Note to translators: The following message is used if the value of 
...
INVALID_NUMBER	TokenNameIdentifier	 INVALID  NUMBER
,	TokenNameCOMMA	
"Unzulässiger Wert {1} für NUMBER-Attribut verwendet: {0}. "	TokenNameStringLiteral	Unzulässiger Wert {1} für NUMBER-Attribut verwendet: {0}. 
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
ER_CANT_HAVE_CONTENT_AND_SELECT	TokenNameIdentifier	 ER  CANT  HAVE  CONTENT  AND  SELECT
,	TokenNameCOMMA	
"Das Element {0} darf nicht über ein Attribut ''''content'''' und zusätzlich über ein Attribut ''''select'''' verfügen."	TokenNameStringLiteral	Das Element {0} darf nicht über ein Attribut ''''content'''' und zusätzlich über ein Attribut ''''select'''' verfügen.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
ER_INVALID_SET_PARAM_VALUE	TokenNameIdentifier	 ER  INVALID  SET  PARAM  VALUE
,	TokenNameCOMMA	
"Der Wert von Parameter {0} muss ein gültiges Java-Objekt sein."	TokenNameStringLiteral	Der Wert von Parameter {0} muss ein gültiges Java-Objekt sein.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_INVALID_NAMESPACE_URI_VALUE_FOR_RESULT_PREFIX_FOR_DEFAULT	TokenNameIdentifier	 ER  INVALID  NAMESPACE  URI  VALUE  FOR  RESULT  PREFIX  FOR  DEFAULT
,	TokenNameCOMMA	
"Das Attribut result-prefix eines Elements xsl:namespace-alias hat den Wert '#default', es ist jedoch keine Deklaration des Standardnamensbereichs vorhanden, die für dieses Element gültig ist."	TokenNameStringLiteral	Das Attribut result-prefix eines Elements xsl:namespace-alias hat den Wert '#default', es ist jedoch keine Deklaration des Standardnamensbereichs vorhanden, die für dieses Element gültig ist.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_INVALID_NAMESPACE_URI_VALUE_FOR_RESULT_PREFIX	TokenNameIdentifier	 ER  INVALID  NAMESPACE  URI  VALUE  FOR  RESULT  PREFIX
...
ER_NAMESPACE_CONTEXT_NULL_NAMESPACE	TokenNameIdentifier	 ER  NAMESPACE  CONTEXT  NULL  NAMESPACE
,	TokenNameCOMMA	
"Das Präfix für einen Namensbereich-URI mit dem Wert Null kann nicht abgerufen werden."	TokenNameStringLiteral	Das Präfix für einen Namensbereich-URI mit dem Wert Null kann nicht abgerufen werden.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_NAMESPACE_CONTEXT_NULL_PREFIX	TokenNameIdentifier	 ER  NAMESPACE  CONTEXT  NULL  PREFIX
,	TokenNameCOMMA	
"Der Namensbereich-URI für ein Präfix mit dem Wert Null kann nicht abgerufen werden."	TokenNameStringLiteral	Der Namensbereich-URI für ein Präfix mit dem Wert Null kann nicht abgerufen werden.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_XPATH_RESOLVER_NULL_QNAME	TokenNameIdentifier	 ER  XPATH  RESOLVER  NULL  QNAME
...
WG_FOUND_CURLYBRACE	TokenNameIdentifier	 WG  FOUND  CURLYBRACE
,	TokenNameCOMMA	
"'}' gefunden, es ist aber keine Attributvorlage geöffnet!"	TokenNameStringLiteral	'}' gefunden, es ist aber keine Attributvorlage geöffnet!
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
WG_COUNT_ATTRIB_MATCHES_NO_ANCESTOR	TokenNameIdentifier	 WG  COUNT  ATTRIB  MATCHES  NO  ANCESTOR
,	TokenNameCOMMA	
"Warnung: Attribut ''count'' entspricht keinem übergeordneten Fensterobjekt in xsl:number! Ziel = {0}"	TokenNameStringLiteral	Warnung: Attribut ''count'' entspricht keinem übergeordneten Fensterobjekt in xsl:number! Ziel = {0}
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
WG_EXPR_ATTRIB_CHANGED_TO_SELECT	TokenNameIdentifier	 WG  EXPR  ATTRIB  CHANGED  TO  SELECT
,	TokenNameCOMMA	
"Veraltete Syntax: Der Name des Attributs 'expr' wurde in 'select' geändert."	TokenNameStringLiteral	Veraltete Syntax: Der Name des Attributs 'expr' wurde in 'select' geändert.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
WG_NO_LOCALE_IN_FORMATNUMBER	TokenNameIdentifier	 WG  NO  LOCALE  IN  FORMATNUMBER
,	TokenNameCOMMA	
"Xalan bearbeitet noch nicht den Ländereinstellungsnamen in der Funktion 'format-number'."	TokenNameStringLiteral	Xalan bearbeitet noch nicht den Ländereinstellungsnamen in der Funktion 'format-number'.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
WG_LOCALE_NOT_FOUND	TokenNameIdentifier	 WG  LOCALE  NOT  FOUND
,	TokenNameCOMMA	
"Warnung: Ländereinstellung für xml:lang={0} konnte nicht gefunden werden."	TokenNameStringLiteral	Warnung: Ländereinstellung für xml:lang={0} konnte nicht gefunden werden.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
WG_CANNOT_MAKE_URL_FROM	TokenNameIdentifier	 WG  CANNOT  MAKE  URL  FROM
...
WG_CANNOT_FIND_COLLATOR	TokenNameIdentifier	 WG  CANNOT  FIND  COLLATOR
,	TokenNameCOMMA	
"Collator für <sort xml:lang={0} konnte nicht gefunden werden."	TokenNameStringLiteral	Collator für <sort xml:lang={0} konnte nicht gefunden werden.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
WG_FUNCTIONS_SHOULD_USE_URL	TokenNameIdentifier	 WG  FUNCTIONS  SHOULD  USE  URL
...
WG_ENCODING_NOT_SUPPORTED_USING_UTF8	TokenNameIdentifier	 WG  ENCODING  NOT  SUPPORTED  USING  UT F8
,	TokenNameCOMMA	
"Verschlüsselung nicht unterstützt: {0}, UTF-8 wird verwendet."	TokenNameStringLiteral	Verschlüsselung nicht unterstützt: {0}, UTF-8 wird verwendet.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
WG_ENCODING_NOT_SUPPORTED_USING_JAVA	TokenNameIdentifier	 WG  ENCODING  NOT  SUPPORTED  USING  JAVA
,	TokenNameCOMMA	
"Verschlüsselung nicht unterstützt: {0}, Java {1} wird verwendet."	TokenNameStringLiteral	Verschlüsselung nicht unterstützt: {0}, Java {1} wird verwendet.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
WG_SPECIFICITY_CONFLICTS	TokenNameIdentifier	 WG  SPECIFICITY  CONFLICTS
...
WG_CONFLICT_BETWEEN_XSLSTRIPSPACE_AND_XSLPRESERVESPACE	TokenNameIdentifier	 WG  CONFLICT  BETWEEN  XSLSTRIPSPACE  AND  XSLPRESERVESPACE
,	TokenNameCOMMA	
"Übereinstimmungskonflikt zwischen xsl:strip-space und xsl:preserve-space"	TokenNameStringLiteral	Übereinstimmungskonflikt zwischen xsl:strip-space und xsl:preserve-space
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
WG_ATTRIB_NOT_HANDLED	TokenNameIdentifier	 WG  ATTRIB  NOT  HANDLED
...
WG_NO_DECIMALFORMAT_DECLARATION	TokenNameIdentifier	 WG  NO  DECIMALFORMAT  DECLARATION
,	TokenNameCOMMA	
"Keine Deklaration für Dezimalformat gefunden: {0}"	TokenNameStringLiteral	Keine Deklaration für Dezimalformat gefunden: {0}
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
WG_OLD_XSLT_NS	TokenNameIdentifier	 WG  OLD  XSLT  NS
,	TokenNameCOMMA	
"Fehlender oder ungültiger XSLT-Namensbereich "	TokenNameStringLiteral	Fehlender oder ungültiger XSLT-Namensbereich 
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
WG_ONE_DEFAULT_XSLDECIMALFORMAT_ALLOWED	TokenNameIdentifier	 WG  ONE  DEFAULT  XSLDECIMALFORMAT  ALLOWED
,	TokenNameCOMMA	
"Nur eine Standarddeklaration xsl:decimal-format ist zulässig."	TokenNameStringLiteral	Nur eine Standarddeklaration xsl:decimal-format ist zulässig.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
WG_XSLDECIMALFORMAT_NAMES_MUST_BE_UNIQUE	TokenNameIdentifier	 WG  XSLDECIMALFORMAT  NAMES  MUST  BE  UNIQUE
,	TokenNameCOMMA	
"Namen in xsl:decimal-format müssen eindeutig sein. Name "{0}" wurde dupliziert."	TokenNameStringLiteral	Namen in xsl:decimal-format müssen eindeutig sein. Name "{0}" wurde dupliziert.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
WG_ILLEGAL_ATTRIBUTE	TokenNameIdentifier	 WG  ILLEGAL  ATTRIBUTE
...
WG_COULD_NOT_RESOLVE_PREFIX	TokenNameIdentifier	 WG  COULD  NOT  RESOLVE  PREFIX
,	TokenNameCOMMA	
"Namensbereichspräfix konnte nicht aufgelöst werden: {0}. Der Knoten wird ignoriert."	TokenNameStringLiteral	Namensbereichspräfix konnte nicht aufgelöst werden: {0}. Der Knoten wird ignoriert.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
WG_STYLESHEET_REQUIRES_VERSION_ATTRIB	TokenNameIdentifier	 WG  STYLESHEET  REQUIRES  VERSION  ATTRIB
...
WG_ILLEGAL_ATTRIBUTE_NAME	TokenNameIdentifier	 WG  ILLEGAL  ATTRIBUTE  NAME
,	TokenNameCOMMA	
"Unzulässiger Attributname: {0}"	TokenNameStringLiteral	Unzulässiger Attributname: {0}
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
WG_ILLEGAL_ATTRIBUTE_VALUE	TokenNameIdentifier	 WG  ILLEGAL  ATTRIBUTE  VALUE
,	TokenNameCOMMA	
"Unzulässiger Wert für Attribut {0} verwendet: {1}"	TokenNameStringLiteral	Unzulässiger Wert für Attribut {0} verwendet: {1}
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
WG_EMPTY_SECOND_ARG	TokenNameIdentifier	 WG  EMPTY  SECOND  ARG
,	TokenNameCOMMA	
"Die Ergebnisknoteneinstellung des zweiten Arguments der Dokumentfunktion ist leer. Geben Sie eine leere Knotengruppe zurück."	TokenNameStringLiteral	Die Ergebnisknoteneinstellung des zweiten Arguments der Dokumentfunktion ist leer. Geben Sie eine leere Knotengruppe zurück.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
WG_PROCESSINGINSTRUCTION_NOTVALID_NCNAME	TokenNameIdentifier	 WG  PROCESSINGINSTRUCTION  NOTVALID  NCNAME
,	TokenNameCOMMA	
"Der Wert des Attributs ''name'' von xsl:processing-instruction muss ein gültiger NCName sein: {0}"	TokenNameStringLiteral	Der Wert des Attributs ''name'' von xsl:processing-instruction muss ein gültiger NCName sein: {0}
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
WG_ILLEGAL_ATTRIBUTE_POSITION	TokenNameIdentifier	 WG  ILLEGAL  ATTRIBUTE  POSITION
,	TokenNameCOMMA	
"Attribut {0} kann nicht nach Kindknoten oder vor dem Erstellen eines Elements hinzugefügt werden. Das Attribut wird ignoriert."	TokenNameStringLiteral	Attribut {0} kann nicht nach Kindknoten oder vor dem Erstellen eines Elements hinzugefügt werden. Das Attribut wird ignoriert.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
NO_MODIFICATION_ALLOWED_ERR	TokenNameIdentifier	 NO  MODIFICATION  ALLOWED  ERR
,	TokenNameCOMMA	
"Es wurde versucht, ein Objekt an einer nicht zulässigen Stelle zu ändern."	TokenNameStringLiteral	Es wurde versucht, ein Objekt an einer nicht zulässigen Stelle zu ändern.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
,	TokenNameCOMMA	
"Der Parameter für createMessage lag außerhalb des gültigen Bereichs"	TokenNameStringLiteral	Der Parameter für createMessage lag außerhalb des gültigen Bereichs
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
"FORMAT_FAILED"	TokenNameStringLiteral	FORMAT_FAILED
,	TokenNameCOMMA	
"Während des Aufrufs von messageFormat wurde eine Ausnahmebedingung ausgelöst"	TokenNameStringLiteral	Während des Aufrufs von messageFormat wurde eine Ausnahmebedingung ausgelöst
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
...
,	TokenNameCOMMA	
"Optionen für Verarbeitungsklassen in der Xalan-J-Befehlszeile:"	TokenNameStringLiteral	Optionen für Verarbeitungsklassen in der Xalan-J-Befehlszeile:
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
"xslProc_option"	TokenNameStringLiteral	xslProc_option
...
,	TokenNameCOMMA	
"Die Option {0} wird im XSLTC-Modus nicht unterstützt."	TokenNameStringLiteral	Die Option {0} wird im XSLTC-Modus nicht unterstützt.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
...
,	TokenNameCOMMA	
"Fehler: Es wurde keine Formatvorlagen- oder Eingabe-XML angegeben. Führen Sie diesen Befehl ohne Optionen für Syntaxanweisungen aus."	TokenNameStringLiteral	Fehler: Es wurde keine Formatvorlagen- oder Eingabe-XML angegeben. Führen Sie diesen Befehl ohne Optionen für Syntaxanweisungen aus.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
...
,	TokenNameCOMMA	
"-Optionen für Xalan-"	TokenNameStringLiteral	-Optionen für Xalan-
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
"xslProc_xsltc_options"	TokenNameStringLiteral	xslProc_xsltc_options
,	TokenNameCOMMA	
"-Optionen für XSLTC-"	TokenNameStringLiteral	-Optionen für XSLTC-
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
"xslProc_return_to_continue"	TokenNameStringLiteral	xslProc_return_to_continue
,	TokenNameCOMMA	
"(Drücken Sie die Eingabetaste, um fortzufahren.)"	TokenNameStringLiteral	(Drücken Sie die Eingabetaste, um fortzufahren.)
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
,	TokenNameCOMMA	
"[-XSLTC (XSLTC für Umsetzung verwenden)]"	TokenNameStringLiteral	[-XSLTC (XSLTC für Umsetzung verwenden)]
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
...
,	TokenNameCOMMA	
"[-PARSER vollständig qualifizierter Klassenname der Parser-Liaison]"	TokenNameStringLiteral	[-PARSER vollständig qualifizierter Klassenname der Parser-Liaison]
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
"optionE"	TokenNameStringLiteral	optionE
,	TokenNameCOMMA	
"[-E (Entitätenverweise nicht erweitern)]"	TokenNameStringLiteral	[-E (Entitätenverweise nicht erweitern)]
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
...
,	TokenNameCOMMA	
"[-QC (Unterdrückte Musterkonfliktwarnungen)]"	TokenNameStringLiteral	[-QC (Unterdrückte Musterkonfliktwarnungen)]
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
"optionQ"	TokenNameStringLiteral	optionQ
,	TokenNameCOMMA	
"[-Q (Unterdrückter Modus)]"	TokenNameStringLiteral	[-Q (Unterdrückter Modus)]
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
...
,	TokenNameCOMMA	
"[-ESCAPE (Zeichen, die mit einem Escapezeichen angegeben werden müssen {Standardeinstellung ist <>&"'\r\n}]"	TokenNameStringLiteral	[-ESCAPE (Zeichen, die mit einem Escapezeichen angegeben werden müssen {Standardeinstellung ist <>&"'\r\n}]
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
"optionINDENT"	TokenNameStringLiteral	optionINDENT
,	TokenNameCOMMA	
"[-INDENT (Steuerung, um wie viele Leerzeichen eingerückt werden soll {Standardeinstellung ist 0})]"	TokenNameStringLiteral	[-INDENT (Steuerung, um wie viele Leerzeichen eingerückt werden soll {Standardeinstellung ist 0})]
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
"optionTT"	TokenNameStringLiteral	optionTT
,	TokenNameCOMMA	
"[-TT (Trace für Vorlagen ausführen, wenn sie aufgerufen werden.)]"	TokenNameStringLiteral	[-TT (Trace für Vorlagen ausführen, wenn sie aufgerufen werden.)]
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
"optionTG"	TokenNameStringLiteral	optionTG
,	TokenNameCOMMA	
"[-TG (Trace für jedes Generierungsereignis durchführen.)]"	TokenNameStringLiteral	[-TG (Trace für jedes Generierungsereignis durchführen.)]
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
"optionTS"	TokenNameStringLiteral	optionTS
,	TokenNameCOMMA	
"[-TS (Trace für jedes Auswahlereignis durchführen.)]"	TokenNameStringLiteral	[-TS (Trace für jedes Auswahlereignis durchführen.)]
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
"optionTTC"	TokenNameStringLiteral	optionTTC
,	TokenNameCOMMA	
"[-TTC (Trace für die untergeordneten Vorlagen ausführen, wenn sie verarbeitet werden.)]"	TokenNameStringLiteral	[-TTC (Trace für die untergeordneten Vorlagen ausführen, wenn sie verarbeitet werden.)]
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
"optionTCLASS"	TokenNameStringLiteral	optionTCLASS
,	TokenNameCOMMA	
"[-TCLASS (TraceListener-Klasse für Trace-Erweiterungen.)]"	TokenNameStringLiteral	[-TCLASS (TraceListener-Klasse für Trace-Erweiterungen.)]
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
"optionVALIDATE"	TokenNameStringLiteral	optionVALIDATE
,	TokenNameCOMMA	
"[-VALIDATE (Festlegen, ob eine Gültigkeitsprüfung erfolgen soll. Die Gültigkeitsprüfung ist standardmäßig ausgeschaltet.)]"	TokenNameStringLiteral	[-VALIDATE (Festlegen, ob eine Gültigkeitsprüfung erfolgen soll. Die Gültigkeitsprüfung ist standardmäßig ausgeschaltet.)]
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
...
,	TokenNameCOMMA	
"[-XML (XML-Formatierungsprogramm verwenden und XML-Header hinzufügen.)]"	TokenNameStringLiteral	[-XML (XML-Formatierungsprogramm verwenden und XML-Header hinzufügen.)]
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
...
,	TokenNameCOMMA	
"XSL-Prozess konnte nicht erfolgreich durchgeführt werden."	TokenNameStringLiteral	XSL-Prozess konnte nicht erfolgreich durchgeführt werden.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
...
,	TokenNameCOMMA	
"Bitte überprüfen Sie den Klassenpfad."	TokenNameStringLiteral	Bitte überprüfen Sie den Klassenpfad.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
"noParsermsg4"	TokenNameStringLiteral	noParsermsg4
,	TokenNameCOMMA	
"Wenn Sie nicht über einen IBM XML-Parser für Java verfügen, können Sie ihn herunterladen:"	TokenNameStringLiteral	Wenn Sie nicht über einen IBM XML-Parser für Java verfügen, können Sie ihn herunterladen:
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
...
,	TokenNameCOMMA	
"[-URIRESOLVER vollständiger Klassenname (URIResolver wird zum Auflösen von URIs verwendet)]"	TokenNameStringLiteral	[-URIRESOLVER vollständiger Klassenname (URIResolver wird zum Auflösen von URIs verwendet)]
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
"optionENTITYRESOLVER"	TokenNameStringLiteral	optionENTITYRESOLVER
,	TokenNameCOMMA	
"[-ENTITYRESOLVER vollständiger Klassenname (EntityResolver wird zum Auflösen von Entitäten verwendet)]"	TokenNameStringLiteral	[-ENTITYRESOLVER vollständiger Klassenname (EntityResolver wird zum Auflösen von Entitäten verwendet)]
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
"optionCONTENTHANDLER"	TokenNameStringLiteral	optionCONTENTHANDLER
,	TokenNameCOMMA	
"[-CONTENTHANDLER vollständiger Klassenname (ContentHandler wird zum Serialisieren der Ausgabe verwendet)]"	TokenNameStringLiteral	[-CONTENTHANDLER vollständiger Klassenname (ContentHandler wird zum Serialisieren der Ausgabe verwendet)]
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
"optionLINENUMBERS"	TokenNameStringLiteral	optionLINENUMBERS
,	TokenNameCOMMA	
"[-L Zeilennummern für das Quellendokument verwenden]"	TokenNameStringLiteral	[-L Zeilennummern für das Quellendokument verwenden]
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
...
,	TokenNameCOMMA	
"[-MEDIA DatenträgerTyp (Datenträgerattribut verwenden, um die einem Dokument zugeordnete Formatvorlage zu suchen.)]"	TokenNameStringLiteral	[-MEDIA DatenträgerTyp (Datenträgerattribut verwenden, um die einem Dokument zugeordnete Formatvorlage zu suchen.)]
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
"optionFLAVOR"	TokenNameStringLiteral	optionFLAVOR
,	TokenNameCOMMA	
"[-FLAVOR WunschName (Explizit s2s=SAX oder d2d=DOM verwenden, um die Umsetzung auszuführen.)] "	TokenNameStringLiteral	[-FLAVOR WunschName (Explizit s2s=SAX oder d2d=DOM verwenden, um die Umsetzung auszuführen.)] 
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
,	TokenNameCOMMA	
"[-DIAG (Gesamtanzahl Millisekunden für die Umsetzung ausgeben.)]"	TokenNameStringLiteral	[-DIAG (Gesamtanzahl Millisekunden für die Umsetzung ausgeben.)]
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
"optionINCREMENTAL"	TokenNameStringLiteral	optionINCREMENTAL
,	TokenNameCOMMA	
"[-INCREMENTAL (Inkrementelle DTM-Erstellung mit der Einstellung 'true' für http://xml.apache.org/xalan/features/incremental anfordern.)]"	TokenNameStringLiteral	[-INCREMENTAL (Inkrementelle DTM-Erstellung mit der Einstellung 'true' für http://xml.apache.org/xalan/features/incremental anfordern.)]
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
"optionNOOPTIMIMIZE"	TokenNameStringLiteral	optionNOOPTIMIMIZE
,	TokenNameCOMMA	
"[-NOOPTIMIMIZE (Mit der Einstellung 'false' für 'http://xml.apache.org/xalan/features/optimize' anfordern, dass keine Formatvorlagenoptimierung ausgeführt wird.)]"	TokenNameStringLiteral	[-NOOPTIMIMIZE (Mit der Einstellung 'false' für 'http://xml.apache.org/xalan/features/optimize' anfordern, dass keine Formatvorlagenoptimierung ausgeführt wird.)]
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
"optionRL"	TokenNameStringLiteral	optionRL
,	TokenNameCOMMA	
"[-RL Verschachtelungsbegrenzung (Numerische Begrenzung für Verschachtelungstiefe der Formatvorlage festlegen.)]"	TokenNameStringLiteral	[-RL Verschachtelungsbegrenzung (Numerische Begrenzung für Verschachtelungstiefe der Formatvorlage festlegen.)]
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
...
,	TokenNameCOMMA	
"[-XD ZielVerzeichnis (Ein Zielverzeichnis für Translet angeben)]"	TokenNameStringLiteral	[-XD ZielVerzeichnis (Ein Zielverzeichnis für Translet angeben)]
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
...
,	TokenNameCOMMA	
"[-XP paket (Ein Paketnamenpräfix für alle generierten Translet-Klassen angeben)]"	TokenNameStringLiteral	[-XP paket (Ein Paketnamenpräfix für alle generierten Translet-Klassen angeben)]
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
,	TokenNameCOMMA	
"[-XN (Inline-Anordnung für Vorlagen aktivieren)]"	TokenNameStringLiteral	[-XN (Inline-Anordnung für Vorlagen aktivieren)]
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
"optionXX"	TokenNameStringLiteral	optionXX
,	TokenNameCOMMA	
"[-XX (Zusätzliche Debugnachrichtenausgabe aktivieren)]"	TokenNameStringLiteral	[-XX (Zusätzliche Debugnachrichtenausgabe aktivieren)]
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
"optionXT"	TokenNameStringLiteral	optionXT
,	TokenNameCOMMA	
"[-XT (Translet für Umsetzung verwenden, wenn möglich)]"	TokenNameStringLiteral	[-XT (Translet für Umsetzung verwenden, wenn möglich)]
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
"diagTiming"	TokenNameStringLiteral	diagTiming
,	TokenNameCOMMA	
"--------- Umsetzung von {0} über {1} betrug {2} Millisekunden"	TokenNameStringLiteral	--------- Umsetzung von {0} über {1} betrug {2} Millisekunden
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
