...
/** * An {@link Aggregator} which updates the weight of a category by summing the * weights of the float association it finds for every document. * * @lucene.experimental */	TokenNameCOMMENT_JAVADOC	 An {@link Aggregator} which updates the weight of a category by summing the weights of the float association it finds for every document. * @lucene.experimental 
