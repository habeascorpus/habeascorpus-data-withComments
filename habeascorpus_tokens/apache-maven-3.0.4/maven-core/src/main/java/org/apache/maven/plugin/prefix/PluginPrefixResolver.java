...
/** * Resolves a plugin prefix. * * @since 3.0 * @author Benjamin Bentmann */	TokenNameCOMMENT_JAVADOC	 Resolves a plugin prefix. * @since 3.0 @author Benjamin Bentmann 
public	TokenNamepublic	
interface	TokenNameinterface	
PluginPrefixResolver	TokenNameIdentifier	 Plugin Prefix Resolver
{	TokenNameLBRACE	
/** * Resolves the plugin prefix for the specified request. * * @param request The request that holds the details about the plugin and the repositories to consult, must not be * {@code null}. * @return The result of the prefix resolution, never {@code null}. * @throws NoPluginFoundForPrefixException If the plugin prefix could not be resolved. */	TokenNameCOMMENT_JAVADOC	 Resolves the plugin prefix for the specified request. * @param request The request that holds the details about the plugin and the repositories to consult, must not be {@code null}. @return The result of the prefix resolution, never {@code null}. @throws NoPluginFoundForPrefixException If the plugin prefix could not be resolved. 
