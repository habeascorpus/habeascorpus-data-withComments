...
;	TokenNameSEMICOLON	
/** Main routine that loads a TextLabels object and summarizes its properties. * * @author William Cohen */	TokenNameCOMMENT_JAVADOC	 Main routine that loads a TextLabels object and summarizes its properties. * @author William Cohen 
public	TokenNamepublic	
class	TokenNameclass	
SummarizeLabels	TokenNameIdentifier	 Summarize Labels
{	TokenNameLBRACE	
public	TokenNamepublic	
...
(	TokenNameLPAREN	
"========== Summary of "	TokenNameStringLiteral	========== Summary of 
+	TokenNamePLUS	
argv	TokenNameIdentifier	 argv
[	TokenNameLBRACKET	
0	TokenNameIntegerLiteral	
...
println	TokenNameIdentifier	 println
(	TokenNameLPAREN	
"Documents: "	TokenNameStringLiteral	Documents: 
+	TokenNamePLUS	
labels	TokenNameIdentifier	 labels
.	TokenNameDOT	
...
println	TokenNameIdentifier	 println
(	TokenNameLPAREN	
"Span Properties: "	TokenNameStringLiteral	Span Properties: 
+	TokenNamePLUS	
labels	TokenNameIdentifier	 labels
.	TokenNameDOT	
...
println	TokenNameIdentifier	 println
(	TokenNameLPAREN	
"Span Types: "	TokenNameStringLiteral	Span Types: 
+	TokenNamePLUS	
labels	TokenNameIdentifier	 labels
.	TokenNameDOT	
