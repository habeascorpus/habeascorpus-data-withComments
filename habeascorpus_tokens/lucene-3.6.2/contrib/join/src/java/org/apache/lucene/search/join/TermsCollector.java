...
;	TokenNameSEMICOLON	
/** * A collector that collects all terms from a specified field matching the query. * * @lucene.experimental */	TokenNameCOMMENT_JAVADOC	 A collector that collects all terms from a specified field matching the query. * @lucene.experimental 
...
String	TokenNameIdentifier	 String
>	TokenNameGREATER	
collectorTerms	TokenNameIdentifier	 collector Terms
=	TokenNameEQUAL	
new	TokenNamenew	
HashSet	TokenNameIdentifier	 Hash Set
<	TokenNameLESS	
...
fromDocTerms	TokenNameIdentifier	 from Doc Terms
;	TokenNameSEMICOLON	
TermsCollector	TokenNameIdentifier	 Terms Collector
(	TokenNameLPAREN	
String	TokenNameIdentifier	 String
