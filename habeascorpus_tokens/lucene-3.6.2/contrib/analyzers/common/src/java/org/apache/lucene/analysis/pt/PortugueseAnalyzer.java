...
.	TokenNameDOT	
PortugueseStemmer	TokenNameIdentifier	 Portuguese Stemmer
;	TokenNameSEMICOLON	
/** * {@link Analyzer} for Portuguese. * <p> * <a name="version"/> * <p>You must specify the required {@link Version} * compatibility when creating PortugueseAnalyzer: * <ul> * <li> As of 3.6, PortugueseLightStemFilter is used for less aggressive stemming. * </ul> */	TokenNameCOMMENT_JAVADOC	 {@link Analyzer} for Portuguese. <p> <a name="version"/> <p>You must specify the required {@link Version} compatibility when creating PortugueseAnalyzer: <ul> <li> As of 3.6, PortugueseLightStemFilter is used for less aggressive stemming. </ul> 
public	TokenNamepublic	
final	TokenNamefinal	
class	TokenNameclass	
PortugueseAnalyzer	TokenNameIdentifier	 Portuguese Analyzer
...
;	TokenNameSEMICOLON	
/** File containing default Portuguese stopwords. */	TokenNameCOMMENT_JAVADOC	 File containing default Portuguese stopwords. 
public	TokenNamepublic	
final	TokenNamefinal	
...
=	TokenNameEQUAL	
"portuguese_stop.txt"	TokenNameStringLiteral	portuguese_stop.txt
;	TokenNameSEMICOLON	
