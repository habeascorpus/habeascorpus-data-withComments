...
/* * $Id: XSLTErrorResources_sl.java 338081 2004-12-15 17:35:58Z jycli $ */	TokenNameCOMMENT_BLOCK	 $Id: XSLTErrorResources_sl.java 338081 2004-12-15 17:35:58Z jycli $ 
...
XSLTErrorResources_sl	TokenNameIdentifier	 XSLT Error Resources sl
...
ER_NO_CURLYBRACE	TokenNameIdentifier	 ER  NO  CURLYBRACE
,	TokenNameCOMMA	
"Napaka: Izraz ne sme vsebovati '{'"	TokenNameStringLiteral	Napaka: Izraz ne sme vsebovati '{'
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_ILLEGAL_ATTRIBUTE	TokenNameIdentifier	 ER  ILLEGAL  ATTRIBUTE
,	TokenNameCOMMA	
"{0} vsebuje neveljaven atribut: {1}"	TokenNameStringLiteral	{0} vsebuje neveljaven atribut: {1}
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_NULL_SOURCENODE_APPLYIMPORTS	TokenNameIdentifier	 ER  NULL  SOURCENODE  APPLYIMPORTS
,	TokenNameCOMMA	
"sourceNode je NULL v xsl:apply-imports!"	TokenNameStringLiteral	sourceNode je NULL v xsl:apply-imports!
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_CANNOT_ADD	TokenNameIdentifier	 ER  CANNOT  ADD
,	TokenNameCOMMA	
"Ne morem dodati {0} k {1}"	TokenNameStringLiteral	Ne morem dodati {0} k {1}
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_NULL_SOURCENODE_HANDLEAPPLYTEMPLATES	TokenNameIdentifier	 ER  NULL  SOURCENODE  HANDLEAPPLYTEMPLATES
,	TokenNameCOMMA	
"sourceNode je NULL v handleApplyTemplatesInstruction!"	TokenNameStringLiteral	sourceNode je NULL v handleApplyTemplatesInstruction!
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_NO_NAME_ATTRIB	TokenNameIdentifier	 ER  NO  NAME  ATTRIB
,	TokenNameCOMMA	
"{0} mora vsebovati atribut imena."	TokenNameStringLiteral	{0} mora vsebovati atribut imena.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_TEMPLATE_NOT_FOUND	TokenNameIdentifier	 ER  TEMPLATE  NOT  FOUND
,	TokenNameCOMMA	
"Nisem na?em predloge z imenom: {0}"	TokenNameStringLiteral	Nisem na?em predloge z imenom: {0}
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_CANT_RESOLVE_NAME_AVT	TokenNameIdentifier	 ER  CANT  RESOLVE  NAME  AVT
,	TokenNameCOMMA	
"Imena AVT v xsl:call-template ni bilo mogo?e razre?iti."	TokenNameStringLiteral	Imena AVT v xsl:call-template ni bilo mogo?e razre?iti.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_REQUIRES_ATTRIB	TokenNameIdentifier	 ER  REQUIRES  ATTRIB
,	TokenNameCOMMA	
"{0} zahteva atribut: {1}"	TokenNameStringLiteral	{0} zahteva atribut: {1}
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_MUST_HAVE_TEST_ATTRIB	TokenNameIdentifier	 ER  MUST  HAVE  TEST  ATTRIB
,	TokenNameCOMMA	
"{0} mora imeti atribut ''test''."	TokenNameStringLiteral	{0} mora imeti atribut ''test''.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_BAD_VAL_ON_LEVEL_ATTRIB	TokenNameIdentifier	 ER  BAD  VAL  ON  LEVEL  ATTRIB
,	TokenNameCOMMA	
"Slaba vrednost pri atributu stopnje: {0}"	TokenNameStringLiteral	Slaba vrednost pri atributu stopnje: {0}
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_PROCESSINGINSTRUCTION_NAME_CANT_BE_XML	TokenNameIdentifier	 ER  PROCESSINGINSTRUCTION  NAME  CANT  BE  XML
,	TokenNameCOMMA	
"Ime navodila za obdelavo ne more biti 'xml'"	TokenNameStringLiteral	Ime navodila za obdelavo ne more biti 'xml'
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_PROCESSINGINSTRUCTION_NOTVALID_NCNAME	TokenNameIdentifier	 ER  PROCESSINGINSTRUCTION  NOTVALID  NCNAME
,	TokenNameCOMMA	
"Ime navodila za obdelavo mora biti veljavno NCIme: {0}"	TokenNameStringLiteral	Ime navodila za obdelavo mora biti veljavno NCIme: {0}
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_NEED_MATCH_ATTRIB	TokenNameIdentifier	 ER  NEED  MATCH  ATTRIB
,	TokenNameCOMMA	
"{0} mora vsebovati primerjalni atribut, ?e vsebuje vozli??e."	TokenNameStringLiteral	{0} mora vsebovati primerjalni atribut, ?e vsebuje vozli??e.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_NEED_NAME_OR_MATCH_ATTRIB	TokenNameIdentifier	 ER  NEED  NAME  OR  MATCH  ATTRIB
,	TokenNameCOMMA	
"{0} zahteva atribut imena ali primerjalni atribut."	TokenNameStringLiteral	{0} zahteva atribut imena ali primerjalni atribut.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_CANT_RESOLVE_NSPREFIX	TokenNameIdentifier	 ER  CANT  RESOLVE  NSPREFIX
,	TokenNameCOMMA	
"Predpone imenskega prostora ni mogo?e razre?iti: {0}"	TokenNameStringLiteral	Predpone imenskega prostora ni mogo?e razre?iti: {0}
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_ILLEGAL_VALUE	TokenNameIdentifier	 ER  ILLEGAL  VALUE
,	TokenNameCOMMA	
"xml:space vsebuje neveljavno vrednost: {0}"	TokenNameStringLiteral	xml:space vsebuje neveljavno vrednost: {0}
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_NO_OWNERDOC	TokenNameIdentifier	 ER  NO  OWNERDOC
,	TokenNameCOMMA	
"Podrejeno vozli??e ne vsebuje lastni?kega dokumenta!"	TokenNameStringLiteral	Podrejeno vozli??e ne vsebuje lastni?kega dokumenta!
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_ELEMTEMPLATEELEM_ERR	TokenNameIdentifier	 ER  ELEMTEMPLATEELEM  ERR
,	TokenNameCOMMA	
"Napaka ElemTemplateElement: {0}"	TokenNameStringLiteral	Napaka ElemTemplateElement: {0}
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_NULL_CHILD	TokenNameIdentifier	 ER  NULL  CHILD
,	TokenNameCOMMA	
"Poskus dodajanja podrejenega elementa z vrednostjo NULL!"	TokenNameStringLiteral	Poskus dodajanja podrejenega elementa z vrednostjo NULL!
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_NEED_SELECT_ATTRIB	TokenNameIdentifier	 ER  NEED  SELECT  ATTRIB
,	TokenNameCOMMA	
"{0} zahteva atribut izbire."	TokenNameStringLiteral	{0} zahteva atribut izbire.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_NEED_TEST_ATTRIB	TokenNameIdentifier	 ER  NEED  TEST  ATTRIB
,	TokenNameCOMMA	
"xsl:when mora vsebovati atribut 'test'."	TokenNameStringLiteral	xsl:when mora vsebovati atribut 'test'.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_NEED_NAME_ATTRIB	TokenNameIdentifier	 ER  NEED  NAME  ATTRIB
,	TokenNameCOMMA	
"xsl:with-param mora vsebovati atribut 'ime'."	TokenNameStringLiteral	xsl:with-param mora vsebovati atribut 'ime'.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_NO_CONTEXT_OWNERDOC	TokenNameIdentifier	 ER  NO  CONTEXT  OWNERDOC
,	TokenNameCOMMA	
"Kontekst ne vsebuje lastni?kega dokumenta!"	TokenNameStringLiteral	Kontekst ne vsebuje lastni?kega dokumenta!
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_COULD_NOT_CREATE_XML_PROC_LIAISON	TokenNameIdentifier	 ER  COULD  NOT  CREATE  XML  PROC  LIAISON
,	TokenNameCOMMA	
"Ne morem ustvariti zveze XML TransformerFactory: {0}"	TokenNameStringLiteral	Ne morem ustvariti zveze XML TransformerFactory: {0}
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_PROCESS_NOT_SUCCESSFUL	TokenNameIdentifier	 ER  PROCESS  NOT  SUCCESSFUL
,	TokenNameCOMMA	
"Xalan: postopek ni uspel."	TokenNameStringLiteral	Xalan: postopek ni uspel.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_NOT_SUCCESSFUL	TokenNameIdentifier	 ER  NOT  SUCCESSFUL
,	TokenNameCOMMA	
"Xalan: ni uspel."	TokenNameStringLiteral	Xalan: ni uspel.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_ENCODING_NOT_SUPPORTED	TokenNameIdentifier	 ER  ENCODING  NOT  SUPPORTED
,	TokenNameCOMMA	
"Kodiranje ni podprto: {0}"	TokenNameStringLiteral	Kodiranje ni podprto: {0}
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_COULD_NOT_CREATE_TRACELISTENER	TokenNameIdentifier	 ER  COULD  NOT  CREATE  TRACELISTENER
,	TokenNameCOMMA	
"Ne morem ustvariti javanskega razreda TraceListener: {0}"	TokenNameStringLiteral	Ne morem ustvariti javanskega razreda TraceListener: {0}
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_KEY_REQUIRES_NAME_ATTRIB	TokenNameIdentifier	 ER  KEY  REQUIRES  NAME  ATTRIB
,	TokenNameCOMMA	
"xsl:key zahteva atribut 'ime'!"	TokenNameStringLiteral	xsl:key zahteva atribut 'ime'!
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_KEY_REQUIRES_MATCH_ATTRIB	TokenNameIdentifier	 ER  KEY  REQUIRES  MATCH  ATTRIB
,	TokenNameCOMMA	
"xsl:key zahteva atribut 'ujemanje'!"	TokenNameStringLiteral	xsl:key zahteva atribut 'ujemanje'!
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_KEY_REQUIRES_USE_ATTRIB	TokenNameIdentifier	 ER  KEY  REQUIRES  USE  ATTRIB
,	TokenNameCOMMA	
"xsl:key zahteva atribut 'uporaba'!"	TokenNameStringLiteral	xsl:key zahteva atribut 'uporaba'!
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_REQUIRES_ELEMENTS_ATTRIB	TokenNameIdentifier	 ER  REQUIRES  ELEMENTS  ATTRIB
,	TokenNameCOMMA	
"(StylesheetHandler) {0} zahteva atribut ''elementi''!"	TokenNameStringLiteral	(StylesheetHandler) {0} zahteva atribut ''elementi''!
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_MISSING_PREFIX_ATTRIB	TokenNameIdentifier	 ER  MISSING  PREFIX  ATTRIB
,	TokenNameCOMMA	
"(StylesheetHandler) {0} manjka atribut ''predpona''"	TokenNameStringLiteral	(StylesheetHandler) {0} manjka atribut ''predpona''
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_BAD_STYLESHEET_URL	TokenNameIdentifier	 ER  BAD  STYLESHEET  URL
,	TokenNameCOMMA	
"URL slogovne datoteke je neveljaven: {0}"	TokenNameStringLiteral	URL slogovne datoteke je neveljaven: {0}
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_FILE_NOT_FOUND	TokenNameIdentifier	 ER  FILE  NOT  FOUND
,	TokenNameCOMMA	
"Slogovne datoteke ni bilo mogo?e najti: {0}"	TokenNameStringLiteral	Slogovne datoteke ni bilo mogo?e najti: {0}
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_IOEXCEPTION	TokenNameIdentifier	 ER  IOEXCEPTION
,	TokenNameCOMMA	
"Pri slogovni datoteki je pri?lo do izjeme IO: {0}"	TokenNameStringLiteral	Pri slogovni datoteki je pri?lo do izjeme IO: {0}
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_NO_HREF_ATTRIB	TokenNameIdentifier	 ER  NO  HREF  ATTRIB
,	TokenNameCOMMA	
"(StylesheetHandler) Atributa href za {0} ni bilo mogo?e najti"	TokenNameStringLiteral	(StylesheetHandler) Atributa href za {0} ni bilo mogo?e najti
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_STYLESHEET_INCLUDES_ITSELF	TokenNameIdentifier	 ER  STYLESHEET  INCLUDES  ITSELF
,	TokenNameCOMMA	
"(StylesheetHandler) {0} neposredno ali posredno vklju?uje samega sebe!"	TokenNameStringLiteral	(StylesheetHandler) {0} neposredno ali posredno vklju?uje samega sebe!
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_PROCESSINCLUDE_ERROR	TokenNameIdentifier	 ER  PROCESSINCLUDE  ERROR
,	TokenNameCOMMA	
"Napaka StylesheetHandler.processInclude, {0}"	TokenNameStringLiteral	Napaka StylesheetHandler.processInclude, {0}
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_MISSING_LANG_ATTRIB	TokenNameIdentifier	 ER  MISSING  LANG  ATTRIB
,	TokenNameCOMMA	
"(StylesheetHandler) {0} manjka atribut ''lang'' "	TokenNameStringLiteral	(StylesheetHandler) {0} manjka atribut ''lang'' 
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_MISSING_CONTAINER_ELEMENT_COMPONENT	TokenNameIdentifier	 ER  MISSING  CONTAINER  ELEMENT  COMPONENT
,	TokenNameCOMMA	
"(StylesheetHandler) napa?na postavitev elementa {0}?? Manjka vsebni element ''komponenta''"	TokenNameStringLiteral	(StylesheetHandler) napa?na postavitev elementa {0}?? Manjka vsebni element ''komponenta''
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_CAN_ONLY_OUTPUT_TO_ELEMENT	TokenNameIdentifier	 ER  CAN  ONLY  OUTPUT  TO  ELEMENT
,	TokenNameCOMMA	
"Prenos mogo? samo v Element, DocumentFragment, Document, ali PrintWriter."	TokenNameStringLiteral	Prenos mogo? samo v Element, DocumentFragment, Document, ali PrintWriter.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_PROCESS_ERROR	TokenNameIdentifier	 ER  PROCESS  ERROR
,	TokenNameCOMMA	
"Napaka StylesheetRoot.process"	TokenNameStringLiteral	Napaka StylesheetRoot.process
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_UNIMPLNODE_ERROR	TokenNameIdentifier	 ER  UNIMPLNODE  ERROR
,	TokenNameCOMMA	
"Napaka UnImplNode: {0}"	TokenNameStringLiteral	Napaka UnImplNode: {0}
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_NO_SELECT_EXPRESSION	TokenNameIdentifier	 ER  NO  SELECT  EXPRESSION
,	TokenNameCOMMA	
"Napaka! Ne najdem izbirnega izraza xpath (-select)."	TokenNameStringLiteral	Napaka! Ne najdem izbirnega izraza xpath (-select).
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_CANNOT_SERIALIZE_XSLPROCESSOR	TokenNameIdentifier	 ER  CANNOT  SERIALIZE  XSLPROCESSOR
,	TokenNameCOMMA	
"Ne morem serializirati XSLProcessor!"	TokenNameStringLiteral	Ne morem serializirati XSLProcessor!
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_NO_INPUT_STYLESHEET	TokenNameIdentifier	 ER  NO  INPUT  STYLESHEET
,	TokenNameCOMMA	
"Vnos slogovne datoteke ni dolo?en!"	TokenNameStringLiteral	Vnos slogovne datoteke ni dolo?en!
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_FAILED_PROCESS_STYLESHEET	TokenNameIdentifier	 ER  FAILED  PROCESS  STYLESHEET
,	TokenNameCOMMA	
"Obdelava slogovne datoteke ni uspela!"	TokenNameStringLiteral	Obdelava slogovne datoteke ni uspela!
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_COULDNT_PARSE_DOC	TokenNameIdentifier	 ER  COULDNT  PARSE  DOC
,	TokenNameCOMMA	
"Dokumenta {0} ni mogo?e raz?leniti!"	TokenNameStringLiteral	Dokumenta {0} ni mogo?e raz?leniti!
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_COULDNT_FIND_FRAGMENT	TokenNameIdentifier	 ER  COULDNT  FIND  FRAGMENT
,	TokenNameCOMMA	
"Ne najdem fragmenta: {0}"	TokenNameStringLiteral	Ne najdem fragmenta: {0}
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_NODE_NOT_ELEMENT	TokenNameIdentifier	 ER  NODE  NOT  ELEMENT
,	TokenNameCOMMA	
"Vozli??e, na katerega ka?e identifikator fragmenta, ni element: {0}"	TokenNameStringLiteral	Vozli??e, na katerega ka?e identifikator fragmenta, ni element: {0}
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_FOREACH_NEED_MATCH_OR_NAME_ATTRIB	TokenNameIdentifier	 ER  FOREACH  NEED  MATCH  OR  NAME  ATTRIB
,	TokenNameCOMMA	
"vsak mora vsebovati primerjalni atribut ali atribut imena"	TokenNameStringLiteral	vsak mora vsebovati primerjalni atribut ali atribut imena
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_TEMPLATES_NEED_MATCH_OR_NAME_ATTRIB	TokenNameIdentifier	 ER  TEMPLATES  NEED  MATCH  OR  NAME  ATTRIB
,	TokenNameCOMMA	
"predloge morajo imeti primerjalni atribut ali atribut imena"	TokenNameStringLiteral	predloge morajo imeti primerjalni atribut ali atribut imena
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_NO_CLONE_OF_DOCUMENT_FRAG	TokenNameIdentifier	 ER  NO  CLONE  OF  DOCUMENT  FRAG
,	TokenNameCOMMA	
"Ni klona fragmenta dokumenta!"	TokenNameStringLiteral	Ni klona fragmenta dokumenta!
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_CANT_CREATE_ITEM	TokenNameIdentifier	 ER  CANT  CREATE  ITEM
,	TokenNameCOMMA	
"Ne morem ustvariti elementa v drevesu rezultatov: {0}"	TokenNameStringLiteral	Ne morem ustvariti elementa v drevesu rezultatov: {0}
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_XMLSPACE_ILLEGAL_VALUE	TokenNameIdentifier	 ER  XMLSPACE  ILLEGAL  VALUE
,	TokenNameCOMMA	
"xml:space v izvirnem XML ima neveljavno vrednost: {0}"	TokenNameStringLiteral	xml:space v izvirnem XML ima neveljavno vrednost: {0}
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_NO_XSLKEY_DECLARATION	TokenNameIdentifier	 ER  NO  XSLKEY  DECLARATION
,	TokenNameCOMMA	
"Ni deklaracije xsl:key za {0}!"	TokenNameStringLiteral	Ni deklaracije xsl:key za {0}!
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_CANT_CREATE_URL	TokenNameIdentifier	 ER  CANT  CREATE  URL
,	TokenNameCOMMA	
"Napaka! Ne morem ustvariti URL za: {0}"	TokenNameStringLiteral	Napaka! Ne morem ustvariti URL za: {0}
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_XSLFUNCTIONS_UNSUPPORTED	TokenNameIdentifier	 ER  XSLFUNCTIONS  UNSUPPORTED
,	TokenNameCOMMA	
"xsl:functions niso podprte"	TokenNameStringLiteral	xsl:functions niso podprte
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_PROCESSOR_ERROR	TokenNameIdentifier	 ER  PROCESSOR  ERROR
,	TokenNameCOMMA	
"Napaka XSLT TransformerFactory"	TokenNameStringLiteral	Napaka XSLT TransformerFactory
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_NOT_ALLOWED_INSIDE_STYLESHEET	TokenNameIdentifier	 ER  NOT  ALLOWED  INSIDE  STYLESHEET
,	TokenNameCOMMA	
"(StylesheetHandler) {0} ni dovoljen znotraj slogovne datoteke!"	TokenNameStringLiteral	(StylesheetHandler) {0} ni dovoljen znotraj slogovne datoteke!
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_RESULTNS_NOT_SUPPORTED	TokenNameIdentifier	 ER  RESULTNS  NOT  SUPPORTED
,	TokenNameCOMMA	
"result-ns ni ve? podprt! Namesto njega uporabite xsl:output."	TokenNameStringLiteral	result-ns ni ve? podprt! Namesto njega uporabite xsl:output.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_DEFAULTSPACE_NOT_SUPPORTED	TokenNameIdentifier	 ER  DEFAULTSPACE  NOT  SUPPORTED
,	TokenNameCOMMA	
"default-space ni ve? podprt! Namesto njega uporabite xsl:strip-space ali xsl:preserve-space."	TokenNameStringLiteral	default-space ni ve? podprt! Namesto njega uporabite xsl:strip-space ali xsl:preserve-space.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_INDENTRESULT_NOT_SUPPORTED	TokenNameIdentifier	 ER  INDENTRESULT  NOT  SUPPORTED
,	TokenNameCOMMA	
"indent-result ni ve? podprt! Namesto njega uporabite xsl:output."	TokenNameStringLiteral	indent-result ni ve? podprt! Namesto njega uporabite xsl:output.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_ILLEGAL_ATTRIB	TokenNameIdentifier	 ER  ILLEGAL  ATTRIB
,	TokenNameCOMMA	
"(StylesheetHandler) {0} ima neveljaven atribut: {1}"	TokenNameStringLiteral	(StylesheetHandler) {0} ima neveljaven atribut: {1}
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_UNKNOWN_XSL_ELEM	TokenNameIdentifier	 ER  UNKNOWN  XSL  ELEM
,	TokenNameCOMMA	
"Neznani element XSL: {0}"	TokenNameStringLiteral	Neznani element XSL: {0}
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_BAD_XSLSORT_USE	TokenNameIdentifier	 ER  BAD  XSLSORT  USE
,	TokenNameCOMMA	
"(StylesheetHandler) xsl:sort lahko uporabljamo samo z xsl:apply-templates ali z xsl:for-each."	TokenNameStringLiteral	(StylesheetHandler) xsl:sort lahko uporabljamo samo z xsl:apply-templates ali z xsl:for-each.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_MISPLACED_XSLWHEN	TokenNameIdentifier	 ER  MISPLACED  XSLWHEN
,	TokenNameCOMMA	
"(StylesheetHandler) napa?na postavitev xsl:when!"	TokenNameStringLiteral	(StylesheetHandler) napa?na postavitev xsl:when!
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_XSLWHEN_NOT_PARENTED_BY_XSLCHOOSE	TokenNameIdentifier	 ER  XSLWHEN  NOT  PARENTED  BY  XSLCHOOSE
,	TokenNameCOMMA	
"(StylesheetHandler) xsl:choose ni nadrejen xsl:when!"	TokenNameStringLiteral	(StylesheetHandler) xsl:choose ni nadrejen xsl:when!
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_MISPLACED_XSLOTHERWISE	TokenNameIdentifier	 ER  MISPLACED  XSLOTHERWISE
,	TokenNameCOMMA	
"(StylesheetHandler) napa?na postavitev xsl:otherwise!"	TokenNameStringLiteral	(StylesheetHandler) napa?na postavitev xsl:otherwise!
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_XSLOTHERWISE_NOT_PARENTED_BY_XSLCHOOSE	TokenNameIdentifier	 ER  XSLOTHERWISE  NOT  PARENTED  BY  XSLCHOOSE
,	TokenNameCOMMA	
"(StylesheetHandler) xsl:choose ni nadrejen xsl:otherwise!"	TokenNameStringLiteral	(StylesheetHandler) xsl:choose ni nadrejen xsl:otherwise!
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_NOT_ALLOWED_INSIDE_TEMPLATE	TokenNameIdentifier	 ER  NOT  ALLOWED  INSIDE  TEMPLATE
,	TokenNameCOMMA	
"(StylesheetHandler) {0} ni dovoljen znotraj predloge!"	TokenNameStringLiteral	(StylesheetHandler) {0} ni dovoljen znotraj predloge!
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_UNKNOWN_EXT_NS_PREFIX	TokenNameIdentifier	 ER  UNKNOWN  EXT  NS  PREFIX
,	TokenNameCOMMA	
"(StylesheetHandler) Neznana {0} kon?nica predpone imenskega prostora {1}"	TokenNameStringLiteral	(StylesheetHandler) Neznana {0} kon?nica predpone imenskega prostora {1}
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_IMPORTS_AS_FIRST_ELEM	TokenNameIdentifier	 ER  IMPORTS  AS  FIRST  ELEM
,	TokenNameCOMMA	
"(StylesheetHandler) Uvozi se lahko pojavijo samo kot prvi elementi v slogovni datoteki!"	TokenNameStringLiteral	(StylesheetHandler) Uvozi se lahko pojavijo samo kot prvi elementi v slogovni datoteki!
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_IMPORTING_ITSELF	TokenNameIdentifier	 ER  IMPORTING  ITSELF
,	TokenNameCOMMA	
"(StylesheetHandler) {0} neposredno ali posredno uva?a samega sebe!"	TokenNameStringLiteral	(StylesheetHandler) {0} neposredno ali posredno uva?a samega sebe!
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_XMLSPACE_ILLEGAL_VAL	TokenNameIdentifier	 ER  XMLSPACE  ILLEGAL  VAL
,	TokenNameCOMMA	
"(StylesheetHandler) xml:space vsebuje neveljavno vrednost: {0}"	TokenNameStringLiteral	(StylesheetHandler) xml:space vsebuje neveljavno vrednost: {0}
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_PROCESSSTYLESHEET_NOT_SUCCESSFUL	TokenNameIdentifier	 ER  PROCESSSTYLESHEET  NOT  SUCCESSFUL
,	TokenNameCOMMA	
"processStylesheet ni uspelo!"	TokenNameStringLiteral	processStylesheet ni uspelo!
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_SAX_EXCEPTION	TokenNameIdentifier	 ER  SAX  EXCEPTION
,	TokenNameCOMMA	
"Izjema SAX"	TokenNameStringLiteral	Izjema SAX
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
ER_XSLT_ERROR	TokenNameIdentifier	 ER  XSLT  ERROR
,	TokenNameCOMMA	
"Napaka XSLT"	TokenNameStringLiteral	Napaka XSLT
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_CURRENCY_SIGN_ILLEGAL	TokenNameIdentifier	 ER  CURRENCY  SIGN  ILLEGAL
,	TokenNameCOMMA	
"V oblikovnem nizu vzorca znak za denarno enoto ni dovoljen"	TokenNameStringLiteral	V oblikovnem nizu vzorca znak za denarno enoto ni dovoljen
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_DOCUMENT_FUNCTION_INVALID_IN_STYLESHEET_DOM	TokenNameIdentifier	 ER  DOCUMENT  FUNCTION  INVALID  IN  STYLESHEET  DOM
,	TokenNameCOMMA	
"Funkcija dokumenta v slogovni datoteki DOM ni podprta!"	TokenNameStringLiteral	Funkcija dokumenta v slogovni datoteki DOM ni podprta!
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_CANT_RESOLVE_PREFIX_OF_NON_PREFIX_RESOLVER	TokenNameIdentifier	 ER  CANT  RESOLVE  PREFIX  OF  NON  PREFIX  RESOLVER
,	TokenNameCOMMA	
"Ne morem razbrati predpone nepredponskega razre?evalnika!"	TokenNameStringLiteral	Ne morem razbrati predpone nepredponskega razre?evalnika!
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_REDIRECT_COULDNT_GET_FILENAME	TokenNameIdentifier	 ER  REDIRECT  COULDNT  GET  FILENAME
,	TokenNameCOMMA	
"Preusmeri kon?nico: ne morem pridobiti imena datoteke - atribut datoteke ali izbire mora vrniti veljaven niz."	TokenNameStringLiteral	Preusmeri kon?nico: ne morem pridobiti imena datoteke - atribut datoteke ali izbire mora vrniti veljaven niz.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_CANNOT_BUILD_FORMATTERLISTENER_IN_REDIRECT	TokenNameIdentifier	 ER  CANNOT  BUILD  FORMATTERLISTENER  IN  REDIRECT
,	TokenNameCOMMA	
"V Preusmeritvi kon?nice ne morem zgraditi FormatterListener!"	TokenNameStringLiteral	V Preusmeritvi kon?nice ne morem zgraditi FormatterListener!
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_INVALID_PREFIX_IN_EXCLUDERESULTPREFIX	TokenNameIdentifier	 ER  INVALID  PREFIX  IN  EXCLUDERESULTPREFIX
,	TokenNameCOMMA	
"Predpona v izklju?i-predpone-rezultatov (exclude-result-prefixes) ni veljavna: {0}"	TokenNameStringLiteral	Predpona v izklju?i-predpone-rezultatov (exclude-result-prefixes) ni veljavna: {0}
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_MISSING_NS_URI	TokenNameIdentifier	 ER  MISSING  NS  URI
,	TokenNameCOMMA	
"Za navedeno predpono manjka imenski prostor URI"	TokenNameStringLiteral	Za navedeno predpono manjka imenski prostor URI
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_MISSING_ARG_FOR_OPTION	TokenNameIdentifier	 ER  MISSING  ARG  FOR  OPTION
,	TokenNameCOMMA	
"Manjka argument za mo?nost: {0}"	TokenNameStringLiteral	Manjka argument za mo?nost: {0}
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_INVALID_OPTION	TokenNameIdentifier	 ER  INVALID  OPTION
,	TokenNameCOMMA	
"Neveljavna mo?nost: {0}"	TokenNameStringLiteral	Neveljavna mo?nost: {0}
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_MALFORMED_FORMAT_STRING	TokenNameIdentifier	 ER  MALFORMED  FORMAT  STRING
,	TokenNameCOMMA	
"Po?kodovan niz sloga: {0}"	TokenNameStringLiteral	Po?kodovan niz sloga: {0}
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_STYLESHEET_REQUIRES_VERSION_ATTRIB	TokenNameIdentifier	 ER  STYLESHEET  REQUIRES  VERSION  ATTRIB
,	TokenNameCOMMA	
"xsl:stylesheet zahteva atribut 'razli?ica'!"	TokenNameStringLiteral	xsl:stylesheet zahteva atribut 'razli?ica'!
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_ILLEGAL_ATTRIBUTE_VALUE	TokenNameIdentifier	 ER  ILLEGAL  ATTRIBUTE  VALUE
,	TokenNameCOMMA	
"Atribut: {0} ima neveljavno vrednost: {1}"	TokenNameStringLiteral	Atribut: {0} ima neveljavno vrednost: {1}
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_CHOOSE_REQUIRES_WHEN	TokenNameIdentifier	 ER  CHOOSE  REQUIRES  WHEN
,	TokenNameCOMMA	
"xsl:choose zahteva xsl:when"	TokenNameStringLiteral	xsl:choose zahteva xsl:when
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_NO_APPLY_IMPORT_IN_FOR_EACH	TokenNameIdentifier	 ER  NO  APPLY  IMPORT  IN  FOR  EACH
,	TokenNameCOMMA	
"xsl:apply-imports v xsl:for-each ni dovoljen"	TokenNameStringLiteral	xsl:apply-imports v xsl:for-each ni dovoljen
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_CANT_USE_DTM_FOR_OUTPUT	TokenNameIdentifier	 ER  CANT  USE  DTM  FOR  OUTPUT
,	TokenNameCOMMA	
"Za izhodno vozli??e DOM ne morem uporabiti DTMLiaison... namesto njega posredujte org.apache.xpath.DOM2Helper!"	TokenNameStringLiteral	Za izhodno vozli??e DOM ne morem uporabiti DTMLiaison... namesto njega posredujte org.apache.xpath.DOM2Helper!
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_CANT_USE_DTM_FOR_INPUT	TokenNameIdentifier	 ER  CANT  USE  DTM  FOR  INPUT
,	TokenNameCOMMA	
"Za vhodno vozli??e DOM ne morem uporabiti DTMLiaison... namesto njega posredujte org.apache.xpath.DOM2Helper!"	TokenNameStringLiteral	Za vhodno vozli??e DOM ne morem uporabiti DTMLiaison... namesto njega posredujte org.apache.xpath.DOM2Helper!
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_CALL_TO_EXT_FAILED	TokenNameIdentifier	 ER  CALL  TO  EXT  FAILED
,	TokenNameCOMMA	
"Klic elementa kon?nice ni uspel: {0}"	TokenNameStringLiteral	Klic elementa kon?nice ni uspel: {0}
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_PREFIX_MUST_RESOLVE	TokenNameIdentifier	 ER  PREFIX  MUST  RESOLVE
...
ER_XSLATTRSET_USED_ITSELF	TokenNameIdentifier	 ER  XSLATTRSET  USED  ITSELF
,	TokenNameCOMMA	
"xsl:attribute-set {0} je uporabil samega sebe, kar bo povzro?ilo neskon?o ponavljanje."	TokenNameStringLiteral	xsl:attribute-set {0} je uporabil samega sebe, kar bo povzro?ilo neskon?o ponavljanje.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_CANNOT_MIX_XERCESDOM	TokenNameIdentifier	 ER  CANNOT  MIX  XERCESDOM
,	TokenNameCOMMA	
"Prepletanje ne-Xerces-DOM vhoda s Xerces-DOM vhodom ni mogo?e!"	TokenNameStringLiteral	Prepletanje ne-Xerces-DOM vhoda s Xerces-DOM vhodom ni mogo?e!
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_TOO_MANY_LISTENERS	TokenNameIdentifier	 ER  TOO  MANY  LISTENERS
...
ER_DUPLICATE_NAMED_TEMPLATE	TokenNameIdentifier	 ER  DUPLICATE  NAMED  TEMPLATE
,	TokenNameCOMMA	
"Na?el ve? predlog z istim imenom: {0}"	TokenNameStringLiteral	Na?el ve? predlog z istim imenom: {0}
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_INVALID_KEY_CALL	TokenNameIdentifier	 ER  INVALID  KEY  CALL
,	TokenNameCOMMA	
"Neveljaven klic funkcije: povratni klici key() niso dovoljeni"	TokenNameStringLiteral	Neveljaven klic funkcije: povratni klici key() niso dovoljeni
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_REFERENCING_ITSELF	TokenNameIdentifier	 ER  REFERENCING  ITSELF
,	TokenNameCOMMA	
"Spremenljivka {0} se neposredno ali posredno sklicuje sama nase!"	TokenNameStringLiteral	Spremenljivka {0} se neposredno ali posredno sklicuje sama nase!
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_ILLEGAL_DOMSOURCE_INPUT	TokenNameIdentifier	 ER  ILLEGAL  DOMSOURCE  INPUT
,	TokenNameCOMMA	
"Vhodno vozli??e za DOMSource za newTemplates ne more biti NULL!"	TokenNameStringLiteral	Vhodno vozli??e za DOMSource za newTemplates ne more biti NULL!
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_CLASS_NOT_FOUND_FOR_OPTION	TokenNameIdentifier	 ER  CLASS  NOT  FOUND  FOR  OPTION
,	TokenNameCOMMA	
"Datoteke razreda za mo?nost {0} ni bilo mogo?e najti"	TokenNameStringLiteral	Datoteke razreda za mo?nost {0} ni bilo mogo?e najti
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_REQUIRED_ELEM_NOT_FOUND	TokenNameIdentifier	 ER  REQUIRED  ELEM  NOT  FOUND
,	TokenNameCOMMA	
"Zahtevanega elementa ni bilo mogo?e najti: {0}"	TokenNameStringLiteral	Zahtevanega elementa ni bilo mogo?e najti: {0}
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_INPUT_CANNOT_BE_NULL	TokenNameIdentifier	 ER  INPUT  CANNOT  BE  NULL
,	TokenNameCOMMA	
"InputStream ne more biti NULL"	TokenNameStringLiteral	InputStream ne more biti NULL
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_URI_CANNOT_BE_NULL	TokenNameIdentifier	 ER  URI  CANNOT  BE  NULL
,	TokenNameCOMMA	
"URI ne more biti NULL"	TokenNameStringLiteral	URI ne more biti NULL
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_FILE_CANNOT_BE_NULL	TokenNameIdentifier	 ER  FILE  CANNOT  BE  NULL
,	TokenNameCOMMA	
"Datoteka ne more biti NULL"	TokenNameStringLiteral	Datoteka ne more biti NULL
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_SOURCE_CANNOT_BE_NULL	TokenNameIdentifier	 ER  SOURCE  CANNOT  BE  NULL
,	TokenNameCOMMA	
"InputSource ne more biti NULL"	TokenNameStringLiteral	InputSource ne more biti NULL
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_CANNOT_INIT_BSFMGR	TokenNameIdentifier	 ER  CANNOT  INIT  BSFMGR
,	TokenNameCOMMA	
"Inicializacija BSF Manager-ja ni mogo?a"	TokenNameStringLiteral	Inicializacija BSF Manager-ja ni mogo?a
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_CANNOT_CMPL_EXTENSN	TokenNameIdentifier	 ER  CANNOT  CMPL  EXTENSN
,	TokenNameCOMMA	
"Kon?nice ni mogo?e prevesti"	TokenNameStringLiteral	Kon?nice ni mogo?e prevesti
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_CANNOT_CREATE_EXTENSN	TokenNameIdentifier	 ER  CANNOT  CREATE  EXTENSN
,	TokenNameCOMMA	
"Ne morem ustvariti kon?nice: {0} zaradi: {1}"	TokenNameStringLiteral	Ne morem ustvariti kon?nice: {0} zaradi: {1}
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_INSTANCE_MTHD_CALL_REQUIRES	TokenNameIdentifier	 ER  INSTANCE  MTHD  CALL  REQUIRES
,	TokenNameCOMMA	
"Klic primerkov metode za metodo {0} zahteva primerek objekta kot prvi argument"	TokenNameStringLiteral	Klic primerkov metode za metodo {0} zahteva primerek objekta kot prvi argument
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_INVALID_ELEMENT_NAME	TokenNameIdentifier	 ER  INVALID  ELEMENT  NAME
,	TokenNameCOMMA	
"Navedeno neveljavno ime elementa {0}"	TokenNameStringLiteral	Navedeno neveljavno ime elementa {0}
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_ELEMENT_NAME_METHOD_STATIC	TokenNameIdentifier	 ER  ELEMENT  NAME  METHOD  STATIC
,	TokenNameCOMMA	
"Metoda imena elementa mora biti stati?na (static) {0}"	TokenNameStringLiteral	Metoda imena elementa mora biti stati?na (static) {0}
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_EXTENSION_FUNC_UNKNOWN	TokenNameIdentifier	 ER  EXTENSION  FUNC  UNKNOWN
,	TokenNameCOMMA	
"Funkcija kon?nice {0} : {1} je neznana"	TokenNameStringLiteral	Funkcija kon?nice {0} : {1} je neznana
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_MORE_MATCH_CONSTRUCTOR	TokenNameIdentifier	 ER  MORE  MATCH  CONSTRUCTOR
,	TokenNameCOMMA	
"Ve? kot eno najbolj?e ujemanje za graditelja za {0}"	TokenNameStringLiteral	Ve? kot eno najbolj?e ujemanje za graditelja za {0}
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_MORE_MATCH_METHOD	TokenNameIdentifier	 ER  MORE  MATCH  METHOD
,	TokenNameCOMMA	
"Ve? kot eno najbolj?e ujemanje za metodo {0}"	TokenNameStringLiteral	Ve? kot eno najbolj?e ujemanje za metodo {0}
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_MORE_MATCH_ELEMENT	TokenNameIdentifier	 ER  MORE  MATCH  ELEMENT
,	TokenNameCOMMA	
"Ve? kot eno najbolj?e ujemanje za metodo elementa {0}"	TokenNameStringLiteral	Ve? kot eno najbolj?e ujemanje za metodo elementa {0}
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_INVALID_CONTEXT_PASSED	TokenNameIdentifier	 ER  INVALID  CONTEXT  PASSED
,	TokenNameCOMMA	
"Posredovan neveljaven kontekst za ovrednotenje {0}"	TokenNameStringLiteral	Posredovan neveljaven kontekst za ovrednotenje {0}
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_POOL_EXISTS	TokenNameIdentifier	 ER  POOL  EXISTS
,	TokenNameCOMMA	
"Zaloga ?e obstaja"	TokenNameStringLiteral	Zaloga ?e obstaja
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_NO_DRIVER_NAME	TokenNameIdentifier	 ER  NO  DRIVER  NAME
,	TokenNameCOMMA	
"Ime gonilnika ni dolo?eno"	TokenNameStringLiteral	Ime gonilnika ni dolo?eno
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_NO_URL	TokenNameIdentifier	 ER  NO  URL
,	TokenNameCOMMA	
"URL ni dolo?en"	TokenNameStringLiteral	URL ni dolo?en
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_POOL_SIZE_LESSTHAN_ONE	TokenNameIdentifier	 ER  POOL  SIZE  LESSTHAN  ONE
,	TokenNameCOMMA	
"Zaloga je manj?a od ena!"	TokenNameStringLiteral	Zaloga je manj?a od ena!
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_INVALID_DRIVER	TokenNameIdentifier	 ER  INVALID  DRIVER
,	TokenNameCOMMA	
"Navedeno neveljavno ime gonilnika!"	TokenNameStringLiteral	Navedeno neveljavno ime gonilnika!
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_NO_STYLESHEETROOT	TokenNameIdentifier	 ER  NO  STYLESHEETROOT
,	TokenNameCOMMA	
"Korena slogovne datoteke ni mogo?e najti!"	TokenNameStringLiteral	Korena slogovne datoteke ni mogo?e najti!
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_ILLEGAL_XMLSPACE_VALUE	TokenNameIdentifier	 ER  ILLEGAL  XMLSPACE  VALUE
,	TokenNameCOMMA	
"Neveljavna vrednost za xml:space"	TokenNameStringLiteral	Neveljavna vrednost za xml:space
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_PROCESSFROMNODE_FAILED	TokenNameIdentifier	 ER  PROCESSFROMNODE  FAILED
,	TokenNameCOMMA	
"processFromNode spodletelo"	TokenNameStringLiteral	processFromNode spodletelo
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_RESOURCE_COULD_NOT_LOAD	TokenNameIdentifier	 ER  RESOURCE  COULD  NOT  LOAD
...
ER_UNKNOWN_ERROR_CALLING_EXTENSION	TokenNameIdentifier	 ER  UNKNOWN  ERROR  CALLING  EXTENSION
,	TokenNameCOMMA	
"Neznana napaka pri klicu kon?nice"	TokenNameStringLiteral	Neznana napaka pri klicu kon?nice
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_NO_NAMESPACE_DECL	TokenNameIdentifier	 ER  NO  NAMESPACE  DECL
,	TokenNameCOMMA	
"Predpona {0} nima ustrezne deklaracije imenskega prostora"	TokenNameStringLiteral	Predpona {0} nima ustrezne deklaracije imenskega prostora
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_ELEM_CONTENT_NOT_ALLOWED	TokenNameIdentifier	 ER  ELEM  CONTENT  NOT  ALLOWED
,	TokenNameCOMMA	
"Vsebina elementa za lang=javaclass {0} ni dovoljena"	TokenNameStringLiteral	Vsebina elementa za lang=javaclass {0} ni dovoljena
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_STYLESHEET_DIRECTED_TERMINATION	TokenNameIdentifier	 ER  STYLESHEET  DIRECTED  TERMINATION
,	TokenNameCOMMA	
"Prekinitev usmerja slogovna datoteka"	TokenNameStringLiteral	Prekinitev usmerja slogovna datoteka
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_ONE_OR_TWO	TokenNameIdentifier	 ER  ONE  OR  TWO
,	TokenNameCOMMA	
"1 ali 2"	TokenNameStringLiteral	1 ali 2
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_TWO_OR_THREE	TokenNameIdentifier	 ER  TWO  OR  THREE
,	TokenNameCOMMA	
"2 ali 3"	TokenNameStringLiteral	2 ali 3
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_COULD_NOT_LOAD_RESOURCE	TokenNameIdentifier	 ER  COULD  NOT  LOAD  RESOURCE
,	TokenNameCOMMA	
"Nisem mogel nalo?iti {0} (preverite CLASSPATH), trenutno se uporabljajo privzete vrednosti"	TokenNameStringLiteral	Nisem mogel nalo?iti {0} (preverite CLASSPATH), trenutno se uporabljajo privzete vrednosti
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_CANNOT_INIT_DEFAULT_TEMPLATES	TokenNameIdentifier	 ER  CANNOT  INIT  DEFAULT  TEMPLATES
,	TokenNameCOMMA	
"Ne morem inicializirati privzetih predlog"	TokenNameStringLiteral	Ne morem inicializirati privzetih predlog
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_RESULT_NULL	TokenNameIdentifier	 ER  RESULT  NULL
...
ER_RESULT_COULD_NOT_BE_SET	TokenNameIdentifier	 ER  RESULT  COULD  NOT  BE  SET
,	TokenNameCOMMA	
"Rezultata ni bilo mogo?e nastaviti"	TokenNameStringLiteral	Rezultata ni bilo mogo?e nastaviti
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_NO_OUTPUT_SPECIFIED	TokenNameIdentifier	 ER  NO  OUTPUT  SPECIFIED
,	TokenNameCOMMA	
"Izhod ni naveden"	TokenNameStringLiteral	Izhod ni naveden
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_CANNOT_TRANSFORM_TO_RESULT_TYPE	TokenNameIdentifier	 ER  CANNOT  TRANSFORM  TO  RESULT  TYPE
,	TokenNameCOMMA	
"Ne morem pretvoriti v rezultat tipa {0}"	TokenNameStringLiteral	Ne morem pretvoriti v rezultat tipa {0}
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_CANNOT_TRANSFORM_SOURCE_TYPE	TokenNameIdentifier	 ER  CANNOT  TRANSFORM  SOURCE  TYPE
,	TokenNameCOMMA	
"Ne morem pretvoriti vira tipa {0}"	TokenNameStringLiteral	Ne morem pretvoriti vira tipa {0}
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_NULL_CONTENT_HANDLER	TokenNameIdentifier	 ER  NULL  CONTENT  HANDLER
,	TokenNameCOMMA	
"Program za obravnavo vsebine NULL"	TokenNameStringLiteral	Program za obravnavo vsebine NULL
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_NULL_ERROR_HANDLER	TokenNameIdentifier	 ER  NULL  ERROR  HANDLER
,	TokenNameCOMMA	
"Program za obravnavo napak NULL"	TokenNameStringLiteral	Program za obravnavo napak NULL
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_CANNOT_CALL_PARSE	TokenNameIdentifier	 ER  CANNOT  CALL  PARSE
,	TokenNameCOMMA	
"klic raz?lenitve ni mo?en ?e ContentHandler ni bil nastavljen"	TokenNameStringLiteral	klic raz?lenitve ni mo?en ?e ContentHandler ni bil nastavljen
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_NO_PARENT_FOR_FILTER	TokenNameIdentifier	 ER  NO  PARENT  FOR  FILTER
,	TokenNameCOMMA	
"Ni nadrejenega za filter"	TokenNameStringLiteral	Ni nadrejenega za filter
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_NO_STYLESHEET_IN_MEDIA	TokenNameIdentifier	 ER  NO  STYLESHEET  IN  MEDIA
,	TokenNameCOMMA	
"Ni mogo?e najti slogovne datoteke v: {0}, medij= {1}"	TokenNameStringLiteral	Ni mogo?e najti slogovne datoteke v: {0}, medij= {1}
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_NO_STYLESHEET_PI	TokenNameIdentifier	 ER  NO  STYLESHEET  PI
,	TokenNameCOMMA	
"Ne najdem xml-stylesheet PI v: {0}"	TokenNameStringLiteral	Ne najdem xml-stylesheet PI v: {0}
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_NOT_SUPPORTED	TokenNameIdentifier	 ER  NOT  SUPPORTED
...
ER_PROPERTY_VALUE_BOOLEAN	TokenNameIdentifier	 ER  PROPERTY  VALUE  BOOLEAN
,	TokenNameCOMMA	
"Vrednost lastnosti {0} bi morala biti ponovitev logi?ne vrednosti"	TokenNameStringLiteral	Vrednost lastnosti {0} bi morala biti ponovitev logi?ne vrednosti
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_COULD_NOT_FIND_EXTERN_SCRIPT	TokenNameIdentifier	 ER  COULD  NOT  FIND  EXTERN  SCRIPT
,	TokenNameCOMMA	
"Ne morem dostopati do zunanje skripte na {0}"	TokenNameStringLiteral	Ne morem dostopati do zunanje skripte na {0}
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_RESOURCE_COULD_NOT_FIND	TokenNameIdentifier	 ER  RESOURCE  COULD  NOT  FIND
...
ER_OUTPUT_PROPERTY_NOT_RECOGNIZED	TokenNameIdentifier	 ER  OUTPUT  PROPERTY  NOT  RECOGNIZED
,	TokenNameCOMMA	
"Izhodna lastnost ni prepoznana: {0}"	TokenNameStringLiteral	Izhodna lastnost ni prepoznana: {0}
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_FAILED_CREATING_ELEMLITRSLT	TokenNameIdentifier	 ER  FAILED  CREATING  ELEMLITRSLT
,	TokenNameCOMMA	
"Priprava primerka ElemLiteralResult ni uspela"	TokenNameStringLiteral	Priprava primerka ElemLiteralResult ni uspela
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
ER_VALUE_SHOULD_BE_NUMBER	TokenNameIdentifier	 ER  VALUE  SHOULD  BE  NUMBER
,	TokenNameCOMMA	
"Vrednost za {0} bi morala biti ?tevilka, ki jo je mogo?e raz?leniti"	TokenNameStringLiteral	Vrednost za {0} bi morala biti ?tevilka, ki jo je mogo?e raz?leniti
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_VALUE_SHOULD_EQUAL	TokenNameIdentifier	 ER  VALUE  SHOULD  EQUAL
,	TokenNameCOMMA	
"Vrednost za {0} bi morala biti enaka da ali ne"	TokenNameStringLiteral	Vrednost za {0} bi morala biti enaka da ali ne
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_FAILED_CALLING_METHOD	TokenNameIdentifier	 ER  FAILED  CALLING  METHOD
,	TokenNameCOMMA	
"Klic metode {0} ni uspel"	TokenNameStringLiteral	Klic metode {0} ni uspel
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_FAILED_CREATING_ELEMTMPL	TokenNameIdentifier	 ER  FAILED  CREATING  ELEMTMPL
,	TokenNameCOMMA	
"Priprava primerka ElemTemplateElement ni uspela"	TokenNameStringLiteral	Priprava primerka ElemTemplateElement ni uspela
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_CHARS_NOT_ALLOWED	TokenNameIdentifier	 ER  CHARS  NOT  ALLOWED
,	TokenNameCOMMA	
"V tem trenutku znaki v dokumentu niso na voljo"	TokenNameStringLiteral	V tem trenutku znaki v dokumentu niso na voljo
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_ATTR_NOT_ALLOWED	TokenNameIdentifier	 ER  ATTR  NOT  ALLOWED
,	TokenNameCOMMA	
"Atribut "{0}" v elementu {1} ni dovoljen!"	TokenNameStringLiteral	Atribut "{0}" v elementu {1} ni dovoljen!
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_BAD_VALUE	TokenNameIdentifier	 ER  BAD  VALUE
,	TokenNameCOMMA	
"{0} slaba vrednost {1} "	TokenNameStringLiteral	{0} slaba vrednost {1} 
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_ATTRIB_VALUE_NOT_FOUND	TokenNameIdentifier	 ER  ATTRIB  VALUE  NOT  FOUND
,	TokenNameCOMMA	
"Vrednosti atributa {0} ni bilo mogo?e najti "	TokenNameStringLiteral	Vrednosti atributa {0} ni bilo mogo?e najti 
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_ATTRIB_VALUE_NOT_RECOGNIZED	TokenNameIdentifier	 ER  ATTRIB  VALUE  NOT  RECOGNIZED
,	TokenNameCOMMA	
"Vrednosti atributa {0} ni bilo mogo?e prepoznati "	TokenNameStringLiteral	Vrednosti atributa {0} ni bilo mogo?e prepoznati 
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_NULL_URI_NAMESPACE	TokenNameIdentifier	 ER  NULL  URI  NAMESPACE
,	TokenNameCOMMA	
"Posku?am generirati predpono imenskega prostora z URI z vrednostjo NULL"	TokenNameStringLiteral	Posku?am generirati predpono imenskega prostora z URI z vrednostjo NULL
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
ER_NUMBER_TOO_BIG	TokenNameIdentifier	 ER  NUMBER  TOO  BIG
,	TokenNameCOMMA	
"Poskus oblikovanja ?tevilke, ve?je od najve?jega dolgega celega ?tevila"	TokenNameStringLiteral	Poskus oblikovanja ?tevilke, ve?je od najve?jega dolgega celega ?tevila
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_CANNOT_FIND_SAX1_DRIVER	TokenNameIdentifier	 ER  CANNOT  FIND  SA X1  DRIVER
,	TokenNameCOMMA	
"Ne najdem razreda gonilnika SAX1 {0}"	TokenNameStringLiteral	Ne najdem razreda gonilnika SAX1 {0}
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_SAX1_DRIVER_NOT_LOADED	TokenNameIdentifier	 ER  SA X1  DRIVER  NOT  LOADED
,	TokenNameCOMMA	
"Na?el razred gonilnika SAX1 {0}, vendar ga ne morem nalo?iti"	TokenNameStringLiteral	Na?el razred gonilnika SAX1 {0}, vendar ga ne morem nalo?iti
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_SAX1_DRIVER_NOT_INSTANTIATED	TokenNameIdentifier	 ER  SA X1  DRIVER  NOT  INSTANTIATED
,	TokenNameCOMMA	
"Nalo?il razred gonilnika SAX1 {0}, vendar ga ne morem udejaniti"	TokenNameStringLiteral	Nalo?il razred gonilnika SAX1 {0}, vendar ga ne morem udejaniti
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_SAX1_DRIVER_NOT_IMPLEMENT_PARSER	TokenNameIdentifier	 ER  SA X1  DRIVER  NOT  IMPLEMENT  PARSER
,	TokenNameCOMMA	
"Razred gonilnika SAX1 {0} ne vklju?uje org.xml.sax.Parser"	TokenNameStringLiteral	Razred gonilnika SAX1 {0} ne vklju?uje org.xml.sax.Parser
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_PARSER_PROPERTY_NOT_SPECIFIED	TokenNameIdentifier	 ER  PARSER  PROPERTY  NOT  SPECIFIED
,	TokenNameCOMMA	
"Sistemska lastnost org.xml.sax.parser ni dolo?ena"	TokenNameStringLiteral	Sistemska lastnost org.xml.sax.parser ni dolo?ena
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_PARSER_ARG_CANNOT_BE_NULL	TokenNameIdentifier	 ER  PARSER  ARG  CANNOT  BE  NULL
,	TokenNameCOMMA	
"Argument raz?lenjevalnika sme biti NULL"	TokenNameStringLiteral	Argument raz?lenjevalnika sme biti NULL
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_FEATURE	TokenNameIdentifier	 ER  FEATURE
,	TokenNameCOMMA	
"Zna?ilnost: {0}"	TokenNameStringLiteral	Zna?ilnost: {0}
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_PROPERTY	TokenNameIdentifier	 ER  PROPERTY
,	TokenNameCOMMA	
"Lastnost: {0}"	TokenNameStringLiteral	Lastnost: {0}
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_NULL_ENTITY_RESOLVER	TokenNameIdentifier	 ER  NULL  ENTITY  RESOLVER
,	TokenNameCOMMA	
"Razre?evalnik entitet NULL"	TokenNameStringLiteral	Razre?evalnik entitet NULL
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_NULL_DTD_HANDLER	TokenNameIdentifier	 ER  NULL  DTD  HANDLER
,	TokenNameCOMMA	
"Program za obravnavanje DTD z vrednostjo NULL"	TokenNameStringLiteral	Program za obravnavanje DTD z vrednostjo NULL
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_NO_DRIVER_NAME_SPECIFIED	TokenNameIdentifier	 ER  NO  DRIVER  NAME  SPECIFIED
...
ER_POOLSIZE_LESS_THAN_ONE	TokenNameIdentifier	 ER  POOLSIZE  LESS  THAN  ONE
,	TokenNameCOMMA	
"Zaloga je manj?a od 1!"	TokenNameStringLiteral	Zaloga je manj?a od 1!
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_INVALID_DRIVER_NAME	TokenNameIdentifier	 ER  INVALID  DRIVER  NAME
,	TokenNameCOMMA	
"Dolo?eno neveljavno ime gonilnika!"	TokenNameStringLiteral	Dolo?eno neveljavno ime gonilnika!
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_ERRORLISTENER	TokenNameIdentifier	 ER  ERRORLISTENER
...
ER_ASSERT_NO_TEMPLATE_PARENT	TokenNameIdentifier	 ER  ASSERT  NO  TEMPLATE  PARENT
,	TokenNameCOMMA	
"Programerjeva napaka! Izraz nima nadrejenega ElemTemplateElement!"	TokenNameStringLiteral	Programerjeva napaka! Izraz nima nadrejenega ElemTemplateElement!
}	TokenNameRBRACE	
,	TokenNameCOMMA	
// Note to translators: The following message should not normally be displayed 	TokenNameCOMMENT_LINE	Note to translators: The following message should not normally be displayed 
// to users. It describes a situation in which the processor has detected 	TokenNameCOMMENT_LINE	to users. It describes a situation in which the processor has detected 
...
ER_ASSERT_REDUNDENT_EXPR_ELIMINATOR	TokenNameIdentifier	 ER  ASSERT  REDUNDENT  EXPR  ELIMINATOR
,	TokenNameCOMMA	
"Programerjeva izjava v RedundentExprEliminator: {0}"	TokenNameStringLiteral	Programerjeva izjava v RedundentExprEliminator: {0}
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_NOT_ALLOWED_IN_POSITION	TokenNameIdentifier	 ER  NOT  ALLOWED  IN  POSITION
,	TokenNameCOMMA	
"Na tem polo?aju v slogovni datoteki {0} ni dovoljen!"	TokenNameStringLiteral	Na tem polo?aju v slogovni datoteki {0} ni dovoljen!
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_NONWHITESPACE_NOT_ALLOWED_IN_POSITION	TokenNameIdentifier	 ER  NONWHITESPACE  NOT  ALLOWED  IN  POSITION
,	TokenNameCOMMA	
"Besedilo, ki niso presledki in drugi podobni znaki, na tem polo?aju v slogovni datoteki ni dovoljeno.!"	TokenNameStringLiteral	Besedilo, ki niso presledki in drugi podobni znaki, na tem polo?aju v slogovni datoteki ni dovoljeno.!
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
INVALID_TCHAR	TokenNameIdentifier	 INVALID  TCHAR
,	TokenNameCOMMA	
"Neveljavna vrednost: {1} uporabljena za atribut CHAR: {0}. Atribut tipa CHAR mora biti samo 1 znak!"	TokenNameStringLiteral	Neveljavna vrednost: {1} uporabljena za atribut CHAR: {0}. Atribut tipa CHAR mora biti samo 1 znak!
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
INVALID_QNAME	TokenNameIdentifier	 INVALID  QNAME
,	TokenNameCOMMA	
"Neveljavna vrednost: {1} uporabljena za atribut QNAME: {0}"	TokenNameStringLiteral	Neveljavna vrednost: {1} uporabljena za atribut QNAME: {0}
}	TokenNameRBRACE	
,	TokenNameCOMMA	
// Note to translators: The following message is used if the value of 	TokenNameCOMMENT_LINE	Note to translators: The following message is used if the value of 
...
INVALID_ENUM	TokenNameIdentifier	 INVALID  ENUM
,	TokenNameCOMMA	
"Neveljavna vrednost: {1} uporabljena za atribut ENUM: {0}. Veljavne vrednosti so: {2}."	TokenNameStringLiteral	Neveljavna vrednost: {1} uporabljena za atribut ENUM: {0}. Veljavne vrednosti so: {2}.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
// Note to translators: The following message is used if the value of 	TokenNameCOMMENT_LINE	Note to translators: The following message is used if the value of 
...
INVALID_NMTOKEN	TokenNameIdentifier	 INVALID  NMTOKEN
,	TokenNameCOMMA	
"Neveljavna vrednost: {1} uporabljena za atribut NMTOKEN: {0} "	TokenNameStringLiteral	Neveljavna vrednost: {1} uporabljena za atribut NMTOKEN: {0} 
}	TokenNameRBRACE	
,	TokenNameCOMMA	
// Note to translators: The following message is used if the value of 	TokenNameCOMMENT_LINE	Note to translators: The following message is used if the value of 
...
INVALID_NCNAME	TokenNameIdentifier	 INVALID  NCNAME
,	TokenNameCOMMA	
"Neveljavna vrednost: {1} uporabljena za atribut NCNAME: {0} "	TokenNameStringLiteral	Neveljavna vrednost: {1} uporabljena za atribut NCNAME: {0} 
}	TokenNameRBRACE	
,	TokenNameCOMMA	
// Note to translators: The following message is used if the value of 	TokenNameCOMMENT_LINE	Note to translators: The following message is used if the value of 
...
INVALID_BOOLEAN	TokenNameIdentifier	 INVALID  BOOLEAN
,	TokenNameCOMMA	
"Neveljavna vrednost: {1} uporabljena za atribut boolean: {0} "	TokenNameStringLiteral	Neveljavna vrednost: {1} uporabljena za atribut boolean: {0} 
}	TokenNameRBRACE	
,	TokenNameCOMMA	
// Note to translators: The following message is used if the value of 	TokenNameCOMMENT_LINE	Note to translators: The following message is used if the value of 
...
INVALID_NUMBER	TokenNameIdentifier	 INVALID  NUMBER
,	TokenNameCOMMA	
"Neveljavna vrednost: {1} uporabljena za atribut number: {0} "	TokenNameStringLiteral	Neveljavna vrednost: {1} uporabljena za atribut number: {0} 
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
ER_ARG_LITERAL	TokenNameIdentifier	 ER  ARG  LITERAL
,	TokenNameCOMMA	
"Argument za {0} v primerjalnem vzorcu mora biti dobesedni niz."	TokenNameStringLiteral	Argument za {0} v primerjalnem vzorcu mora biti dobesedni niz.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
ER_DUPLICATE_GLOBAL_VAR	TokenNameIdentifier	 ER  DUPLICATE  GLOBAL  VAR
,	TokenNameCOMMA	
"Dvojnik deklaracije globalne spremenljivke."	TokenNameStringLiteral	Dvojnik deklaracije globalne spremenljivke.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
// Note to translators: The following message indicates that two definitions of 	TokenNameCOMMENT_LINE	Note to translators: The following message indicates that two definitions of 
...
ER_DUPLICATE_VAR	TokenNameIdentifier	 ER  DUPLICATE  VAR
,	TokenNameCOMMA	
"Dvojnik deklaracije spremenljivke."	TokenNameStringLiteral	Dvojnik deklaracije spremenljivke.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
ER_TEMPLATE_NAME_MATCH	TokenNameIdentifier	 ER  TEMPLATE  NAME  MATCH
,	TokenNameCOMMA	
"xsl:template mora vsebovati atribut name ali match (ali oba)"	TokenNameStringLiteral	xsl:template mora vsebovati atribut name ali match (ali oba)
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
ER_NO_ATTRIB_SET	TokenNameIdentifier	 ER  NO  ATTRIB  SET
,	TokenNameCOMMA	
"Nabor atributov, imenovana {0}, ne obstaja"	TokenNameStringLiteral	Nabor atributov, imenovana {0}, ne obstaja
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
ER_FUNCTION_NOT_FOUND	TokenNameIdentifier	 ER  FUNCTION  NOT  FOUND
,	TokenNameCOMMA	
"Funkcija, imenovana {0}, ne obstaja"	TokenNameStringLiteral	Funkcija, imenovana {0}, ne obstaja
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
ER_CANT_HAVE_CONTENT_AND_SELECT	TokenNameIdentifier	 ER  CANT  HAVE  CONTENT  AND  SELECT
,	TokenNameCOMMA	
"Element {0} ne sme imeti vsebine in atributa izbire hkrati."	TokenNameStringLiteral	Element {0} ne sme imeti vsebine in atributa izbire hkrati.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
ER_INVALID_NAMESPACE_URI_VALUE_FOR_RESULT_PREFIX_FOR_DEFAULT	TokenNameIdentifier	 ER  INVALID  NAMESPACE  URI  VALUE  FOR  RESULT  PREFIX  FOR  DEFAULT
,	TokenNameCOMMA	
"Atribut result-prefix elementa xsl:namespace-alias element ima vrednost '#default' (privzeto), ampak ni deklaracije privzetega imenskega prostora v razponu za ta element."	TokenNameStringLiteral	Atribut result-prefix elementa xsl:namespace-alias element ima vrednost '#default' (privzeto), ampak ni deklaracije privzetega imenskega prostora v razponu za ta element.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_INVALID_NAMESPACE_URI_VALUE_FOR_RESULT_PREFIX	TokenNameIdentifier	 ER  INVALID  NAMESPACE  URI  VALUE  FOR  RESULT  PREFIX
,	TokenNameCOMMA	
"Atribut result-prefix elementa xsl:namespace-alias ima vrednost ''{0}'', ampak ni deklaracije privzetega imenskega prostora za predpono ''{0}'' v razponu za ta element."	TokenNameStringLiteral	Atribut result-prefix elementa xsl:namespace-alias ima vrednost ''{0}'', ampak ni deklaracije privzetega imenskega prostora za predpono ''{0}'' v razponu za ta element.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_SET_FEATURE_NULL_NAME	TokenNameIdentifier	 ER  SET  FEATURE  NULL  NAME
,	TokenNameCOMMA	
"Ime funkcije ne sme biti null v TransformerFactory.getFeature(Ime niza, vrednost boolean)."	TokenNameStringLiteral	Ime funkcije ne sme biti null v TransformerFactory.getFeature(Ime niza, vrednost boolean).
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_GET_FEATURE_NULL_NAME	TokenNameIdentifier	 ER  GET  FEATURE  NULL  NAME
...
ER_EXTENSION_ELEMENT_NOT_ALLOWED_IN_SECURE_PROCESSING	TokenNameIdentifier	 ER  EXTENSION  ELEMENT  NOT  ALLOWED  IN  SECURE  PROCESSING
,	TokenNameCOMMA	
"Uporaba raz?iritvene elementa ''{0}'' ni na voljo, ko je funkcija varnega procesiranja nastavljena na true."	TokenNameStringLiteral	Uporaba raz?iritvene elementa ''{0}'' ni na voljo, ko je funkcija varnega procesiranja nastavljena na true.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_NAMESPACE_CONTEXT_NULL_NAMESPACE	TokenNameIdentifier	 ER  NAMESPACE  CONTEXT  NULL  NAMESPACE
,	TokenNameCOMMA	
"Ni mogo?e dobiti predpone za URI imenskega prostora null."	TokenNameStringLiteral	Ni mogo?e dobiti predpone za URI imenskega prostora null.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_NAMESPACE_CONTEXT_NULL_PREFIX	TokenNameIdentifier	 ER  NAMESPACE  CONTEXT  NULL  PREFIX
,	TokenNameCOMMA	
"Ni mogo?e dobiti URI-ja imenskega prostora za predpono null."	TokenNameStringLiteral	Ni mogo?e dobiti URI-ja imenskega prostora za predpono null.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_XPATH_RESOLVER_NULL_QNAME	TokenNameIdentifier	 ER  XPATH  RESOLVER  NULL  QNAME
,	TokenNameCOMMA	
"Ime funkcije ne more biti ni?."	TokenNameStringLiteral	Ime funkcije ne more biti ni?.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_XPATH_RESOLVER_NEGATIVE_ARITY	TokenNameIdentifier	 ER  XPATH  RESOLVER  NEGATIVE  ARITY
,	TokenNameCOMMA	
"?tevilo argumentov ne more biti negativno"	TokenNameStringLiteral	?tevilo argumentov ne more biti negativno
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
WG_FOUND_CURLYBRACE	TokenNameIdentifier	 WG  FOUND  CURLYBRACE
,	TokenNameCOMMA	
"Najden '}' vendar ni odprtih predlog atributov!"	TokenNameStringLiteral	Najden '}' vendar ni odprtih predlog atributov!
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
WG_COUNT_ATTRIB_MATCHES_NO_ANCESTOR	TokenNameIdentifier	 WG  COUNT  ATTRIB  MATCHES  NO  ANCESTOR
,	TokenNameCOMMA	
"Opozorilo: ?tevni atribut ni skladen s prednikom v xsl:number! Cilj = {0}"	TokenNameStringLiteral	Opozorilo: ?tevni atribut ni skladen s prednikom v xsl:number! Cilj = {0}
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
WG_EXPR_ATTRIB_CHANGED_TO_SELECT	TokenNameIdentifier	 WG  EXPR  ATTRIB  CHANGED  TO  SELECT
,	TokenNameCOMMA	
"Stara sintaksa: Ime atributa 'izraz' je bilo spremenjeno v 'izbira'."	TokenNameStringLiteral	Stara sintaksa: Ime atributa 'izraz' je bilo spremenjeno v 'izbira'.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
WG_NO_LOCALE_IN_FORMATNUMBER	TokenNameIdentifier	 WG  NO  LOCALE  IN  FORMATNUMBER
,	TokenNameCOMMA	
"Xalan ?e ne podpira podro?nih imen v funkciji za oblikovanje ?tevilk."	TokenNameStringLiteral	Xalan ?e ne podpira podro?nih imen v funkciji za oblikovanje ?tevilk.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
WG_LOCALE_NOT_FOUND	TokenNameIdentifier	 WG  LOCALE  NOT  FOUND
,	TokenNameCOMMA	
"Opozorilo: ne najdem podro?nih nastavitev za xml:lang={0}"	TokenNameStringLiteral	Opozorilo: ne najdem podro?nih nastavitev za xml:lang={0}
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
WG_CANNOT_MAKE_URL_FROM	TokenNameIdentifier	 WG  CANNOT  MAKE  URL  FROM
,	TokenNameCOMMA	
"Iz {0} ni mogo?e narediti naslova URL."	TokenNameStringLiteral	Iz {0} ni mogo?e narediti naslova URL.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
WG_CANNOT_LOAD_REQUESTED_DOC	TokenNameIdentifier	 WG  CANNOT  LOAD  REQUESTED  DOC
,	TokenNameCOMMA	
"Ne morem nalo?iti zahtevanega dokumenta: {0}"	TokenNameStringLiteral	Ne morem nalo?iti zahtevanega dokumenta: {0}
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
WG_CANNOT_FIND_COLLATOR	TokenNameIdentifier	 WG  CANNOT  FIND  COLLATOR
,	TokenNameCOMMA	
"Ne najdem kolacionista (collator) za <sort xml:lang={0}"	TokenNameStringLiteral	Ne najdem kolacionista (collator) za <sort xml:lang={0}
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
WG_FUNCTIONS_SHOULD_USE_URL	TokenNameIdentifier	 WG  FUNCTIONS  SHOULD  USE  URL
,	TokenNameCOMMA	
"Stara sintaksa: navodilo za funkcije bi moralo uporabljati URL {0}"	TokenNameStringLiteral	Stara sintaksa: navodilo za funkcije bi moralo uporabljati URL {0}
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
WG_ENCODING_NOT_SUPPORTED_USING_UTF8	TokenNameIdentifier	 WG  ENCODING  NOT  SUPPORTED  USING  UT F8
,	TokenNameCOMMA	
"Kodiranje ni podprto: {0}, uporabljen bo UTF-8"	TokenNameStringLiteral	Kodiranje ni podprto: {0}, uporabljen bo UTF-8
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
WG_ENCODING_NOT_SUPPORTED_USING_JAVA	TokenNameIdentifier	 WG  ENCODING  NOT  SUPPORTED  USING  JAVA
,	TokenNameCOMMA	
"kodiranje ni podprto: {0}, uporabljena bo Java {1}"	TokenNameStringLiteral	kodiranje ni podprto: {0}, uporabljena bo Java {1}
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
WG_SPECIFICITY_CONFLICTS	TokenNameIdentifier	 WG  SPECIFICITY  CONFLICTS
,	TokenNameCOMMA	
"Spori pri specifi?nosti: uporabljen bo zadnji najdeni {0} v slogovni datoteki."	TokenNameStringLiteral	Spori pri specifi?nosti: uporabljen bo zadnji najdeni {0} v slogovni datoteki.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
WG_PARSING_AND_PREPARING	TokenNameIdentifier	 WG  PARSING  AND  PREPARING
,	TokenNameCOMMA	
"========= Poteka raz?lenjevanje in priprava {0} =========="	TokenNameStringLiteral	========= Poteka raz?lenjevanje in priprava {0} ==========
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
WG_ATTR_TEMPLATE	TokenNameIdentifier	 WG  ATTR  TEMPLATE
,	TokenNameCOMMA	
"Predloga atributa, {0}"	TokenNameStringLiteral	Predloga atributa, {0}
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
WG_CONFLICT_BETWEEN_XSLSTRIPSPACE_AND_XSLPRESERVESPACE	TokenNameIdentifier	 WG  CONFLICT  BETWEEN  XSLSTRIPSPACE  AND  XSLPRESERVESPACE
,	TokenNameCOMMA	
"Spor ujemanja med xsl:strip-space in xsl:preserve-space"	TokenNameStringLiteral	Spor ujemanja med xsl:strip-space in xsl:preserve-space
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
WG_ATTRIB_NOT_HANDLED	TokenNameIdentifier	 WG  ATTRIB  NOT  HANDLED
,	TokenNameCOMMA	
"Xalan ?e ne podpira atributa {0}!"	TokenNameStringLiteral	Xalan ?e ne podpira atributa {0}!
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
WG_NO_DECIMALFORMAT_DECLARATION	TokenNameIdentifier	 WG  NO  DECIMALFORMAT  DECLARATION
,	TokenNameCOMMA	
"Deklaracije za decimalno obliko ni bilo mogo?e najti: {0}"	TokenNameStringLiteral	Deklaracije za decimalno obliko ni bilo mogo?e najti: {0}
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
WG_OLD_XSLT_NS	TokenNameIdentifier	 WG  OLD  XSLT  NS
,	TokenNameCOMMA	
"Manjkajo? ali nepravilen imenski prostor XSLT. "	TokenNameStringLiteral	Manjkajo? ali nepravilen imenski prostor XSLT. 
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
WG_ONE_DEFAULT_XSLDECIMALFORMAT_ALLOWED	TokenNameIdentifier	 WG  ONE  DEFAULT  XSLDECIMALFORMAT  ALLOWED
,	TokenNameCOMMA	
"Dovoljena je samo ena privzeta deklaracija xsl:decimal-format."	TokenNameStringLiteral	Dovoljena je samo ena privzeta deklaracija xsl:decimal-format.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
WG_XSLDECIMALFORMAT_NAMES_MUST_BE_UNIQUE	TokenNameIdentifier	 WG  XSLDECIMALFORMAT  NAMES  MUST  BE  UNIQUE
,	TokenNameCOMMA	
"Imena xsl:decimal-format morajo biti enoli?na. Ime "{0}" je bilo podvojeno."	TokenNameStringLiteral	Imena xsl:decimal-format morajo biti enoli?na. Ime "{0}" je bilo podvojeno.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
WG_ILLEGAL_ATTRIBUTE	TokenNameIdentifier	 WG  ILLEGAL  ATTRIBUTE
...
WG_COULD_NOT_RESOLVE_PREFIX	TokenNameIdentifier	 WG  COULD  NOT  RESOLVE  PREFIX
,	TokenNameCOMMA	
"Ne morem razre?iti predpone imenskega prostora: {0}. Vozli??e bo prezrto."	TokenNameStringLiteral	Ne morem razre?iti predpone imenskega prostora: {0}. Vozli??e bo prezrto.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
WG_STYLESHEET_REQUIRES_VERSION_ATTRIB	TokenNameIdentifier	 WG  STYLESHEET  REQUIRES  VERSION  ATTRIB
...
WG_ILLEGAL_ATTRIBUTE_NAME	TokenNameIdentifier	 WG  ILLEGAL  ATTRIBUTE  NAME
,	TokenNameCOMMA	
"Neveljavno ime atributa: {0}"	TokenNameStringLiteral	Neveljavno ime atributa: {0}
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
WG_ILLEGAL_ATTRIBUTE_VALUE	TokenNameIdentifier	 WG  ILLEGAL  ATTRIBUTE  VALUE
,	TokenNameCOMMA	
"Uporabljena neveljavna vrednost za atribut {0}: {1}"	TokenNameStringLiteral	Uporabljena neveljavna vrednost za atribut {0}: {1}
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
WG_EMPTY_SECOND_ARG	TokenNameIdentifier	 WG  EMPTY  SECOND  ARG
,	TokenNameCOMMA	
"Posledi?na skupina vozli?? iz drugega argumenta funkcije dokumenta je prazna. Posredujte prazno skupino vozli??."	TokenNameStringLiteral	Posledi?na skupina vozli?? iz drugega argumenta funkcije dokumenta je prazna. Posredujte prazno skupino vozli??.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
WG_PROCESSINGINSTRUCTION_NAME_CANT_BE_XML	TokenNameIdentifier	 WG  PROCESSINGINSTRUCTION  NAME  CANT  BE  XML
,	TokenNameCOMMA	
"Vrednost atributa 'ime' iz imena xsl:processing-instruction ne sme biti 'xml'"	TokenNameStringLiteral	Vrednost atributa 'ime' iz imena xsl:processing-instruction ne sme biti 'xml'
}	TokenNameRBRACE	
,	TokenNameCOMMA	
// Note to translators: "name" and "xsl:processing-instruction" are keywords 	TokenNameCOMMENT_LINE	Note to translators: "name" and "xsl:processing-instruction" are keywords 
...
WG_PROCESSINGINSTRUCTION_NOTVALID_NCNAME	TokenNameIdentifier	 WG  PROCESSINGINSTRUCTION  NOTVALID  NCNAME
,	TokenNameCOMMA	
"Vrednost atributa ''ime'' iz xsl:processing-instruction mora biti veljavno NCIme: {0}"	TokenNameStringLiteral	Vrednost atributa ''ime'' iz xsl:processing-instruction mora biti veljavno NCIme: {0}
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
NO_MODIFICATION_ALLOWED_ERR	TokenNameIdentifier	 NO  MODIFICATION  ALLOWED  ERR
,	TokenNameCOMMA	
"Izveden je poskus spremembe objekta tam, kjer spremembe niso dovoljene."	TokenNameStringLiteral	Izveden je poskus spremembe objekta tam, kjer spremembe niso dovoljene.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
,	TokenNameCOMMA	
"Parameter za createMessage presega meje"	TokenNameStringLiteral	Parameter za createMessage presega meje
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
...
,	TokenNameCOMMA	
">>>>>>> Razli?ica Xalan "	TokenNameStringLiteral	>>>>>>> Razli?ica Xalan 
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
...
,	TokenNameCOMMA	
"XSLProcessor: dokon?ano"	TokenNameStringLiteral	XSLProcessor: dokon?ano
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
,	TokenNameCOMMA	
"Ukazna vrstica Xalan-J Mo?nosti razreda postopka:"	TokenNameStringLiteral	Ukazna vrstica Xalan-J Mo?nosti razreda postopka:
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
"xslProc_option"	TokenNameStringLiteral	xslProc_option
,	TokenNameCOMMA	
"Ukazna vrstica Xalan-J Mo?nosti razredov postopkov:"	TokenNameStringLiteral	Ukazna vrstica Xalan-J Mo?nosti razredov postopkov:
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
"xslProc_invalid_xsltc_option"	TokenNameStringLiteral	xslProc_invalid_xsltc_option
,	TokenNameCOMMA	
"Mo?nost {0} v na?inu XSLTC ni podprta."	TokenNameStringLiteral	Mo?nost {0} v na?inu XSLTC ni podprta.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
"xslProc_invalid_xalan_option"	TokenNameStringLiteral	xslProc_invalid_xalan_option
,	TokenNameCOMMA	
"Mo?nost {0} se lahko uporablja samo z -XSLTC."	TokenNameStringLiteral	Mo?nost {0} se lahko uporablja samo z -XSLTC.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
"xslProc_no_input"	TokenNameStringLiteral	xslProc_no_input
,	TokenNameCOMMA	
"Napaka: ni dolo?ene slogovne datoteke ali vhodnega xml. Po?enite ta ukaz, za katerega ni na voljo napotkov za uporabo."	TokenNameStringLiteral	Napaka: ni dolo?ene slogovne datoteke ali vhodnega xml. Po?enite ta ukaz, za katerega ni na voljo napotkov za uporabo.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
"xslProc_common_options"	TokenNameStringLiteral	xslProc_common_options
,	TokenNameCOMMA	
"-Splo?ne mo?nosti-"	TokenNameStringLiteral	-Splo?ne mo?nosti-
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
"xslProc_xalan_options"	TokenNameStringLiteral	xslProc_xalan_options
,	TokenNameCOMMA	
"-Mo?nosti za Xalan-"	TokenNameStringLiteral	-Mo?nosti za Xalan-
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
"xslProc_xsltc_options"	TokenNameStringLiteral	xslProc_xsltc_options
,	TokenNameCOMMA	
"-Mo?nosti za XSLTC-"	TokenNameStringLiteral	-Mo?nosti za XSLTC-
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
"xslProc_return_to_continue"	TokenNameStringLiteral	xslProc_return_to_continue
,	TokenNameCOMMA	
"(za nadaljevanje pritisnite <return>)"	TokenNameStringLiteral	(za nadaljevanje pritisnite <return>)
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
,	TokenNameCOMMA	
" [-XSLTC (za preoblikovanje uporabite XSLTC)]"	TokenNameStringLiteral	 [-XSLTC (za preoblikovanje uporabite XSLTC)]
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
"optionIN"	TokenNameStringLiteral	optionIN
,	TokenNameCOMMA	
" [-IN vhodniXMLURL]"	TokenNameStringLiteral	 [-IN vhodniXMLURL]
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
"optionXSL"	TokenNameStringLiteral	optionXSL
,	TokenNameCOMMA	
" [-XSL XSLPreoblikovanjeURL]"	TokenNameStringLiteral	 [-XSL XSLPreoblikovanjeURL]
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
"optionOUT"	TokenNameStringLiteral	optionOUT
,	TokenNameCOMMA	
" [-OUT ImeIzhodneDatoteke]"	TokenNameStringLiteral	 [-OUT ImeIzhodneDatoteke]
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
"optionLXCIN"	TokenNameStringLiteral	optionLXCIN
,	TokenNameCOMMA	
" [-LXCIN ImeVhodneDatotekePrevedeneSlogovneDatoteke]"	TokenNameStringLiteral	 [-LXCIN ImeVhodneDatotekePrevedeneSlogovneDatoteke]
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
"optionLXCOUT"	TokenNameStringLiteral	optionLXCOUT
,	TokenNameCOMMA	
" [-LXCOUT ImeIzhodneDatotekePrevedeneSlogovneDatoteke]"	TokenNameStringLiteral	 [-LXCOUT ImeIzhodneDatotekePrevedeneSlogovneDatoteke]
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
"optionPARSER"	TokenNameStringLiteral	optionPARSER
,	TokenNameCOMMA	
" [-PARSER popolnoma ustrezno ime razreda zveze raz?lenjevalnika]"	TokenNameStringLiteral	 [-PARSER popolnoma ustrezno ime razreda zveze raz?lenjevalnika]
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
"optionE"	TokenNameStringLiteral	optionE
,	TokenNameCOMMA	
" [-E (Ne raz?irjajte sklicev entitet)]"	TokenNameStringLiteral	 [-E (Ne raz?irjajte sklicev entitet)]
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
...
,	TokenNameCOMMA	
" [-QC (Tiha opozorila o sporih vzorcev)]"	TokenNameStringLiteral	 [-QC (Tiha opozorila o sporih vzorcev)]
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
"optionQ"	TokenNameStringLiteral	optionQ
,	TokenNameCOMMA	
" [-Q (Tihi na?in)]"	TokenNameStringLiteral	 [-Q (Tihi na?in)]
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
"optionLF"	TokenNameStringLiteral	optionLF
,	TokenNameCOMMA	
" [-LF (Uporabite pomike samo na izhodu {privzeto je CR/LF})]"	TokenNameStringLiteral	 [-LF (Uporabite pomike samo na izhodu {privzeto je CR/LF})]
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
"optionCR"	TokenNameStringLiteral	optionCR
,	TokenNameCOMMA	
" [-CR (Uporabite prehode v novo vrstico samo na izhodu {privzeto je CR/LF})]"	TokenNameStringLiteral	 [-CR (Uporabite prehode v novo vrstico samo na izhodu {privzeto je CR/LF})]
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
"optionESCAPE"	TokenNameStringLiteral	optionESCAPE
,	TokenNameCOMMA	
" [-ESCAPE (Znaki za izogib {privzeto je <>&"'\r\n}]"	TokenNameStringLiteral	 [-ESCAPE (Znaki za izogib {privzeto je <>&"'\r\n}]
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
"optionINDENT"	TokenNameStringLiteral	optionINDENT
,	TokenNameCOMMA	
" [-INDENT (Koliko presledkov zamika {privzeto je 0})]"	TokenNameStringLiteral	 [-INDENT (Koliko presledkov zamika {privzeto je 0})]
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
"optionTT"	TokenNameStringLiteral	optionTT
,	TokenNameCOMMA	
" [-TT (Sledite predlogam glede na njihov poziv.)]"	TokenNameStringLiteral	 [-TT (Sledite predlogam glede na njihov poziv.)]
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
"optionTG"	TokenNameStringLiteral	optionTG
,	TokenNameCOMMA	
" [-TG (Sledite vsakemu dogodku rodu.)]"	TokenNameStringLiteral	 [-TG (Sledite vsakemu dogodku rodu.)]
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
"optionTS"	TokenNameStringLiteral	optionTS
,	TokenNameCOMMA	
" [-TS (Sledite vsakemu dogodku izbire.)]"	TokenNameStringLiteral	 [-TS (Sledite vsakemu dogodku izbire.)]
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
"optionTTC"	TokenNameStringLiteral	optionTTC
,	TokenNameCOMMA	
" [-TTC (Sledite podrejenim predloge kot se obdelujejo.)]"	TokenNameStringLiteral	 [-TTC (Sledite podrejenim predloge kot se obdelujejo.)]
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
"optionTCLASS"	TokenNameStringLiteral	optionTCLASS
,	TokenNameCOMMA	
" [-TCLASS (Razred TraceListener za kon?nice sledi.)]"	TokenNameStringLiteral	 [-TCLASS (Razred TraceListener za kon?nice sledi.)]
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
"optionVALIDATE"	TokenNameStringLiteral	optionVALIDATE
,	TokenNameCOMMA	
" [-VALIDATE (Nastavi v primeru preverjanja veljavnosti. Privzeta vrednost za preverjanje veljavnosti je izklopljeno.)]"	TokenNameStringLiteral	 [-VALIDATE (Nastavi v primeru preverjanja veljavnosti. Privzeta vrednost za preverjanje veljavnosti je izklopljeno.)]
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
"optionEDUMP"	TokenNameStringLiteral	optionEDUMP
,	TokenNameCOMMA	
" [-EDUMP {izbirno ime datoteke} (V primeru napake naredi izvoz skladov.)]"	TokenNameStringLiteral	 [-EDUMP {izbirno ime datoteke} (V primeru napake naredi izvoz skladov.)]
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
"optionXML"	TokenNameStringLiteral	optionXML
,	TokenNameCOMMA	
" [-XML (Uporabite oblikovalnik XML in dodajte glavo XML.)]"	TokenNameStringLiteral	 [-XML (Uporabite oblikovalnik XML in dodajte glavo XML.)]
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
"optionTEXT"	TokenNameStringLiteral	optionTEXT
,	TokenNameCOMMA	
" [-TEXT (Uporabite preprost oblikovalnik besedila.)]"	TokenNameStringLiteral	 [-TEXT (Uporabite preprost oblikovalnik besedila.)]
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
"optionHTML"	TokenNameStringLiteral	optionHTML
,	TokenNameCOMMA	
" [-HTML (Uporabite oblikovalnik za HTML.)]"	TokenNameStringLiteral	 [-HTML (Uporabite oblikovalnik za HTML.)]
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
"optionPARAM"	TokenNameStringLiteral	optionPARAM
,	TokenNameCOMMA	
" [-PARAM izraz imena (nastavite parameter slogovne datoteke)]"	TokenNameStringLiteral	 [-PARAM izraz imena (nastavite parameter slogovne datoteke)]
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
"noParsermsg1"	TokenNameStringLiteral	noParsermsg1
,	TokenNameCOMMA	
"Postopek XSL ni uspel."	TokenNameStringLiteral	Postopek XSL ni uspel.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
"noParsermsg2"	TokenNameStringLiteral	noParsermsg2
,	TokenNameCOMMA	
"** Nisem na?el raz?lenjevalnika **"	TokenNameStringLiteral	** Nisem na?el raz?lenjevalnika **
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
"noParsermsg3"	TokenNameStringLiteral	noParsermsg3
,	TokenNameCOMMA	
"Preverite pot razreda."	TokenNameStringLiteral	Preverite pot razreda.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
"noParsermsg4"	TokenNameStringLiteral	noParsermsg4
,	TokenNameCOMMA	
"?e nimate IBM raz?lenjevalnika za Javo, ga lahko prenesete iz"	TokenNameStringLiteral	?e nimate IBM raz?lenjevalnika za Javo, ga lahko prenesete iz
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
...
,	TokenNameCOMMA	
" [-URIRESOLVER polno ime razreda (URIResolver za razre?evanje URL-jev)]"	TokenNameStringLiteral	 [-URIRESOLVER polno ime razreda (URIResolver za razre?evanje URL-jev)]
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
"optionENTITYRESOLVER"	TokenNameStringLiteral	optionENTITYRESOLVER
,	TokenNameCOMMA	
" [-ENTITYRESOLVER polno ime razreda (EntityResolver za razre?evanje entitet)]"	TokenNameStringLiteral	 [-ENTITYRESOLVER polno ime razreda (EntityResolver za razre?evanje entitet)]
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
"optionCONTENTHANDLER"	TokenNameStringLiteral	optionCONTENTHANDLER
,	TokenNameCOMMA	
" [-CONTENTHANDLER polno ime razreda (ContentHandler za serializacijo izhoda)]"	TokenNameStringLiteral	 [-CONTENTHANDLER polno ime razreda (ContentHandler za serializacijo izhoda)]
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
"optionLINENUMBERS"	TokenNameStringLiteral	optionLINENUMBERS
,	TokenNameCOMMA	
" [-L za izvorni dokument uporabite ?tevilke vrstic]"	TokenNameStringLiteral	 [-L za izvorni dokument uporabite ?tevilke vrstic]
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
"optionSECUREPROCESSING"	TokenNameStringLiteral	optionSECUREPROCESSING
,	TokenNameCOMMA	
" [-SECURE (nastavite funkcijo varne obdelave na True.)]"	TokenNameStringLiteral	 [-SECURE (nastavite funkcijo varne obdelave na True.)]
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
,	TokenNameCOMMA	
" [-MEDIA TipMedija (z atributom medija poi??ite slogovno datoteko, ki se nana?a na dokument.)]"	TokenNameStringLiteral	 [-MEDIA TipMedija (z atributom medija poi??ite slogovno datoteko, ki se nana?a na dokument.)]
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
"optionFLAVOR"	TokenNameStringLiteral	optionFLAVOR
,	TokenNameCOMMA	
" [-FLAVOR ImePosebnosti (Za preoblikovanje izrecno uporabljajte s2s=SAX ali d2d=DOM.)] "	TokenNameStringLiteral	 [-FLAVOR ImePosebnosti (Za preoblikovanje izrecno uporabljajte s2s=SAX ali d2d=DOM.)] 
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
,	TokenNameCOMMA	
" [-DIAG (Natisnite skupni ?as trajanja pretvorbe v milisekundah.)]"	TokenNameStringLiteral	 [-DIAG (Natisnite skupni ?as trajanja pretvorbe v milisekundah.)]
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
"optionINCREMENTAL"	TokenNameStringLiteral	optionINCREMENTAL
,	TokenNameCOMMA	
" [-INCREMENTAL (zahtevajte gradnjo prirastnega DTM tako, da nastavite http://xml.apache.org/xalan/features/incremental na resni?no.)]"	TokenNameStringLiteral	 [-INCREMENTAL (zahtevajte gradnjo prirastnega DTM tako, da nastavite http://xml.apache.org/xalan/features/incremental na resni?no.)]
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
"optionNOOPTIMIMIZE"	TokenNameStringLiteral	optionNOOPTIMIMIZE
,	TokenNameCOMMA	
" [-NOOPTIMIMIZE (prepre?ite obdelavo optimiziranja slogovne datoteke, tako da nastavite http://xml.apache.org/xalan/features/optimize na false.)]"	TokenNameStringLiteral	 [-NOOPTIMIMIZE (prepre?ite obdelavo optimiziranja slogovne datoteke, tako da nastavite http://xml.apache.org/xalan/features/optimize na false.)]
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
"optionRL"	TokenNameStringLiteral	optionRL
,	TokenNameCOMMA	
" [-RL mejaRekurzije (zahtevajte numeri?no mejo globine rekurzije slogovne datoteke.)]"	TokenNameStringLiteral	 [-RL mejaRekurzije (zahtevajte numeri?no mejo globine rekurzije slogovne datoteke.)]
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
"optionXO"	TokenNameStringLiteral	optionXO
,	TokenNameCOMMA	
" [-XO [imeTransleta] (dodelite ime ustvarjenemu transletu)]"	TokenNameStringLiteral	 [-XO [imeTransleta] (dodelite ime ustvarjenemu transletu)]
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
"optionXD"	TokenNameStringLiteral	optionXD
,	TokenNameCOMMA	
" [-XD ciljnaMapa (navedite ciljno mapo za translet)]"	TokenNameStringLiteral	 [-XD ciljnaMapa (navedite ciljno mapo za translet)]
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
"optionXJ"	TokenNameStringLiteral	optionXJ
,	TokenNameCOMMA	
" [-XJ datotekaJar (zdru?i razrede transleta v datoteko jar z imenom <jarfile>)]"	TokenNameStringLiteral	 [-XJ datotekaJar (zdru?i razrede transleta v datoteko jar z imenom <jarfile>)]
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
"optionXP"	TokenNameStringLiteral	optionXP
,	TokenNameCOMMA	
" [-XP paket (navede predpono imena paketa vsem ustvarjenim razredom transletov)]"	TokenNameStringLiteral	 [-XP paket (navede predpono imena paketa vsem ustvarjenim razredom transletov)]
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
,	TokenNameCOMMA	
" [-XN (omogo?a vstavljanje predlog)]"	TokenNameStringLiteral	 [-XN (omogo?a vstavljanje predlog)]
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
"optionXX"	TokenNameStringLiteral	optionXX
,	TokenNameCOMMA	
" [-XX (vklopi izhod za dodatna sporo?ila za iskanje napak)]"	TokenNameStringLiteral	 [-XX (vklopi izhod za dodatna sporo?ila za iskanje napak)]
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
"optionXT"	TokenNameStringLiteral	optionXT
,	TokenNameCOMMA	
" [-XT (?e je mogo?e, uporabite translet za pretvorbo)]"	TokenNameStringLiteral	 [-XT (?e je mogo?e, uporabite translet za pretvorbo)]
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
"diagTiming"	TokenNameStringLiteral	diagTiming
,	TokenNameCOMMA	
" --------- Pretvorba {0} prek {1} je trajala {2} ms"	TokenNameStringLiteral	 --------- Pretvorba {0} prek {1} je trajala {2} ms
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
"recursionTooDeep"	TokenNameStringLiteral	recursionTooDeep
,	TokenNameCOMMA	
"Predloga pregloboko vgnezdena. Gnezdenje = {0}, predloga {1} {2}"	TokenNameStringLiteral	Predloga pregloboko vgnezdena. Gnezdenje = {0}, predloga {1} {2}
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
"nameIs"	TokenNameStringLiteral	nameIs
,	TokenNameCOMMA	
"ime je"	TokenNameStringLiteral	ime je
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
"matchPatternIs"	TokenNameStringLiteral	matchPatternIs
,	TokenNameCOMMA	
"primerjalni vzorec je"	TokenNameStringLiteral	primerjalni vzorec je
}	TokenNameRBRACE	
}	TokenNameRBRACE	
;	TokenNameSEMICOLON	
}	TokenNameRBRACE	
...
=	TokenNameEQUAL	
"Napaka: "	TokenNameStringLiteral	Napaka: 
;	TokenNameSEMICOLON	
...
=	TokenNameEQUAL	
"Opozorilo: "	TokenNameStringLiteral	Opozorilo: 
;	TokenNameSEMICOLON	
...
=	TokenNameEQUAL	
"VZOREC "	TokenNameStringLiteral	VZOREC 
;	TokenNameSEMICOLON	
