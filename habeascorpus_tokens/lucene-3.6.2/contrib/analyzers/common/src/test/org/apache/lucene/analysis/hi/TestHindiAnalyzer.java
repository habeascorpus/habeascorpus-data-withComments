...
/** * Tests the HindiAnalyzer */	TokenNameCOMMENT_JAVADOC	 Tests the HindiAnalyzer 
public	TokenNamepublic	
class	TokenNameclass	
TestHindiAnalyzer	TokenNameIdentifier	 Test Hindi Analyzer
...
{	TokenNameLBRACE	
new	TokenNamenew	
HindiAnalyzer	TokenNameIdentifier	 Hindi Analyzer
(	TokenNameLPAREN	
...
;	TokenNameSEMICOLON	
// two ways to write 'hindi' itself. 	TokenNameCOMMENT_LINE	two ways to write 'hindi' itself. 
checkOneTermReuse	TokenNameIdentifier	 check One Term Reuse
(	TokenNameLPAREN	
a	TokenNameIdentifier	 a
,	TokenNameCOMMA	
"हिन्दी"	TokenNameStringLiteral	हिन्दी
,	TokenNameCOMMA	
"हिंद"	TokenNameStringLiteral	हिंद
)	TokenNameRPAREN	
;	TokenNameSEMICOLON	
checkOneTermReuse	TokenNameIdentifier	 check One Term Reuse
(	TokenNameLPAREN	
a	TokenNameIdentifier	 a
,	TokenNameCOMMA	
"हिंदी"	TokenNameStringLiteral	हिंदी
,	TokenNameCOMMA	
"हिंद"	TokenNameStringLiteral	हिंद
)	TokenNameRPAREN	
;	TokenNameSEMICOLON	
...
public	TokenNamepublic	
void	TokenNamevoid	
testExclusionSet	TokenNameIdentifier	 test Exclusion Set
(	TokenNameLPAREN	
)	TokenNameRPAREN	
throws	TokenNamethrows	
Exception	TokenNameIdentifier	 Exception
