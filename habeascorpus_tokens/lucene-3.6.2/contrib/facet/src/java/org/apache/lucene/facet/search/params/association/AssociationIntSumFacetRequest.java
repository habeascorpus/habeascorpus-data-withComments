...
/** * Facet request for weighting facets according to their integer association by * summing the association values. * * @lucene.experimental */	TokenNameCOMMENT_JAVADOC	 Facet request for weighting facets according to their integer association by summing the association values. * @lucene.experimental 
...
FacetRequest	TokenNameIdentifier	 Facet Request
{	TokenNameLBRACE	
/** * Create an integer association facet request for a given node in the * taxonomy. */	TokenNameCOMMENT_JAVADOC	 Create an integer association facet request for a given node in the taxonomy. 
public	TokenNamepublic	
AssociationIntSumFacetRequest	TokenNameIdentifier	 Association Int Sum Facet Request
(	TokenNameLPAREN	
CategoryPath	TokenNameIdentifier	 Category Path
