...
/* * $Id: XMLErrorResources_sk.java 468653 2006-10-28 07:07:05Z minchau $ */	TokenNameCOMMENT_BLOCK	 $Id: XMLErrorResources_sk.java 468653 2006-10-28 07:07:05Z minchau $ 
...
XMLErrorResources_sk	TokenNameIdentifier	 XML Error Resources sk
...
ER_CANNOT_OVERWRITE_CAUSE	TokenNameIdentifier	 ER  CANNOT  OVERWRITE  CAUSE
,	TokenNameCOMMA	
"Nie je mo?né prepísa? prí?inu"	TokenNameStringLiteral	Nie je mo?né prepísa? prí?inu
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_NO_DEFAULT_IMPL	TokenNameIdentifier	 ER  NO  DEFAULT  IMPL
,	TokenNameCOMMA	
"Nebola nájdená ?iadna predvolená implementácia "	TokenNameStringLiteral	Nebola nájdená ?iadna predvolená implementácia 
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_CHUNKEDINTARRAY_NOT_SUPPORTED	TokenNameIdentifier	 ER  CHUNKEDINTARRAY  NOT  SUPPORTED
,	TokenNameCOMMA	
"ChunkedIntArray({0}) nie je momentálne podporovan?"	TokenNameStringLiteral	ChunkedIntArray({0}) nie je momentálne podporovan?
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_OFFSET_BIGGER_THAN_SLOT	TokenNameIdentifier	 ER  OFFSET  BIGGER  THAN  SLOT
,	TokenNameCOMMA	
"Offset vä??í, ne? zásuvka"	TokenNameStringLiteral	Offset vä??í, ne? zásuvka
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_COROUTINE_NOT_AVAIL	TokenNameIdentifier	 ER  COROUTINE  NOT  AVAIL
,	TokenNameCOMMA	
"Ko-rutina nie je dostupná, id={0}"	TokenNameStringLiteral	Ko-rutina nie je dostupná, id={0}
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_COROUTINE_CO_EXIT	TokenNameIdentifier	 ER  COROUTINE  CO  EXIT
,	TokenNameCOMMA	
"CoroutineManager obdr?al po?iadavku co_exit()"	TokenNameStringLiteral	CoroutineManager obdr?al po?iadavku co_exit()
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_COJOINROUTINESET_FAILED	TokenNameIdentifier	 ER  COJOINROUTINESET  FAILED
,	TokenNameCOMMA	
"zlyhal co_joinCoroutineSet()"	TokenNameStringLiteral	zlyhal co_joinCoroutineSet()
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_COROUTINE_PARAM	TokenNameIdentifier	 ER  COROUTINE  PARAM
,	TokenNameCOMMA	
"Chyba parametra korutiny ({0})"	TokenNameStringLiteral	Chyba parametra korutiny ({0})
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_PARSER_DOTERMINATE_ANSWERS	TokenNameIdentifier	 ER  PARSER  DOTERMINATE  ANSWERS
,	TokenNameCOMMA	
" NEO?AKÁVANÉ: Analyzátor doTerminate odpovedá {0}"	TokenNameStringLiteral	 NEO?AKÁVANÉ: Analyzátor doTerminate odpovedá {0}
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_NO_PARSE_CALL_WHILE_PARSING	TokenNameIdentifier	 ER  NO  PARSE  CALL  WHILE  PARSING
,	TokenNameCOMMA	
"syntaktick? analyzátor nemô?e by? volan? po?as vykonávania anal?zy"	TokenNameStringLiteral	syntaktick? analyzátor nemô?e by? volan? po?as vykonávania anal?zy
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_TYPED_ITERATOR_AXIS_NOT_IMPLEMENTED	TokenNameIdentifier	 ER  TYPED  ITERATOR  AXIS  NOT  IMPLEMENTED
,	TokenNameCOMMA	
"Chyba: napísan? iterátor pre os {0} nie je implementovan?"	TokenNameStringLiteral	Chyba: napísan? iterátor pre os {0} nie je implementovan?
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_ITERATOR_AXIS_NOT_IMPLEMENTED	TokenNameIdentifier	 ER  ITERATOR  AXIS  NOT  IMPLEMENTED
,	TokenNameCOMMA	
"Chyba: iterátor pre os {0} nie je implementovan? "	TokenNameStringLiteral	Chyba: iterátor pre os {0} nie je implementovan? 
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_ITERATOR_CLONE_NOT_SUPPORTED	TokenNameIdentifier	 ER  ITERATOR  CLONE  NOT  SUPPORTED
,	TokenNameCOMMA	
"Klon iterátora nie je podporovan?"	TokenNameStringLiteral	Klon iterátora nie je podporovan?
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_UNKNOWN_AXIS_TYPE	TokenNameIdentifier	 ER  UNKNOWN  AXIS  TYPE
,	TokenNameCOMMA	
"Neznámy typ pretínania osí: {0}"	TokenNameStringLiteral	Neznámy typ pretínania osí: {0}
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_AXIS_NOT_SUPPORTED	TokenNameIdentifier	 ER  AXIS  NOT  SUPPORTED
,	TokenNameCOMMA	
"Pretínanie osí nie je podporované: {0}"	TokenNameStringLiteral	Pretínanie osí nie je podporované: {0}
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_NO_DTMIDS_AVAIL	TokenNameIdentifier	 ER  NO  DTMIDS  AVAIL
,	TokenNameCOMMA	
"?iadne ?al?ie DTM ID nie sú dostupné"	TokenNameStringLiteral	?iadne ?al?ie DTM ID nie sú dostupné
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_NOT_SUPPORTED	TokenNameIdentifier	 ER  NOT  SUPPORTED
...
ER_NODE_NON_NULL	TokenNameIdentifier	 ER  NODE  NON  NULL
,	TokenNameCOMMA	
"Pre getDTMHandleFromNode musí by? uzol nenulov?"	TokenNameStringLiteral	Pre getDTMHandleFromNode musí by? uzol nenulov?
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_COULD_NOT_RESOLVE_NODE	TokenNameIdentifier	 ER  COULD  NOT  RESOLVE  NODE
,	TokenNameCOMMA	
"Nebolo mo?né ur?i? uzol na spracovanie"	TokenNameStringLiteral	Nebolo mo?né ur?i? uzol na spracovanie
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_STARTPARSE_WHILE_PARSING	TokenNameIdentifier	 ER  STARTPARSE  WHILE  PARSING
,	TokenNameCOMMA	
"startParse nemô?e by? volan? po?as vykonávania anal?zy"	TokenNameStringLiteral	startParse nemô?e by? volan? po?as vykonávania anal?zy
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_STARTPARSE_NEEDS_SAXPARSER	TokenNameIdentifier	 ER  STARTPARSE  NEEDS  SAXPARSER
,	TokenNameCOMMA	
"startParse potrebuje nenulov? SAXParser"	TokenNameStringLiteral	startParse potrebuje nenulov? SAXParser
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_COULD_NOT_INIT_PARSER	TokenNameIdentifier	 ER  COULD  NOT  INIT  PARSER
,	TokenNameCOMMA	
"Nebolo mo?né inicializova? syntaktick? analyzátor pomocou"	TokenNameStringLiteral	Nebolo mo?né inicializova? syntaktick? analyzátor pomocou
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_EXCEPTION_CREATING_POOL	TokenNameIdentifier	 ER  EXCEPTION  CREATING  POOL
,	TokenNameCOMMA	
"v?nimka vytvárania novej in?tancie oblasti"	TokenNameStringLiteral	v?nimka vytvárania novej in?tancie oblasti
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_PATH_CONTAINS_INVALID_ESCAPE_SEQUENCE	TokenNameIdentifier	 ER  PATH  CONTAINS  INVALID  ESCAPE  SEQUENCE
...
ER_NO_SCHEME_IN_URI	TokenNameIdentifier	 ER  NO  SCHEME  IN  URI
,	TokenNameCOMMA	
"V URI sa nena?la ?iadna schéma: {0}"	TokenNameStringLiteral	V URI sa nena?la ?iadna schéma: {0}
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_NO_SCHEME_INURI	TokenNameIdentifier	 ER  NO  SCHEME  INURI
...
ER_PARSER_IN_USE	TokenNameIdentifier	 ER  PARSER  IN  USE
,	TokenNameCOMMA	
"Syntaktick? analyzátor je u? pou?ívan?"	TokenNameStringLiteral	Syntaktick? analyzátor je u? pou?ívan?
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_CANNOT_CHANGE_WHILE_PARSING	TokenNameIdentifier	 ER  CANNOT  CHANGE  WHILE  PARSING
,	TokenNameCOMMA	
"Nie je mo?né zmeni? {0} {1} po?as vykonávania anal?zy"	TokenNameStringLiteral	Nie je mo?né zmeni? {0} {1} po?as vykonávania anal?zy
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_SELF_CAUSATION_NOT_PERMITTED	TokenNameIdentifier	 ER  SELF  CAUSATION  NOT  PERMITTED
,	TokenNameCOMMA	
"Samozaprí?inenie nie je povolené"	TokenNameStringLiteral	Samozaprí?inenie nie je povolené
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_NO_USERINFO_IF_NO_HOST	TokenNameIdentifier	 ER  NO  USERINFO  IF  NO  HOST
...
ER_METHOD_NOT_SUPPORTED	TokenNameIdentifier	 ER  METHOD  NOT  SUPPORTED
,	TokenNameCOMMA	
"Metóda e?te nie je podporovaná "	TokenNameStringLiteral	Metóda e?te nie je podporovaná 
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_INCRSAXSRCFILTER_NOT_RESTARTABLE	TokenNameIdentifier	 ER  INCRSAXSRCFILTER  NOT  RESTARTABLE
,	TokenNameCOMMA	
"IncrementalSAXSource_Filter nie je momentálne re?tartovate?n?"	TokenNameStringLiteral	IncrementalSAXSource_Filter nie je momentálne re?tartovate?n?
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_XMLRDR_NOT_BEFORE_STARTPARSE	TokenNameIdentifier	 ER  XMLRDR  NOT  BEFORE  STARTPARSE
,	TokenNameCOMMA	
"XMLReader nepredchádza po?iadavke na startParse"	TokenNameStringLiteral	XMLReader nepredchádza po?iadavke na startParse
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_AXIS_TRAVERSER_NOT_SUPPORTED	TokenNameIdentifier	 ER  AXIS  TRAVERSER  NOT  SUPPORTED
...
ER_ERRORHANDLER_CREATED_WITH_NULL_PRINTWRITER	TokenNameIdentifier	 ER  ERRORHANDLER  CREATED  WITH  NULL  PRINTWRITER
,	TokenNameCOMMA	
"ListingErrorHandler vytvoren? s nulov?m PrintWriter!"	TokenNameStringLiteral	ListingErrorHandler vytvoren? s nulov?m PrintWriter!
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_SYSTEMID_UNKNOWN	TokenNameIdentifier	 ER  SYSTEMID  UNKNOWN
,	TokenNameCOMMA	
"Neznáme SystemId"	TokenNameStringLiteral	Neznáme SystemId
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_LOCATION_UNKNOWN	TokenNameIdentifier	 ER  LOCATION  UNKNOWN
,	TokenNameCOMMA	
"Neznáme miesto v?skytu chyby"	TokenNameStringLiteral	Neznáme miesto v?skytu chyby
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_PREFIX_MUST_RESOLVE	TokenNameIdentifier	 ER  PREFIX  MUST  RESOLVE
...
ER_CREATEDOCUMENT_NOT_SUPPORTED	TokenNameIdentifier	 ER  CREATEDOCUMENT  NOT  SUPPORTED
,	TokenNameCOMMA	
"createDocument() nie je podporované XPathContext!"	TokenNameStringLiteral	createDocument() nie je podporované XPathContext!
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_CHILD_HAS_NO_OWNER_DOCUMENT	TokenNameIdentifier	 ER  CHILD  HAS  NO  OWNER  DOCUMENT
,	TokenNameCOMMA	
"Potomok atribútu nemá dokument vlastníka!"	TokenNameStringLiteral	Potomok atribútu nemá dokument vlastníka!
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_CHILD_HAS_NO_OWNER_DOCUMENT_ELEMENT	TokenNameIdentifier	 ER  CHILD  HAS  NO  OWNER  DOCUMENT  ELEMENT
,	TokenNameCOMMA	
"Potomok atribútu nemá sú?as? dokumentu vlastníka!"	TokenNameStringLiteral	Potomok atribútu nemá sú?as? dokumentu vlastníka!
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_CANT_OUTPUT_TEXT_BEFORE_DOC	TokenNameIdentifier	 ER  CANT  OUTPUT  TEXT  BEFORE  DOC
,	TokenNameCOMMA	
"Upozornenie: nemo?no vypusti? text pred elementom dokumentu! Ignorovanie..."	TokenNameStringLiteral	Upozornenie: nemo?no vypusti? text pred elementom dokumentu! Ignorovanie...
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_CANT_HAVE_MORE_THAN_ONE_ROOT	TokenNameIdentifier	 ER  CANT  HAVE  MORE  THAN  ONE  ROOT
,	TokenNameCOMMA	
"Nie je mo?né ma? viac, ne? jeden kore? DOM!"	TokenNameStringLiteral	Nie je mo?né ma? viac, ne? jeden kore? DOM!
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_ARG_LOCALNAME_NULL	TokenNameIdentifier	 ER  ARG  LOCALNAME  NULL
,	TokenNameCOMMA	
"Argument 'localName' je nulov?"	TokenNameStringLiteral	Argument 'localName' je nulov?
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
ER_ARG_LOCALNAME_INVALID	TokenNameIdentifier	 ER  ARG  LOCALNAME  INVALID
,	TokenNameCOMMA	
"Lokálny názov v QNAME by mal by? platn?m NCName"	TokenNameStringLiteral	Lokálny názov v QNAME by mal by? platn?m NCName
}	TokenNameRBRACE	
,	TokenNameCOMMA	
// Note to translators: A QNAME has the syntactic form [NCName:]NCName 	TokenNameCOMMENT_LINE	Note to translators: A QNAME has the syntactic form [NCName:]NCName 
...
ER_ARG_PREFIX_INVALID	TokenNameIdentifier	 ER  ARG  PREFIX  INVALID
,	TokenNameCOMMA	
"Predpona v QNAME by mala by? platn?m NCName"	TokenNameStringLiteral	Predpona v QNAME by mala by? platn?m NCName
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_NAME_CANT_START_WITH_COLON	TokenNameIdentifier	 ER  NAME  CANT  START  WITH  COLON
,	TokenNameCOMMA	
"Názov sa nemô?e za?ína? dvojbodkou."	TokenNameStringLiteral	Názov sa nemô?e za?ína? dvojbodkou.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
