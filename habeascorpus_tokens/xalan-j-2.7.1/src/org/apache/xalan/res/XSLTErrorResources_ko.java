...
/* * $Id: XSLTErrorResources_ko.java 468641 2006-10-28 06:54:42Z minchau $ */	TokenNameCOMMENT_BLOCK	 $Id: XSLTErrorResources_ko.java 468641 2006-10-28 06:54:42Z minchau $ 
...
XSLTErrorResources_ko	TokenNameIdentifier	 XSLT Error Resources ko
...
ER_NULL_SOURCENODE_APPLYIMPORTS	TokenNameIdentifier	 ER  NULL  SOURCENODE  APPLYIMPORTS
,	TokenNameCOMMA	
"xsl:apply-imports?? sourceNode? ?(null)???."	TokenNameStringLiteral	xsl:apply-imports?? sourceNode? ?(null)???.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_CANNOT_ADD	TokenNameIdentifier	 ER  CANNOT  ADD
...
ER_NULL_SOURCENODE_HANDLEAPPLYTEMPLATES	TokenNameIdentifier	 ER  NULL  SOURCENODE  HANDLEAPPLYTEMPLATES
,	TokenNameCOMMA	
"handleApplyTemplatesInstruction?? sourceNode? ?(null)???."	TokenNameStringLiteral	handleApplyTemplatesInstruction?? sourceNode? ?(null)???.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_NO_NAME_ATTRIB	TokenNameIdentifier	 ER  NO  NAME  ATTRIB
...
ER_XMLSPACE_ILLEGAL_VAL	TokenNameIdentifier	 ER  XMLSPACE  ILLEGAL  VAL
,	TokenNameCOMMA	
"(StylesheetHandler) xml:??? ???? ?? ?? ????: {0}"	TokenNameStringLiteral	(StylesheetHandler) xml:??? ???? ?? ?? ????: {0}
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_PROCESSSTYLESHEET_NOT_SUCCESSFUL	TokenNameIdentifier	 ER  PROCESSSTYLESHEET  NOT  SUCCESSFUL
...
ER_DOCUMENT_FUNCTION_INVALID_IN_STYLESHEET_DOM	TokenNameIdentifier	 ER  DOCUMENT  FUNCTION  INVALID  IN  STYLESHEET  DOM
,	TokenNameCOMMA	
"????? DOM?? Document ??? ???? ????."	TokenNameStringLiteral	????? DOM?? Document ??? ???? ????.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_CANT_RESOLVE_PREFIX_OF_NON_PREFIX_RESOLVER	TokenNameIdentifier	 ER  CANT  RESOLVE  PREFIX  OF  NON  PREFIX  RESOLVER
...
ER_REDIRECT_COULDNT_GET_FILENAME	TokenNameIdentifier	 ER  REDIRECT  COULDNT  GET  FILENAME
,	TokenNameCOMMA	
"Redirect extension: ?? ??? ??? ? ????. ?? ?? ??? ??? ??? ???? ???? ???."	TokenNameStringLiteral	Redirect extension: ?? ??? ??? ? ????. ?? ?? ??? ??? ??? ???? ???? ???.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_CANNOT_BUILD_FORMATTERLISTENER_IN_REDIRECT	TokenNameIdentifier	 ER  CANNOT  BUILD  FORMATTERLISTENER  IN  REDIRECT
...
ER_INVALID_UTF16_SURROGATE	TokenNameIdentifier	 ER  INVALID  UT F16  SURROGATE
,	TokenNameCOMMA	
"??? UTF-16 ???(surrogate)? ???????: {0}"	TokenNameStringLiteral	??? UTF-16 ???(surrogate)? ???????: {0}
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_XSLATTRSET_USED_ITSELF	TokenNameIdentifier	 ER  XSLATTRSET  USED  ITSELF
...
ER_ILLEGAL_DOMSOURCE_INPUT	TokenNameIdentifier	 ER  ILLEGAL  DOMSOURCE  INPUT
,	TokenNameCOMMA	
"newTemplates? DOMSource? ?? ?? ??? ?(null)? ? ? ????."	TokenNameStringLiteral	newTemplates? DOMSource? ?? ?? ??? ?(null)? ? ? ????.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_CLASS_NOT_FOUND_FOR_OPTION	TokenNameIdentifier	 ER  CLASS  NOT  FOUND  FOR  OPTION
...
ER_INPUT_CANNOT_BE_NULL	TokenNameIdentifier	 ER  INPUT  CANNOT  BE  NULL
,	TokenNameCOMMA	
"InputStream? ?(null)? ? ? ????."	TokenNameStringLiteral	InputStream? ?(null)? ? ? ????.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_URI_CANNOT_BE_NULL	TokenNameIdentifier	 ER  URI  CANNOT  BE  NULL
,	TokenNameCOMMA	
"URI? ?(null)? ? ? ????."	TokenNameStringLiteral	URI? ?(null)? ? ? ????.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_FILE_CANNOT_BE_NULL	TokenNameIdentifier	 ER  FILE  CANNOT  BE  NULL
...
ER_SOURCE_CANNOT_BE_NULL	TokenNameIdentifier	 ER  SOURCE  CANNOT  BE  NULL
,	TokenNameCOMMA	
"InputSource? ?(null)? ? ? ????."	TokenNameStringLiteral	InputSource? ?(null)? ? ? ????.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_CANNOT_INIT_BSFMGR	TokenNameIdentifier	 ER  CANNOT  INIT  BSFMGR
...
ER_NO_STYLESHEET_PI	TokenNameIdentifier	 ER  NO  STYLESHEET  PI
,	TokenNameCOMMA	
"{0}? xml-????? PI? ????."	TokenNameStringLiteral	{0}? xml-????? PI? ????.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_NOT_SUPPORTED	TokenNameIdentifier	 ER  NOT  SUPPORTED
...
ER_NULL_URI_NAMESPACE	TokenNameIdentifier	 ER  NULL  URI  NAMESPACE
,	TokenNameCOMMA	
"?(null) URI? ?? ?? ???? ????? ???."	TokenNameStringLiteral	?(null) URI? ?? ?? ???? ????? ???.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
ER_NULL_DTD_HANDLER	TokenNameIdentifier	 ER  NULL  DTD  HANDLER
,	TokenNameCOMMA	
"?(null) DTD ???"	TokenNameStringLiteral	?(null) DTD ???
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_NO_DRIVER_NAME_SPECIFIED	TokenNameIdentifier	 ER  NO  DRIVER  NAME  SPECIFIED
...
INVALID_TCHAR	TokenNameIdentifier	 INVALID  TCHAR
,	TokenNameCOMMA	
"{0} CHAR ??? ?? ??? {1} ?? ???? ????. CHAR ??? ??? 1??? ???."	TokenNameStringLiteral	{0} CHAR ??? ?? ??? {1} ?? ???? ????. CHAR ??? ??? 1??? ???.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
INVALID_QNAME	TokenNameIdentifier	 INVALID  QNAME
,	TokenNameCOMMA	
"{0} QNAME ??? ?? ??? {1} ?? ???? ????."	TokenNameStringLiteral	{0} QNAME ??? ?? ??? {1} ?? ???? ????.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
// Note to translators: The following message is used if the value of 	TokenNameCOMMENT_LINE	Note to translators: The following message is used if the value of 
...
INVALID_ENUM	TokenNameIdentifier	 INVALID  ENUM
,	TokenNameCOMMA	
"{0} ENUM ??? ?? ??? {1} ?? ???? ????. ??? ?? {2}???."	TokenNameStringLiteral	{0} ENUM ??? ?? ??? {1} ?? ???? ????. ??? ?? {2}???.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
// Note to translators: The following message is used if the value of 	TokenNameCOMMENT_LINE	Note to translators: The following message is used if the value of 
...
INVALID_NMTOKEN	TokenNameIdentifier	 INVALID  NMTOKEN
,	TokenNameCOMMA	
"{0} NMTOKEN ??? ?? ??? {1} ?? ???? ????. "	TokenNameStringLiteral	{0} NMTOKEN ??? ?? ??? {1} ?? ???? ????. 
}	TokenNameRBRACE	
,	TokenNameCOMMA	
// Note to translators: The following message is used if the value of 	TokenNameCOMMENT_LINE	Note to translators: The following message is used if the value of 
...
INVALID_NCNAME	TokenNameIdentifier	 INVALID  NCNAME
,	TokenNameCOMMA	
"{0} NCNAME ??? ?? ??? {1} ?? ???? ????. "	TokenNameStringLiteral	{0} NCNAME ??? ?? ??? {1} ?? ???? ????. 
}	TokenNameRBRACE	
,	TokenNameCOMMA	
// Note to translators: The following message is used if the value of 	TokenNameCOMMENT_LINE	Note to translators: The following message is used if the value of 
...
ER_NO_ATTRIB_SET	TokenNameIdentifier	 ER  NO  ATTRIB  SET
,	TokenNameCOMMA	
"??? {0}? attribute-set? ????."	TokenNameStringLiteral	??? {0}? attribute-set? ????.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
ER_SET_FEATURE_NULL_NAME	TokenNameIdentifier	 ER  SET  FEATURE  NULL  NAME
,	TokenNameCOMMA	
"TransformerFactory.setFeature(??? ??, ?? ?)?? ?? ??? ?(null)?? ????."	TokenNameStringLiteral	TransformerFactory.setFeature(??? ??, ?? ?)?? ?? ??? ?(null)?? ????.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_GET_FEATURE_NULL_NAME	TokenNameIdentifier	 ER  GET  FEATURE  NULL  NAME
,	TokenNameCOMMA	
"TransformerFactory.getFeature(??? ??)?? ?? ??? ?(null)?? ????."	TokenNameStringLiteral	TransformerFactory.getFeature(??? ??)?? ?? ??? ?(null)?? ????.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_UNSUPPORTED_FEATURE	TokenNameIdentifier	 ER  UNSUPPORTED  FEATURE
...
WG_COUNT_ATTRIB_MATCHES_NO_ANCESTOR	TokenNameIdentifier	 WG  COUNT  ATTRIB  MATCHES  NO  ANCESTOR
,	TokenNameCOMMA	
"??: ?? ??? xsl:number? ?? ??? ???? ????. ?? = {0}"	TokenNameStringLiteral	??: ?? ??? xsl:number? ?? ??? ???? ????. ?? = {0}
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
WG_EXPR_ATTRIB_CHANGED_TO_SELECT	TokenNameIdentifier	 WG  EXPR  ATTRIB  CHANGED  TO  SELECT
...
WG_CANNOT_FIND_COLLATOR	TokenNameIdentifier	 WG  CANNOT  FIND  COLLATOR
,	TokenNameCOMMA	
"<sort xml:lang={0}? ?? Collator? ?? ? ????."	TokenNameStringLiteral	<sort xml:lang={0}? ?? Collator? ?? ? ????.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
WG_FUNCTIONS_SHOULD_USE_URL	TokenNameIdentifier	 WG  FUNCTIONS  SHOULD  USE  URL
...
WG_ATTR_TEMPLATE	TokenNameIdentifier	 WG  ATTR  TEMPLATE
,	TokenNameCOMMA	
"Attr ????, {0}"	TokenNameStringLiteral	Attr ????, {0}
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
WG_CONFLICT_BETWEEN_XSLSTRIPSPACE_AND_XSLPRESERVESPACE	TokenNameIdentifier	 WG  CONFLICT  BETWEEN  XSLSTRIPSPACE  AND  XSLPRESERVESPACE
...
WG_EMPTY_SECOND_ARG	TokenNameIdentifier	 WG  EMPTY  SECOND  ARG
,	TokenNameCOMMA	
"document ?? ? ?? ?????? ?? nodeset? ?? ????. ? ?? ??? ??????."	TokenNameStringLiteral	document ?? ? ?? ?????? ?? nodeset? ?? ????. ? ?? ??? ??????.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
,	TokenNameCOMMA	
"Xalan-J ??? ???? ??? ??:"	TokenNameStringLiteral	Xalan-J ??? ???? ??? ??:
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
"xslProc_option"	TokenNameStringLiteral	xslProc_option
...
,	TokenNameCOMMA	
"[-PARSER ?? ??? liaison? ??? ??? ??]"	TokenNameStringLiteral	[-PARSER ?? ??? liaison? ??? ??? ??]
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
"optionE"	TokenNameStringLiteral	optionE
,	TokenNameCOMMA	
"[-E(??? ref? ??? ??)]"	TokenNameStringLiteral	[-E(??? ref? ??? ??)]
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
...
,	TokenNameCOMMA	
"[-VALIDATE(??? ?? ?? ?? ??. ?????? ??? ??? off? ???.)]"	TokenNameStringLiteral	[-VALIDATE(??? ?? ?? ?? ??. ?????? ??? ??? off? ???.)]
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
"optionEDUMP"	TokenNameStringLiteral	optionEDUMP
,	TokenNameCOMMA	
"[-EDUMP{optional filename}(?? ? stackdump ??)]"	TokenNameStringLiteral	[-EDUMP{optional filename}(?? ? stackdump ??)]
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
...
,	TokenNameCOMMA	
"Java? IBM XML ?? ???? ?? ?? ???? ????? ? ????. "	TokenNameStringLiteral	Java? IBM XML ?? ???? ?? ?? ???? ????? ? ????. 
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
...
,	TokenNameCOMMA	
"[-XJ jarfile(??? <jarfile>? jar ??? translet ??? ???)]"	TokenNameStringLiteral	[-XJ jarfile(??? <jarfile>? jar ??? translet ??? ???)]
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
...
,	TokenNameCOMMA	
"--------- {1}?(?) ?? {0} ??? {2}ms? ???????."	TokenNameStringLiteral	--------- {1}?(?) ?? {0} ??? {2}ms? ???????.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
