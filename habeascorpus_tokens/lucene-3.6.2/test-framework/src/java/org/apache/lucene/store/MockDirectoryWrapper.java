...
{	TokenNameLBRACE	
// don't wear out our hardware so much in tests. 	TokenNameCOMMENT_LINE	don't wear out our hardware so much in tests. 
delegate	TokenNameIdentifier	 delegate
.	TokenNameDOT	
sync	TokenNameIdentifier	 sync
(	TokenNameLPAREN	
...
;	TokenNameSEMICOLON	
int	TokenNameint	
damage	TokenNameIdentifier	 damage
=	TokenNameEQUAL	
randomState	TokenNameIdentifier	 random State
.	TokenNameDOT	
nextInt	TokenNameIdentifier	 next Int
...
action	TokenNameIdentifier	 action
=	TokenNameEQUAL	
"zeroed"	TokenNameStringLiteral	zeroed
;	TokenNameSEMICOLON	
...
action	TokenNameIdentifier	 action
=	TokenNameEQUAL	
"partially truncated"	TokenNameStringLiteral	partially truncated
;	TokenNameSEMICOLON	
// Partially Truncate the file: 	TokenNameCOMMENT_LINE	Partially Truncate the file: 
// First, make temp file and copy only half this 	TokenNameCOMMENT_LINE	First, make temp file and copy only half this 
// file over: 	TokenNameCOMMENT_LINE	file over: 
String	TokenNameIdentifier	 String
tempFileName	TokenNameIdentifier	 temp File Name
;	TokenNameSEMICOLON	
while	TokenNamewhile	
(	TokenNameLPAREN	
true	TokenNametrue	
...
final	TokenNamefinal	
IndexOutput	TokenNameIdentifier	 Index Output
tempOut	TokenNameIdentifier	 temp Out
=	TokenNameEQUAL	
delegate	TokenNameIdentifier	 delegate
.	TokenNameDOT	
createOutput	TokenNameIdentifier	 create Output
...
;	TokenNameSEMICOLON	
// Delete original and copy bytes back: 	TokenNameCOMMENT_LINE	Delete original and copy bytes back: 
deleteFile	TokenNameIdentifier	 delete File
(	TokenNameLPAREN	
name	TokenNameIdentifier	 name
,	TokenNameCOMMA	
...
{	TokenNameLBRACE	
// The file survived intact: 	TokenNameCOMMENT_LINE	The file survived intact: 
action	TokenNameIdentifier	 action
=	TokenNameEQUAL	
"didn't change"	TokenNameStringLiteral	didn't change
;	TokenNameSEMICOLON	
}	TokenNameRBRACE	
else	TokenNameelse	
{	TokenNameLBRACE	
action	TokenNameIdentifier	 action
=	TokenNameEQUAL	
"fully truncated"	TokenNameStringLiteral	fully truncated
;	TokenNameSEMICOLON	
// Totally truncate the file to zero bytes 	TokenNameCOMMENT_LINE	Totally truncate the file to zero bytes 
deleteFile	TokenNameIdentifier	 delete File
(	TokenNameLPAREN	
name	TokenNameIdentifier	 name
,	TokenNameCOMMA	
...
(	TokenNameLPAREN	
"MockDirectoryWrapper: "	TokenNameStringLiteral	MockDirectoryWrapper: 
+	TokenNamePLUS	
action	TokenNameIdentifier	 action
+	TokenNamePLUS	
" unsynced file: "	TokenNameStringLiteral	 unsynced file: 
+	TokenNamePLUS	
name	TokenNameIdentifier	 name
)	TokenNameRPAREN	
;	TokenNameSEMICOLON	
...
private	TokenNameprivate	
boolean	TokenNameboolean	
assertNoUnreferencedFilesOnClose	TokenNameIdentifier	 assert No Unreferenced Files On Close
=	TokenNameEQUAL	
true	TokenNametrue	
;	TokenNameSEMICOLON	
public	TokenNamepublic	
void	TokenNamevoid	
setAssertNoUnrefencedFilesOnClose	TokenNameIdentifier	 set Assert No Unrefenced Files On Close
(	TokenNameLPAREN	
boolean	TokenNameboolean	
v	TokenNameIdentifier	 v
)	TokenNameRPAREN	
...
if	TokenNameif	
(	TokenNameLPAREN	
indexPossiblyExists	TokenNameIdentifier	 index Possibly Exists
(	TokenNameLPAREN	
this	TokenNamethis	
)	TokenNameRPAREN	
)	TokenNameRPAREN	
...
println	TokenNameIdentifier	 println
(	TokenNameLPAREN	
" NOTE: MockDirectoryWrapper: now crash"	TokenNameStringLiteral	 NOTE: MockDirectoryWrapper: now crash
)	TokenNameRPAREN	
;	TokenNameSEMICOLON	
}	TokenNameRBRACE	
crash	TokenNameIdentifier	 crash
...
;	TokenNameSEMICOLON	
// corrumpt any unsynced-files 	TokenNameCOMMENT_LINE	corrumpt any unsynced-files 
if	TokenNameif	
(	TokenNameLPAREN	
LuceneTestCase	TokenNameIdentifier	 Lucene Test Case
.	TokenNameDOT	
...
{	TokenNameLBRACE	
// now look for unreferenced files: 	TokenNameCOMMENT_LINE	now look for unreferenced files: 
String	TokenNameIdentifier	 String
[	TokenNameLBRACKET	
]	TokenNameRBRACKET	
...
false	TokenNamefalse	
:	TokenNameCOLON	
"unreferenced files: before delete: "	TokenNameStringLiteral	unreferenced files: before delete: 
+	TokenNamePLUS	
Arrays	TokenNameIdentifier	 Arrays
.	TokenNameDOT	
toString	TokenNameIdentifier	 to String
...
numDocs2	TokenNameIdentifier	 num Docs2
:	TokenNameCOLON	
"numDocs changed after opening/closing IW: before="	TokenNameStringLiteral	numDocs changed after opening/closing IW: before=
+	TokenNamePLUS	
numDocs1	TokenNameIdentifier	 num Docs1
+	TokenNamePLUS	
...
/** don't rely upon DirectoryReader.fileExists to determine if we should * checkIndex() or not. It might mask real problems, where we silently * don't checkindex at all. instead we look for a segments file. */	TokenNameCOMMENT_JAVADOC	 don't rely upon DirectoryReader.fileExists to determine if we should checkIndex() or not. It might mask real problems, where we silently don't checkindex at all. instead we look for a segments file. 
private	TokenNameprivate	
boolean	TokenNameboolean	
indexPossiblyExists	TokenNameIdentifier	 index Possibly Exists
(	TokenNameLPAREN	
...
{	TokenNameLBRACE	
// this means directory doesn't exist, which is ok. return false 	TokenNameCOMMENT_LINE	this means directory doesn't exist, which is ok. return false 
return	TokenNamereturn	
false	TokenNamefalse	
;	TokenNameSEMICOLON	
}	TokenNameRBRACE	
