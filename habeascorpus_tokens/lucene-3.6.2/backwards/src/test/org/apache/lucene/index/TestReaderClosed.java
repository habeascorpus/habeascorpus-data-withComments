...
TestReaderClosed	TokenNameIdentifier	 Test Reader Closed
...
;	TokenNameSEMICOLON	
// we generate aweful prefixes: good for testing. 	TokenNameCOMMENT_LINE	we generate aweful prefixes: good for testing. 
// but for preflex codec, the test can be very slow, so use less iterations. 	TokenNameCOMMENT_LINE	but for preflex codec, the test can be very slow, so use less iterations. 
int	TokenNameint	
