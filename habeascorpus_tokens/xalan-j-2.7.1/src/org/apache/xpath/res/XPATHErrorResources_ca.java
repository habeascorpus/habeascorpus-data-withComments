...
ER_CURRENT_NOT_ALLOWED_IN_MATCH	TokenNameIdentifier	 ER  CURRENT  NOT  ALLOWED  IN  MATCH
,	TokenNameCOMMA	
"La funci— current() no Žs permesa en un patr— de coincidncia."	TokenNameStringLiteral	La funci— current() no Žs permesa en un patr— de coincidncia.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_CURRENT_TAKES_NO_ARGS	TokenNameIdentifier	 ER  CURRENT  TAKES  NO  ARGS
...
ER_CONTEXT_HAS_NO_OWNERDOC	TokenNameIdentifier	 ER  CONTEXT  HAS  NO  OWNERDOC
,	TokenNameCOMMA	
"El context no tŽ un document de propietari."	TokenNameStringLiteral	El context no tŽ un document de propietari.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_LOCALNAME_HAS_TOO_MANY_ARGS	TokenNameIdentifier	 ER  LOCALNAME  HAS  TOO  MANY  ARGS
,	TokenNameCOMMA	
"local-name() tŽ massa arguments."	TokenNameStringLiteral	local-name() tŽ massa arguments.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_NAMESPACEURI_HAS_TOO_MANY_ARGS	TokenNameIdentifier	 ER  NAMESPACEURI  HAS  TOO  MANY  ARGS
,	TokenNameCOMMA	
"namespace-uri() tŽ massa arguments."	TokenNameStringLiteral	namespace-uri() tŽ massa arguments.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_NORMALIZESPACE_HAS_TOO_MANY_ARGS	TokenNameIdentifier	 ER  NORMALIZESPACE  HAS  TOO  MANY  ARGS
,	TokenNameCOMMA	
"normalize-space() tŽ massa arguments."	TokenNameStringLiteral	normalize-space() tŽ massa arguments.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_NUMBER_HAS_TOO_MANY_ARGS	TokenNameIdentifier	 ER  NUMBER  HAS  TOO  MANY  ARGS
,	TokenNameCOMMA	
"number() tŽ massa arguments."	TokenNameStringLiteral	number() tŽ massa arguments.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_NAME_HAS_TOO_MANY_ARGS	TokenNameIdentifier	 ER  NAME  HAS  TOO  MANY  ARGS
,	TokenNameCOMMA	
"name() tŽ massa arguments."	TokenNameStringLiteral	name() tŽ massa arguments.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_STRING_HAS_TOO_MANY_ARGS	TokenNameIdentifier	 ER  STRING  HAS  TOO  MANY  ARGS
,	TokenNameCOMMA	
"string() tŽ massa arguments."	TokenNameStringLiteral	string() tŽ massa arguments.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_STRINGLENGTH_HAS_TOO_MANY_ARGS	TokenNameIdentifier	 ER  STRINGLENGTH  HAS  TOO  MANY  ARGS
,	TokenNameCOMMA	
"string-length() tŽ massa arguments."	TokenNameStringLiteral	string-length() tŽ massa arguments.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_TRANSLATE_TAKES_3_ARGS	TokenNameIdentifier	 ER  TRANSLATE  TAKES 3  ARGS
,	TokenNameCOMMA	
"La funci— translate() tŽ tres arguments."	TokenNameStringLiteral	La funci— translate() tŽ tres arguments.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_UNPARSEDENTITYURI_TAKES_1_ARG	TokenNameIdentifier	 ER  UNPARSEDENTITYURI  TAKES 1  ARG
...
ER_INCORRECT_ARG_LENGTH	TokenNameIdentifier	 ER  INCORRECT  ARG  LENGTH
,	TokenNameCOMMA	
"La longitud de l'argument de la prova de node processing-instruction() no Žs correcta."	TokenNameStringLiteral	La longitud de l'argument de la prova de node processing-instruction() no Žs correcta.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_CANT_CONVERT_TO_NUMBER	TokenNameIdentifier	 ER  CANT  CONVERT  TO  NUMBER
,	TokenNameCOMMA	
"No es pot convertir {0} en un nœmero."	TokenNameStringLiteral	No es pot convertir {0} en un nœmero.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_CANT_CONVERT_TO_NODELIST	TokenNameIdentifier	 ER  CANT  CONVERT  TO  NODELIST
...
ER_EXPECTED_MATCH_PATTERN	TokenNameIdentifier	 ER  EXPECTED  MATCH  PATTERN
,	TokenNameCOMMA	
"El patr— de coincidncia de getMatchScore Žs l'esperat."	TokenNameStringLiteral	El patr— de coincidncia de getMatchScore Žs l'esperat.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_COULDNOT_GET_VAR_NAMED	TokenNameIdentifier	 ER  COULDNOT  GET  VAR  NAMED
...
ER_INCORRECT_PROGRAMMER_ASSERTION	TokenNameIdentifier	 ER  INCORRECT  PROGRAMMER  ASSERTION
,	TokenNameCOMMA	
"L''afirmaci— del programador Žs incorrecta. - {0}"	TokenNameStringLiteral	L''afirmaci— del programador Žs incorrecta. - {0}
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_BOOLEAN_ARG_NO_LONGER_OPTIONAL	TokenNameIdentifier	 ER  BOOLEAN  ARG  NO  LONGER  OPTIONAL
,	TokenNameCOMMA	
"L'argument boolean(...) ja no Žs opcional amb l'esborrany d'XPath 19990709."	TokenNameStringLiteral	L'argument boolean(...) ja no Žs opcional amb l'esborrany d'XPath 19990709.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_FOUND_COMMA_BUT_NO_PRECEDING_ARG	TokenNameIdentifier	 ER  FOUND  COMMA  BUT  NO  PRECEDING  ARG
...
ER_PREDICATE_ILLEGAL_SYNTAX	TokenNameIdentifier	 ER  PREDICATE  ILLEGAL  SYNTAX
,	TokenNameCOMMA	
"'..[predicate]' o '.[predicate]' no Žs una sintaxi permesa. En comptes d'aix˜, utilitzeu 'self::node()[predicate]'."	TokenNameStringLiteral	'..[predicate]' o '.[predicate]' no Žs una sintaxi permesa. En comptes d'aix˜, utilitzeu 'self::node()[predicate]'.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_ILLEGAL_AXIS_NAME	TokenNameIdentifier	 ER  ILLEGAL  AXIS  NAME
...
ER_COULDNOT_BE_FORMATTED_TO_NUMBER	TokenNameIdentifier	 ER  COULDNOT  BE  FORMATTED  TO  NUMBER
,	TokenNameCOMMA	
"{0} no s''ha pogut formatar com a nœmero."	TokenNameStringLiteral	{0} no s''ha pogut formatar com a nœmero.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_COULDNOT_CREATE_XMLPROCESSORLIAISON	TokenNameIdentifier	 ER  COULDNOT  CREATE  XMLPROCESSORLIAISON
...
ER_COULDNOT_FIND_ENDOP_AFTER_OPLOCATIONPATH	TokenNameIdentifier	 ER  COULDNOT  FIND  ENDOP  AFTER  OPLOCATIONPATH
,	TokenNameCOMMA	
"ERROR. No s'ha trobat ENDOP desprŽs d'OP_LOCATIONPATH."	TokenNameStringLiteral	ERROR. No s'ha trobat ENDOP desprŽs d'OP_LOCATIONPATH.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_ERROR_OCCURED	TokenNameIdentifier	 ER  ERROR  OCCURED
...
ER_AXES_NOT_ALLOWED	TokenNameIdentifier	 ER  AXES  NOT  ALLOWED
,	TokenNameCOMMA	
"NomŽs es permeten els eixos subordinat:: i atribut:: en els patrons de coincidncia. Eixos incorrectes = {0}"	TokenNameStringLiteral	NomŽs es permeten els eixos subordinat:: i atribut:: en els patrons de coincidncia. Eixos incorrectes = {0}
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_KEY_HAS_TOO_MANY_ARGS	TokenNameIdentifier	 ER  KEY  HAS  TOO  MANY  ARGS
,	TokenNameCOMMA	
"key() tŽ un nombre incorrecte d'arguments."	TokenNameStringLiteral	key() tŽ un nombre incorrecte d'arguments.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_COUNT_TAKES_1_ARG	TokenNameIdentifier	 ER  COUNT  TAKES 1  ARG
...
ER_PROBLEM_IN_DTM_NEXTSIBLING	TokenNameIdentifier	 ER  PROBLEM  IN  DTM  NEXTSIBLING
,	TokenNameCOMMA	
"S'ha produ•t un error en el DTM de getNextSibling. S'intentarˆ solucionar."	TokenNameStringLiteral	S'ha produ•t un error en el DTM de getNextSibling. S'intentarˆ solucionar.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_CANNOT_WRITE_TO_EMPTYNODELISTIMPL	TokenNameIdentifier	 ER  CANNOT  WRITE  TO  EMPTYNODELISTIMPL
...
ER_PARSE_NOT_SUPPORTED	TokenNameIdentifier	 ER  PARSE  NOT  SUPPORTED
,	TokenNameCOMMA	
"L''anˆlisi (origen InputSource) no tŽ suport a XPathContext. No es pot obrir {0}."	TokenNameStringLiteral	L''anˆlisi (origen InputSource) no tŽ suport a XPathContext. No es pot obrir {0}.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_SAX_API_NOT_HANDLED	TokenNameIdentifier	 ER  SAX  API  NOT  HANDLED
,	TokenNameCOMMA	
"Els carˆcters de l'API SAX (char ch[]... no es poden gestionar pel DTM."	TokenNameStringLiteral	Els carˆcters de l'API SAX (char ch[]... no es poden gestionar pel DTM.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_IGNORABLE_WHITESPACE_NOT_HANDLED	TokenNameIdentifier	 ER  IGNORABLE  WHITESPACE  NOT  HANDLED
...
ER_INVALID_UTF16_SURROGATE	TokenNameIdentifier	 ER  INVALID  UT F16  SURROGATE
,	TokenNameCOMMA	
"S''ha detectat un suplent UTF-16 no vˆlid: {0} ?"	TokenNameStringLiteral	S''ha detectat un suplent UTF-16 no vˆlid: {0} ?
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_OIERROR	TokenNameIdentifier	 ER  OIERROR
...
ER_NODESET_NOT_MUTABLE	TokenNameIdentifier	 ER  NODESET  NOT  MUTABLE
,	TokenNameCOMMA	
"Aquest NodeSet no Žs mutable."	TokenNameStringLiteral	Aquest NodeSet no Žs mutable.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_NODESETDTM_NOT_MUTABLE	TokenNameIdentifier	 ER  NODESETDTM  NOT  MUTABLE
,	TokenNameCOMMA	
"Aquest NodeSetDTM no Žs mutable."	TokenNameStringLiteral	Aquest NodeSetDTM no Žs mutable.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_VAR_NOT_RESOLVABLE	TokenNameIdentifier	 ER  VAR  NOT  RESOLVABLE
...
ER_RTF_NOT_SUPPORTED_XRTREEFRAGSELECTWRAPPER	TokenNameIdentifier	 ER  RTF  NOT  SUPPORTED  XRTREEFRAGSELECTWRAPPER
,	TokenNameCOMMA	
"rtf() no tŽ suport d'XRTreeFragSelectWrapper"	TokenNameStringLiteral	rtf() no tŽ suport d'XRTreeFragSelectWrapper
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_RTF_NOT_SUPPORTED_XRTREEFRAGSELECTWRAPPER	TokenNameIdentifier	 ER  RTF  NOT  SUPPORTED  XRTREEFRAGSELECTWRAPPER
,	TokenNameCOMMA	
"asNodeIterator() no tŽ suport d'XRTreeFragSelectWrapper"	TokenNameStringLiteral	asNodeIterator() no tŽ suport d'XRTreeFragSelectWrapper
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_DETACH_NOT_SUPPORTED_XRTREEFRAGSELECTWRAPPER	TokenNameIdentifier	 ER  DETACH  NOT  SUPPORTED  XRTREEFRAGSELECTWRAPPER
,	TokenNameCOMMA	
"detach() no tŽ suport d'XRTreeFragSelectWrapper"	TokenNameStringLiteral	detach() no tŽ suport d'XRTreeFragSelectWrapper
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_NUM_NOT_SUPPORTED_XRTREEFRAGSELECTWRAPPER	TokenNameIdentifier	 ER  NUM  NOT  SUPPORTED  XRTREEFRAGSELECTWRAPPER
,	TokenNameCOMMA	
"num() no tŽ suport d'XRTreeFragSelectWrapper"	TokenNameStringLiteral	num() no tŽ suport d'XRTreeFragSelectWrapper
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_XSTR_NOT_SUPPORTED_XRTREEFRAGSELECTWRAPPER	TokenNameIdentifier	 ER  XSTR  NOT  SUPPORTED  XRTREEFRAGSELECTWRAPPER
,	TokenNameCOMMA	
"xstr() no tŽ suport d'XRTreeFragSelectWrapper"	TokenNameStringLiteral	xstr() no tŽ suport d'XRTreeFragSelectWrapper
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_STR_NOT_SUPPORTED_XRTREEFRAGSELECTWRAPPER	TokenNameIdentifier	 ER  STR  NOT  SUPPORTED  XRTREEFRAGSELECTWRAPPER
,	TokenNameCOMMA	
"str() no tŽ suport d'XRTreeFragSelectWrapper"	TokenNameStringLiteral	str() no tŽ suport d'XRTreeFragSelectWrapper
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_FSB_NOT_SUPPORTED_XSTRINGFORCHARS	TokenNameIdentifier	 ER  FSB  NOT  SUPPORTED  XSTRINGFORCHARS
,	TokenNameCOMMA	
"fsb() no tŽ suport d'XStringForChars"	TokenNameStringLiteral	fsb() no tŽ suport d'XStringForChars
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_COULD_NOT_FIND_VAR	TokenNameIdentifier	 ER  COULD  NOT  FIND  VAR
...
ER_VARIABLE_ACCESSED_BEFORE_BIND	TokenNameIdentifier	 ER  VARIABLE  ACCESSED  BEFORE  BIND
,	TokenNameCOMMA	
"S'ha accedit a la variable abans que estiguŽs vinculada."	TokenNameStringLiteral	S'ha accedit a la variable abans que estiguŽs vinculada.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_FSB_CANNOT_TAKE_STRING	TokenNameIdentifier	 ER  FSB  CANNOT  TAKE  STRING
...
ER_SETTING_WALKER_ROOT_TO_NULL	TokenNameIdentifier	 ER  SETTING  WALKER  ROOT  TO  NULL
,	TokenNameCOMMA	
" Error. S'estˆ establint l'arrel d'un itinerant en nul."	TokenNameStringLiteral	 Error. S'estˆ establint l'arrel d'un itinerant en nul.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_NODESETDTM_CANNOT_ITERATE	TokenNameIdentifier	 ER  NODESETDTM  CANNOT  ITERATE
...
ER_CANNOT_CALL_SETSHOULDCACHENODE	TokenNameIdentifier	 ER  CANNOT  CALL  SETSHOULDCACHENODE
,	TokenNameCOMMA	
"No es pot cridar setShouldCacheNodes desprŽs que s'hagi cridat nextNode"	TokenNameStringLiteral	No es pot cridar setShouldCacheNodes desprŽs que s'hagi cridat nextNode
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_ONLY_ALLOWS	TokenNameIdentifier	 ER  ONLY  ALLOWS
,	TokenNameCOMMA	
"{0} nomŽs permet {1} arguments"	TokenNameStringLiteral	{0} nomŽs permet {1} arguments
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_UNKNOWN_STEP	TokenNameIdentifier	 ER  UNKNOWN  STEP
...
ER_EXPECTED_REL_LOC_PATH	TokenNameIdentifier	 ER  EXPECTED  REL  LOC  PATH
,	TokenNameCOMMA	
"S'esperava una via d'accŽs relativa darrere del senyal '/' o '//'."	TokenNameStringLiteral	S'esperava una via d'accŽs relativa darrere del senyal '/' o '//'.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
ER_EXPECTED_LOC_PATH	TokenNameIdentifier	 ER  EXPECTED  LOC  PATH
,	TokenNameCOMMA	
"S''esperava una via d''accŽs d''ubicaci—, per˜ s''ha trobat el senyal segŸent: {0}"	TokenNameStringLiteral	S''esperava una via d''accŽs d''ubicaci—, per˜ s''ha trobat el senyal segŸent: {0}
}	TokenNameRBRACE	
,	TokenNameCOMMA	
// Note to translators: A location path is a form of XPath expression. 	TokenNameCOMMENT_LINE	Note to translators: A location path is a form of XPath expression. 
...
ER_EXPECTED_LOC_PATH_AT_END_EXPR	TokenNameIdentifier	 ER  EXPECTED  LOC  PATH  AT  END  EXPR
,	TokenNameCOMMA	
"S'esperava una via d'accŽs, per˜ enlloc d'aix˜ s'ha trobat el final de l'expressi— XPath. "	TokenNameStringLiteral	S'esperava una via d'accŽs, per˜ enlloc d'aix˜ s'ha trobat el final de l'expressi— XPath. 
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
ER_EXPECTED_LOC_STEP	TokenNameIdentifier	 ER  EXPECTED  LOC  STEP
,	TokenNameCOMMA	
"S'esperava un pas d'ubicaci— desprŽs del senyal '/' o '//'."	TokenNameStringLiteral	S'esperava un pas d'ubicaci— desprŽs del senyal '/' o '//'.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
ER_EXPECTED_REL_PATH_PATTERN	TokenNameIdentifier	 ER  EXPECTED  REL  PATH  PATTERN
,	TokenNameCOMMA	
"S'esperava un patr— de via d'accŽs relativa."	TokenNameStringLiteral	S'esperava un patr— de via d'accŽs relativa.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
ER_CANT_CONVERT_TO_BOOLEAN	TokenNameIdentifier	 ER  CANT  CONVERT  TO  BOOLEAN
,	TokenNameCOMMA	
"L''expressi— XPathResult d''XPath ''{0}'' tŽ un XPathResultType de {1} que no es pot convertir a un cap valor booleˆ. "	TokenNameStringLiteral	L''expressi— XPathResult d''XPath ''{0}'' tŽ un XPathResultType de {1} que no es pot convertir a un cap valor booleˆ. 
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
ER_CANT_CONVERT_TO_SINGLENODE	TokenNameIdentifier	 ER  CANT  CONVERT  TO  SINGLENODE
,	TokenNameCOMMA	
"L''expressi— XPathResult d''XPath ''{0}'' tŽ un XPathResultType de {1} que no es pot convertir a un node œnic. El mtode getSingleNodeValue s''aplica nomŽs al tipus ANY_UNORDERED_NODE_TYPE i FIRST_ORDERED_NODE_TYPE."	TokenNameStringLiteral	L''expressi— XPathResult d''XPath ''{0}'' tŽ un XPathResultType de {1} que no es pot convertir a un node œnic. El mtode getSingleNodeValue s''aplica nomŽs al tipus ANY_UNORDERED_NODE_TYPE i FIRST_ORDERED_NODE_TYPE.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
ER_CANT_GET_SNAPSHOT_LENGTH	TokenNameIdentifier	 ER  CANT  GET  SNAPSHOT  LENGTH
,	TokenNameCOMMA	
"El mtode getSnapshotLength no es pot cridar a l''expressi— XPathResult d''XPath ''{0}'' perqu el seu XPathResultType Žs {1}. Aquest mtode nomŽs s''aplica als tipus UNORDERED_NODE_SNAPSHOT_TYPE i ORDERED_NODE_SNAPSHOT_TYPE."	TokenNameStringLiteral	El mtode getSnapshotLength no es pot cridar a l''expressi— XPathResult d''XPath ''{0}'' perqu el seu XPathResultType Žs {1}. Aquest mtode nomŽs s''aplica als tipus UNORDERED_NODE_SNAPSHOT_TYPE i ORDERED_NODE_SNAPSHOT_TYPE.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_NON_ITERATOR_TYPE	TokenNameIdentifier	 ER  NON  ITERATOR  TYPE
,	TokenNameCOMMA	
"El mtode iterateNext no es pot cridar a l''expressi— XPathResult d''XPath ''{0}'' perqu el seu XPathResultType Žs {1}. Aquest mtode nomŽs s''aplica als tipus UNORDERED_NODE_ITERATOR_TYPE i ORDERED_NODE_ITERATOR_TYPE."	TokenNameStringLiteral	El mtode iterateNext no es pot cridar a l''expressi— XPathResult d''XPath ''{0}'' perqu el seu XPathResultType Žs {1}. Aquest mtode nomŽs s''aplica als tipus UNORDERED_NODE_ITERATOR_TYPE i ORDERED_NODE_ITERATOR_TYPE.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
ER_DOC_MUTATED	TokenNameIdentifier	 ER  DOC  MUTATED
,	TokenNameCOMMA	
"El document s'ha modificat des que es van produir els resultats. L'iterador no Žs vˆlid."	TokenNameStringLiteral	El document s'ha modificat des que es van produir els resultats. L'iterador no Žs vˆlid.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_INVALID_XPATH_TYPE	TokenNameIdentifier	 ER  INVALID  XPATH  TYPE
,	TokenNameCOMMA	
"L''argument de tipus XPath no Žs vˆlid: {0}"	TokenNameStringLiteral	L''argument de tipus XPath no Žs vˆlid: {0}
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_EMPTY_XPATH_RESULT	TokenNameIdentifier	 ER  EMPTY  XPATH  RESULT
,	TokenNameCOMMA	
"L'objecte de resultats XPath estˆ buit."	TokenNameStringLiteral	L'objecte de resultats XPath estˆ buit.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_INCOMPATIBLE_TYPES	TokenNameIdentifier	 ER  INCOMPATIBLE  TYPES
,	TokenNameCOMMA	
"L''expressi— XPathResult d''XPath ''{0}'' tŽ un XPathResultType de {1} que no es pot encaixar al XPathResultType especificat de {2}."	TokenNameStringLiteral	L''expressi— XPathResult d''XPath ''{0}'' tŽ un XPathResultType de {1} que no es pot encaixar al XPathResultType especificat de {2}.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_NULL_RESOLVER	TokenNameIdentifier	 ER  NULL  RESOLVER
...
ER_CANT_CONVERT_TO_STRING	TokenNameIdentifier	 ER  CANT  CONVERT  TO  STRING
,	TokenNameCOMMA	
"L''expressi— XPathResult d''XPath ''{0}'' tŽ un XPathResultType de {1} que no es pot convertir a cap cadena. "	TokenNameStringLiteral	L''expressi— XPathResult d''XPath ''{0}'' tŽ un XPathResultType de {1} que no es pot convertir a cap cadena. 
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
ER_NON_SNAPSHOT_TYPE	TokenNameIdentifier	 ER  NON  SNAPSHOT  TYPE
,	TokenNameCOMMA	
"El mtode snapshotItem no es pot cridar a l''expressi— XPathResult d''XPath ''{0}'' perqu el seu XPathResultType Žs {1}. Aquest mtode nomŽs s''aplica als tipus UNORDERED_NODE_SNAPSHOT_TYPE i ORDERED_NODE_SNAPSHOT_TYPE."	TokenNameStringLiteral	El mtode snapshotItem no es pot cridar a l''expressi— XPathResult d''XPath ''{0}'' perqu el seu XPathResultType Žs {1}. Aquest mtode nomŽs s''aplica als tipus UNORDERED_NODE_SNAPSHOT_TYPE i ORDERED_NODE_SNAPSHOT_TYPE.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
ER_WRONG_NODETYPE	TokenNameIdentifier	 ER  WRONG  NODETYPE
,	TokenNameCOMMA	
"El tipus de node de context no tŽ suport."	TokenNameStringLiteral	El tipus de node de context no tŽ suport.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_XPATH_ERROR	TokenNameIdentifier	 ER  XPATH  ERROR
...
ER_CANT_CONVERT_XPATHRESULTTYPE_TO_NUMBER	TokenNameIdentifier	 ER  CANT  CONVERT  XPATHRESULTTYPE  TO  NUMBER
,	TokenNameCOMMA	
"L''expressi— XPathResult d''XPath ''{0}'' tŽ un XPathResultType de {1} que no es pot convertir a cap nœmero "	TokenNameStringLiteral	L''expressi— XPathResult d''XPath ''{0}'' tŽ un XPathResultType de {1} que no es pot convertir a cap nœmero 
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
WG_PROPERTY_NOT_SUPPORTED	TokenNameIdentifier	 WG  PROPERTY  NOT  SUPPORTED
,	TokenNameCOMMA	
"La propietat XSL no tŽ suport: {0}"	TokenNameStringLiteral	La propietat XSL no tŽ suport: {0}
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
WG_DONT_DO_ANYTHING_WITH_NS	TokenNameIdentifier	 WG  DONT  DO  ANYTHING  WITH  NS
...
WG_QUO_NO_LONGER_DEFINED	TokenNameIdentifier	 WG  QUO  NO  LONGER  DEFINED
,	TokenNameCOMMA	
"Sintaxi antiga: quo(...) ja no estˆ definit a XPath."	TokenNameStringLiteral	Sintaxi antiga: quo(...) ja no estˆ definit a XPath.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
WG_NEED_DERIVED_OBJECT_TO_IMPLEMENT_NODETEST	TokenNameIdentifier	 WG  NEED  DERIVED  OBJECT  TO  IMPLEMENT  NODETEST
...
WG_EXPAND_ENTITIES_NOT_SUPPORTED	TokenNameIdentifier	 WG  EXPAND  ENTITIES  NOT  SUPPORTED
,	TokenNameCOMMA	
"L'opci— -E no tŽ suport a l'analitzador de DTM"	TokenNameStringLiteral	L'opci— -E no tŽ suport a l'analitzador de DTM
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
WG_ILLEGAL_VARIABLE_REFERENCE	TokenNameIdentifier	 WG  ILLEGAL  VARIABLE  REFERENCE
...
,	TokenNameCOMMA	
"El parˆmetre de createMessage estava fora dels l’mits."	TokenNameStringLiteral	El parˆmetre de createMessage estava fora dels l’mits.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
...
,	TokenNameCOMMA	
"L’nia nœm."	TokenNameStringLiteral	L’nia nœm.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
...
,	TokenNameCOMMA	
"O nomŽs una expressi— xpath farˆ un buidatge de diagn˜stic."	TokenNameStringLiteral	O nomŽs una expressi— xpath farˆ un buidatge de diagn˜stic.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
"noParsermsg1"	TokenNameStringLiteral	noParsermsg1
,	TokenNameCOMMA	
"El procŽs XSL no ha estat correcte."	TokenNameStringLiteral	El procŽs XSL no ha estat correcte.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
