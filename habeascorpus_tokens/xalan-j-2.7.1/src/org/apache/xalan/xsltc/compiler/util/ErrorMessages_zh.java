...
/* * $Id: ErrorMessages_zh.java 338081 2004-12-15 17:35:58Z jycli $ */	TokenNameCOMMENT_BLOCK	 $Id: ErrorMessages_zh.java 338081 2004-12-15 17:35:58Z jycli $ 
...
ErrorMessages_zh	TokenNameIdentifier	 Error Messages zh
...
,	TokenNameCOMMA	
"XSLTC ??? XSL V{0}?"	TokenNameStringLiteral	XSLTC ??? XSL V{0}?
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
,	TokenNameCOMMA	
"???? systemId ???? XSLTCSource.build()?"	TokenNameStringLiteral	???? systemId ???? XSLTCSource.build()?
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ErrorMsg	TokenNameIdentifier	 Error Msg
...
,	TokenNameCOMMA	
"SYNOPSIS java org.apache.xalan.xsltc.cmdline.Compile [-o <output>] [-d <directory>] [-j <jarfile>] [-p <package>] [-n] [-x] [-u] [-v] [-h] { <stylesheet> | -i } OPTIONS -o <output> ??? <output> ?????? translet???????translet ?? ??? <stylesheet> ??? ????????????????? -d <directory> ?? translet ????? -j <jarfile> ? translet ??????? <jarfile> ? jar ?? -p <package> ?????? translet ? ??????????? -n ??????????? ?????? -x ?????????? -u ? <stylesheet> ?????? URL -i ?????? stdin ????? -v ???????? -h ??????? "	TokenNameStringLiteral	SYNOPSIS java org.apache.xalan.xsltc.cmdline.Compile [-o <output>] [-d <directory>] [-j <jarfile>] [-p <package>] [-n] [-x] [-u] [-v] [-h] { <stylesheet> | -i } OPTIONS -o <output> ??? <output> ?????? translet???????translet ?? ??? <stylesheet> ??? ????????????????? -d <directory> ?? translet ????? -j <jarfile> ? translet ??????? <jarfile> ? jar ?? -p <package> ?????? translet ? ??????????? -n ??????????? ?????? -x ?????????? -u ? <stylesheet> ?????? URL -i ?????? stdin ????? -v ???????? -h ??????? 
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
,	TokenNameCOMMA	
"SYNOPSIS java org.apache.xalan.xsltc.cmdline.Transform [-j <jarfile>] [-x] [-n <iterations>] {-u <document_url> | <document>} <class> [<param1>=<value1> ...] ?? translet <class> ?????? <document> ? XML ???translet <class> ??? ??? CLASSPATH ?????????? <jarfile> ?? OPTIONS -j <jarfile> ???? translet ? jarfile -x ?????????? -n <iterations> ?????? <iterations> ??? ???????? -u <document_url> ? XML ????? URL "	TokenNameStringLiteral	SYNOPSIS java org.apache.xalan.xsltc.cmdline.Transform [-j <jarfile>] [-x] [-n <iterations>] {-u <document_url> | <document>} <class> [<param1>=<value1> ...] ?? translet <class> ?????? <document> ? XML ???translet <class> ??? ??? CLASSPATH ?????????? <jarfile> ?? OPTIONS -j <jarfile> ???? translet ? jarfile -x ?????????? -n <iterations> ?????? <iterations> ??? ???????? -u <document_url> ? XML ????? URL 
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
,	TokenNameCOMMA	
"?? translet“{0}”? jar ??“{1}”??"	TokenNameStringLiteral	?? translet“{0}”? jar ??“{1}”??
}	TokenNameRBRACE	
,	TokenNameCOMMA	
