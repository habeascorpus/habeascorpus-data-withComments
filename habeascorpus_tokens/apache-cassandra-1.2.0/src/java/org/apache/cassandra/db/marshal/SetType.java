...
ConfigurationException	TokenNameIdentifier	 Configuration Exception
(	TokenNameLPAREN	
"SetType takes exactly 1 type parameter"	TokenNameStringLiteral	SetType takes exactly 1 type parameter
)	TokenNameRPAREN	
;	TokenNameSEMICOLON	
...
{	TokenNameLBRACE	
return	TokenNamereturn	
EmptyType	TokenNameIdentifier	 Empty Type
.	TokenNameDOT	
...
(	TokenNameLPAREN	
"Not enough bytes to read a set"	TokenNameStringLiteral	Not enough bytes to read a set
)	TokenNameRPAREN	
;	TokenNameSEMICOLON	
}	TokenNameRBRACE	
}	TokenNameRBRACE	
