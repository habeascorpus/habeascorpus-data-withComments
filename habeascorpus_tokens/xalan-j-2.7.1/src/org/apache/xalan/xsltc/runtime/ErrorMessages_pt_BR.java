...
/* * $Id: ErrorMessages_pt_BR.java 468652 2006-10-28 07:05:17Z minchau $ */	TokenNameCOMMENT_BLOCK	 $Id: ErrorMessages_pt_BR.java 468652 2006-10-28 07:05:17Z minchau $ 
...
ErrorMessages_pt_BR	TokenNameIdentifier	 Error Messages pt  BR
...
,	TokenNameCOMMA	
"Erro interno de tempo de execução em ''{0}''"	TokenNameStringLiteral	Erro interno de tempo de execução em ''{0}''
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
,	TokenNameCOMMA	
"Erro de tempo de execução ao executar <xsl:copy>."	TokenNameStringLiteral	Erro de tempo de execução ao executar <xsl:copy>.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
,	TokenNameCOMMA	
"Conversão inválida de ''{0}'' em ''{1}''."	TokenNameStringLiteral	Conversão inválida de ''{0}'' em ''{1}''.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
,	TokenNameCOMMA	
"Função externa ''{0}'' não suportada por XSLTC."	TokenNameStringLiteral	Função externa ''{0}'' não suportada por XSLTC.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
,	TokenNameCOMMA	
"Tipo de argumento desconhecido na expressão de igualdade. "	TokenNameStringLiteral	Tipo de argumento desconhecido na expressão de igualdade. 
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
,	TokenNameCOMMA	
"Tipo de argumento inválido ''{0}'' na chamada para ''{1}''"	TokenNameStringLiteral	Tipo de argumento inválido ''{0}'' na chamada para ''{1}''
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
,	TokenNameCOMMA	
"Tentando formatar o número ''{0}'' utilizando o padrão ''{1}''."	TokenNameStringLiteral	Tentando formatar o número ''{0}'' utilizando o padrão ''{1}''.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
,	TokenNameCOMMA	
"Não é possível clonar o iterador ''{0}''."	TokenNameStringLiteral	Não é possível clonar o iterador ''{0}''.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
,	TokenNameCOMMA	
"O iterador do eixo ''{0}'' não é suportado. "	TokenNameStringLiteral	O iterador do eixo ''{0}'' não é suportado. 
}	TokenNameRBRACE	
,	TokenNameCOMMA	
/* * Note to translators: The following represents an internal error * situation in XSLTC. The processor attempted to create an iterator * for a particular axis (see definition above) that it does not * support. */	TokenNameCOMMENT_BLOCK	 Note to translators: The following represents an internal error situation in XSLTC. The processor attempted to create an iterator for a particular axis (see definition above) that it does not support. 
{	TokenNameLBRACE	
...
,	TokenNameCOMMA	
"O iterador do eixo digitado ''{0}'' não é suportado. "	TokenNameStringLiteral	O iterador do eixo digitado ''{0}'' não é suportado. 
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
,	TokenNameCOMMA	
"Declaração de espaço de nomes ''{0}''=''{1}'' fora do elemento. "	TokenNameStringLiteral	Declaração de espaço de nomes ''{0}''=''{1}'' fora do elemento. 
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
,	TokenNameCOMMA	
"O espaço de nomes do prefixo ''{0}'' não foi declarado. "	TokenNameStringLiteral	O espaço de nomes do prefixo ''{0}'' não foi declarado. 
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
,	TokenNameCOMMA	
"DOMAdapter criado utilizando tipo incorreto de DOM de origem."	TokenNameStringLiteral	DOMAdapter criado utilizando tipo incorreto de DOM de origem.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
,	TokenNameCOMMA	
"O analisador SAX que está sendo utilizado não trata de eventos de declaração de DTD."	TokenNameStringLiteral	O analisador SAX que está sendo utilizado não trata de eventos de declaração de DTD.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
,	TokenNameCOMMA	
"O analisador SAX que está sendo utilizado não possui suporte para Namespaces XML."	TokenNameStringLiteral	O analisador SAX que está sendo utilizado não possui suporte para Namespaces XML.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
,	TokenNameCOMMA	
"Não foi possível resolver a referência de URI ''{0}''."	TokenNameStringLiteral	Não foi possível resolver a referência de URI ''{0}''.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
,	TokenNameCOMMA	
"Elemento XSL não suportado ''{0}''"	TokenNameStringLiteral	Elemento XSL não suportado ''{0}''
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
,	TokenNameCOMMA	
"Extensão XSLTC não reconhecida ''{0}''"	TokenNameStringLiteral	Extensão XSLTC não reconhecida ''{0}''
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
,	TokenNameCOMMA	
"Um atributo cujo valor deve ser um QName apresentou o valor ''{0}''"	TokenNameStringLiteral	Um atributo cujo valor deve ser um QName apresentou o valor ''{0}''
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
,	TokenNameCOMMA	
"Um atributo cujo valor deve ser um NCName apresentou o valor ''{0}''"	TokenNameStringLiteral	Um atributo cujo valor deve ser um NCName apresentou o valor ''{0}''
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
BasisLibrary	TokenNameIdentifier	 Basis Library
...
,	TokenNameCOMMA	
"O uso da função de extensão ''{0}'' não é permitido quando o recurso de processamento seguro é definido como true."	TokenNameStringLiteral	O uso da função de extensão ''{0}'' não é permitido quando o recurso de processamento seguro é definido como true.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
BasisLibrary	TokenNameIdentifier	 Basis Library
