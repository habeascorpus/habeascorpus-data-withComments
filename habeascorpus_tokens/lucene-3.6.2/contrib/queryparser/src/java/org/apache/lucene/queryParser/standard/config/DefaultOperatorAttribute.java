...
;	TokenNameSEMICOLON	
/** * This attribute is used by {@link GroupQueryNodeProcessor} processor and must * be defined in the {@link QueryConfigHandler}. This attribute tells the * processor which is the default boolean operator when no operator is defined * between terms. <br/> * * @deprecated * */	TokenNameCOMMENT_JAVADOC	 This attribute is used by {@link GroupQueryNodeProcessor} processor and must be defined in the {@link QueryConfigHandler}. This attribute tells the processor which is the default boolean operator when no operator is defined between terms. <br/> * @deprecated 
@	TokenNameAT	
