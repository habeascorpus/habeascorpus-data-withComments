...
;	TokenNameSEMICOLON	
/** * A Node that uses an EventSupport for its event registration and * dispatch. * * @author <a href="mailto:Thierry.Kormann@sophia.inria.fr">Thierry Kormann</a> * @author <a href="mailto:stephane@hillion.org">Stephane Hillion</a> * @version $Id: NodeEventTarget.java 484911 2006-12-09 04:37:29Z cam $ */	TokenNameCOMMENT_JAVADOC	 A Node that uses an EventSupport for its event registration and dispatch. * @author <a href="mailto:Thierry.Kormann@sophia.inria.fr">Thierry Kormann</a> @author <a href="mailto:stephane@hillion.org">Stephane Hillion</a> @version $Id: NodeEventTarget.java 484911 2006-12-09 04:37:29Z cam $ 
...
EventTarget	TokenNameIdentifier	 Event Target
{	TokenNameLBRACE	
/** * Returns the event support instance for this node, or null if any. */	TokenNameCOMMENT_JAVADOC	 Returns the event support instance for this node, or null if any. 
EventSupport	TokenNameIdentifier	 Event Support
getEventSupport	TokenNameIdentifier	 get Event Support
(	TokenNameLPAREN	
)	TokenNameRPAREN	
;	TokenNameSEMICOLON	
/** * Returns the parent node event target. */	TokenNameCOMMENT_JAVADOC	 Returns the parent node event target. 
NodeEventTarget	TokenNameIdentifier	 Node Event Target
getParentNodeEventTarget	TokenNameIdentifier	 get Parent Node Event Target
(	TokenNameLPAREN	
)	TokenNameRPAREN	
;	TokenNameSEMICOLON	
// Members inherited from DOM Level 3 Events org.w3c.dom.events.EventTarget 	TokenNameCOMMENT_LINE	Members inherited from DOM Level 3 Events org.w3c.dom.events.EventTarget 
// follow. 	TokenNameCOMMENT_LINE	follow. 
