...
;	TokenNameSEMICOLON	
/** * Element namespace implementation; stores PSVI element items. * * @xerces.internal * * @author Sandy Gao, IBM * * @version $Id: PSVIElementNSImpl.java 1024038 2010-10-18 22:06:35Z sandygao $ */	TokenNameCOMMENT_JAVADOC	 Element namespace implementation; stores PSVI element items. * @xerces.internal * @author Sandy Gao, IBM * @version $Id: PSVIElementNSImpl.java 1024038 2010-10-18 22:06:35Z sandygao $ 
...
;	TokenNameSEMICOLON	
/** * Construct an element node. */	TokenNameCOMMENT_JAVADOC	 Construct an element node. 
public	TokenNamepublic	
PSVIElementNSImpl	TokenNameIdentifier	 PSVI Element NS Impl
(	TokenNameLPAREN	
...
;	TokenNameSEMICOLON	
/** false if the element value was provided by the schema; true otherwise. */	TokenNameCOMMENT_JAVADOC	 false if the element value was provided by the schema; true otherwise. 
protected	TokenNameprotected	
boolean	TokenNameboolean	
...
/** * Copy PSVI properties from another psvi item. * * @param elem the source of element PSVI items */	TokenNameCOMMENT_JAVADOC	 Copy PSVI properties from another psvi item. * @param elem the source of element PSVI items 
public	TokenNamepublic	
void	TokenNamevoid	
