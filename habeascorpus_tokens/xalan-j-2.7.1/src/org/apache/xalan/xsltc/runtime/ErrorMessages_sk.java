...
/* * $Id: ErrorMessages_sk.java 468652 2006-10-28 07:05:17Z minchau $ */	TokenNameCOMMENT_BLOCK	 $Id: ErrorMessages_sk.java 468652 2006-10-28 07:05:17Z minchau $ 
...
,	TokenNameCOMMA	
"V ''{0}'' sa vyskytla interná runtime chyba"	TokenNameStringLiteral	V ''{0}'' sa vyskytla interná runtime chyba
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
,	TokenNameCOMMA	
"Chyba ?asu spustenia pri spú??aní <xsl:copy>."	TokenNameStringLiteral	Chyba ?asu spustenia pri spú??aní <xsl:copy>.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
,	TokenNameCOMMA	
"Konverzia z ''{0}'' na ''{1}'' je neplatná."	TokenNameStringLiteral	Konverzia z ''{0}'' na ''{1}'' je neplatná.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
,	TokenNameCOMMA	
"XLTC nepodporuje externú funkciu ''{0}''."	TokenNameStringLiteral	XLTC nepodporuje externú funkciu ''{0}''.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
,	TokenNameCOMMA	
"Neznámy typ argumentu je v?razom rovnosti."	TokenNameStringLiteral	Neznámy typ argumentu je v?razom rovnosti.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
,	TokenNameCOMMA	
"Vo volaní do ''{1}'' je neplatn? typ argumentu ''{0}'' "	TokenNameStringLiteral	Vo volaní do ''{1}'' je neplatn? typ argumentu ''{0}'' 
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
,	TokenNameCOMMA	
"Prebieha pokus o formátovanie ?ísla ''{0}'' pomocou vzoru ''{1}''."	TokenNameStringLiteral	Prebieha pokus o formátovanie ?ísla ''{0}'' pomocou vzoru ''{1}''.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
,	TokenNameCOMMA	
"Iterátor ''{0}'' sa nedá klonova?."	TokenNameStringLiteral	Iterátor ''{0}'' sa nedá klonova?.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
,	TokenNameCOMMA	
"Iterátor pre os ''{0}'' nie je podporovan?."	TokenNameStringLiteral	Iterátor pre os ''{0}'' nie je podporovan?.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
/* * Note to translators: The following represents an internal error * situation in XSLTC. The processor attempted to create an iterator * for a particular axis (see definition above) that it does not * support. */	TokenNameCOMMENT_BLOCK	 Note to translators: The following represents an internal error situation in XSLTC. The processor attempted to create an iterator for a particular axis (see definition above) that it does not support. 
{	TokenNameLBRACE	
...
,	TokenNameCOMMA	
"Iterátor pre zadanú os ''{0}'' nie je podporovan?."	TokenNameStringLiteral	Iterátor pre zadanú os ''{0}'' nie je podporovan?.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
,	TokenNameCOMMA	
"DOMAdapter bol vytvoren? pomocou nesprávneho typu zdrojového DOM."	TokenNameStringLiteral	DOMAdapter bol vytvoren? pomocou nesprávneho typu zdrojového DOM.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
,	TokenNameCOMMA	
"Analyzátor SAX, ktor? pou?ívate, nespracúva udalosti deklarácie DTD."	TokenNameStringLiteral	Analyzátor SAX, ktor? pou?ívate, nespracúva udalosti deklarácie DTD.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
,	TokenNameCOMMA	
"Analyzátor SAX, ktor? pou?ívate, nemá podporu pre názvové priestory XML."	TokenNameStringLiteral	Analyzátor SAX, ktor? pou?ívate, nemá podporu pre názvové priestory XML.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
,	TokenNameCOMMA	
"Nebolo mo?né rozlí?i? odkaz na URI ''{0}''."	TokenNameStringLiteral	Nebolo mo?né rozlí?i? odkaz na URI ''{0}''.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
,	TokenNameCOMMA	
"?pecifikovan? translet ''{0}'' bol vytvoren? pomocou verzie XSLTC, ktorá je nov?ia ako verzia XSLTC runtime, ktor? sa pou?íva. Musíte prekompilova? definície ?t?lov (objekt stylesheet) alebo pou?i? na spustenie tohto transletu nov?iu verziu nástroja XSLTC."	TokenNameStringLiteral	?pecifikovan? translet ''{0}'' bol vytvoren? pomocou verzie XSLTC, ktorá je nov?ia ako verzia XSLTC runtime, ktor? sa pou?íva. Musíte prekompilova? definície ?t?lov (objekt stylesheet) alebo pou?i? na spustenie tohto transletu nov?iu verziu nástroja XSLTC.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
,	TokenNameCOMMA	
"Atribút, ktor? musí ma? hodnotu QName, mal hodnotu ''{0}''"	TokenNameStringLiteral	Atribút, ktor? musí ma? hodnotu QName, mal hodnotu ''{0}''
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
,	TokenNameCOMMA	
"Pou?ívanie funkcie roz?írenia ''{0}'' nie je povolené, ke? je funkcia bezpe?ného spracovania nastavená na hodnotu true."	TokenNameStringLiteral	Pou?ívanie funkcie roz?írenia ''{0}'' nie je povolené, ke? je funkcia bezpe?ného spracovania nastavená na hodnotu true.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
BasisLibrary	TokenNameIdentifier	 Basis Library
