...
/** * Simple {@link Encoder} implementation that does not modify the output * */	TokenNameCOMMENT_JAVADOC	 Simple {@link Encoder} implementation that does not modify the output 
