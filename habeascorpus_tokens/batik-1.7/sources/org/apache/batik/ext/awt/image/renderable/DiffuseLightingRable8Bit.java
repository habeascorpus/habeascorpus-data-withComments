...
;	TokenNameSEMICOLON	
/** * Implementation of the DiffuseLightRable interface. * * @author <a href="mailto:vincent.hardy@eng.sun.com">Vincent Hardy</a> * @version $Id: DiffuseLightingRable8Bit.java 475477 2006-11-15 22:44:28Z cam $ */	TokenNameCOMMENT_JAVADOC	 Implementation of the DiffuseLightRable interface. * @author <a href="mailto:vincent.hardy@eng.sun.com">Vincent Hardy</a> @version $Id: DiffuseLightingRable8Bit.java 475477 2006-11-15 22:44:28Z cam $ 
...
{	TokenNameLBRACE	
/** * Surface Scale */	TokenNameCOMMENT_JAVADOC	 Surface Scale 
private	TokenNameprivate	
double	TokenNamedouble	
surfaceScale	TokenNameIdentifier	 surface Scale
;	TokenNameSEMICOLON	
/** * Diffuse constant */	TokenNameCOMMENT_JAVADOC	 Diffuse constant 
private	TokenNameprivate	
double	TokenNamedouble	
kd	TokenNameIdentifier	 kd
;	TokenNameSEMICOLON	
/** * Light used for the diffuse lighting computations */	TokenNameCOMMENT_JAVADOC	 Light used for the diffuse lighting computations 
private	TokenNameprivate	
Light	TokenNameIdentifier	 Light
light	TokenNameIdentifier	 light
;	TokenNameSEMICOLON	
/** * Lit Area */	TokenNameCOMMENT_JAVADOC	 Lit Area 
private	TokenNameprivate	
Rectangle2D	TokenNameIdentifier	 Rectangle2 D
litRegion	TokenNameIdentifier	 lit Region
;	TokenNameSEMICOLON	
/** * The dx/dy to use in user space for the sobel gradient. */	TokenNameCOMMENT_JAVADOC	 The dx/dy to use in user space for the sobel gradient. 
private	TokenNameprivate	
...
/** * Returns this filter's litRegion */	TokenNameCOMMENT_JAVADOC	 Returns this filter's litRegion 
public	TokenNamepublic	
Rectangle2D	TokenNameIdentifier	 Rectangle2 D
...
/** * Set this filter's litRegion */	TokenNameCOMMENT_JAVADOC	 Set this filter's litRegion 
public	TokenNamepublic	
void	TokenNamevoid	
setLitRegion	TokenNameIdentifier	 set Lit Region
(	TokenNameLPAREN	
...
// DiffuseLightingRed only operates on a scaled space. 	TokenNameCOMMENT_LINE	DiffuseLightingRed only operates on a scaled space. 
// The following extracts the scale portion of the 	TokenNameCOMMENT_LINE	The following extracts the scale portion of the 
// user to device transform 	TokenNameCOMMENT_LINE	user to device transform 
// 	TokenNameCOMMENT_LINE	 
// The source is rendered with the scale-only transform 	TokenNameCOMMENT_LINE	The source is rendered with the scale-only transform 
// and the rendered result is used as a bumpMap for the 	TokenNameCOMMENT_LINE	and the rendered result is used as a bumpMap for the 
// DiffuseLightingRed filter. 	TokenNameCOMMENT_LINE	DiffuseLightingRed filter. 
// 	TokenNameCOMMENT_LINE	 
double	TokenNamedouble	
...
{	TokenNameLBRACE	
// Non invertible transform 	TokenNameCOMMENT_LINE	Non invertible transform 
return	TokenNamereturn	
null	TokenNamenull	
;	TokenNameSEMICOLON	
}	TokenNameRBRACE	
// These values represent the scale factor to the intermediate 	TokenNameCOMMENT_LINE	These values represent the scale factor to the intermediate 
// coordinate system where we will apply our convolution. 	TokenNameCOMMENT_LINE	coordinate system where we will apply our convolution. 
if	TokenNameif	
(	TokenNameLPAREN	
kernelUnitLength	TokenNameIdentifier	 kernel Unit Length
!=	TokenNameNOT_EQUAL	
...
;	TokenNameSEMICOLON	
// Grow for surround needs of bump map. 	TokenNameCOMMENT_LINE	Grow for surround needs of bump map. 
aoiR	TokenNameIdentifier	 aoi R
.	TokenNameDOT	
...
;	TokenNameSEMICOLON	
// Build texture from the source 	TokenNameCOMMENT_LINE	Build texture from the source 
rc	TokenNameIdentifier	 rc
=	TokenNameEQUAL	
(	TokenNameLPAREN	
RenderContext	TokenNameIdentifier	 Render Context
...
rc	TokenNameIdentifier	 rc
.	TokenNameDOT	
setAreaOfInterest	TokenNameIdentifier	 set Area Of Interest
(	TokenNameLPAREN	
aoiR	TokenNameIdentifier	 aoi R
)	TokenNameRPAREN	
;	TokenNameSEMICOLON	
