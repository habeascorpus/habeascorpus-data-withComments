...
/* * $Id: ErrorMessages_ru.java 468649 2006-10-28 07:00:55Z minchau $ */	TokenNameCOMMENT_BLOCK	 $Id: ErrorMessages_ru.java 468649 2006-10-28 07:00:55Z minchau $ 
...
,	TokenNameCOMMA	
"?? ??????? ????????????? ??? argument/return ??? ?????? ?????? ''{0}''"	TokenNameStringLiteral	?? ??????? ????????????? ??? argument/return ??? ?????? ?????? ''{0}''
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
,	TokenNameCOMMA	
"??????? use <key> ?????? ???? node, node-set, string ??? number."	TokenNameStringLiteral	??????? use <key> ?????? ???? node, node-set, string ??? number.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
,	TokenNameCOMMA	
"? ?????? Templates ??? ??????????? ??????????? ?????? ???????? ??????????????."	TokenNameStringLiteral	? ?????? Templates ??? ??????????? ??????????? ?????? ???????? ??????????????.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
/* * Note to translators: "Templates" is a Java class name that should * not be translated. */	TokenNameCOMMENT_BLOCK	 Note to translators: "Templates" is a Java class name that should not be translated. 
{	TokenNameLBRACE	
...
,	TokenNameCOMMA	
"??????? ????????? ???????? null ?????????? ErrorListener ??? ''{0}''"	TokenNameStringLiteral	??????? ????????? ???????? null ?????????? ErrorListener ??? ''{0}''
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
,	TokenNameCOMMA	
"????? startDocument() ?????????? ??????? setResult()."	TokenNameStringLiteral	????? startDocument() ?????????? ??????? setResult().
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
,	TokenNameCOMMA	
"?????? Result, ?????????? ''{0}'', ??????????. "	TokenNameStringLiteral	?????? Result, ?????????? ''{0}'', ??????????. 
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
,	TokenNameCOMMA	
"SYNOPSIS java org.apache.xalan.xsltc.cmdline.Compile [-o <????????-????>] [-d <???????>] [-j <????-jar>] [-p <?????>] [-n] [-x] [-u] [-v] [-h] { <???????-??????> | -i } ????? -o <????????-????> ??????????? ??? <????????-????> ?????????? ??????? translet. ?? ????????? ??? ????????? ?????????????? ??????? ?? ????? <???????-??????>. ??? ?????????? ?????????? ?????? ?????? ??? ????? ????????????. -d <???????> ?????? ??????? ??????? ??? ????????? ?????????????? -j <????-jar> ??????????? ?????? ????????? ?????????????? ? <????-jar> ? ????????? ?????? -p <?????> ?????? ??????? ????? ?????? ??? ???? ????????? ??????? ????????? ?????????????? -n ????????? ??????????? ????? ??????? (?????? ??????, ??????????? ?? ?????????, ???????? ?????). -x ???????? ????????? ?????????? ????????? -u ???????????????? ????????? <???????-??????> ??? URL -i ?????? ??????? ?????? ?? stdin -v ???????? ?????? ??????????? -h ?????? ??? ????????? "	TokenNameStringLiteral	SYNOPSIS java org.apache.xalan.xsltc.cmdline.Compile [-o <????????-????>] [-d <???????>] [-j <????-jar>] [-p <?????>] [-n] [-x] [-u] [-v] [-h] { <???????-??????> | -i } ????? -o <????????-????> ??????????? ??? <????????-????> ?????????? ??????? translet. ?? ????????? ??? ????????? ?????????????? ??????? ?? ????? <???????-??????>. ??? ?????????? ?????????? ?????? ?????? ??? ????? ????????????. -d <???????> ?????? ??????? ??????? ??? ????????? ?????????????? -j <????-jar> ??????????? ?????? ????????? ?????????????? ? <????-jar> ? ????????? ?????? -p <?????> ?????? ??????? ????? ?????? ??? ???? ????????? ??????? ????????? ?????????????? -n ????????? ??????????? ????? ??????? (?????? ??????, ??????????? ?? ?????????, ???????? ?????). -x ???????? ????????? ?????????? ????????? -u ???????????????? ????????? <???????-??????> ??? URL -i ?????? ??????? ?????? ?? stdin -v ???????? ?????? ??????????? -h ?????? ??? ????????? 
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
,	TokenNameCOMMA	
"SYNOPSIS java org.apache.xalan.xsltc.cmdline.Transform [-j <????-jar>] [-x] [-n <????????>] {-u <URL-?????????> | <????????>} <?????> [<????????1>=<????????1> ...] ????????? ????????? <?????> ??? ?????????????? ????????? XML, ?????????? ? ????????? <????????>. <?????> ????????? ?????????????? ?????? ???? ???????? ???? ? ??????? CLASSPATH ????????????, ???? ? ??????? ?????????? <?????-jar>. ????? -j <????-jar> ???? jar, ?? ???????? ????? ????????? translet -x ???????? ????????? ?????????? ????????? -n <????????> ????????? ?????????????? ????????? ????? ??? ? ???????? ???????? ? ????????? -u <URL-?????????> URL ???????? ????????? XML "	TokenNameStringLiteral	SYNOPSIS java org.apache.xalan.xsltc.cmdline.Transform [-j <????-jar>] [-x] [-n <????????>] {-u <URL-?????????> | <????????>} <?????> [<????????1>=<????????1> ...] ????????? ????????? <?????> ??? ?????????????? ????????? XML, ?????????? ? ????????? <????????>. <?????> ????????? ?????????????? ?????? ???? ???????? ???? ? ??????? CLASSPATH ????????????, ???? ? ??????? ?????????? <?????-jar>. ????? -j <????-jar> ???? jar, ?? ???????? ????? ????????? translet -x ???????? ????????? ?????????? ????????? -n <????????> ????????? ?????????????? ????????? ????? ??? ? ???????? ???????? ? ????????? -u <URL-?????????> URL ???????? ????????? XML 
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
,	TokenNameCOMMA	
"?????????????? ? ??????? ????????? ''{0}'' ?? ????? jar ''{1}''"	TokenNameStringLiteral	?????????????? ? ??????? ????????? ''{0}'' ?? ????? jar ''{1}''
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
,	TokenNameCOMMA	
"? ???????? ?????? ???????? <xsl:output> ??????? ???????? ''{0}''. ????????? ????????? ???????? ''xml'', ''html'', ''text'' ? qname, ?? ?? ncname"	TokenNameStringLiteral	? ???????? ?????? ???????? <xsl:output> ??????? ???????? ''{0}''. ????????? ????????? ???????? ''xml'', ''html'', ''text'' ? qname, ?? ?? ncname
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ErrorMsg	TokenNameIdentifier	 Error Msg
