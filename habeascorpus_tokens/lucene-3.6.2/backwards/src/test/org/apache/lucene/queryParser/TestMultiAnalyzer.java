...
public	TokenNamepublic	
void	TokenNamevoid	
testMultiAnalyzerWithSubclassOfQueryParser	TokenNameIdentifier	 test Multi Analyzer With Subclass Of Query Parser
(	TokenNameLPAREN	
)	TokenNameRPAREN	
throws	TokenNamethrows	
ParseException	TokenNameIdentifier	 Parse Exception
{	TokenNameLBRACE	
DumbQueryParser	TokenNameIdentifier	 Dumb Query Parser
qp	TokenNameIdentifier	 qp
=	TokenNameEQUAL	
new	TokenNamenew	
DumbQueryParser	TokenNameIdentifier	 Dumb Query Parser
...
;	TokenNameSEMICOLON	
// modified default slop 	TokenNameCOMMENT_LINE	modified default slop 
...
assertEquals	TokenNameIdentifier	 assert Equals
(	TokenNameLPAREN	
""foo bar"~99"	TokenNameStringLiteral	"foo bar"~99
,	TokenNameCOMMA	
qp	TokenNameIdentifier	 qp
.	TokenNameDOT	
getSuperFieldQuery	TokenNameIdentifier	 get Super Field Query
(	TokenNameLPAREN	
""	TokenNameStringLiteral	 
,	TokenNameCOMMA	
...
assertEquals	TokenNameIdentifier	 assert Equals
(	TokenNameLPAREN	
""(multi multi2) bar"~99"	TokenNameStringLiteral	"(multi multi2) bar"~99
,	TokenNameCOMMA	
qp	TokenNameIdentifier	 qp
.	TokenNameDOT	
getSuperFieldQuery	TokenNameIdentifier	 get Super Field Query
...
""	TokenNameStringLiteral	 
,	TokenNameCOMMA	
"multi bar"	TokenNameStringLiteral	multi bar
,	TokenNameCOMMA	
true	TokenNametrue	
)	TokenNameRPAREN	
.	TokenNameDOT	
...
/** a very simple subclass of QueryParser */	TokenNameCOMMENT_JAVADOC	 a very simple subclass of QueryParser 
private	TokenNameprivate	
final	TokenNamefinal	
static	TokenNamestatic	
class	TokenNameclass	
...
/** expose super's version */	TokenNameCOMMENT_JAVADOC	 expose super's version 
public	TokenNamepublic	
Query	TokenNameIdentifier	 Query
getSuperFieldQuery	TokenNameIdentifier	 get Super Field Query
(	TokenNameLPAREN	
...
/** wrap super's version */	TokenNameCOMMENT_JAVADOC	 wrap super's version 
@	TokenNameAT	
Override	TokenNameIdentifier	 Override
...
return	TokenNamereturn	
new	TokenNamenew	
DumbQueryWrapper	TokenNameIdentifier	 Dumb Query Wrapper
(	TokenNameLPAREN	
getSuperFieldQuery	TokenNameIdentifier	 get Super Field Query
(	TokenNameLPAREN	
f	TokenNameIdentifier	 f
...
/** * A very simple wrapper to prevent instanceof checks but uses * the toString of the query it wraps. */	TokenNameCOMMENT_JAVADOC	 A very simple wrapper to prevent instanceof checks but uses the toString of the query it wraps. 
private	TokenNameprivate	
final	TokenNamefinal	
static	TokenNamestatic	
class	TokenNameclass	
