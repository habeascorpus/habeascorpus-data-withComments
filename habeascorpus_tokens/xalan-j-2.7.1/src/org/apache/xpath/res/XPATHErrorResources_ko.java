...
/* * $Id: XPATHErrorResources_ko.java 468655 2006-10-28 07:12:06Z minchau $ */	TokenNameCOMMENT_BLOCK	 $Id: XPATHErrorResources_ko.java 468655 2006-10-28 07:12:06Z minchau $ 
...
XPATHErrorResources_ko	TokenNameIdentifier	 XPATH Error Resources ko
...
ER_INCORRECT_ARG_LENGTH	TokenNameIdentifier	 ER  INCORRECT  ARG  LENGTH
,	TokenNameCOMMA	
"processing-instruction() node ???? ?? ??? ???? ????."	TokenNameStringLiteral	processing-instruction() node ???? ?? ??? ???? ????.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_CANT_CONVERT_TO_NUMBER	TokenNameIdentifier	 ER  CANT  CONVERT  TO  NUMBER
...
ER_UNKNOWN_OPCODE	TokenNameIdentifier	 ER  UNKNOWN  OPCODE
,	TokenNameCOMMA	
"??. ? ? ?? op ??: {0}"	TokenNameStringLiteral	??. ? ? ?? op ??: {0}
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_EXTRA_ILLEGAL_TOKENS	TokenNameIdentifier	 ER  EXTRA  ILLEGAL  TOKENS
...
ER_PARSE_NOT_SUPPORTED	TokenNameIdentifier	 ER  PARSE  NOT  SUPPORTED
,	TokenNameCOMMA	
"XPathContext?? ?? ??(InputSource ??)? ???? ????. {0}?(?) ? ? ????."	TokenNameStringLiteral	XPathContext?? ?? ??(InputSource ??)? ???? ????. {0}?(?) ? ? ????.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_SAX_API_NOT_HANDLED	TokenNameIdentifier	 ER  SAX  API  NOT  HANDLED
,	TokenNameCOMMA	
"SAX API ??(char ch[]... ? DTM? ?? ???? ????."	TokenNameStringLiteral	SAX API ??(char ch[]... ? DTM? ?? ???? ????.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_IGNORABLE_WHITESPACE_NOT_HANDLED	TokenNameIdentifier	 ER  IGNORABLE  WHITESPACE  NOT  HANDLED
...
ER_XERCES_PARSE_ERROR_DETAILS	TokenNameIdentifier	 ER  XERCES  PARSE  ERROR  DETAILS
,	TokenNameCOMMA	
"DOM2Helper.parse ??: ??? ID - {0} ?? - {1}"	TokenNameStringLiteral	DOM2Helper.parse ??: ??? ID - {0} ?? - {1}
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_XERCES_PARSE_ERROR	TokenNameIdentifier	 ER  XERCES  PARSE  ERROR
...
ER_FASTSTRINGBUFFER_CANNOT_BE_NULL	TokenNameIdentifier	 ER  FASTSTRINGBUFFER  CANNOT  BE  NULL
,	TokenNameCOMMA	
"FastStringBuffer ??? ?(null)? ? ? ????."	TokenNameStringLiteral	FastStringBuffer ??? ?(null)? ? ? ????.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_TWO_OR_THREE	TokenNameIdentifier	 ER  TWO  OR  THREE
...
ER_CANT_GET_SNAPSHOT_LENGTH	TokenNameIdentifier	 ER  CANT  GET  SNAPSHOT  LENGTH
,	TokenNameCOMMA	
"XPathResultType? {1}?? ??? XPath ??? ''{0}''? XPathResult?? getSnapshotLength ???? ??? ? ????. ? ???? UNORDERED_NODE_SNAPSHOT_TYPE ? ORDERED_NODE_SNAPSHOT_TYPE ???? ?????."	TokenNameStringLiteral	XPathResultType? {1}?? ??? XPath ??? ''{0}''? XPathResult?? getSnapshotLength ???? ??? ? ????. ? ???? UNORDERED_NODE_SNAPSHOT_TYPE ? ORDERED_NODE_SNAPSHOT_TYPE ???? ?????.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_NON_ITERATOR_TYPE	TokenNameIdentifier	 ER  NON  ITERATOR  TYPE
,	TokenNameCOMMA	
"XPathResultType? {1}?? ??? XPath ??? ''{0}''? XPathResult?? iterateNext ???? ??? ? ????. ? ???? UNORDERED_NODE_ITERATOR_TYPE ? ORDERED_NODE_ITERATOR_TYPE ???? ?????."	TokenNameStringLiteral	XPathResultType? {1}?? ??? XPath ??? ''{0}''? XPathResult?? iterateNext ???? ??? ? ????. ? ???? UNORDERED_NODE_ITERATOR_TYPE ? ORDERED_NODE_ITERATOR_TYPE ???? ?????.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
ER_INCOMPATIBLE_TYPES	TokenNameIdentifier	 ER  INCOMPATIBLE  TYPES
,	TokenNameCOMMA	
"XPath ??? ''{0}''? XPathResult? ??? XPathResultType {2}(?)? ?? ??? ? ?? XPathReultType {1}?(?) ????."	TokenNameStringLiteral	XPath ??? ''{0}''? XPathResult? ??? XPathResultType {2}(?)? ?? ??? ? ?? XPathReultType {1}?(?) ????.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_NULL_RESOLVER	TokenNameIdentifier	 ER  NULL  RESOLVER
...
ER_NON_SNAPSHOT_TYPE	TokenNameIdentifier	 ER  NON  SNAPSHOT  TYPE
,	TokenNameCOMMA	
"XPathResultType? {1}?? ??? XPath ??? ''{0}''? XPathResult?? snapshotItem ???? ??? ? ????. ? ???? UNORDERED_NODE_SNAPSHOT_TYPE ? ORDERED_NODE_SNAPSHOT_TYPE ???? ?????."	TokenNameStringLiteral	XPathResultType? {1}?? ??? XPath ??? ''{0}''? XPathResult?? snapshotItem ???? ??? ? ????. ? ???? UNORDERED_NODE_SNAPSHOT_TYPE ? ORDERED_NODE_SNAPSHOT_TYPE ???? ?????.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
ER_ARG_CANNOT_BE_NULL	TokenNameIdentifier	 ER  ARG  CANNOT  BE  NULL
,	TokenNameCOMMA	
"{0} ??? ?(null)?? ????."	TokenNameStringLiteral	{0} ??? ?(null)?? ????.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
ER_FEATURE_NAME_NULL	TokenNameIdentifier	 ER  FEATURE  NAME  NULL
,	TokenNameCOMMA	
"?(null) ??? ???? ??? ????? ???: {0}#setFeature( null, {1})"	TokenNameStringLiteral	?(null) ??? ???? ??? ????? ???: {0}#setFeature( null, {1})
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
ER_GETTING_NULL_FEATURE	TokenNameIdentifier	 ER  GETTING  NULL  FEATURE
,	TokenNameCOMMA	
"?(null) ??? ???? ??? ????? ???: {0}#getFeature(null)"	TokenNameStringLiteral	?(null) ??? ???? ??? ????? ???: {0}#getFeature(null)
}	TokenNameRBRACE	
,	TokenNameCOMMA	
/** Field ER_GETTING_NULL_FEATURE */	TokenNameCOMMENT_JAVADOC	 Field ER_GETTING_NULL_FEATURE 
{	TokenNameLBRACE	
...
ER_NULL_XPATH_FUNCTION_RESOLVER	TokenNameIdentifier	 ER  NULL  XPATH  FUNCTION  RESOLVER
,	TokenNameCOMMA	
"?(null)? XPathFunctionResolver? ????? ???: {0}#setXPathFunctionResolver(null)"	TokenNameStringLiteral	?(null)? XPathFunctionResolver? ????? ???: {0}#setXPathFunctionResolver(null)
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
ER_NULL_XPATH_VARIABLE_RESOLVER	TokenNameIdentifier	 ER  NULL  XPATH  VARIABLE  RESOLVER
,	TokenNameCOMMA	
"?(null)? XPathVariableResolver? ????? ???: {0}#setXPathVariableResolver(null)"	TokenNameStringLiteral	?(null)? XPathVariableResolver? ????? ???: {0}#setXPathVariableResolver(null)
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
WG_SECURITY_EXCEPTION	TokenNameIdentifier	 WG  SECURITY  EXCEPTION
,	TokenNameCOMMA	
"XSL ??? ??? ????? ? SecurityException? ??????: {0}"	TokenNameStringLiteral	XSL ??? ??? ????? ? SecurityException? ??????: {0}
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
WG_QUO_NO_LONGER_DEFINED	TokenNameIdentifier	 WG  QUO  NO  LONGER  DEFINED
...
,	TokenNameCOMMA	
"[-match match pattern(?? ???)]"	TokenNameStringLiteral	[-match match pattern(?? ???)]
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
