...
;	TokenNameSEMICOLON	
/** * {@link Analyzer} for Bulgarian. * <p> * This analyzer implements light-stemming as specified by: <i> Searching * Strategies for the Bulgarian Language </i> * http://members.unine.ch/jacques.savoy/Papers/BUIR.pdf * <p> */	TokenNameCOMMENT_JAVADOC	 {@link Analyzer} for Bulgarian. <p> This analyzer implements light-stemming as specified by: <i> Searching Strategies for the Bulgarian Language </i> http://members.unine.ch/jacques.savoy/Papers/BUIR.pdf <p> 
...
StopwordAnalyzerBase	TokenNameIdentifier	 Stopword Analyzer Base
{	TokenNameLBRACE	
/** * File containing default Bulgarian stopwords. * * Default stopword list is from * http://members.unine.ch/jacques.savoy/clef/index.html The stopword list is * BSD-Licensed. */	TokenNameCOMMENT_JAVADOC	 File containing default Bulgarian stopwords. * Default stopword list is from http://members.unine.ch/jacques.savoy/clef/index.html The stopword list is BSD-Licensed. 
public	TokenNamepublic	
final	TokenNamefinal	
...
;	TokenNameSEMICOLON	
/** * The comment character in the stopwords file. All lines prefixed with this * will be ignored * @deprecated use {@link WordlistLoader#getWordSet(Reader, String, Version)} directly */	TokenNameCOMMENT_JAVADOC	 The comment character in the stopwords file. All lines prefixed with this will be ignored @deprecated use {@link WordlistLoader#getWordSet(Reader, String, Version)} directly 
//TODO make this private 	TokenNameCOMMENT_LINE	TODO make this private 
@	TokenNameAT	
...
/** * Builds an analyzer with the given stop words. */	TokenNameCOMMENT_JAVADOC	 Builds an analyzer with the given stop words. 
public	TokenNamepublic	
BulgarianAnalyzer	TokenNameIdentifier	 Bulgarian Analyzer
(	TokenNameLPAREN	
Version	TokenNameIdentifier	 Version
...
/** * Builds an analyzer with the given stop words and a stem exclusion set. * If a stem exclusion set is provided this analyzer will add a {@link KeywordMarkerFilter} * before {@link BulgarianStemFilter}. */	TokenNameCOMMENT_JAVADOC	 Builds an analyzer with the given stop words and a stem exclusion set. If a stem exclusion set is provided this analyzer will add a {@link KeywordMarkerFilter} before {@link BulgarianStemFilter}. 
public	TokenNamepublic	
BulgarianAnalyzer	TokenNameIdentifier	 Bulgarian Analyzer
(	TokenNameLPAREN	
Version	TokenNameIdentifier	 Version
