...
ER_CANNOT_OVERWRITE_CAUSE	TokenNameIdentifier	 ER  CANNOT  OVERWRITE  CAUSE
,	TokenNameCOMMA	
"Nem lehet felülírni az okot"	TokenNameStringLiteral	Nem lehet felülírni az okot
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_NO_DEFAULT_IMPL	TokenNameIdentifier	 ER  NO  DEFAULT  IMPL
,	TokenNameCOMMA	
"Nem található alapértelmezett megvalósítás "	TokenNameStringLiteral	Nem található alapértelmezett megvalósítás 
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_CHUNKEDINTARRAY_NOT_SUPPORTED	TokenNameIdentifier	 ER  CHUNKEDINTARRAY  NOT  SUPPORTED
,	TokenNameCOMMA	
"A ChunkedIntArray({0}) jelenleg nem támogatott"	TokenNameStringLiteral	A ChunkedIntArray({0}) jelenleg nem támogatott
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_OFFSET_BIGGER_THAN_SLOT	TokenNameIdentifier	 ER  OFFSET  BIGGER  THAN  SLOT
,	TokenNameCOMMA	
"Az eltolás nagyobb mint a nyílás"	TokenNameStringLiteral	Az eltolás nagyobb mint a nyílás
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_COROUTINE_NOT_AVAIL	TokenNameIdentifier	 ER  COROUTINE  NOT  AVAIL
,	TokenNameCOMMA	
"Társ szubrutin nem érhet? el, id={0}"	TokenNameStringLiteral	Társ szubrutin nem érhet? el, id={0}
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_COROUTINE_CO_EXIT	TokenNameIdentifier	 ER  COROUTINE  CO  EXIT
,	TokenNameCOMMA	
"CoroutineManager érkezett a co_exit() kérésre"	TokenNameStringLiteral	CoroutineManager érkezett a co_exit() kérésre
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_COJOINROUTINESET_FAILED	TokenNameIdentifier	 ER  COJOINROUTINESET  FAILED
,	TokenNameCOMMA	
"A co_joinCoroutineSet() nem sikerült "	TokenNameStringLiteral	A co_joinCoroutineSet() nem sikerült 
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_COROUTINE_PARAM	TokenNameIdentifier	 ER  COROUTINE  PARAM
,	TokenNameCOMMA	
"Társ szubrutin paraméterhiba ({0})"	TokenNameStringLiteral	Társ szubrutin paraméterhiba ({0})
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_PARSER_DOTERMINATE_ANSWERS	TokenNameIdentifier	 ER  PARSER  DOTERMINATE  ANSWERS
,	TokenNameCOMMA	
" VÁRATLAN: Értelmez? doTerminate válaszok {0}"	TokenNameStringLiteral	 VÁRATLAN: Értelmez? doTerminate válaszok {0}
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_NO_PARSE_CALL_WHILE_PARSING	TokenNameIdentifier	 ER  NO  PARSE  CALL  WHILE  PARSING
,	TokenNameCOMMA	
"értelmezés nem hívható meg értelmezés közben "	TokenNameStringLiteral	értelmezés nem hívható meg értelmezés közben 
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_TYPED_ITERATOR_AXIS_NOT_IMPLEMENTED	TokenNameIdentifier	 ER  TYPED  ITERATOR  AXIS  NOT  IMPLEMENTED
,	TokenNameCOMMA	
"Hiba: A tipizált iterátor a(z) {0} tengelyhez nincs megvalósítva"	TokenNameStringLiteral	Hiba: A tipizált iterátor a(z) {0} tengelyhez nincs megvalósítva
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_ITERATOR_AXIS_NOT_IMPLEMENTED	TokenNameIdentifier	 ER  ITERATOR  AXIS  NOT  IMPLEMENTED
,	TokenNameCOMMA	
"Hiba: Az iterátor a(z) {0} tengelyhez nincs megvalósítva "	TokenNameStringLiteral	Hiba: Az iterátor a(z) {0} tengelyhez nincs megvalósítva 
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_ITERATOR_CLONE_NOT_SUPPORTED	TokenNameIdentifier	 ER  ITERATOR  CLONE  NOT  SUPPORTED
,	TokenNameCOMMA	
"Az iterátor klónozása nem támogatott"	TokenNameStringLiteral	Az iterátor klónozása nem támogatott
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_UNKNOWN_AXIS_TYPE	TokenNameIdentifier	 ER  UNKNOWN  AXIS  TYPE
,	TokenNameCOMMA	
"Ismeretlen tengely bejárási út típus: {0}"	TokenNameStringLiteral	Ismeretlen tengely bejárási út típus: {0}
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_AXIS_NOT_SUPPORTED	TokenNameIdentifier	 ER  AXIS  NOT  SUPPORTED
,	TokenNameCOMMA	
"A tengely bejárási út nem támogatott: {0}"	TokenNameStringLiteral	A tengely bejárási út nem támogatott: {0}
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_NO_DTMIDS_AVAIL	TokenNameIdentifier	 ER  NO  DTMIDS  AVAIL
,	TokenNameCOMMA	
"Nincs több DTM azonosító"	TokenNameStringLiteral	Nincs több DTM azonosító
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_NOT_SUPPORTED	TokenNameIdentifier	 ER  NOT  SUPPORTED
...
ER_NODE_NON_NULL	TokenNameIdentifier	 ER  NODE  NON  NULL
,	TokenNameCOMMA	
"A csomópont nem lehet null a getDTMHandleFromNode függvényhez"	TokenNameStringLiteral	A csomópont nem lehet null a getDTMHandleFromNode függvényhez
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_COULD_NOT_RESOLVE_NODE	TokenNameIdentifier	 ER  COULD  NOT  RESOLVE  NODE
,	TokenNameCOMMA	
"A csomópontot nem lehet azonosítóra feloldani"	TokenNameStringLiteral	A csomópontot nem lehet azonosítóra feloldani
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_STARTPARSE_WHILE_PARSING	TokenNameIdentifier	 ER  STARTPARSE  WHILE  PARSING
,	TokenNameCOMMA	
"A startParse függvényt nem hívhatja meg értelmezés közben"	TokenNameStringLiteral	A startParse függvényt nem hívhatja meg értelmezés közben
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_STARTPARSE_NEEDS_SAXPARSER	TokenNameIdentifier	 ER  STARTPARSE  NEEDS  SAXPARSER
,	TokenNameCOMMA	
"A startParse függvényhez nemnull SAXParser szükséges"	TokenNameStringLiteral	A startParse függvényhez nemnull SAXParser szükséges
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_COULD_NOT_INIT_PARSER	TokenNameIdentifier	 ER  COULD  NOT  INIT  PARSER
,	TokenNameCOMMA	
"Nem lehet inicializálni az értelmez?t ezzel"	TokenNameStringLiteral	Nem lehet inicializálni az értelmez?t ezzel
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_EXCEPTION_CREATING_POOL	TokenNameIdentifier	 ER  EXCEPTION  CREATING  POOL
,	TokenNameCOMMA	
"kivétel egy új tárolópéldány létrehozásakor"	TokenNameStringLiteral	kivétel egy új tárolópéldány létrehozásakor
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_PATH_CONTAINS_INVALID_ESCAPE_SEQUENCE	TokenNameIdentifier	 ER  PATH  CONTAINS  INVALID  ESCAPE  SEQUENCE
...
ER_SCHEME_REQUIRED	TokenNameIdentifier	 ER  SCHEME  REQUIRED
,	TokenNameCOMMA	
"Séma szükséges."	TokenNameStringLiteral	Séma szükséges.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_NO_SCHEME_IN_URI	TokenNameIdentifier	 ER  NO  SCHEME  IN  URI
,	TokenNameCOMMA	
"Nem található séma az URI-ban: {0}"	TokenNameStringLiteral	Nem található séma az URI-ban: {0}
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_NO_SCHEME_INURI	TokenNameIdentifier	 ER  NO  SCHEME  INURI
...
ER_PARSER_IN_USE	TokenNameIdentifier	 ER  PARSER  IN  USE
,	TokenNameCOMMA	
"Az értelmez? már használatban van"	TokenNameStringLiteral	Az értelmez? már használatban van
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_CANNOT_CHANGE_WHILE_PARSING	TokenNameIdentifier	 ER  CANNOT  CHANGE  WHILE  PARSING
,	TokenNameCOMMA	
"Nem változtatható meg a(z) {0} {1} értelmezés közben"	TokenNameStringLiteral	Nem változtatható meg a(z) {0} {1} értelmezés közben
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_SELF_CAUSATION_NOT_PERMITTED	TokenNameIdentifier	 ER  SELF  CAUSATION  NOT  PERMITTED
,	TokenNameCOMMA	
"Az ön-megokolás nem megengedett"	TokenNameStringLiteral	Az ön-megokolás nem megengedett
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_NO_USERINFO_IF_NO_HOST	TokenNameIdentifier	 ER  NO  USERINFO  IF  NO  HOST
...
ER_METHOD_NOT_SUPPORTED	TokenNameIdentifier	 ER  METHOD  NOT  SUPPORTED
,	TokenNameCOMMA	
"A metódus még nem támogatott "	TokenNameStringLiteral	A metódus még nem támogatott 
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_INCRSAXSRCFILTER_NOT_RESTARTABLE	TokenNameIdentifier	 ER  INCRSAXSRCFILTER  NOT  RESTARTABLE
,	TokenNameCOMMA	
"Az IncrementalSAXSource_Filter jelenleg nem índítható újra"	TokenNameStringLiteral	Az IncrementalSAXSource_Filter jelenleg nem índítható újra
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_XMLRDR_NOT_BEFORE_STARTPARSE	TokenNameIdentifier	 ER  XMLRDR  NOT  BEFORE  STARTPARSE
,	TokenNameCOMMA	
"Az XMLReader nem a startParse kérés el?tt van "	TokenNameStringLiteral	Az XMLReader nem a startParse kérés el?tt van 
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_AXIS_TRAVERSER_NOT_SUPPORTED	TokenNameIdentifier	 ER  AXIS  TRAVERSER  NOT  SUPPORTED
...
ER_ERRORHANDLER_CREATED_WITH_NULL_PRINTWRITER	TokenNameIdentifier	 ER  ERRORHANDLER  CREATED  WITH  NULL  PRINTWRITER
,	TokenNameCOMMA	
"A ListingErrorHandler null PrintWriter értékkel jött létre."	TokenNameStringLiteral	A ListingErrorHandler null PrintWriter értékkel jött létre.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_SYSTEMID_UNKNOWN	TokenNameIdentifier	 ER  SYSTEMID  UNKNOWN
...
ER_CREATEDOCUMENT_NOT_SUPPORTED	TokenNameIdentifier	 ER  CREATEDOCUMENT  NOT  SUPPORTED
,	TokenNameCOMMA	
"A createDocument() nem támogatott az XPathContext-ben."	TokenNameStringLiteral	A createDocument() nem támogatott az XPathContext-ben.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_CHILD_HAS_NO_OWNER_DOCUMENT	TokenNameIdentifier	 ER  CHILD  HAS  NO  OWNER  DOCUMENT
,	TokenNameCOMMA	
"Az attribútum utódnak nincs tulajdonos dokumentuma."	TokenNameStringLiteral	Az attribútum utódnak nincs tulajdonos dokumentuma.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_CHILD_HAS_NO_OWNER_DOCUMENT_ELEMENT	TokenNameIdentifier	 ER  CHILD  HAS  NO  OWNER  DOCUMENT  ELEMENT
,	TokenNameCOMMA	
"Az attribútum utódnak nincs tulajdonos dokumentumeleme."	TokenNameStringLiteral	Az attribútum utódnak nincs tulajdonos dokumentumeleme.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_CANT_OUTPUT_TEXT_BEFORE_DOC	TokenNameIdentifier	 ER  CANT  OUTPUT  TEXT  BEFORE  DOC
,	TokenNameCOMMA	
"Figyelmeztetés: nem lehet szöveget kiírni dokumentum elem el?tt. Figyelmen kívül marad..."	TokenNameStringLiteral	Figyelmeztetés: nem lehet szöveget kiírni dokumentum elem el?tt. Figyelmen kívül marad...
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_CANT_HAVE_MORE_THAN_ONE_ROOT	TokenNameIdentifier	 ER  CANT  HAVE  MORE  THAN  ONE  ROOT
,	TokenNameCOMMA	
"Nem lehet egynél több gyökér a DOM-ban"	TokenNameStringLiteral	Nem lehet egynél több gyökér a DOM-ban
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_ARG_LOCALNAME_NULL	TokenNameIdentifier	 ER  ARG  LOCALNAME  NULL
...
ER_ARG_LOCALNAME_INVALID	TokenNameIdentifier	 ER  ARG  LOCALNAME  INVALID
,	TokenNameCOMMA	
"A QNAME-beli helyi névnek egy érvényes NCName-nek kell lennie"	TokenNameStringLiteral	A QNAME-beli helyi névnek egy érvényes NCName-nek kell lennie
}	TokenNameRBRACE	
,	TokenNameCOMMA	
// Note to translators: A QNAME has the syntactic form [NCName:]NCName 	TokenNameCOMMENT_LINE	Note to translators: A QNAME has the syntactic form [NCName:]NCName 
...
ER_ARG_PREFIX_INVALID	TokenNameIdentifier	 ER  ARG  PREFIX  INVALID
,	TokenNameCOMMA	
"A QNAME-beli el?tagnak érvényes NCName-nek kell lennie"	TokenNameStringLiteral	A QNAME-beli el?tagnak érvényes NCName-nek kell lennie
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_NAME_CANT_START_WITH_COLON	TokenNameIdentifier	 ER  NAME  CANT  START  WITH  COLON
,	TokenNameCOMMA	
"A név nem kezd?dhet kett?sponttal"	TokenNameStringLiteral	A név nem kezd?dhet kett?sponttal
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
"BAD_CODE"	TokenNameStringLiteral	BAD_CODE
,	TokenNameCOMMA	
"A createMessage egyik paramétere nincs a megfelel? tartományban"	TokenNameStringLiteral	A createMessage egyik paramétere nincs a megfelel? tartományban
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
"FORMAT_FAILED"	TokenNameStringLiteral	FORMAT_FAILED
,	TokenNameCOMMA	
"Kivétel történt a messageFormat hívása közben"	TokenNameStringLiteral	Kivétel történt a messageFormat hívása közben
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
