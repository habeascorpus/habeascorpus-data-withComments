...
*	TokenNameMULTIPLY	
;	TokenNameSEMICOLON	
/** * Simple tests for {@link GermanLightStemFilter} */	TokenNameCOMMENT_JAVADOC	 Simple tests for {@link GermanLightStemFilter} 
public	TokenNamepublic	
class	TokenNameclass	
TestGermanLightStemFilter	TokenNameIdentifier	 Test German Light Stem Filter
...
,	TokenNameCOMMA	
new	TokenNamenew	
GermanLightStemFilter	TokenNameIdentifier	 German Light Stem Filter
(	TokenNameLPAREN	
source	TokenNameIdentifier	 source
)	TokenNameRPAREN	
)	TokenNameRPAREN	
...
(	TokenNameLPAREN	
"delighttestdata.zip"	TokenNameStringLiteral	delighttestdata.zip
)	TokenNameRPAREN	
,	TokenNameCOMMA	
"delight.txt"	TokenNameStringLiteral	delight.txt
)	TokenNameRPAREN	
;	TokenNameSEMICOLON	
}	TokenNameRBRACE	
