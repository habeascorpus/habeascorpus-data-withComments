...
;	TokenNameSEMICOLON	
/** * NOTE: This up outdated exception left for backward compatibility reasons, * no actual schema agreement validation is done starting from Cassandra 1.2 * * schemas are not in agreement across all nodes */	TokenNameCOMMENT_JAVADOC	 NOTE: This up outdated exception left for backward compatibility reasons, no actual schema agreement validation is done starting from Cassandra 1.2 * schemas are not in agreement across all nodes 
...
TStruct	TokenNameIdentifier	 T Struct
(	TokenNameLPAREN	
"SchemaDisagreementException"	TokenNameStringLiteral	SchemaDisagreementException
)	TokenNameRPAREN	
;	TokenNameSEMICOLON	
