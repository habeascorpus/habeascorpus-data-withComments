...
;	TokenNameSEMICOLON	
/** Example showing how to extend EnhancedPatternLayout to recognize additional conversion characters. <p>In this case MyPatternLayout recognizes %# conversion pattern. It outputs the value of an internal counter which is also incremented at each call. <p>See <a href=doc-files/MyPatternLayout.java><b>source</b></a> code for more details. @see MyPatternParser @see org.apache.log4j.EnhancedPatternLayout @author Anders Kristensen */	TokenNameCOMMENT_JAVADOC	 Example showing how to extend EnhancedPatternLayout to recognize additional conversion characters. <p>In this case MyPatternLayout recognizes %# conversion pattern. It outputs the value of an internal counter which is also incremented at each call. <p>See <a href=doc-files/MyPatternLayout.java><b>source</b></a> code for more details. @see MyPatternParser @see org.apache.log4j.EnhancedPatternLayout @author Anders Kristensen 
public	TokenNamepublic	
class	TokenNameclass	
EnhancedMyPatternLayout	TokenNameIdentifier	 Enhanced My Pattern Layout
