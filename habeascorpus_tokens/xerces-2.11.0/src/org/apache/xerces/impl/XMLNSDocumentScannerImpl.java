...
;	TokenNameSEMICOLON	
/** * The scanner is responsible for removing DTD validator * from the pipeline if it is not needed. * * @param dtdValidator The DTDValidator */	TokenNameCOMMENT_JAVADOC	 The scanner is responsible for removing DTD validator from the pipeline if it is not needed. * @param dtdValidator The DTDValidator 
public	TokenNamepublic	
void	TokenNamevoid	
setDTDValidator	TokenNameIdentifier	 set DTD Validator
(	TokenNameLPAREN	
XMLDTDValidatorFilter	TokenNameIdentifier	 XMLDTD Validator Filter
dtdValidator	TokenNameIdentifier	 dtd Validator
)	TokenNameRPAREN	
{	TokenNameLBRACE	
fDTDValidator	TokenNameIdentifier	 f DTD Validator
=	TokenNameEQUAL	
...
;	TokenNameSEMICOLON	
// REVISIT - [Q] Why do we need this temp variable? -- mrglavas 	TokenNameCOMMENT_LINE	REVISIT - [Q] Why do we need this temp variable? -- mrglavas 
...
;	TokenNameSEMICOLON	
// fLength = 0; //initialize structure 	TokenNameCOMMENT_LINE	fLength = 0; //initialize structure 
for	TokenNamefor	
(	TokenNameLPAREN	
int	TokenNameint	
...
{	TokenNameLBRACE	
// checkDuplicates(fAttributeQName, fAttributes); 	TokenNameCOMMENT_LINE	checkDuplicates(fAttributeQName, fAttributes); 
...
EMPTY_STRING	TokenNameIdentifier	 EMPTY  STRING
;	TokenNameSEMICOLON	
// http://www.w3.org/TR/1999/REC-xml-names-19990114/#dt-prefix 	TokenNameCOMMENT_LINE	http://www.w3.org/TR/1999/REC-xml-names-19990114/#dt-prefix 
// We should only report an error if there is a prefix, 	TokenNameCOMMENT_LINE	We should only report an error if there is a prefix, 
// that is, the local part is not "xmlns". -SG 	TokenNameCOMMENT_LINE	that is, the local part is not "xmlns". -SG 
if	TokenNameif	
(	TokenNameLPAREN	
uri	TokenNameIdentifier	 uri
==	TokenNameEQUAL_EQUAL	
...
// declare prefix in context 	TokenNameCOMMENT_LINE	declare prefix in context 
fNamespaceContext	TokenNameIdentifier	 f Namespace Context
.	TokenNameDOT	
...
return	TokenNamereturn	
new	TokenNamenew	
NSContentDispatcher	TokenNameIdentifier	 NS Content Dispatcher
(	TokenNameLPAREN	
)	TokenNameRPAREN	
;	TokenNameSEMICOLON	
}	TokenNameRBRACE	
...
// class XMLNSDocumentScannerImpl 	TokenNameCOMMENT_LINE	class XMLNSDocumentScannerImpl 
