...
;	TokenNameSEMICOLON	
/** * This interface should be implemented by every class that wants to build * {@link Query} objects from {@link QueryNode} objects. <br/> * * @see QueryBuilder * @see QueryTreeBuilder */	TokenNameCOMMENT_JAVADOC	 This interface should be implemented by every class that wants to build {@link Query} objects from {@link QueryNode} objects. <br/> * @see QueryBuilder @see QueryTreeBuilder 
