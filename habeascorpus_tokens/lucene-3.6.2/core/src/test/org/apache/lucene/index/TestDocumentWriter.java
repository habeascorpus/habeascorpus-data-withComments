...
TestDocumentWriter	TokenNameIdentifier	 Test Document Writer
...
public	TokenNamepublic	
void	TokenNamevoid	
testAddDocument	TokenNameIdentifier	 test Add Document
(	TokenNameLPAREN	
)	TokenNameRPAREN	
throws	TokenNamethrows	
Exception	TokenNameIdentifier	 Exception
...
getFields	TokenNameIdentifier	 get Fields
(	TokenNameLPAREN	
"keyField"	TokenNameStringLiteral	keyField
)	TokenNameRPAREN	
;	TokenNameSEMICOLON	
assertTrue	TokenNameIdentifier	 assert True
(	TokenNameLPAREN	
...
DocHelper	TokenNameIdentifier	 Doc Helper
.	TokenNameDOT	
KEYWORD_TEXT	TokenNameIdentifier	 KEYWORD  TEXT
)	TokenNameRPAREN	
)	TokenNameRPAREN	
;	TokenNameSEMICOLON	
fields	TokenNameIdentifier	 fields
...
;	TokenNameSEMICOLON	
// test that the norms are not present in the segment if 	TokenNameCOMMENT_LINE	test that the norms are not present in the segment if 
// omitNorms is true 	TokenNameCOMMENT_LINE	omitNorms is true 
for	TokenNamefor	
(	TokenNameLPAREN	
int	TokenNameint	
...
public	TokenNamepublic	
void	TokenNamevoid	
testPositionIncrementGap	TokenNameIdentifier	 test Position Increment Gap
(	TokenNameLPAREN	
)	TokenNameRPAREN	
throws	TokenNamethrows	
IOException	TokenNameIdentifier	 IO Exception
...
,	TokenNameCOMMA	
"repeated one"	TokenNameStringLiteral	repeated one
,	TokenNameCOMMA	
Field	TokenNameIdentifier	 Field
.	TokenNameDOT	
Store	TokenNameIdentifier	 Store
...
"repeated"	TokenNameStringLiteral	repeated
,	TokenNameCOMMA	
"repeated two"	TokenNameStringLiteral	repeated two
,	TokenNameCOMMA	
Field	TokenNameIdentifier	 Field
.	TokenNameDOT	
Store	TokenNameIdentifier	 Store
...
public	TokenNamepublic	
void	TokenNamevoid	
testTokenReuse	TokenNameIdentifier	 test Token Reuse
(	TokenNameLPAREN	
)	TokenNameRPAREN	
throws	TokenNamethrows	
IOException	TokenNameIdentifier	 IO Exception
...
{	TokenNameLBRACE	
// set payload on first position only 	TokenNameCOMMENT_LINE	set payload on first position only 
payloadAtt	TokenNameIdentifier	 payload Att
.	TokenNameDOT	
setPayload	TokenNameIdentifier	 set Payload
(	TokenNameLPAREN	
...
// index a "synonym" for every token 	TokenNameCOMMENT_LINE	index a "synonym" for every token 
state	TokenNameIdentifier	 state
=	TokenNameEQUAL	
...
,	TokenNameCOMMA	
"a 5 a a"	TokenNameStringLiteral	a 5 a a
,	TokenNameCOMMA	
Field	TokenNameIdentifier	 Field
.	TokenNameDOT	
Store	TokenNameIdentifier	 Store
...
public	TokenNamepublic	
void	TokenNamevoid	
testPreAnalyzedField	TokenNameIdentifier	 test Pre Analyzed Field
(	TokenNameLPAREN	
)	TokenNameRPAREN	
throws	TokenNamethrows	
IOException	TokenNameIdentifier	 IO Exception
...
/** * Test adding two fields with the same name, but * with different term vector setting (LUCENE-766). */	TokenNameCOMMENT_JAVADOC	 Test adding two fields with the same name, but with different term vector setting (LUCENE-766). 
public	TokenNamepublic	
void	TokenNamevoid	
testMixedTermVectorSettingsSameField	TokenNameIdentifier	 test Mixed Term Vector Settings Same Field
(	TokenNameLPAREN	
)	TokenNameRPAREN	
throws	TokenNamethrows	
Exception	TokenNameIdentifier	 Exception
...
;	TokenNameSEMICOLON	
// f1 first without tv then with tv 	TokenNameCOMMENT_LINE	f1 first without tv then with tv 
doc	TokenNameIdentifier	 doc
.	TokenNameDOT	
add	TokenNameIdentifier	 add
(	TokenNameLPAREN	
...
;	TokenNameSEMICOLON	
// f2 first with tv then without tv 	TokenNameCOMMENT_LINE	f2 first with tv then without tv 
doc	TokenNameIdentifier	 doc
.	TokenNameDOT	
add	TokenNameIdentifier	 add
(	TokenNameLPAREN	
...
;	TokenNameSEMICOLON	
// f1 	TokenNameCOMMENT_LINE	f1 
TermFreqVector	TokenNameIdentifier	 Term Freq Vector
tfv1	TokenNameIdentifier	 tfv1
=	TokenNameEQUAL	
reader	TokenNameIdentifier	 reader
.	TokenNameDOT	
...
assertEquals	TokenNameIdentifier	 assert Equals
(	TokenNameLPAREN	
"the 'with_tv' setting should rule!"	TokenNameStringLiteral	the 'with_tv' setting should rule!
,	TokenNameCOMMA	
2	TokenNameIntegerLiteral	
,	TokenNameCOMMA	
tfv1	TokenNameIdentifier	 tfv1
...
;	TokenNameSEMICOLON	
// f2 	TokenNameCOMMENT_LINE	f2 
TermFreqVector	TokenNameIdentifier	 Term Freq Vector
tfv2	TokenNameIdentifier	 tfv2
=	TokenNameEQUAL	
reader	TokenNameIdentifier	 reader
.	TokenNameDOT	
getTermFreqVector	TokenNameIdentifier	 get Term Freq Vector
...
;	TokenNameSEMICOLON	
// f1 has no norms 	TokenNameCOMMENT_LINE	f1 has no norms 
doc	TokenNameIdentifier	 doc
.	TokenNameDOT	
add	TokenNameIdentifier	 add
(	TokenNameLPAREN	
...
;	TokenNameSEMICOLON	
// f2 has no TF 	TokenNameCOMMENT_LINE	f2 has no TF 
Field	TokenNameIdentifier	 Field
...
;	TokenNameSEMICOLON	
// be sure to have a single segment 	TokenNameCOMMENT_LINE	be sure to have a single segment 
writer	TokenNameIdentifier	 writer
.	TokenNameDOT	
close	TokenNameIdentifier	 close
(	TokenNameLPAREN	
...
assertFalse	TokenNameIdentifier	 assert False
(	TokenNameLPAREN	
"f1 should have no norms"	TokenNameStringLiteral	f1 should have no norms
,	TokenNameCOMMA	
reader	TokenNameIdentifier	 reader
.	TokenNameDOT	
hasNorms	TokenNameIdentifier	 has Norms
...
assertEquals	TokenNameIdentifier	 assert Equals
(	TokenNameLPAREN	
"omitTermFreqAndPositions field bit should not be set for f1"	TokenNameStringLiteral	omitTermFreqAndPositions field bit should not be set for f1
,	TokenNameCOMMA	
IndexOptions	TokenNameIdentifier	 Index Options
.	TokenNameDOT	
...
assertTrue	TokenNameIdentifier	 assert True
(	TokenNameLPAREN	
"f2 should have norms"	TokenNameStringLiteral	f2 should have norms
,	TokenNameCOMMA	
reader	TokenNameIdentifier	 reader
.	TokenNameDOT	
hasNorms	TokenNameIdentifier	 has Norms
...
assertEquals	TokenNameIdentifier	 assert Equals
(	TokenNameLPAREN	
"omitTermFreqAndPositions field bit should be set for f2"	TokenNameStringLiteral	omitTermFreqAndPositions field bit should be set for f2
,	TokenNameCOMMA	
IndexOptions	TokenNameIdentifier	 Index Options
.	TokenNameDOT	
DOCS_ONLY	TokenNameIdentifier	 DOCS  ONLY
