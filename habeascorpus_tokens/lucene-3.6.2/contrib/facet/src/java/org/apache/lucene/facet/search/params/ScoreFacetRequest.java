...
/** * Facet request for weighting facets according to document scores. * * @lucene.experimental */	TokenNameCOMMENT_JAVADOC	 Facet request for weighting facets according to document scores. * @lucene.experimental 
...
{	TokenNameLBRACE	
/** Create a score facet request for a given node in the taxonomy. */	TokenNameCOMMENT_JAVADOC	 Create a score facet request for a given node in the taxonomy. 
public	TokenNamepublic	
ScoreFacetRequest	TokenNameIdentifier	 Score Facet Request
(	TokenNameLPAREN	
CategoryPath	TokenNameIdentifier	 Category Path
