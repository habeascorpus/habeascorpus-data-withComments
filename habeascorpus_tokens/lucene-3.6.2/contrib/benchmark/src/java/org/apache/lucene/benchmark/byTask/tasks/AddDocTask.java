...
Document	TokenNameIdentifier	 Document
;	TokenNameSEMICOLON	
/** * Add a document, optionally of a certain size. * <br>Other side effects: none. * <br>Takes optional param: document size. */	TokenNameCOMMENT_JAVADOC	 Add a document, optionally of a certain size. <br>Other side effects: none. <br>Takes optional param: document size. 
...
;	TokenNameSEMICOLON	
/** * volatile data passed between setup(), doLogic(), tearDown(). * the doc is created at setup() and added at doLogic(). */	TokenNameCOMMENT_JAVADOC	 volatile data passed between setup(), doLogic(), tearDown(). the doc is created at setup() and added at doLogic(). 
...
(	TokenNameLPAREN	
"added %9d docs"	TokenNameStringLiteral	added %9d docs
,	TokenNameCOMMA	
recsCount	TokenNameIdentifier	 recs Count
)	TokenNameRPAREN	
;	TokenNameSEMICOLON	
