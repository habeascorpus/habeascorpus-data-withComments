...
TStruct	TokenNameIdentifier	 T Struct
(	TokenNameLPAREN	
"CounterColumn"	TokenNameStringLiteral	CounterColumn
)	TokenNameRPAREN	
;	TokenNameSEMICOLON	
private	TokenNameprivate	
static	TokenNamestatic	
...
final	TokenNamefinal	
int	TokenNameint	
__VALUE_ISSET_ID	TokenNameIdentifier	 VALUE  ISSET  ID
=	TokenNameEQUAL	
...
(	TokenNameLPAREN	
"Required field 'value' was not found in serialized data! Struct: "	TokenNameStringLiteral	Required field 'value' was not found in serialized data! Struct: 
+	TokenNamePLUS	
...
// alas, we cannot check 'value' because it's a primitive and you chose the non-beans generator. 	TokenNameCOMMENT_LINE	alas, we cannot check 'value' because it's a primitive and you chose the non-beans generator. 
}	TokenNameRBRACE	
private	TokenNameprivate	
void	TokenNamevoid	
