...
/* * $Id: LiteralExpr.java 468650 2006-10-28 07:03:30Z minchau $ */	TokenNameCOMMENT_BLOCK	 $Id: LiteralExpr.java 468650 2006-10-28 07:03:30Z minchau $ 
...
;	TokenNameSEMICOLON	
/** * Creates a new literal expression node. * @param value the literal expression content/value. */	TokenNameCOMMENT_JAVADOC	 Creates a new literal expression node. @param value the literal expression content/value. 
...
/** * Creates a new literal expression node. * @param value the literal expression content/value. * @param namespace the namespace in which the expression exists. */	TokenNameCOMMENT_JAVADOC	 Creates a new literal expression node. @param value the literal expression content/value. @param namespace the namespace in which the expression exists. 
public	TokenNamepublic	
LiteralExpr	TokenNameIdentifier	 Literal Expr
(	TokenNameLPAREN	
String	TokenNameIdentifier	 String
...
{	TokenNameLBRACE	
return	TokenNamereturn	
"literal-expr("	TokenNameStringLiteral	literal-expr(
+	TokenNamePLUS	
_value	TokenNameIdentifier	 value
+	TokenNamePLUS	
