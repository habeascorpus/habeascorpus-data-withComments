...
;	TokenNameSEMICOLON	
/** * Occurs when a download checksum fails. * * @author <a href="mailto:brett@apache.org">Brett Porter</a> */	TokenNameCOMMENT_JAVADOC	 Occurs when a download checksum fails. * @author <a href="mailto:brett@apache.org">Brett Porter</a> 
