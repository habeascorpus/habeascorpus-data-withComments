...
ER_NO_CURLYBRACE	TokenNameIdentifier	 ER  NO  CURLYBRACE
,	TokenNameCOMMA	
"Error: No puede haber '{' dentro de la expresión"	TokenNameStringLiteral	Error: No puede haber '{' dentro de la expresión
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_ILLEGAL_ATTRIBUTE	TokenNameIdentifier	 ER  ILLEGAL  ATTRIBUTE
...
ER_CANNOT_ADD	TokenNameIdentifier	 ER  CANNOT  ADD
,	TokenNameCOMMA	
"No se puede añadir {0} a {1}"	TokenNameStringLiteral	No se puede añadir {0} a {1}
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_NULL_SOURCENODE_HANDLEAPPLYTEMPLATES	TokenNameIdentifier	 ER  NULL  SOURCENODE  HANDLEAPPLYTEMPLATES
...
ER_PROCESSINGINSTRUCTION_NOTVALID_NCNAME	TokenNameIdentifier	 ER  PROCESSINGINSTRUCTION  NOTVALID  NCNAME
,	TokenNameCOMMA	
"Nombre de processing-instruction debe ser un NCName válido: {0}"	TokenNameStringLiteral	Nombre de processing-instruction debe ser un NCName válido: {0}
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_NEED_MATCH_ATTRIB	TokenNameIdentifier	 ER  NEED  MATCH  ATTRIB
...
ER_NULL_CHILD	TokenNameIdentifier	 ER  NULL  CHILD
,	TokenNameCOMMA	
"Intentando añadir un hijo nulo"	TokenNameStringLiteral	Intentando añadir un hijo nulo
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_NEED_SELECT_ATTRIB	TokenNameIdentifier	 ER  NEED  SELECT  ATTRIB
,	TokenNameCOMMA	
"{0} necesita un atributo de selección."	TokenNameStringLiteral	{0} necesita un atributo de selección.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_NEED_TEST_ATTRIB	TokenNameIdentifier	 ER  NEED  TEST  ATTRIB
...
ER_ENCODING_NOT_SUPPORTED	TokenNameIdentifier	 ER  ENCODING  NOT  SUPPORTED
,	TokenNameCOMMA	
"Codificación no soportada: {0}"	TokenNameStringLiteral	Codificación no soportada: {0}
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_COULD_NOT_CREATE_TRACELISTENER	TokenNameIdentifier	 ER  COULD  NOT  CREATE  TRACELISTENER
...
ER_IOEXCEPTION	TokenNameIdentifier	 ER  IOEXCEPTION
,	TokenNameCOMMA	
"Se ha producido una excepción de ES con el archivo de hoja de estilos: {0}"	TokenNameStringLiteral	Se ha producido una excepción de ES con el archivo de hoja de estilos: {0}
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_NO_HREF_ATTRIB	TokenNameIdentifier	 ER  NO  HREF  ATTRIB
...
ER_STYLESHEET_INCLUDES_ITSELF	TokenNameIdentifier	 ER  STYLESHEET  INCLUDES  ITSELF
,	TokenNameCOMMA	
"(StylesheetHandler) Inclusión propia de {0} directa o indirectamente."	TokenNameStringLiteral	(StylesheetHandler) Inclusión propia de {0} directa o indirectamente.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_PROCESSINCLUDE_ERROR	TokenNameIdentifier	 ER  PROCESSINCLUDE  ERROR
...
ER_CAN_ONLY_OUTPUT_TO_ELEMENT	TokenNameIdentifier	 ER  CAN  ONLY  OUTPUT  TO  ELEMENT
,	TokenNameCOMMA	
"Sólo se puede dar salida hacia Element, DocumentFragment, Document o PrintWriter."	TokenNameStringLiteral	Sólo se puede dar salida hacia Element, DocumentFragment, Document o PrintWriter.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_PROCESS_ERROR	TokenNameIdentifier	 ER  PROCESS  ERROR
...
ER_NO_SELECT_EXPRESSION	TokenNameIdentifier	 ER  NO  SELECT  EXPRESSION
,	TokenNameCOMMA	
"Error. No se ha encontrado la expresión de selección (-select) de xpath."	TokenNameStringLiteral	Error. No se ha encontrado la expresión de selección (-select) de xpath.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_CANNOT_SERIALIZE_XSLPROCESSOR	TokenNameIdentifier	 ER  CANNOT  SERIALIZE  XSLPROCESSOR
...
ER_NODE_NOT_ELEMENT	TokenNameIdentifier	 ER  NODE  NOT  ELEMENT
,	TokenNameCOMMA	
"El nodo señalado por un identificador de fragmento no es un elemento: {0}"	TokenNameStringLiteral	El nodo señalado por un identificador de fragmento no es un elemento: {0}
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_FOREACH_NEED_MATCH_OR_NAME_ATTRIB	TokenNameIdentifier	 ER  FOREACH  NEED  MATCH  OR  NAME  ATTRIB
...
ER_NO_CLONE_OF_DOCUMENT_FRAG	TokenNameIdentifier	 ER  NO  CLONE  OF  DOCUMENT  FRAG
,	TokenNameCOMMA	
"No es réplica de un fragmento de documento."	TokenNameStringLiteral	No es réplica de un fragmento de documento.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_CANT_CREATE_ITEM	TokenNameIdentifier	 ER  CANT  CREATE  ITEM
,	TokenNameCOMMA	
"No se puede crear el elemento en el árbol de resultados: {0}"	TokenNameStringLiteral	No se puede crear el elemento en el árbol de resultados: {0}
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_XMLSPACE_ILLEGAL_VALUE	TokenNameIdentifier	 ER  XMLSPACE  ILLEGAL  VALUE
...
ER_NO_XSLKEY_DECLARATION	TokenNameIdentifier	 ER  NO  XSLKEY  DECLARATION
,	TokenNameCOMMA	
"No hay declaración xsl:key para {0}."	TokenNameStringLiteral	No hay declaración xsl:key para {0}.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_CANT_CREATE_URL	TokenNameIdentifier	 ER  CANT  CREATE  URL
...
ER_XSLFUNCTIONS_UNSUPPORTED	TokenNameIdentifier	 ER  XSLFUNCTIONS  UNSUPPORTED
,	TokenNameCOMMA	
"xsl:functions no está soportado"	TokenNameStringLiteral	xsl:functions no está soportado
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_PROCESSOR_ERROR	TokenNameIdentifier	 ER  PROCESSOR  ERROR
...
ER_BAD_XSLSORT_USE	TokenNameIdentifier	 ER  BAD  XSLSORT  USE
,	TokenNameCOMMA	
"(StylesheetHandler) xsl:sort sólo puede utilizarse con xsl:apply-templates o xsl:for-each."	TokenNameStringLiteral	(StylesheetHandler) xsl:sort sólo puede utilizarse con xsl:apply-templates o xsl:for-each.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_MISPLACED_XSLWHEN	TokenNameIdentifier	 ER  MISPLACED  XSLWHEN
...
ER_UNKNOWN_EXT_NS_PREFIX	TokenNameIdentifier	 ER  UNKNOWN  EXT  NS  PREFIX
,	TokenNameCOMMA	
"(StylesheetHandler) Prefijo {1} de espacio de nombres de extensión {0} desconocido"	TokenNameStringLiteral	(StylesheetHandler) Prefijo {1} de espacio de nombres de extensión {0} desconocido
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_IMPORTS_AS_FIRST_ELEM	TokenNameIdentifier	 ER  IMPORTS  AS  FIRST  ELEM
,	TokenNameCOMMA	
"(StylesheetHandler) Las importaciones sólo pueden aparecer como primeros elementos de la hoja de estilos."	TokenNameStringLiteral	(StylesheetHandler) Las importaciones sólo pueden aparecer como primeros elementos de la hoja de estilos.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_IMPORTING_ITSELF	TokenNameIdentifier	 ER  IMPORTING  ITSELF
,	TokenNameCOMMA	
"(StylesheetHandler) Importación propia de {0} directa o indirectamente."	TokenNameStringLiteral	(StylesheetHandler) Importación propia de {0} directa o indirectamente.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_XMLSPACE_ILLEGAL_VAL	TokenNameIdentifier	 ER  XMLSPACE  ILLEGAL  VAL
...
ER_SAX_EXCEPTION	TokenNameIdentifier	 ER  SAX  EXCEPTION
,	TokenNameCOMMA	
"Excepción SAX"	TokenNameStringLiteral	Excepción SAX
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
ER_CURRENCY_SIGN_ILLEGAL	TokenNameIdentifier	 ER  CURRENCY  SIGN  ILLEGAL
,	TokenNameCOMMA	
"El signo monetario no está permitido en la serie del patrón de formato"	TokenNameStringLiteral	El signo monetario no está permitido en la serie del patrón de formato
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_DOCUMENT_FUNCTION_INVALID_IN_STYLESHEET_DOM	TokenNameIdentifier	 ER  DOCUMENT  FUNCTION  INVALID  IN  STYLESHEET  DOM
,	TokenNameCOMMA	
"La función de documento no está soportada en DOM de hoja de estilos."	TokenNameStringLiteral	La función de documento no está soportada en DOM de hoja de estilos.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_CANT_RESOLVE_PREFIX_OF_NON_PREFIX_RESOLVER	TokenNameIdentifier	 ER  CANT  RESOLVE  PREFIX  OF  NON  PREFIX  RESOLVER
...
ER_REDIRECT_COULDNT_GET_FILENAME	TokenNameIdentifier	 ER  REDIRECT  COULDNT  GET  FILENAME
,	TokenNameCOMMA	
"Extensión Redirect: No se ha podido obtener el nombre de archivo - el atributo de archivo o de selección debe devolver una serie válida."	TokenNameStringLiteral	Extensión Redirect: No se ha podido obtener el nombre de archivo - el atributo de archivo o de selección debe devolver una serie válida.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_CANNOT_BUILD_FORMATTERLISTENER_IN_REDIRECT	TokenNameIdentifier	 ER  CANNOT  BUILD  FORMATTERLISTENER  IN  REDIRECT
,	TokenNameCOMMA	
"No se puede crear FormatterListener en extensión Redirect."	TokenNameStringLiteral	No se puede crear FormatterListener en extensión Redirect.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_INVALID_PREFIX_IN_EXCLUDERESULTPREFIX	TokenNameIdentifier	 ER  INVALID  PREFIX  IN  EXCLUDERESULTPREFIX
,	TokenNameCOMMA	
"El prefijo en exclude-result-prefixes no es válido: {0}"	TokenNameStringLiteral	El prefijo en exclude-result-prefixes no es válido: {0}
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_MISSING_NS_URI	TokenNameIdentifier	 ER  MISSING  NS  URI
...
ER_MISSING_ARG_FOR_OPTION	TokenNameIdentifier	 ER  MISSING  ARG  FOR  OPTION
,	TokenNameCOMMA	
"Falta un argumento para la opción: {0}"	TokenNameStringLiteral	Falta un argumento para la opción: {0}
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_INVALID_OPTION	TokenNameIdentifier	 ER  INVALID  OPTION
,	TokenNameCOMMA	
"Opción no válida: {0}"	TokenNameStringLiteral	Opción no válida: {0}
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_MALFORMED_FORMAT_STRING	TokenNameIdentifier	 ER  MALFORMED  FORMAT  STRING
...
ER_CALL_TO_EXT_FAILED	TokenNameIdentifier	 ER  CALL  TO  EXT  FAILED
,	TokenNameCOMMA	
"Anomalía al llamar al elemento de extensión: {0}"	TokenNameStringLiteral	Anomalía al llamar al elemento de extensión: {0}
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_PREFIX_MUST_RESOLVE	TokenNameIdentifier	 ER  PREFIX  MUST  RESOLVE
...
ER_INVALID_UTF16_SURROGATE	TokenNameIdentifier	 ER  INVALID  UT F16  SURROGATE
,	TokenNameCOMMA	
"¿Se ha detectado un sustituto UTF-16 no válido: {0}?"	TokenNameStringLiteral	¿Se ha detectado un sustituto UTF-16 no válido: {0}?
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_XSLATTRSET_USED_ITSELF	TokenNameIdentifier	 ER  XSLATTRSET  USED  ITSELF
,	TokenNameCOMMA	
"xsl:attribute-set {0} se ha utilizado a sí mismo lo que puede provocar un bucle infinito."	TokenNameStringLiteral	xsl:attribute-set {0} se ha utilizado a sí mismo lo que puede provocar un bucle infinito.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_CANNOT_MIX_XERCESDOM	TokenNameIdentifier	 ER  CANNOT  MIX  XERCESDOM
...
ER_DUPLICATE_NAMED_TEMPLATE	TokenNameIdentifier	 ER  DUPLICATE  NAMED  TEMPLATE
,	TokenNameCOMMA	
"Se ha encontrado más de una plantilla con el nombre: {0}"	TokenNameStringLiteral	Se ha encontrado más de una plantilla con el nombre: {0}
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_INVALID_KEY_CALL	TokenNameIdentifier	 ER  INVALID  KEY  CALL
,	TokenNameCOMMA	
"Llamada de función no válida: no están permitidas las llamadas key() recursivas"	TokenNameStringLiteral	Llamada de función no válida: no están permitidas las llamadas key() recursivas
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_REFERENCING_ITSELF	TokenNameIdentifier	 ER  REFERENCING  ITSELF
,	TokenNameCOMMA	
"La variable {0} se está referenciando a sí misma directa o indirectamente."	TokenNameStringLiteral	La variable {0} se está referenciando a sí misma directa o indirectamente.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_ILLEGAL_DOMSOURCE_INPUT	TokenNameIdentifier	 ER  ILLEGAL  DOMSOURCE  INPUT
...
ER_CLASS_NOT_FOUND_FOR_OPTION	TokenNameIdentifier	 ER  CLASS  NOT  FOUND  FOR  OPTION
,	TokenNameCOMMA	
"No se ha encontrado el archivo de clase para la opción {0}"	TokenNameStringLiteral	No se ha encontrado el archivo de clase para la opción {0}
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_REQUIRED_ELEM_NOT_FOUND	TokenNameIdentifier	 ER  REQUIRED  ELEM  NOT  FOUND
...
ER_CANNOT_CMPL_EXTENSN	TokenNameIdentifier	 ER  CANNOT  CMPL  EXTENSN
,	TokenNameCOMMA	
"No se ha podido compilar la extensión"	TokenNameStringLiteral	No se ha podido compilar la extensión
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_CANNOT_CREATE_EXTENSN	TokenNameIdentifier	 ER  CANNOT  CREATE  EXTENSN
,	TokenNameCOMMA	
"No se ha podido crear la extensión: {0} como consecuencia de: {1}"	TokenNameStringLiteral	No se ha podido crear la extensión: {0} como consecuencia de: {1}
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_INSTANCE_MTHD_CALL_REQUIRES	TokenNameIdentifier	 ER  INSTANCE  MTHD  CALL  REQUIRES
,	TokenNameCOMMA	
"La llamada del método de instancia al método {0} necesita una instancia Object como primer argumento"	TokenNameStringLiteral	La llamada del método de instancia al método {0} necesita una instancia Object como primer argumento
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_INVALID_ELEMENT_NAME	TokenNameIdentifier	 ER  INVALID  ELEMENT  NAME
,	TokenNameCOMMA	
"Se ha especificado un nombre de elemento no válido {0}"	TokenNameStringLiteral	Se ha especificado un nombre de elemento no válido {0}
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_ELEMENT_NAME_METHOD_STATIC	TokenNameIdentifier	 ER  ELEMENT  NAME  METHOD  STATIC
,	TokenNameCOMMA	
"El método del nombre de elemento debe ser estático {0}"	TokenNameStringLiteral	El método del nombre de elemento debe ser estático {0}
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_EXTENSION_FUNC_UNKNOWN	TokenNameIdentifier	 ER  EXTENSION  FUNC  UNKNOWN
,	TokenNameCOMMA	
"Función de extensión {0} : {1} desconocida"	TokenNameStringLiteral	Función de extensión {0} : {1} desconocida
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_MORE_MATCH_CONSTRUCTOR	TokenNameIdentifier	 ER  MORE  MATCH  CONSTRUCTOR
,	TokenNameCOMMA	
"Hay más de una coincidencia máxima para el constructor de {0}"	TokenNameStringLiteral	Hay más de una coincidencia máxima para el constructor de {0}
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_MORE_MATCH_METHOD	TokenNameIdentifier	 ER  MORE  MATCH  METHOD
,	TokenNameCOMMA	
"Hay más de una coincidencia máxima para el método {0}"	TokenNameStringLiteral	Hay más de una coincidencia máxima para el método {0}
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_MORE_MATCH_ELEMENT	TokenNameIdentifier	 ER  MORE  MATCH  ELEMENT
,	TokenNameCOMMA	
"Hay más de una coincidencia máxima para el método de elemento {0}"	TokenNameStringLiteral	Hay más de una coincidencia máxima para el método de elemento {0}
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_INVALID_CONTEXT_PASSED	TokenNameIdentifier	 ER  INVALID  CONTEXT  PASSED
,	TokenNameCOMMA	
"Se ha pasado un contexto no válido para evaluar {0}"	TokenNameStringLiteral	Se ha pasado un contexto no válido para evaluar {0}
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_POOL_EXISTS	TokenNameIdentifier	 ER  POOL  EXISTS
,	TokenNameCOMMA	
"La agrupación ya existe"	TokenNameStringLiteral	La agrupación ya existe
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_NO_DRIVER_NAME	TokenNameIdentifier	 ER  NO  DRIVER  NAME
...
ER_POOL_SIZE_LESSTHAN_ONE	TokenNameIdentifier	 ER  POOL  SIZE  LESSTHAN  ONE
,	TokenNameCOMMA	
"El tamaño de la agrupación es menor que uno."	TokenNameStringLiteral	El tamaño de la agrupación es menor que uno.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_INVALID_DRIVER	TokenNameIdentifier	 ER  INVALID  DRIVER
,	TokenNameCOMMA	
"Se ha especificado un nombre de controlador no válido."	TokenNameStringLiteral	Se ha especificado un nombre de controlador no válido.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_NO_STYLESHEETROOT	TokenNameIdentifier	 ER  NO  STYLESHEETROOT
,	TokenNameCOMMA	
"No se ha encontrado la raíz de la hoja de estilos."	TokenNameStringLiteral	No se ha encontrado la raíz de la hoja de estilos.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_ILLEGAL_XMLSPACE_VALUE	TokenNameIdentifier	 ER  ILLEGAL  XMLSPACE  VALUE
...
ER_PROCESSFROMNODE_FAILED	TokenNameIdentifier	 ER  PROCESSFROMNODE  FAILED
,	TokenNameCOMMA	
"Anomalía de processFromNode"	TokenNameStringLiteral	Anomalía de processFromNode
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_RESOURCE_COULD_NOT_LOAD	TokenNameIdentifier	 ER  RESOURCE  COULD  NOT  LOAD
...
ER_BUFFER_SIZE_LESSTHAN_ZERO	TokenNameIdentifier	 ER  BUFFER  SIZE  LESSTHAN  ZERO
,	TokenNameCOMMA	
"Tamaño de almacenamiento intermedio <=0"	TokenNameStringLiteral	Tamaño de almacenamiento intermedio <=0
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_UNKNOWN_ERROR_CALLING_EXTENSION	TokenNameIdentifier	 ER  UNKNOWN  ERROR  CALLING  EXTENSION
,	TokenNameCOMMA	
"Error desconocido al llamar a la extensión"	TokenNameStringLiteral	Error desconocido al llamar a la extensión
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_NO_NAMESPACE_DECL	TokenNameIdentifier	 ER  NO  NAMESPACE  DECL
,	TokenNameCOMMA	
"El prefijo {0} no tiene una declaración de espacio de nombres correspondiente"	TokenNameStringLiteral	El prefijo {0} no tiene una declaración de espacio de nombres correspondiente
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_ELEM_CONTENT_NOT_ALLOWED	TokenNameIdentifier	 ER  ELEM  CONTENT  NOT  ALLOWED
...
ER_STYLESHEET_DIRECTED_TERMINATION	TokenNameIdentifier	 ER  STYLESHEET  DIRECTED  TERMINATION
,	TokenNameCOMMA	
"Terminación de hoja de estilos dirigida"	TokenNameStringLiteral	Terminación de hoja de estilos dirigida
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_ONE_OR_TWO	TokenNameIdentifier	 ER  ONE  OR  TWO
,	TokenNameCOMMA	
"1 ó 2"	TokenNameStringLiteral	1 ó 2
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_TWO_OR_THREE	TokenNameIdentifier	 ER  TWO  OR  THREE
,	TokenNameCOMMA	
"2 ó 3"	TokenNameStringLiteral	2 ó 3
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_COULD_NOT_LOAD_RESOURCE	TokenNameIdentifier	 ER  COULD  NOT  LOAD  RESOURCE
,	TokenNameCOMMA	
"No se ha podido cargar {0} (compruebe la CLASSPATH), ahora sólo se están utilizando los valores predeterminados"	TokenNameStringLiteral	No se ha podido cargar {0} (compruebe la CLASSPATH), ahora sólo se están utilizando los valores predeterminados
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_CANNOT_INIT_DEFAULT_TEMPLATES	TokenNameIdentifier	 ER  CANNOT  INIT  DEFAULT  TEMPLATES
...
ER_RESULT_NULL	TokenNameIdentifier	 ER  RESULT  NULL
,	TokenNameCOMMA	
"El resultado no debería ser nulo"	TokenNameStringLiteral	El resultado no debería ser nulo
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_RESULT_COULD_NOT_BE_SET	TokenNameIdentifier	 ER  RESULT  COULD  NOT  BE  SET
...
ER_PROPERTY_VALUE_BOOLEAN	TokenNameIdentifier	 ER  PROPERTY  VALUE  BOOLEAN
,	TokenNameCOMMA	
"El valor de la propiedad {0} debería ser una instancia Boolean"	TokenNameStringLiteral	El valor de la propiedad {0} debería ser una instancia Boolean
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_COULD_NOT_FIND_EXTERN_SCRIPT	TokenNameIdentifier	 ER  COULD  NOT  FIND  EXTERN  SCRIPT
...
ER_FAILED_CREATING_ELEMLITRSLT	TokenNameIdentifier	 ER  FAILED  CREATING  ELEMLITRSLT
,	TokenNameCOMMA	
"Anomalía al crear la instancia ElemLiteralResult"	TokenNameStringLiteral	Anomalía al crear la instancia ElemLiteralResult
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
ER_VALUE_SHOULD_BE_NUMBER	TokenNameIdentifier	 ER  VALUE  SHOULD  BE  NUMBER
,	TokenNameCOMMA	
"El valor para {0} debería contener un número analizable"	TokenNameStringLiteral	El valor para {0} debería contener un número analizable
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_VALUE_SHOULD_EQUAL	TokenNameIdentifier	 ER  VALUE  SHOULD  EQUAL
,	TokenNameCOMMA	
"El valor de {0} debería ser sí o no"	TokenNameStringLiteral	El valor de {0} debería ser sí o no
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_FAILED_CALLING_METHOD	TokenNameIdentifier	 ER  FAILED  CALLING  METHOD
,	TokenNameCOMMA	
"Anomalía al llamar al método {0}"	TokenNameStringLiteral	Anomalía al llamar al método {0}
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_FAILED_CREATING_ELEMTMPL	TokenNameIdentifier	 ER  FAILED  CREATING  ELEMTMPL
,	TokenNameCOMMA	
"Anomalía al crear la instancia ElemTemplateElement"	TokenNameStringLiteral	Anomalía al crear la instancia ElemTemplateElement
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_CHARS_NOT_ALLOWED	TokenNameIdentifier	 ER  CHARS  NOT  ALLOWED
...
ER_ATTR_NOT_ALLOWED	TokenNameIdentifier	 ER  ATTR  NOT  ALLOWED
,	TokenNameCOMMA	
"El atributo "{0}" no está permitido en el elemento {1}."	TokenNameStringLiteral	El atributo "{0}" no está permitido en el elemento {1}.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_BAD_VALUE	TokenNameIdentifier	 ER  BAD  VALUE
...
ER_NUMBER_TOO_BIG	TokenNameIdentifier	 ER  NUMBER  TOO  BIG
,	TokenNameCOMMA	
"Se ha intentado formatear un número mayor que el entero largo más grande"	TokenNameStringLiteral	Se ha intentado formatear un número mayor que el entero largo más grande
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_CANNOT_FIND_SAX1_DRIVER	TokenNameIdentifier	 ER  CANNOT  FIND  SA X1  DRIVER
...
ER_FEATURE	TokenNameIdentifier	 ER  FEATURE
,	TokenNameCOMMA	
"Característica: {0}"	TokenNameStringLiteral	Característica: {0}
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_PROPERTY	TokenNameIdentifier	 ER  PROPERTY
...
ER_POOLSIZE_LESS_THAN_ONE	TokenNameIdentifier	 ER  POOLSIZE  LESS  THAN  ONE
,	TokenNameCOMMA	
"El tamaño de la agrupación es menor que 1."	TokenNameStringLiteral	El tamaño de la agrupación es menor que 1.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_INVALID_DRIVER_NAME	TokenNameIdentifier	 ER  INVALID  DRIVER  NAME
...
ER_ASSERT_NO_TEMPLATE_PARENT	TokenNameIdentifier	 ER  ASSERT  NO  TEMPLATE  PARENT
,	TokenNameCOMMA	
"Error del programador. La expresión no tiene un padre ElemTemplateElement."	TokenNameStringLiteral	Error del programador. La expresión no tiene un padre ElemTemplateElement.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
// Note to translators: The following message should not normally be displayed 	TokenNameCOMMENT_LINE	Note to translators: The following message should not normally be displayed 
// to users. It describes a situation in which the processor has detected 	TokenNameCOMMENT_LINE	to users. It describes a situation in which the processor has detected 
...
ER_ASSERT_REDUNDENT_EXPR_ELIMINATOR	TokenNameIdentifier	 ER  ASSERT  REDUNDENT  EXPR  ELIMINATOR
,	TokenNameCOMMA	
"Aserción del programador en RedundentExprEliminator: {0} "	TokenNameStringLiteral	Aserción del programador en RedundentExprEliminator: {0} 
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_NOT_ALLOWED_IN_POSITION	TokenNameIdentifier	 ER  NOT  ALLOWED  IN  POSITION
,	TokenNameCOMMA	
"{0} no está permitido en esta posición de la hoja de estilos."	TokenNameStringLiteral	{0} no está permitido en esta posición de la hoja de estilos.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_NONWHITESPACE_NOT_ALLOWED_IN_POSITION	TokenNameIdentifier	 ER  NONWHITESPACE  NOT  ALLOWED  IN  POSITION
,	TokenNameCOMMA	
"No está permitido texto sin espacios en blanco en esta posición de la hoja de estilos."	TokenNameStringLiteral	No está permitido texto sin espacios en blanco en esta posición de la hoja de estilos.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
INVALID_TCHAR	TokenNameIdentifier	 INVALID  TCHAR
,	TokenNameCOMMA	
"Valor no permitido: se ha utilizado {1} para el atributo CHAR: {0}. Un atributo de tipo CHAR debe ser de un solo carácter."	TokenNameStringLiteral	Valor no permitido: se ha utilizado {1} para el atributo CHAR: {0}. Un atributo de tipo CHAR debe ser de un solo carácter.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
INVALID_ENUM	TokenNameIdentifier	 INVALID  ENUM
,	TokenNameCOMMA	
"Valor no permitido: se ha utilizado {1} para el atributo ENUM: {0}. Los valores válidos son: {2}."	TokenNameStringLiteral	Valor no permitido: se ha utilizado {1} para el atributo ENUM: {0}. Los valores válidos son: {2}.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
// Note to translators: The following message is used if the value of 	TokenNameCOMMENT_LINE	Note to translators: The following message is used if the value of 
...
ER_ARG_LITERAL	TokenNameIdentifier	 ER  ARG  LITERAL
,	TokenNameCOMMA	
"El argumento para {0} en el patrón de coincidencia debe ser un literal."	TokenNameStringLiteral	El argumento para {0} en el patrón de coincidencia debe ser un literal.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
ER_DUPLICATE_GLOBAL_VAR	TokenNameIdentifier	 ER  DUPLICATE  GLOBAL  VAR
,	TokenNameCOMMA	
"Declaración de variable global duplicada."	TokenNameStringLiteral	Declaración de variable global duplicada.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
// Note to translators: The following message indicates that two definitions of 	TokenNameCOMMENT_LINE	Note to translators: The following message indicates that two definitions of 
...
ER_DUPLICATE_VAR	TokenNameIdentifier	 ER  DUPLICATE  VAR
,	TokenNameCOMMA	
"Declaración de variable duplicada."	TokenNameStringLiteral	Declaración de variable duplicada.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
ER_FUNCTION_NOT_FOUND	TokenNameIdentifier	 ER  FUNCTION  NOT  FOUND
,	TokenNameCOMMA	
"La función de nombre {0} no existe"	TokenNameStringLiteral	La función de nombre {0} no existe
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
ER_INVALID_SET_PARAM_VALUE	TokenNameIdentifier	 ER  INVALID  SET  PARAM  VALUE
,	TokenNameCOMMA	
"El valor del parámetro {0} debe ser un objeto Java válido"	TokenNameStringLiteral	El valor del parámetro {0} debe ser un objeto Java válido
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_INVALID_NAMESPACE_URI_VALUE_FOR_RESULT_PREFIX_FOR_DEFAULT	TokenNameIdentifier	 ER  INVALID  NAMESPACE  URI  VALUE  FOR  RESULT  PREFIX  FOR  DEFAULT
,	TokenNameCOMMA	
"El atributo result-prefix de un elemento xsl:namespace-alias tiene el valor '#default', pero no hay declaración de espacio de nombres predeterminado en el ámbito del elemento."	TokenNameStringLiteral	El atributo result-prefix de un elemento xsl:namespace-alias tiene el valor '#default', pero no hay declaración de espacio de nombres predeterminado en el ámbito del elemento.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_INVALID_NAMESPACE_URI_VALUE_FOR_RESULT_PREFIX	TokenNameIdentifier	 ER  INVALID  NAMESPACE  URI  VALUE  FOR  RESULT  PREFIX
,	TokenNameCOMMA	
"El atributo result-prefix de un elemento xsl:namespace-alias tiene el valor ''{0}'', pero no hay declaración de espacio de nombres para el prefijo ''{0}'' en el ámbito del elemento."	TokenNameStringLiteral	El atributo result-prefix de un elemento xsl:namespace-alias tiene el valor ''{0}'', pero no hay declaración de espacio de nombres para el prefijo ''{0}'' en el ámbito del elemento.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_SET_FEATURE_NULL_NAME	TokenNameIdentifier	 ER  SET  FEATURE  NULL  NAME
,	TokenNameCOMMA	
"El nombre de característica no puede ser nulo en TransformerFactory.setFeature(nombre de tipo String, valor booleano)."	TokenNameStringLiteral	El nombre de característica no puede ser nulo en TransformerFactory.setFeature(nombre de tipo String, valor booleano).
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_GET_FEATURE_NULL_NAME	TokenNameIdentifier	 ER  GET  FEATURE  NULL  NAME
,	TokenNameCOMMA	
"El nombre de característica no puede ser nulo en TransformerFactory.getFeature(nombre de tipo String)."	TokenNameStringLiteral	El nombre de característica no puede ser nulo en TransformerFactory.getFeature(nombre de tipo String).
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_UNSUPPORTED_FEATURE	TokenNameIdentifier	 ER  UNSUPPORTED  FEATURE
,	TokenNameCOMMA	
"No se puede establecer la característica ''{0}'' en esta TransformerFactory."	TokenNameStringLiteral	No se puede establecer la característica ''{0}'' en esta TransformerFactory.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_EXTENSION_ELEMENT_NOT_ALLOWED_IN_SECURE_PROCESSING	TokenNameIdentifier	 ER  EXTENSION  ELEMENT  NOT  ALLOWED  IN  SECURE  PROCESSING
,	TokenNameCOMMA	
"No se permite el uso del elemento de extensión ''{0}'' cuando la característica de proceso seguro está establecida en true."	TokenNameStringLiteral	No se permite el uso del elemento de extensión ''{0}'' cuando la característica de proceso seguro está establecida en true.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_NAMESPACE_CONTEXT_NULL_NAMESPACE	TokenNameIdentifier	 ER  NAMESPACE  CONTEXT  NULL  NAMESPACE
...
ER_XPATH_RESOLVER_NULL_QNAME	TokenNameIdentifier	 ER  XPATH  RESOLVER  NULL  QNAME
,	TokenNameCOMMA	
"El nombre de función no puede ser nulo."	TokenNameStringLiteral	El nombre de función no puede ser nulo.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_XPATH_RESOLVER_NEGATIVE_ARITY	TokenNameIdentifier	 ER  XPATH  RESOLVER  NEGATIVE  ARITY
...
WG_NO_LOCALE_IN_FORMATNUMBER	TokenNameIdentifier	 WG  NO  LOCALE  IN  FORMATNUMBER
,	TokenNameCOMMA	
"Xalan no maneja aún el nombre de entorno local en la función format-number."	TokenNameStringLiteral	Xalan no maneja aún el nombre de entorno local en la función format-number.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
WG_LOCALE_NOT_FOUND	TokenNameIdentifier	 WG  LOCALE  NOT  FOUND
...
WG_FUNCTIONS_SHOULD_USE_URL	TokenNameIdentifier	 WG  FUNCTIONS  SHOULD  USE  URL
,	TokenNameCOMMA	
"Sintaxis antigua: La instrucción functions debería utilizar un url de {0}"	TokenNameStringLiteral	Sintaxis antigua: La instrucción functions debería utilizar un url de {0}
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
WG_ENCODING_NOT_SUPPORTED_USING_UTF8	TokenNameIdentifier	 WG  ENCODING  NOT  SUPPORTED  USING  UT F8
,	TokenNameCOMMA	
"Codificación no soportada: {0}, se utiliza UTF-8"	TokenNameStringLiteral	Codificación no soportada: {0}, se utiliza UTF-8
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
WG_ENCODING_NOT_SUPPORTED_USING_JAVA	TokenNameIdentifier	 WG  ENCODING  NOT  SUPPORTED  USING  JAVA
,	TokenNameCOMMA	
"Codificación no soportada: {0}, se utiliza Java {1}"	TokenNameStringLiteral	Codificación no soportada: {0}, se utiliza Java {1}
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
WG_SPECIFICITY_CONFLICTS	TokenNameIdentifier	 WG  SPECIFICITY  CONFLICTS
,	TokenNameCOMMA	
"Se han encontrado conflictos de especificación: {0} Se utilizará lo último encontrado en la hoja de estilos."	TokenNameStringLiteral	Se han encontrado conflictos de especificación: {0} Se utilizará lo último encontrado en la hoja de estilos.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
WG_PARSING_AND_PREPARING	TokenNameIdentifier	 WG  PARSING  AND  PREPARING
...
WG_ATTRIB_NOT_HANDLED	TokenNameIdentifier	 WG  ATTRIB  NOT  HANDLED
,	TokenNameCOMMA	
"Xalan no maneja aún el atributo {0}."	TokenNameStringLiteral	Xalan no maneja aún el atributo {0}.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
WG_NO_DECIMALFORMAT_DECLARATION	TokenNameIdentifier	 WG  NO  DECIMALFORMAT  DECLARATION
,	TokenNameCOMMA	
"No se ha encontrado declaración para el formato decimal: {0}"	TokenNameStringLiteral	No se ha encontrado declaración para el formato decimal: {0}
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
WG_OLD_XSLT_NS	TokenNameIdentifier	 WG  OLD  XSLT  NS
...
WG_ONE_DEFAULT_XSLDECIMALFORMAT_ALLOWED	TokenNameIdentifier	 WG  ONE  DEFAULT  XSLDECIMALFORMAT  ALLOWED
,	TokenNameCOMMA	
"Sólo se permite una declaración xsl:decimal-format predeterminada."	TokenNameStringLiteral	Sólo se permite una declaración xsl:decimal-format predeterminada.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
WG_XSLDECIMALFORMAT_NAMES_MUST_BE_UNIQUE	TokenNameIdentifier	 WG  XSLDECIMALFORMAT  NAMES  MUST  BE  UNIQUE
,	TokenNameCOMMA	
"Los nombres de xsl:decimal-format deben ser únicos. El nombre "{0}" se ha duplicado."	TokenNameStringLiteral	Los nombres de xsl:decimal-format deben ser únicos. El nombre "{0}" se ha duplicado.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
WG_ILLEGAL_ATTRIBUTE	TokenNameIdentifier	 WG  ILLEGAL  ATTRIBUTE
...
WG_COULD_NOT_RESOLVE_PREFIX	TokenNameIdentifier	 WG  COULD  NOT  RESOLVE  PREFIX
,	TokenNameCOMMA	
"No se ha podido resolver el prefijo del espacio de nombres: {0}. Se ignorará el nodo."	TokenNameStringLiteral	No se ha podido resolver el prefijo del espacio de nombres: {0}. Se ignorará el nodo.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
WG_STYLESHEET_REQUIRES_VERSION_ATTRIB	TokenNameIdentifier	 WG  STYLESHEET  REQUIRES  VERSION  ATTRIB
...
WG_EMPTY_SECOND_ARG	TokenNameIdentifier	 WG  EMPTY  SECOND  ARG
,	TokenNameCOMMA	
"El NodeSet resultante del segundo argumento de la función del documento está vacío. Devuelve un conjunto de nodos vacío."	TokenNameStringLiteral	El NodeSet resultante del segundo argumento de la función del documento está vacío. Devuelve un conjunto de nodos vacío.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
WG_PROCESSINGINSTRUCTION_NOTVALID_NCNAME	TokenNameIdentifier	 WG  PROCESSINGINSTRUCTION  NOTVALID  NCNAME
,	TokenNameCOMMA	
"El valor del atributo ''name'' de xsl:processing-instruction debe ser un NCName válido: {0}"	TokenNameStringLiteral	El valor del atributo ''name'' de xsl:processing-instruction debe ser un NCName válido: {0}
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
WG_ILLEGAL_ATTRIBUTE_POSITION	TokenNameIdentifier	 WG  ILLEGAL  ATTRIBUTE  POSITION
,	TokenNameCOMMA	
"No se puede añadir el atributo {0} después de nodos hijo o antes de que se produzca un elemento. Se ignorará el atributo."	TokenNameStringLiteral	No se puede añadir el atributo {0} después de nodos hijo o antes de que se produzca un elemento. Se ignorará el atributo.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
NO_MODIFICATION_ALLOWED_ERR	TokenNameIdentifier	 NO  MODIFICATION  ALLOWED  ERR
...
,	TokenNameCOMMA	
">>>>>>> Xalan versión "	TokenNameStringLiteral	>>>>>>> Xalan versión 
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
...
,	TokenNameCOMMA	
"Opciones de la clase Process de la línea de mandatos Xalan-J:"	TokenNameStringLiteral	Opciones de la clase Process de la línea de mandatos Xalan-J:
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
"xslProc_option"	TokenNameStringLiteral	xslProc_option
...
,	TokenNameCOMMA	
"La opción {0} no está soportada en modalidad XSLTC."	TokenNameStringLiteral	La opción {0} no está soportada en modalidad XSLTC.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
"xslProc_invalid_xalan_option"	TokenNameStringLiteral	xslProc_invalid_xalan_option
,	TokenNameCOMMA	
"La opción {0} sólo puede utilizarse con -XSLTC."	TokenNameStringLiteral	La opción {0} sólo puede utilizarse con -XSLTC.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
...
,	TokenNameCOMMA	
"[-XSLTC (Utilizar XSLTC para transformación)]"	TokenNameStringLiteral	[-XSLTC (Utilizar XSLTC para transformación)]
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
...
,	TokenNameCOMMA	
"[-XSL URL_transformación_XSL]"	TokenNameStringLiteral	[-XSL URL_transformación_XSL]
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
...
,	TokenNameCOMMA	
"[-LF (Utilizar sólo avances de línea en la salida {el valor predeterminado es CR/LF})]"	TokenNameStringLiteral	[-LF (Utilizar sólo avances de línea en la salida {el valor predeterminado es CR/LF})]
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
"optionCR"	TokenNameStringLiteral	optionCR
,	TokenNameCOMMA	
"[-CR (Utilizar sólo retornos de carro en la salida {el valor predeterminado es CR/LF})]"	TokenNameStringLiteral	[-CR (Utilizar sólo retornos de carro en la salida {el valor predeterminado es CR/LF})]
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
...
,	TokenNameCOMMA	
"[-INDENT (Controlar el número de espacios de sangrado {el valor predeterminado es 0})]"	TokenNameStringLiteral	[-INDENT (Controlar el número de espacios de sangrado {el valor predeterminado es 0})]
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
...
,	TokenNameCOMMA	
"[-TG (Rastrear cada suceso de generación.)]"	TokenNameStringLiteral	[-TG (Rastrear cada suceso de generación.)]
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
"optionTS"	TokenNameStringLiteral	optionTS
,	TokenNameCOMMA	
"[-TS (Rastrear cada suceso de selección.)]"	TokenNameStringLiteral	[-TS (Rastrear cada suceso de selección.)]
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
...
,	TokenNameCOMMA	
"[-VALIDATE (Establecer si se realiza la validación. De forma predeterminada la validación está desactivada.)]"	TokenNameStringLiteral	[-VALIDATE (Establecer si se realiza la validación. De forma predeterminada la validación está desactivada.)]
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
...
,	TokenNameCOMMA	
"[-XML (Utilizar el formateador XML y añadir la cabecera XML.)]"	TokenNameStringLiteral	[-XML (Utilizar el formateador XML y añadir la cabecera XML.)]
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
...
,	TokenNameCOMMA	
"[-PARAM expresión de nombre (Establecer un parámetro de hoja de estilos)]"	TokenNameStringLiteral	[-PARAM expresión de nombre (Establecer un parámetro de hoja de estilos)]
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
...
,	TokenNameCOMMA	
"[-L utilizar números de línea para el documento fuente]"	TokenNameStringLiteral	[-L utilizar números de línea para el documento fuente]
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
"optionSECUREPROCESSING"	TokenNameStringLiteral	optionSECUREPROCESSING
,	TokenNameCOMMA	
" [-SECURE (establecer la característica de proceso seguro en true.)]"	TokenNameStringLiteral	 [-SECURE (establecer la característica de proceso seguro en true.)]
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
,	TokenNameCOMMA	
"[-FLAVOR nombre_estilo (Utilizar explícitamente s2s=SAX o d2d=DOM para realizar la transformación.)] "	TokenNameStringLiteral	[-FLAVOR nombre_estilo (Utilizar explícitamente s2s=SAX o d2d=DOM para realizar la transformación.)] 
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
,	TokenNameCOMMA	
"[-DIAG (Imprimir el total de milisegundos que lleva la transformación.)]"	TokenNameStringLiteral	[-DIAG (Imprimir el total de milisegundos que lleva la transformación.)]
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
"optionINCREMENTAL"	TokenNameStringLiteral	optionINCREMENTAL
,	TokenNameCOMMA	
"[-INCREMENTAL (Solicitar construcción DTM incremental estableciendo http://xml.apache.org/xalan/features/incremental como verdadero.)]"	TokenNameStringLiteral	[-INCREMENTAL (Solicitar construcción DTM incremental estableciendo http://xml.apache.org/xalan/features/incremental como verdadero.)]
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
"optionNOOPTIMIMIZE"	TokenNameStringLiteral	optionNOOPTIMIMIZE
,	TokenNameCOMMA	
"[-NOOPTIMIMIZE (Solicitar proceso de optimización de hoja de estilos estableciendo http://xml.apache.org/xalan/features/optimize como falso.)]"	TokenNameStringLiteral	[-NOOPTIMIMIZE (Solicitar proceso de optimización de hoja de estilos estableciendo http://xml.apache.org/xalan/features/optimize como falso.)]
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
"optionRL"	TokenNameStringLiteral	optionRL
,	TokenNameCOMMA	
"[-RL límite_recursión (Límite numérico de aserción sobre profundidad de recursión de hoja de estilos.)]"	TokenNameStringLiteral	[-RL límite_recursión (Límite numérico de aserción sobre profundidad de recursión de hoja de estilos.)]
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
...
,	TokenNameCOMMA	
"[-XN (habilita la inclusión en línea de plantillas)]"	TokenNameStringLiteral	[-XN (habilita la inclusión en línea de plantillas)]
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
"optionXX"	TokenNameStringLiteral	optionXX
,	TokenNameCOMMA	
"[-XX (activa la salida de mensajes de depuración adicionales)]"	TokenNameStringLiteral	[-XX (activa la salida de mensajes de depuración adicionales)]
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
...
,	TokenNameCOMMA	
"--------- La transformación de {0} mediante {1} ha durado {2} ms"	TokenNameStringLiteral	--------- La transformación de {0} mediante {1} ha durado {2} ms
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
...
,	TokenNameCOMMA	
"el patrón de coincidencia es"	TokenNameStringLiteral	el patrón de coincidencia es
}	TokenNameRBRACE	
}	TokenNameRBRACE	
;	TokenNameSEMICOLON	
}	TokenNameRBRACE	
