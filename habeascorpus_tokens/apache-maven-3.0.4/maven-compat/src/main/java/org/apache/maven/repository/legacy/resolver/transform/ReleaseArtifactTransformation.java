...
Component	TokenNameIdentifier	 Component
;	TokenNameSEMICOLON	
/** * Change the version <code>RELEASE</code> to the appropriate release version from the remote repository. * * @author <a href="mailto:brett@apache.org">Brett Porter</a> */	TokenNameCOMMENT_JAVADOC	 Change the version <code>RELEASE</code> to the appropriate release version from the remote repository. * @author <a href="mailto:brett@apache.org">Brett Porter</a> 
@	TokenNameAT	
Component	TokenNameIdentifier	 Component
(	TokenNameLPAREN	
...
ArtifactNotFoundException	TokenNameIdentifier	 Artifact Not Found Exception
(	TokenNameLPAREN	
"Unable to determine the release version"	TokenNameStringLiteral	Unable to determine the release version
,	TokenNameCOMMA	
artifact	TokenNameIdentifier	 artifact
)	TokenNameRPAREN	
;	TokenNameSEMICOLON	
