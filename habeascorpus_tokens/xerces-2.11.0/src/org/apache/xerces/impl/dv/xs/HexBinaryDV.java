...
;	TokenNameSEMICOLON	
/** * Represent the schema type "hexBinary" * * @xerces.internal * * @author Neeraj Bajaj, Sun Microsystems, inc. * @author Sandy Gao, IBM * * @version $Id: HexBinaryDV.java 446745 2006-09-15 21:43:58Z mrglavas $ */	TokenNameCOMMENT_JAVADOC	 Represent the schema type "hexBinary" * @xerces.internal * @author Neeraj Bajaj, Sun Microsystems, inc. @author Sandy Gao, IBM * @version $Id: HexBinaryDV.java 446745 2006-09-15 21:43:58Z mrglavas $ 
...
return	TokenNamereturn	
new	TokenNamenew	
XHex	TokenNameIdentifier	 X Hex
(	TokenNameLPAREN	
decoded	TokenNameIdentifier	 decoded
)	TokenNameRPAREN	
;	TokenNameSEMICOLON	
