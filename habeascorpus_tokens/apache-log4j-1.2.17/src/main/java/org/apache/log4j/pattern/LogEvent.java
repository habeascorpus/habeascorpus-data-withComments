...
/** * This class is a copy of o.a.l.spi.LoggingEvent from * log4j 1.2.15 which has been renamed to keep * the same overall class name length to allow a * serialization written with a prior instance of o.a.l.spi.LoggingEvent * to be deserialized with this class just by mangling the class name * in the byte stream. * */	TokenNameCOMMENT_JAVADOC	 This class is a copy of o.a.l.spi.LoggingEvent from log4j 1.2.15 which has been renamed to keep the same overall class name length to allow a serialization written with a prior instance of o.a.l.spi.LoggingEvent to be deserialized with this class just by mangling the class name in the byte stream. 
