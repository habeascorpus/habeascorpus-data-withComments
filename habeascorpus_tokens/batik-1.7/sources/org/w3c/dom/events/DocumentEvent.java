...
DOMException	TokenNameIdentifier	 DOM Exception
;	TokenNameSEMICOLON	
/** * Test if the implementation can generate events of a specified type. * @param namespaceURI Specifies the <code>Event.namespaceURI</code> of * the event. * @param type Specifies the <code>Event.type</code> of the event. * @return <code>true</code> if the implementation can generate and * dispatch this event type, <code>false</code> otherwise. * @since DOM Level 3 */	TokenNameCOMMENT_JAVADOC	 Test if the implementation can generate events of a specified type. @param namespaceURI Specifies the <code>Event.namespaceURI</code> of the event. @param type Specifies the <code>Event.type</code> of the event. @return <code>true</code> if the implementation can generate and dispatch this event type, <code>false</code> otherwise. @since DOM Level 3 
public	TokenNamepublic	
boolean	TokenNameboolean	
canDispatch	TokenNameIdentifier	 can Dispatch
(	TokenNameLPAREN	
String	TokenNameIdentifier	 String
