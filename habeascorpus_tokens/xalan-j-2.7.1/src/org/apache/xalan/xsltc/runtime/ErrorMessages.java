...
/* * $Id: ErrorMessages.java 468652 2006-10-28 07:05:17Z minchau $ */	TokenNameCOMMENT_BLOCK	 $Id: ErrorMessages.java 468652 2006-10-28 07:05:17Z minchau $ 
...
,	TokenNameCOMMA	
"Run-time internal error in ''{0}''"	TokenNameStringLiteral	Run-time internal error in ''{0}''
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
,	TokenNameCOMMA	
"Run-time error when executing <xsl:copy>."	TokenNameStringLiteral	Run-time error when executing <xsl:copy>.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
,	TokenNameCOMMA	
"Invalid conversion from ''{0}'' to ''{1}''."	TokenNameStringLiteral	Invalid conversion from ''{0}'' to ''{1}''.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
,	TokenNameCOMMA	
"External function ''{0}'' not supported by XSLTC."	TokenNameStringLiteral	External function ''{0}'' not supported by XSLTC.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
,	TokenNameCOMMA	
"Unknown argument type in equality expression."	TokenNameStringLiteral	Unknown argument type in equality expression.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
,	TokenNameCOMMA	
"Invalid argument type ''{0}'' in call to ''{1}''"	TokenNameStringLiteral	Invalid argument type ''{0}'' in call to ''{1}''
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
,	TokenNameCOMMA	
"Attempting to format number ''{0}'' using pattern ''{1}''."	TokenNameStringLiteral	Attempting to format number ''{0}'' using pattern ''{1}''.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
,	TokenNameCOMMA	
"Cannot clone iterator ''{0}''."	TokenNameStringLiteral	Cannot clone iterator ''{0}''.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
,	TokenNameCOMMA	
"Iterator for axis ''{0}'' not supported."	TokenNameStringLiteral	Iterator for axis ''{0}'' not supported.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
/* * Note to translators: The following represents an internal error * situation in XSLTC. The processor attempted to create an iterator * for a particular axis (see definition above) that it does not * support. */	TokenNameCOMMENT_BLOCK	 Note to translators: The following represents an internal error situation in XSLTC. The processor attempted to create an iterator for a particular axis (see definition above) that it does not support. 
{	TokenNameLBRACE	
...
,	TokenNameCOMMA	
"Iterator for typed axis ''{0}'' not supported."	TokenNameStringLiteral	Iterator for typed axis ''{0}'' not supported.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
,	TokenNameCOMMA	
"DOMAdapter created using wrong type of source DOM."	TokenNameStringLiteral	DOMAdapter created using wrong type of source DOM.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
,	TokenNameCOMMA	
"The SAX parser you are using does not handle DTD declaration events."	TokenNameStringLiteral	The SAX parser you are using does not handle DTD declaration events.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
,	TokenNameCOMMA	
"The SAX parser you are using does not have support for XML Namespaces."	TokenNameStringLiteral	The SAX parser you are using does not have support for XML Namespaces.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
,	TokenNameCOMMA	
"Could not resolve the URI reference ''{0}''."	TokenNameStringLiteral	Could not resolve the URI reference ''{0}''.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
,	TokenNameCOMMA	
"Unrecognized XSLTC extension ''{0}''"	TokenNameStringLiteral	Unrecognized XSLTC extension ''{0}''
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
,	TokenNameCOMMA	
"The specified translet, ''{0}'', was created using a version of XSLTC more recent than the version of the XSLTC run-time that is in use. You must recompile the stylesheet or use a more recent version of XSLTC to run this translet."	TokenNameStringLiteral	The specified translet, ''{0}'', was created using a version of XSLTC more recent than the version of the XSLTC run-time that is in use. You must recompile the stylesheet or use a more recent version of XSLTC to run this translet.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
,	TokenNameCOMMA	
"An attribute whose value must be a QName had the value ''{0}''"	TokenNameStringLiteral	An attribute whose value must be a QName had the value ''{0}''
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
,	TokenNameCOMMA	
"Use of the extension function ''{0}'' is not allowed when the secure processing feature is set to true."	TokenNameStringLiteral	Use of the extension function ''{0}'' is not allowed when the secure processing feature is set to true.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
BasisLibrary	TokenNameIdentifier	 Basis Library
