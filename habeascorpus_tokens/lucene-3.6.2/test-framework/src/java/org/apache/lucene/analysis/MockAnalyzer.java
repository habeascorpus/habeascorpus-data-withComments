...
/** * Calls {@link #MockAnalyzer(Random, int, boolean, CharArraySet, boolean) * MockAnalyzer(random, pattern, lowerCase, CharArraySet.EMPTY_STOPSET, true}). */	TokenNameCOMMENT_JAVADOC	 Calls {@link #MockAnalyzer(Random, int, boolean, CharArraySet, boolean) MockAnalyzer(random, pattern, lowerCase, CharArraySet.EMPTY_STOPSET, true}). 
public	TokenNamepublic	
MockAnalyzer	TokenNameIdentifier	 Mock Analyzer
(	TokenNameLPAREN	
Random	TokenNameIdentifier	 Random
...
/** * Toggle maxTokenLength for MockTokenizer */	TokenNameCOMMENT_JAVADOC	 Toggle maxTokenLength for MockTokenizer 
public	TokenNamepublic	
void	TokenNamevoid	
