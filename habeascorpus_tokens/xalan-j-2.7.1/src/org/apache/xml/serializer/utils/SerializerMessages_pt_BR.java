...
,	TokenNameCOMMA	
"A chave de mensagem ''{0}'' não está na classe de mensagem ''{1}''"	TokenNameStringLiteral	A chave de mensagem ''{0}'' não está na classe de mensagem ''{1}''
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
MsgKey	TokenNameIdentifier	 Msg Key
...
,	TokenNameCOMMA	
"A classe de serializador ''{0}'' não implementa org.xml.sax.ContentHandler."	TokenNameStringLiteral	A classe de serializador ''{0}'' não implementa org.xml.sax.ContentHandler.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
MsgKey	TokenNameIdentifier	 Msg Key
...
,	TokenNameCOMMA	
"Não foi possível carregar ''{0}'' (verifique CLASSPATH) agora , utilizando somente os padrões"	TokenNameStringLiteral	Não foi possível carregar ''{0}'' (verifique CLASSPATH) agora , utilizando somente os padrões
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
MsgKey	TokenNameIdentifier	 Msg Key
...
,	TokenNameCOMMA	
"Tentativa de processar o caractere de um valor integral {0} que não é representado na codificação de saída especificada de {1}."	TokenNameStringLiteral	Tentativa de processar o caractere de um valor integral {0} que não é representado na codificação de saída especificada de {1}.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
MsgKey	TokenNameIdentifier	 Msg Key
...
,	TokenNameCOMMA	
"Não foi possível carregar o arquivo de propriedade ''{0}'' para o método de saída ''{1}'' (verifique CLASSPATH)"	TokenNameStringLiteral	Não foi possível carregar o arquivo de propriedade ''{0}'' para o método de saída ''{1}'' (verifique CLASSPATH)
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
MsgKey	TokenNameIdentifier	 Msg Key
...
,	TokenNameCOMMA	
"Aviso: A versão do documento de saída precisa ser ''{0}''. Essa versão do XML não é suportada. A versão do documento de saída será ''1.0''."	TokenNameStringLiteral	Aviso: A versão do documento de saída precisa ser ''{0}''. Essa versão do XML não é suportada. A versão do documento de saída será ''1.0''.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
MsgKey	TokenNameIdentifier	 Msg Key
...
,	TokenNameCOMMA	
"O objeto Properties transmitido para SerializerFactory não tem uma propriedade ''{0}''."	TokenNameStringLiteral	O objeto Properties transmitido para SerializerFactory não tem uma propriedade ''{0}''.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
MsgKey	TokenNameIdentifier	 Msg Key
...
,	TokenNameCOMMA	
"Aviso: A codificação ''{0}'' não é suportada pelo Java Runtime."	TokenNameStringLiteral	Aviso: A codificação ''{0}'' não é suportada pelo Java Runtime.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
MsgKey	TokenNameIdentifier	 Msg Key
...
,	TokenNameCOMMA	
"O parâmetro ''{0}'' não é reconhecido."	TokenNameStringLiteral	O parâmetro ''{0}'' não é reconhecido.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
MsgKey	TokenNameIdentifier	 Msg Key
...
,	TokenNameCOMMA	
"O parâmetro ''{0}'' é reconhecido, mas o valor pedido não pode ser definido. "	TokenNameStringLiteral	O parâmetro ''{0}'' é reconhecido, mas o valor pedido não pode ser definido. 
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
MsgKey	TokenNameIdentifier	 Msg Key
...
,	TokenNameCOMMA	
"A cadeia resultante é muito longa para caber em uma DOMString: ''{0}''. "	TokenNameStringLiteral	A cadeia resultante é muito longa para caber em uma DOMString: ''{0}''. 
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
MsgKey	TokenNameIdentifier	 Msg Key
...
,	TokenNameCOMMA	
"O tipo de valor para este nome de parâmetro é incompatível com o tipo de valor esperado. "	TokenNameStringLiteral	O tipo de valor para este nome de parâmetro é incompatível com o tipo de valor esperado. 
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
MsgKey	TokenNameIdentifier	 Msg Key
...
,	TokenNameCOMMA	
"O destino de saída para os dados a serem gravados era nulo. "	TokenNameStringLiteral	O destino de saída para os dados a serem gravados era nulo. 
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
MsgKey	TokenNameIdentifier	 Msg Key
...
,	TokenNameCOMMA	
"Uma codificação não suportada foi encontrada. "	TokenNameStringLiteral	Uma codificação não suportada foi encontrada. 
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
MsgKey	TokenNameIdentifier	 Msg Key
...
,	TokenNameCOMMA	
"O nó não pôde ser serializado."	TokenNameStringLiteral	O nó não pôde ser serializado.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
MsgKey	TokenNameIdentifier	 Msg Key
...
,	TokenNameCOMMA	
"A Seção CDATA contém um ou mais marcadores de término ']]>'."	TokenNameStringLiteral	A Seção CDATA contém um ou mais marcadores de término ']]>'.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
MsgKey	TokenNameIdentifier	 Msg Key
...
,	TokenNameCOMMA	
"Uma instância do verificador Well-Formedness não pôde ser criada. O parâmetro well-formed foi definido como true, mas a verificação well-formedness não pode ser executada."	TokenNameStringLiteral	Uma instância do verificador Well-Formedness não pôde ser criada. O parâmetro well-formed foi definido como true, mas a verificação well-formedness não pode ser executada.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
MsgKey	TokenNameIdentifier	 Msg Key
...
,	TokenNameCOMMA	
"O nó ''{0}'' contém caracteres XML inválidos. "	TokenNameStringLiteral	O nó ''{0}'' contém caracteres XML inválidos. 
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
MsgKey	TokenNameIdentifier	 Msg Key
...
,	TokenNameCOMMA	
"Um caractere XML inválido (Unicode: 0x{0}) foi encontrado no comentário. "	TokenNameStringLiteral	Um caractere XML inválido (Unicode: 0x{0}) foi encontrado no comentário. 
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
MsgKey	TokenNameIdentifier	 Msg Key
...
,	TokenNameCOMMA	
"Um caractere XML inválido (Unicode: 0x{0}) foi encontrado no processo instructiondata."	TokenNameStringLiteral	Um caractere XML inválido (Unicode: 0x{0}) foi encontrado no processo instructiondata.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
MsgKey	TokenNameIdentifier	 Msg Key
...
,	TokenNameCOMMA	
"Um caractere XML inválido (Unicode: 0x{0}) foi encontrado nos conteúdos do CDATASection. "	TokenNameStringLiteral	Um caractere XML inválido (Unicode: 0x{0}) foi encontrado nos conteúdos do CDATASection. 
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
MsgKey	TokenNameIdentifier	 Msg Key
...
,	TokenNameCOMMA	
"Um caractere XML inválido (Unicode: 0x{0}) foi encontrado no conteúdo dos dados de caractere dos nós. "	TokenNameStringLiteral	Um caractere XML inválido (Unicode: 0x{0}) foi encontrado no conteúdo dos dados de caractere dos nós. 
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
MsgKey	TokenNameIdentifier	 Msg Key
...
,	TokenNameCOMMA	
"Um caractere inválido foi encontrado no {0} do nó denominado ''{1}''."	TokenNameStringLiteral	Um caractere inválido foi encontrado no {0} do nó denominado ''{1}''.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
MsgKey	TokenNameIdentifier	 Msg Key
...
,	TokenNameCOMMA	
"A cadeia "--" não é permitida dentro dos comentários. "	TokenNameStringLiteral	A cadeia "--" não é permitida dentro dos comentários. 
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
MsgKey	TokenNameIdentifier	 Msg Key
...
,	TokenNameCOMMA	
"O valor do atributo "{1}" associado a um tipo de elemento "{0}" não deve conter o caractere ''<''. "	TokenNameStringLiteral	O valor do atributo "{1}" associado a um tipo de elemento "{0}" não deve conter o caractere ''<''. 
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
MsgKey	TokenNameIdentifier	 Msg Key
...
,	TokenNameCOMMA	
"A referência de entidade não analisada "&{0};" não é permitida. "	TokenNameStringLiteral	A referência de entidade não analisada "&{0};" não é permitida. 
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
MsgKey	TokenNameIdentifier	 Msg Key
...
,	TokenNameCOMMA	
"A referência de entidade externa "&{0};" não é permitida em um valor de atributo. "	TokenNameStringLiteral	A referência de entidade externa "&{0};" não é permitida em um valor de atributo. 
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
MsgKey	TokenNameIdentifier	 Msg Key
...
,	TokenNameCOMMA	
"O prefixo "{0}" não pode ser vinculado ao espaço de nomes "{1}"."	TokenNameStringLiteral	O prefixo "{0}" não pode ser vinculado ao espaço de nomes "{1}".
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
MsgKey	TokenNameIdentifier	 Msg Key
...
,	TokenNameCOMMA	
"O nome local do elemento "{0}" é nulo."	TokenNameStringLiteral	O nome local do elemento "{0}" é nulo.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
MsgKey	TokenNameIdentifier	 Msg Key
...
,	TokenNameCOMMA	
"O nome local do atributo "{0}" é nulo."	TokenNameStringLiteral	O nome local do atributo "{0}" é nulo.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
MsgKey	TokenNameIdentifier	 Msg Key
...
,	TokenNameCOMMA	
"O texto de substituição do nó de entidade "{0}" contém um nó de elemento "{1}" com um prefixo não vinculado "{2}"."	TokenNameStringLiteral	O texto de substituição do nó de entidade "{0}" contém um nó de elemento "{1}" com um prefixo não vinculado "{2}".
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
MsgKey	TokenNameIdentifier	 Msg Key
...
,	TokenNameCOMMA	
"O texto de substituição do nó de entidade "{0}" contém um nó de atributo "{1}" com um prefixo não vinculado "{2}"."	TokenNameStringLiteral	O texto de substituição do nó de entidade "{0}" contém um nó de atributo "{1}" com um prefixo não vinculado "{2}".
}	TokenNameRBRACE	
,	TokenNameCOMMA	
}	TokenNameRBRACE	
;	TokenNameSEMICOLON	
