...
;	TokenNameSEMICOLON	
/** * This class is duplicated for each subpackage so keep it in sync. * It is package private and therefore is not exposed as part of any API. * * @xerces.internal * * @version $Id: SecuritySupport.java 950361 2010-06-02 04:12:35Z mrglavas $ */	TokenNameCOMMENT_JAVADOC	 This class is duplicated for each subpackage so keep it in sync. It is package private and therefore is not exposed as part of any API. * @xerces.internal * @version $Id: SecuritySupport.java 950361 2010-06-02 04:12:35Z mrglavas $ 
