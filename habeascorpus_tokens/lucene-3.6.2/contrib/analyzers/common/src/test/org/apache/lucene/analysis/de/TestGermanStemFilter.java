...
*	TokenNameMULTIPLY	
;	TokenNameSEMICOLON	
/** * Test the German stemmer. The stemming algorithm is known to work less * than perfect, as it doesn't use any word lists with exceptions. We * also check some of the cases where the algorithm is wrong. * */	TokenNameCOMMENT_JAVADOC	 Test the German stemmer. The stemming algorithm is known to work less than perfect, as it doesn't use any word lists with exceptions. We also check some of the cases where the algorithm is wrong. 
public	TokenNamepublic	
class	TokenNameclass	
TestGermanStemFilter	TokenNameIdentifier	 Test German Stem Filter
...
public	TokenNamepublic	
void	TokenNamevoid	
testStemming	TokenNameIdentifier	 test Stemming
(	TokenNameLPAREN	
)	TokenNameRPAREN	
...
(	TokenNameLPAREN	
"data.txt"	TokenNameStringLiteral	data.txt
)	TokenNameRPAREN	
;	TokenNameSEMICOLON	
...
// LUCENE-3043: we use keywordtokenizer in this test, 	TokenNameCOMMENT_LINE	LUCENE-3043: we use keywordtokenizer in this test, 
// so ensure the stemmer does not crash on zero-length strings. 	TokenNameCOMMENT_LINE	so ensure the stemmer does not crash on zero-length strings. 
public	TokenNamepublic	
void	TokenNamevoid	
