...
/* * $Id: ErrorMessages_ko.java 468649 2006-10-28 07:00:55Z minchau $ */	TokenNameCOMMENT_BLOCK	 $Id: ErrorMessages_ko.java 468649 2006-10-28 07:00:55Z minchau $ 
...
ErrorMessages_ko	TokenNameIdentifier	 Error Messages ko
...
,	TokenNameCOMMA	
"''{0}'' URI ?? ??? ?? ? ????."	TokenNameStringLiteral	''{0}'' URI ?? ??? ?? ? ????.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
,	TokenNameCOMMA	
"''{0}'' XPath ??? ?? ?? ?? ??? ??????."	TokenNameStringLiteral	''{0}'' XPath ??? ?? ?? ?? ??? ??????.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
,	TokenNameCOMMA	
"''{0}'' 10?? ???? ?? ???? ????."	TokenNameStringLiteral	''{0}'' 10?? ???? ?? ???? ????.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
,	TokenNameCOMMA	
"XSLTC?? ''{0}'' XSL ??? ???? ????."	TokenNameStringLiteral	XSLTC?? ''{0}'' XSL ??? ???? ????.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
,	TokenNameCOMMA	
"document() ??? ?? ? ?? ??? node-set?? ???."	TokenNameStringLiteral	document() ??? ?? ? ?? ??? node-set?? ???.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
,	TokenNameCOMMA	
"<xsl:choose>? ??? <xsl:otherwise> ???? ?????."	TokenNameStringLiteral	<xsl:choose>? ??? <xsl:otherwise> ???? ?????.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
/* * Note to translators: "<xsl:otherwise>" and "<xsl:choose>" are * keywords and should not be translated. This message describes a * syntax error in the stylesheet. */	TokenNameCOMMENT_BLOCK	 Note to translators: "<xsl:otherwise>" and "<xsl:choose>" are keywords and should not be translated. This message describes a syntax error in the stylesheet. 
{	TokenNameLBRACE	
...
,	TokenNameCOMMA	
"<xsl:when> ? <xsl:otherwise> ???? <xsl:choose>?? ?????."	TokenNameStringLiteral	<xsl:when> ? <xsl:otherwise> ???? <xsl:choose>?? ?????.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
,	TokenNameCOMMA	
"''{0}'' XSL ??? ???? ????."	TokenNameStringLiteral	''{0}'' XSL ??? ???? ????.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
,	TokenNameCOMMA	
"? Templates?? ??? translet ??? ??? ???? ?? ????."	TokenNameStringLiteral	? Templates?? ??? translet ??? ??? ???? ?? ????.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
/* * Note to translators: "Templates" is a Java class name that should * not be translated. */	TokenNameCOMMENT_BLOCK	 Note to translators: "Templates" is a Java class name that should not be translated. 
{	TokenNameLBRACE	
...
,	TokenNameCOMMA	
"''{0}'' translet ???? ??? ? ????."	TokenNameStringLiteral	''{0}'' translet ???? ??? ? ????.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ErrorMsg	TokenNameIdentifier	 Error Msg
...
,	TokenNameCOMMA	
"''{0}''? ?? ErrorListener? ?(null)? ????? ???."	TokenNameStringLiteral	''{0}''? ?? ErrorListener? ?(null)? ????? ???.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
,	TokenNameCOMMA	
"Transformer? ??? translet ????? ????."	TokenNameStringLiteral	Transformer? ??? translet ????? ????.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
,	TokenNameCOMMA	
"''{0}'' ??? Transformer ??? ?????? ???."	TokenNameStringLiteral	''{0}'' ??? Transformer ??? ?????? ???.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
,	TokenNameCOMMA	
"XSLTCSource.build()? ??? ??? ID ?? ???????."	TokenNameStringLiteral	XSLTCSource.build()? ??? ??? ID ?? ???????.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ErrorMsg	TokenNameIdentifier	 Error Msg
...
,	TokenNameCOMMA	
"SYNOPSIS java org.apache.xalan.xsltc.cmdline.Compile [-o <output>] [-d <directory>] [-j <jarfile>] [-p <package>] [-n] [-x] [-u] [-v] [-h] { <stylesheet> | -i } ?? -o <output> ??? Translet? <output> ??? ?????. ????? Translet ??? <stylesheet> ???? ?????. ? ??? ?? ?? ?????? ???? ?? ?????. -d <directory> Translet? ?? ????? ?????. -j <jarfile> <jarfile>? ??? jar ?? ???? Translet ???? ??????. -p <package> ??? ?? Translet ???? ?? ??? ?? ???? ?????. -n ???? ????(???? ???)? ?? ???? ???. -x ?? ??? ??? ??? ?????. -u <stylesheet> ??? URL? ?????. -i stdin???? ?????? ??? ????? ?? ?????. -v ???? ??? ?????. -h ??? ???? ?????. "	TokenNameStringLiteral	SYNOPSIS java org.apache.xalan.xsltc.cmdline.Compile [-o <output>] [-d <directory>] [-j <jarfile>] [-p <package>] [-n] [-x] [-u] [-v] [-h] { <stylesheet> | -i } ?? -o <output> ??? Translet? <output> ??? ?????. ????? Translet ??? <stylesheet> ???? ?????. ? ??? ?? ?? ?????? ???? ?? ?????. -d <directory> Translet? ?? ????? ?????. -j <jarfile> <jarfile>? ??? jar ?? ???? Translet ???? ??????. -p <package> ??? ?? Translet ???? ?? ??? ?? ???? ?????. -n ???? ????(???? ???)? ?? ???? ???. -x ?? ??? ??? ??? ?????. -u <stylesheet> ??? URL? ?????. -i stdin???? ?????? ??? ????? ?? ?????. -v ???? ??? ?????. -h ??? ???? ?????. 
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
,	TokenNameCOMMA	
"SYNOPSIS java org.apache.xalan.xsltc.cmdline.Transform [-j <jarfile>] [-x] [-n <iterations>] {-u <document_url> | <document>} <class> [<param1>=<value1> ...] Translet <class>? ???? <document>? ??? XML ??? ?????. Translet <class>? ???? CLASSPATH ?? ????? ??? <jarfile> ?? ????. ?? -j <jarfile> Translet? ???? jarfile? ?????. -x ?? ??? ??? ??? ?????. -n <iterations> <iterations> ?? ??? ???? ????? ??? ?????. -u <document_url> XML ?? ??? URL? ?????. "	TokenNameStringLiteral	SYNOPSIS java org.apache.xalan.xsltc.cmdline.Transform [-j <jarfile>] [-x] [-n <iterations>] {-u <document_url> | <document>} <class> [<param1>=<value1> ...] Translet <class>? ???? <document>? ??? XML ??? ?????. Translet <class>? ???? CLASSPATH ?? ????? ??? <jarfile> ?? ????. ?? -j <jarfile> Translet? ???? jarfile? ?????. -x ?? ??? ??? ??? ?????. -n <iterations> <iterations> ?? ??? ???? ????? ??? ?????. -u <document_url> XML ?? ??? URL? ?????. 
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
,	TokenNameCOMMA	
"? JVM?? ''{0}'' ?? ???? ???? ????."	TokenNameStringLiteral	? JVM?? ''{0}'' ?? ???? ???? ????.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
,	TokenNameCOMMA	
"non-static Java ?? ''{0}''? ? ?? ??? ??? ???? ??? ????."	TokenNameStringLiteral	non-static Java ?? ''{0}''? ? ?? ??? ??? ???? ??? ????.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
,	TokenNameCOMMA	
"''{1}'' jar ??? ''{0}'' Translet? ???? ??????."	TokenNameStringLiteral	''{1}'' jar ??? ''{0}'' Translet? ???? ??????.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
,	TokenNameCOMMA	
"''{0}'' ??? Java ??? ???? ??? ? ?? ??? ???? ???? Translet ??? ???? ??? ? ????. ??? ''{1}'' ??? ???????."	TokenNameStringLiteral	''{0}'' ??? Java ??? ???? ??? ? ?? ??? ???? ???? Translet ??? ???? ??? ? ????. ??? ''{1}'' ??? ???????.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
,	TokenNameCOMMA	
"?? QName ?? QName? ??? ????? ??? ????? ?? ??? ''{0}'' ?? ????."	TokenNameStringLiteral	?? QName ?? QName? ??? ????? ??? ????? ?? ??? ''{0}'' ?? ????.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
,	TokenNameCOMMA	
"<xsl:output> ??? ??? ??? ''{0}'' ?? ????. ?? ''xml'', ''html'', ''text'' ?? qname-but-not-ncname ? ???? ???."	TokenNameStringLiteral	<xsl:output> ??? ??? ??? ''{0}'' ?? ????. ?? ''xml'', ''html'', ''text'' ?? qname-but-not-ncname ? ???? ???.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ErrorMsg	TokenNameIdentifier	 Error Msg
