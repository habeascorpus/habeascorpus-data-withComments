...
/* * $Id: ErrorMessages_ca.java 468652 2006-10-28 07:05:17Z minchau $ */	TokenNameCOMMENT_BLOCK	 $Id: ErrorMessages_ca.java 468652 2006-10-28 07:05:17Z minchau $ 
...
ErrorMessages_ca	TokenNameIdentifier	 Error Messages ca
...
,	TokenNameCOMMA	
"S''ha produït un error intern de temps d''execució a ''{0}''"	TokenNameStringLiteral	S''ha produït un error intern de temps d''execució a ''{0}''
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
,	TokenNameCOMMA	
"Es produeix un error de temps d'execució en executar <xsl:copy>."	TokenNameStringLiteral	Es produeix un error de temps d'execució en executar <xsl:copy>.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
,	TokenNameCOMMA	
"Conversió no vàlida de ''{0}'' a ''{1}''."	TokenNameStringLiteral	Conversió no vàlida de ''{0}'' a ''{1}''.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
,	TokenNameCOMMA	
"XSLTC no dóna suport a la funció externa ''{0}''. "	TokenNameStringLiteral	XSLTC no dóna suport a la funció externa ''{0}''. 
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
,	TokenNameCOMMA	
"L'expressió d'igualtat conté un tipus d'argument desconegut."	TokenNameStringLiteral	L'expressió d'igualtat conté un tipus d'argument desconegut.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
,	TokenNameCOMMA	
"El tipus d''argument ''{0}'' a la crida de ''{1}'' no és vàlid "	TokenNameStringLiteral	El tipus d''argument ''{0}'' a la crida de ''{1}'' no és vàlid 
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
,	TokenNameCOMMA	
"S''ha intentat formatar el número ''{0}'' fent servir el patró ''{1}''."	TokenNameStringLiteral	S''ha intentat formatar el número ''{0}'' fent servir el patró ''{1}''.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
,	TokenNameCOMMA	
"No es pot clonar l''iterador ''{0}''."	TokenNameStringLiteral	No es pot clonar l''iterador ''{0}''.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
,	TokenNameCOMMA	
"No està suportat l''iterador de l''eix ''{0}''. "	TokenNameStringLiteral	No està suportat l''iterador de l''eix ''{0}''. 
}	TokenNameRBRACE	
,	TokenNameCOMMA	
/* * Note to translators: The following represents an internal error * situation in XSLTC. The processor attempted to create an iterator * for a particular axis (see definition above) that it does not * support. */	TokenNameCOMMENT_BLOCK	 Note to translators: The following represents an internal error situation in XSLTC. The processor attempted to create an iterator for a particular axis (see definition above) that it does not support. 
{	TokenNameLBRACE	
...
,	TokenNameCOMMA	
"No està suportat l''iterador de l''eix escrit ''{0}''. "	TokenNameStringLiteral	No està suportat l''iterador de l''eix escrit ''{0}''. 
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
,	TokenNameCOMMA	
"La declaració de l''espai de noms ''{0}''=''{1}'' es troba fora de l''element. "	TokenNameStringLiteral	La declaració de l''espai de noms ''{0}''=''{1}'' es troba fora de l''element. 
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
,	TokenNameCOMMA	
"L''espai de noms del prefix ''{0}'' no s''ha declarat. "	TokenNameStringLiteral	L''espai de noms del prefix ''{0}'' no s''ha declarat. 
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
,	TokenNameCOMMA	
"DOMAdapter s'ha creat mitjançant un tipus incorrecte de DOM d'origen."	TokenNameStringLiteral	DOMAdapter s'ha creat mitjançant un tipus incorrecte de DOM d'origen.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
,	TokenNameCOMMA	
"L'analitzador SAX que feu servir no gestiona esdeveniments de declaració de DTD."	TokenNameStringLiteral	L'analitzador SAX que feu servir no gestiona esdeveniments de declaració de DTD.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
,	TokenNameCOMMA	
"L'analitzador SAX que feu servir no dóna suport a espais de noms XML."	TokenNameStringLiteral	L'analitzador SAX que feu servir no dóna suport a espais de noms XML.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
,	TokenNameCOMMA	
"No s''ha pogut resoldre la referència d''URI ''{0}''."	TokenNameStringLiteral	No s''ha pogut resoldre la referència d''URI ''{0}''.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
,	TokenNameCOMMA	
"L''element XSL ''{0}'' no té suport "	TokenNameStringLiteral	L''element XSL ''{0}'' no té suport 
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
,	TokenNameCOMMA	
"No es reconeix l''extensió XSLTC ''{0}''"	TokenNameStringLiteral	No es reconeix l''extensió XSLTC ''{0}''
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
,	TokenNameCOMMA	
"La classe translet especificada, ''{0}'', es va crear fent servir una versió d''XSLTC més recent que la versió del temps d''execució d''XSLTC que ja s''està utilitzant. Heu de recompilar el full d''estil o fer servir una versió més recent d''XSLTC per executar aquesta classe translet."	TokenNameStringLiteral	La classe translet especificada, ''{0}'', es va crear fent servir una versió d''XSLTC més recent que la versió del temps d''execució d''XSLTC que ja s''està utilitzant. Heu de recompilar el full d''estil o fer servir una versió més recent d''XSLTC per executar aquesta classe translet.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
,	TokenNameCOMMA	
"Un atribut, que ha de tenir el valor QName, tenia el valor ''{0}''"	TokenNameStringLiteral	Un atribut, que ha de tenir el valor QName, tenia el valor ''{0}''
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
,	TokenNameCOMMA	
"Un atribut, que ha de tenir el valor NCName, tenia el valor ''{0}''"	TokenNameStringLiteral	Un atribut, que ha de tenir el valor NCName, tenia el valor ''{0}''
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
BasisLibrary	TokenNameIdentifier	 Basis Library
...
,	TokenNameCOMMA	
"L''ús de la funció d''extensió ''{0}'' no està permès, si la característica de procés segur s''ha establert en true."	TokenNameStringLiteral	L''ús de la funció d''extensió ''{0}'' no està permès, si la característica de procés segur s''ha establert en true.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
BasisLibrary	TokenNameIdentifier	 Basis Library
...
,	TokenNameCOMMA	
"L''ús de l''element d''extensió ''{0}'' no està permès, si la característica de procés segur s''ha establert en true."	TokenNameStringLiteral	L''ús de l''element d''extensió ''{0}'' no està permès, si la característica de procés segur s''ha establert en true.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
}	TokenNameRBRACE	
;	TokenNameSEMICOLON	
