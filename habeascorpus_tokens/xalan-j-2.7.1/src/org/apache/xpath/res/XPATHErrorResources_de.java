...
ER_CURRENT_NOT_ALLOWED_IN_MATCH	TokenNameIdentifier	 ER  CURRENT  NOT  ALLOWED  IN  MATCH
,	TokenNameCOMMA	
"Die Funktion current() ist in einem †bereinstimmungsmuster nicht zulŠssig!"	TokenNameStringLiteral	Die Funktion current() ist in einem †bereinstimmungsmuster nicht zulŠssig!
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_CURRENT_TAKES_NO_ARGS	TokenNameIdentifier	 ER  CURRENT  TAKES  NO  ARGS
,	TokenNameCOMMA	
"In der Funktion current() dŸrfen keine Argumente angegeben werden!"	TokenNameStringLiteral	In der Funktion current() dŸrfen keine Argumente angegeben werden!
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_DOCUMENT_REPLACED	TokenNameIdentifier	 ER  DOCUMENT  REPLACED
...
ER_CONTEXT_HAS_NO_OWNERDOC	TokenNameIdentifier	 ER  CONTEXT  HAS  NO  OWNERDOC
,	TokenNameCOMMA	
"Der Kontextknoten verfŸgt nicht Ÿber ein Eignerdokument!"	TokenNameStringLiteral	Der Kontextknoten verfŸgt nicht Ÿber ein Eignerdokument!
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_LOCALNAME_HAS_TOO_MANY_ARGS	TokenNameIdentifier	 ER  LOCALNAME  HAS  TOO  MANY  ARGS
...
ER_INCORRECT_ARG_LENGTH	TokenNameIdentifier	 ER  INCORRECT  ARG  LENGTH
,	TokenNameCOMMA	
"Die LŠnge des Arguments fŸr den Knotentest von processing-instruction() ist falsch!"	TokenNameStringLiteral	Die LŠnge des Arguments fŸr den Knotentest von processing-instruction() ist falsch!
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_CANT_CONVERT_TO_NUMBER	TokenNameIdentifier	 ER  CANT  CONVERT  TO  NUMBER
...
ER_EXTRA_ILLEGAL_TOKENS	TokenNameIdentifier	 ER  EXTRA  ILLEGAL  TOKENS
,	TokenNameCOMMA	
"ZusŠtzliche nicht zulŠssige Token: {0}"	TokenNameStringLiteral	ZusŠtzliche nicht zulŠssige Token: {0}
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_EXPECTED_DOUBLE_QUOTE	TokenNameIdentifier	 ER  EXPECTED  DOUBLE  QUOTE
,	TokenNameCOMMA	
"Falsche AnfŸhrungszeichen fŸr Literal... Doppelte AnfŸhrungszeichen wurden erwartet!"	TokenNameStringLiteral	Falsche AnfŸhrungszeichen fŸr Literal... Doppelte AnfŸhrungszeichen wurden erwartet!
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_EXPECTED_SINGLE_QUOTE	TokenNameIdentifier	 ER  EXPECTED  SINGLE  QUOTE
,	TokenNameCOMMA	
"Falsche AnfŸhrungszeichen fŸr Literal... Einfache AnfŸhrungszeichen wurden erwartet!"	TokenNameStringLiteral	Falsche AnfŸhrungszeichen fŸr Literal... Einfache AnfŸhrungszeichen wurden erwartet!
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_EMPTY_EXPRESSION	TokenNameIdentifier	 ER  EMPTY  EXPRESSION
...
ER_PREDICATE_ILLEGAL_SYNTAX	TokenNameIdentifier	 ER  PREDICATE  ILLEGAL  SYNTAX
,	TokenNameCOMMA	
"'..[predicate]' oder '.[predicate]' ist eine nicht zulŠssige Syntax. Verwenden Sie stattdessen 'self::node()[predicate]'."	TokenNameStringLiteral	'..[predicate]' oder '.[predicate]' ist eine nicht zulŠssige Syntax. Verwenden Sie stattdessen 'self::node()[predicate]'.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_ILLEGAL_AXIS_NAME	TokenNameIdentifier	 ER  ILLEGAL  AXIS  NAME
,	TokenNameCOMMA	
"Nicht zulŠssiger Achsenname: {0}"	TokenNameStringLiteral	Nicht zulŠssiger Achsenname: {0}
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_UNKNOWN_NODETYPE	TokenNameIdentifier	 ER  UNKNOWN  NODETYPE
...
ER_PATTERN_LITERAL_NEEDS_BE_QUOTED	TokenNameIdentifier	 ER  PATTERN  LITERAL  NEEDS  BE  QUOTED
,	TokenNameCOMMA	
"Musterliteral ({0}) muss in AnfŸhrungszeichen angegeben werden!"	TokenNameStringLiteral	Musterliteral ({0}) muss in AnfŸhrungszeichen angegeben werden!
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_COULDNOT_BE_FORMATTED_TO_NUMBER	TokenNameIdentifier	 ER  COULDNOT  BE  FORMATTED  TO  NUMBER
...
ER_ILLEGAL_VARIABLE_REFERENCE	TokenNameIdentifier	 ER  ILLEGAL  VARIABLE  REFERENCE
,	TokenNameCOMMA	
"Das fŸr die Variable angegebene Argument VariableReference befindet sich au§erhalb des Kontexts oder weist keine Definition auf! Name = {0}"	TokenNameStringLiteral	Das fŸr die Variable angegebene Argument VariableReference befindet sich au§erhalb des Kontexts oder weist keine Definition auf! Name = {0}
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_AXES_NOT_ALLOWED	TokenNameIdentifier	 ER  AXES  NOT  ALLOWED
,	TokenNameCOMMA	
"Nur die Achsen ''''child::'''' und ''''attribute::'''' sind in Suchmustern zulŠssig! Fehlerhafte Achsen = {0}"	TokenNameStringLiteral	Nur die Achsen ''''child::'''' und ''''attribute::'''' sind in Suchmustern zulŠssig! Fehlerhafte Achsen = {0}
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_KEY_HAS_TOO_MANY_ARGS	TokenNameIdentifier	 ER  KEY  HAS  TOO  MANY  ARGS
...
ER_UNSUPPORTED_ENCODING	TokenNameIdentifier	 ER  UNSUPPORTED  ENCODING
,	TokenNameCOMMA	
"Nicht unterstŸtzte VerschlŸsselung: {0}"	TokenNameStringLiteral	Nicht unterstŸtzte VerschlŸsselung: {0}
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_PROBLEM_IN_DTM_NEXTSIBLING	TokenNameIdentifier	 ER  PROBLEM  IN  DTM  NEXTSIBLING
,	TokenNameCOMMA	
"In dem DTM in getNextSibling ist ein Fehler aufgetreten... Wiederherstellung wird durchgefŸhrt"	TokenNameStringLiteral	In dem DTM in getNextSibling ist ein Fehler aufgetreten... Wiederherstellung wird durchgefŸhrt
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_CANNOT_WRITE_TO_EMPTYNODELISTIMPL	TokenNameIdentifier	 ER  CANNOT  WRITE  TO  EMPTYNODELISTIMPL
...
ER_SETDOMFACTORY_NOT_SUPPORTED	TokenNameIdentifier	 ER  SETDOMFACTORY  NOT  SUPPORTED
,	TokenNameCOMMA	
"setDOMFactory wird nicht von XPathContext unterstŸtzt!"	TokenNameStringLiteral	setDOMFactory wird nicht von XPathContext unterstŸtzt!
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_PREFIX_MUST_RESOLVE	TokenNameIdentifier	 ER  PREFIX  MUST  RESOLVE
,	TokenNameCOMMA	
"Das PrŠfix muss in einen Namensbereich aufgelšst werden: {0}"	TokenNameStringLiteral	Das PrŠfix muss in einen Namensbereich aufgelšst werden: {0}
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_PARSE_NOT_SUPPORTED	TokenNameIdentifier	 ER  PARSE  NOT  SUPPORTED
,	TokenNameCOMMA	
"parse (InputSource Quelle) wird nicht in XPathContext unterstŸtzt! {0} kann nicht gešffnet werden."	TokenNameStringLiteral	parse (InputSource Quelle) wird nicht in XPathContext unterstŸtzt! {0} kann nicht gešffnet werden.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_SAX_API_NOT_HANDLED	TokenNameIdentifier	 ER  SAX  API  NOT  HANDLED
...
ER_INVALID_UTF16_SURROGATE	TokenNameIdentifier	 ER  INVALID  UT F16  SURROGATE
,	TokenNameCOMMA	
"UngŸltige UTF-16-Ersetzung festgestellt: {0} ?"	TokenNameStringLiteral	UngŸltige UTF-16-Ersetzung festgestellt: {0} ?
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_OIERROR	TokenNameIdentifier	 ER  OIERROR
...
ER_CANNOT_CREATE_URL	TokenNameIdentifier	 ER  CANNOT  CREATE  URL
,	TokenNameCOMMA	
"URL kann nicht erstellt werden fŸr: {0}"	TokenNameStringLiteral	URL kann nicht erstellt werden fŸr: {0}
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_XPATH_READOBJECT	TokenNameIdentifier	 ER  XPATH  READOBJECT
...
ER_NODESET_NOT_MUTABLE	TokenNameIdentifier	 ER  NODESET  NOT  MUTABLE
,	TokenNameCOMMA	
"Diese NodeSet kann nicht geŠndert werden"	TokenNameStringLiteral	Diese NodeSet kann nicht geŠndert werden
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_NODESETDTM_NOT_MUTABLE	TokenNameIdentifier	 ER  NODESETDTM  NOT  MUTABLE
,	TokenNameCOMMA	
"Dieses NodeSetDTM kann nicht geŠndert werden"	TokenNameStringLiteral	Dieses NodeSetDTM kann nicht geŠndert werden
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_VAR_NOT_RESOLVABLE	TokenNameIdentifier	 ER  VAR  NOT  RESOLVABLE
,	TokenNameCOMMA	
"Die Variable kann nicht aufgelšst werden: {0}"	TokenNameStringLiteral	Die Variable kann nicht aufgelšst werden: {0}
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_NULL_ERROR_HANDLER	TokenNameIdentifier	 ER  NULL  ERROR  HANDLER
...
ER_RTF_NOT_SUPPORTED_XRTREEFRAGSELECTWRAPPER	TokenNameIdentifier	 ER  RTF  NOT  SUPPORTED  XRTREEFRAGSELECTWRAPPER
,	TokenNameCOMMA	
"rtf() wird nicht von XRTreeFragSelectWrapper unterstŸtzt"	TokenNameStringLiteral	rtf() wird nicht von XRTreeFragSelectWrapper unterstŸtzt
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_RTF_NOT_SUPPORTED_XRTREEFRAGSELECTWRAPPER	TokenNameIdentifier	 ER  RTF  NOT  SUPPORTED  XRTREEFRAGSELECTWRAPPER
,	TokenNameCOMMA	
"asNodeIterator() wird nicht von XRTreeFragSelectWrapper unterstŸtzt"	TokenNameStringLiteral	asNodeIterator() wird nicht von XRTreeFragSelectWrapper unterstŸtzt
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_DETACH_NOT_SUPPORTED_XRTREEFRAGSELECTWRAPPER	TokenNameIdentifier	 ER  DETACH  NOT  SUPPORTED  XRTREEFRAGSELECTWRAPPER
,	TokenNameCOMMA	
"detach() wird nicht von XRTreeFragSelectWrapper unterstŸtzt"	TokenNameStringLiteral	detach() wird nicht von XRTreeFragSelectWrapper unterstŸtzt
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_NUM_NOT_SUPPORTED_XRTREEFRAGSELECTWRAPPER	TokenNameIdentifier	 ER  NUM  NOT  SUPPORTED  XRTREEFRAGSELECTWRAPPER
,	TokenNameCOMMA	
"num() wird nicht von XRTreeFragSelectWrapper unterstŸtzt"	TokenNameStringLiteral	num() wird nicht von XRTreeFragSelectWrapper unterstŸtzt
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_XSTR_NOT_SUPPORTED_XRTREEFRAGSELECTWRAPPER	TokenNameIdentifier	 ER  XSTR  NOT  SUPPORTED  XRTREEFRAGSELECTWRAPPER
,	TokenNameCOMMA	
"xstr() wird nicht von XRTreeFragSelectWrapper unterstŸtzt"	TokenNameStringLiteral	xstr() wird nicht von XRTreeFragSelectWrapper unterstŸtzt
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_STR_NOT_SUPPORTED_XRTREEFRAGSELECTWRAPPER	TokenNameIdentifier	 ER  STR  NOT  SUPPORTED  XRTREEFRAGSELECTWRAPPER
,	TokenNameCOMMA	
"str() wird nicht von XRTreeFragSelectWrapper unterstŸtzt"	TokenNameStringLiteral	str() wird nicht von XRTreeFragSelectWrapper unterstŸtzt
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_FSB_NOT_SUPPORTED_XSTRINGFORCHARS	TokenNameIdentifier	 ER  FSB  NOT  SUPPORTED  XSTRINGFORCHARS
,	TokenNameCOMMA	
"fsb() wird nicht fŸr XStringForChars unterstŸtzt"	TokenNameStringLiteral	fsb() wird nicht fŸr XStringForChars unterstŸtzt
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_COULD_NOT_FIND_VAR	TokenNameIdentifier	 ER  COULD  NOT  FIND  VAR
...
ER_NODESETDTM_CANNOT_INDEX	TokenNameIdentifier	 ER  NODESETDTM  CANNOT  INDEX
,	TokenNameCOMMA	
"Dieses NodeSetDTM kann keine Indexierungs- oder ZŠhlfunktionen ausfŸhren!"	TokenNameStringLiteral	Dieses NodeSetDTM kann keine Indexierungs- oder ZŠhlfunktionen ausfŸhren!
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_NODESET_CANNOT_INDEX	TokenNameIdentifier	 ER  NODESET  CANNOT  INDEX
,	TokenNameCOMMA	
"Diese NodeSet kann keine Indexierungs- oder ZŠhlfunktionen ausfŸhren!"	TokenNameStringLiteral	Diese NodeSet kann keine Indexierungs- oder ZŠhlfunktionen ausfŸhren!
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_CANNOT_CALL_SETSHOULDCACHENODE	TokenNameIdentifier	 ER  CANNOT  CALL  SETSHOULDCACHENODE
...
ER_CANT_GET_SNAPSHOT_LENGTH	TokenNameIdentifier	 ER  CANT  GET  SNAPSHOT  LENGTH
,	TokenNameCOMMA	
"Die Methode getSnapshotLength kann nicht Ÿber XPathResult des XPath-Ausdrucks ''{0}'' aufgerufen werden, da der zugehšrige XPathResultType {1} ist. Diese Methode gilt nur fŸr die Typen UNORDERED_NODE_SNAPSHOT_TYPE und ORDERED_NODE_SNAPSHOT_TYPE."	TokenNameStringLiteral	Die Methode getSnapshotLength kann nicht Ÿber XPathResult des XPath-Ausdrucks ''{0}'' aufgerufen werden, da der zugehšrige XPathResultType {1} ist. Diese Methode gilt nur fŸr die Typen UNORDERED_NODE_SNAPSHOT_TYPE und ORDERED_NODE_SNAPSHOT_TYPE.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_NON_ITERATOR_TYPE	TokenNameIdentifier	 ER  NON  ITERATOR  TYPE
,	TokenNameCOMMA	
"Die Methode iterateNext kann nicht Ÿber XPathResult des XPath-Ausdrucks ''{0}'' aufgerufen werden, da der zugehšrige XPathResultType {1} ist. Diese Methode gilt nur fŸr die Typen UNORDERED_NODE_ITERATOR_TYPE und ORDERED_NODE_ITERATOR_TYPE."	TokenNameStringLiteral	Die Methode iterateNext kann nicht Ÿber XPathResult des XPath-Ausdrucks ''{0}'' aufgerufen werden, da der zugehšrige XPathResultType {1} ist. Diese Methode gilt nur fŸr die Typen UNORDERED_NODE_ITERATOR_TYPE und ORDERED_NODE_ITERATOR_TYPE.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
ER_DOC_MUTATED	TokenNameIdentifier	 ER  DOC  MUTATED
,	TokenNameCOMMA	
"Seit der RŸckgabe des Ergebnisses wurde das Dokument geŠndert. Der Iterator ist ungŸltig."	TokenNameStringLiteral	Seit der RŸckgabe des Ergebnisses wurde das Dokument geŠndert. Der Iterator ist ungŸltig.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_INVALID_XPATH_TYPE	TokenNameIdentifier	 ER  INVALID  XPATH  TYPE
,	TokenNameCOMMA	
"UngŸltiges XPath-Typenargument: {0}"	TokenNameStringLiteral	UngŸltiges XPath-Typenargument: {0}
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_EMPTY_XPATH_RESULT	TokenNameIdentifier	 ER  EMPTY  XPATH  RESULT
...
ER_NULL_RESOLVER	TokenNameIdentifier	 ER  NULL  RESOLVER
,	TokenNameCOMMA	
"Das PrŠfix kann nicht mit einer Auflšsungsfunktion fŸr NullprŠfixe aufgelšst werden."	TokenNameStringLiteral	Das PrŠfix kann nicht mit einer Auflšsungsfunktion fŸr NullprŠfixe aufgelšst werden.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
// Note to translators: The substitution text is the name of a data type. The 	TokenNameCOMMENT_LINE	Note to translators: The substitution text is the name of a data type. The 
// message indicates that a value of a particular type could not be converted 	TokenNameCOMMENT_LINE	message indicates that a value of a particular type could not be converted 
...
ER_NON_SNAPSHOT_TYPE	TokenNameIdentifier	 ER  NON  SNAPSHOT  TYPE
,	TokenNameCOMMA	
"Die Methode snapshotItem kann nicht Ÿber XPathResult des XPath-Ausdrucks ''{0}'' aufgerufen werden, da der zugehšrige XPathResultType {1} ist. Diese Methode gilt nur fŸr die Typen UNORDERED_NODE_SNAPSHOT_TYPE und ORDERED_NODE_SNAPSHOT_TYPE."	TokenNameStringLiteral	Die Methode snapshotItem kann nicht Ÿber XPathResult des XPath-Ausdrucks ''{0}'' aufgerufen werden, da der zugehšrige XPathResultType {1} ist. Diese Methode gilt nur fŸr die Typen UNORDERED_NODE_SNAPSHOT_TYPE und ORDERED_NODE_SNAPSHOT_TYPE.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
ER_WRONG_DOCUMENT	TokenNameIdentifier	 ER  WRONG  DOCUMENT
,	TokenNameCOMMA	
"Kontextknoten gehšrt nicht zu dem Dokument, das an diesen XPathEvaluator gebunden ist."	TokenNameStringLiteral	Kontextknoten gehšrt nicht zu dem Dokument, das an diesen XPathEvaluator gebunden ist.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
ER_WRONG_NODETYPE	TokenNameIdentifier	 ER  WRONG  NODETYPE
,	TokenNameCOMMA	
"Der Kontextknotentyp wird nicht unterstŸtzt."	TokenNameStringLiteral	Der Kontextknotentyp wird nicht unterstŸtzt.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_XPATH_ERROR	TokenNameIdentifier	 ER  XPATH  ERROR
...
ER_EXTENSION_FUNCTION_CANNOT_BE_INVOKED	TokenNameIdentifier	 ER  EXTENSION  FUNCTION  CANNOT  BE  INVOKED
,	TokenNameCOMMA	
"Erweiterungsfunktion: ''{0}'' kann nicht aufgerufen werden, wenn fŸr XMLConstants.FEATURE_SECURE_PROCESSING die Einstellung ''True'' festgelegt wurde."	TokenNameStringLiteral	Erweiterungsfunktion: ''{0}'' kann nicht aufgerufen werden, wenn fŸr XMLConstants.FEATURE_SECURE_PROCESSING die Einstellung ''True'' festgelegt wurde.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
ER_RESOLVE_VARIABLE_RETURNS_NULL	TokenNameIdentifier	 ER  RESOLVE  VARIABLE  RETURNS  NULL
,	TokenNameCOMMA	
"resolveVariable fŸr die Variable {0} gibt den Wert Null zurŸck"	TokenNameStringLiteral	resolveVariable fŸr die Variable {0} gibt den Wert Null zurŸck
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
ER_UNSUPPORTED_RETURN_TYPE	TokenNameIdentifier	 ER  UNSUPPORTED  RETURN  TYPE
,	TokenNameCOMMA	
"Nicht unterstŸtzter RŸckgabetyp: {0}"	TokenNameStringLiteral	Nicht unterstŸtzter RŸckgabetyp: {0}
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
ER_SOURCE_RETURN_TYPE_CANNOT_BE_NULL	TokenNameIdentifier	 ER  SOURCE  RETURN  TYPE  CANNOT  BE  NULL
,	TokenNameCOMMA	
"Quellen- und/oder RŸckgabetyp dŸrfen nicht null sein"	TokenNameStringLiteral	Quellen- und/oder RŸckgabetyp dŸrfen nicht null sein
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
WG_LOCALE_NAME_NOT_HANDLED	TokenNameIdentifier	 WG  LOCALE  NAME  NOT  HANDLED
,	TokenNameCOMMA	
"Der Name der LŠndereinstellung in der Funktion format-number wurde bisher nicht verarbeitet!"	TokenNameStringLiteral	Der Name der LŠndereinstellung in der Funktion format-number wurde bisher nicht verarbeitet!
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
WG_PROPERTY_NOT_SUPPORTED	TokenNameIdentifier	 WG  PROPERTY  NOT  SUPPORTED
,	TokenNameCOMMA	
"XSL-Merkmal wird nicht unterstŸtzt: {0}"	TokenNameStringLiteral	XSL-Merkmal wird nicht unterstŸtzt: {0}
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
WG_DONT_DO_ANYTHING_WITH_NS	TokenNameIdentifier	 WG  DONT  DO  ANYTHING  WITH  NS
,	TokenNameCOMMA	
"FŸhren Sie derzeit keine VorgŠnge mit dem Namensbereich {0} in folgendem Merkmal durch: {1}"	TokenNameStringLiteral	FŸhren Sie derzeit keine VorgŠnge mit dem Namensbereich {0} in folgendem Merkmal durch: {1}
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
WG_SECURITY_EXCEPTION	TokenNameIdentifier	 WG  SECURITY  EXCEPTION
...
WG_NEED_DERIVED_OBJECT_TO_IMPLEMENT_NODETEST	TokenNameIdentifier	 WG  NEED  DERIVED  OBJECT  TO  IMPLEMENT  NODETEST
,	TokenNameCOMMA	
"XPath benštigt fŸr die Implementierung von nodeTest ein abgeleitetes Objekt!"	TokenNameStringLiteral	XPath benštigt fŸr die Implementierung von nodeTest ein abgeleitetes Objekt!
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
WG_FUNCTION_TOKEN_NOT_FOUND	TokenNameIdentifier	 WG  FUNCTION  TOKEN  NOT  FOUND
...
WG_EXPAND_ENTITIES_NOT_SUPPORTED	TokenNameIdentifier	 WG  EXPAND  ENTITIES  NOT  SUPPORTED
,	TokenNameCOMMA	
"Option -E wird fŸr DTM-Parser nicht unterstŸtzt"	TokenNameStringLiteral	Option -E wird fŸr DTM-Parser nicht unterstŸtzt
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
WG_ILLEGAL_VARIABLE_REFERENCE	TokenNameIdentifier	 WG  ILLEGAL  VARIABLE  REFERENCE
...
,	TokenNameCOMMA	
"Der Parameter fŸr createMessage lag au§erhalb des gŸltigen Bereichs"	TokenNameStringLiteral	Der Parameter fŸr createMessage lag au§erhalb des gŸltigen Bereichs
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
"FORMAT_FAILED"	TokenNameStringLiteral	FORMAT_FAILED
,	TokenNameCOMMA	
"WŠhrend des Aufrufs von messageFormat wurde eine Ausnahmebedingung ausgelšst"	TokenNameStringLiteral	WŠhrend des Aufrufs von messageFormat wurde eine Ausnahmebedingung ausgelšst
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
...
,	TokenNameCOMMA	
"[-match †bereinstimmungsmuster (fŸr †bereinstimmungsdiagnose)]"	TokenNameStringLiteral	[-match †bereinstimmungsmuster (fŸr †bereinstimmungsdiagnose)]
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
...
,	TokenNameCOMMA	
"XSL-Prozess konnte nicht erfolgreich durchgefŸhrt werden."	TokenNameStringLiteral	XSL-Prozess konnte nicht erfolgreich durchgefŸhrt werden.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
...
,	TokenNameCOMMA	
"Bitte ŸberprŸfen Sie den Klassenpfad."	TokenNameStringLiteral	Bitte ŸberprŸfen Sie den Klassenpfad.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
"noParsermsg4"	TokenNameStringLiteral	noParsermsg4
,	TokenNameCOMMA	
"Wenn Sie nicht Ÿber einen IBM XML-Parser fŸr Java verfŸgen, kšnnen Sie ihn Ÿber"	TokenNameStringLiteral	Wenn Sie nicht Ÿber einen IBM XML-Parser fŸr Java verfŸgen, kšnnen Sie ihn Ÿber
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
