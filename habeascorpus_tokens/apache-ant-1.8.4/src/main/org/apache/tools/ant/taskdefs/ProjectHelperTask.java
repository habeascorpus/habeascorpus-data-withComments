...
;	TokenNameSEMICOLON	
/** * Task to install project helper into Ant's runtime * * @since Ant 1.8.2 */	TokenNameCOMMENT_JAVADOC	 Task to install project helper into Ant's runtime * @since Ant 1.8.2 
public	TokenNamepublic	
class	TokenNameclass	
ProjectHelperTask	TokenNameIdentifier	 Project Helper Task
extends	TokenNameextends	
Task	TokenNameIdentifier	 Task
{	TokenNameLBRACE	
private	TokenNameprivate	
List	TokenNameIdentifier	 List
projectHelpers	TokenNameIdentifier	 project Helpers
=	TokenNameEQUAL	
new	TokenNamenew	
ArrayList	TokenNameIdentifier	 Array List
(	TokenNameLPAREN	
