...
swing	TokenNameIdentifier	 swing
.	TokenNameDOT	
ListCellRenderer	TokenNameIdentifier	 List Cell Renderer
;	TokenNameSEMICOLON	
import	TokenNameimport	
edu	TokenNameIdentifier	 edu
.	TokenNameDOT	
...
;	TokenNameSEMICOLON	
/** * @author Edoardo Airoldi * Date: Jul 19, 2004 */	TokenNameCOMMENT_JAVADOC	 @author Edoardo Airoldi Date: Jul 19, 2004 
...
Instance	TokenNameIdentifier	 Instance
>	TokenNameGREATER	
unlabeledExamples	TokenNameIdentifier	 unlabeled Examples
=	TokenNameEQUAL	
new	TokenNamenew	
ArrayList	TokenNameIdentifier	 Array List
<	TokenNameLESS	
...
// methods for semi-supervised data, part of the SemiSupervisedDataset interface 	TokenNameCOMMENT_LINE	methods for semi-supervised data, part of the SemiSupervisedDataset interface 
// 	TokenNameCOMMENT_LINE	 
@	TokenNameAT	
Override	TokenNameIdentifier	 Override
public	TokenNamepublic	
...
//public ArrayList getUnlabeled() { return this.unlabeledExamples; } 	TokenNameCOMMENT_LINE	public ArrayList getUnlabeled() { return this.unlabeledExamples; } 
@	TokenNameAT	
Override	TokenNameIdentifier	 Override
public	TokenNamepublic	
int	TokenNameint	
...
// 	TokenNameCOMMENT_LINE	 
// methods for labeled data, part of the Dataset interface 	TokenNameCOMMENT_LINE	methods for labeled data, part of the Dataset interface 
// 	TokenNameCOMMENT_LINE	 
/** * Add an example to the dataset. <br> * <br> * This method compresses the example before adding it to the dataset. If * you don't want/need the example to be compressed then call {@link #add(Example, boolean)} * * @param example The Example that you want to add to the dataset. */	TokenNameCOMMENT_JAVADOC	 Add an example to the dataset. <br> <br> This method compresses the example before adding it to the dataset. If you don't want/need the example to be compressed then call {@link #add(Example, boolean)} * @param example The Example that you want to add to the dataset. 
@	TokenNameAT	
Override	TokenNameIdentifier	 Override
public	TokenNamepublic	
void	TokenNamevoid	
...
// 	TokenNameCOMMENT_LINE	 
// Implement Saveable interface. 	TokenNameCOMMENT_LINE	Implement Saveable interface. 
// 	TokenNameCOMMENT_LINE	 
static	TokenNamestatic	
private	TokenNameprivate	
final	TokenNamefinal	
String	TokenNameIdentifier	 String
FORMAT_NAME	TokenNameIdentifier	 FORMAT  NAME
=	TokenNameEQUAL	
"Minorthird Dataset"	TokenNameStringLiteral	Minorthird Dataset
;	TokenNameSEMICOLON	
@	TokenNameAT	
Override	TokenNameIdentifier	 Override
public	TokenNamepublic	
...
(	TokenNameLPAREN	
"error loading from "	TokenNameStringLiteral	error loading from 
+	TokenNamePLUS	
file	TokenNameIdentifier	 file
+	TokenNamePLUS	
...
/** A string view of the dataset */	TokenNameCOMMENT_JAVADOC	 A string view of the dataset 
@	TokenNameAT	
Override	TokenNameIdentifier	 Override
public	TokenNamepublic	
String	TokenNameIdentifier	 String
...
public	TokenNamepublic	
Component	TokenNameIdentifier	 Component
getListCellRendererComponent	TokenNameIdentifier	 get List Cell Renderer Component
(	TokenNameLPAREN	
JList	TokenNameIdentifier	 J List
...
// 	TokenNameCOMMENT_LINE	 
// splitter 	TokenNameCOMMENT_LINE	splitter 
// 	TokenNameCOMMENT_LINE	 
@	TokenNameAT	
Override	TokenNameIdentifier	 Override
public	TokenNamepublic	
...
ViewerFrame	TokenNameIdentifier	 Viewer Frame
(	TokenNameLPAREN	
"Toy Dataset"	TokenNameStringLiteral	Toy Dataset
,	TokenNameCOMMA	
data	TokenNameIdentifier	 data
.	TokenNameDOT	
toGUI	TokenNameIdentifier	 to GUI
