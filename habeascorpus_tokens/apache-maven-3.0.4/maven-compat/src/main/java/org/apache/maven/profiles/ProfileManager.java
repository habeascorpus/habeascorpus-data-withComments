...
;	TokenNameSEMICOLON	
void	TokenNamevoid	
addProfiles	TokenNameIdentifier	 add Profiles
(	TokenNameLPAREN	
List	TokenNameIdentifier	 List
profiles	TokenNameIdentifier	 profiles
)	TokenNameRPAREN	
;	TokenNameSEMICOLON	
Map	TokenNameIdentifier	 Map
getProfilesById	TokenNameIdentifier	 get Profiles By Id
(	TokenNameLPAREN	
)	TokenNameRPAREN	
;	TokenNameSEMICOLON	
List	TokenNameIdentifier	 List
getExplicitlyActivatedIds	TokenNameIdentifier	 get Explicitly Activated Ids
(	TokenNameLPAREN	
)	TokenNameRPAREN	
;	TokenNameSEMICOLON	
List	TokenNameIdentifier	 List
getExplicitlyDeactivatedIds	TokenNameIdentifier	 get Explicitly Deactivated Ids
(	TokenNameLPAREN	
)	TokenNameRPAREN	
;	TokenNameSEMICOLON	
List	TokenNameIdentifier	 List
getIdsActivatedByDefault	TokenNameIdentifier	 get Ids Activated By Default
(	TokenNameLPAREN	
)	TokenNameRPAREN	
;	TokenNameSEMICOLON	
Properties	TokenNameIdentifier	 Properties
getRequestProperties	TokenNameIdentifier	 get Request Properties
(	TokenNameLPAREN	
)	TokenNameRPAREN	
;	TokenNameSEMICOLON	
}	TokenNameRBRACE	
