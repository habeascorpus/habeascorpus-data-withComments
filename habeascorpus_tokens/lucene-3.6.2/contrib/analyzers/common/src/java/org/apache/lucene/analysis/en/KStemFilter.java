...
/** Returns the next, stemmed, input Token. * @return The stemed form of a token. * @throws IOException */	TokenNameCOMMENT_JAVADOC	 Returns the next, stemmed, input Token. @return The stemed form of a token. @throws IOException 
@	TokenNameAT	
