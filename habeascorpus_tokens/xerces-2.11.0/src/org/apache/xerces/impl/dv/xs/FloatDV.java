...
.	TokenNameDOT	
XSFloat	TokenNameIdentifier	 XS Float
;	TokenNameSEMICOLON	
/** * Represent the schema type "float" * * @xerces.internal * * @author Neeraj Bajaj, Sun Microsystems, inc. * @author Sandy Gao, IBM * * @version $Id: FloatDV.java 572095 2007-09-02 18:32:43Z mrglavas $ */	TokenNameCOMMENT_JAVADOC	 Represent the schema type "float" * @xerces.internal * @author Neeraj Bajaj, Sun Microsystems, inc. @author Sandy Gao, IBM * @version $Id: FloatDV.java 572095 2007-09-02 18:32:43Z mrglavas $ 
...
//convert a String to Float form, we have to take care of cases specified in spec like INF, -INF and NaN 	TokenNameCOMMENT_LINE	convert a String to Float form, we have to take care of cases specified in spec like INF, -INF and NaN 
public	TokenNamepublic	
...
return	TokenNamereturn	
new	TokenNamenew	
XFloat	TokenNameIdentifier	 X Float
(	TokenNameLPAREN	
content	TokenNameIdentifier	 content
)	TokenNameRPAREN	
;	TokenNameSEMICOLON	
...
// Can't call Float#compareTo method, because it's introduced in jdk 1.2 	TokenNameCOMMENT_LINE	Can't call Float#compareTo method, because it's introduced in jdk 1.2 
public	TokenNamepublic	
int	TokenNameint	
...
//distinguishes between identity and equality for float datatype 	TokenNameCOMMENT_LINE	distinguishes between identity and equality for float datatype 
...
{	TokenNameLBRACE	
// This check is necessary because floatToIntBits(+0) != floatToIntBits(-0) 	TokenNameCOMMENT_LINE	This check is necessary because floatToIntBits(+0) != floatToIntBits(-0) 
return	TokenNamereturn	
(	TokenNameLPAREN	
value	TokenNameIdentifier	 value
==	TokenNameEQUAL_EQUAL	
...
// don't know what to output for 1.1f (which is no 	TokenNameCOMMENT_LINE	don't know what to output for 1.1f (which is no 
...
// class FloatDV 	TokenNameCOMMENT_LINE	class FloatDV 
