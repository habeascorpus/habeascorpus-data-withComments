...
;	TokenNameSEMICOLON	
/** Manages multiple ArtifactTransformation instances and applies them in succession. */	TokenNameCOMMENT_JAVADOC	 Manages multiple ArtifactTransformation instances and applies them in succession. 
...
ArtifactInstallationException	TokenNameIdentifier	 Artifact Installation Exception
;	TokenNameSEMICOLON	
/** * Take in a artifact and return the transformed artifact for distributing to a remote repository. If no * transformation has occurred the original artifact is returned. * * @param artifact Artifact to be transformed. * @param remoteRepository the repository to deploy to * @param localRepository the local repository the metadata is stored in */	TokenNameCOMMENT_JAVADOC	 Take in a artifact and return the transformed artifact for distributing to a remote repository. If no transformation has occurred the original artifact is returned. * @param artifact Artifact to be transformed. @param remoteRepository the repository to deploy to @param localRepository the local repository the metadata is stored in 
void	TokenNamevoid	
