...
;	TokenNameSEMICOLON	
/** * This processor removes every {@link BooleanQueryNode} that contains only one * child and returns this child. If this child is {@link ModifierQueryNode} that * was defined by the user. A modifier is not defined by the user when it's a * {@link BooleanModifierNode} <br/> * * @see ModifierQueryNode */	TokenNameCOMMENT_JAVADOC	 This processor removes every {@link BooleanQueryNode} that contains only one child and returns this child. If this child is {@link ModifierQueryNode} that was defined by the user. A modifier is not defined by the user when it's a {@link BooleanModifierNode} <br/> * @see ModifierQueryNode 
...
{	TokenNameLBRACE	
ModifierQueryNode	TokenNameIdentifier	 Modifier Query Node
modNode	TokenNameIdentifier	 mod Node
=	TokenNameEQUAL	
(	TokenNameLPAREN	
ModifierQueryNode	TokenNameIdentifier	 Modifier Query Node
)	TokenNameRPAREN	
