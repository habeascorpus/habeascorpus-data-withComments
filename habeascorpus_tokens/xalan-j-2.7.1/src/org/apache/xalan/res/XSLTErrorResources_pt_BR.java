...
ER_NO_CURLYBRACE	TokenNameIdentifier	 ER  NO  CURLYBRACE
,	TokenNameCOMMA	
"Erro: Impossível ter '{' na expressão"	TokenNameStringLiteral	Erro: Impossível ter '{' na expressão
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_ILLEGAL_ATTRIBUTE	TokenNameIdentifier	 ER  ILLEGAL  ATTRIBUTE
,	TokenNameCOMMA	
"{0} possui um atributo inválido: {1}"	TokenNameStringLiteral	{0} possui um atributo inválido: {1}
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_NULL_SOURCENODE_APPLYIMPORTS	TokenNameIdentifier	 ER  NULL  SOURCENODE  APPLYIMPORTS
,	TokenNameCOMMA	
"sourceNode é nulo em xsl:apply-imports!"	TokenNameStringLiteral	sourceNode é nulo em xsl:apply-imports!
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_CANNOT_ADD	TokenNameIdentifier	 ER  CANNOT  ADD
,	TokenNameCOMMA	
"Impossível incluir {0} em {1}"	TokenNameStringLiteral	Impossível incluir {0} em {1}
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_NULL_SOURCENODE_HANDLEAPPLYTEMPLATES	TokenNameIdentifier	 ER  NULL  SOURCENODE  HANDLEAPPLYTEMPLATES
,	TokenNameCOMMA	
"sourceNode é nulo em handleApplyTemplatesInstruction!"	TokenNameStringLiteral	sourceNode é nulo em handleApplyTemplatesInstruction!
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_NO_NAME_ATTRIB	TokenNameIdentifier	 ER  NO  NAME  ATTRIB
...
ER_TEMPLATE_NOT_FOUND	TokenNameIdentifier	 ER  TEMPLATE  NOT  FOUND
,	TokenNameCOMMA	
"Não foi possível localizar o template: {0}"	TokenNameStringLiteral	Não foi possível localizar o template: {0}
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_CANT_RESOLVE_NAME_AVT	TokenNameIdentifier	 ER  CANT  RESOLVE  NAME  AVT
,	TokenNameCOMMA	
"Não foi possível resolver nome AVT em xsl:call-template."	TokenNameStringLiteral	Não foi possível resolver nome AVT em xsl:call-template.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_REQUIRES_ATTRIB	TokenNameIdentifier	 ER  REQUIRES  ATTRIB
...
ER_BAD_VAL_ON_LEVEL_ATTRIB	TokenNameIdentifier	 ER  BAD  VAL  ON  LEVEL  ATTRIB
,	TokenNameCOMMA	
"Valor inválido no atributo de nível: {0}"	TokenNameStringLiteral	Valor inválido no atributo de nível: {0}
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_PROCESSINGINSTRUCTION_NAME_CANT_BE_XML	TokenNameIdentifier	 ER  PROCESSINGINSTRUCTION  NAME  CANT  BE  XML
,	TokenNameCOMMA	
"O nome de processing-instruction não pode ser 'xml'"	TokenNameStringLiteral	O nome de processing-instruction não pode ser 'xml'
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_PROCESSINGINSTRUCTION_NOTVALID_NCNAME	TokenNameIdentifier	 ER  PROCESSINGINSTRUCTION  NOTVALID  NCNAME
,	TokenNameCOMMA	
"O nome de processing-instruction deve ser um NCName válido: {0}"	TokenNameStringLiteral	O nome de processing-instruction deve ser um NCName válido: {0}
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_NEED_MATCH_ATTRIB	TokenNameIdentifier	 ER  NEED  MATCH  ATTRIB
,	TokenNameCOMMA	
"{0} deve ter um atributo de correspondência se tiver um modo."	TokenNameStringLiteral	{0} deve ter um atributo de correspondência se tiver um modo.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_NEED_NAME_OR_MATCH_ATTRIB	TokenNameIdentifier	 ER  NEED  NAME  OR  MATCH  ATTRIB
,	TokenNameCOMMA	
"{0} requer um nome ou um atributo de correspondência."	TokenNameStringLiteral	{0} requer um nome ou um atributo de correspondência.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_CANT_RESOLVE_NSPREFIX	TokenNameIdentifier	 ER  CANT  RESOLVE  NSPREFIX
,	TokenNameCOMMA	
"Impossível resolver prefixo do espaço de nomes: {0}"	TokenNameStringLiteral	Impossível resolver prefixo do espaço de nomes: {0}
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_ILLEGAL_VALUE	TokenNameIdentifier	 ER  ILLEGAL  VALUE
,	TokenNameCOMMA	
"xml:space possui um valor inválido: {0}"	TokenNameStringLiteral	xml:space possui um valor inválido: {0}
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_NO_OWNERDOC	TokenNameIdentifier	 ER  NO  OWNERDOC
,	TokenNameCOMMA	
"O nó filho não possui um documento do proprietário!"	TokenNameStringLiteral	O nó filho não possui um documento do proprietário!
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_ELEMTEMPLATEELEM_ERR	TokenNameIdentifier	 ER  ELEMTEMPLATEELEM  ERR
...
ER_NO_CONTEXT_OWNERDOC	TokenNameIdentifier	 ER  NO  CONTEXT  OWNERDOC
,	TokenNameCOMMA	
"context não possui um documento do proprietário!"	TokenNameStringLiteral	context não possui um documento do proprietário!
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_COULD_NOT_CREATE_XML_PROC_LIAISON	TokenNameIdentifier	 ER  COULD  NOT  CREATE  XML  PROC  LIAISON
,	TokenNameCOMMA	
"Não foi possível criar XML TransformerFactory Liaison: {0}"	TokenNameStringLiteral	Não foi possível criar XML TransformerFactory Liaison: {0}
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_PROCESS_NOT_SUCCESSFUL	TokenNameIdentifier	 ER  PROCESS  NOT  SUCCESSFUL
,	TokenNameCOMMA	
"Xalan: O processo não foi bem-sucedido."	TokenNameStringLiteral	Xalan: O processo não foi bem-sucedido.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_NOT_SUCCESSFUL	TokenNameIdentifier	 ER  NOT  SUCCESSFUL
,	TokenNameCOMMA	
"Xalan: não foi bem-sucedido."	TokenNameStringLiteral	Xalan: não foi bem-sucedido.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_ENCODING_NOT_SUPPORTED	TokenNameIdentifier	 ER  ENCODING  NOT  SUPPORTED
,	TokenNameCOMMA	
"Codificação não suportada: {0}"	TokenNameStringLiteral	Codificação não suportada: {0}
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_COULD_NOT_CREATE_TRACELISTENER	TokenNameIdentifier	 ER  COULD  NOT  CREATE  TRACELISTENER
,	TokenNameCOMMA	
"Não foi possível criar TraceListener: {0}"	TokenNameStringLiteral	Não foi possível criar TraceListener: {0}
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_KEY_REQUIRES_NAME_ATTRIB	TokenNameIdentifier	 ER  KEY  REQUIRES  NAME  ATTRIB
...
ER_MISSING_PREFIX_ATTRIB	TokenNameIdentifier	 ER  MISSING  PREFIX  ATTRIB
,	TokenNameCOMMA	
"(StylesheetHandler) O atributo ''prefix'' de {0} está ausente"	TokenNameStringLiteral	(StylesheetHandler) O atributo ''prefix'' de {0} está ausente
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_BAD_STYLESHEET_URL	TokenNameIdentifier	 ER  BAD  STYLESHEET  URL
,	TokenNameCOMMA	
"A URL da página de estilo é inválida: {0}"	TokenNameStringLiteral	A URL da página de estilo é inválida: {0}
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_FILE_NOT_FOUND	TokenNameIdentifier	 ER  FILE  NOT  FOUND
,	TokenNameCOMMA	
"O arquivo da página de estilo não foi encontrado: {0}"	TokenNameStringLiteral	O arquivo da página de estilo não foi encontrado: {0}
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_IOEXCEPTION	TokenNameIdentifier	 ER  IOEXCEPTION
,	TokenNameCOMMA	
"Ocorreu uma Exceção de E/S (entrada/saída) no arquivo de página de estilo: {0}"	TokenNameStringLiteral	Ocorreu uma Exceção de E/S (entrada/saída) no arquivo de página de estilo: {0}
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_NO_HREF_ATTRIB	TokenNameIdentifier	 ER  NO  HREF  ATTRIB
,	TokenNameCOMMA	
"(StylesheetHandler) Não foi possível encontrar o atributo href para {0}"	TokenNameStringLiteral	(StylesheetHandler) Não foi possível encontrar o atributo href para {0}
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_STYLESHEET_INCLUDES_ITSELF	TokenNameIdentifier	 ER  STYLESHEET  INCLUDES  ITSELF
,	TokenNameCOMMA	
"(StylesheetHandler) {0} está incluindo a si mesmo, direta ou indiretamente!"	TokenNameStringLiteral	(StylesheetHandler) {0} está incluindo a si mesmo, direta ou indiretamente!
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_PROCESSINCLUDE_ERROR	TokenNameIdentifier	 ER  PROCESSINCLUDE  ERROR
...
ER_MISSING_LANG_ATTRIB	TokenNameIdentifier	 ER  MISSING  LANG  ATTRIB
,	TokenNameCOMMA	
"(StylesheetHandler) O atributo ''lang'' de {0} está ausente"	TokenNameStringLiteral	(StylesheetHandler) O atributo ''lang'' de {0} está ausente
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_MISSING_CONTAINER_ELEMENT_COMPONENT	TokenNameIdentifier	 ER  MISSING  CONTAINER  ELEMENT  COMPONENT
,	TokenNameCOMMA	
"(StylesheetHandler) Elemento {0} aplicado incorretamente?? O elemento de contêiner ''component'' está ausente "	TokenNameStringLiteral	(StylesheetHandler) Elemento {0} aplicado incorretamente?? O elemento de contêiner ''component'' está ausente 
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_CAN_ONLY_OUTPUT_TO_ELEMENT	TokenNameIdentifier	 ER  CAN  ONLY  OUTPUT  TO  ELEMENT
,	TokenNameCOMMA	
"A saída pode ser apenas para um Element, DocumentFragment, Document ou PrintWriter."	TokenNameStringLiteral	A saída pode ser apenas para um Element, DocumentFragment, Document ou PrintWriter.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_PROCESS_ERROR	TokenNameIdentifier	 ER  PROCESS  ERROR
...
ER_NO_SELECT_EXPRESSION	TokenNameIdentifier	 ER  NO  SELECT  EXPRESSION
,	TokenNameCOMMA	
"Erro! Não encontrada a expressão xpath select (-select)."	TokenNameStringLiteral	Erro! Não encontrada a expressão xpath select (-select).
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_CANNOT_SERIALIZE_XSLPROCESSOR	TokenNameIdentifier	 ER  CANNOT  SERIALIZE  XSLPROCESSOR
,	TokenNameCOMMA	
"Não é possível serializar um XSLProcessor!"	TokenNameStringLiteral	Não é possível serializar um XSLProcessor!
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_NO_INPUT_STYLESHEET	TokenNameIdentifier	 ER  NO  INPUT  STYLESHEET
,	TokenNameCOMMA	
"A entrada de folha de estilo não foi especificada!"	TokenNameStringLiteral	A entrada de folha de estilo não foi especificada!
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_FAILED_PROCESS_STYLESHEET	TokenNameIdentifier	 ER  FAILED  PROCESS  STYLESHEET
...
ER_COULDNT_PARSE_DOC	TokenNameIdentifier	 ER  COULDNT  PARSE  DOC
,	TokenNameCOMMA	
"Não foi possível analisar o documento {0}!"	TokenNameStringLiteral	Não foi possível analisar o documento {0}!
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_COULDNT_FIND_FRAGMENT	TokenNameIdentifier	 ER  COULDNT  FIND  FRAGMENT
,	TokenNameCOMMA	
"Não foi possível localizar o fragmento: {0}"	TokenNameStringLiteral	Não foi possível localizar o fragmento: {0}
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_NODE_NOT_ELEMENT	TokenNameIdentifier	 ER  NODE  NOT  ELEMENT
,	TokenNameCOMMA	
"O nó apontado por um identificador de fragmento não era um elemento: {0}"	TokenNameStringLiteral	O nó apontado por um identificador de fragmento não era um elemento: {0}
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_FOREACH_NEED_MATCH_OR_NAME_ATTRIB	TokenNameIdentifier	 ER  FOREACH  NEED  MATCH  OR  NAME  ATTRIB
...
ER_CANT_CREATE_ITEM	TokenNameIdentifier	 ER  CANT  CREATE  ITEM
,	TokenNameCOMMA	
"Impossível criar item na árvore de resultados: {0}"	TokenNameStringLiteral	Impossível criar item na árvore de resultados: {0}
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_XMLSPACE_ILLEGAL_VALUE	TokenNameIdentifier	 ER  XMLSPACE  ILLEGAL  VALUE
,	TokenNameCOMMA	
"xml:space no XML de origem possui um valor inválido: {0}"	TokenNameStringLiteral	xml:space no XML de origem possui um valor inválido: {0}
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_NO_XSLKEY_DECLARATION	TokenNameIdentifier	 ER  NO  XSLKEY  DECLARATION
,	TokenNameCOMMA	
"Não existe nenhuma declaração xsl:key para {0}!"	TokenNameStringLiteral	Não existe nenhuma declaração xsl:key para {0}!
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_CANT_CREATE_URL	TokenNameIdentifier	 ER  CANT  CREATE  URL
,	TokenNameCOMMA	
"Erro! Impossível criar url para: {0}"	TokenNameStringLiteral	Erro! Impossível criar url para: {0}
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_XSLFUNCTIONS_UNSUPPORTED	TokenNameIdentifier	 ER  XSLFUNCTIONS  UNSUPPORTED
,	TokenNameCOMMA	
"xsl:functions não é suportado"	TokenNameStringLiteral	xsl:functions não é suportado
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_PROCESSOR_ERROR	TokenNameIdentifier	 ER  PROCESSOR  ERROR
...
ER_NOT_ALLOWED_INSIDE_STYLESHEET	TokenNameIdentifier	 ER  NOT  ALLOWED  INSIDE  STYLESHEET
,	TokenNameCOMMA	
"(StylesheetHandler) {0} não permitido dentro de uma folha de estilo!"	TokenNameStringLiteral	(StylesheetHandler) {0} não permitido dentro de uma folha de estilo!
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_RESULTNS_NOT_SUPPORTED	TokenNameIdentifier	 ER  RESULTNS  NOT  SUPPORTED
,	TokenNameCOMMA	
"result-ns não é mais suportado! Utilize então xsl:output."	TokenNameStringLiteral	result-ns não é mais suportado! Utilize então xsl:output.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_DEFAULTSPACE_NOT_SUPPORTED	TokenNameIdentifier	 ER  DEFAULTSPACE  NOT  SUPPORTED
,	TokenNameCOMMA	
"default-space não é mais suportado! Utilize então xsl:strip-space ou xsl:preserve-space."	TokenNameStringLiteral	default-space não é mais suportado! Utilize então xsl:strip-space ou xsl:preserve-space.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_INDENTRESULT_NOT_SUPPORTED	TokenNameIdentifier	 ER  INDENTRESULT  NOT  SUPPORTED
,	TokenNameCOMMA	
"indent-result não é mais suportado! Utilize então xsl:output."	TokenNameStringLiteral	indent-result não é mais suportado! Utilize então xsl:output.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_ILLEGAL_ATTRIB	TokenNameIdentifier	 ER  ILLEGAL  ATTRIB
,	TokenNameCOMMA	
"(StylesheetHandler) {0} possui um atributo inválido: {1}"	TokenNameStringLiteral	(StylesheetHandler) {0} possui um atributo inválido: {1}
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_UNKNOWN_XSL_ELEM	TokenNameIdentifier	 ER  UNKNOWN  XSL  ELEM
...
ER_XSLWHEN_NOT_PARENTED_BY_XSLCHOOSE	TokenNameIdentifier	 ER  XSLWHEN  NOT  PARENTED  BY  XSLCHOOSE
,	TokenNameCOMMA	
"(StylesheetHandler) xsl:when não está ligado a xsl:choose!"	TokenNameStringLiteral	(StylesheetHandler) xsl:when não está ligado a xsl:choose!
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_MISPLACED_XSLOTHERWISE	TokenNameIdentifier	 ER  MISPLACED  XSLOTHERWISE
...
ER_XSLOTHERWISE_NOT_PARENTED_BY_XSLCHOOSE	TokenNameIdentifier	 ER  XSLOTHERWISE  NOT  PARENTED  BY  XSLCHOOSE
,	TokenNameCOMMA	
"(StylesheetHandler) xsl:otherwise não está ligado a xsl:choose!"	TokenNameStringLiteral	(StylesheetHandler) xsl:otherwise não está ligado a xsl:choose!
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_NOT_ALLOWED_INSIDE_TEMPLATE	TokenNameIdentifier	 ER  NOT  ALLOWED  INSIDE  TEMPLATE
,	TokenNameCOMMA	
"(StylesheetHandler) {0} não é permitido dentro de um template!"	TokenNameStringLiteral	(StylesheetHandler) {0} não é permitido dentro de um template!
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_UNKNOWN_EXT_NS_PREFIX	TokenNameIdentifier	 ER  UNKNOWN  EXT  NS  PREFIX
,	TokenNameCOMMA	
"(StylesheetHandler) o espaço de nomes de extensão {0} possui prefixo {1} desconhecido"	TokenNameStringLiteral	(StylesheetHandler) o espaço de nomes de extensão {0} possui prefixo {1} desconhecido
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_IMPORTS_AS_FIRST_ELEM	TokenNameIdentifier	 ER  IMPORTS  AS  FIRST  ELEM
,	TokenNameCOMMA	
"(StylesheetHandler) Importações só podem ocorrer como os primeiros elementos na folha de estilo!"	TokenNameStringLiteral	(StylesheetHandler) Importações só podem ocorrer como os primeiros elementos na folha de estilo!
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_IMPORTING_ITSELF	TokenNameIdentifier	 ER  IMPORTING  ITSELF
,	TokenNameCOMMA	
"(StylesheetHandler) {0} está importando a si mesmo, direta ou indiretamente!"	TokenNameStringLiteral	(StylesheetHandler) {0} está importando a si mesmo, direta ou indiretamente!
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_XMLSPACE_ILLEGAL_VAL	TokenNameIdentifier	 ER  XMLSPACE  ILLEGAL  VAL
,	TokenNameCOMMA	
"(StylesheetHandler) xml:space tem um valor inválido: {0}"	TokenNameStringLiteral	(StylesheetHandler) xml:space tem um valor inválido: {0}
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_PROCESSSTYLESHEET_NOT_SUCCESSFUL	TokenNameIdentifier	 ER  PROCESSSTYLESHEET  NOT  SUCCESSFUL
,	TokenNameCOMMA	
"processStylesheet não obteve êxito!"	TokenNameStringLiteral	processStylesheet não obteve êxito!
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_SAX_EXCEPTION	TokenNameIdentifier	 ER  SAX  EXCEPTION
,	TokenNameCOMMA	
"Exceção de SAX"	TokenNameStringLiteral	Exceção de SAX
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
ER_CURRENCY_SIGN_ILLEGAL	TokenNameIdentifier	 ER  CURRENCY  SIGN  ILLEGAL
,	TokenNameCOMMA	
"O sinal monetário não é permitido na cadeia de padrões de formato"	TokenNameStringLiteral	O sinal monetário não é permitido na cadeia de padrões de formato
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_DOCUMENT_FUNCTION_INVALID_IN_STYLESHEET_DOM	TokenNameIdentifier	 ER  DOCUMENT  FUNCTION  INVALID  IN  STYLESHEET  DOM
,	TokenNameCOMMA	
"Função Document não suportada no DOM da Folha de Estilo!"	TokenNameStringLiteral	Função Document não suportada no DOM da Folha de Estilo!
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_CANT_RESOLVE_PREFIX_OF_NON_PREFIX_RESOLVER	TokenNameIdentifier	 ER  CANT  RESOLVE  PREFIX  OF  NON  PREFIX  RESOLVER
,	TokenNameCOMMA	
"Impossível resolver prefixo de solucionador sem Prefixo!"	TokenNameStringLiteral	Impossível resolver prefixo de solucionador sem Prefixo!
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_REDIRECT_COULDNT_GET_FILENAME	TokenNameIdentifier	 ER  REDIRECT  COULDNT  GET  FILENAME
,	TokenNameCOMMA	
"Redirecionar extensão: Não foi possível obter o nome do arquivo - o atributo file ou select deve retornar uma cadeia válida."	TokenNameStringLiteral	Redirecionar extensão: Não foi possível obter o nome do arquivo - o atributo file ou select deve retornar uma cadeia válida.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_CANNOT_BUILD_FORMATTERLISTENER_IN_REDIRECT	TokenNameIdentifier	 ER  CANNOT  BUILD  FORMATTERLISTENER  IN  REDIRECT
,	TokenNameCOMMA	
"Impossível construir FormatterListener em Redirecionar extensão!"	TokenNameStringLiteral	Impossível construir FormatterListener em Redirecionar extensão!
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_INVALID_PREFIX_IN_EXCLUDERESULTPREFIX	TokenNameIdentifier	 ER  INVALID  PREFIX  IN  EXCLUDERESULTPREFIX
,	TokenNameCOMMA	
"O prefixo em exclude-result-prefixes não é válido: {0}"	TokenNameStringLiteral	O prefixo em exclude-result-prefixes não é válido: {0}
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_MISSING_NS_URI	TokenNameIdentifier	 ER  MISSING  NS  URI
,	TokenNameCOMMA	
"URI do espaço de nomes ausente para o prefixo especificado"	TokenNameStringLiteral	URI do espaço de nomes ausente para o prefixo especificado
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_MISSING_ARG_FOR_OPTION	TokenNameIdentifier	 ER  MISSING  ARG  FOR  OPTION
,	TokenNameCOMMA	
"Argumento ausente para a opção: {0}"	TokenNameStringLiteral	Argumento ausente para a opção: {0}
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_INVALID_OPTION	TokenNameIdentifier	 ER  INVALID  OPTION
,	TokenNameCOMMA	
"Opção inválida: {0}"	TokenNameStringLiteral	Opção inválida: {0}
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_MALFORMED_FORMAT_STRING	TokenNameIdentifier	 ER  MALFORMED  FORMAT  STRING
,	TokenNameCOMMA	
"Cadeia com problemas de formatação: {0}"	TokenNameStringLiteral	Cadeia com problemas de formatação: {0}
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_STYLESHEET_REQUIRES_VERSION_ATTRIB	TokenNameIdentifier	 ER  STYLESHEET  REQUIRES  VERSION  ATTRIB
...
ER_ILLEGAL_ATTRIBUTE_VALUE	TokenNameIdentifier	 ER  ILLEGAL  ATTRIBUTE  VALUE
,	TokenNameCOMMA	
"Atributo: {0} possui um valor inválido: {1}"	TokenNameStringLiteral	Atributo: {0} possui um valor inválido: {1}
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_CHOOSE_REQUIRES_WHEN	TokenNameIdentifier	 ER  CHOOSE  REQUIRES  WHEN
...
ER_NO_APPLY_IMPORT_IN_FOR_EACH	TokenNameIdentifier	 ER  NO  APPLY  IMPORT  IN  FOR  EACH
,	TokenNameCOMMA	
"xsl:apply-imports não permitido em um xsl:for-each"	TokenNameStringLiteral	xsl:apply-imports não permitido em um xsl:for-each
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_CANT_USE_DTM_FOR_OUTPUT	TokenNameIdentifier	 ER  CANT  USE  DTM  FOR  OUTPUT
,	TokenNameCOMMA	
"Impossível utilizar um DTMLiaison para um nó DOM de saída... transmita um org.apache.xpath.DOM2Helper no lugar!"	TokenNameStringLiteral	Impossível utilizar um DTMLiaison para um nó DOM de saída... transmita um org.apache.xpath.DOM2Helper no lugar!
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_CANT_USE_DTM_FOR_INPUT	TokenNameIdentifier	 ER  CANT  USE  DTM  FOR  INPUT
,	TokenNameCOMMA	
"Impossível utilizar um DTMLiaison para um nó DOM de entrada... transmita um org.apache.xpath.DOM2Helper no lugar!"	TokenNameStringLiteral	Impossível utilizar um DTMLiaison para um nó DOM de entrada... transmita um org.apache.xpath.DOM2Helper no lugar!
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_CALL_TO_EXT_FAILED	TokenNameIdentifier	 ER  CALL  TO  EXT  FAILED
,	TokenNameCOMMA	
"Falha na chamada do elemento da extensão: {0}"	TokenNameStringLiteral	Falha na chamada do elemento da extensão: {0}
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_PREFIX_MUST_RESOLVE	TokenNameIdentifier	 ER  PREFIX  MUST  RESOLVE
...
ER_INVALID_UTF16_SURROGATE	TokenNameIdentifier	 ER  INVALID  UT F16  SURROGATE
,	TokenNameCOMMA	
"Detectado substituto UTF-16 inválido: {0} ?"	TokenNameStringLiteral	Detectado substituto UTF-16 inválido: {0} ?
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_XSLATTRSET_USED_ITSELF	TokenNameIdentifier	 ER  XSLATTRSET  USED  ITSELF
,	TokenNameCOMMA	
"xsl:attribute-set {0} utilizou a si mesmo, o que causará um loop infinito."	TokenNameStringLiteral	xsl:attribute-set {0} utilizou a si mesmo, o que causará um loop infinito.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_CANNOT_MIX_XERCESDOM	TokenNameIdentifier	 ER  CANNOT  MIX  XERCESDOM
,	TokenNameCOMMA	
"Impossível misturar entrada não Xerces-DOM com saída Xerces-DOM!"	TokenNameStringLiteral	Impossível misturar entrada não Xerces-DOM com saída Xerces-DOM!
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_TOO_MANY_LISTENERS	TokenNameIdentifier	 ER  TOO  MANY  LISTENERS
...
ER_INVALID_KEY_CALL	TokenNameIdentifier	 ER  INVALID  KEY  CALL
,	TokenNameCOMMA	
"Chamada de função inválida: chamadas key() recursivas não são permitidas"	TokenNameStringLiteral	Chamada de função inválida: chamadas key() recursivas não são permitidas
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_REFERENCING_ITSELF	TokenNameIdentifier	 ER  REFERENCING  ITSELF
,	TokenNameCOMMA	
"A variável {0} está fazendo referência a si mesmo, direta ou indiretamente!"	TokenNameStringLiteral	A variável {0} está fazendo referência a si mesmo, direta ou indiretamente!
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_ILLEGAL_DOMSOURCE_INPUT	TokenNameIdentifier	 ER  ILLEGAL  DOMSOURCE  INPUT
,	TokenNameCOMMA	
"O nó de entrada não pode ser nulo para um DOMSource de newTemplates!"	TokenNameStringLiteral	O nó de entrada não pode ser nulo para um DOMSource de newTemplates!
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_CLASS_NOT_FOUND_FOR_OPTION	TokenNameIdentifier	 ER  CLASS  NOT  FOUND  FOR  OPTION
,	TokenNameCOMMA	
"Arquivo de classe não encontrado para a opção {0}"	TokenNameStringLiteral	Arquivo de classe não encontrado para a opção {0}
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_REQUIRED_ELEM_NOT_FOUND	TokenNameIdentifier	 ER  REQUIRED  ELEM  NOT  FOUND
,	TokenNameCOMMA	
"Elemento requerido não encontrado: {0}"	TokenNameStringLiteral	Elemento requerido não encontrado: {0}
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_INPUT_CANNOT_BE_NULL	TokenNameIdentifier	 ER  INPUT  CANNOT  BE  NULL
,	TokenNameCOMMA	
"InputStream não pode ser nulo"	TokenNameStringLiteral	InputStream não pode ser nulo
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_URI_CANNOT_BE_NULL	TokenNameIdentifier	 ER  URI  CANNOT  BE  NULL
,	TokenNameCOMMA	
"URI não pode ser nulo"	TokenNameStringLiteral	URI não pode ser nulo
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_FILE_CANNOT_BE_NULL	TokenNameIdentifier	 ER  FILE  CANNOT  BE  NULL
,	TokenNameCOMMA	
"File não pode ser nulo"	TokenNameStringLiteral	File não pode ser nulo
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_SOURCE_CANNOT_BE_NULL	TokenNameIdentifier	 ER  SOURCE  CANNOT  BE  NULL
,	TokenNameCOMMA	
"InputSource não pode ser nulo"	TokenNameStringLiteral	InputSource não pode ser nulo
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_CANNOT_INIT_BSFMGR	TokenNameIdentifier	 ER  CANNOT  INIT  BSFMGR
,	TokenNameCOMMA	
"Não foi possível inicializar o BSF Manager"	TokenNameStringLiteral	Não foi possível inicializar o BSF Manager
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_CANNOT_CMPL_EXTENSN	TokenNameIdentifier	 ER  CANNOT  CMPL  EXTENSN
,	TokenNameCOMMA	
"Não foi possível compilar a extensão"	TokenNameStringLiteral	Não foi possível compilar a extensão
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_CANNOT_CREATE_EXTENSN	TokenNameIdentifier	 ER  CANNOT  CREATE  EXTENSN
,	TokenNameCOMMA	
"Não foi possível criar extensão: {0} devido a: {1}"	TokenNameStringLiteral	Não foi possível criar extensão: {0} devido a: {1}
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_INSTANCE_MTHD_CALL_REQUIRES	TokenNameIdentifier	 ER  INSTANCE  MTHD  CALL  REQUIRES
,	TokenNameCOMMA	
"A chamada do método da instância para o método {0} requer uma instância Object como primeiro argumento"	TokenNameStringLiteral	A chamada do método da instância para o método {0} requer uma instância Object como primeiro argumento
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_INVALID_ELEMENT_NAME	TokenNameIdentifier	 ER  INVALID  ELEMENT  NAME
,	TokenNameCOMMA	
"Especificado nome de elemento inválido {0}"	TokenNameStringLiteral	Especificado nome de elemento inválido {0}
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_ELEMENT_NAME_METHOD_STATIC	TokenNameIdentifier	 ER  ELEMENT  NAME  METHOD  STATIC
,	TokenNameCOMMA	
"O método do nome de elemento deve ser estático {0}"	TokenNameStringLiteral	O método do nome de elemento deve ser estático {0}
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_EXTENSION_FUNC_UNKNOWN	TokenNameIdentifier	 ER  EXTENSION  FUNC  UNKNOWN
,	TokenNameCOMMA	
"A função de extensão {0} : {1} é desconhecida"	TokenNameStringLiteral	A função de extensão {0} : {1} é desconhecida
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_MORE_MATCH_CONSTRUCTOR	TokenNameIdentifier	 ER  MORE  MATCH  CONSTRUCTOR
,	TokenNameCOMMA	
"Mais de uma correspondência principal para o construtor de {0}"	TokenNameStringLiteral	Mais de uma correspondência principal para o construtor de {0}
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_MORE_MATCH_METHOD	TokenNameIdentifier	 ER  MORE  MATCH  METHOD
,	TokenNameCOMMA	
"Mais de uma correspondência principal para o método {0}"	TokenNameStringLiteral	Mais de uma correspondência principal para o método {0}
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_MORE_MATCH_ELEMENT	TokenNameIdentifier	 ER  MORE  MATCH  ELEMENT
,	TokenNameCOMMA	
"Mais de uma correspondência principal para o método do elemento {0}"	TokenNameStringLiteral	Mais de uma correspondência principal para o método do elemento {0}
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_INVALID_CONTEXT_PASSED	TokenNameIdentifier	 ER  INVALID  CONTEXT  PASSED
,	TokenNameCOMMA	
"Contexto inválido transmitido para avaliar {0}"	TokenNameStringLiteral	Contexto inválido transmitido para avaliar {0}
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_POOL_EXISTS	TokenNameIdentifier	 ER  POOL  EXISTS
,	TokenNameCOMMA	
"O conjunto já existe"	TokenNameStringLiteral	O conjunto já existe
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_NO_DRIVER_NAME	TokenNameIdentifier	 ER  NO  DRIVER  NAME
...
ER_POOL_SIZE_LESSTHAN_ONE	TokenNameIdentifier	 ER  POOL  SIZE  LESSTHAN  ONE
,	TokenNameCOMMA	
"O tamanho do conjunto é menor que um!"	TokenNameStringLiteral	O tamanho do conjunto é menor que um!
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_INVALID_DRIVER	TokenNameIdentifier	 ER  INVALID  DRIVER
,	TokenNameCOMMA	
"Especificado nome de driver inválido!"	TokenNameStringLiteral	Especificado nome de driver inválido!
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_NO_STYLESHEETROOT	TokenNameIdentifier	 ER  NO  STYLESHEETROOT
,	TokenNameCOMMA	
"Não encontrada a raiz da folha de estilo!"	TokenNameStringLiteral	Não encontrada a raiz da folha de estilo!
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_ILLEGAL_XMLSPACE_VALUE	TokenNameIdentifier	 ER  ILLEGAL  XMLSPACE  VALUE
,	TokenNameCOMMA	
"Valor inválido para xml:space"	TokenNameStringLiteral	Valor inválido para xml:space
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_PROCESSFROMNODE_FAILED	TokenNameIdentifier	 ER  PROCESSFROMNODE  FAILED
...
ER_RESOURCE_COULD_NOT_LOAD	TokenNameIdentifier	 ER  RESOURCE  COULD  NOT  LOAD
,	TokenNameCOMMA	
"O recurso [ {0} ] não pôde carregar: {1} {2} {3}"	TokenNameStringLiteral	O recurso [ {0} ] não pôde carregar: {1} {2} {3}
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_BUFFER_SIZE_LESSTHAN_ZERO	TokenNameIdentifier	 ER  BUFFER  SIZE  LESSTHAN  ZERO
...
ER_UNKNOWN_ERROR_CALLING_EXTENSION	TokenNameIdentifier	 ER  UNKNOWN  ERROR  CALLING  EXTENSION
,	TokenNameCOMMA	
"Erro desconhecido ao chamar a extensão"	TokenNameStringLiteral	Erro desconhecido ao chamar a extensão
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_NO_NAMESPACE_DECL	TokenNameIdentifier	 ER  NO  NAMESPACE  DECL
,	TokenNameCOMMA	
"O prefixo {0} não possui uma declaração do espaço de nomes correspondente"	TokenNameStringLiteral	O prefixo {0} não possui uma declaração do espaço de nomes correspondente
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_ELEM_CONTENT_NOT_ALLOWED	TokenNameIdentifier	 ER  ELEM  CONTENT  NOT  ALLOWED
,	TokenNameCOMMA	
"Conteúdo de elemento não permitido para lang=javaclass {0}"	TokenNameStringLiteral	Conteúdo de elemento não permitido para lang=javaclass {0}
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_STYLESHEET_DIRECTED_TERMINATION	TokenNameIdentifier	 ER  STYLESHEET  DIRECTED  TERMINATION
,	TokenNameCOMMA	
"Finalização direcionada por folha de estilo"	TokenNameStringLiteral	Finalização direcionada por folha de estilo
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_ONE_OR_TWO	TokenNameIdentifier	 ER  ONE  OR  TWO
...
ER_COULD_NOT_LOAD_RESOURCE	TokenNameIdentifier	 ER  COULD  NOT  LOAD  RESOURCE
,	TokenNameCOMMA	
"Não foi possível carregar {0} (verificar CLASSPATH); utilizando apenas os padrões"	TokenNameStringLiteral	Não foi possível carregar {0} (verificar CLASSPATH); utilizando apenas os padrões
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_CANNOT_INIT_DEFAULT_TEMPLATES	TokenNameIdentifier	 ER  CANNOT  INIT  DEFAULT  TEMPLATES
,	TokenNameCOMMA	
"Impossível inicializar templates padrão"	TokenNameStringLiteral	Impossível inicializar templates padrão
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_RESULT_NULL	TokenNameIdentifier	 ER  RESULT  NULL
,	TokenNameCOMMA	
"O resultado não deve ser nulo"	TokenNameStringLiteral	O resultado não deve ser nulo
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_RESULT_COULD_NOT_BE_SET	TokenNameIdentifier	 ER  RESULT  COULD  NOT  BE  SET
,	TokenNameCOMMA	
"O resultado não pôde ser definido"	TokenNameStringLiteral	O resultado não pôde ser definido
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_NO_OUTPUT_SPECIFIED	TokenNameIdentifier	 ER  NO  OUTPUT  SPECIFIED
,	TokenNameCOMMA	
"Nenhuma saída especificada"	TokenNameStringLiteral	Nenhuma saída especificada
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_CANNOT_TRANSFORM_TO_RESULT_TYPE	TokenNameIdentifier	 ER  CANNOT  TRANSFORM  TO  RESULT  TYPE
,	TokenNameCOMMA	
"Não é possível transformar em um Resultado do tipo {0} "	TokenNameStringLiteral	Não é possível transformar em um Resultado do tipo {0} 
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_CANNOT_TRANSFORM_SOURCE_TYPE	TokenNameIdentifier	 ER  CANNOT  TRANSFORM  SOURCE  TYPE
,	TokenNameCOMMA	
"Não é possível transformar em uma Origem do tipo {0} "	TokenNameStringLiteral	Não é possível transformar em uma Origem do tipo {0} 
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_NULL_CONTENT_HANDLER	TokenNameIdentifier	 ER  NULL  CONTENT  HANDLER
,	TokenNameCOMMA	
"Rotina de tratamento de conteúdo nula"	TokenNameStringLiteral	Rotina de tratamento de conteúdo nula
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_NULL_ERROR_HANDLER	TokenNameIdentifier	 ER  NULL  ERROR  HANDLER
...
ER_CANNOT_CALL_PARSE	TokenNameIdentifier	 ER  CANNOT  CALL  PARSE
,	TokenNameCOMMA	
"parse não pode ser chamado se ContentHandler não tiver sido definido"	TokenNameStringLiteral	parse não pode ser chamado se ContentHandler não tiver sido definido
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_NO_PARENT_FOR_FILTER	TokenNameIdentifier	 ER  NO  PARENT  FOR  FILTER
...
ER_NO_STYLESHEET_IN_MEDIA	TokenNameIdentifier	 ER  NO  STYLESHEET  IN  MEDIA
,	TokenNameCOMMA	
"Nenhuma página de estilo foi encontrada em: {0}, mídia= {1}"	TokenNameStringLiteral	Nenhuma página de estilo foi encontrada em: {0}, mídia= {1}
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_NO_STYLESHEET_PI	TokenNameIdentifier	 ER  NO  STYLESHEET  PI
...
ER_PROPERTY_VALUE_BOOLEAN	TokenNameIdentifier	 ER  PROPERTY  VALUE  BOOLEAN
,	TokenNameCOMMA	
"O valor para a propriedade {0} deve ser uma instância Booleana"	TokenNameStringLiteral	O valor para a propriedade {0} deve ser uma instância Booleana
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_COULD_NOT_FIND_EXTERN_SCRIPT	TokenNameIdentifier	 ER  COULD  NOT  FIND  EXTERN  SCRIPT
,	TokenNameCOMMA	
"Não foi possível obter script externo em {0}"	TokenNameStringLiteral	Não foi possível obter script externo em {0}
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_RESOURCE_COULD_NOT_FIND	TokenNameIdentifier	 ER  RESOURCE  COULD  NOT  FIND
,	TokenNameCOMMA	
"O recurso [ {0} ] não pôde ser encontrado. {1}"	TokenNameStringLiteral	O recurso [ {0} ] não pôde ser encontrado. {1}
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_OUTPUT_PROPERTY_NOT_RECOGNIZED	TokenNameIdentifier	 ER  OUTPUT  PROPERTY  NOT  RECOGNIZED
,	TokenNameCOMMA	
"Propriedade de saída não reconhecida: {0}"	TokenNameStringLiteral	Propriedade de saída não reconhecida: {0}
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_FAILED_CREATING_ELEMLITRSLT	TokenNameIdentifier	 ER  FAILED  CREATING  ELEMLITRSLT
,	TokenNameCOMMA	
"Falha ao criar a instância ElemLiteralResult"	TokenNameStringLiteral	Falha ao criar a instância ElemLiteralResult
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
ER_VALUE_SHOULD_BE_NUMBER	TokenNameIdentifier	 ER  VALUE  SHOULD  BE  NUMBER
,	TokenNameCOMMA	
"O valor para {0} deve conter um número analisável"	TokenNameStringLiteral	O valor para {0} deve conter um número analisável
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_VALUE_SHOULD_EQUAL	TokenNameIdentifier	 ER  VALUE  SHOULD  EQUAL
...
ER_FAILED_CALLING_METHOD	TokenNameIdentifier	 ER  FAILED  CALLING  METHOD
,	TokenNameCOMMA	
"Falha ao chamar o método {0}"	TokenNameStringLiteral	Falha ao chamar o método {0}
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_FAILED_CREATING_ELEMTMPL	TokenNameIdentifier	 ER  FAILED  CREATING  ELEMTMPL
,	TokenNameCOMMA	
"Falha ao criar a instância ElemTemplateElement"	TokenNameStringLiteral	Falha ao criar a instância ElemTemplateElement
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_CHARS_NOT_ALLOWED	TokenNameIdentifier	 ER  CHARS  NOT  ALLOWED
,	TokenNameCOMMA	
"Não são permitidos caracteres neste ponto do documento"	TokenNameStringLiteral	Não são permitidos caracteres neste ponto do documento
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_ATTR_NOT_ALLOWED	TokenNameIdentifier	 ER  ATTR  NOT  ALLOWED
,	TokenNameCOMMA	
"O atributo "{0}" não é permitido no elemento {1}!"	TokenNameStringLiteral	O atributo "{0}" não é permitido no elemento {1}!
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_BAD_VALUE	TokenNameIdentifier	 ER  BAD  VALUE
,	TokenNameCOMMA	
"{0} possui valor inválido {1}"	TokenNameStringLiteral	{0} possui valor inválido {1}
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_ATTRIB_VALUE_NOT_FOUND	TokenNameIdentifier	 ER  ATTRIB  VALUE  NOT  FOUND
,	TokenNameCOMMA	
"Valor do atributo {0} não encontrado"	TokenNameStringLiteral	Valor do atributo {0} não encontrado
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_ATTRIB_VALUE_NOT_RECOGNIZED	TokenNameIdentifier	 ER  ATTRIB  VALUE  NOT  RECOGNIZED
,	TokenNameCOMMA	
"Valor do atributo {0} não reconhecido"	TokenNameStringLiteral	Valor do atributo {0} não reconhecido
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_NULL_URI_NAMESPACE	TokenNameIdentifier	 ER  NULL  URI  NAMESPACE
,	TokenNameCOMMA	
"Tentando gerar um prefixo do espaço de nomes com URI nulo"	TokenNameStringLiteral	Tentando gerar um prefixo do espaço de nomes com URI nulo
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
ER_NUMBER_TOO_BIG	TokenNameIdentifier	 ER  NUMBER  TOO  BIG
,	TokenNameCOMMA	
"Tentando formatar um número superior ao maior inteiro Longo"	TokenNameStringLiteral	Tentando formatar um número superior ao maior inteiro Longo
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_CANNOT_FIND_SAX1_DRIVER	TokenNameIdentifier	 ER  CANNOT  FIND  SA X1  DRIVER
,	TokenNameCOMMA	
"Impossível encontrar a classe de driver SAX1 {0}"	TokenNameStringLiteral	Impossível encontrar a classe de driver SAX1 {0}
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_SAX1_DRIVER_NOT_LOADED	TokenNameIdentifier	 ER  SA X1  DRIVER  NOT  LOADED
,	TokenNameCOMMA	
"Classe de driver SAX1 {0} encontrada, mas não pode ser carregada"	TokenNameStringLiteral	Classe de driver SAX1 {0} encontrada, mas não pode ser carregada
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_SAX1_DRIVER_NOT_INSTANTIATED	TokenNameIdentifier	 ER  SA X1  DRIVER  NOT  INSTANTIATED
,	TokenNameCOMMA	
"Classe de driver SAX1 {0} carregada, mas não pode ser instanciada"	TokenNameStringLiteral	Classe de driver SAX1 {0} carregada, mas não pode ser instanciada
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_SAX1_DRIVER_NOT_IMPLEMENT_PARSER	TokenNameIdentifier	 ER  SA X1  DRIVER  NOT  IMPLEMENT  PARSER
,	TokenNameCOMMA	
"A classe de driver SAX1 {0} não implementa org.xml.sax.Parser"	TokenNameStringLiteral	A classe de driver SAX1 {0} não implementa org.xml.sax.Parser
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_PARSER_PROPERTY_NOT_SPECIFIED	TokenNameIdentifier	 ER  PARSER  PROPERTY  NOT  SPECIFIED
,	TokenNameCOMMA	
"Propriedade de sistema org.xml.sax.parser não especificada"	TokenNameStringLiteral	Propriedade de sistema org.xml.sax.parser não especificada
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_PARSER_ARG_CANNOT_BE_NULL	TokenNameIdentifier	 ER  PARSER  ARG  CANNOT  BE  NULL
,	TokenNameCOMMA	
"O argumento Parser não deve ser nulo"	TokenNameStringLiteral	O argumento Parser não deve ser nulo
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_FEATURE	TokenNameIdentifier	 ER  FEATURE
...
ER_POOLSIZE_LESS_THAN_ONE	TokenNameIdentifier	 ER  POOLSIZE  LESS  THAN  ONE
,	TokenNameCOMMA	
"O tamanho do conjunto é menor que 1!"	TokenNameStringLiteral	O tamanho do conjunto é menor que 1!
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_INVALID_DRIVER_NAME	TokenNameIdentifier	 ER  INVALID  DRIVER  NAME
...
ER_ASSERT_NO_TEMPLATE_PARENT	TokenNameIdentifier	 ER  ASSERT  NO  TEMPLATE  PARENT
,	TokenNameCOMMA	
"Erro do programador! A expressão não possui o pai ElemTemplateElement!"	TokenNameStringLiteral	Erro do programador! A expressão não possui o pai ElemTemplateElement!
}	TokenNameRBRACE	
,	TokenNameCOMMA	
// Note to translators: The following message should not normally be displayed 	TokenNameCOMMENT_LINE	Note to translators: The following message should not normally be displayed 
// to users. It describes a situation in which the processor has detected 	TokenNameCOMMENT_LINE	to users. It describes a situation in which the processor has detected 
...
ER_ASSERT_REDUNDENT_EXPR_ELIMINATOR	TokenNameIdentifier	 ER  ASSERT  REDUNDENT  EXPR  ELIMINATOR
,	TokenNameCOMMA	
"Declaração do programador em RedundentExprEliminator: {0}"	TokenNameStringLiteral	Declaração do programador em RedundentExprEliminator: {0}
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_NOT_ALLOWED_IN_POSITION	TokenNameIdentifier	 ER  NOT  ALLOWED  IN  POSITION
,	TokenNameCOMMA	
"{0} não é permitido nesta posição na página de estilo!"	TokenNameStringLiteral	{0} não é permitido nesta posição na página de estilo!
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_NONWHITESPACE_NOT_ALLOWED_IN_POSITION	TokenNameIdentifier	 ER  NONWHITESPACE  NOT  ALLOWED  IN  POSITION
,	TokenNameCOMMA	
"O texto sem espaço em branco não é permitido nesta posição na página de estilo!"	TokenNameStringLiteral	O texto sem espaço em branco não é permitido nesta posição na página de estilo!
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
INVALID_TCHAR	TokenNameIdentifier	 INVALID  TCHAR
,	TokenNameCOMMA	
"Valor inválido: {1} utilizado para o caractere CHAR: {0}. Um atributo de tipo CHAR deve ter apenas 1 caractere!"	TokenNameStringLiteral	Valor inválido: {1} utilizado para o caractere CHAR: {0}. Um atributo de tipo CHAR deve ter apenas 1 caractere!
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
INVALID_QNAME	TokenNameIdentifier	 INVALID  QNAME
,	TokenNameCOMMA	
"Valor inválido: {1} utilizado para o atributo QNAME: {0}"	TokenNameStringLiteral	Valor inválido: {1} utilizado para o atributo QNAME: {0}
}	TokenNameRBRACE	
,	TokenNameCOMMA	
// Note to translators: The following message is used if the value of 	TokenNameCOMMENT_LINE	Note to translators: The following message is used if the value of 
...
INVALID_ENUM	TokenNameIdentifier	 INVALID  ENUM
,	TokenNameCOMMA	
"Valor inválido: {1} utilizado para o atributo ENUM: {0}. Os valores válidos são: {2}."	TokenNameStringLiteral	Valor inválido: {1} utilizado para o atributo ENUM: {0}. Os valores válidos são: {2}.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
// Note to translators: The following message is used if the value of 	TokenNameCOMMENT_LINE	Note to translators: The following message is used if the value of 
...
INVALID_NMTOKEN	TokenNameIdentifier	 INVALID  NMTOKEN
,	TokenNameCOMMA	
"Valor inválido: {1} utilizado para o atributo NMTOKEN: {0}"	TokenNameStringLiteral	Valor inválido: {1} utilizado para o atributo NMTOKEN: {0}
}	TokenNameRBRACE	
,	TokenNameCOMMA	
// Note to translators: The following message is used if the value of 	TokenNameCOMMENT_LINE	Note to translators: The following message is used if the value of 
...
INVALID_NCNAME	TokenNameIdentifier	 INVALID  NCNAME
,	TokenNameCOMMA	
"Valor inválido: {1} utilizado para o atributo NCNAME: {0}"	TokenNameStringLiteral	Valor inválido: {1} utilizado para o atributo NCNAME: {0}
}	TokenNameRBRACE	
,	TokenNameCOMMA	
// Note to translators: The following message is used if the value of 	TokenNameCOMMENT_LINE	Note to translators: The following message is used if the value of 
...
INVALID_BOOLEAN	TokenNameIdentifier	 INVALID  BOOLEAN
,	TokenNameCOMMA	
"Valor inválido: {1} utilizado para o atributo boolean: {0}"	TokenNameStringLiteral	Valor inválido: {1} utilizado para o atributo boolean: {0}
}	TokenNameRBRACE	
,	TokenNameCOMMA	
// Note to translators: The following message is used if the value of 	TokenNameCOMMENT_LINE	Note to translators: The following message is used if the value of 
...
INVALID_NUMBER	TokenNameIdentifier	 INVALID  NUMBER
,	TokenNameCOMMA	
"Valor inválido: {1} utilizado para o atributo number: {0}"	TokenNameStringLiteral	Valor inválido: {1} utilizado para o atributo number: {0}
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
ER_ARG_LITERAL	TokenNameIdentifier	 ER  ARG  LITERAL
,	TokenNameCOMMA	
"Argumento para {0} no padrão de correspondência deve ser um literal."	TokenNameStringLiteral	Argumento para {0} no padrão de correspondência deve ser um literal.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
ER_DUPLICATE_GLOBAL_VAR	TokenNameIdentifier	 ER  DUPLICATE  GLOBAL  VAR
,	TokenNameCOMMA	
"Declaração de variável global duplicada."	TokenNameStringLiteral	Declaração de variável global duplicada.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
// Note to translators: The following message indicates that two definitions of 	TokenNameCOMMENT_LINE	Note to translators: The following message indicates that two definitions of 
...
ER_DUPLICATE_VAR	TokenNameIdentifier	 ER  DUPLICATE  VAR
,	TokenNameCOMMA	
"Declaração de variável duplicada."	TokenNameStringLiteral	Declaração de variável duplicada.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
ER_NO_ATTRIB_SET	TokenNameIdentifier	 ER  NO  ATTRIB  SET
,	TokenNameCOMMA	
"O attribute-set {0} não existe"	TokenNameStringLiteral	O attribute-set {0} não existe
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
ER_FUNCTION_NOT_FOUND	TokenNameIdentifier	 ER  FUNCTION  NOT  FOUND
,	TokenNameCOMMA	
"A função denominada {0} não existe"	TokenNameStringLiteral	A função denominada {0} não existe
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
ER_CANT_HAVE_CONTENT_AND_SELECT	TokenNameIdentifier	 ER  CANT  HAVE  CONTENT  AND  SELECT
,	TokenNameCOMMA	
"O elemento {0} não deve ter um conteúdo e um atributo de seleção ao mesmo tempo."	TokenNameStringLiteral	O elemento {0} não deve ter um conteúdo e um atributo de seleção ao mesmo tempo.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
ER_INVALID_SET_PARAM_VALUE	TokenNameIdentifier	 ER  INVALID  SET  PARAM  VALUE
,	TokenNameCOMMA	
"O valor do parâmetro {0} deve ser um Objeto Java válido"	TokenNameStringLiteral	O valor do parâmetro {0} deve ser um Objeto Java válido
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_INVALID_NAMESPACE_URI_VALUE_FOR_RESULT_PREFIX_FOR_DEFAULT	TokenNameIdentifier	 ER  INVALID  NAMESPACE  URI  VALUE  FOR  RESULT  PREFIX  FOR  DEFAULT
,	TokenNameCOMMA	
"O atributo result-prefix de um elemento xsl:namespace-alias tem o valor '#default', mas não há nenhuma declaração do espaço de nomes padrão no escopo para o elemento"	TokenNameStringLiteral	O atributo result-prefix de um elemento xsl:namespace-alias tem o valor '#default', mas não há nenhuma declaração do espaço de nomes padrão no escopo para o elemento
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_INVALID_NAMESPACE_URI_VALUE_FOR_RESULT_PREFIX	TokenNameIdentifier	 ER  INVALID  NAMESPACE  URI  VALUE  FOR  RESULT  PREFIX
,	TokenNameCOMMA	
"O atributo result-prefix de um elemento xsl:namespace-alias tem o valor ''{0}'', mas não há nenhuma declaração do espaço de nomes para o prefixo ''{0}'' no escopo para o elemento."	TokenNameStringLiteral	O atributo result-prefix de um elemento xsl:namespace-alias tem o valor ''{0}'', mas não há nenhuma declaração do espaço de nomes para o prefixo ''{0}'' no escopo para o elemento.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_SET_FEATURE_NULL_NAME	TokenNameIdentifier	 ER  SET  FEATURE  NULL  NAME
,	TokenNameCOMMA	
"O nome do recurso não pode ser nulo em TransformerFactory.setFeature(String name, boolean value)."	TokenNameStringLiteral	O nome do recurso não pode ser nulo em TransformerFactory.setFeature(String name, boolean value).
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_GET_FEATURE_NULL_NAME	TokenNameIdentifier	 ER  GET  FEATURE  NULL  NAME
,	TokenNameCOMMA	
"O nome do recurso não pode ser nulo em TransformerFactory.getFeature(String name)."	TokenNameStringLiteral	O nome do recurso não pode ser nulo em TransformerFactory.getFeature(String name).
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_UNSUPPORTED_FEATURE	TokenNameIdentifier	 ER  UNSUPPORTED  FEATURE
,	TokenNameCOMMA	
"Não é possível definir o recurso ''{0}'' neste TransformerFactory."	TokenNameStringLiteral	Não é possível definir o recurso ''{0}'' neste TransformerFactory.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_EXTENSION_ELEMENT_NOT_ALLOWED_IN_SECURE_PROCESSING	TokenNameIdentifier	 ER  EXTENSION  ELEMENT  NOT  ALLOWED  IN  SECURE  PROCESSING
,	TokenNameCOMMA	
"O uso do elemento de extensão ''{0}'' não é permitido quando o recurso de processamento seguro é definido como true."	TokenNameStringLiteral	O uso do elemento de extensão ''{0}'' não é permitido quando o recurso de processamento seguro é definido como true.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_NAMESPACE_CONTEXT_NULL_NAMESPACE	TokenNameIdentifier	 ER  NAMESPACE  CONTEXT  NULL  NAMESPACE
,	TokenNameCOMMA	
"Não é possível obter o prefixo para um uri de espaço de nomes nulo."	TokenNameStringLiteral	Não é possível obter o prefixo para um uri de espaço de nomes nulo.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_NAMESPACE_CONTEXT_NULL_PREFIX	TokenNameIdentifier	 ER  NAMESPACE  CONTEXT  NULL  PREFIX
,	TokenNameCOMMA	
"Não é possível obter o uri do espaço de nomes para um prefixo nulo."	TokenNameStringLiteral	Não é possível obter o uri do espaço de nomes para um prefixo nulo.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_XPATH_RESOLVER_NULL_QNAME	TokenNameIdentifier	 ER  XPATH  RESOLVER  NULL  QNAME
,	TokenNameCOMMA	
"O nome da função não pode ser nulo."	TokenNameStringLiteral	O nome da função não pode ser nulo.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_XPATH_RESOLVER_NEGATIVE_ARITY	TokenNameIdentifier	 ER  XPATH  RESOLVER  NEGATIVE  ARITY
,	TokenNameCOMMA	
"O arity não pode ser negativo."	TokenNameStringLiteral	O arity não pode ser negativo.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
WG_COUNT_ATTRIB_MATCHES_NO_ANCESTOR	TokenNameIdentifier	 WG  COUNT  ATTRIB  MATCHES  NO  ANCESTOR
,	TokenNameCOMMA	
"Aviso: o atributo count não corresponde a um predecessor em xsl:number! Destino = {0}"	TokenNameStringLiteral	Aviso: o atributo count não corresponde a um predecessor em xsl:number! Destino = {0}
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
WG_EXPR_ATTRIB_CHANGED_TO_SELECT	TokenNameIdentifier	 WG  EXPR  ATTRIB  CHANGED  TO  SELECT
...
WG_NO_LOCALE_IN_FORMATNUMBER	TokenNameIdentifier	 WG  NO  LOCALE  IN  FORMATNUMBER
,	TokenNameCOMMA	
"Xalan ainda não trata do nome de locale na função format-number."	TokenNameStringLiteral	Xalan ainda não trata do nome de locale na função format-number.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
WG_LOCALE_NOT_FOUND	TokenNameIdentifier	 WG  LOCALE  NOT  FOUND
,	TokenNameCOMMA	
"Aviso: Não foi possível localizar o locale para xml:lang={0}"	TokenNameStringLiteral	Aviso: Não foi possível localizar o locale para xml:lang={0}
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
WG_CANNOT_MAKE_URL_FROM	TokenNameIdentifier	 WG  CANNOT  MAKE  URL  FROM
,	TokenNameCOMMA	
"Impossível criar URL a partir de: {0}"	TokenNameStringLiteral	Impossível criar URL a partir de: {0}
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
WG_CANNOT_LOAD_REQUESTED_DOC	TokenNameIdentifier	 WG  CANNOT  LOAD  REQUESTED  DOC
,	TokenNameCOMMA	
"Impossível carregar doc solicitado: {0}"	TokenNameStringLiteral	Impossível carregar doc solicitado: {0}
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
WG_CANNOT_FIND_COLLATOR	TokenNameIdentifier	 WG  CANNOT  FIND  COLLATOR
,	TokenNameCOMMA	
"Impossível localizar Intercalador para <sort xml:lang={0}"	TokenNameStringLiteral	Impossível localizar Intercalador para <sort xml:lang={0}
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
WG_FUNCTIONS_SHOULD_USE_URL	TokenNameIdentifier	 WG  FUNCTIONS  SHOULD  USE  URL
,	TokenNameCOMMA	
"Sintaxe antiga: a instrução functions deve utilizar uma url de {0}"	TokenNameStringLiteral	Sintaxe antiga: a instrução functions deve utilizar uma url de {0}
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
WG_ENCODING_NOT_SUPPORTED_USING_UTF8	TokenNameIdentifier	 WG  ENCODING  NOT  SUPPORTED  USING  UT F8
,	TokenNameCOMMA	
"codificação não suportada: {0}, utilizando UTF-8"	TokenNameStringLiteral	codificação não suportada: {0}, utilizando UTF-8
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
WG_ENCODING_NOT_SUPPORTED_USING_JAVA	TokenNameIdentifier	 WG  ENCODING  NOT  SUPPORTED  USING  JAVA
,	TokenNameCOMMA	
"codificação não suportada: {0}, utilizando Java {1}"	TokenNameStringLiteral	codificação não suportada: {0}, utilizando Java {1}
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
WG_SPECIFICITY_CONFLICTS	TokenNameIdentifier	 WG  SPECIFICITY  CONFLICTS
,	TokenNameCOMMA	
"Encontrados conflitos de especificação: O último {0} encontrado na página de estilo será utilizado."	TokenNameStringLiteral	Encontrados conflitos de especificação: O último {0} encontrado na página de estilo será utilizado.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
WG_PARSING_AND_PREPARING	TokenNameIdentifier	 WG  PARSING  AND  PREPARING
,	TokenNameCOMMA	
"========= Análise e preparação {0} =========="	TokenNameStringLiteral	========= Análise e preparação {0} ==========
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
WG_ATTR_TEMPLATE	TokenNameIdentifier	 WG  ATTR  TEMPLATE
...
WG_CONFLICT_BETWEEN_XSLSTRIPSPACE_AND_XSLPRESERVESPACE	TokenNameIdentifier	 WG  CONFLICT  BETWEEN  XSLSTRIPSPACE  AND  XSLPRESERVESPACE
,	TokenNameCOMMA	
"Conflito de correspondência entre xsl:strip-space e xsl:preserve-space"	TokenNameStringLiteral	Conflito de correspondência entre xsl:strip-space e xsl:preserve-space
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
WG_ATTRIB_NOT_HANDLED	TokenNameIdentifier	 WG  ATTRIB  NOT  HANDLED
,	TokenNameCOMMA	
"Xalan ainda não trata do atributo {0}!"	TokenNameStringLiteral	Xalan ainda não trata do atributo {0}!
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
WG_NO_DECIMALFORMAT_DECLARATION	TokenNameIdentifier	 WG  NO  DECIMALFORMAT  DECLARATION
,	TokenNameCOMMA	
"Nenhuma declaração encontrada para formato decimal: {0}"	TokenNameStringLiteral	Nenhuma declaração encontrada para formato decimal: {0}
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
WG_OLD_XSLT_NS	TokenNameIdentifier	 WG  OLD  XSLT  NS
,	TokenNameCOMMA	
"Espaço de nomes XSLT ausente ou incorreto."	TokenNameStringLiteral	Espaço de nomes XSLT ausente ou incorreto.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
WG_ONE_DEFAULT_XSLDECIMALFORMAT_ALLOWED	TokenNameIdentifier	 WG  ONE  DEFAULT  XSLDECIMALFORMAT  ALLOWED
,	TokenNameCOMMA	
"Apenas uma declaração padrão xsl:decimal-format é permitida."	TokenNameStringLiteral	Apenas uma declaração padrão xsl:decimal-format é permitida.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
WG_XSLDECIMALFORMAT_NAMES_MUST_BE_UNIQUE	TokenNameIdentifier	 WG  XSLDECIMALFORMAT  NAMES  MUST  BE  UNIQUE
...
WG_COULD_NOT_RESOLVE_PREFIX	TokenNameIdentifier	 WG  COULD  NOT  RESOLVE  PREFIX
,	TokenNameCOMMA	
"Não foi possível resolver prefixo do espaço de nomes: {0}. O nó será ignorado."	TokenNameStringLiteral	Não foi possível resolver prefixo do espaço de nomes: {0}. O nó será ignorado.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
WG_STYLESHEET_REQUIRES_VERSION_ATTRIB	TokenNameIdentifier	 WG  STYLESHEET  REQUIRES  VERSION  ATTRIB
...
WG_ILLEGAL_ATTRIBUTE_NAME	TokenNameIdentifier	 WG  ILLEGAL  ATTRIBUTE  NAME
,	TokenNameCOMMA	
"Nome de atributo inválido: {0}"	TokenNameStringLiteral	Nome de atributo inválido: {0}
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
WG_ILLEGAL_ATTRIBUTE_VALUE	TokenNameIdentifier	 WG  ILLEGAL  ATTRIBUTE  VALUE
,	TokenNameCOMMA	
"Valor inválido utilizado para o atributo {0}: {1}"	TokenNameStringLiteral	Valor inválido utilizado para o atributo {0}: {1}
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
WG_EMPTY_SECOND_ARG	TokenNameIdentifier	 WG  EMPTY  SECOND  ARG
,	TokenNameCOMMA	
"O nodeset resultante do segundo argumento da função document está vazio. Retornar um node-set vazio."	TokenNameStringLiteral	O nodeset resultante do segundo argumento da função document está vazio. Retornar um node-set vazio.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
WG_PROCESSINGINSTRUCTION_NAME_CANT_BE_XML	TokenNameIdentifier	 WG  PROCESSINGINSTRUCTION  NAME  CANT  BE  XML
,	TokenNameCOMMA	
"O valor do atributo 'name' do nome xsl:processing-instruction não deve ser 'xml'"	TokenNameStringLiteral	O valor do atributo 'name' do nome xsl:processing-instruction não deve ser 'xml'
}	TokenNameRBRACE	
,	TokenNameCOMMA	
// Note to translators: "name" and "xsl:processing-instruction" are keywords 	TokenNameCOMMENT_LINE	Note to translators: "name" and "xsl:processing-instruction" are keywords 
...
WG_PROCESSINGINSTRUCTION_NOTVALID_NCNAME	TokenNameIdentifier	 WG  PROCESSINGINSTRUCTION  NOTVALID  NCNAME
,	TokenNameCOMMA	
"O valor do atributo ''name'' de xsl:processing-instruction deve ser um NCName válido: {0}"	TokenNameStringLiteral	O valor do atributo ''name'' de xsl:processing-instruction deve ser um NCName válido: {0}
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
WG_ILLEGAL_ATTRIBUTE_POSITION	TokenNameIdentifier	 WG  ILLEGAL  ATTRIBUTE  POSITION
,	TokenNameCOMMA	
"Impossível incluir atributo {0} depois de nós filhos ou antes da geração de um elemento. O atributo será ignorado."	TokenNameStringLiteral	Impossível incluir atributo {0} depois de nós filhos ou antes da geração de um elemento. O atributo será ignorado.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
NO_MODIFICATION_ALLOWED_ERR	TokenNameIdentifier	 NO  MODIFICATION  ALLOWED  ERR
,	TokenNameCOMMA	
"Foi feita uma tentativa de modificar um objeto no qual não são permitidas modificações. "	TokenNameStringLiteral	Foi feita uma tentativa de modificar um objeto no qual não são permitidas modificações. 
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
,	TokenNameCOMMA	
">>>>>>> Versão Xalan"	TokenNameStringLiteral	>>>>>>> Versão Xalan
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
...
,	TokenNameCOMMA	
"XSLProcessor: concluído"	TokenNameStringLiteral	XSLProcessor: concluído
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
,	TokenNameCOMMA	
"Opções da classe Process da linha de comando de Xalan-J:"	TokenNameStringLiteral	Opções da classe Process da linha de comando de Xalan-J:
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
"xslProc_option"	TokenNameStringLiteral	xslProc_option
,	TokenNameCOMMA	
"Opções da classe Process da linha de comandos de Xalan-J:"	TokenNameStringLiteral	Opções da classe Process da linha de comandos de Xalan-J:
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
"xslProc_invalid_xsltc_option"	TokenNameStringLiteral	xslProc_invalid_xsltc_option
,	TokenNameCOMMA	
"A opção {0} não é suportada no modo XSLTC."	TokenNameStringLiteral	A opção {0} não é suportada no modo XSLTC.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
"xslProc_invalid_xalan_option"	TokenNameStringLiteral	xslProc_invalid_xalan_option
,	TokenNameCOMMA	
"A opção {0} somente pode ser utilizada com -XSLTC."	TokenNameStringLiteral	A opção {0} somente pode ser utilizada com -XSLTC.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
"xslProc_no_input"	TokenNameStringLiteral	xslProc_no_input
,	TokenNameCOMMA	
"Erro: Nenhuma página de estilo ou xml de entrada foi especificado. Execute este comando sem nenhuma opção para instruções de uso."	TokenNameStringLiteral	Erro: Nenhuma página de estilo ou xml de entrada foi especificado. Execute este comando sem nenhuma opção para instruções de uso.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
"xslProc_common_options"	TokenNameStringLiteral	xslProc_common_options
,	TokenNameCOMMA	
"-Opções Comuns-"	TokenNameStringLiteral	-Opções Comuns-
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
"xslProc_xalan_options"	TokenNameStringLiteral	xslProc_xalan_options
,	TokenNameCOMMA	
"-Opções para Xalan-"	TokenNameStringLiteral	-Opções para Xalan-
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
"xslProc_xsltc_options"	TokenNameStringLiteral	xslProc_xsltc_options
,	TokenNameCOMMA	
"-Opções para XSLTC-"	TokenNameStringLiteral	-Opções para XSLTC-
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
...
,	TokenNameCOMMA	
" [-XSLTC (utilizar XSLTC para transformação)]"	TokenNameStringLiteral	 [-XSLTC (utilizar XSLTC para transformação)]
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
...
,	TokenNameCOMMA	
" [-E (Não expandir refs de entidade)]"	TokenNameStringLiteral	 [-E (Não expandir refs de entidade)]
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
...
,	TokenNameCOMMA	
" [-QC (Avisos de Conflitos de Padrão Silencioso)]"	TokenNameStringLiteral	 [-QC (Avisos de Conflitos de Padrão Silencioso)]
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
...
,	TokenNameCOMMA	
" [-LF (Utilizar avanços de linha apenas na saída {padrão é CR/LF})]"	TokenNameStringLiteral	 [-LF (Utilizar avanços de linha apenas na saída {padrão é CR/LF})]
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
"optionCR"	TokenNameStringLiteral	optionCR
,	TokenNameCOMMA	
" [-CR (Utilizar retornos de carro apenas na saída {padrão é CR/LF})]"	TokenNameStringLiteral	 [-CR (Utilizar retornos de carro apenas na saída {padrão é CR/LF})]
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
"optionESCAPE"	TokenNameStringLiteral	optionESCAPE
,	TokenNameCOMMA	
" [-ESCAPE (Quais caracteres de escape {padrão é <>&"'\r\n}]"	TokenNameStringLiteral	 [-ESCAPE (Quais caracteres de escape {padrão é <>&"'\r\n}]
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
"optionINDENT"	TokenNameStringLiteral	optionINDENT
,	TokenNameCOMMA	
" [-INDENT (Controlar como os espaços são recuados {padrão é 0})]"	TokenNameStringLiteral	 [-INDENT (Controlar como os espaços são recuados {padrão é 0})]
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
"optionTT"	TokenNameStringLiteral	optionTT
,	TokenNameCOMMA	
" [-TT (Rastrear os templates enquanto estão sendo chamados.)]"	TokenNameStringLiteral	 [-TT (Rastrear os templates enquanto estão sendo chamados.)]
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
"optionTG"	TokenNameStringLiteral	optionTG
,	TokenNameCOMMA	
" [-TG (Rastrear cada evento de geração.)]"	TokenNameStringLiteral	 [-TG (Rastrear cada evento de geração.)]
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
"optionTS"	TokenNameStringLiteral	optionTS
,	TokenNameCOMMA	
" [-TS (Rastrear cada evento de seleção.)]"	TokenNameStringLiteral	 [-TS (Rastrear cada evento de seleção.)]
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
"optionTTC"	TokenNameStringLiteral	optionTTC
,	TokenNameCOMMA	
" [-TTC (Rastrear os filhos do modelo enquanto estão sendo processados.)]"	TokenNameStringLiteral	 [-TTC (Rastrear os filhos do modelo enquanto estão sendo processados.)]
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
"optionTCLASS"	TokenNameStringLiteral	optionTCLASS
,	TokenNameCOMMA	
" [-TCLASS (Classe TraceListener para extensões de rastreio.)]"	TokenNameStringLiteral	 [-TCLASS (Classe TraceListener para extensões de rastreio.)]
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
"optionVALIDATE"	TokenNameStringLiteral	optionVALIDATE
,	TokenNameCOMMA	
" [-VALIDATE (Definir se ocorrer validação. A validação fica desativada por padrão.)]"	TokenNameStringLiteral	 [-VALIDATE (Definir se ocorrer validação. A validação fica desativada por padrão.)]
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
...
,	TokenNameCOMMA	
" [-XML (Utilizar formatador XML e incluir cabeçalho XML.)]"	TokenNameStringLiteral	 [-XML (Utilizar formatador XML e incluir cabeçalho XML.)]
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
...
,	TokenNameCOMMA	
" [-PARAM expressão de nome (Definir um parâmetro stylesheet)]"	TokenNameStringLiteral	 [-PARAM expressão de nome (Definir um parâmetro stylesheet)]
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
"noParsermsg1"	TokenNameStringLiteral	noParsermsg1
,	TokenNameCOMMA	
"O Processo XSL não obteve êxito."	TokenNameStringLiteral	O Processo XSL não obteve êxito.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
"noParsermsg2"	TokenNameStringLiteral	noParsermsg2
,	TokenNameCOMMA	
"** Não foi possível encontrar o analisador **"	TokenNameStringLiteral	** Não foi possível encontrar o analisador **
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
...
,	TokenNameCOMMA	
"Se você não tiver o XML Parser para Java da IBM, poderá fazer o download dele a partir de"	TokenNameStringLiteral	Se você não tiver o XML Parser para Java da IBM, poderá fazer o download dele a partir de
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
...
,	TokenNameCOMMA	
" [-CONTENTHANDLER nome completo da classe (ContentHandler a ser utilizado para serializar saída)]"	TokenNameStringLiteral	 [-CONTENTHANDLER nome completo da classe (ContentHandler a ser utilizado para serializar saída)]
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
"optionLINENUMBERS"	TokenNameStringLiteral	optionLINENUMBERS
,	TokenNameCOMMA	
" [-L utilizar números de linha para documento de origem]"	TokenNameStringLiteral	 [-L utilizar números de linha para documento de origem]
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
...
,	TokenNameCOMMA	
" [-MEDIA mediaType (utilizar atributo de mídia para encontrar folha de estilo associada a um documento.)]"	TokenNameStringLiteral	 [-MEDIA mediaType (utilizar atributo de mídia para encontrar folha de estilo associada a um documento.)]
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
"optionFLAVOR"	TokenNameStringLiteral	optionFLAVOR
,	TokenNameCOMMA	
" [-FLAVOR flavorName (Utilizar explicitamente s2s=SAX ou d2d=DOM para executar transformação.)]"	TokenNameStringLiteral	 [-FLAVOR flavorName (Utilizar explicitamente s2s=SAX ou d2d=DOM para executar transformação.)]
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
,	TokenNameCOMMA	
" [-DIAG (Imprimir total de milissegundos que a transformação gastou.)]"	TokenNameStringLiteral	 [-DIAG (Imprimir total de milissegundos que a transformação gastou.)]
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
"optionINCREMENTAL"	TokenNameStringLiteral	optionINCREMENTAL
,	TokenNameCOMMA	
" [-INCREMENTAL (pedir construção incremental de DTM definindo http://xml.apache.org/xalan/features/incremental verdadeiro.)]"	TokenNameStringLiteral	 [-INCREMENTAL (pedir construção incremental de DTM definindo http://xml.apache.org/xalan/features/incremental verdadeiro.)]
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
"optionNOOPTIMIMIZE"	TokenNameStringLiteral	optionNOOPTIMIMIZE
,	TokenNameCOMMA	
" [-NOOPTIMIMIZE (não solicitar o processamento de otimização de folha de estilo definindo http://xml.apache.org/xalan/features/optimize false.)]"	TokenNameStringLiteral	 [-NOOPTIMIMIZE (não solicitar o processamento de otimização de folha de estilo definindo http://xml.apache.org/xalan/features/optimize false.)]
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
"optionRL"	TokenNameStringLiteral	optionRL
,	TokenNameCOMMA	
" [-RL recursionlimit (declarar limite numérico em profundidade de recorrência de folha de estilo.)]"	TokenNameStringLiteral	 [-RL recursionlimit (declarar limite numérico em profundidade de recorrência de folha de estilo.)]
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
...
,	TokenNameCOMMA	
" [-XD destinationDirectory (especificar um diretório de destino para translet)]"	TokenNameStringLiteral	 [-XD destinationDirectory (especificar um diretório de destino para translet)]
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
...
,	TokenNameCOMMA	
" [-XN (ativa a seqüência de templates)]"	TokenNameStringLiteral	 [-XN (ativa a seqüência de templates)]
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
"optionXX"	TokenNameStringLiteral	optionXX
,	TokenNameCOMMA	
" [-XX (ativa a saída de mensagem de depuração adicional)]"	TokenNameStringLiteral	 [-XX (ativa a saída de mensagem de depuração adicional)]
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
"optionXT"	TokenNameStringLiteral	optionXT
,	TokenNameCOMMA	
" [-XT (utilizar translet para transformação, se possível)]"	TokenNameStringLiteral	 [-XT (utilizar translet para transformação, se possível)]
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
"diagTiming"	TokenNameStringLiteral	diagTiming
,	TokenNameCOMMA	
" --------- Transformação de {0} via {1} levou {2} ms"	TokenNameStringLiteral	 --------- Transformação de {0} via {1} levou {2} ms
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
...
,	TokenNameCOMMA	
"o nome é"	TokenNameStringLiteral	o nome é
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
"matchPatternIs"	TokenNameStringLiteral	matchPatternIs
,	TokenNameCOMMA	
"o padrão de correspondência é"	TokenNameStringLiteral	o padrão de correspondência é
}	TokenNameRBRACE	
}	TokenNameRBRACE	
;	TokenNameSEMICOLON	
}	TokenNameRBRACE	
...
=	TokenNameEQUAL	
"PADRÃO "	TokenNameStringLiteral	PADRÃO 
;	TokenNameSEMICOLON	
