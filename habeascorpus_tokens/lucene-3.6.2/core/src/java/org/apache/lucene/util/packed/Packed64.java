...
;	TokenNameSEMICOLON	
/** * Space optimized random access capable array of values with a fixed number of * bits. For 32 bits/value and less, performance on 32 bit machines is not * optimal. Consider using {@link Packed32} for such a setup. * </p><p> * The implementation strives to avoid conditionals and expensive operations, * sacrificing code clarity to achieve better performance. */	TokenNameCOMMENT_JAVADOC	 Space optimized random access capable array of values with a fixed number of bits. For 32 bits/value and less, performance on 32 bit machines is not optimal. Consider using {@link Packed32} for such a setup. </p><p> The implementation strives to avoid conditionals and expensive operations, sacrificing code clarity to achieve better performance. 
...
;	TokenNameSEMICOLON	
//new int[BLOCK_SIZE+1][BLOCK_SIZE][BLOCK_SIZE+1]; 	TokenNameCOMMENT_LINE	new int[BLOCK_SIZE+1][BLOCK_SIZE][BLOCK_SIZE+1]; 
private	TokenNameprivate	
static	TokenNamestatic	
final	TokenNamefinal	
long	TokenNamelong	
...
;	TokenNameSEMICOLON	
// blocks.length * BLOCK_SIZE / elementBits - 1 	TokenNameCOMMENT_LINE	blocks.length * BLOCK_SIZE / elementBits - 1 
private	TokenNameprivate	
int	TokenNameint	
[	TokenNameLBRACKET	
]	TokenNameRBRACKET	
shifts	TokenNameIdentifier	 shifts
;	TokenNameSEMICOLON	
// The shifts for the current elementBits 	TokenNameCOMMENT_LINE	The shifts for the current elementBits 
private	TokenNameprivate	
long	TokenNamelong	
[	TokenNameLBRACKET	
]	TokenNameRBRACKET	
...
;	TokenNameSEMICOLON	
/** * Creates an array with the internal structures adjusted for the given * limits and initialized to 0. * @param valueCount the number of elements. * @param bitsPerValue the number of bits available for any given value. */	TokenNameCOMMENT_JAVADOC	 Creates an array with the internal structures adjusted for the given limits and initialized to 0. @param valueCount the number of elements. @param bitsPerValue the number of bits available for any given value. 
...
{	TokenNameLBRACE	
// TODO: Test for edge-cases (2^31 values, 63 bitsPerValue) 	TokenNameCOMMENT_LINE	TODO: Test for edge-cases (2^31 values, 63 bitsPerValue) 
// +2 due to the avoid-conditionals-trick. The last entry is always 0 	TokenNameCOMMENT_LINE	+2 due to the avoid-conditionals-trick. The last entry is always 0 
this	TokenNamethis	
(	TokenNameLPAREN	
new	TokenNamenew	
long	TokenNamelong	
...
// TODO: find a faster way to bulk-read longs... 	TokenNameCOMMENT_LINE	TODO: find a faster way to bulk-read longs... 
for	TokenNamefor	
(	TokenNameLPAREN	
int	TokenNameint	
...
length	TokenNameIdentifier	 length
:	TokenNameCOLON	
"elementPos: "	TokenNameStringLiteral	elementPos: 
+	TokenNamePLUS	
elementPos	TokenNameIdentifier	 element Pos
+	TokenNamePLUS	
"; blocks.len: "	TokenNameStringLiteral	; blocks.len: 
+	TokenNamePLUS	
blocks	TokenNameIdentifier	 blocks
.	TokenNameDOT	
length	TokenNameIdentifier	 length
...
{	TokenNameLBRACE	
return	TokenNamereturn	
"Packed64(bitsPerValue="	TokenNameStringLiteral	Packed64(bitsPerValue=
+	TokenNamePLUS	
bitsPerValue	TokenNameIdentifier	 bits Per Value
+	TokenNamePLUS	
