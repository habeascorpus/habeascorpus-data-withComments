...
;	TokenNameSEMICOLON	
/** * This processor removes invalid {@link SlopQueryNode} objects in the query * node tree. A {@link SlopQueryNode} is invalid if its child is neither a * {@link TokenizedPhraseQueryNode} nor a {@link MultiPhraseQueryNode}. <br/> * * @see SlopQueryNode */	TokenNameCOMMENT_JAVADOC	 This processor removes invalid {@link SlopQueryNode} objects in the query node tree. A {@link SlopQueryNode} is invalid if its child is neither a {@link TokenizedPhraseQueryNode} nor a {@link MultiPhraseQueryNode}. <br/> * @see SlopQueryNode 
