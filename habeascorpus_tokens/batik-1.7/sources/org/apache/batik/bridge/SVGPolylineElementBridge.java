...
svg	TokenNameIdentifier	 svg
.	TokenNameDOT	
SVGOMPolylineElement	TokenNameIdentifier	 SVGOM Polyline Element
;	TokenNameSEMICOLON	
import	TokenNameimport	
org	TokenNameIdentifier	 org
.	TokenNameDOT	
...
;	TokenNameSEMICOLON	
/** * Bridge class for the &lt;polyline> element. * * @author <a href="mailto:tkormann@apache.org">Thierry Kormann</a> * @version $Id: SVGPolylineElementBridge.java 594018 2007-11-12 04:17:41Z cam $ */	TokenNameCOMMENT_JAVADOC	 Bridge class for the &lt;polyline> element. * @author <a href="mailto:tkormann@apache.org">Thierry Kormann</a> @version $Id: SVGPolylineElementBridge.java 594018 2007-11-12 04:17:41Z cam $ 
...
{	TokenNameLBRACE	
/** * default shape for the update of 'points' when * the value is the empty string. */	TokenNameCOMMENT_JAVADOC	 default shape for the update of 'points' when the value is the empty string. 
protected	TokenNameprotected	
static	TokenNamestatic	
final	TokenNamefinal	
Shape	TokenNameIdentifier	 Shape
DEFAULT_SHAPE	TokenNameIdentifier	 DEFAULT  SHAPE
=	TokenNameEQUAL	
new	TokenNamenew	
GeneralPath	TokenNameIdentifier	 General Path
(	TokenNameLPAREN	
...
;	TokenNameSEMICOLON	
/** * Constructs a new bridge for the &lt;polyline> element. */	TokenNameCOMMENT_JAVADOC	 Constructs a new bridge for the &lt;polyline> element. 
public	TokenNamepublic	
SVGPolylineElementBridge	TokenNameIdentifier	 SVG Polyline Element Bridge
(	TokenNameLPAREN	
)	TokenNameRPAREN	
...
/** * Returns 'polyline'. */	TokenNameCOMMENT_JAVADOC	 Returns 'polyline'. 
public	TokenNamepublic	
...
/** * Constructs a polyline according to the specified parameters. * * @param ctx the bridge context to use * @param e the element that describes a rect element * @param shapeNode the shape node to initialize */	TokenNameCOMMENT_JAVADOC	 Constructs a polyline according to the specified parameters. * @param ctx the bridge context to use @param e the element that describes a rect element @param shapeNode the shape node to initialize 
protected	TokenNameprotected	
void	TokenNamevoid	
...
{	TokenNameLBRACE	
SVGOMAnimatedPoints	TokenNameIdentifier	 SVGOM Animated Points
_points	TokenNameIdentifier	 points
=	TokenNameEQUAL	
pe	TokenNameIdentifier	 pe
.	TokenNameDOT	
...
SVGCSSEngine	TokenNameIdentifier	 SVGCSS Engine
.	TokenNameDOT	
FILL_RULE_INDEX	TokenNameIdentifier	 FILL  RULE  INDEX
:	TokenNameCOLON	
buildShape	TokenNameIdentifier	 build Shape
(	TokenNameLPAREN	
ctx	TokenNameIdentifier	 ctx
