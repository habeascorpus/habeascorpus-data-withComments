...
Component	TokenNameIdentifier	 Component
;	TokenNameSEMICOLON	
/** * Resolves conflicting artifacts by always selecting the <em>oldest</em> declaration. Oldest is defined as the * declaration whose version is less according to <code>ArtifactVersion.compareTo</code>. * * @author <a href="mailto:markhobson@gmail.com">Mark Hobson</a> * @see ArtifactVersion#compareTo * @since 3.0 */	TokenNameCOMMENT_JAVADOC	 Resolves conflicting artifacts by always selecting the <em>oldest</em> declaration. Oldest is defined as the declaration whose version is less according to <code>ArtifactVersion.compareTo</code>. * @author <a href="mailto:markhobson@gmail.com">Mark Hobson</a> @see ArtifactVersion#compareTo @since 3.0 
@	TokenNameAT	
Component	TokenNameIdentifier	 Component
(	TokenNameLPAREN	
