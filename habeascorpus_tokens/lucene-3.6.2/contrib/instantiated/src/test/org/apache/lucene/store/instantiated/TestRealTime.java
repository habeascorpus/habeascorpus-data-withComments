...
;	TokenNameSEMICOLON	
/** * Assert that the content of an index * is instantly available * for all open searchers * also after a commit. */	TokenNameCOMMENT_JAVADOC	 Assert that the content of an index is instantly available for all open searchers also after a commit. 
public	TokenNamepublic	
class	TokenNameclass	
TestRealTime	TokenNameIdentifier	 Test Real Time
...
;	TokenNameSEMICOLON	
InstantiatedIndexWriter	TokenNameIdentifier	 Instantiated Index Writer
