...
/* * $Id: ErrorMessages_zh_TW.java 468652 2006-10-28 07:05:17Z minchau $ */	TokenNameCOMMENT_BLOCK	 $Id: ErrorMessages_zh_TW.java 468652 2006-10-28 07:05:17Z minchau $ 
...
,	TokenNameCOMMA	
"?? DOMAdapter ??????? DOM ?????"	TokenNameStringLiteral	?? DOMAdapter ??????? DOM ?????
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
,	TokenNameCOMMA	
"??? translet ''{0}'' ?????? XSLTC ????????? XSLTC ?????????????????????? XSLTC ?????? translet?"	TokenNameStringLiteral	??? translet ''{0}'' ?????? XSLTC ????????? XSLTC ?????????????????????? XSLTC ?????? translet?
}	TokenNameRBRACE	
,	TokenNameCOMMA	
