...
/* * $Id: ErrorMessages_tr.java 468652 2006-10-28 07:05:17Z minchau $ */	TokenNameCOMMENT_BLOCK	 $Id: ErrorMessages_tr.java 468652 2006-10-28 07:05:17Z minchau $ 
...
,	TokenNameCOMMA	
"''{0}'' içinde yürütme zamanı iç hatası"	TokenNameStringLiteral	''{0}'' içinde yürütme zamanı iç hatası
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
,	TokenNameCOMMA	
"<xsl:copy> yürütülürken yürütme zamanı hatası."	TokenNameStringLiteral	<xsl:copy> yürütülürken yürütme zamanı hatası.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
,	TokenNameCOMMA	
"''{0}'' tipinden ''{1}'' tipine dönü?türme geçersiz."	TokenNameStringLiteral	''{0}'' tipinden ''{1}'' tipine dönü?türme geçersiz.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
,	TokenNameCOMMA	
"''{0}'' dı? i?levi XSLTC tarafından desteklenmiyor."	TokenNameStringLiteral	''{0}'' dı? i?levi XSLTC tarafından desteklenmiyor.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
,	TokenNameCOMMA	
"E?itlik ifadesinde bilinmeyen ba?ımsız de?i?ken tipi."	TokenNameStringLiteral	E?itlik ifadesinde bilinmeyen ba?ımsız de?i?ken tipi.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
,	TokenNameCOMMA	
"''{1}'' i?levi ça?rısında ba?ımsız de?i?ken tipi ''{0}'' geçersiz."	TokenNameStringLiteral	''{1}'' i?levi ça?rısında ba?ımsız de?i?ken tipi ''{0}'' geçersiz.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
,	TokenNameCOMMA	
"''{0}'' sayısını ''{1}'' örüntüsünü kullanarak biçimleme giri?imi."	TokenNameStringLiteral	''{0}'' sayısını ''{1}'' örüntüsünü kullanarak biçimleme giri?imi.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
,	TokenNameCOMMA	
"''{0}'' yineleyicisinin e?kopyası yaratılamıyor."	TokenNameStringLiteral	''{0}'' yineleyicisinin e?kopyası yaratılamıyor.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
,	TokenNameCOMMA	
"''{0}'' ekseni için yineleyici desteklenmiyor."	TokenNameStringLiteral	''{0}'' ekseni için yineleyici desteklenmiyor.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
/* * Note to translators: The following represents an internal error * situation in XSLTC. The processor attempted to create an iterator * for a particular axis (see definition above) that it does not * support. */	TokenNameCOMMENT_BLOCK	 Note to translators: The following represents an internal error situation in XSLTC. The processor attempted to create an iterator for a particular axis (see definition above) that it does not support. 
{	TokenNameLBRACE	
...
,	TokenNameCOMMA	
"Tip atanmı? ''{0}'' ekseni için yineleyici desteklenmiyor."	TokenNameStringLiteral	Tip atanmı? ''{0}'' ekseni için yineleyici desteklenmiyor.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
,	TokenNameCOMMA	
"DOMAdapter, yanlı? tipte kaynak DOM kullanılarak yaratıldı."	TokenNameStringLiteral	DOMAdapter, yanlı? tipte kaynak DOM kullanılarak yaratıldı.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
,	TokenNameCOMMA	
"Kullandı?ınız SAX ayrı?tırıcısı DTD bildirim olaylarını i?lemiyor."	TokenNameStringLiteral	Kullandı?ınız SAX ayrı?tırıcısı DTD bildirim olaylarını i?lemiyor.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
,	TokenNameCOMMA	
"Kullandı?ınız SAX ayrı?tırıcısının XML ad alanları deste?i yok."	TokenNameStringLiteral	Kullandı?ınız SAX ayrı?tırıcısının XML ad alanları deste?i yok.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
,	TokenNameCOMMA	
"''{0}'' URI ba?vurusu çözülemedi."	TokenNameStringLiteral	''{0}'' URI ba?vurusu çözülemedi.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
,	TokenNameCOMMA	
"XSL ö?esi ''{0}'' desteklenmiyor"	TokenNameStringLiteral	XSL ö?esi ''{0}'' desteklenmiyor
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
,	TokenNameCOMMA	
"XSLTC uzantısı ''{0}'' tanınmıyor"	TokenNameStringLiteral	XSLTC uzantısı ''{0}'' tanınmıyor
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
,	TokenNameCOMMA	
"Belirtilen derleme sonucu sınıf dosyası ''{0}'', kullanılmakta olan XSLTC sürümünden daha yeni bir XSLTC sürümüyle yaratılmı?. Biçem yapra?ını yeniden derlemeli ya da bu derleme sonucu sınıf dosyasını çalı?tırmak için daha yeni bir XSLTC sürümünü kullanmalısınız."	TokenNameStringLiteral	Belirtilen derleme sonucu sınıf dosyası ''{0}'', kullanılmakta olan XSLTC sürümünden daha yeni bir XSLTC sürümüyle yaratılmı?. Biçem yapra?ını yeniden derlemeli ya da bu derleme sonucu sınıf dosyasını çalı?tırmak için daha yeni bir XSLTC sürümünü kullanmalısınız.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
,	TokenNameCOMMA	
"De?erinin bir QName olması gereken özniteli?in de?eri ''{0}''"	TokenNameStringLiteral	De?erinin bir QName olması gereken özniteli?in de?eri ''{0}''
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
,	TokenNameCOMMA	
"De?erinin bir NCName olması gereken özniteli?in de?eri ''{0}''"	TokenNameStringLiteral	De?erinin bir NCName olması gereken özniteli?in de?eri ''{0}''
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
BasisLibrary	TokenNameIdentifier	 Basis Library
...
,	TokenNameCOMMA	
"Güvenli i?leme özelli?i true de?erine ayarlandı?ında ''{0}'' eklenti i?levinin kullanılmasına izin verilmez."	TokenNameStringLiteral	Güvenli i?leme özelli?i true de?erine ayarlandı?ında ''{0}'' eklenti i?levinin kullanılmasına izin verilmez.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
BasisLibrary	TokenNameIdentifier	 Basis Library
