...
/* * $Id: ErrorMessages_ca.java 468649 2006-10-28 07:00:55Z minchau $ */	TokenNameCOMMENT_BLOCK	 $Id: ErrorMessages_ca.java 468649 2006-10-28 07:00:55Z minchau $ 
...
,	TokenNameCOMMA	
"S'ha definit més d'un full d'estils en el mateix fitxer."	TokenNameStringLiteral	S'ha definit més d'un full d'estils en el mateix fitxer.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
,	TokenNameCOMMA	
"La plantilla ''{0}'' ja està definida en aquest full d''estil. "	TokenNameStringLiteral	La plantilla ''{0}'' ja està definida en aquest full d''estil. 
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
,	TokenNameCOMMA	
"La plantilla ''{0}'' no està definida en aquest full d''estil. "	TokenNameStringLiteral	La plantilla ''{0}'' no està definida en aquest full d''estil. 
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
,	TokenNameCOMMA	
"La variable ''{0}'' s''ha definit més d''una vegada en el mateix àmbit. "	TokenNameStringLiteral	La variable ''{0}'' s''ha definit més d''una vegada en el mateix àmbit. 
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
,	TokenNameCOMMA	
"La variable o el paràmetre ''{0}'' no s''ha definit. "	TokenNameStringLiteral	La variable o el paràmetre ''{0}'' no s''ha definit. 
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
,	TokenNameCOMMA	
"No es pot trobar la classe ''{0}''."	TokenNameStringLiteral	No es pot trobar la classe ''{0}''.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
,	TokenNameCOMMA	
"No es pot trobar el mètode extern ''{0}'' (ha de ser públic)."	TokenNameStringLiteral	No es pot trobar el mètode extern ''{0}'' (ha de ser públic).
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
,	TokenNameCOMMA	
"No es pot convertir el tipus d''argument/retorn en la crida al mètode ''{0}''"	TokenNameStringLiteral	No es pot convertir el tipus d''argument/retorn en la crida al mètode ''{0}''
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
,	TokenNameCOMMA	
"No s''ha trobat el fitxer o URI ''{0}''. "	TokenNameStringLiteral	No s''ha trobat el fitxer o URI ''{0}''. 
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
,	TokenNameCOMMA	
"L''URI ''{0}'' no és vàlid."	TokenNameStringLiteral	L''URI ''{0}'' no és vàlid.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
,	TokenNameCOMMA	
"No es pot obrir el fitxer o URI ''{0}''."	TokenNameStringLiteral	No es pot obrir el fitxer o URI ''{0}''.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
,	TokenNameCOMMA	
"S'esperava l'element <xsl:stylesheet> o <xsl:transform>."	TokenNameStringLiteral	S'esperava l'element <xsl:stylesheet> o <xsl:transform>.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
,	TokenNameCOMMA	
"No s''ha declarat el prefix de l''espai de noms ''{0}''. "	TokenNameStringLiteral	No s''ha declarat el prefix de l''espai de noms ''{0}''. 
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
,	TokenNameCOMMA	
"No es pot resoldre la crida a la funció ''{0}''."	TokenNameStringLiteral	No es pot resoldre la crida a la funció ''{0}''.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
,	TokenNameCOMMA	
"L''argument de ''{0}'' ha de ser una cadena de literals. "	TokenNameStringLiteral	L''argument de ''{0}'' ha de ser una cadena de literals. 
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
,	TokenNameCOMMA	
"Error en analitzar l''expressió XPath ''{0}''."	TokenNameStringLiteral	Error en analitzar l''expressió XPath ''{0}''.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
,	TokenNameCOMMA	
"Falta l''atribut obligatori ''{0}''. "	TokenNameStringLiteral	Falta l''atribut obligatori ''{0}''. 
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
,	TokenNameCOMMA	
"L''expressió XPath conté el caràcter no permès ''{0}''. "	TokenNameStringLiteral	L''expressió XPath conté el caràcter no permès ''{0}''. 
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
,	TokenNameCOMMA	
"La instrucció de procés conté el nom no permès ''{0}''. "	TokenNameStringLiteral	La instrucció de procés conté el nom no permès ''{0}''. 
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
,	TokenNameCOMMA	
"Atribut no permès ''{0}''."	TokenNameStringLiteral	Atribut no permès ''{0}''.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
,	TokenNameCOMMA	
"Import/include circular. El full d''estil ''{0}'' ja s''ha carregat. "	TokenNameStringLiteral	Import/include circular. El full d''estil ''{0}'' ja s''ha carregat. 
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
,	TokenNameCOMMA	
"Els fragments de l'arbre de resultats no es poden classificar (es passen per alt els elements <xsl:sort>). Heu de classificar els nodes quan creeu l'arbre de resultats."	TokenNameStringLiteral	Els fragments de l'arbre de resultats no es poden classificar (es passen per alt els elements <xsl:sort>). Heu de classificar els nodes quan creeu l'arbre de resultats.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
,	TokenNameCOMMA	
"El formatatge decimal ''{0}'' ja està definit."	TokenNameStringLiteral	El formatatge decimal ''{0}'' ja està definit.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
,	TokenNameCOMMA	
"XSLTC no dóna suport a la versió XSL ''{0}''. "	TokenNameStringLiteral	XSLTC no dóna suport a la versió XSL ''{0}''. 
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
,	TokenNameCOMMA	
"Hi ha una referència de variable/paràmetre circular a ''{0}''."	TokenNameStringLiteral	Hi ha una referència de variable/paràmetre circular a ''{0}''.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
,	TokenNameCOMMA	
"L'operador de l'expressió binària és desconegut."	TokenNameStringLiteral	L'operador de l'expressió binària és desconegut.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
,	TokenNameCOMMA	
"La crida de funció té arguments no permesos."	TokenNameStringLiteral	La crida de funció té arguments no permesos.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
,	TokenNameCOMMA	
"El segon argument de la funció document() ha de ser un conjunt de nodes."	TokenNameStringLiteral	El segon argument de la funció document() ha de ser un conjunt de nodes.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
,	TokenNameCOMMA	
"Es necessita com a mínim un element <xsl:when> a <xsl:choose>."	TokenNameStringLiteral	Es necessita com a mínim un element <xsl:when> a <xsl:choose>.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
,	TokenNameCOMMA	
"Només es permet un element <xsl:otherwise> a <xsl:choose>."	TokenNameStringLiteral	Només es permet un element <xsl:otherwise> a <xsl:choose>.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
/* * Note to translators: "<xsl:otherwise>" and "<xsl:choose>" are * keywords and should not be translated. This message describes a * syntax error in the stylesheet. */	TokenNameCOMMENT_BLOCK	 Note to translators: "<xsl:otherwise>" and "<xsl:choose>" are keywords and should not be translated. This message describes a syntax error in the stylesheet. 
{	TokenNameLBRACE	
...
,	TokenNameCOMMA	
"<xsl:otherwise> només es pot utilitzar dins de <xsl:choose>."	TokenNameStringLiteral	<xsl:otherwise> només es pot utilitzar dins de <xsl:choose>.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
/* * Note to translators: "<xsl:when>" and "<xsl:choose>" are keywords * and should not be translated. This message describes a syntax error * in the stylesheet. */	TokenNameCOMMENT_BLOCK	 Note to translators: "<xsl:when>" and "<xsl:choose>" are keywords and should not be translated. This message describes a syntax error in the stylesheet. 
{	TokenNameLBRACE	
...
,	TokenNameCOMMA	
"<xsl:when> només es pot utilitzar dins de <xsl:choose>."	TokenNameStringLiteral	<xsl:when> només es pot utilitzar dins de <xsl:choose>.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
,	TokenNameCOMMA	
"A <xsl:choose> només es permeten els elements <xsl:when> i <xsl:otherwise>."	TokenNameStringLiteral	A <xsl:choose> només es permeten els elements <xsl:when> i <xsl:otherwise>.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
,	TokenNameCOMMA	
"L'atribut 'name' falta a <xsl:attribute-set>."	TokenNameStringLiteral	L'atribut 'name' falta a <xsl:attribute-set>.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
,	TokenNameCOMMA	
"L'element subordinat no és permès."	TokenNameStringLiteral	L'element subordinat no és permès.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
,	TokenNameCOMMA	
"No podeu cridar un element ''{0}''"	TokenNameStringLiteral	No podeu cridar un element ''{0}''
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
,	TokenNameCOMMA	
"No podeu cridar un atribut ''{0}''"	TokenNameStringLiteral	No podeu cridar un atribut ''{0}''
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
,	TokenNameCOMMA	
"Hi ha dades fora de l'element de nivell superior <xsl:stylesheet>."	TokenNameStringLiteral	Hi ha dades fora de l'element de nivell superior <xsl:stylesheet>.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
,	TokenNameCOMMA	
"L'analitzador JAXP no s'ha configurat correctament"	TokenNameStringLiteral	L'analitzador JAXP no s'ha configurat correctament
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
,	TokenNameCOMMA	
"S''ha produït un error intern d''XSLTC irrecuperable: ''{0}''"	TokenNameStringLiteral	S''ha produït un error intern d''XSLTC irrecuperable: ''{0}''
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
,	TokenNameCOMMA	
"El document d'entrada no és un full d'estils (l'espai de noms XSL no s'ha declarat en l'element arrel)."	TokenNameStringLiteral	El document d'entrada no és un full d'estils (l'espai de noms XSL no s'ha declarat en l'element arrel).
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
,	TokenNameCOMMA	
"No s''ha pogut trobar la destinació del full d''estil ''{0}''."	TokenNameStringLiteral	No s''ha pogut trobar la destinació del full d''estil ''{0}''.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
,	TokenNameCOMMA	
"No s''ha implementat: ''{0}''."	TokenNameStringLiteral	No s''ha implementat: ''{0}''.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
,	TokenNameCOMMA	
"El document d'entrada no conté cap full d'estils XSL."	TokenNameStringLiteral	El document d'entrada no conté cap full d'estils XSL.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
,	TokenNameCOMMA	
"No s''ha pogut analitzar l''element ''{0}''"	TokenNameStringLiteral	No s''ha pogut analitzar l''element ''{0}''
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
,	TokenNameCOMMA	
"L'atribut use de <key> ha de ser node, node-set, string o number."	TokenNameStringLiteral	L'atribut use de <key> ha de ser node, node-set, string o number.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
,	TokenNameCOMMA	
"La versió del document XML de sortida ha de ser 1.0"	TokenNameStringLiteral	La versió del document XML de sortida ha de ser 1.0
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
,	TokenNameCOMMA	
"L'operador de l'expressió relacional és desconegut."	TokenNameStringLiteral	L'operador de l'expressió relacional és desconegut.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
,	TokenNameCOMMA	
"S''ha intentat utilitzar el conjunt d''atributs ''{0}'' que no existeix."	TokenNameStringLiteral	S''ha intentat utilitzar el conjunt d''atributs ''{0}'' que no existeix.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
,	TokenNameCOMMA	
"No es pot analitzar la plantilla del valor d''atribut ''{0}''."	TokenNameStringLiteral	No es pot analitzar la plantilla del valor d''atribut ''{0}''.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
,	TokenNameCOMMA	
"Es desconeix el tipus de dades de la signatura de la classe ''{0}''."	TokenNameStringLiteral	Es desconeix el tipus de dades de la signatura de la classe ''{0}''.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
,	TokenNameCOMMA	
"No es pot convertir el tipus de dades ''{0}'' a ''{1}''."	TokenNameStringLiteral	No es pot convertir el tipus de dades ''{0}'' a ''{1}''.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
,	TokenNameCOMMA	
"Templates no conté cap definició de classe translet."	TokenNameStringLiteral	Templates no conté cap definició de classe translet.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
/* * Note to translators: "Templates" is a Java class name that should * not be translated. */	TokenNameCOMMENT_BLOCK	 Note to translators: "Templates" is a Java class name that should not be translated. 
{	TokenNameLBRACE	
...
,	TokenNameCOMMA	
"Templates no conté cap classe amb el nom ''{0}''."	TokenNameStringLiteral	Templates no conté cap classe amb el nom ''{0}''.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
,	TokenNameCOMMA	
"No s''ha pogut carregar la classe translet ''{0}''."	TokenNameStringLiteral	No s''ha pogut carregar la classe translet ''{0}''.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ErrorMsg	TokenNameIdentifier	 Error Msg
...
,	TokenNameCOMMA	
"La classe translet s'ha carregat, però no s'ha pogut crear la instància translet."	TokenNameStringLiteral	La classe translet s'ha carregat, però no s'ha pogut crear la instància translet.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
,	TokenNameCOMMA	
"S''ha intentat establir ErrorListener de ''{0}'' en nul"	TokenNameStringLiteral	S''ha intentat establir ErrorListener de ''{0}'' en nul
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
,	TokenNameCOMMA	
"XSLTC només dóna suport a StreamSource, SAXSource i DOMSource."	TokenNameStringLiteral	XSLTC només dóna suport a StreamSource, SAXSource i DOMSource.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
,	TokenNameCOMMA	
"L''objecte source passat a ''{0}'' no té contingut. "	TokenNameStringLiteral	L''objecte source passat a ''{0}'' no té contingut. 
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
,	TokenNameCOMMA	
"No s'ha pogut compilar el full d'estils."	TokenNameStringLiteral	No s'ha pogut compilar el full d'estils.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
,	TokenNameCOMMA	
"TransformerFactory no reconeix l''atribut ''{0}''."	TokenNameStringLiteral	TransformerFactory no reconeix l''atribut ''{0}''.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
,	TokenNameCOMMA	
"setResult() s'ha de cridar abans de startDocument()."	TokenNameStringLiteral	setResult() s'ha de cridar abans de startDocument().
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
,	TokenNameCOMMA	
"Transformer no conté cap objecte translet."	TokenNameStringLiteral	Transformer no conté cap objecte translet.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
,	TokenNameCOMMA	
"No s'ha definit cap manejador de sortida per al resultat de transformació."	TokenNameStringLiteral	No s'ha definit cap manejador de sortida per al resultat de transformació.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
,	TokenNameCOMMA	
"L''objecte result passat a ''{0}'' no és vàlid. "	TokenNameStringLiteral	L''objecte result passat a ''{0}'' no és vàlid. 
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
,	TokenNameCOMMA	
"S''ha intentat accedir a una propietat Transformer no vàlida ''{0}''."	TokenNameStringLiteral	S''ha intentat accedir a una propietat Transformer no vàlida ''{0}''.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
,	TokenNameCOMMA	
"No s''ha pogut crear l''adaptador SAX2DOMr: ''{0}''."	TokenNameStringLiteral	No s''ha pogut crear l''adaptador SAX2DOMr: ''{0}''.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
,	TokenNameCOMMA	
"S'ha cridat XSLTCSource.build() sense que s'hagués establert la identificació del sistema."	TokenNameStringLiteral	S'ha cridat XSLTCSource.build() sense que s'hagués establert la identificació del sistema.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ErrorMsg	TokenNameIdentifier	 Error Msg
...
,	TokenNameCOMMA	
"L'opció -i s'ha d'utilitzar amb l'opció -o."	TokenNameStringLiteral	L'opció -i s'ha d'utilitzar amb l'opció -o.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
,	TokenNameCOMMA	
"RESUM java org.apache.xalan.xsltc.cmdline.Transform [-j <fitxer_jar>] [-x] [-n <iteracions>] {-u <url_document> | <document>} <classe> [<param1>=<valor1> ...] fa servir la <classe> translet per transformar un document XML especificat com <document>. La <classe> translet es troba o bé a la CLASSPATH de l'usuari o bé al <fitxer_jar> que es pot especificar opcionalment. OPCIONS -j <fitxer_jar> especifica un fitxer jar des del qual es carrega la classe translet -x habilita la sortida de missatges de depuració addicionals -n <iteracions> executa la transformació el nombre de vegades <iteracions> i mostra la informació de perfil -u <url_document> especifica el document d'entrada XML com una URL "	TokenNameStringLiteral	RESUM java org.apache.xalan.xsltc.cmdline.Transform [-j <fitxer_jar>] [-x] [-n <iteracions>] {-u <url_document> | <document>} <classe> [<param1>=<valor1> ...] fa servir la <classe> translet per transformar un document XML especificat com <document>. La <classe> translet es troba o bé a la CLASSPATH de l'usuari o bé al <fitxer_jar> que es pot especificar opcionalment. OPCIONS -j <fitxer_jar> especifica un fitxer jar des del qual es carrega la classe translet -x habilita la sortida de missatges de depuració addicionals -n <iteracions> executa la transformació el nombre de vegades <iteracions> i mostra la informació de perfil -u <url_document> especifica el document d'entrada XML com una URL 
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
,	TokenNameCOMMA	
"<xsl:sort> només es pot utilitzar amb <xsl:for-each> o <xsl:apply-templates>."	TokenNameStringLiteral	<xsl:sort> només es pot utilitzar amb <xsl:for-each> o <xsl:apply-templates>.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
,	TokenNameCOMMA	
"A aquesta JVM, no es dóna suport a la codificació de sortida ''{0}''."	TokenNameStringLiteral	A aquesta JVM, no es dóna suport a la codificació de sortida ''{0}''.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
,	TokenNameCOMMA	
"S''ha produït un error de sintaxi a ''{0}''."	TokenNameStringLiteral	S''ha produït un error de sintaxi a ''{0}''.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
,	TokenNameCOMMA	
"No es pot trobar el constructor extern ''{0}''."	TokenNameStringLiteral	No es pot trobar el constructor extern ''{0}''.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
,	TokenNameCOMMA	
"El primer argument de la funció Java no static ''{0}'' no és una referència d''objecte vàlida. "	TokenNameStringLiteral	El primer argument de la funció Java no static ''{0}'' no és una referència d''objecte vàlida. 
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
,	TokenNameCOMMA	
"S''ha produït un error en comprovar el tipus de l''expressió ''{0}''."	TokenNameStringLiteral	S''ha produït un error en comprovar el tipus de l''expressió ''{0}''.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
,	TokenNameCOMMA	
"S'ha produït un error en comprovar el tipus d'expressió en una ubicació desconeguda."	TokenNameStringLiteral	S'ha produït un error en comprovar el tipus d'expressió en una ubicació desconeguda.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
,	TokenNameCOMMA	
"L''opció de línia d''ordres ''{0}'' no és vàlida. "	TokenNameStringLiteral	L''opció de línia d''ordres ''{0}'' no és vàlida. 
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
,	TokenNameCOMMA	
"A l''opció de línia d''ordres ''{0}'' falta un argument obligatori. "	TokenNameStringLiteral	A l''opció de línia d''ordres ''{0}'' falta un argument obligatori. 
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
,	TokenNameCOMMA	
"AVÍS: ''{0}'' :{1}"	TokenNameStringLiteral	AVÍS: ''{0}'' :{1}
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
,	TokenNameCOMMA	
"AVÍS: ''{0}''"	TokenNameStringLiteral	AVÍS: ''{0}''
}	TokenNameRBRACE	
,	TokenNameCOMMA	
/* * Note to translators: This message is used to indicate the severity * of another message. The substitution text contains two error * messages. The spacing before the second substitution text indents * it the same amount as the first in English. */	TokenNameCOMMENT_BLOCK	 Note to translators: This message is used to indicate the severity of another message. The substitution text contains two error messages. The spacing before the second substitution text indents it the same amount as the first in English. 
{	TokenNameLBRACE	
...
,	TokenNameCOMMA	
"ERROR MOLT GREU: ''{0}'' :{1}"	TokenNameStringLiteral	ERROR MOLT GREU: ''{0}'' :{1}
}	TokenNameRBRACE	
,	TokenNameCOMMA	
/* * Note to translators: This message is used to indicate the severity * of another message. The substitution text is an error message. */	TokenNameCOMMENT_BLOCK	 Note to translators: This message is used to indicate the severity of another message. The substitution text is an error message. 
{	TokenNameLBRACE	
...
,	TokenNameCOMMA	
"ERROR MOLT GREU: ''{0}''"	TokenNameStringLiteral	ERROR MOLT GREU: ''{0}''
}	TokenNameRBRACE	
,	TokenNameCOMMA	
/* * Note to translators: This message is used to indicate the severity * of another message. The substitution text contains two error * messages. The spacing before the second substitution text indents * it the same amount as the first in English. */	TokenNameCOMMENT_BLOCK	 Note to translators: This message is used to indicate the severity of another message. The substitution text contains two error messages. The spacing before the second substitution text indents it the same amount as the first in English. 
{	TokenNameLBRACE	
...
,	TokenNameCOMMA	
"Transformació mitjançant la classe translet ''{0}'' "	TokenNameStringLiteral	Transformació mitjançant la classe translet ''{0}'' 
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
,	TokenNameCOMMA	
"Transformació mitjançant la classe translet ''{0}'' des del fitxer jar ''{1}''"	TokenNameStringLiteral	Transformació mitjançant la classe translet ''{0}'' des del fitxer jar ''{1}''
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
,	TokenNameCOMMA	
"No s''ha pogut crear una instància de la classe TransformerFactory ''{0}''."	TokenNameStringLiteral	No s''ha pogut crear una instància de la classe TransformerFactory ''{0}''.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
,	TokenNameCOMMA	
"Errors del compilador:"	TokenNameStringLiteral	Errors del compilador:
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
,	TokenNameCOMMA	
"Errors del translet:"	TokenNameStringLiteral	Errors del translet:
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
,	TokenNameCOMMA	
"Un atribut que ha de tenir el valor QName o una llista separada per espais de QNames tenia el valor ''{0}''"	TokenNameStringLiteral	Un atribut que ha de tenir el valor QName o una llista separada per espais de QNames tenia el valor ''{0}''
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
,	TokenNameCOMMA	
"L''atribut del mètode d''un element <xsl:sortida> tenia el valor ''{0}''. El valor ha de ser un de ''xml'', ''html'', ''text'', o ncname però no qname "	TokenNameStringLiteral	L''atribut del mètode d''un element <xsl:sortida> tenia el valor ''{0}''. El valor ha de ser un de ''xml'', ''html'', ''text'', o ncname però no qname 
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ErrorMsg	TokenNameIdentifier	 Error Msg
