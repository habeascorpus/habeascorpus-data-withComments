...
;	TokenNameSEMICOLON	
/** Enumerates all input (IntsRef) + output pairs in an * FST. * * @lucene.experimental */	TokenNameCOMMENT_JAVADOC	 Enumerates all input (IntsRef) + output pairs in an FST. * @lucene.experimental 
...
;	TokenNameSEMICOLON	
/** Holds a single input (IntsRef) + output pair. */	TokenNameCOMMENT_JAVADOC	 Holds a single input (IntsRef) + output pair. 
public	TokenNamepublic	
