...
Settings	TokenNameIdentifier	 Settings
;	TokenNameSEMICOLON	
/** * Handles deserialization of settings from some kind of textual format like XML. * * @author Benjamin Bentmann */	TokenNameCOMMENT_JAVADOC	 Handles deserialization of settings from some kind of textual format like XML. * @author Benjamin Bentmann 
...
=	TokenNameEQUAL	
"org.apache.maven.settings.io.isStrict"	TokenNameStringLiteral	org.apache.maven.settings.io.isStrict
;	TokenNameSEMICOLON	
/** * Reads the settings from the specified file. * * @param input The file to deserialize the settings from, must not be {@code null}. * @param options The options to use for deserialization, may be {@code null} to use the default values. * @return The deserialized settings, never {@code null}. * @throws IOException If the settings could not be deserialized. * @throws SettingsParseException If the input format could not be parsed. */	TokenNameCOMMENT_JAVADOC	 Reads the settings from the specified file. * @param input The file to deserialize the settings from, must not be {@code null}. @param options The options to use for deserialization, may be {@code null} to use the default values. @return The deserialized settings, never {@code null}. @throws IOException If the settings could not be deserialized. @throws SettingsParseException If the input format could not be parsed. 
Settings	TokenNameIdentifier	 Settings
...
;	TokenNameSEMICOLON	
/** * Reads the settings from the specified character reader. The reader will be automatically closed before the method * returns. * * @param input The reader to deserialize the settings from, must not be {@code null}. * @param options The options to use for deserialization, may be {@code null} to use the default values. * @return The deserialized settings, never {@code null}. * @throws IOException If the settings could not be deserialized. * @throws SettingsParseException If the input format could not be parsed. */	TokenNameCOMMENT_JAVADOC	 Reads the settings from the specified character reader. The reader will be automatically closed before the method returns. * @param input The reader to deserialize the settings from, must not be {@code null}. @param options The options to use for deserialization, may be {@code null} to use the default values. @return The deserialized settings, never {@code null}. @throws IOException If the settings could not be deserialized. @throws SettingsParseException If the input format could not be parsed. 
Settings	TokenNameIdentifier	 Settings
read	TokenNameIdentifier	 read
(	TokenNameLPAREN	
Reader	TokenNameIdentifier	 Reader
...
SettingsParseException	TokenNameIdentifier	 Settings Parse Exception
;	TokenNameSEMICOLON	
/** * Reads the settings from the specified byte stream. The stream will be automatically closed before the method * returns. * * @param input The stream to deserialize the settings from, must not be {@code null}. * @param options The options to use for deserialization, may be {@code null} to use the default values. * @return The deserialized settings, never {@code null}. * @throws IOException If the settings could not be deserialized. * @throws SettingsParseException If the input format could not be parsed. */	TokenNameCOMMENT_JAVADOC	 Reads the settings from the specified byte stream. The stream will be automatically closed before the method returns. * @param input The stream to deserialize the settings from, must not be {@code null}. @param options The options to use for deserialization, may be {@code null} to use the default values. @return The deserialized settings, never {@code null}. @throws IOException If the settings could not be deserialized. @throws SettingsParseException If the input format could not be parsed. 
Settings	TokenNameIdentifier	 Settings
read	TokenNameIdentifier	 read
(	TokenNameLPAREN	
InputStream	TokenNameIdentifier	 Input Stream
