...
.	TokenNameDOT	
RuleChain	TokenNameIdentifier	 Rule Chain
;	TokenNameSEMICOLON	
import	TokenNameimport	
org	TokenNameIdentifier	 org
.	TokenNameDOT	
...
;	TokenNameSEMICOLON	
/** * @see SubclassSetupTeardownRule */	TokenNameCOMMENT_JAVADOC	 @see SubclassSetupTeardownRule 
private	TokenNameprivate	
boolean	TokenNameboolean	
setupCalled	TokenNameIdentifier	 setup Called
;	TokenNameSEMICOLON	
/** * @see SubclassSetupTeardownRule */	TokenNameCOMMENT_JAVADOC	 @see SubclassSetupTeardownRule 
private	TokenNameprivate	
boolean	TokenNameboolean	
teardownCalled	TokenNameIdentifier	 teardown Called
;	TokenNameSEMICOLON	
private	TokenNameprivate	
static	TokenNamestatic	
Locale	TokenNameIdentifier	 Locale
...
;	TokenNameSEMICOLON	
/** * Restore these system property values in {@link #afterClassLuceneTestCaseJ4()}. */	TokenNameCOMMENT_JAVADOC	 Restore these system property values in {@link #afterClassLuceneTestCaseJ4()}. 
private	TokenNameprivate	
static	TokenNamestatic	
HashMap	TokenNameIdentifier	 Hash Map
<	TokenNameLESS	
...
String	TokenNameIdentifier	 String
>	TokenNameGREATER	
restoreProperties	TokenNameIdentifier	 restore Properties
=	TokenNameEQUAL	
new	TokenNamenew	
HashMap	TokenNameIdentifier	 Hash Map
<	TokenNameLESS	
...
;	TokenNameSEMICOLON	
/** * Stores the currently class under test. */	TokenNameCOMMENT_JAVADOC	 Stores the currently class under test. 
private	TokenNameprivate	
static	TokenNamestatic	
final	TokenNamefinal	
StoreClassNameRule	TokenNameIdentifier	 Store Class Name Rule
classNameRule	TokenNameIdentifier	 class Name Rule
=	TokenNameEQUAL	
new	TokenNamenew	
StoreClassNameRule	TokenNameIdentifier	 Store Class Name Rule
(	TokenNameLPAREN	
...
;	TokenNameSEMICOLON	
/** * Catch any uncaught exceptions on threads within the suite scope and fail the test/ * suite if they happen. */	TokenNameCOMMENT_JAVADOC	 Catch any uncaught exceptions on threads within the suite scope and fail the test/ suite if they happen. 
private	TokenNameprivate	
static	TokenNamestatic	
final	TokenNamefinal	
...
;	TokenNameSEMICOLON	
/** * These property keys will be ignored in verification of altered properties. * @see SystemPropertiesInvariantRule * @see #ruleChain * @see #classRules */	TokenNameCOMMENT_JAVADOC	 These property keys will be ignored in verification of altered properties. @see SystemPropertiesInvariantRule @see #ruleChain @see #classRules 
private	TokenNameprivate	
static	TokenNamestatic	
final	TokenNamefinal	
String	TokenNameIdentifier	 String
...
ignoredInvariantProperties	TokenNameIdentifier	 ignored Invariant Properties
=	TokenNameEQUAL	
{	TokenNameLBRACE	
"user.timezone"	TokenNameStringLiteral	user.timezone
}	TokenNameRBRACE	
;	TokenNameSEMICOLON	
/** * This controls how suite-level rules are nested. It is important that _all_ rules declared * in {@link LuceneTestCase} are executed in proper order if they depend on each * other. */	TokenNameCOMMENT_JAVADOC	 This controls how suite-level rules are nested. It is important that _all_ rules declared in {@link LuceneTestCase} are executed in proper order if they depend on each other. 
@	TokenNameAT	
ClassRule	TokenNameIdentifier	 Class Rule
public	TokenNamepublic	
static	TokenNamestatic	
TestRule	TokenNameIdentifier	 Test Rule
classRules	TokenNameIdentifier	 class Rules
=	TokenNameEQUAL	
RuleChain	TokenNameIdentifier	 Rule Chain
.	TokenNameDOT	
outerRule	TokenNameIdentifier	 outer Rule
(	TokenNameLPAREN	
new	TokenNamenew	
...
.	TokenNameDOT	
around	TokenNameIdentifier	 around
(	TokenNameLPAREN	
classNameRule	TokenNameIdentifier	 class Name Rule
)	TokenNameRPAREN	
.	TokenNameDOT	
...
;	TokenNameSEMICOLON	
/** * This controls how individual test rules are nested. It is important that _all_ rules declared * in {@link LuceneTestCase} are executed in proper order if they depend on each * other. */	TokenNameCOMMENT_JAVADOC	 This controls how individual test rules are nested. It is important that _all_ rules declared in {@link LuceneTestCase} are executed in proper order if they depend on each other. 
@	TokenNameAT	
Rule	TokenNameIdentifier	 Rule
public	TokenNamepublic	
final	TokenNamefinal	
...
(	TokenNameLPAREN	
new	TokenNamenew	
SaveThreadAndTestNameRule	TokenNameIdentifier	 Save Thread And Test Name Rule
(	TokenNameLPAREN	
)	TokenNameRPAREN	
)	TokenNameRPAREN	
.	TokenNameDOT	
...
(	TokenNameLPAREN	
new	TokenNamenew	
TestResultInterceptorRule	TokenNameIdentifier	 Test Result Interceptor Rule
(	TokenNameLPAREN	
)	TokenNameRPAREN	
)	TokenNameRPAREN	
.	TokenNameDOT	
...
(	TokenNameLPAREN	
new	TokenNamenew	
InternalSetupTeardownRule	TokenNameIdentifier	 Internal Setup Teardown Rule
(	TokenNameLPAREN	
)	TokenNameRPAREN	
)	TokenNameRPAREN	
.	TokenNameDOT	
...
(	TokenNameLPAREN	
new	TokenNamenew	
SubclassSetupTeardownRule	TokenNameIdentifier	 Subclass Setup Teardown Rule
(	TokenNameLPAREN	
)	TokenNameRPAREN	
)	TokenNameRPAREN	
;	TokenNameSEMICOLON	
...
;	TokenNameSEMICOLON	
// TimeZone.getDefault will set user.timezone to the default timezone of the user's locale. 	TokenNameCOMMENT_LINE	TimeZone.getDefault will set user.timezone to the default timezone of the user's locale. 
// So store the original property value and restore it at end. 	TokenNameCOMMENT_LINE	So store the original property value and restore it at end. 
restoreProperties	TokenNameIdentifier	 restore Properties
.	TokenNameDOT	
put	TokenNameIdentifier	 put
(	TokenNameLPAREN	
...
/** * Control the outcome of each test's output status (failure, assumption-failure). This * would ideally be handled by attaching a {@link RunListener} to a {@link Runner} (because * then we would be notified about static block failures). */	TokenNameCOMMENT_JAVADOC	 Control the outcome of each test's output status (failure, assumption-failure). This would ideally be handled by attaching a {@link RunListener} to a {@link Runner} (because then we would be notified about static block failures). 
private	TokenNameprivate	
class	TokenNameclass	
TestResultInterceptorRule	TokenNameIdentifier	 Test Result Interceptor Rule
...
{	TokenNameLBRACE	
assumptionIgnored	TokenNameIdentifier	 assumption Ignored
(	TokenNameLPAREN	
e	TokenNameIdentifier	 e
,	TokenNameCOMMA	
description	TokenNameIdentifier	 description
...
;	TokenNameSEMICOLON	
/** * @see LuceneTestCase#testCaseThread */	TokenNameCOMMENT_JAVADOC	 @see LuceneTestCase#testCaseThread 
private	TokenNameprivate	
class	TokenNameclass	
SaveThreadAndTestNameRule	TokenNameIdentifier	 Save Thread And Test Name Rule
implements	TokenNameimplements	
...
private	TokenNameprivate	
String	TokenNameIdentifier	 String
previousName	TokenNameIdentifier	 previous Name
;	TokenNameSEMICOLON	
// @Override 	TokenNameCOMMENT_LINE	@Override 
public	TokenNamepublic	
Statement	TokenNameIdentifier	 Statement
...
/** * Internal {@link LuceneTestCase} setup before/after each test. */	TokenNameCOMMENT_JAVADOC	 Internal {@link LuceneTestCase} setup before/after each test. 
private	TokenNameprivate	
class	TokenNameclass	
InternalSetupTeardownRule	TokenNameIdentifier	 Internal Setup Teardown Rule
implements	TokenNameimplements	
...
Throwable	TokenNameIdentifier	 Throwable
{	TokenNameLBRACE	
// We simulate the previous behavior of @Before in that 	TokenNameCOMMENT_LINE	We simulate the previous behavior of @Before in that 
// if any statement below us fails, we just propagate the original 	TokenNameCOMMENT_LINE	if any statement below us fails, we just propagate the original 
// exception and do not call tearDownInternal. 	TokenNameCOMMENT_LINE	exception and do not call tearDownInternal. 
setUpInternal	TokenNameIdentifier	 set Up Internal
(	TokenNameLPAREN	
)	TokenNameRPAREN	
;	TokenNameSEMICOLON	
final	TokenNamefinal	
...
try	TokenNametry	
{	TokenNameLBRACE	
// But we will collect errors from statements below and wrap them 	TokenNameCOMMENT_LINE	But we will collect errors from statements below and wrap them 
// into a multiple so that tearDownInternal is called. 	TokenNameCOMMENT_LINE	into a multiple so that tearDownInternal is called. 
base	TokenNameIdentifier	 base
.	TokenNameDOT	
evaluate	TokenNameIdentifier	 evaluate
(	TokenNameLPAREN	
...
try	TokenNametry	
{	TokenNameLBRACE	
tearDownInternal	TokenNameIdentifier	 tear Down Internal
(	TokenNameLPAREN	
)	TokenNameRPAREN	
;	TokenNameSEMICOLON	
}	TokenNameRBRACE	
...
/** * Setup before the tests. */	TokenNameCOMMENT_JAVADOC	 Setup before the tests. 
private	TokenNameprivate	
final	TokenNamefinal	
void	TokenNamevoid	
setUpInternal	TokenNameIdentifier	 set Up Internal
...
setName	TokenNameIdentifier	 set Name
(	TokenNameLPAREN	
"LTC-main#seed="	TokenNameStringLiteral	LTC-main#seed=
+	TokenNamePLUS	
new	TokenNamenew	
ThreeLongs	TokenNameIdentifier	 Three Longs
(	TokenNameLPAREN	
...
/** * Make sure {@link #setUp()} and {@link #tearDown()} were invoked even if they * have been overriden. We assume nobody will call these out of non-overriden * methods (they have to be public by contract, unfortunately). The top-level * methods just set a flag that is checked upon successful execution of each test * case. */	TokenNameCOMMENT_JAVADOC	 Make sure {@link #setUp()} and {@link #tearDown()} were invoked even if they have been overriden. We assume nobody will call these out of non-overriden methods (they have to be public by contract, unfortunately). The top-level methods just set a flag that is checked upon successful execution of each test case. 
private	TokenNameprivate	
class	TokenNameclass	
SubclassSetupTeardownRule	TokenNameIdentifier	 Subclass Setup Teardown Rule
implements	TokenNameimplements	
...
;	TokenNameSEMICOLON	
// I assume we don't want to check teardown chaining if something happens in the 	TokenNameCOMMENT_LINE	I assume we don't want to check teardown chaining if something happens in the 
// test because this would obscure the original exception? 	TokenNameCOMMENT_LINE	test because this would obscure the original exception? 
if	TokenNameif	
(	TokenNameLPAREN	
!	TokenNameNOT	
setupCalled	TokenNameIdentifier	 setup Called
...
/** * For subclassing only. Overrides must call {@code super.setUp()}. */	TokenNameCOMMENT_JAVADOC	 For subclassing only. Overrides must call {@code super.setUp()}. 
@	TokenNameAT	
Before	TokenNameIdentifier	 Before
public	TokenNamepublic	
void	TokenNamevoid	
...
/** * For subclassing only. Overrides must call {@code super.tearDown()}. */	TokenNameCOMMENT_JAVADOC	 For subclassing only. Overrides must call {@code super.tearDown()}. 
@	TokenNameAT	
After	TokenNameIdentifier	 After
public	TokenNamepublic	
void	TokenNamevoid	
...
/** * Clean up after tests. */	TokenNameCOMMENT_JAVADOC	 Clean up after tests. 
private	TokenNameprivate	
final	TokenNamefinal	
void	TokenNamevoid	
tearDownInternal	TokenNameIdentifier	 tear Down Internal
...
;	TokenNameSEMICOLON	
// TODO: simply rethrow problem, without wrapping? 	TokenNameCOMMENT_LINE	TODO: simply rethrow problem, without wrapping? 
throw	TokenNamethrow	
new	TokenNamenew	
RuntimeException	TokenNameIdentifier	 Runtime Exception
(	TokenNameLPAREN	
...
r	TokenNameIdentifier	 r
,	TokenNameCOMMA	
maybeNRTWrap	TokenNameIdentifier	 maybe NRT Wrap
(	TokenNameLPAREN	
r	TokenNameIdentifier	 r
,	TokenNameCOMMA	
impl	TokenNameIdentifier	 impl
...
println	TokenNameIdentifier	 println
(	TokenNameLPAREN	
"NOTE: LuceneTestCase.newDirectory: returning "	TokenNameStringLiteral	NOTE: LuceneTestCase.newDirectory: returning 
+	TokenNamePLUS	
dir	TokenNameIdentifier	 dir
)	TokenNameRPAREN	
;	TokenNameSEMICOLON	
...
/** * Return the current class being tested. */	TokenNameCOMMENT_JAVADOC	 Return the current class being tested. 
public	TokenNamepublic	
static	TokenNamestatic	
Class	TokenNameIdentifier	 Class
<	TokenNameLESS	
