...
;	TokenNameSEMICOLON	
/** * Tests {@link EdgeNGramTokenFilter} for correctness. */	TokenNameCOMMENT_JAVADOC	 Tests {@link EdgeNGramTokenFilter} for correctness. 
public	TokenNamepublic	
class	TokenNameclass	
EdgeNGramTokenFilterTest	TokenNameIdentifier	 Edge N Gram Token Filter Test
...
public	TokenNamepublic	
void	TokenNamevoid	
testSmallTokenInStream	TokenNameIdentifier	 test Small Token In Stream
(	TokenNameLPAREN	
)	TokenNameRPAREN	
throws	TokenNamethrows	
Exception	TokenNameIdentifier	 Exception
...
StringReader	TokenNameIdentifier	 String Reader
(	TokenNameLPAREN	
"abc de fgh"	TokenNameStringLiteral	abc de fgh
)	TokenNameRPAREN	
,	TokenNameCOMMA	
MockTokenizer	TokenNameIdentifier	 Mock Tokenizer
.	TokenNameDOT	
...
// EdgeNgram blindly adds term length to offset, but this can take things out of bounds 	TokenNameCOMMENT_LINE	EdgeNgram blindly adds term length to offset, but this can take things out of bounds 
// wrt original text if a previous filter increases the length of the word (in this case æ -> ae) 	TokenNameCOMMENT_LINE	wrt original text if a previous filter increases the length of the word (in this case æ -> ae) 
// so in this case we behave like WDF, and preserve any modified offsets 	TokenNameCOMMENT_LINE	so in this case we behave like WDF, and preserve any modified offsets 
public	TokenNamepublic	
void	TokenNamevoid	
testInvalidOffsets	TokenNameIdentifier	 test Invalid Offsets
(	TokenNameLPAREN	
)	TokenNameRPAREN	
throws	TokenNamethrows	
Exception	TokenNameIdentifier	 Exception
...
{	TokenNameLBRACE	
"mo"	TokenNameStringLiteral	mo
,	TokenNameCOMMA	
"mos"	TokenNameStringLiteral	mos
,	TokenNameCOMMA	
"mosf"	TokenNameStringLiteral	mosf
,	TokenNameCOMMA	
"mosfe"	TokenNameStringLiteral	mosfe
,	TokenNameCOMMA	
"mosfel"	TokenNameStringLiteral	mosfel
,	TokenNameCOMMA	
"mosfell"	TokenNameStringLiteral	mosfell
,	TokenNameCOMMA	
"mosfells"	TokenNameStringLiteral	mosfells
,	TokenNameCOMMA	
"mosfellsb"	TokenNameStringLiteral	mosfellsb
,	TokenNameCOMMA	
"mosfellsba"	TokenNameStringLiteral	mosfellsba
,	TokenNameCOMMA	
"mosfellsbae"	TokenNameStringLiteral	mosfellsbae
,	TokenNameCOMMA	
