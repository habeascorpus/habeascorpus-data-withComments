...
MarshalException	TokenNameIdentifier	 Marshal Exception
{	TokenNameLBRACE	
// all bytes are legal. 	TokenNameCOMMENT_LINE	all bytes are legal. 
}	TokenNameRBRACE	
@	TokenNameAT	
...
{	TokenNameLBRACE	
// Both asciiType and utf8Type really use bytes comparison and 	TokenNameCOMMENT_LINE	Both asciiType and utf8Type really use bytes comparison and 
// bytesType validate everything, so it is compatible with the former. 	TokenNameCOMMENT_LINE	bytesType validate everything, so it is compatible with the former. 
return	TokenNamereturn	
this	TokenNamethis	
==	TokenNameEQUAL_EQUAL	
previous	TokenNameIdentifier	 previous
