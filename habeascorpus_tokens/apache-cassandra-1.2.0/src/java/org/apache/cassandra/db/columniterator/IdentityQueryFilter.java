...
SliceQueryFilter	TokenNameIdentifier	 Slice Query Filter
{	TokenNameLBRACE	
/** * Only for use in testing; will read entire CF into memory. */	TokenNameCOMMENT_JAVADOC	 Only for use in testing; will read entire CF into memory. 
public	TokenNamepublic	
IdentityQueryFilter	TokenNameIdentifier	 Identity Query Filter
(	TokenNameLPAREN	
)	TokenNameRPAREN	
...
{	TokenNameLBRACE	
// no filtering done, deliberately 	TokenNameCOMMENT_LINE	no filtering done, deliberately 
