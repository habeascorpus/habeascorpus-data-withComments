...
;	TokenNameSEMICOLON	
/** * This attribute is used by {@link MultiFieldQueryNodeProcessor} processor and * it should be defined in a {@link FieldConfig}. This processor uses this * attribute to define which boost a specific field should have when none is * defined to it. <br/> * <br/> * * @deprecated * */	TokenNameCOMMENT_JAVADOC	 This attribute is used by {@link MultiFieldQueryNodeProcessor} processor and it should be defined in a {@link FieldConfig}. This processor uses this attribute to define which boost a specific field should have when none is defined to it. <br/> <br/> * @deprecated 
@	TokenNameAT	
