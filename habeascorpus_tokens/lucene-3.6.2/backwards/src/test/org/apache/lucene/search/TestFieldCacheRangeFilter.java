...
scoreDocs	TokenNameIdentifier	 score Docs
;	TokenNameSEMICOLON	
//behaviour change: assertFalse("DocIdSet must be not cacheable", fcrf.getDocIdSet(reader.getSequentialSubReaders()[0]).isCacheable()); 	TokenNameCOMMENT_LINE	behaviour change: assertFalse("DocIdSet must be not cacheable", fcrf.getDocIdSet(reader.getSequentialSubReaders()[0]).isCacheable()); 
assertEquals	TokenNameIdentifier	 assert Equals
(	TokenNameLPAREN	
"find all"	TokenNameStringLiteral	find all
,	TokenNameCOMMA	
...
scoreDocs	TokenNameIdentifier	 score Docs
;	TokenNameSEMICOLON	
//behaviour change: assertTrue("DocIdSet must be cacheable", fcrf.getDocIdSet(reader.getSequentialSubReaders()[0]).isCacheable()); 	TokenNameCOMMENT_LINE	behaviour change: assertTrue("DocIdSet must be cacheable", fcrf.getDocIdSet(reader.getSequentialSubReaders()[0]).isCacheable()); 
assertEquals	TokenNameIdentifier	 assert Equals
(	TokenNameLPAREN	
"find all"	TokenNameStringLiteral	find all
,	TokenNameCOMMA	
