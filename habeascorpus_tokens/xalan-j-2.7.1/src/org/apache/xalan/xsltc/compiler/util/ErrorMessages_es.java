...
/* * $Id: ErrorMessages_es.java 468649 2006-10-28 07:00:55Z minchau $ */	TokenNameCOMMENT_BLOCK	 $Id: ErrorMessages_es.java 468649 2006-10-28 07:00:55Z minchau $ 
...
,	TokenNameCOMMA	
"Hay más de una hoja de estilos definida en el mismo archivo."	TokenNameStringLiteral	Hay más de una hoja de estilos definida en el mismo archivo.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
,	TokenNameCOMMA	
"La plantilla ''{0}'' ya está definida en esta hoja de estilos."	TokenNameStringLiteral	La plantilla ''{0}'' ya está definida en esta hoja de estilos.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
,	TokenNameCOMMA	
"La plantilla ''{0}'' no está definida en esta hoja de estilos."	TokenNameStringLiteral	La plantilla ''{0}'' no está definida en esta hoja de estilos.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
,	TokenNameCOMMA	
"La variable ''{0}'' se ha definido varias veces en el mismo ámbito."	TokenNameStringLiteral	La variable ''{0}'' se ha definido varias veces en el mismo ámbito.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
,	TokenNameCOMMA	
"La variable o el parámetro ''{0}'' no están definidos."	TokenNameStringLiteral	La variable o el parámetro ''{0}'' no están definidos.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
,	TokenNameCOMMA	
"No se puede encontrar la clase ''{0}''."	TokenNameStringLiteral	No se puede encontrar la clase ''{0}''.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
,	TokenNameCOMMA	
"No se puede encontrar el método externo ''{0}'' (debe ser público)."	TokenNameStringLiteral	No se puede encontrar el método externo ''{0}'' (debe ser público).
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
,	TokenNameCOMMA	
"No se puede convertir el argumento/tipo de devolución en la llamada al método ''{0}''"	TokenNameStringLiteral	No se puede convertir el argumento/tipo de devolución en la llamada al método ''{0}''
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
,	TokenNameCOMMA	
"Archivo o URI ''{0}'' no encontrado."	TokenNameStringLiteral	Archivo o URI ''{0}'' no encontrado.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
,	TokenNameCOMMA	
"URI ''{0}'' no válido."	TokenNameStringLiteral	URI ''{0}'' no válido.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
,	TokenNameCOMMA	
"No se puede abrir el archivo o URI ''{0}''."	TokenNameStringLiteral	No se puede abrir el archivo o URI ''{0}''.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
,	TokenNameCOMMA	
"Se esperaba el elemento <xsl:stylesheet> o <xsl:transform>."	TokenNameStringLiteral	Se esperaba el elemento <xsl:stylesheet> o <xsl:transform>.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
,	TokenNameCOMMA	
"El prefijo ''{0}'' del espacio de nombres no está declarado."	TokenNameStringLiteral	El prefijo ''{0}'' del espacio de nombres no está declarado.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
,	TokenNameCOMMA	
"No se puede resolver la llamada a la función ''{0}''."	TokenNameStringLiteral	No se puede resolver la llamada a la función ''{0}''.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
,	TokenNameCOMMA	
"El argumento para ''{0}'' debe ser una serie literal."	TokenNameStringLiteral	El argumento para ''{0}'' debe ser una serie literal.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
,	TokenNameCOMMA	
"Error al analizar la expresión ''{0}'' de XPath."	TokenNameStringLiteral	Error al analizar la expresión ''{0}'' de XPath.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
,	TokenNameCOMMA	
"Falta el atributo necesario ''{0}''."	TokenNameStringLiteral	Falta el atributo necesario ''{0}''.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
,	TokenNameCOMMA	
"Carácter ''{0}'' no permitido en expresión de XPath."	TokenNameStringLiteral	Carácter ''{0}'' no permitido en expresión de XPath.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
,	TokenNameCOMMA	
"Nombre ''{0}'' no permitido para la instrucción de proceso."	TokenNameStringLiteral	Nombre ''{0}'' no permitido para la instrucción de proceso.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
,	TokenNameCOMMA	
"Atributo ''{0}'' no permitido."	TokenNameStringLiteral	Atributo ''{0}'' no permitido.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
,	TokenNameCOMMA	
"import/include circular. Hoja de estilos ''{0}'' ya cargada."	TokenNameStringLiteral	import/include circular. Hoja de estilos ''{0}'' ya cargada.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
,	TokenNameCOMMA	
"Los fragmentos del árbol de resultados no se pueden ordenar (elementos <xsl:sort> ignorados). Debe ordenar los nodos al crear el árbol de resultados."	TokenNameStringLiteral	Los fragmentos del árbol de resultados no se pueden ordenar (elementos <xsl:sort> ignorados). Debe ordenar los nodos al crear el árbol de resultados.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
,	TokenNameCOMMA	
"El formato decimal ''{0}'' ya está definido."	TokenNameStringLiteral	El formato decimal ''{0}'' ya está definido.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
,	TokenNameCOMMA	
"La versión de XSL ''{0}'' no está soportada por XSLTC."	TokenNameStringLiteral	La versión de XSL ''{0}'' no está soportada por XSLTC.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
,	TokenNameCOMMA	
"Referencia de variable/parámetro circular en ''{0}''."	TokenNameStringLiteral	Referencia de variable/parámetro circular en ''{0}''.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
,	TokenNameCOMMA	
"Operador desconocido para expresión binaria."	TokenNameStringLiteral	Operador desconocido para expresión binaria.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
,	TokenNameCOMMA	
"Argumento(s) no permitido(s) para llamada a función."	TokenNameStringLiteral	Argumento(s) no permitido(s) para llamada a función.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
,	TokenNameCOMMA	
"El segundo argumento de la función document() debe ser un conjunto de nodos."	TokenNameStringLiteral	El segundo argumento de la función document() debe ser un conjunto de nodos.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
,	TokenNameCOMMA	
"Se necesita al menos un elemento <xsl:when> en <xsl:choose>."	TokenNameStringLiteral	Se necesita al menos un elemento <xsl:when> en <xsl:choose>.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
,	TokenNameCOMMA	
"Sólo se permite un elemento <xsl:otherwise> en <xsl:choose>."	TokenNameStringLiteral	Sólo se permite un elemento <xsl:otherwise> en <xsl:choose>.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
/* * Note to translators: "<xsl:otherwise>" and "<xsl:choose>" are * keywords and should not be translated. This message describes a * syntax error in the stylesheet. */	TokenNameCOMMENT_BLOCK	 Note to translators: "<xsl:otherwise>" and "<xsl:choose>" are keywords and should not be translated. This message describes a syntax error in the stylesheet. 
{	TokenNameLBRACE	
...
,	TokenNameCOMMA	
"<xsl:otherwise> sólo puede utilizarse dentro de <xsl:choose>."	TokenNameStringLiteral	<xsl:otherwise> sólo puede utilizarse dentro de <xsl:choose>.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
/* * Note to translators: "<xsl:when>" and "<xsl:choose>" are keywords * and should not be translated. This message describes a syntax error * in the stylesheet. */	TokenNameCOMMENT_BLOCK	 Note to translators: "<xsl:when>" and "<xsl:choose>" are keywords and should not be translated. This message describes a syntax error in the stylesheet. 
{	TokenNameLBRACE	
...
,	TokenNameCOMMA	
"<xsl:when> sólo puede utilizarse dentro de <xsl:choose>."	TokenNameStringLiteral	<xsl:when> sólo puede utilizarse dentro de <xsl:choose>.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
,	TokenNameCOMMA	
"Sólo están permitidos los elementos <xsl:when> y <xsl:otherwise> en <xsl:choose>."	TokenNameStringLiteral	Sólo están permitidos los elementos <xsl:when> y <xsl:otherwise> en <xsl:choose>.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
,	TokenNameCOMMA	
"Falta el atributo 'name' en <xsl:attribute-set>."	TokenNameStringLiteral	Falta el atributo 'name' en <xsl:attribute-set>.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
,	TokenNameCOMMA	
"Elemento hijo no permitido."	TokenNameStringLiteral	Elemento hijo no permitido.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
,	TokenNameCOMMA	
"No puede llamar a un elemento ''{0}''"	TokenNameStringLiteral	No puede llamar a un elemento ''{0}''
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
,	TokenNameCOMMA	
"No puede llamar a un atributo ''{0}''"	TokenNameStringLiteral	No puede llamar a un atributo ''{0}''
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
,	TokenNameCOMMA	
"Datos de texto fuera del elemento <xsl:stylesheet> de nivel superior."	TokenNameStringLiteral	Datos de texto fuera del elemento <xsl:stylesheet> de nivel superior.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
,	TokenNameCOMMA	
"Analizador JAXP no configurado correctamente"	TokenNameStringLiteral	Analizador JAXP no configurado correctamente
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
,	TokenNameCOMMA	
"Error interno de XSLTC irrecuperable: ''{0}''"	TokenNameStringLiteral	Error interno de XSLTC irrecuperable: ''{0}''
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
,	TokenNameCOMMA	
"Extensión XSLTC ''{0}'' no reconocida."	TokenNameStringLiteral	Extensión XSLTC ''{0}'' no reconocida.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
,	TokenNameCOMMA	
"El documento de entrada no es una hoja de estilos (el espacio de nombres XSL no está declarado en el elemento raíz)."	TokenNameStringLiteral	El documento de entrada no es una hoja de estilos (el espacio de nombres XSL no está declarado en el elemento raíz).
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
,	TokenNameCOMMA	
"No se ha podido encontrar el destino de la hoja de estilos ''{0}''."	TokenNameStringLiteral	No se ha podido encontrar el destino de la hoja de estilos ''{0}''.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
,	TokenNameCOMMA	
"No implementado: ''{0}''."	TokenNameStringLiteral	No implementado: ''{0}''.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
,	TokenNameCOMMA	
"El documento de entrada no contiene una hoja de estilos XSL."	TokenNameStringLiteral	El documento de entrada no contiene una hoja de estilos XSL.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
,	TokenNameCOMMA	
"No se ha podido analizar el elemento ''{0}''"	TokenNameStringLiteral	No se ha podido analizar el elemento ''{0}''
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
,	TokenNameCOMMA	
"El atributo use de <key> debe ser node, node-set, string o number."	TokenNameStringLiteral	El atributo use de <key> debe ser node, node-set, string o number.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
,	TokenNameCOMMA	
"La versión del documento XML de salida debería ser 1.0"	TokenNameStringLiteral	La versión del documento XML de salida debería ser 1.0
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
,	TokenNameCOMMA	
"Operador desconocido para expresión relacional"	TokenNameStringLiteral	Operador desconocido para expresión relacional
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
,	TokenNameCOMMA	
"Intento de utilizar un conjunto de atributos no existente ''{0}''."	TokenNameStringLiteral	Intento de utilizar un conjunto de atributos no existente ''{0}''.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
,	TokenNameCOMMA	
"No se puede analizar la plantilla de valor del atributo ''{0}''."	TokenNameStringLiteral	No se puede analizar la plantilla de valor del atributo ''{0}''.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
,	TokenNameCOMMA	
"Tipo de datos desconocido en la firma de la clase ''{0}''."	TokenNameStringLiteral	Tipo de datos desconocido en la firma de la clase ''{0}''.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
,	TokenNameCOMMA	
"No se puede convertir el tipo de datos ''{0}'' a ''{1}''."	TokenNameStringLiteral	No se puede convertir el tipo de datos ''{0}'' a ''{1}''.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
,	TokenNameCOMMA	
"Templates no contiene una definición de clase translet válida."	TokenNameStringLiteral	Templates no contiene una definición de clase translet válida.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
/* * Note to translators: "Templates" is a Java class name that should * not be translated. */	TokenNameCOMMENT_BLOCK	 Note to translators: "Templates" is a Java class name that should not be translated. 
{	TokenNameLBRACE	
...
,	TokenNameCOMMA	
"Templates no contiene una clase con el nombre ''{0}''."	TokenNameStringLiteral	Templates no contiene una clase con el nombre ''{0}''.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
,	TokenNameCOMMA	
"No se ha podido cargar la clase translet ''{0}''."	TokenNameStringLiteral	No se ha podido cargar la clase translet ''{0}''.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ErrorMsg	TokenNameIdentifier	 Error Msg
...
,	TokenNameCOMMA	
"Clase translet cargada, pero no es posible crear una instancia translet."	TokenNameStringLiteral	Clase translet cargada, pero no es posible crear una instancia translet.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
,	TokenNameCOMMA	
"Intento de establecer ErrorListener para ''{0}'' en null"	TokenNameStringLiteral	Intento de establecer ErrorListener para ''{0}'' en null
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
,	TokenNameCOMMA	
"Sólo StreamSource, SAXSource y DOMSource están soportadas por XSLTC"	TokenNameStringLiteral	Sólo StreamSource, SAXSource y DOMSource están soportadas por XSLTC
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
,	TokenNameCOMMA	
"El objeto Source pasado a ''{0}'' no tiene contenido."	TokenNameStringLiteral	El objeto Source pasado a ''{0}'' no tiene contenido.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
,	TokenNameCOMMA	
"No se ha podido compilar la hoja de estilos"	TokenNameStringLiteral	No se ha podido compilar la hoja de estilos
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
,	TokenNameCOMMA	
"TransformerFactory no reconoce el atributo ''{0}''."	TokenNameStringLiteral	TransformerFactory no reconoce el atributo ''{0}''.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
,	TokenNameCOMMA	
"setResult() debe llamarse antes de startDocument()."	TokenNameStringLiteral	setResult() debe llamarse antes de startDocument().
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
,	TokenNameCOMMA	
"Transformer no tiene un objeto translet encapsulado."	TokenNameStringLiteral	Transformer no tiene un objeto translet encapsulado.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
,	TokenNameCOMMA	
"No se ha definido un manejador de salida para el resultado de la transformación."	TokenNameStringLiteral	No se ha definido un manejador de salida para el resultado de la transformación.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
,	TokenNameCOMMA	
"El objeto Result pasado a ''{0}'' no es válido."	TokenNameStringLiteral	El objeto Result pasado a ''{0}'' no es válido.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
,	TokenNameCOMMA	
"Intento de acceder a una propiedad de Transformer ''{0}'' no válida."	TokenNameStringLiteral	Intento de acceder a una propiedad de Transformer ''{0}'' no válida.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
,	TokenNameCOMMA	
"No se ha podido crear adaptador SAX2DOMr: ''{0}''."	TokenNameStringLiteral	No se ha podido crear adaptador SAX2DOMr: ''{0}''.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
,	TokenNameCOMMA	
"XSLTCSource.build() llamado sin establecer systemId."	TokenNameStringLiteral	XSLTCSource.build() llamado sin establecer systemId.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ErrorMsg	TokenNameIdentifier	 Error Msg
...
,	TokenNameCOMMA	
"La opción -i debe utilizarse con la opción -o."	TokenNameStringLiteral	La opción -i debe utilizarse con la opción -o.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
,	TokenNameCOMMA	
"SINOPSIS java org.apache.xalan.xsltc.cmdline.Compile [-o <salida>] [-d <directory>] [-j <archivojar>] [-p <paquete>] [-n] [-x] [-u] [-v] [-h] { <stylesheet> | -i } OPCIONES -o <salida> asigna el nombre <salida> al translet generado. De forma predeterminada, el nombre del translet se deriva del nombre de la <hojaestilos>. Esta opción se ignora si se compilan varias hojas de estilos. -d <directorio> especificar un directorio de destino para el translet -j <archivojar> empaqueta las clases translet en el archivo jar del nombre especificado por <archivojar> -p <paquete> especifica un prefijo de nombre de paquete para todas las clases translet generadas. -n habilita la inclusión en línea de plantillas (comportamiento predeterminado mejor según promedio). -x activa la salida de mensajes de depuración adicionales -u interpreta los argumentos <stylesheet> como URL -i fuerza que el compilador lea la hoja de estilos de stdin -v imprime la versión del compilador -h imprime esta sentencia de uso "	TokenNameStringLiteral	SINOPSIS java org.apache.xalan.xsltc.cmdline.Compile [-o <salida>] [-d <directory>] [-j <archivojar>] [-p <paquete>] [-n] [-x] [-u] [-v] [-h] { <stylesheet> | -i } OPCIONES -o <salida> asigna el nombre <salida> al translet generado. De forma predeterminada, el nombre del translet se deriva del nombre de la <hojaestilos>. Esta opción se ignora si se compilan varias hojas de estilos. -d <directorio> especificar un directorio de destino para el translet -j <archivojar> empaqueta las clases translet en el archivo jar del nombre especificado por <archivojar> -p <paquete> especifica un prefijo de nombre de paquete para todas las clases translet generadas. -n habilita la inclusión en línea de plantillas (comportamiento predeterminado mejor según promedio). -x activa la salida de mensajes de depuración adicionales -u interpreta los argumentos <stylesheet> como URL -i fuerza que el compilador lea la hoja de estilos de stdin -v imprime la versión del compilador -h imprime esta sentencia de uso 
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
,	TokenNameCOMMA	
"<xsl:sort> sólo puede utilizarse dentro de <xsl:for-each> o <xsl:apply-templates>."	TokenNameStringLiteral	<xsl:sort> sólo puede utilizarse dentro de <xsl:for-each> o <xsl:apply-templates>.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
,	TokenNameCOMMA	
"La codificación de salida ''{0}'' no está soportada en esta JVM."	TokenNameStringLiteral	La codificación de salida ''{0}'' no está soportada en esta JVM.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
,	TokenNameCOMMA	
"Error de sintaxis en ''{0}''."	TokenNameStringLiteral	Error de sintaxis en ''{0}''.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
,	TokenNameCOMMA	
"No se puede encontrar el constructor externo ''{0}''."	TokenNameStringLiteral	No se puede encontrar el constructor externo ''{0}''.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
,	TokenNameCOMMA	
"El primer argumento de la función Java no estática ''{0}'' no es una referencia de objeto válida."	TokenNameStringLiteral	El primer argumento de la función Java no estática ''{0}'' no es una referencia de objeto válida.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
,	TokenNameCOMMA	
"Error al comprobar el tipo de la expresión ''{0}''."	TokenNameStringLiteral	Error al comprobar el tipo de la expresión ''{0}''.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
,	TokenNameCOMMA	
"Error al comprobar el tipo de una expresión en una ubicación desconocida."	TokenNameStringLiteral	Error al comprobar el tipo de una expresión en una ubicación desconocida.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
,	TokenNameCOMMA	
"La opción ''{0}'' de la línea de mandatos no es válida."	TokenNameStringLiteral	La opción ''{0}'' de la línea de mandatos no es válida.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
,	TokenNameCOMMA	
"Falta un argumento necesario en la opción ''{0}'' de la línea de mandatos."	TokenNameStringLiteral	Falta un argumento necesario en la opción ''{0}'' de la línea de mandatos.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
,	TokenNameCOMMA	
"AVISO: ''{0}'' :{1}"	TokenNameStringLiteral	AVISO: ''{0}'' :{1}
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
,	TokenNameCOMMA	
"AVISO: ''{0}''"	TokenNameStringLiteral	AVISO: ''{0}''
}	TokenNameRBRACE	
,	TokenNameCOMMA	
/* * Note to translators: This message is used to indicate the severity * of another message. The substitution text contains two error * messages. The spacing before the second substitution text indents * it the same amount as the first in English. */	TokenNameCOMMENT_BLOCK	 Note to translators: This message is used to indicate the severity of another message. The substitution text contains two error messages. The spacing before the second substitution text indents it the same amount as the first in English. 
{	TokenNameLBRACE	
...
,	TokenNameCOMMA	
"ERROR MUY GRAVE: ''{0}'' :{1}"	TokenNameStringLiteral	ERROR MUY GRAVE: ''{0}'' :{1}
}	TokenNameRBRACE	
,	TokenNameCOMMA	
/* * Note to translators: This message is used to indicate the severity * of another message. The substitution text is an error message. */	TokenNameCOMMENT_BLOCK	 Note to translators: This message is used to indicate the severity of another message. The substitution text is an error message. 
{	TokenNameLBRACE	
...
,	TokenNameCOMMA	
"ERROR MUY GRAVE: ''{0}''"	TokenNameStringLiteral	ERROR MUY GRAVE: ''{0}''
}	TokenNameRBRACE	
,	TokenNameCOMMA	
/* * Note to translators: This message is used to indicate the severity * of another message. The substitution text contains two error * messages. The spacing before the second substitution text indents * it the same amount as the first in English. */	TokenNameCOMMENT_BLOCK	 Note to translators: This message is used to indicate the severity of another message. The substitution text contains two error messages. The spacing before the second substitution text indents it the same amount as the first in English. 
{	TokenNameLBRACE	
...
,	TokenNameCOMMA	
"Transformación con translet ''{0}'' "	TokenNameStringLiteral	Transformación con translet ''{0}'' 
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
,	TokenNameCOMMA	
"Transformación con translet ''{0}'' del archivo jar ''{1}''"	TokenNameStringLiteral	Transformación con translet ''{0}'' del archivo jar ''{1}''
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
,	TokenNameCOMMA	
"No se ha podido crear una instancia de la clase TransformerFactory ''{0}''."	TokenNameStringLiteral	No se ha podido crear una instancia de la clase TransformerFactory ''{0}''.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
,	TokenNameCOMMA	
"No se ha podido utilizar el nombre ''{0}'' como nombre de la clase translet porque contiene caracteres que no están permitidos en los nombres de clases Java. Se utiliza el nombre ''{1}'' en su lugar."	TokenNameStringLiteral	No se ha podido utilizar el nombre ''{0}'' como nombre de la clase translet porque contiene caracteres que no están permitidos en los nombres de clases Java. Se utiliza el nombre ''{1}'' en su lugar.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
,	TokenNameCOMMA	
"Errores del compilador:"	TokenNameStringLiteral	Errores del compilador:
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
,	TokenNameCOMMA	
"Avisos del compilador:"	TokenNameStringLiteral	Avisos del compilador:
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
,	TokenNameCOMMA	
"Errores de translet:"	TokenNameStringLiteral	Errores de translet:
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
,	TokenNameCOMMA	
"Un atributo cuyo valor debe ser un QName o una lista de QNames separados por espacios tiene el valor ''{0}''"	TokenNameStringLiteral	Un atributo cuyo valor debe ser un QName o una lista de QNames separados por espacios tiene el valor ''{0}''
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
,	TokenNameCOMMA	
"El atributo method de un elemento <xsl:output> tiene el valor ''{0}''. El valor debe ser ''xml'', ''html'', ''text'' o qname-but-not-ncname"	TokenNameStringLiteral	El atributo method de un elemento <xsl:output> tiene el valor ''{0}''. El valor debe ser ''xml'', ''html'', ''text'' o qname-but-not-ncname
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ErrorMsg	TokenNameIdentifier	 Error Msg
...
,	TokenNameCOMMA	
"El nombre de característica no puede ser null en TransformerFactory.getFeature(nombre de tipo String)."	TokenNameStringLiteral	El nombre de característica no puede ser null en TransformerFactory.getFeature(nombre de tipo String).
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ErrorMsg	TokenNameIdentifier	 Error Msg
...
,	TokenNameCOMMA	
"El nombre de característica no puede ser null en TransformerFactory.setFeature(nombre de tipo String, valor booleano)."	TokenNameStringLiteral	El nombre de característica no puede ser null en TransformerFactory.setFeature(nombre de tipo String, valor booleano).
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ErrorMsg	TokenNameIdentifier	 Error Msg
