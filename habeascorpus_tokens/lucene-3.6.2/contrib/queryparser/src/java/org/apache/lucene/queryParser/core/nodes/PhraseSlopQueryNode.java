...
PhraseSlopQueryNode	TokenNameIdentifier	 Phrase Slop Query Node
...
;	TokenNameSEMICOLON	
/** * @throws QueryNodeException * @throws QueryNodeParseException * @exception QueryNodeParseException * throw in overridden method to disallow */	TokenNameCOMMENT_JAVADOC	 @throws QueryNodeException @throws QueryNodeParseException @exception QueryNodeParseException throw in overridden method to disallow 
public	TokenNamepublic	
PhraseSlopQueryNode	TokenNameIdentifier	 Phrase Slop Query Node
(	TokenNameLPAREN	
...
{	TokenNameLBRACE	
return	TokenNamereturn	
"<phraseslop value='"	TokenNameStringLiteral	<phraseslop value='
+	TokenNamePLUS	
getValueString	TokenNameIdentifier	 get Value String
(	TokenNameLPAREN	
)	TokenNameRPAREN	
...
+	TokenNamePLUS	
" </phraseslop>"	TokenNameStringLiteral	 </phraseslop>
;	TokenNameSEMICOLON	
}	TokenNameRBRACE	
public	TokenNamepublic	
CharSequence	TokenNameIdentifier	 Char Sequence
