...
,	TokenNameCOMMA	
"Více ne? jedna p?edloha stylu je definována ve stejném souboru."	TokenNameStringLiteral	Více ne? jedna p?edloha stylu je definována ve stejném souboru.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
,	TokenNameCOMMA	
"?ablona ''{0}'' je ji? v této p?edloze stylu definována. "	TokenNameStringLiteral	?ablona ''{0}'' je ji? v této p?edloze stylu definována. 
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
,	TokenNameCOMMA	
"?ablona ''{0}'' není v této p?edloze stylu definována."	TokenNameStringLiteral	?ablona ''{0}'' není v této p?edloze stylu definována.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
,	TokenNameCOMMA	
"Prom?nná ''{0}'' je n?kolikanásobn? definována ve stejném oboru."	TokenNameStringLiteral	Prom?nná ''{0}'' je n?kolikanásobn? definována ve stejném oboru.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
,	TokenNameCOMMA	
"Prom?nná nebo parametr ''{0}'' nejsou definovány."	TokenNameStringLiteral	Prom?nná nebo parametr ''{0}'' nejsou definovány.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
,	TokenNameCOMMA	
"Nelze najít t?ídu ''{0}''."	TokenNameStringLiteral	Nelze najít t?ídu ''{0}''.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
,	TokenNameCOMMA	
"Nelze najít externí metodu ''{0}'' (musí b?t ve?ejná)."	TokenNameStringLiteral	Nelze najít externí metodu ''{0}'' (musí b?t ve?ejná).
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
,	TokenNameCOMMA	
"Nelze p?evést argument/návratov? typ ve volání metody ''{0}''"	TokenNameStringLiteral	Nelze p?evést argument/návratov? typ ve volání metody ''{0}''
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
,	TokenNameCOMMA	
"Soubor nebo identifikátor URI ''{0}'' nebyl nalezen."	TokenNameStringLiteral	Soubor nebo identifikátor URI ''{0}'' nebyl nalezen.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
,	TokenNameCOMMA	
"Neplatn? identifikátor URI ''{0}''."	TokenNameStringLiteral	Neplatn? identifikátor URI ''{0}''.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
,	TokenNameCOMMA	
"Nelze otev?ít soubor nebo identifikátor URI ''{0}''."	TokenNameStringLiteral	Nelze otev?ít soubor nebo identifikátor URI ''{0}''.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
,	TokenNameCOMMA	
"Byl o?ekáván prvek <xsl:stylesheet> nebo <xsl:transform>."	TokenNameStringLiteral	Byl o?ekáván prvek <xsl:stylesheet> nebo <xsl:transform>.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
,	TokenNameCOMMA	
"P?edpona oboru názv? ''{0}'' není deklarována."	TokenNameStringLiteral	P?edpona oboru názv? ''{0}'' není deklarována.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
,	TokenNameCOMMA	
"Nelze vy?e?it volání funkce ''{0}''."	TokenNameStringLiteral	Nelze vy?e?it volání funkce ''{0}''.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
,	TokenNameCOMMA	
"Argumentem funkce ''{0}'' musí b?t ?et?zcov? literál."	TokenNameStringLiteral	Argumentem funkce ''{0}'' musí b?t ?et?zcov? literál.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
,	TokenNameCOMMA	
"Po?adovan? atribut ''{0}'' chybí."	TokenNameStringLiteral	Po?adovan? atribut ''{0}'' chybí.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
,	TokenNameCOMMA	
"Neplatn? název ''{0}'' pro instrukci zpracování. "	TokenNameStringLiteral	Neplatn? název ''{0}'' pro instrukci zpracování. 
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
,	TokenNameCOMMA	
"Cyklick? import/zahrnutí. P?edloha stylu ''{0}'' je ji? zavedena."	TokenNameStringLiteral	Cyklick? import/zahrnutí. P?edloha stylu ''{0}'' je ji? zavedena.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
,	TokenNameCOMMA	
"Fragmenty stromu v?sledk? nemohou b?t ?azeny (prvky <xsl:sort> se ignorují). P?i vytvá?ení stromu v?sledk? musíte se?adit uzly."	TokenNameStringLiteral	Fragmenty stromu v?sledk? nemohou b?t ?azeny (prvky <xsl:sort> se ignorují). P?i vytvá?ení stromu v?sledk? musíte se?adit uzly.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
,	TokenNameCOMMA	
"Desetinné formátování ''{0}'' je ji? definováno."	TokenNameStringLiteral	Desetinné formátování ''{0}'' je ji? definováno.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
,	TokenNameCOMMA	
"Verze XSL ''{0}'' není produktem XSLTC podporována."	TokenNameStringLiteral	Verze XSL ''{0}'' není produktem XSLTC podporována.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
,	TokenNameCOMMA	
"Neznám? operátor pro binární v?raz."	TokenNameStringLiteral	Neznám? operátor pro binární v?raz.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
,	TokenNameCOMMA	
"Neplatn? argument pro volání funkce."	TokenNameStringLiteral	Neplatn? argument pro volání funkce.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
,	TokenNameCOMMA	
"Druh? argument pro funkci document() musí b?t node-set."	TokenNameStringLiteral	Druh? argument pro funkci document() musí b?t node-set.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
,	TokenNameCOMMA	
"V prvku <xsl:attribute-set> chybí atribut 'name'."	TokenNameStringLiteral	V prvku <xsl:attribute-set> chybí atribut 'name'.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
,	TokenNameCOMMA	
"Textová data jsou vn? prvku nejvy??í úrovn? <xsl:stylesheet>."	TokenNameStringLiteral	Textová data jsou vn? prvku nejvy??í úrovn? <xsl:stylesheet>.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
,	TokenNameCOMMA	
"Analyzátor JAXP je nesprávn? konfigurován."	TokenNameStringLiteral	Analyzátor JAXP je nesprávn? konfigurován.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
,	TokenNameCOMMA	
"Neopravitelná interní chyba XSLTC: ''{0}''"	TokenNameStringLiteral	Neopravitelná interní chyba XSLTC: ''{0}''
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
,	TokenNameCOMMA	
"Vstupní dokument není p?edloha stylu (obor názv? XSL není deklarován v ko?enovém elementu)."	TokenNameStringLiteral	Vstupní dokument není p?edloha stylu (obor názv? XSL není deklarován v ko?enovém elementu).
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
,	TokenNameCOMMA	
"Nelze najít cílovou p?edlohu se stylem ''{0}''."	TokenNameStringLiteral	Nelze najít cílovou p?edlohu se stylem ''{0}''.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
,	TokenNameCOMMA	
"Neimplementováno: ''{0}''."	TokenNameStringLiteral	Neimplementováno: ''{0}''.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
,	TokenNameCOMMA	
"Vstupní dokument neobsahuje p?edlohu stylu XSL."	TokenNameStringLiteral	Vstupní dokument neobsahuje p?edlohu stylu XSL.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
,	TokenNameCOMMA	
"Atribut use prom?nné <key> musí b?t typu node, node-set, string nebo number."	TokenNameStringLiteral	Atribut use prom?nné <key> musí b?t typu node, node-set, string nebo number.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
,	TokenNameCOMMA	
"V?stupní verze dokumentu XML by m?la b?t 1.0"	TokenNameStringLiteral	V?stupní verze dokumentu XML by m?la b?t 1.0
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
,	TokenNameCOMMA	
"Neznám? operátor pro rela?ní v?raz"	TokenNameStringLiteral	Neznám? operátor pro rela?ní v?raz
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
,	TokenNameCOMMA	
"Pokus pou?ít neexistující sadu atribut? ''{0}''."	TokenNameStringLiteral	Pokus pou?ít neexistující sadu atribut? ''{0}''.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
,	TokenNameCOMMA	
"Neznám? datov? typ v podpisu pro t?ídu ''{0}''. "	TokenNameStringLiteral	Neznám? datov? typ v podpisu pro t?ídu ''{0}''. 
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
,	TokenNameCOMMA	
"Nelze p?evést datov? typ ''{0}'' na ''{1}''."	TokenNameStringLiteral	Nelze p?evést datov? typ ''{0}'' na ''{1}''.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
,	TokenNameCOMMA	
"Tato ?ablona neobsahuje platnou definici t?ídy translet."	TokenNameStringLiteral	Tato ?ablona neobsahuje platnou definici t?ídy translet.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
/* * Note to translators: "Templates" is a Java class name that should * not be translated. */	TokenNameCOMMENT_BLOCK	 Note to translators: "Templates" is a Java class name that should not be translated. 
{	TokenNameLBRACE	
...
,	TokenNameCOMMA	
"Tato ?ablona neobsahuje t?ídu s názvem ''{0}''. "	TokenNameStringLiteral	Tato ?ablona neobsahuje t?ídu s názvem ''{0}''. 
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
,	TokenNameCOMMA	
"Nelze zavést t?ídu translet ''{0}''. "	TokenNameStringLiteral	Nelze zavést t?ídu translet ''{0}''. 
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ErrorMsg	TokenNameIdentifier	 Error Msg
...
,	TokenNameCOMMA	
"T?ída translet byla zavedena, av?ak nelze vytvo?it instanci translet."	TokenNameStringLiteral	T?ída translet byla zavedena, av?ak nelze vytvo?it instanci translet.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
,	TokenNameCOMMA	
"Pokus nastavit objekt ErrorListener pro t?ídu ''{0}'' na hodnotu Null"	TokenNameStringLiteral	Pokus nastavit objekt ErrorListener pro t?ídu ''{0}'' na hodnotu Null
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
,	TokenNameCOMMA	
"Pouze prom?nné StreamSource, SAXSource a DOMSource jsou podporovány produktem XSLTC"	TokenNameStringLiteral	Pouze prom?nné StreamSource, SAXSource a DOMSource jsou podporovány produktem XSLTC
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
,	TokenNameCOMMA	
"Zdrojov? objekt p?edan? metod? ''{0}'' nemá ?ádn? obsah."	TokenNameStringLiteral	Zdrojov? objekt p?edan? metod? ''{0}'' nemá ?ádn? obsah.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
,	TokenNameCOMMA	
"T?ída TransformerFactory nerozpoznala atribut ''{0}''. "	TokenNameStringLiteral	T?ída TransformerFactory nerozpoznala atribut ''{0}''. 
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
,	TokenNameCOMMA	
"Metoda setResult() musí b?t volána p?ed metodou startDocument()."	TokenNameStringLiteral	Metoda setResult() musí b?t volána p?ed metodou startDocument().
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
,	TokenNameCOMMA	
"Objekt Transformer nemá ?ádn? zapouzd?en? objekt translet."	TokenNameStringLiteral	Objekt Transformer nemá ?ádn? zapouzd?en? objekt translet.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
,	TokenNameCOMMA	
"Neexistuje ?ádn? definovan? v?stupní obslu?n? program pro v?sledek transformace."	TokenNameStringLiteral	Neexistuje ?ádn? definovan? v?stupní obslu?n? program pro v?sledek transformace.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
,	TokenNameCOMMA	
"Pokus o p?ístup k neplatné vlastnosti objektu Transformer: ''{0}''. "	TokenNameStringLiteral	Pokus o p?ístup k neplatné vlastnosti objektu Transformer: ''{0}''. 
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
,	TokenNameCOMMA	
"Nelze vytvo?it adaptér SAX2DOM: ''{0}''. "	TokenNameStringLiteral	Nelze vytvo?it adaptér SAX2DOM: ''{0}''. 
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
,	TokenNameCOMMA	
"Byla volána metoda XSLTCSource.build(), ani? by byla nastavena hodnota systemId."	TokenNameStringLiteral	Byla volána metoda XSLTCSource.build(), ani? by byla nastavena hodnota systemId.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ErrorMsg	TokenNameIdentifier	 Error Msg
...
,	TokenNameCOMMA	
"Volba -i musí b?t pou?ita s volbou -o."	TokenNameStringLiteral	Volba -i musí b?t pou?ita s volbou -o.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
,	TokenNameCOMMA	
"SYNOPSE java org.apache.xalan.xsltc.cmdline.Compile [-o <v?stup>] [-d <adresá?>] [-j <soubor_jar>] [-p <balík>] [-n] [-x] [-u] [-v] [-h] { <p?edloha_stylu> | -i } VOLBY -o <v?stup> p?i?adí k vygenerovanému transletu název <v?stup>. Podle v?chozího nastavení je jméno transletu odvozeno z názvu <p?edloha_stylu>. Tato volba se ignoruje, pokud se kompilují násobné p?edlohy styl?. -d <adresá?> ur?uje v?chozí adresá? pro translet -j <soubor_jar> zabalí t?ídu transletu do souboru jar pojmenovaného jako <soubor_jar> -p <balík> ur?uje p?edponu názvu balí?ku pro v?echny generované t?ídy transletu. -n povoluje zarovnání ?ablony (v?chozí chování je v pr?m?ru lep?í) -x zapne dal?í v?stup zprávy lad?ní -u interpretuje argumenty <p?edloha_stylu> jako URL -i vynutí ?tení p?edlohy styl? kompilátorem ze vstupu stdin -v tiskne verzi kompilátoru -h tiskne tyto pokyny k pou?ití "	TokenNameStringLiteral	SYNOPSE java org.apache.xalan.xsltc.cmdline.Compile [-o <v?stup>] [-d <adresá?>] [-j <soubor_jar>] [-p <balík>] [-n] [-x] [-u] [-v] [-h] { <p?edloha_stylu> | -i } VOLBY -o <v?stup> p?i?adí k vygenerovanému transletu název <v?stup>. Podle v?chozího nastavení je jméno transletu odvozeno z názvu <p?edloha_stylu>. Tato volba se ignoruje, pokud se kompilují násobné p?edlohy styl?. -d <adresá?> ur?uje v?chozí adresá? pro translet -j <soubor_jar> zabalí t?ídu transletu do souboru jar pojmenovaného jako <soubor_jar> -p <balík> ur?uje p?edponu názvu balí?ku pro v?echny generované t?ídy transletu. -n povoluje zarovnání ?ablony (v?chozí chování je v pr?m?ru lep?í) -x zapne dal?í v?stup zprávy lad?ní -u interpretuje argumenty <p?edloha_stylu> jako URL -i vynutí ?tení p?edlohy styl? kompilátorem ze vstupu stdin -v tiskne verzi kompilátoru -h tiskne tyto pokyny k pou?ití 
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
,	TokenNameCOMMA	
"SYNOPSE java org.apache.xalan.xsltc.cmdline.Transform [-j <soubor_jar>] [-x] [-n <iterace>] {-u <URL_dokumentu> | <dokument>} <t?ída> [<param1>=<hodn1>...] Pou?ívá translet <t?ída> k transformaci dokumentu XML ur?eného parametrem <dokument>. Translet <t?ída> je bu? v u?ivatelské cest? CLASSPATH, nebo ve voliteln? ur?eném souboru <soubor_jar>. VOLBY -j <soubor_jar> ur?uje soubor jar, z n?j? má b?t translet na?ten -x zapíná v?stup dal?ích ladicích zpráv -n <iterace> spou?tí transformaci opakovan?, parametr <iterace> ur?uje po?et opakování, a zobrazí informace o profilu -u <URL_dokumentu> ur?uje adresu URL vstupního dokumentu XML "	TokenNameStringLiteral	SYNOPSE java org.apache.xalan.xsltc.cmdline.Transform [-j <soubor_jar>] [-x] [-n <iterace>] {-u <URL_dokumentu> | <dokument>} <t?ída> [<param1>=<hodn1>...] Pou?ívá translet <t?ída> k transformaci dokumentu XML ur?eného parametrem <dokument>. Translet <t?ída> je bu? v u?ivatelské cest? CLASSPATH, nebo ve voliteln? ur?eném souboru <soubor_jar>. VOLBY -j <soubor_jar> ur?uje soubor jar, z n?j? má b?t translet na?ten -x zapíná v?stup dal?ích ladicích zpráv -n <iterace> spou?tí transformaci opakovan?, parametr <iterace> ur?uje po?et opakování, a zobrazí informace o profilu -u <URL_dokumentu> ur?uje adresu URL vstupního dokumentu XML 
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
,	TokenNameCOMMA	
"V?stupní kódování ''{0}'' není v tomto prost?edí JVM podporováno."	TokenNameStringLiteral	V?stupní kódování ''{0}'' není v tomto prost?edí JVM podporováno.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
,	TokenNameCOMMA	
"Nelze najít externí konstruktor ''{0}''."	TokenNameStringLiteral	Nelze najít externí konstruktor ''{0}''.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
,	TokenNameCOMMA	
"První argument nestatické funkce Java ''{0}'' není platn?m odkazem na objekt."	TokenNameStringLiteral	První argument nestatické funkce Java ''{0}'' není platn?m odkazem na objekt.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
,	TokenNameCOMMA	
"Chyba p?i kontrole typu v?razu na neznámém míst?."	TokenNameStringLiteral	Chyba p?i kontrole typu v?razu na neznámém míst?.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
,	TokenNameCOMMA	
"Volba p?íkazového ?ádku ''{0}'' není platná."	TokenNameStringLiteral	Volba p?íkazového ?ádku ''{0}'' není platná.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
,	TokenNameCOMMA	
"Ve volb? p?íkazového ?ádku ''{0}'' chybí po?adovan? argument."	TokenNameStringLiteral	Ve volb? p?íkazového ?ádku ''{0}'' chybí po?adovan? argument.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
,	TokenNameCOMMA	
"VAROVÁNÍ: ''{0}'' :{1}"	TokenNameStringLiteral	VAROVÁNÍ: ''{0}'' :{1}
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
,	TokenNameCOMMA	
"VAROVÁNÍ: ''{0}''"	TokenNameStringLiteral	VAROVÁNÍ: ''{0}''
}	TokenNameRBRACE	
,	TokenNameCOMMA	
/* * Note to translators: This message is used to indicate the severity * of another message. The substitution text contains two error * messages. The spacing before the second substitution text indents * it the same amount as the first in English. */	TokenNameCOMMENT_BLOCK	 Note to translators: This message is used to indicate the severity of another message. The substitution text contains two error messages. The spacing before the second substitution text indents it the same amount as the first in English. 
{	TokenNameLBRACE	
...
,	TokenNameCOMMA	
"ZÁVA?NÁ CHYBA:''{0}'' :{1}"	TokenNameStringLiteral	ZÁVA?NÁ CHYBA:''{0}'' :{1}
}	TokenNameRBRACE	
,	TokenNameCOMMA	
/* * Note to translators: This message is used to indicate the severity * of another message. The substitution text is an error message. */	TokenNameCOMMENT_BLOCK	 Note to translators: This message is used to indicate the severity of another message. The substitution text is an error message. 
{	TokenNameLBRACE	
...
,	TokenNameCOMMA	
"ZÁVA?NÁ CHYBA:''{0}''"	TokenNameStringLiteral	ZÁVA?NÁ CHYBA:''{0}''
}	TokenNameRBRACE	
,	TokenNameCOMMA	
/* * Note to translators: This message is used to indicate the severity * of another message. The substitution text contains two error * messages. The spacing before the second substitution text indents * it the same amount as the first in English. */	TokenNameCOMMENT_BLOCK	 Note to translators: This message is used to indicate the severity of another message. The substitution text contains two error messages. The spacing before the second substitution text indents it the same amount as the first in English. 
{	TokenNameLBRACE	
...
,	TokenNameCOMMA	
"Transformace s pou?itím transletu ''{0}'' "	TokenNameStringLiteral	Transformace s pou?itím transletu ''{0}'' 
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
,	TokenNameCOMMA	
"Transformace s pou?itím transletu ''{0}'' ze souboru JAR ''{1}'' "	TokenNameStringLiteral	Transformace s pou?itím transletu ''{0}'' ze souboru JAR ''{1}'' 
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
,	TokenNameCOMMA	
"Nelze vytvo?it instanci t?ídy TransformerFactory ''{0}''."	TokenNameStringLiteral	Nelze vytvo?it instanci t?ídy TransformerFactory ''{0}''.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
,	TokenNameCOMMA	
"Jméno ''{0}'' nelze pou?ít jako jméno t?ídy translet?, proto?e obsahuje znaky, které nejsou ve jménu t?ídy jazyka Java povoleny. Pou?ito bylo jméno ''{1}''."	TokenNameStringLiteral	Jméno ''{0}'' nelze pou?ít jako jméno t?ídy translet?, proto?e obsahuje znaky, které nejsou ve jménu t?ídy jazyka Java povoleny. Pou?ito bylo jméno ''{1}''.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
,	TokenNameCOMMA	
"Chyby kompilátoru:"	TokenNameStringLiteral	Chyby kompilátoru:
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
,	TokenNameCOMMA	
"Varování kompilátoru:"	TokenNameStringLiteral	Varování kompilátoru:
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
,	TokenNameCOMMA	
"Atribut, jeho? hodnota musí b?t jméno QName nebo seznam jmen QName odd?len?ch mezerami, má hodnotu ''{0}''. "	TokenNameStringLiteral	Atribut, jeho? hodnota musí b?t jméno QName nebo seznam jmen QName odd?len?ch mezerami, má hodnotu ''{0}''. 
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
,	TokenNameCOMMA	
"Atribut, jeho? hodnota musí b?t jméno NCName, má hodnotu ''{0}''. "	TokenNameStringLiteral	Atribut, jeho? hodnota musí b?t jméno NCName, má hodnotu ''{0}''. 
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
,	TokenNameCOMMA	
"Atribut metody prvku <xsl:output> má hodnotu ''{0}''. Hodnotou musí b?t ?et?zec ''xml'', ''html'', ''text'' nebo jméno QName, které není jménem NCName."	TokenNameStringLiteral	Atribut metody prvku <xsl:output> má hodnotu ''{0}''. Hodnotou musí b?t ?et?zec ''xml'', ''html'', ''text'' nebo jméno QName, které není jménem NCName.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ErrorMsg	TokenNameIdentifier	 Error Msg
