...
;	TokenNameSEMICOLON	
/** * This class implements a multiImage extension to SVG. * * The 'multiImage' element is similar to the 'image' element (supports * all the same attributes and properties) except. * <ol> * <li>It can only be used to reference raster content (this is an * implementation thing really)</li> * <li>It has two addtional attributes: 'pixel-width' and * 'pixel-height' which are the maximum width and height of the * image referenced by the xlink:href attribute.</li> * <li>It can contain a child element 'subImage' which has only * three attributes, pixel-width, pixel-height and xlink:href. * The image displayed is the smallest image such that * pixel-width and pixel-height are greater than or equal to the * required image size for display.</li> * </ol> * * @author <a href="mailto:thomas.deweese@kodak.com">Thomas DeWeese</a> * @version $Id: SVGOMSubImageRefElement.java 475477 2006-11-15 22:44:28Z cam $ */	TokenNameCOMMENT_JAVADOC	 This class implements a multiImage extension to SVG. * The 'multiImage' element is similar to the 'image' element (supports all the same attributes and properties) except. <ol> <li>It can only be used to reference raster content (this is an implementation thing really)</li> <li>It has two addtional attributes: 'pixel-width' and 'pixel-height' which are the maximum width and height of the image referenced by the xlink:href attribute.</li> <li>It can contain a child element 'subImage' which has only three attributes, pixel-width, pixel-height and xlink:href. The image displayed is the smallest image such that pixel-width and pixel-height are greater than or equal to the required image size for display.</li> </ol> * @author <a href="mailto:thomas.deweese@kodak.com">Thomas DeWeese</a> @version $Id: SVGOMSubImageRefElement.java 475477 2006-11-15 22:44:28Z cam $ 
public	TokenNamepublic	
class	TokenNameclass	
SVGOMSubImageRefElement	TokenNameIdentifier	 SVGOM Sub Image Ref Element
extends	TokenNameextends	
SVGStylableElement	TokenNameIdentifier	 SVG Stylable Element
{	TokenNameLBRACE	
/** * Creates a new SubImageRefElement object. */	TokenNameCOMMENT_JAVADOC	 Creates a new SubImageRefElement object. 
...
/** * Creates a new SubImageRefElement object. * @param prefix The namespace prefix. * @param owner The owner document. */	TokenNameCOMMENT_JAVADOC	 Creates a new SubImageRefElement object. @param prefix The namespace prefix. @param owner The owner document. 
public	TokenNamepublic	
SVGOMSubImageRefElement	TokenNameIdentifier	 SVGOM Sub Image Ref Element
(	TokenNameLPAREN	
