...
.	TokenNameDOT	
SimpleTrainParams	TokenNameIdentifier	 Simple Train Params
.	TokenNameDOT	
class	TokenNameclass	
,	TokenNameCOMMA	
ClassifyCommandLineUtil	TokenNameIdentifier	 Classify Command Line Util
.	TokenNameDOT	
MultiTrainParams	TokenNameIdentifier	 Multi Train Params
.	TokenNameDOT	
class	TokenNameclass	
,	TokenNameCOMMA	
ClassifyCommandLineUtil	TokenNameIdentifier	 Classify Command Line Util
.	TokenNameDOT	
SeqTrainParams	TokenNameIdentifier	 Seq Train Params
.	TokenNameDOT	
class	TokenNameclass	
,	TokenNameCOMMA	
ClassifyCommandLineUtil	TokenNameIdentifier	 Classify Command Line Util
...
;	TokenNameSEMICOLON	
//private static final Set LEGAL_OPS = new HashSet(Arrays.asList(new String[]{"train","test","trainTest"})); 	TokenNameCOMMENT_LINE	private static final Set LEGAL_OPS = new HashSet(Arrays.asList(new String[]{"train","test","trainTest"})); 
public	TokenNamepublic	
static	TokenNamestatic	
class	TokenNameclass	
DataClassificationTask	TokenNameIdentifier	 Data Classification Task
...
.	TokenNameDOT	
TrainParams	TokenNameIdentifier	 Train Params
getTrainParams	TokenNameIdentifier	 get Train Params
(	TokenNameLPAREN	
)	TokenNameRPAREN	
{	TokenNameLBRACE	
...
public	TokenNamepublic	
void	TokenNamevoid	
setTrainParams	TokenNameIdentifier	 set Train Params
(	TokenNameLPAREN	
ClassifyCommandLineUtil	TokenNameIdentifier	 Classify Command Line Util
.	TokenNameDOT	
TrainParams	TokenNameIdentifier	 Train Params
...
getTrainParamsHelp	TokenNameIdentifier	 get Train Params Help
(	TokenNameLPAREN	
)	TokenNameRPAREN	
{	TokenNameLBRACE	
return	TokenNamereturn	
"Define what type of experiment you would like to run: <br>"	TokenNameStringLiteral	Define what type of experiment you would like to run: <br>
+	TokenNamePLUS	
"Simple - Standard classify experiment <br> "	TokenNameStringLiteral	Simple - Standard classify experiment <br> 
+	TokenNamePLUS	
"Multi - Classify Experiment with Multiple labels per example <br>"	TokenNameStringLiteral	Multi - Classify Experiment with Multiple labels per example <br>
+	TokenNamePLUS	
"Seq - Classify experiment with a Sequential Dataset, where each example has a history, <br> "	TokenNameStringLiteral	Seq - Classify experiment with a Sequential Dataset, where each example has a history, <br> 
+	TokenNamePLUS	
" and uses a Sequential Learner"	TokenNameStringLiteral	 and uses a Sequential Learner
;	TokenNameSEMICOLON	
}	TokenNameRBRACE	
...
{	TokenNameLBRACE	
JointCommandLineProcessor	TokenNameIdentifier	 Joint Command Line Processor
jlpTrain	TokenNameIdentifier	 jlp Train
=	TokenNameEQUAL	
new	TokenNamenew	
JointCommandLineProcessor	TokenNameIdentifier	 Joint Command Line Processor
(	TokenNameLPAREN	
...
{	TokenNameLBRACE	
MultiDataset	TokenNameIdentifier	 Multi Dataset
multiData	TokenNameIdentifier	 multi Data
;	TokenNameSEMICOLON	
if	TokenNameif	
(	TokenNameLPAREN	
trainParams	TokenNameIdentifier	 train Params
.	TokenNameDOT	
crossDim	TokenNameIdentifier	 cross Dim
)	TokenNameRPAREN	
multiData	TokenNameIdentifier	 multi Data
=	TokenNameEQUAL	
annotateData	TokenNameIdentifier	 annotate Data
