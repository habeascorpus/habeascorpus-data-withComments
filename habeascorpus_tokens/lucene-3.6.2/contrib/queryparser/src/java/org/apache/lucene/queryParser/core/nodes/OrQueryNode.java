...
;	TokenNameSEMICOLON	
/** * A {@link OrQueryNode} represents an OR boolean operation performed on a list * of nodes. * */	TokenNameCOMMENT_JAVADOC	 A {@link OrQueryNode} represents an OR boolean operation performed on a list of nodes. 
...
(	TokenNameLPAREN	
"OR query must have at least one clause"	TokenNameStringLiteral	OR query must have at least one clause
)	TokenNameRPAREN	
;	TokenNameSEMICOLON	
}	TokenNameRBRACE	
}	TokenNameRBRACE	
...
"<boolean operation='or'/>"	TokenNameStringLiteral	<boolean operation='or'/>
;	TokenNameSEMICOLON	
