...
;	TokenNameSEMICOLON	
/** * JUnit 3 testcases for org.apache.tools.ant.types.TarFileSet. * * <p>This doesn't actually test much, mainly reference handling. * */	TokenNameCOMMENT_JAVADOC	 JUnit 3 testcases for org.apache.tools.ant.types.TarFileSet. * <p>This doesn't actually test much, mainly reference handling. 
public	TokenNamepublic	
class	TokenNameclass	
TarFileSetTest	TokenNameIdentifier	 Tar File Set Test
...
File	TokenNameIdentifier	 File
(	TokenNameLPAREN	
"example.tar"	TokenNameStringLiteral	example.tar
)	TokenNameRPAREN	
)	TokenNameRPAREN	
;	TokenNameSEMICOLON	
try	TokenNametry	
...
// check that reference tarfilesets cannot have specific attributes 	TokenNameCOMMENT_LINE	check that reference tarfilesets cannot have specific attributes 
f	TokenNameIdentifier	 f
=	TokenNameEQUAL	
(	TokenNameLPAREN	
TarFileSet	TokenNameIdentifier	 Tar File Set
...
// check that a reference tarfileset gets the same attributes as the original 	TokenNameCOMMENT_LINE	check that a reference tarfileset gets the same attributes as the original 
f	TokenNameIdentifier	 f
=	TokenNameEQUAL	
(	TokenNameLPAREN	
TarFileSet	TokenNameIdentifier	 Tar File Set
