...
Reader	TokenNameIdentifier	 Reader
{	TokenNameLBRACE	
/** * Called by CharFilter(s) and Tokenizer to correct token offset. * * @param currentOff offset as seen in the output * @return corrected offset based on the input */	TokenNameCOMMENT_JAVADOC	 Called by CharFilter(s) and Tokenizer to correct token offset. * @param currentOff offset as seen in the output @return corrected offset based on the input 
public	TokenNamepublic	
abstract	TokenNameabstract	
int	TokenNameint	
