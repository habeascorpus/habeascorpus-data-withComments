...
/** * Return name of compatibility level. * * @return the name of compatibility level */	TokenNameCOMMENT_JAVADOC	 Return name of compatibility level. * @return the name of compatibility level 
public	TokenNamepublic	
String	TokenNameIdentifier	 String
