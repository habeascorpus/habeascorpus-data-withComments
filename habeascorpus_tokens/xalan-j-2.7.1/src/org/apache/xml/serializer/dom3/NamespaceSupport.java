...
;	TokenNameSEMICOLON	
/** * Namespace support for XML document handlers. This class doesn't * perform any error checking and assumes that all strings passed * as arguments to methods are unique symbols. The SymbolTable class * can be used for this purpose. * * Derived from org.apache.xerces.util.NamespaceSupport * * @author Andy Clark, IBM * * @version $Id: Exp $ */	TokenNameCOMMENT_JAVADOC	 Namespace support for XML document handlers. This class doesn't perform any error checking and assumes that all strings passed as arguments to methods are unique symbols. The SymbolTable class can be used for this purpose. * Derived from org.apache.xerces.util.NamespaceSupport * @author Andy Clark, IBM * @version $Id: Exp $ 
...
{	TokenNameLBRACE	
//if (fNamespace[i - 2] == prefix) { 	TokenNameCOMMENT_LINE	if (fNamespace[i - 2] == prefix) { 
if	TokenNameif	
(	TokenNameLPAREN	
fNamespace	TokenNameIdentifier	 f Namespace
[	TokenNameLBRACKET	
...
{	TokenNameLBRACE	
//if (fNamespace[i - 1] == uri) { 	TokenNameCOMMENT_LINE	if (fNamespace[i - 1] == uri) { 
if	TokenNameif	
(	TokenNameLPAREN	
fNamespace	TokenNameIdentifier	 f Namespace
[	TokenNameLBRACKET	
...
{	TokenNameLBRACE	
//if (getURI(fNamespace[i - 2]) == uri) 	TokenNameCOMMENT_LINE	if (getURI(fNamespace[i - 2]) == uri) 
if	TokenNameif	
(	TokenNameLPAREN	
getURI	TokenNameIdentifier	 get URI
(	TokenNameLPAREN	
