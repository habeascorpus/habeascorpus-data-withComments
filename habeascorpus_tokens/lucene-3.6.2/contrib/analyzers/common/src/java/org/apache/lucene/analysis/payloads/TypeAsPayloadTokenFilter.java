...
;	TokenNameSEMICOLON	
/** * Makes the {@link org.apache.lucene.analysis.Token#type()} a payload. * * Encodes the type using {@link String#getBytes(String)} with "UTF-8" as the encoding * **/	TokenNameCOMMENT_JAVADOC	 Makes the {@link org.apache.lucene.analysis.Token#type()} a payload. * Encodes the type using {@link String#getBytes(String)} with "UTF-8" as the encoding *
