...
/* * $Id: Include.java 468650 2006-10-28 07:03:30Z minchau $ */	TokenNameCOMMENT_BLOCK	 $Id: Include.java 468650 2006-10-28 07:03:30Z minchau $ 
...
;	TokenNameSEMICOLON	
/** * @author Jacek Ambroziak * @author Morten Jorgensen * @author Erwin Bolwidt <ejb@klomp.org> * @author Gunnlaugur Briem <gthb@dimon.is> */	TokenNameCOMMENT_JAVADOC	 @author Jacek Ambroziak @author Morten Jorgensen @author Erwin Bolwidt <ejb@klomp.org> @author Gunnlaugur Briem <gthb@dimon.is> 
...
_included	TokenNameIdentifier	 included
=	TokenNameEQUAL	
null	TokenNamenull	
;	TokenNameSEMICOLON	
public	TokenNamepublic	
Stylesheet	TokenNameIdentifier	 Stylesheet
getIncludedStylesheet	TokenNameIdentifier	 get Included Stylesheet
(	TokenNameLPAREN	
)	TokenNameRPAREN	
{	TokenNameLBRACE	
...
docToLoad	TokenNameIdentifier	 doc To Load
=	TokenNameEQUAL	
...
context	TokenNameIdentifier	 context
.	TokenNameDOT	
checkForLoop	TokenNameIdentifier	 check For Loop
(	TokenNameLPAREN	
docToLoad	TokenNameIdentifier	 doc To Load
)	TokenNameRPAREN	
)	TokenNameRPAREN	
...
;	TokenNameSEMICOLON	
String	TokenNameIdentifier	 String
currLoadedDoc	TokenNameIdentifier	 curr Loaded Doc
=	TokenNameEQUAL	
context	TokenNameIdentifier	 context
.	TokenNameDOT	
...
context	TokenNameIdentifier	 context
.	TokenNameDOT	
getSourceLoader	TokenNameIdentifier	 get Source Loader
(	TokenNameLPAREN	
)	TokenNameRPAREN	
;	TokenNameSEMICOLON	
// Use SourceLoader if available 	TokenNameCOMMENT_LINE	Use SourceLoader if available 
if	TokenNameif	
(	TokenNameLPAREN	
loader	TokenNameIdentifier	 loader
!=	TokenNameNOT_EQUAL	
...
// No SourceLoader or not resolved by SourceLoader 	TokenNameCOMMENT_LINE	No SourceLoader or not resolved by SourceLoader 
if	TokenNameif	
(	TokenNameLPAREN	
input	TokenNameIdentifier	 input
...
// Return if we could not resolve the URL 	TokenNameCOMMENT_LINE	Return if we could not resolve the URL 
if	TokenNameif	
(	TokenNameLPAREN	
input	TokenNameIdentifier	 input
==	TokenNameEQUAL_EQUAL	
...
_included	TokenNameIdentifier	 included
.	TokenNameDOT	
setIncludingStylesheet	TokenNameIdentifier	 set Including Stylesheet
(	TokenNameLPAREN	
context	TokenNameIdentifier	 context
)	TokenNameRPAREN	
;	TokenNameSEMICOLON	
...
;	TokenNameSEMICOLON	
// An included stylesheet gets the same import precedence 	TokenNameCOMMENT_LINE	An included stylesheet gets the same import precedence 
// as the stylesheet that included it. 	TokenNameCOMMENT_LINE	as the stylesheet that included it. 
final	TokenNamefinal	
int	TokenNameint	
...
_included	TokenNameIdentifier	 included
.	TokenNameDOT	
setImportPrecedence	TokenNameIdentifier	 set Import Precedence
(	TokenNameLPAREN	
precedence	TokenNameIdentifier	 precedence
)	TokenNameRPAREN	
;	TokenNameSEMICOLON	
...
final	TokenNamefinal	
Stylesheet	TokenNameIdentifier	 Stylesheet
topStylesheet	TokenNameIdentifier	 top Stylesheet
=	TokenNameEQUAL	
parser	TokenNameIdentifier	 parser
.	TokenNameDOT	
