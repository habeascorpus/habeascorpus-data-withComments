...
TaskdefTest	TokenNameIdentifier	 Taskdef Test
...
(	TokenNameLPAREN	
"src/etc/testcases/taskdefs/taskdef.xml"	TokenNameStringLiteral	src/etc/testcases/taskdefs/taskdef.xml
)	TokenNameRPAREN	
;	TokenNameSEMICOLON	
}	TokenNameRBRACE	
public	TokenNamepublic	
...
public	TokenNamepublic	
void	TokenNamevoid	
test5a	TokenNameIdentifier	 test5a
(	TokenNameLPAREN	
)	TokenNameRPAREN	
{	TokenNameLBRACE	
executeTarget	TokenNameIdentifier	 execute Target
(	TokenNameLPAREN	
"test5a"	TokenNameStringLiteral	test5a
)	TokenNameRPAREN	
;	TokenNameSEMICOLON	
}	TokenNameRBRACE	
public	TokenNamepublic	
...
,	TokenNameCOMMA	
"simpletask: worked"	TokenNameStringLiteral	simpletask: worked
)	TokenNameRPAREN	
;	TokenNameSEMICOLON	
}	TokenNameRBRACE	
public	TokenNamepublic	
...
,	TokenNameCOMMA	
"worked"	TokenNameStringLiteral	worked
)	TokenNameRPAREN	
;	TokenNameSEMICOLON	
}	TokenNameRBRACE	
public	TokenNamepublic	
...
executeTarget	TokenNameIdentifier	 execute Target
(	TokenNameLPAREN	
"testOverride"	TokenNameStringLiteral	testOverride
)	TokenNameRPAREN	
;	TokenNameSEMICOLON	
String	TokenNameIdentifier	 String
...
(	TokenNameLPAREN	
"override warning sent"	TokenNameStringLiteral	override warning sent
,	TokenNameCOMMA	
log	TokenNameIdentifier	 log
.	TokenNameDOT	
indexOf	TokenNameIdentifier	 index Of
(	TokenNameLPAREN	
"Trying to override old definition of task copy"	TokenNameStringLiteral	Trying to override old definition of task copy
)	TokenNameRPAREN	
>	TokenNameGREATER	
-	TokenNameMINUS	
...
assertTrue	TokenNameIdentifier	 assert True
(	TokenNameLPAREN	
"task inside target worked"	TokenNameStringLiteral	task inside target worked
,	TokenNameCOMMA	
log	TokenNameIdentifier	 log
.	TokenNameDOT	
indexOf	TokenNameIdentifier	 index Of
(	TokenNameLPAREN	
"In target"	TokenNameStringLiteral	In target
)	TokenNameRPAREN	
>	TokenNameGREATER	
-	TokenNameMINUS	
1	TokenNameIntegerLiteral	
...
indexOf	TokenNameIdentifier	 index Of
(	TokenNameLPAREN	
"In TaskContainer"	TokenNameStringLiteral	In TaskContainer
)	TokenNameRPAREN	
>	TokenNameGREATER	
-	TokenNameMINUS	
1	TokenNameIntegerLiteral	
