...
/** * Returns the int mapped with the given key. * * @param key * int who's mapped object we're interested in. * @return an object mapped by the given key. null if the key wasn't found. */	TokenNameCOMMENT_JAVADOC	 Returns the int mapped with the given key. * @param key int who's mapped object we're interested in. @return an object mapped by the given key. null if the key wasn't found. 
public	TokenNamepublic	
int	TokenNameint	
