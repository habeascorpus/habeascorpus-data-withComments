...
{	TokenNameLBRACE	
/** Add a new position & payload. If payloadLength > 0 * you must read those bytes from the IndexInput. */	TokenNameCOMMENT_JAVADOC	 Add a new position & payload. If payloadLength > 0 you must read those bytes from the IndexInput. 
abstract	TokenNameabstract	
void	TokenNamevoid	
