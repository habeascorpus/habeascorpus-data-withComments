...
/* * $Id: ApplyXPath.java 470245 2006-11-02 06:34:33Z minchau $ */	TokenNameCOMMENT_BLOCK	 $Id: ApplyXPath.java 470245 2006-11-02 06:34:33Z minchau $ 
...
;	TokenNameSEMICOLON	
/** * Very basic utility for applying an XPath epxression to an xml file and printing information / about the execution of the XPath object and the nodes it finds. * Takes 2 arguments: * (1) an xml filename * (2) an XPath expression to apply to the file * Examples: * java ApplyXPath foo.xml / * java ApplyXPath foo.xml /doc/name[1]/@last * @see XPathAPI */	TokenNameCOMMENT_JAVADOC	 Very basic utility for applying an XPath epxression to an xml file and printing information / about the execution of the XPath object and the nodes it finds. Takes 2 arguments: (1) an xml filename (2) an XPath expression to apply to the file Examples: java ApplyXPath foo.xml / java ApplyXPath foo.xml /doc/name[1]/@last @see XPathAPI 
public	TokenNamepublic	
class	TokenNameclass	
ApplyXPath	TokenNameIdentifier	 Apply X Path
{	TokenNameLBRACE	
...
;	TokenNameSEMICOLON	
// Use the simple XPath API to select a nodeIterator. 	TokenNameCOMMENT_LINE	Use the simple XPath API to select a nodeIterator. 
System	TokenNameIdentifier	 System
.	TokenNameDOT	
out	TokenNameIdentifier	 out
.	TokenNameDOT	
...
println	TokenNameIdentifier	 println
(	TokenNameLPAREN	
"java ApplyXPath filename.xml xpath "	TokenNameStringLiteral	java ApplyXPath filename.xml xpath 
+	TokenNamePLUS	
...
// end of class ApplyXPath 	TokenNameCOMMENT_LINE	end of class ApplyXPath 
