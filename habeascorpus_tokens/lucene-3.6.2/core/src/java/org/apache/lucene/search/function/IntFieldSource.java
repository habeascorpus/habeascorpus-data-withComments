...
;	TokenNameSEMICOLON	
/** * Expert: obtains int field values from the * {@link org.apache.lucene.search.FieldCache FieldCache} * using <code>getInts()</code> and makes those values * available as other numeric types, casting as needed. * * @lucene.experimental * * @see org.apache.lucene.search.function.FieldCacheSource for requirements * on the field. * * <p><b>NOTE</b>: with the switch in 2.9 to segment-based * searching, if {@link #getValues} is invoked with a * composite (multi-segment) reader, this can easily cause * double RAM usage for the values in the FieldCache. It's * best to switch your application to pass only atomic * (single segment) readers to this API.</p> */	TokenNameCOMMENT_JAVADOC	 Expert: obtains int field values from the {@link org.apache.lucene.search.FieldCache FieldCache} using <code>getInts()</code> and makes those values available as other numeric types, casting as needed. * @lucene.experimental * @see org.apache.lucene.search.function.FieldCacheSource for requirements on the field. * <p><b>NOTE</b>: with the switch in 2.9 to segment-based searching, if {@link #getValues} is invoked with a composite (multi-segment) reader, this can easily cause double RAM usage for the values in the FieldCache. It's best to switch your application to pass only atomic (single segment) readers to this API.</p> 
...
;	TokenNameSEMICOLON	
/** * Create a cached int field source with default string-to-int parser. */	TokenNameCOMMENT_JAVADOC	 Create a cached int field source with default string-to-int parser. 
public	TokenNamepublic	
IntFieldSource	TokenNameIdentifier	 Int Field Source
(	TokenNameLPAREN	
...
/** * Create a cached int field source with a specific string-to-int parser. */	TokenNameCOMMENT_JAVADOC	 Create a cached int field source with a specific string-to-int parser. 
public	TokenNamepublic	
IntFieldSource	TokenNameIdentifier	 Int Field Source
(	TokenNameLPAREN	
String	TokenNameIdentifier	 String
