...
*	TokenNameMULTIPLY	
;	TokenNameSEMICOLON	
/** * Simple tests for {@link GermanMinimalStemFilter} */	TokenNameCOMMENT_JAVADOC	 Simple tests for {@link GermanMinimalStemFilter} 
public	TokenNamepublic	
class	TokenNameclass	
TestGermanMinimalStemFilter	TokenNameIdentifier	 Test German Minimal Stem Filter
...
,	TokenNameCOMMA	
new	TokenNamenew	
GermanMinimalStemFilter	TokenNameIdentifier	 German Minimal Stem Filter
(	TokenNameLPAREN	
source	TokenNameIdentifier	 source
)	TokenNameRPAREN	
)	TokenNameRPAREN	
...
analyzer	TokenNameIdentifier	 analyzer
,	TokenNameCOMMA	
"sängerinnen"	TokenNameStringLiteral	sängerinnen
,	TokenNameCOMMA	
"sangerin"	TokenNameStringLiteral	sangerin
)	TokenNameRPAREN	
;	TokenNameSEMICOLON	
checkOneTerm	TokenNameIdentifier	 check One Term
(	TokenNameLPAREN	
analyzer	TokenNameIdentifier	 analyzer
,	TokenNameCOMMA	
"frauen"	TokenNameStringLiteral	frauen
,	TokenNameCOMMA	
...
analyzer	TokenNameIdentifier	 analyzer
,	TokenNameCOMMA	
"kenntnisse"	TokenNameStringLiteral	kenntnisse
,	TokenNameCOMMA	
"kenntnis"	TokenNameStringLiteral	kenntnis
)	TokenNameRPAREN	
;	TokenNameSEMICOLON	
checkOneTerm	TokenNameIdentifier	 check One Term
(	TokenNameLPAREN	
analyzer	TokenNameIdentifier	 analyzer
,	TokenNameCOMMA	
"staates"	TokenNameStringLiteral	staates
,	TokenNameCOMMA	
"staat"	TokenNameStringLiteral	staat
)	TokenNameRPAREN	
;	TokenNameSEMICOLON	
checkOneTerm	TokenNameIdentifier	 check One Term
(	TokenNameLPAREN	
analyzer	TokenNameIdentifier	 analyzer
,	TokenNameCOMMA	
"bilder"	TokenNameStringLiteral	bilder
,	TokenNameCOMMA	
"bild"	TokenNameStringLiteral	bild
)	TokenNameRPAREN	
;	TokenNameSEMICOLON	
checkOneTerm	TokenNameIdentifier	 check One Term
(	TokenNameLPAREN	
analyzer	TokenNameIdentifier	 analyzer
,	TokenNameCOMMA	
"boote"	TokenNameStringLiteral	boote
,	TokenNameCOMMA	
...
analyzer	TokenNameIdentifier	 analyzer
,	TokenNameCOMMA	
"götter"	TokenNameStringLiteral	götter
,	TokenNameCOMMA	
"gott"	TokenNameStringLiteral	gott
)	TokenNameRPAREN	
;	TokenNameSEMICOLON	
checkOneTerm	TokenNameIdentifier	 check One Term
(	TokenNameLPAREN	
analyzer	TokenNameIdentifier	 analyzer
,	TokenNameCOMMA	
"äpfel"	TokenNameStringLiteral	äpfel
,	TokenNameCOMMA	
"apfel"	TokenNameStringLiteral	apfel
)	TokenNameRPAREN	
;	TokenNameSEMICOLON	
}	TokenNameRBRACE	
...
(	TokenNameLPAREN	
"deminimaltestdata.zip"	TokenNameStringLiteral	deminimaltestdata.zip
)	TokenNameRPAREN	
,	TokenNameCOMMA	
"deminimal.txt"	TokenNameStringLiteral	deminimal.txt
)	TokenNameRPAREN	
;	TokenNameSEMICOLON	
}	TokenNameRBRACE	
