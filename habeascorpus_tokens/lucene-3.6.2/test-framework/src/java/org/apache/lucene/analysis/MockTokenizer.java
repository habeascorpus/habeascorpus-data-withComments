...
0	TokenNameIntegerLiteral	
;	TokenNameSEMICOLON	
// only for asserting 	TokenNameCOMMENT_LINE	only for asserting 
private	TokenNameprivate	
boolean	TokenNameboolean	
...
/** Calls {@link #MockTokenizer(Reader, int, boolean) MockTokenizer(Reader, WHITESPACE, true)} */	TokenNameCOMMENT_JAVADOC	 Calls {@link #MockTokenizer(Reader, int, boolean) MockTokenizer(Reader, WHITESPACE, true)} 
public	TokenNamepublic	
MockTokenizer	TokenNameIdentifier	 Mock Tokenizer
(	TokenNameLPAREN	
Reader	TokenNameIdentifier	 Reader
...
;	TokenNameSEMICOLON	
int	TokenNameint	
correctedStartOffset	TokenNameIdentifier	 corrected Start Offset
=	TokenNameEQUAL	
...
;	TokenNameSEMICOLON	
int	TokenNameint	
correctedEndOffset	TokenNameIdentifier	 corrected End Offset
=	TokenNameEQUAL	
correctOffset	TokenNameIdentifier	 correct Offset
(	TokenNameLPAREN	
endOffset	TokenNameIdentifier	 end Offset
...
AssumptionViolatedException	TokenNameIdentifier	 Assumption Violated Exception
(	TokenNameLPAREN	
"Test data cannot contain '\uFFFF' (Lucene 3.x only)"	TokenNameStringLiteral	Test data cannot contain '\uFFFF' (Lucene 3.x only)
)	TokenNameRPAREN	
;	TokenNameSEMICOLON	
}	TokenNameRBRACE	
assert	TokenNameassert	
