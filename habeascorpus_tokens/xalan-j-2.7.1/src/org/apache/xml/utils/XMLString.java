...
/* * $Id: XMLString.java 570109 2007-08-27 13:31:35Z zongaro $ */	TokenNameCOMMENT_BLOCK	 $Id: XMLString.java 570109 2007-08-27 13:31:35Z zongaro $ 
...
;	TokenNameSEMICOLON	
/** * This class is meant to be an interface to character strings, whether they * be java Strings or <code>org.apache.xml.utils.FastStringBuffer</code>s, or * other character data. By using XMLString, character copies can be reduced * in the XML pipeline. */	TokenNameCOMMENT_JAVADOC	 This class is meant to be an interface to character strings, whether they be java Strings or <code>org.apache.xml.utils.FastStringBuffer</code>s, or other character data. By using XMLString, character copies can be reduced in the XML pipeline. 
...
;	TokenNameSEMICOLON	
/** * Compares this string to the specified object. * The result is <code>true</code> if and only if the argument is not * <code>null</code> and is an <code>XMLString</code> object that represents * the same sequence of characters as this object. * * @param anObject the object to compare this <code>String</code> * against. * @return <code>true</code> if the <code>String </code>are equal; * <code>false</code> otherwise. * @see java.lang.String#compareTo(java.lang.String) * @see java.lang.String#equalsIgnoreCase(java.lang.String) */	TokenNameCOMMENT_JAVADOC	 Compares this string to the specified object. The result is <code>true</code> if and only if the argument is not <code>null</code> and is an <code>XMLString</code> object that represents the same sequence of characters as this object. * @param anObject the object to compare this <code>String</code> against. @return <code>true</code> if the <code>String </code>are equal; <code>false</code> otherwise. @see java.lang.String#compareTo(java.lang.String) @see java.lang.String#equalsIgnoreCase(java.lang.String) 
public	TokenNamepublic	
abstract	TokenNameabstract	
boolean	TokenNameboolean	
...
;	TokenNameSEMICOLON	
/** * Compares this string to the specified <code>String</code>. * The result is <code>true</code> if and only if the argument is not * <code>null</code> and is a <code>String</code> object that represents * the same sequence of characters as this object. * * @param anotherString the object to compare this <code>String</code> * against. * @return <code>true</code> if the <code>String</code>s are equal; * <code>false</code> otherwise. * @see java.lang.String#compareTo(java.lang.String) * @see java.lang.String#equalsIgnoreCase(java.lang.String) */	TokenNameCOMMENT_JAVADOC	 Compares this string to the specified <code>String</code>. The result is <code>true</code> if and only if the argument is not <code>null</code> and is a <code>String</code> object that represents the same sequence of characters as this object. * @param anotherString the object to compare this <code>String</code> against. @return <code>true</code> if the <code>String</code>s are equal; <code>false</code> otherwise. @see java.lang.String#compareTo(java.lang.String) @see java.lang.String#equalsIgnoreCase(java.lang.String) 
public	TokenNamepublic	
abstract	TokenNameabstract	
boolean	TokenNameboolean	
equals	TokenNameIdentifier	 equals
