...
int	TokenNameint	
GROUD	TokenNameIdentifier	 GROUD
=	TokenNameEQUAL	
-	TokenNameMINUS	
...
/** * Implements an IntIterator used for iteration over the map's values. */	TokenNameCOMMENT_JAVADOC	 Implements an IntIterator used for iteration over the map's values. 
private	TokenNameprivate	
final	TokenNamefinal	
class	TokenNameclass	
...
/** * Checks if the given object exists in the map.<br> * This method iterates over the collection, trying to find an equal object. * * @param v * value that is checked against the map data. * @return true if the value exists in the map (in .equals() meaning). * false otherwise. */	TokenNameCOMMENT_JAVADOC	 Checks if the given object exists in the map.<br> This method iterates over the collection, trying to find an equal object. * @param v value that is checked against the map data. @return true if the value exists in the map (in .equals() meaning). false otherwise. 
public	TokenNamepublic	
boolean	TokenNameboolean	
...
/** * Inserts the &lt;key,value&gt; pair into the map. If the key already exists, * this method updates the mapped value to the given one, returning the old * mapped value. * * @return the old mapped value, or 0 if the key didn't exist. */	TokenNameCOMMENT_JAVADOC	 Inserts the &lt;key,value&gt; pair into the map. If the key already exists, this method updates the mapped value to the given one, returning the old mapped value. * @return the old mapped value, or 0 if the key didn't exist. 
public	TokenNamepublic	
int	TokenNameint	
