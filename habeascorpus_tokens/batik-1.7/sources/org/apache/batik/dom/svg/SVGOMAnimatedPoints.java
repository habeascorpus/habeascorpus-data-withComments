...
;	TokenNameSEMICOLON	
/** * This class is the implementation of the SVGAnimatedPoints interface. * * @author <a href="mailto:nicolas.socheleau@bitflash.com">Nicolas Socheleau</a> * @version $Id: SVGOMAnimatedPoints.java 527382 2007-04-11 04:31:58Z cam $ */	TokenNameCOMMENT_JAVADOC	 This class is the implementation of the SVGAnimatedPoints interface. * @author <a href="mailto:nicolas.socheleau@bitflash.com">Nicolas Socheleau</a> @version $Id: SVGOMAnimatedPoints.java 527382 2007-04-11 04:31:58Z cam $ 
...
BaseSVGPointList	TokenNameIdentifier	 Base SVG Point List
baseVal	TokenNameIdentifier	 base Val
;	TokenNameSEMICOLON	
/** * The animated value. */	TokenNameCOMMENT_JAVADOC	 The animated value. 
protected	TokenNameprotected	
AnimSVGPointList	TokenNameIdentifier	 Anim SVG Point List
animVal	TokenNameIdentifier	 anim Val
;	TokenNameSEMICOLON	
/** * Whether the list is changing. */	TokenNameCOMMENT_JAVADOC	 Whether the list is changing. 
protected	TokenNameprotected	
boolean	TokenNameboolean	
changing	TokenNameIdentifier	 changing
;	TokenNameSEMICOLON	
/** * Default value for the point list. */	TokenNameCOMMENT_JAVADOC	 Default value for the point list. 
protected	TokenNameprotected	
String	TokenNameIdentifier	 String
defaultValue	TokenNameIdentifier	 default Value
;	TokenNameSEMICOLON	
/** * Creates a new SVGOMAnimatedPoints. * @param elt The associated element. * @param ns The attribute's namespace URI. * @param ln The attribute's local name. * @param defaultValue The default value if the attribute is not specified. */	TokenNameCOMMENT_JAVADOC	 Creates a new SVGOMAnimatedPoints. @param elt The associated element. @param ns The attribute's namespace URI. @param ln The attribute's local name. @param defaultValue The default value if the attribute is not specified. 
public	TokenNamepublic	
SVGOMAnimatedPoints	TokenNameIdentifier	 SVGOM Animated Points
(	TokenNameLPAREN	
...
/** * <b>DOM</b>: Implements {@link SVGAnimatedPoints#getPoints()}. */	TokenNameCOMMENT_JAVADOC	 <b>DOM</b>: Implements {@link SVGAnimatedPoints#getPoints()}. 
public	TokenNamepublic	
SVGPointList	TokenNameIdentifier	 SVG Point List
...
/** * <b>DOM</b>: Implements {@link SVGAnimatedPoints#getAnimatedPoints()}. */	TokenNameCOMMENT_JAVADOC	 <b>DOM</b>: Implements {@link SVGAnimatedPoints#getAnimatedPoints()}. 
public	TokenNamepublic	
SVGPointList	TokenNameIdentifier	 SVG Point List
...
;	TokenNameSEMICOLON	
AnimatablePointListValue	TokenNameIdentifier	 Animatable Point List Value
animPointList	TokenNameIdentifier	 anim Point List
=	TokenNameEQUAL	
(	TokenNameLPAREN	
AnimatablePointListValue	TokenNameIdentifier	 Animatable Point List Value
)	TokenNameRPAREN	
...
/** * {@link SVGPointList} implementation for the base point list value. */	TokenNameCOMMENT_JAVADOC	 {@link SVGPointList} implementation for the base point list value. 
protected	TokenNameprotected	
class	TokenNameclass	
BaseSVGPointList	TokenNameIdentifier	 Base SVG Point List
extends	TokenNameextends	
...
/** * Create a SVGException. */	TokenNameCOMMENT_JAVADOC	 Create a SVGException. 
protected	TokenNameprotected	
SVGException	TokenNameIdentifier	 SVG Exception
...
/** * Returns the value of the DOM attribute containing the point list. */	TokenNameCOMMENT_JAVADOC	 Returns the value of the DOM attribute containing the point list. 
protected	TokenNameprotected	
String	TokenNameIdentifier	 String
getValueAsString	TokenNameIdentifier	 get Value As String
(	TokenNameLPAREN	
...
/** * Sets the DOM attribute value containing the point list. */	TokenNameCOMMENT_JAVADOC	 Sets the DOM attribute value containing the point list. 
protected	TokenNameprotected	
void	TokenNamevoid	
...
/** * {@link SVGPointList} implementation for the animated point list value. */	TokenNameCOMMENT_JAVADOC	 {@link SVGPointList} implementation for the animated point list value. 
protected	TokenNameprotected	
class	TokenNameclass	
AnimSVGPointList	TokenNameIdentifier	 Anim SVG Point List
extends	TokenNameextends	
AbstractSVGPointList	TokenNameIdentifier	 Abstract SVG Point List
{	TokenNameLBRACE	
/** * Creates a new AnimSVGPointList. */	TokenNameCOMMENT_JAVADOC	 Creates a new AnimSVGPointList. 
public	TokenNamepublic	
AnimSVGPointList	TokenNameIdentifier	 Anim SVG Point List
(	TokenNameLPAREN	
)	TokenNameRPAREN	
...
/** * <b>DOM</b>: Implements {@link SVGPointList#getNumberOfItems()}. */	TokenNameCOMMENT_JAVADOC	 <b>DOM</b>: Implements {@link SVGPointList#getNumberOfItems()}. 
public	TokenNamepublic	
int	TokenNameint	
getNumberOfItems	TokenNameIdentifier	 get Number Of Items
(	TokenNameLPAREN	
...
/** * <b>DOM</b>: Implements {@link SVGPointList#clear()}. */	TokenNameCOMMENT_JAVADOC	 <b>DOM</b>: Implements {@link SVGPointList#clear()}. 
public	TokenNamepublic	
void	TokenNamevoid	
clear	TokenNameIdentifier	 clear
(	TokenNameLPAREN	
...
,	TokenNameCOMMA	
"readonly.point.list"	TokenNameStringLiteral	readonly.point.list
,	TokenNameCOMMA	
null	TokenNamenull	
)	TokenNameRPAREN	
;	TokenNameSEMICOLON	
...
/** * Resets the value of the associated attribute. Does nothing, since * there is no attribute for an animated value. */	TokenNameCOMMENT_JAVADOC	 Resets the value of the associated attribute. Does nothing, since there is no attribute for an animated value. 
protected	TokenNameprotected	
void	TokenNamevoid	
resetAttribute	TokenNameIdentifier	 reset Attribute
(	TokenNameLPAREN	
...
/** * Initializes the list, if needed. Does nothing, since there is no * attribute to read the list from. */	TokenNameCOMMENT_JAVADOC	 Initializes the list, if needed. Does nothing, since there is no attribute to read the list from. 
protected	TokenNameprotected	
void	TokenNamevoid	
revalidate	TokenNameIdentifier	 revalidate
(	TokenNameLPAREN	
