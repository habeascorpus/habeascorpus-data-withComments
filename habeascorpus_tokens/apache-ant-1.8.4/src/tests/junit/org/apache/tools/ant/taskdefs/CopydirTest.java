...
CopydirTest	TokenNameIdentifier	 Copydir Test
...
(	TokenNameLPAREN	
"src/etc/testcases/taskdefs/copydir.xml"	TokenNameStringLiteral	src/etc/testcases/taskdefs/copydir.xml
)	TokenNameRPAREN	
;	TokenNameSEMICOLON	
}	TokenNameRBRACE	
public	TokenNamepublic	
...
,	TokenNameCOMMA	
"DEPRECATED - The copydir task is deprecated. Use copy instead.Warning: src == dest"	TokenNameStringLiteral	DEPRECATED - The copydir task is deprecated. Use copy instead.Warning: src == dest
)	TokenNameRPAREN	
;	TokenNameSEMICOLON	
}	TokenNameRBRACE	
public	TokenNamepublic	
...
,	TokenNameCOMMA	
"../taskdefs.tmp"	TokenNameStringLiteral	../taskdefs.tmp
)	TokenNameRPAREN	
;	TokenNameSEMICOLON	
if	TokenNameif	
(	TokenNameLPAREN	
...
// We keep this, so we have something to delete in later tests :-) 	TokenNameCOMMENT_LINE	We keep this, so we have something to delete in later tests :-) 
}	TokenNameRBRACE	
public	TokenNamepublic	
void	TokenNamevoid	
...
,	TokenNameCOMMA	
"target is file"	TokenNameStringLiteral	target is file
)	TokenNameRPAREN	
;	TokenNameSEMICOLON	
}	TokenNameRBRACE	
}	TokenNameRBRACE	
