...
;	TokenNameSEMICOLON	
/** * FilterAsAlphaRable implementation. * * This will take any source Filter and convert it to an alpha channel * according the the SVG Mask operation. * * @author <a href="mailto:Thomas.DeWeese@Kodak.com">Thomas DeWeese</a> * @version $Id: FilterAsAlphaRable.java 475477 2006-11-15 22:44:28Z cam $ */	TokenNameCOMMENT_JAVADOC	 FilterAsAlphaRable implementation. * This will take any source Filter and convert it to an alpha channel according the the SVG Mask operation. * @author <a href="mailto:Thomas.DeWeese@Kodak.com">Thomas DeWeese</a> @version $Id: FilterAsAlphaRable.java 475477 2006-11-15 22:44:28Z cam $ 
public	TokenNamepublic	
class	TokenNameclass	
FilterAsAlphaRable	TokenNameIdentifier	 Filter As Alpha Rable
...
/** * Pass-through: returns the source's bounds */	TokenNameCOMMENT_JAVADOC	 Pass-through: returns the source's bounds 
public	TokenNamepublic	
Rectangle2D	TokenNameIdentifier	 Rectangle2 D
...
{	TokenNameLBRACE	
// Source gets my usr2dev transform 	TokenNameCOMMENT_LINE	Source gets my usr2dev transform 
AffineTransform	TokenNameIdentifier	 Affine Transform
...
;	TokenNameSEMICOLON	
// if we didn't have an aoi specify our bounds as the aoi. 	TokenNameCOMMENT_LINE	if we didn't have an aoi specify our bounds as the aoi. 
Shape	TokenNameIdentifier	 Shape
