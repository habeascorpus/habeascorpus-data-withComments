...
/* * $Id: ErrorMessages_pl.java 468652 2006-10-28 07:05:17Z minchau $ */	TokenNameCOMMENT_BLOCK	 $Id: ErrorMessages_pl.java 468652 2006-10-28 07:05:17Z minchau $ 
...
,	TokenNameCOMMA	
"B??d wewn?trzny czasu wykonywania w klasie ''{0}''"	TokenNameStringLiteral	B??d wewn?trzny czasu wykonywania w klasie ''{0}''
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
,	TokenNameCOMMA	
"B??d czasu wykonywania podczas wykonywania <xsl:copy>."	TokenNameStringLiteral	B??d czasu wykonywania podczas wykonywania <xsl:copy>.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
,	TokenNameCOMMA	
"Niepoprawna konwersja z ''{0}'' na ''{1}''."	TokenNameStringLiteral	Niepoprawna konwersja z ''{0}'' na ''{1}''.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
,	TokenNameCOMMA	
"Funkcja zewn?trzna ''{0}'' jest nieobs?ugiwana przez XSLTC."	TokenNameStringLiteral	Funkcja zewn?trzna ''{0}'' jest nieobs?ugiwana przez XSLTC.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
,	TokenNameCOMMA	
"Nieznany typ argumentu w wyra?eniu r—wno?ci."	TokenNameStringLiteral	Nieznany typ argumentu w wyra?eniu r—wno?ci.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
,	TokenNameCOMMA	
"Niepoprawny typ argumentu ''{0}'' w wywo?aniu funkcji ''{1}''"	TokenNameStringLiteral	Niepoprawny typ argumentu ''{0}'' w wywo?aniu funkcji ''{1}''
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
,	TokenNameCOMMA	
"Pr—ba sformatowania liczby ''{0}'' za pomoc? wzorca ''{1}''."	TokenNameStringLiteral	Pr—ba sformatowania liczby ''{0}'' za pomoc? wzorca ''{1}''.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
,	TokenNameCOMMA	
"Nie mo?na utworzy? kopii iteratora ''{0}''."	TokenNameStringLiteral	Nie mo?na utworzy? kopii iteratora ''{0}''.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
,	TokenNameCOMMA	
"Iterator dla osi ''{0}'' jest nieobs?ugiwany."	TokenNameStringLiteral	Iterator dla osi ''{0}'' jest nieobs?ugiwany.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
/* * Note to translators: The following represents an internal error * situation in XSLTC. The processor attempted to create an iterator * for a particular axis (see definition above) that it does not * support. */	TokenNameCOMMENT_BLOCK	 Note to translators: The following represents an internal error situation in XSLTC. The processor attempted to create an iterator for a particular axis (see definition above) that it does not support. 
{	TokenNameLBRACE	
...
,	TokenNameCOMMA	
"Iterator dla osi ''{0}'' okre?lonego typu jest nieobs?ugiwany."	TokenNameStringLiteral	Iterator dla osi ''{0}'' okre?lonego typu jest nieobs?ugiwany.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
,	TokenNameCOMMA	
"Utworzono DOMAdapter za pomoc? ?r—d?owego DOM o b??dnym typie."	TokenNameStringLiteral	Utworzono DOMAdapter za pomoc? ?r—d?owego DOM o b??dnym typie.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
,	TokenNameCOMMA	
"U?ywany analizator sk?adni SAX nie obs?uguje zdarze? deklaracji DTD."	TokenNameStringLiteral	U?ywany analizator sk?adni SAX nie obs?uguje zdarze? deklaracji DTD.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
,	TokenNameCOMMA	
"U?ywany analizator sk?adni SAX nie obs?uguje przestrzeni nazw XML."	TokenNameStringLiteral	U?ywany analizator sk?adni SAX nie obs?uguje przestrzeni nazw XML.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
,	TokenNameCOMMA	
"Nie mo?na rozstrzygn?? odwo?ania do identyfikatora URI ''{0}''."	TokenNameStringLiteral	Nie mo?na rozstrzygn?? odwo?ania do identyfikatora URI ''{0}''.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
,	TokenNameCOMMA	
"Podany translet ''{0}'' zosta? utworzony za pomoc? wersji XSLTC, kt—ra jest nowsza od u?ywanego obecnie modu?u wykonawczego XSLTC. Trzeba zrekompilowa? arkusz styl—w lub uruchomi? ten translet za pomoc? nowszej wersji XSLTC."	TokenNameStringLiteral	Podany translet ''{0}'' zosta? utworzony za pomoc? wersji XSLTC, kt—ra jest nowsza od u?ywanego obecnie modu?u wykonawczego XSLTC. Trzeba zrekompilowa? arkusz styl—w lub uruchomi? ten translet za pomoc? nowszej wersji XSLTC.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
,	TokenNameCOMMA	
"Atrybut, kt—rego warto?ci? musi by? nazwa QName, mia? warto?? ''{0}''"	TokenNameStringLiteral	Atrybut, kt—rego warto?ci? musi by? nazwa QName, mia? warto?? ''{0}''
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
,	TokenNameCOMMA	
"Atrybut, kt—rego warto?ci? musi by? nazwa NCName, mia? warto?? ''{0}''"	TokenNameStringLiteral	Atrybut, kt—rego warto?ci? musi by? nazwa NCName, mia? warto?? ''{0}''
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
BasisLibrary	TokenNameIdentifier	 Basis Library
...
,	TokenNameCOMMA	
"U?ycie funkcji rozszerzenia ''{0}'' jest niedozwolone, gdy opcja przetwarzania bezpiecznego jest ustawiona na warto?? true."	TokenNameStringLiteral	U?ycie funkcji rozszerzenia ''{0}'' jest niedozwolone, gdy opcja przetwarzania bezpiecznego jest ustawiona na warto?? true.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
BasisLibrary	TokenNameIdentifier	 Basis Library
...
,	TokenNameCOMMA	
"U?ycie elementu rozszerzenia ''{0}'' jest niedozwolone, gdy opcja przetwarzania bezpiecznego jest ustawiona na warto?? true."	TokenNameStringLiteral	U?ycie elementu rozszerzenia ''{0}'' jest niedozwolone, gdy opcja przetwarzania bezpiecznego jest ustawiona na warto?? true.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
}	TokenNameRBRACE	
;	TokenNameSEMICOLON	
