...
;	TokenNameSEMICOLON	
/** * Builds no object, it only returns the {@link Query} object set on the * {@link ModifierQueryNode} object using a * {@link QueryTreeBuilder#QUERY_TREE_BUILDER_TAGID} tag. */	TokenNameCOMMENT_JAVADOC	 Builds no object, it only returns the {@link Query} object set on the {@link ModifierQueryNode} object using a {@link QueryTreeBuilder#QUERY_TREE_BUILDER_TAGID} tag. 
public	TokenNamepublic	
class	TokenNameclass	
ModifierQueryNodeBuilder	TokenNameIdentifier	 Modifier Query Node Builder
...
{	TokenNameLBRACE	
ModifierQueryNode	TokenNameIdentifier	 Modifier Query Node
modifierNode	TokenNameIdentifier	 modifier Node
=	TokenNameEQUAL	
(	TokenNameLPAREN	
ModifierQueryNode	TokenNameIdentifier	 Modifier Query Node
)	TokenNameRPAREN	
