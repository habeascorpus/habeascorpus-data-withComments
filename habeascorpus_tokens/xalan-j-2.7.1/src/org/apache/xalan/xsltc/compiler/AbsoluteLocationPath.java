...
/* * $Id: AbsoluteLocationPath.java 468650 2006-10-28 07:03:30Z minchau $ */	TokenNameCOMMENT_BLOCK	 $Id: AbsoluteLocationPath.java 468650 2006-10-28 07:03:30Z minchau $ 
...
{	TokenNameLBRACE	
return	TokenNamereturn	
"AbsoluteLocationPath("	TokenNameStringLiteral	AbsoluteLocationPath(
+	TokenNamePLUS	
(	TokenNameLPAREN	
_path	TokenNameIdentifier	 path
!=	TokenNameNOT_EQUAL	
...
{	TokenNameLBRACE	
// promote to node-set 	TokenNameCOMMENT_LINE	promote to node-set 
_path	TokenNameIdentifier	 path
=	TokenNameEQUAL	
new	TokenNamenew	
...
final	TokenNamefinal	
int	TokenNameint	
initAI	TokenNameIdentifier	 init AI
=	TokenNameEQUAL	
cpg	TokenNameIdentifier	 cpg
.	TokenNameDOT	
...
;	TokenNameSEMICOLON	
// Compile relative path iterator(s) 	TokenNameCOMMENT_LINE	Compile relative path iterator(s) 
...
// this argument to its constructor. Instead we calculate the 	TokenNameCOMMENT_LINE	this argument to its constructor. Instead we calculate the 
// value of the argument to the constructor first, store it in 	TokenNameCOMMENT_LINE	value of the argument to the constructor first, store it in 
// a temporary variable, create the object and reload the argument 	TokenNameCOMMENT_LINE	a temporary variable, create the object and reload the argument 
// from the temporary to avoid the problem. 	TokenNameCOMMENT_LINE	from the temporary to avoid the problem. 
_path	TokenNameIdentifier	 path
.	TokenNameDOT	
translate	TokenNameIdentifier	 translate
(	TokenNameLPAREN	
...
;	TokenNameSEMICOLON	
LocalVariableGen	TokenNameIdentifier	 Local Variable Gen
relPathIterator	TokenNameIdentifier	 rel Path Iterator
=	TokenNameEQUAL	
methodGen	TokenNameIdentifier	 method Gen
.	TokenNameDOT	
addLocalVariable	TokenNameIdentifier	 add Local Variable
(	TokenNameLPAREN	
"abs_location_path_tmp"	TokenNameStringLiteral	abs_location_path_tmp
,	TokenNameCOMMA	
Util	TokenNameIdentifier	 Util
.	TokenNameDOT	
...
;	TokenNameSEMICOLON	
// Create new AbsoluteIterator 	TokenNameCOMMENT_LINE	Create new AbsoluteIterator 
il	TokenNameIdentifier	 il
.	TokenNameDOT	
append	TokenNameIdentifier	 append
(	TokenNameLPAREN	
...
;	TokenNameSEMICOLON	
// Initialize AbsoluteIterator with iterator from the stack 	TokenNameCOMMENT_LINE	Initialize AbsoluteIterator with iterator from the stack 
il	TokenNameIdentifier	 il
.	TokenNameDOT	
append	TokenNameIdentifier	 append
(	TokenNameLPAREN	
