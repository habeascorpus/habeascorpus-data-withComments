...
;	TokenNameSEMICOLON	
/** * Reducing an extraction task to tagging tokens as one of five * categories. The categories are: a token beginning the type to * extract, a token ending the type to extract, a single token which * is the type to extract, otherwise inside the type to extract, or * outside the type to extract. * * @author William Cohen */	TokenNameCOMMENT_JAVADOC	 Reducing an extraction task to tagging tokens as one of five categories. The categories are: a token beginning the type to extract, a token ending the type to extract, a single token which is the type to extract, otherwise inside the type to extract, or outside the type to extract. * @author William Cohen 
// to do - test with spanProp 	TokenNameCOMMENT_LINE	to do - test with spanProp 
public	TokenNamepublic	
class	TokenNameclass	
BeginContinueEndUniqueReduction	TokenNameIdentifier	 Begin Continue End Unique Reduction
...
(	TokenNameLPAREN	
"empty span "	TokenNameStringLiteral	empty span 
+	TokenNamePLUS	
span	TokenNameIdentifier	 span
)	TokenNameRPAREN	
;	TokenNameSEMICOLON	
