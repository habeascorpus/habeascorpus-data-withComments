...
;	TokenNameSEMICOLON	
/** * A {@link TokenFilter} that applies {@link FrenchMinimalStemmer} to stem French * words. * <p> * To prevent terms from being stemmed use an instance of * {@link KeywordMarkerFilter} or a custom {@link TokenFilter} that sets * the {@link KeywordAttribute} before this {@link TokenStream}. * </p> */	TokenNameCOMMENT_JAVADOC	 A {@link TokenFilter} that applies {@link FrenchMinimalStemmer} to stem French words. <p> To prevent terms from being stemmed use an instance of {@link KeywordMarkerFilter} or a custom {@link TokenFilter} that sets the {@link KeywordAttribute} before this {@link TokenStream}. </p> 
...
final	TokenNamefinal	
FrenchMinimalStemmer	TokenNameIdentifier	 French Minimal Stemmer
