...
.	TokenNameDOT	
ItalianStemmer	TokenNameIdentifier	 Italian Stemmer
;	TokenNameSEMICOLON	
/** * {@link Analyzer} for Italian. * <p> * <a name="version"/> * <p>You must specify the required {@link Version} * compatibility when creating ItalianAnalyzer: * <ul> * <li> As of 3.6, ItalianLightStemFilter is used for less aggressive stemming. * <li> As of 3.2, ElisionFilter with a set of Italian * contractions is used by default. * </ul> */	TokenNameCOMMENT_JAVADOC	 {@link Analyzer} for Italian. <p> <a name="version"/> <p>You must specify the required {@link Version} compatibility when creating ItalianAnalyzer: <ul> <li> As of 3.6, ItalianLightStemFilter is used for less aggressive stemming. <li> As of 3.2, ElisionFilter with a set of Italian contractions is used by default. </ul> 
...
?	TokenNameQUESTION	
>	TokenNameGREATER	
stemExclusionSet	TokenNameIdentifier	 stem Exclusion Set
;	TokenNameSEMICOLON	
/** File containing default Italian stopwords. */	TokenNameCOMMENT_JAVADOC	 File containing default Italian stopwords. 
public	TokenNamepublic	
final	TokenNamefinal	
...
=	TokenNameEQUAL	
"italian_stop.txt"	TokenNameStringLiteral	italian_stop.txt
;	TokenNameSEMICOLON	
private	TokenNameprivate	
static	TokenNamestatic	
final	TokenNamefinal	
...
,	TokenNameCOMMA	
"dall"	TokenNameStringLiteral	dall
,	TokenNameCOMMA	
"dell"	TokenNameStringLiteral	dell
,	TokenNameCOMMA	
"nell"	TokenNameStringLiteral	nell
,	TokenNameCOMMA	
"sull"	TokenNameStringLiteral	sull
,	TokenNameCOMMA	
"coll"	TokenNameStringLiteral	coll
,	TokenNameCOMMA	
"pell"	TokenNameStringLiteral	pell
,	TokenNameCOMMA	
"gl"	TokenNameStringLiteral	gl
,	TokenNameCOMMA	
"agl"	TokenNameStringLiteral	agl
,	TokenNameCOMMA	
"dagl"	TokenNameStringLiteral	dagl
,	TokenNameCOMMA	
"degl"	TokenNameStringLiteral	degl
,	TokenNameCOMMA	
"negl"	TokenNameStringLiteral	negl
,	TokenNameCOMMA	
"sugl"	TokenNameStringLiteral	sugl
,	TokenNameCOMMA	
"un"	TokenNameStringLiteral	un
,	TokenNameCOMMA	
...
/** * Builds an analyzer with the default stop words: {@link #DEFAULT_STOPWORD_FILE}. */	TokenNameCOMMENT_JAVADOC	 Builds an analyzer with the default stop words: {@link #DEFAULT_STOPWORD_FILE}. 
public	TokenNamepublic	
ItalianAnalyzer	TokenNameIdentifier	 Italian Analyzer
(	TokenNameLPAREN	
Version	TokenNameIdentifier	 Version
...
/** * Builds an analyzer with the given stop words. If a non-empty stem exclusion set is * provided this analyzer will add a {@link KeywordMarkerFilter} before * stemming. * * @param matchVersion lucene compatibility version * @param stopwords a stopword set * @param stemExclusionSet a set of terms not to be stemmed */	TokenNameCOMMENT_JAVADOC	 Builds an analyzer with the given stop words. If a non-empty stem exclusion set is provided this analyzer will add a {@link KeywordMarkerFilter} before stemming. * @param matchVersion lucene compatibility version @param stopwords a stopword set @param stemExclusionSet a set of terms not to be stemmed 
public	TokenNamepublic	
ItalianAnalyzer	TokenNameIdentifier	 Italian Analyzer
(	TokenNameLPAREN	
Version	TokenNameIdentifier	 Version
...
=	TokenNameEQUAL	
new	TokenNamenew	
ItalianLightStemFilter	TokenNameIdentifier	 Italian Light Stem Filter
(	TokenNameLPAREN	
result	TokenNameIdentifier	 result
)	TokenNameRPAREN	
;	TokenNameSEMICOLON	
