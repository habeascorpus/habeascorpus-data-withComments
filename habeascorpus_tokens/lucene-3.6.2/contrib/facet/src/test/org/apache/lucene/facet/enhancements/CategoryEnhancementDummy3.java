...
CategoryEnhancementDummy3	TokenNameIdentifier	 Category Enhancement Dummy3
...
CATEGORY_TOKEN_BYTES	TokenNameIdentifier	 CATEGORY  TOKEN  BYTES
=	TokenNameEQUAL	
new	TokenNamenew	
byte	TokenNamebyte	
[	TokenNameLBRACKET	
...
(	TokenNameLPAREN	
"unexpected data length "	TokenNameStringLiteral	unexpected data length 
+	TokenNamePLUS	
length	TokenNameIdentifier	 length
)	TokenNameRPAREN	
;	TokenNameSEMICOLON	
