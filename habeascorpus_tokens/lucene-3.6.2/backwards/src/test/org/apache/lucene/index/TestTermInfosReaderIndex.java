...
TestTermInfosReaderIndex	TokenNameIdentifier	 Test Term Infos Reader Index
...
int	TokenNameint	
NUMBER_OF_DOCUMENTS	TokenNameIdentifier	 NUMBER  OF  DOCUMENTS
=	TokenNameEQUAL	
...
final	TokenNamefinal	
int	TokenNameint	
NUMBER_OF_FIELDS	TokenNameIdentifier	 NUMBER  OF  FIELDS
=	TokenNameEQUAL	
...
>	TokenNameGREATER	
sampleTerms	TokenNameIdentifier	 sample Terms
;	TokenNameSEMICOLON	
@	TokenNameAT	
...
termIndexInterval	TokenNameIdentifier	 term Index Interval
=	TokenNameEQUAL	
populate	TokenNameIdentifier	 populate
(	TokenNameLPAREN	
directory	TokenNameIdentifier	 directory
)	TokenNameRPAREN	
;	TokenNameSEMICOLON	
...
public	TokenNamepublic	
void	TokenNamevoid	
testSeekEnum	TokenNameIdentifier	 test Seek Enum
(	TokenNameLPAREN	
)	TokenNameRPAREN	
throws	TokenNamethrows	
...
term	TokenNameIdentifier	 term
=	TokenNameEQUAL	
findTermThatWouldBeAtIndex	TokenNameIdentifier	 find Term That Would Be At Index
(	TokenNameLPAREN	
clone	TokenNameIdentifier	 clone
,	TokenNameCOMMA	
indexPosition	TokenNameIdentifier	 index Position
...
public	TokenNamepublic	
void	TokenNamevoid	
testRandomSearchPerformance	TokenNameIdentifier	 test Random Search Performance
(	TokenNameLPAREN	
)	TokenNameRPAREN	
throws	TokenNamethrows	
CorruptIndexException	TokenNameIdentifier	 Corrupt Index Exception
...
{	TokenNameLBRACE	
int	TokenNameint	
termPosition	TokenNameIdentifier	 term Position
=	TokenNameEQUAL	
index	TokenNameIdentifier	 index
*	TokenNameMULTIPLY	
termIndexInterval	TokenNameIdentifier	 term Index Interval
...
(	TokenNameLPAREN	
"Should not have run out of terms."	TokenNameStringLiteral	Should not have run out of terms.
)	TokenNameRPAREN	
;	TokenNameSEMICOLON	
}	TokenNameRBRACE	
}	TokenNameRBRACE	
...
;	TokenNameSEMICOLON	
// turn off compound file, this test will open some index files directly. 	TokenNameCOMMENT_LINE	turn off compound file, this test will open some index files directly. 
