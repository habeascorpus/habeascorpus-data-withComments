...
.	TokenNameDOT	
SpanishStemmer	TokenNameIdentifier	 Spanish Stemmer
;	TokenNameSEMICOLON	
/** * {@link Analyzer} for Spanish. * <p> * <a name="version"/> * <p>You must specify the required {@link Version} * compatibility when creating SpanishAnalyzer: * <ul> * <li> As of 3.6, SpanishLightStemFilter is used for less aggressive stemming. * </ul> */	TokenNameCOMMENT_JAVADOC	 {@link Analyzer} for Spanish. <p> <a name="version"/> <p>You must specify the required {@link Version} compatibility when creating SpanishAnalyzer: <ul> <li> As of 3.6, SpanishLightStemFilter is used for less aggressive stemming. </ul> 
public	TokenNamepublic	
final	TokenNamefinal	
class	TokenNameclass	
SpanishAnalyzer	TokenNameIdentifier	 Spanish Analyzer
...
;	TokenNameSEMICOLON	
/** File containing default Spanish stopwords. */	TokenNameCOMMENT_JAVADOC	 File containing default Spanish stopwords. 
public	TokenNamepublic	
final	TokenNamefinal	
...
=	TokenNameEQUAL	
"spanish_stop.txt"	TokenNameStringLiteral	spanish_stop.txt
;	TokenNameSEMICOLON	
...
=	TokenNameEQUAL	
new	TokenNamenew	
SpanishLightStemFilter	TokenNameIdentifier	 Spanish Light Stem Filter
(	TokenNameLPAREN	
result	TokenNameIdentifier	 result
)	TokenNameRPAREN	
;	TokenNameSEMICOLON	
