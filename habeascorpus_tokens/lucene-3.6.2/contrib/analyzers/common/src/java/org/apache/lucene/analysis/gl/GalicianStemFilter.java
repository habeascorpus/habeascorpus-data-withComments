...
;	TokenNameSEMICOLON	
/** * A {@link TokenFilter} that applies {@link GalicianStemmer} to stem * Galician words. * <p> * To prevent terms from being stemmed use an instance of * {@link KeywordMarkerFilter} or a custom {@link TokenFilter} that sets * the {@link KeywordAttribute} before this {@link TokenStream}. * </p> */	TokenNameCOMMENT_JAVADOC	 A {@link TokenFilter} that applies {@link GalicianStemmer} to stem Galician words. <p> To prevent terms from being stemmed use an instance of {@link KeywordMarkerFilter} or a custom {@link TokenFilter} that sets the {@link KeywordAttribute} before this {@link TokenStream}. </p> 
...
final	TokenNamefinal	
GalicianStemmer	TokenNameIdentifier	 Galician Stemmer
...
{	TokenNameLBRACE	
// this stemmer increases word length by 1: worst case '*çom' -> '*ción' 	TokenNameCOMMENT_LINE	this stemmer increases word length by 1: worst case '*çom' -> '*ción' 
final	TokenNamefinal	
int	TokenNameint	
