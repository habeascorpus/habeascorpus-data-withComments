...
/* * $Id: RealType.java 468649 2006-10-28 07:00:55Z minchau $ */	TokenNameCOMMENT_BLOCK	 $Id: RealType.java 468649 2006-10-28 07:00:55Z minchau $ 
...
/** * @see org.apache.xalan.xsltc.compiler.util.Type#distanceTo */	TokenNameCOMMENT_JAVADOC	 @see org.apache.xalan.xsltc.compiler.util.Type#distanceTo 
public	TokenNamepublic	
int	TokenNameint	
...
/** * Translates a real into an object of internal type <code>type</code>. The * translation to int is undefined since reals are never converted to ints. * * @see org.apache.xalan.xsltc.compiler.util.Type#translateTo */	TokenNameCOMMENT_JAVADOC	 Translates a real into an object of internal type <code>type</code>. The translation to int is undefined since reals are never converted to ints. * @see org.apache.xalan.xsltc.compiler.util.Type#translateTo 
public	TokenNamepublic	
void	TokenNamevoid	
...
/** * Expects a real on the stack and pushes its string value by calling * <code>Double.toString(double d)</code>. * * @see org.apache.xalan.xsltc.compiler.util.Type#translateTo */	TokenNameCOMMENT_JAVADOC	 Expects a real on the stack and pushes its string value by calling <code>Double.toString(double d)</code>. * @see org.apache.xalan.xsltc.compiler.util.Type#translateTo 
public	TokenNamepublic	
void	TokenNamevoid	
translateTo	TokenNameIdentifier	 translate To
(	TokenNameLPAREN	
...
,	TokenNameCOMMA	
"realToString"	TokenNameStringLiteral	realToString
,	TokenNameCOMMA	
"(D)"	TokenNameStringLiteral	(D)
+	TokenNamePLUS	
...
/** * Expects a real on the stack and pushes a 0 if that number is 0.0 and * a 1 otherwise. * * @see org.apache.xalan.xsltc.compiler.util.Type#translateTo */	TokenNameCOMMENT_JAVADOC	 Expects a real on the stack and pushes a 0 if that number is 0.0 and a 1 otherwise. * @see org.apache.xalan.xsltc.compiler.util.Type#translateTo 
public	TokenNamepublic	
void	TokenNamevoid	
translateTo	TokenNameIdentifier	 translate To
(	TokenNameLPAREN	
...
;	TokenNameSEMICOLON	
FlowList	TokenNameIdentifier	 Flow List
falsel	TokenNameIdentifier	 falsel
=	TokenNameEQUAL	
...
/** * Expects a real on the stack and pushes a truncated integer value * * @see org.apache.xalan.xsltc.compiler.util.Type#translateTo */	TokenNameCOMMENT_JAVADOC	 Expects a real on the stack and pushes a truncated integer value * @see org.apache.xalan.xsltc.compiler.util.Type#translateTo 
public	TokenNamepublic	
void	TokenNamevoid	
translateTo	TokenNameIdentifier	 translate To
(	TokenNameLPAREN	
...
final	TokenNamefinal	
FlowList	TokenNameIdentifier	 Flow List
flowlist	TokenNameIdentifier	 flowlist
=	TokenNameEQUAL	
new	TokenNamenew	
FlowList	TokenNameIdentifier	 Flow List
(	TokenNameLPAREN	
...
;	TokenNameSEMICOLON	
// Store real into a local variable 	TokenNameCOMMENT_LINE	Store real into a local variable 
il	TokenNameIdentifier	 il
.	TokenNameDOT	
append	TokenNameIdentifier	 append
(	TokenNameLPAREN	
...
(	TokenNameLPAREN	
"real_to_boolean_tmp"	TokenNameStringLiteral	real_to_boolean_tmp
,	TokenNameCOMMA	
org	TokenNameIdentifier	 org
.	TokenNameDOT	
apache	TokenNameIdentifier	 apache
...
;	TokenNameSEMICOLON	
// Compare it to 0.0 	TokenNameCOMMENT_LINE	Compare it to 0.0 
il	TokenNameIdentifier	 il
.	TokenNameDOT	
append	TokenNameIdentifier	 append
(	TokenNameLPAREN	
DCONST_0	TokenNameIdentifier	 DCONST 0
)	TokenNameRPAREN	
;	TokenNameSEMICOLON	
il	TokenNameIdentifier	 il
.	TokenNameDOT	
append	TokenNameIdentifier	 append
(	TokenNameLPAREN	
DCMPG	TokenNameIdentifier	 DCMPG
)	TokenNameRPAREN	
;	TokenNameSEMICOLON	
flowlist	TokenNameIdentifier	 flowlist
.	TokenNameDOT	
...
;	TokenNameSEMICOLON	
//!!! call isNaN 	TokenNameCOMMENT_LINE	!!! call isNaN 
// Compare it to itself to see if NaN 	TokenNameCOMMENT_LINE	Compare it to itself to see if NaN 
il	TokenNameIdentifier	 il
.	TokenNameDOT	
append	TokenNameIdentifier	 append
(	TokenNameLPAREN	
...
;	TokenNameSEMICOLON	
// NaN != NaN 	TokenNameCOMMENT_LINE	NaN != NaN 
return	TokenNamereturn	
flowlist	TokenNameIdentifier	 flowlist
;	TokenNameSEMICOLON	
}	TokenNameRBRACE	
/** * Expects a double on the stack and pushes a boxed double. Boxed * double are represented by an instance of <code>java.lang.Double</code>. * * @see org.apache.xalan.xsltc.compiler.util.Type#translateTo */	TokenNameCOMMENT_JAVADOC	 Expects a double on the stack and pushes a boxed double. Boxed double are represented by an instance of <code>java.lang.Double</code>. * @see org.apache.xalan.xsltc.compiler.util.Type#translateTo 
public	TokenNamepublic	
void	TokenNamevoid	
translateTo	TokenNameIdentifier	 translate To
(	TokenNameLPAREN	
...
append	TokenNameIdentifier	 append
(	TokenNameLPAREN	
DUP_X2	TokenNameIdentifier	 DUP  X2
)	TokenNameRPAREN	
;	TokenNameSEMICOLON	
il	TokenNameIdentifier	 il
.	TokenNameDOT	
...
,	TokenNameCOMMA	
"(D)V"	TokenNameStringLiteral	(D)V
)	TokenNameRPAREN	
)	TokenNameRPAREN	
)	TokenNameRPAREN	
;	TokenNameSEMICOLON	
}	TokenNameRBRACE	
/** * Translates a real into the Java type denoted by <code>clazz</code>. * Expects a real on the stack and pushes a number of the appropriate * type after coercion. */	TokenNameCOMMENT_JAVADOC	 Translates a real into the Java type denoted by <code>clazz</code>. Expects a real on the stack and pushes a number of the appropriate type after coercion. 
public	TokenNamepublic	
void	TokenNamevoid	
translateTo	TokenNameIdentifier	 translate To
(	TokenNameLPAREN	
...
// Is Double <: clazz? I.e. clazz in { Double, Number, Object } 	TokenNameCOMMENT_LINE	Is Double <: clazz? I.e. clazz in { Double, Number, Object } 
else	TokenNameelse	
if	TokenNameif	
(	TokenNameLPAREN	
clazz	TokenNameIdentifier	 clazz
...
/** * Translates an external (primitive) Java type into a real. Expects a java * object on the stack and pushes a real (i.e., a double). */	TokenNameCOMMENT_JAVADOC	 Translates an external (primitive) Java type into a real. Expects a java object on the stack and pushes a real (i.e., a double). 
public	TokenNamepublic	
void	TokenNamevoid	
...
InstructionConstants	TokenNameIdentifier	 Instruction Constants
.	TokenNameDOT	
DCMPL	TokenNameIdentifier	 DCMPL
;	TokenNameSEMICOLON	
}	TokenNameRBRACE	
public	TokenNamepublic	
Instruction	TokenNameIdentifier	 Instruction
