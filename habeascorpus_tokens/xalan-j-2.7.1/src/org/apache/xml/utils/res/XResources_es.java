...
/* * $Id: XResources_es.java 468655 2006-10-28 07:12:06Z minchau $ */	TokenNameCOMMENT_BLOCK	 $Id: XResources_es.java 468655 2006-10-28 07:12:06Z minchau $ 
...
// LangResources_es.properties 	TokenNameCOMMENT_LINE	LangResources_es.properties 
// 	TokenNameCOMMENT_LINE	 
/** * The Spanish resource bundle. * @xsl.usage internal */	TokenNameCOMMENT_JAVADOC	 The Spanish resource bundle. @xsl.usage internal 
public	TokenNamepublic	
class	TokenNameclass	
XResources_es	TokenNameIdentifier	 X Resources es
...
//{"numberGroups", new int[]{10,1}}, 	TokenNameCOMMENT_LINE	{"numberGroups", new int[]{10,1}}, 
...
//{"multiplier", "10"}, 	TokenNameCOMMENT_LINE	{"multiplier", "10"}, 
//{"multiplierChar", "M"}, 	TokenNameCOMMENT_LINE	{"multiplierChar", "M"}, 
//{"digits", new char[]{'a','b','c','d','e','f','g','h','i'}}, 	TokenNameCOMMENT_LINE	{"digits", new char[]{'a','b','c','d','e','f','g','h','i'}}, 
//{"digits", new char[]{0x10D0,0x10D1,0x10D2,0x10D3,0x10D4,0x10D5,0x10D6,0x10D7,0x10D8}}, 	TokenNameCOMMENT_LINE	{"digits", new char[]{0x10D0,0x10D1,0x10D2,0x10D3,0x10D4,0x10D5,0x10D6,0x10D7,0x10D8}}, 
//{"tens", new char[]{0x10D9,0x10DA,0x10DB,0x10DC,0x10DD,0x10DE,0x10DF,0x10E0,0x10E1}}, 	TokenNameCOMMENT_LINE	{"tens", new char[]{0x10D9,0x10DA,0x10DB,0x10DC,0x10DD,0x10DE,0x10DF,0x10E0,0x10E1}}, 
//hundreds, etc... 	TokenNameCOMMENT_LINE	hundreds, etc... 
//{"tables", new String[]{"tens", "digits"}} 	TokenNameCOMMENT_LINE	{"tables", new String[]{"tens", "digits"}} 
}	TokenNameRBRACE	
;	TokenNameSEMICOLON	
}	TokenNameRBRACE	
}	TokenNameRBRACE	
