...
"?"	TokenNameStringLiteral	?
;	TokenNameSEMICOLON	
/** * Convenience method to perform the same function as CollationKeyFilter. * * @param keyBits the result from * collator.getCollationKey(original).toByteArray() * @return The encoded collation key for the original String */	TokenNameCOMMENT_JAVADOC	 Convenience method to perform the same function as CollationKeyFilter. * @param keyBits the result from collator.getCollationKey(original).toByteArray() @return The encoded collation key for the original String 
protected	TokenNameprotected	
String	TokenNameIdentifier	 String
...
keyBits	TokenNameIdentifier	 key Bits
)	TokenNameRPAREN	
{	TokenNameLBRACE	
// Ensure that the backing char[] array is large enough to hold the encoded 	TokenNameCOMMENT_LINE	Ensure that the backing char[] array is large enough to hold the encoded 
// Binary String 	TokenNameCOMMENT_LINE	Binary String 
int	TokenNameint	
...
encodedBegArray	TokenNameIdentifier	 encoded Beg Array
=	TokenNameEQUAL	
new	TokenNamenew	
char	TokenNamechar	
[	TokenNameLBRACKET	
...
,	TokenNameCOMMA	
String	TokenNameIdentifier	 String
firstBeg	TokenNameIdentifier	 first Beg
,	TokenNameCOMMA	
String	TokenNameIdentifier	 String
firstEnd	TokenNameIdentifier	 first End
,	TokenNameCOMMA	
String	TokenNameIdentifier	 String
secondBeg	TokenNameIdentifier	 second Beg
,	TokenNameCOMMA	
String	TokenNameIdentifier	 String
secondEnd	TokenNameIdentifier	 second End
)	TokenNameRPAREN	
...
// Collator (or an Arabic one for the case when Farsi searcher not 	TokenNameCOMMENT_LINE	Collator (or an Arabic one for the case when Farsi searcher not 
...
// Unicode order would include U+0633 in [ U+062F - U+0698 ], but Farsi 	TokenNameCOMMENT_LINE	Unicode order would include U+0633 in [ U+062F - U+0698 ], but Farsi 
// orders the U+0698 character before the U+0633 character, so the single 	TokenNameCOMMENT_LINE	orders the U+0698 character before the U+0633 character, so the single 
// index Term below should NOT be returned by a TermRangeQuery with a Farsi 	TokenNameCOMMENT_LINE	index Term below should NOT be returned by a TermRangeQuery with a Farsi 
...
// Unicode order would include U+0633 in [ U+062F - U+0698 ], but Farsi 	TokenNameCOMMENT_LINE	Unicode order would include U+0633 in [ U+062F - U+0698 ], but Farsi 
// orders the U+0698 character before the U+0633 character, so the single 	TokenNameCOMMENT_LINE	orders the U+0698 character before the U+0633 character, so the single 
// index Term below should NOT be returned by a TermRangeQuery 	TokenNameCOMMENT_LINE	index Term below should NOT be returned by a TermRangeQuery 
...
// 	TokenNameCOMMENT_LINE	 
// TODO: this test is really fragile. there are already 3 different cases, 	TokenNameCOMMENT_LINE	TODO: this test is really fragile. there are already 3 different cases, 
// depending upon unicode version. 	TokenNameCOMMENT_LINE	depending upon unicode version. 
public	TokenNamepublic	
void	TokenNamevoid	
...
,	TokenNameCOMMA	
String	TokenNameIdentifier	 String
usResult	TokenNameIdentifier	 us Result
,	TokenNameCOMMA	
String	TokenNameIdentifier	 String
frResult	TokenNameIdentifier	 fr Result
,	TokenNameCOMMA	
String	TokenNameIdentifier	 String
svResult	TokenNameIdentifier	 sv Result
,	TokenNameCOMMA	
String	TokenNameIdentifier	 String
dkResult	TokenNameIdentifier	 dk Result
)	TokenNameRPAREN	
throws	TokenNamethrows	
Exception	TokenNameIdentifier	 Exception
{	TokenNameLBRACE	
...
sortData	TokenNameIdentifier	 sort Data
=	TokenNameEQUAL	
new	TokenNamenew	
String	TokenNameIdentifier	 String
[	TokenNameLBRACKET	
...
{	TokenNameLBRACE	
// tracer contents US France Sweden (sv_SE) Denmark (da_DK) 	TokenNameCOMMENT_LINE	tracer contents US France Sweden (sv_SE) Denmark (da_DK) 
{	TokenNameLBRACE	
...
// Copied from TestSort.java 	TokenNameCOMMENT_LINE	Copied from TestSort.java 
...
{	TokenNameLBRACE	
int	TokenNameint	
numTestPoints	TokenNameIdentifier	 num Test Points
=	TokenNameEQUAL	
...
;	TokenNameSEMICOLON	
// create a map<String,SortKey> up front. 	TokenNameCOMMENT_LINE	create a map<String,SortKey> up front. 
// then with multiple threads, generate sort keys for all the keys in the map 	TokenNameCOMMENT_LINE	then with multiple threads, generate sort keys for all the keys in the map 
// and ensure they are the same as the ones we produced in serial fashion. 	TokenNameCOMMENT_LINE	and ensure they are the same as the ones we produced in serial fashion. 
for	TokenNamefor	
(	TokenNameLPAREN	
int	TokenNameint	
i	TokenNameIdentifier	 i
...
;	TokenNameSEMICOLON	
CharTermAttribute	TokenNameIdentifier	 Char Term Attribute
encodedBytes	TokenNameIdentifier	 encoded Bytes
=	TokenNameEQUAL	
ts	TokenNameIdentifier	 ts
.	TokenNameDOT	
...
;	TokenNameSEMICOLON	
// ensure we make a copy of the actual bytes too 	TokenNameCOMMENT_LINE	ensure we make a copy of the actual bytes too 
map	TokenNameIdentifier	 map
.	TokenNameDOT	
