...
{	TokenNameLBRACE	
/** * Normalizes the well-known URLs of the specified model. * * @param model The model whose URLs should be normalized, may be {@code null}. * @param request The model building request that holds further settings, must not be {@code null}. */	TokenNameCOMMENT_JAVADOC	 Normalizes the well-known URLs of the specified model. * @param model The model whose URLs should be normalized, may be {@code null}. @param request The model building request that holds further settings, must not be {@code null}. 
void	TokenNamevoid	
