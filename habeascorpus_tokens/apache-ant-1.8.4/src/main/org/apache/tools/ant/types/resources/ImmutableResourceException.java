...
/** * Construct a new ImmutableResourceException with the specified message. * @param s the message String. */	TokenNameCOMMENT_JAVADOC	 Construct a new ImmutableResourceException with the specified message. @param s the message String. 
public	TokenNamepublic	
ImmutableResourceException	TokenNameIdentifier	 Immutable Resource Exception
(	TokenNameLPAREN	
