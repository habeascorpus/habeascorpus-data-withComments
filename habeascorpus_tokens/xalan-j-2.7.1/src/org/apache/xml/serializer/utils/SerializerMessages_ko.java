...
/* * $Id: SerializerMessages_ko.java 471981 2006-11-07 04:28:00Z minchau $ */	TokenNameCOMMENT_BLOCK	 $Id: SerializerMessages_ko.java 471981 2006-11-07 04:28:00Z minchau $ 
...
SerializerMessages_ko	TokenNameIdentifier	 Serializer Messages ko
...
,	TokenNameCOMMA	
"??: ''{0}'' ???? Java Runtime? ???? ????."	TokenNameStringLiteral	??: ''{0}'' ???? Java Runtime? ???? ????.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
MsgKey	TokenNameIdentifier	 Msg Key
...
,	TokenNameCOMMA	
"Well-Formedness ???? ????? ??? ? ????. Well-Formed ????? true? ?????? Well-Formedness ??? ??? ? ????."	TokenNameStringLiteral	Well-Formedness ???? ????? ??? ? ????. Well-Formed ????? true? ?????? Well-Formedness ??? ??? ? ????.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
MsgKey	TokenNameIdentifier	 Msg Key
