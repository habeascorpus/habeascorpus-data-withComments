...
/* * $Id: TransformerClient.java 468645 2006-10-28 06:57:24Z minchau $ */	TokenNameCOMMENT_BLOCK	 $Id: TransformerClient.java 468645 2006-10-28 06:57:24Z minchau $ 
...
;	TokenNameSEMICOLON	
/** * A content handler can get a reference * to a TransformState by implementing * the TransformerClient interface. Xalan will check for * that interface before it calls startDocument, and, if it * is implemented, pass in a TransformState reference to the * setTransformState method. */	TokenNameCOMMENT_JAVADOC	 A content handler can get a reference to a TransformState by implementing the TransformerClient interface. Xalan will check for that interface before it calls startDocument, and, if it is implemented, pass in a TransformState reference to the setTransformState method. 
