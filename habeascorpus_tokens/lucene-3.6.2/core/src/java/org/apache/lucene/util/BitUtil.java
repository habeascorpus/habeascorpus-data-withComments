...
;	TokenNameSEMICOLON	
// from org.apache.solr.util rev 555343 	TokenNameCOMMENT_LINE	from org.apache.solr.util rev 555343 
...
/** table of number of leading zeros in a byte */	TokenNameCOMMENT_JAVADOC	 table of number of leading zeros in a byte 
public	TokenNamepublic	
static	TokenNamestatic	
final	TokenNamefinal	
byte	TokenNamebyte	
...
nlzTable	TokenNameIdentifier	 nlz Table
=	TokenNameEQUAL	
{	TokenNameLBRACE	
8	TokenNameIntegerLiteral	
,	TokenNameCOMMA	
...
;	TokenNameSEMICOLON	
/** Returns the number of leading zero bits. */	TokenNameCOMMENT_JAVADOC	 Returns the number of leading zero bits. 
public	TokenNamepublic	
static	TokenNamestatic	
int	TokenNameint	
...
0	TokenNameIntegerLiteral	
;	TokenNameSEMICOLON	
// do the first step as a long 	TokenNameCOMMENT_LINE	do the first step as a long 
int	TokenNameint	
y	TokenNameIdentifier	 y
=	TokenNameEQUAL	
(	TokenNameLPAREN	
...
;	TokenNameSEMICOLON	
/* implementation without table: if ((y & 0xF0000000) == 0) { n+=4; y<<=4; } if ((y & 0xC0000000) == 0) { n+=2; y<<=2; } if ((y & 0x80000000) == 0) { n+=1; y<<=1; } if ((y & 0x80000000) == 0) { n+=1;} return n; */	TokenNameCOMMENT_BLOCK	 implementation without table: if ((y & 0xF0000000) == 0) { n+=4; y<<=4; } if ((y & 0xC0000000) == 0) { n+=2; y<<=2; } if ((y & 0x80000000) == 0) { n+=1; y<<=1; } if ((y & 0x80000000) == 0) { n+=1;} return n; 
}	TokenNameRBRACE	
