...
/** * Checks if the given value exists in the map.<br> * This method iterates over the collection, trying to find an equal object. * * @param value * double value that is checked against the map data. * @return true if the value exists in the map, false otherwise. */	TokenNameCOMMENT_JAVADOC	 Checks if the given value exists in the map.<br> This method iterates over the collection, trying to find an equal object. * @param value double value that is checked against the map data. @return true if the value exists in the map, false otherwise. 
public	TokenNamepublic	
boolean	TokenNameboolean	
...
/** * Returns a new iterator for the mapped double values. */	TokenNameCOMMENT_JAVADOC	 Returns a new iterator for the mapped double values. 
public	TokenNamepublic	
DoubleIterator	TokenNameIdentifier	 Double Iterator
iterator	TokenNameIdentifier	 iterator
(	TokenNameLPAREN	
...
/** * Inserts the &lt;key,value&gt; pair into the map. If the key already exists, * this method updates the mapped value to the given one, returning the old * mapped value. * * @return the old mapped value, or {@link Double#NaN} if the key didn't exist. */	TokenNameCOMMENT_JAVADOC	 Inserts the &lt;key,value&gt; pair into the map. If the key already exists, this method updates the mapped value to the given one, returning the old mapped value. * @return the old mapped value, or {@link Double#NaN} if the key didn't exist. 
public	TokenNamepublic	
double	TokenNamedouble	
...
/** * Translates the mapped pairs' values into an array of Objects * * @return a double array of all the values currently in the map. */	TokenNameCOMMENT_JAVADOC	 Translates the mapped pairs' values into an array of Objects * @return a double array of all the values currently in the map. 
public	TokenNamepublic	
double	TokenNamedouble	
[	TokenNameLBRACKET	
]	TokenNameRBRACKET	
...
/** * Translates the mapped pairs' values into an array of T * * @param a * the array into which the elements of the list are to be * stored. If it is big enough use whatever space we need, * setting the one after the true data as {@link Double#NaN}. * * @return an array containing the elements of the list, using the given * parameter if big enough, otherwise allocate an appropriate array * and return it. * */	TokenNameCOMMENT_JAVADOC	 Translates the mapped pairs' values into an array of T * @param a the array into which the elements of the list are to be stored. If it is big enough use whatever space we need, setting the one after the true data as {@link Double#NaN}. * @return an array containing the elements of the list, using the given parameter if big enough, otherwise allocate an appropriate array and return it. 
public	TokenNamepublic	
double	TokenNamedouble	
[	TokenNameLBRACKET	
]	TokenNameRBRACKET	
