...
;	TokenNameSEMICOLON	
/** * This class is duplicated for each JAXP subpackage so keep it in sync. * It is package private and therefore is not exposed as part of the JAXP * API. * <p> * This code is designed to implement the JAXP 1.1 spec pluggability * feature and is designed to run on JDK version 1.1 and * later, and to compile on JDK 1.2 and onward. * The code also runs both as part of an unbundled jar file and * when bundled as part of the JDK. * <p> * This class was moved from the <code>javax.xml.parsers.ObjectFactory</code> * class and modified to be used as a general utility for creating objects * dynamically. * * @version $Id: $ */	TokenNameCOMMENT_JAVADOC	 This class is duplicated for each JAXP subpackage so keep it in sync. It is package private and therefore is not exposed as part of the JAXP API. <p> This code is designed to implement the JAXP 1.1 spec pluggability feature and is designed to run on JDK version 1.1 and later, and to compile on JDK 1.2 and onward. The code also runs both as part of an unbundled jar file and when bundled as part of the JDK. <p> This class was moved from the <code>javax.xml.parsers.ObjectFactory</code> class and modified to be used as a general utility for creating objects dynamically. * @version $Id: $ 
...
=	TokenNameEQUAL	
"xalan.properties"	TokenNameStringLiteral	xalan.properties
;	TokenNameSEMICOLON	
private	TokenNameprivate	
static	TokenNamestatic	
final	TokenNamefinal	
String	TokenNameIdentifier	 String
SERVICES_PATH	TokenNameIdentifier	 SERVICES  PATH
=	TokenNameEQUAL	
...
;	TokenNameSEMICOLON	
/** cache the contents of the xalan.properties file. * Until an attempt has been made to read this file, this will * be null; if the file does not exist or we encounter some other error * during the read, this will be empty. */	TokenNameCOMMENT_JAVADOC	 cache the contents of the xalan.properties file. Until an attempt has been made to read this file, this will be null; if the file does not exist or we encounter some other error during the read, this will be empty. 
private	TokenNameprivate	
static	TokenNamestatic	
Properties	TokenNameIdentifier	 Properties
fXalanProperties	TokenNameIdentifier	 f Xalan Properties
=	TokenNameEQUAL	
null	TokenNamenull	
;	TokenNameSEMICOLON	
/*** * Cache the time stamp of the xalan.properties file so * that we know if it's been modified and can invalidate * the cache when necessary. */	TokenNameCOMMENT_JAVADOC	* Cache the time stamp of the xalan.properties file so that we know if it's been modified and can invalidate the cache when necessary. 
private	TokenNameprivate	
static	TokenNamestatic	
long	TokenNamelong	
...
(	TokenNameLPAREN	
"created new instance of factory "	TokenNameStringLiteral	created new instance of factory 
+	TokenNamePLUS	
factoryId	TokenNameIdentifier	 factory Id
)	TokenNameRPAREN	
;	TokenNameSEMICOLON	
...
ConfigurationError	TokenNameIdentifier	 Configuration Error
(	TokenNameLPAREN	
"Provider for factory "	TokenNameStringLiteral	Provider for factory 
+	TokenNamePLUS	
factoryId	TokenNameIdentifier	 factory Id
+	TokenNamePLUS	
...
// lookUpFactoryClass(String):Class 	TokenNameCOMMENT_LINE	lookUpFactoryClass(String):Class 
...
// lookUpFactoryClass(String,String,String):Class 	TokenNameCOMMENT_LINE	lookUpFactoryClass(String,String,String):Class 
/** * Finds the name of the required implementation class in the specified * order. The specified order is the following: * <ol> * <li>query the system property using <code>System.getProperty</code> * <li>read <code>$java.home/lib/<i>propertiesFilename</i></code> file * <li>read <code>META-INF/services/<i>factoryId</i></code> file * <li>use fallback classname * </ol> * * @return name of class that provides factory service, never null * * @param factoryId Name of the factory to find, same as * a property name * @param propertiesFilename The filename in the $java.home/lib directory * of the properties file. If none specified, * ${java.home}/lib/xalan.properties will be used. * @param fallbackClassName Implementation class name, if nothing else * is found. Use null to mean no fallback. * * @exception ObjectFactory.ConfigurationError */	TokenNameCOMMENT_JAVADOC	 Finds the name of the required implementation class in the specified order. The specified order is the following: <ol> <li>query the system property using <code>System.getProperty</code> <li>read <code>$java.home/lib/<i>propertiesFilename</i></code> file <li>read <code>META-INF/services/<i>factoryId</i></code> file <li>use fallback classname </ol> * @return name of class that provides factory service, never null * @param factoryId Name of the factory to find, same as a property name @param propertiesFilename The filename in the $java.home/lib directory of the properties file. If none specified, ${java.home}/lib/xalan.properties will be used. @param fallbackClassName Implementation class name, if nothing else is found. Use null to mean no fallback. * @exception ObjectFactory.ConfigurationError 
static	TokenNamestatic	
String	TokenNameIdentifier	 String
lookUpFactoryClassName	TokenNameIdentifier	 look Up Factory Class Name
(	TokenNameLPAREN	
...
// Try to read from propertiesFilename, or 	TokenNameCOMMENT_LINE	Try to read from propertiesFilename, or 
// $java.home/lib/xalan.properties 	TokenNameCOMMENT_LINE	$java.home/lib/xalan.properties 
String	TokenNameIdentifier	 String
factoryClassName	TokenNameIdentifier	 factory Class Name
=	TokenNameEQUAL	
null	TokenNamenull	
;	TokenNameSEMICOLON	
// no properties file name specified; use 	TokenNameCOMMENT_LINE	no properties file name specified; use 
// $JAVA_HOME/lib/xalan.properties: 	TokenNameCOMMENT_LINE	$JAVA_HOME/lib/xalan.properties: 
if	TokenNameif	
(	TokenNameLPAREN	
propertiesFilename	TokenNameIdentifier	 properties Filename
==	TokenNameEQUAL_EQUAL	
...
{	TokenNameLBRACE	
// must never have attempted to read xalan.properties 	TokenNameCOMMENT_LINE	must never have attempted to read xalan.properties 
// before (or it's outdeated) 	TokenNameCOMMENT_LINE	before (or it's outdeated) 
fXalanProperties	TokenNameIdentifier	 f Xalan Properties
=	TokenNameEQUAL	
new	TokenNamenew	
Properties	TokenNameIdentifier	 Properties
...
return	TokenNamereturn	
findJarServiceProviderName	TokenNameIdentifier	 find Jar Service Provider Name
(	TokenNameLPAREN	
factoryId	TokenNameIdentifier	 factory Id
)	TokenNameRPAREN	
;	TokenNameSEMICOLON	
}	TokenNameRBRACE	
// lookUpFactoryClass(String,String):String 	TokenNameCOMMENT_LINE	lookUpFactoryClass(String,String):String 
// 	TokenNameCOMMENT_LINE	 
...
// ClassLoader (always look in system ClassLoader if Xalan 	TokenNameCOMMENT_LINE	ClassLoader (always look in system ClassLoader if Xalan 
...
ConfigurationError	TokenNameIdentifier	 Configuration Error
{	TokenNameLBRACE	
//throw security exception if the calling thread is not allowed to access the 	TokenNameCOMMENT_LINE	throw security exception if the calling thread is not allowed to access the 
//class. Restrict the access to the package classes as specified in java.security policy. 	TokenNameCOMMENT_LINE	class. Restrict the access to the package classes as specified in java.security policy. 
...
/** * Find the name of service provider using Jar Service Provider Mechanism * * @return instance of provider class if found or null */	TokenNameCOMMENT_JAVADOC	 Find the name of service provider using Jar Service Provider Mechanism * @return instance of provider class if found or null 
private	TokenNameprivate	
static	TokenNamestatic	
String	TokenNameIdentifier	 String
findJarServiceProviderName	TokenNameIdentifier	 find Jar Service Provider Name
...
=	TokenNameEQUAL	
2036619216663421552L	TokenNameLongLiteral	
;	TokenNameSEMICOLON	
// 	TokenNameCOMMENT_LINE	 
