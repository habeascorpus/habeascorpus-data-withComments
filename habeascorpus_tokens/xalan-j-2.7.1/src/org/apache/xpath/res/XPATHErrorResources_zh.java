...
/* * $Id: XPATHErrorResources_zh.java 338104 2005-01-23 01:39:54Z mcnamara $ */	TokenNameCOMMENT_BLOCK	 $Id: XPATHErrorResources_zh.java 338104 2005-01-23 01:39:54Z mcnamara $ 
...
XPATHErrorResources_zh	TokenNameIdentifier	 XPATH Error Resources zh
...
ER_BOOLEAN_ARG_NO_LONGER_OPTIONAL	TokenNameIdentifier	 ER  BOOLEAN  ARG  NO  LONGER  OPTIONAL
,	TokenNameCOMMA	
"19990709 XPath ????boolean(...) ???????"	TokenNameStringLiteral	19990709 XPath ????boolean(...) ???????
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_FOUND_COMMA_BUT_NO_PRECEDING_ARG	TokenNameIdentifier	 ER  FOUND  COMMA  BUT  NO  PRECEDING  ARG
,	TokenNameCOMMA	
"???Ò,Ó??????????"	TokenNameStringLiteral	???Ò,Ó??????????
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_FOUND_COMMA_BUT_NO_FOLLOWING_ARG	TokenNameIdentifier	 ER  FOUND  COMMA  BUT  NO  FOLLOWING  ARG
...
ER_PREDICATE_ILLEGAL_SYNTAX	TokenNameIdentifier	 ER  PREDICATE  ILLEGAL  SYNTAX
,	TokenNameCOMMA	
"Ò..[predicate]Ó?Ò.[predicate]Ó????????????Òself::node()[predicate]Ó?"	TokenNameStringLiteral	Ò..[predicate]Ó?Ò.[predicate]Ó????????????Òself::node()[predicate]Ó?
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_ILLEGAL_AXIS_NAME	TokenNameIdentifier	 ER  ILLEGAL  AXIS  NAME
...
ER_SETDOMFACTORY_NOT_SUPPORTED	TokenNameIdentifier	 ER  SETDOMFACTORY  NOT  SUPPORTED
,	TokenNameCOMMA	
"XPathContext ??? setDOMFactory?"	TokenNameStringLiteral	XPathContext ??? setDOMFactory?
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_PREFIX_MUST_RESOLVE	TokenNameIdentifier	 ER  PREFIX  MUST  RESOLVE
...
ER_PARSE_NOT_SUPPORTED	TokenNameIdentifier	 ER  PARSE  NOT  SUPPORTED
,	TokenNameCOMMA	
"XPathContext ???? parse (InputSource source)????? {0}"	TokenNameStringLiteral	XPathContext ???? parse (InputSource source)????? {0}
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_SAX_API_NOT_HANDLED	TokenNameIdentifier	 ER  SAX  API  NOT  HANDLED
,	TokenNameCOMMA	
"DTM ??? SAX API characters(char ch[]...?"	TokenNameStringLiteral	DTM ??? SAX API characters(char ch[]...?
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_IGNORABLE_WHITESPACE_NOT_HANDLED	TokenNameIdentifier	 ER  IGNORABLE  WHITESPACE  NOT  HANDLED
,	TokenNameCOMMA	
"DTM ??? ignorableWhitespace(char ch[]...?"	TokenNameStringLiteral	DTM ??? ignorableWhitespace(char ch[]...?
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_DTM_CANNOT_HANDLE_NODES	TokenNameIdentifier	 ER  DTM  CANNOT  HANDLE  NODES
...
ER_RTF_NOT_SUPPORTED_XRTREEFRAGSELECTWRAPPER	TokenNameIdentifier	 ER  RTF  NOT  SUPPORTED  XRTREEFRAGSELECTWRAPPER
,	TokenNameCOMMA	
"XRTreeFragSelectWrapper ??? rtf()"	TokenNameStringLiteral	XRTreeFragSelectWrapper ??? rtf()
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_RTF_NOT_SUPPORTED_XRTREEFRAGSELECTWRAPPER	TokenNameIdentifier	 ER  RTF  NOT  SUPPORTED  XRTREEFRAGSELECTWRAPPER
,	TokenNameCOMMA	
"XRTreeFragSelectWrapper ??? asNodeIterator()"	TokenNameStringLiteral	XRTreeFragSelectWrapper ??? asNodeIterator()
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_DETACH_NOT_SUPPORTED_XRTREEFRAGSELECTWRAPPER	TokenNameIdentifier	 ER  DETACH  NOT  SUPPORTED  XRTREEFRAGSELECTWRAPPER
,	TokenNameCOMMA	
"XRTreeFragSelectWrapper ??? detach()"	TokenNameStringLiteral	XRTreeFragSelectWrapper ??? detach()
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_NUM_NOT_SUPPORTED_XRTREEFRAGSELECTWRAPPER	TokenNameIdentifier	 ER  NUM  NOT  SUPPORTED  XRTREEFRAGSELECTWRAPPER
,	TokenNameCOMMA	
"XRTreeFragSelectWrapper ??? num()"	TokenNameStringLiteral	XRTreeFragSelectWrapper ??? num()
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_XSTR_NOT_SUPPORTED_XRTREEFRAGSELECTWRAPPER	TokenNameIdentifier	 ER  XSTR  NOT  SUPPORTED  XRTREEFRAGSELECTWRAPPER
,	TokenNameCOMMA	
"XRTreeFragSelectWrapper ??? xstr()"	TokenNameStringLiteral	XRTreeFragSelectWrapper ??? xstr()
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_STR_NOT_SUPPORTED_XRTREEFRAGSELECTWRAPPER	TokenNameIdentifier	 ER  STR  NOT  SUPPORTED  XRTREEFRAGSELECTWRAPPER
,	TokenNameCOMMA	
"XRTreeFragSelectWrapper ??? str()"	TokenNameStringLiteral	XRTreeFragSelectWrapper ??? str()
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_FSB_NOT_SUPPORTED_XSTRINGFORCHARS	TokenNameIdentifier	 ER  FSB  NOT  SUPPORTED  XSTRINGFORCHARS
,	TokenNameCOMMA	
"XStringForChars ??? fsb()"	TokenNameStringLiteral	XStringForChars ??? fsb()
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_COULD_NOT_FIND_VAR	TokenNameIdentifier	 ER  COULD  NOT  FIND  VAR
...
ER_CANNOT_CALL_SETSHOULDCACHENODE	TokenNameIdentifier	 ER  CANNOT  CALL  SETSHOULDCACHENODE
,	TokenNameCOMMA	
"?? nextNode ????? setShouldCacheNode?"	TokenNameStringLiteral	?? nextNode ????? setShouldCacheNode?
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_ONLY_ALLOWS	TokenNameIdentifier	 ER  ONLY  ALLOWS
...
ER_EXPECTED_REL_LOC_PATH	TokenNameIdentifier	 ER  EXPECTED  REL  LOC  PATH
,	TokenNameCOMMA	
"?Ò/Ó?Ò//Ó??????????????"	TokenNameStringLiteral	?Ò/Ó?Ò//Ó??????????????
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
ER_CANT_CONVERT_TO_BOOLEAN	TokenNameIdentifier	 ER  CANT  CONVERT  TO  BOOLEAN
,	TokenNameCOMMA	
"XPath ???Ò{0}Ó? XPathResult ?? XPathResultType {1}?????????????"	TokenNameStringLiteral	XPath ???Ò{0}Ó? XPathResult ?? XPathResultType {1}?????????????
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
ER_CANT_CONVERT_TO_SINGLENODE	TokenNameIdentifier	 ER  CANT  CONVERT  TO  SINGLENODE
,	TokenNameCOMMA	
"XPath ???Ò{0}Ó? XPathResult ?? XPathResultType {1}??????????????getSingleNodeValue ???????? ANY_UNORDERED_NODE_TYPE ? FIRST_ORDERED_NODE_TYPE?"	TokenNameStringLiteral	XPath ???Ò{0}Ó? XPathResult ?? XPathResultType {1}??????????????getSingleNodeValue ???????? ANY_UNORDERED_NODE_TYPE ? FIRST_ORDERED_NODE_TYPE?
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
ER_CANT_GET_SNAPSHOT_LENGTH	TokenNameIdentifier	 ER  CANT  GET  SNAPSHOT  LENGTH
,	TokenNameCOMMA	
"??? XPath ???Ò{0}Ó? XPathResult ?? getSnapshotLength ?????????? XPathResult ? XPathResultType ? {1}?????????? UNORDERED_NODE_SNAPSHOT_TYPE ? ORDERED_NODE_SNAPSHOT_TYPE?"	TokenNameStringLiteral	??? XPath ???Ò{0}Ó? XPathResult ?? getSnapshotLength ?????????? XPathResult ? XPathResultType ? {1}?????????? UNORDERED_NODE_SNAPSHOT_TYPE ? ORDERED_NODE_SNAPSHOT_TYPE?
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_NON_ITERATOR_TYPE	TokenNameIdentifier	 ER  NON  ITERATOR  TYPE
,	TokenNameCOMMA	
"??? XPath ???Ò{0}Ó? XPathResult ?? iterateNext ?????????? XPathResult ? XPathResultType ? {1}?????????? UNORDERED_NODE_ITERATOR_TYPE ? ORDERED_NODE_ITERATOR_TYPE?"	TokenNameStringLiteral	??? XPath ???Ò{0}Ó? XPathResult ?? iterateNext ?????????? XPathResult ? XPathResultType ? {1}?????????? UNORDERED_NODE_ITERATOR_TYPE ? ORDERED_NODE_ITERATOR_TYPE?
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
ER_INCOMPATIBLE_TYPES	TokenNameIdentifier	 ER  INCOMPATIBLE  TYPES
,	TokenNameCOMMA	
"XPath ???Ò{0}Ó? XPathResult ?? XPathResultType {1}?????????????? XPathResultType {2}?"	TokenNameStringLiteral	XPath ???Ò{0}Ó? XPathResult ?? XPathResultType {1}?????????????? XPathResultType {2}?
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_NULL_RESOLVER	TokenNameIdentifier	 ER  NULL  RESOLVER
...
ER_NON_SNAPSHOT_TYPE	TokenNameIdentifier	 ER  NON  SNAPSHOT  TYPE
,	TokenNameCOMMA	
"??? XPath ???Ò{0}Ó? XPathResult ???? snapshotItem???????? XPathResult ? XPathResultType ? {1}?????????? UNORDERED_NODE_SNAPSHOT_TYPE ? ORDERED_NODE_SNAPSHOT_TYPE?"	TokenNameStringLiteral	??? XPath ???Ò{0}Ó? XPathResult ???? snapshotItem???????? XPathResult ? XPathResultType ? {1}?????????? UNORDERED_NODE_SNAPSHOT_TYPE ? ORDERED_NODE_SNAPSHOT_TYPE?
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
ER_EXTENSION_FUNCTION_CANNOT_BE_INVOKED	TokenNameIdentifier	 ER  EXTENSION  FUNCTION  CANNOT  BE  INVOKED
,	TokenNameCOMMA	
"?????? XMLConstants.FEATURE_SECURE_PROCESSING ????? true ??????Ò{0}Ó?"	TokenNameStringLiteral	?????? XMLConstants.FEATURE_SECURE_PROCESSING ????? true ??????Ò{0}Ó?
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
ER_RESOLVE_VARIABLE_RETURNS_NULL	TokenNameIdentifier	 ER  RESOLVE  VARIABLE  RETURNS  NULL
,	TokenNameCOMMA	
"?? {0} ? resolveVariable ??????"	TokenNameStringLiteral	?? {0} ? resolveVariable ??????
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
ER_OBJECT_MODEL_NULL	TokenNameIdentifier	 ER  OBJECT  MODEL  NULL
,	TokenNameCOMMA	
"{0}#isObjectModelSupported( String objectModel ) ???????? objectModel == null?"	TokenNameStringLiteral	{0}#isObjectModelSupported( String objectModel ) ???????? objectModel == null?
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
ER_OBJECT_MODEL_EMPTY	TokenNameIdentifier	 ER  OBJECT  MODEL  EMPTY
,	TokenNameCOMMA	
"{0}#isObjectModelSupported( String objectModel ) ???????? objectModel == ""?"	TokenNameStringLiteral	{0}#isObjectModelSupported( String objectModel ) ???????? objectModel == ""?
}	TokenNameRBRACE	
,	TokenNameCOMMA	
/** Field ER_OBJECT_MODEL_EMPTY */	TokenNameCOMMENT_JAVADOC	 Field ER_OBJECT_MODEL_EMPTY 
{	TokenNameLBRACE	
...
ER_FEATURE_UNKNOWN	TokenNameIdentifier	 ER  FEATURE  UNKNOWN
,	TokenNameCOMMA	
"??????????Ò{0}Ó?{1}#setFeature({0},{2})"	TokenNameStringLiteral	??????????Ò{0}Ó?{1}#setFeature({0},{2})
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
ER_GETTING_UNKNOWN_FEATURE	TokenNameIdentifier	 ER  GETTING  UNKNOWN  FEATURE
,	TokenNameCOMMA	
"??????????Ò{0}Ó?{1}#getFeature({0})"	TokenNameStringLiteral	??????????Ò{0}Ó?{1}#getFeature({0})
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
WG_QUO_NO_LONGER_DEFINED	TokenNameIdentifier	 WG  QUO  NO  LONGER  DEFINED
,	TokenNameCOMMA	
"XPath ?????????quo(...)?"	TokenNameStringLiteral	XPath ?????????quo(...)?
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
WG_NEED_DERIVED_OBJECT_TO_IMPLEMENT_NODETEST	TokenNameIdentifier	 WG  NEED  DERIVED  OBJECT  TO  IMPLEMENT  NODETEST
,	TokenNameCOMMA	
"XPath ???????????? nodeTest?"	TokenNameStringLiteral	XPath ???????????? nodeTest?
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
WG_FUNCTION_TOKEN_NOT_FOUND	TokenNameIdentifier	 WG  FUNCTION  TOKEN  NOT  FOUND
...
WG_EXPAND_ENTITIES_NOT_SUPPORTED	TokenNameIdentifier	 WG  EXPAND  ENTITIES  NOT  SUPPORTED
,	TokenNameCOMMA	
"DTM ?????? -E ??"	TokenNameStringLiteral	DTM ?????? -E ??
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
WG_ILLEGAL_VARIABLE_REFERENCE	TokenNameIdentifier	 WG  ILLEGAL  VARIABLE  REFERENCE
