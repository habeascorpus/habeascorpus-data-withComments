...
;	TokenNameSEMICOLON	
/** * Report all statistics aggregated by name. * <br>Other side effects: None. */	TokenNameCOMMENT_JAVADOC	 Report all statistics aggregated by name. <br>Other side effects: None. 
...
=	TokenNameEQUAL	
reportSumByName	TokenNameIdentifier	 report Sum By Name
(	TokenNameLPAREN	
...
println	TokenNameIdentifier	 println
(	TokenNameLPAREN	
"------------> Report Sum By (any) Name ("	TokenNameStringLiteral	------------> Report Sum By (any) Name (
+	TokenNamePLUS	
rp	TokenNameIdentifier	 rp
.	TokenNameDOT	
...
/** * Report statistics as a string, aggregate for tasks named the same. * @return the report */	TokenNameCOMMENT_JAVADOC	 Report statistics as a string, aggregate for tasks named the same. @return the report 
