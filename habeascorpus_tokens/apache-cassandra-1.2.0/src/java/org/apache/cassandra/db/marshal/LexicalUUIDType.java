...
format	TokenNameIdentifier	 format
(	TokenNameLPAREN	
"LexicalUUID should be 16 or 0 bytes (%d)"	TokenNameStringLiteral	LexicalUUID should be 16 or 0 bytes (%d)
,	TokenNameCOMMA	
bytes	TokenNameIdentifier	 bytes
.	TokenNameDOT	
remaining	TokenNameIdentifier	 remaining
...
;	TokenNameSEMICOLON	
// not sure what the version should be for this. 	TokenNameCOMMENT_LINE	not sure what the version should be for this. 
}	TokenNameRBRACE	
}	TokenNameRBRACE	
