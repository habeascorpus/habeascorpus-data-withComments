...
;	TokenNameSEMICOLON	
// start/finish 	TokenNameCOMMENT_LINE	start/finish 
sliceRange	TokenNameIdentifier	 slice Range
.	TokenNameDOT	
...
;	TokenNameSEMICOLON	
// reversed/count 	TokenNameCOMMENT_LINE	reversed/count 
sliceRange	TokenNameIdentifier	 slice Range
.	TokenNameDOT	
...
{	TokenNameLBRACE	
runSuperCounterGetter	TokenNameIdentifier	 run Super Counter Getter
(	TokenNameLPAREN	
predicate	TokenNameIdentifier	 predicate
,	TokenNameCOMMA	
client	TokenNameIdentifier	 client
...
{	TokenNameLBRACE	
runCounterGetter	TokenNameIdentifier	 run Counter Getter
(	TokenNameLPAREN	
predicate	TokenNameIdentifier	 predicate
,	TokenNameCOMMA	
client	TokenNameIdentifier	 client
...
(	TokenNameLPAREN	
"Operation [%d] retried %d times - error reading counter key %s %s%n"	TokenNameStringLiteral	Operation [%d] retried %d times - error reading counter key %s %s%n
,	TokenNameCOMMA	
index	TokenNameIdentifier	 index
,	TokenNameCOMMA	
session	TokenNameIdentifier	 session
