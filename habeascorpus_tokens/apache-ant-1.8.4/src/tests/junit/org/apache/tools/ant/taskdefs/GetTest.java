...
(	TokenNameLPAREN	
"src/etc/testcases/taskdefs/get.xml"	TokenNameStringLiteral	src/etc/testcases/taskdefs/get.xml
)	TokenNameRPAREN	
;	TokenNameSEMICOLON	
}	TokenNameRBRACE	
public	TokenNamepublic	
...
,	TokenNameCOMMA	
"src invalid"	TokenNameStringLiteral	src invalid
)	TokenNameRPAREN	
;	TokenNameSEMICOLON	
}	TokenNameRBRACE	
public	TokenNamepublic	
...
,	TokenNameCOMMA	
"dest invalid (or no http-server on local machine)"	TokenNameStringLiteral	dest invalid (or no http-server on local machine)
)	TokenNameRPAREN	
;	TokenNameSEMICOLON	
}	TokenNameRBRACE	
public	TokenNamepublic	
...
public	TokenNamepublic	
void	TokenNamevoid	
testUseTimestamp	TokenNameIdentifier	 test Use Timestamp
(	TokenNameLPAREN	
)	TokenNameRPAREN	
{	TokenNameLBRACE	
executeTarget	TokenNameIdentifier	 execute Target
(	TokenNameLPAREN	
"testUseTimestamp"	TokenNameStringLiteral	testUseTimestamp
)	TokenNameRPAREN	
;	TokenNameSEMICOLON	
}	TokenNameRBRACE	
public	TokenNamepublic	
void	TokenNamevoid	
testUseTomorrow	TokenNameIdentifier	 test Use Tomorrow
(	TokenNameLPAREN	
)	TokenNameRPAREN	
{	TokenNameLBRACE	
executeTarget	TokenNameIdentifier	 execute Target
(	TokenNameLPAREN	
"testUseTomorrow"	TokenNameStringLiteral	testUseTomorrow
)	TokenNameRPAREN	
;	TokenNameSEMICOLON	
}	TokenNameRBRACE	
}	TokenNameRBRACE	
