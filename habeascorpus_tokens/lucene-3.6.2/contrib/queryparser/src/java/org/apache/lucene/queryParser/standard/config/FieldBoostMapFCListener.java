...
;	TokenNameSEMICOLON	
/** * This listener listens for every field configuration request and assign a * {@link ConfigurationKeys#BOOST} to the * equivalent {@link FieldConfig} based on a defined map: fieldName -> boostValue stored in * {@link ConfigurationKeys#FIELD_BOOST_MAP}. * * @see ConfigurationKeys#FIELD_BOOST_MAP * @see ConfigurationKeys#BOOST * @see FieldConfig * @see FieldConfigListener */	TokenNameCOMMENT_JAVADOC	 This listener listens for every field configuration request and assign a {@link ConfigurationKeys#BOOST} to the equivalent {@link FieldConfig} based on a defined map: fieldName -> boostValue stored in {@link ConfigurationKeys#FIELD_BOOST_MAP}. * @see ConfigurationKeys#FIELD_BOOST_MAP @see ConfigurationKeys#BOOST @see FieldConfig @see FieldConfigListener 
public	TokenNamepublic	
class	TokenNameclass	
FieldBoostMapFCListener	TokenNameIdentifier	 Field Boost Map FC Listener
...
>	TokenNameGREATER	
fieldBoostMap	TokenNameIdentifier	 field Boost Map
=	TokenNameEQUAL	
this	TokenNamethis	
.	TokenNameDOT	
config	TokenNameIdentifier	 config
...
// fieldConfig.set(ConfigurationKeys.BOOST, boost); 	TokenNameCOMMENT_LINE	fieldConfig.set(ConfigurationKeys.BOOST, boost); 
}	TokenNameRBRACE	
}	TokenNameRBRACE	
}	TokenNameRBRACE	
}	TokenNameRBRACE	
