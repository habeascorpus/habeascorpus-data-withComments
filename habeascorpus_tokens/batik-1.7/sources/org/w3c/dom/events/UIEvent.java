...
{	TokenNameLBRACE	
/** * The <code>view</code> attribute identifies the * <code>AbstractView</code> from which the event was generated. */	TokenNameCOMMENT_JAVADOC	 The <code>view</code> attribute identifies the <code>AbstractView</code> from which the event was generated. 
public	TokenNamepublic	
AbstractView	TokenNameIdentifier	 Abstract View
...
;	TokenNameSEMICOLON	
/** * Specifies some detail information about the <code>Event</code>, * depending on the type of event. */	TokenNameCOMMENT_JAVADOC	 Specifies some detail information about the <code>Event</code>, depending on the type of event. 
public	TokenNamepublic	
int	TokenNameint	
...
;	TokenNameSEMICOLON	
/** * The <code>initUIEvent</code> method is used to initialize the value of * a <code>UIEvent</code> object and has the same behavior as * <code>Event.initEvent()</code>. * @param typeArg Refer to the <code>Event.initEvent()</code> method for * a description of this parameter. * @param canBubbleArg Refer to the <code>Event.initEvent()</code> * method for a description of this parameter. * @param cancelableArg Refer to the <code>Event.initEvent()</code> * method for a description of this parameter. * @param viewArg Specifies <code>UIEvent.view</code>. This value may be * <code>null</code>. * @param detailArg Specifies <code>UIEvent.detail</code>. */	TokenNameCOMMENT_JAVADOC	 The <code>initUIEvent</code> method is used to initialize the value of a <code>UIEvent</code> object and has the same behavior as <code>Event.initEvent()</code>. @param typeArg Refer to the <code>Event.initEvent()</code> method for a description of this parameter. @param canBubbleArg Refer to the <code>Event.initEvent()</code> method for a description of this parameter. @param cancelableArg Refer to the <code>Event.initEvent()</code> method for a description of this parameter. @param viewArg Specifies <code>UIEvent.view</code>. This value may be <code>null</code>. @param detailArg Specifies <code>UIEvent.detail</code>. 
public	TokenNamepublic	
void	TokenNamevoid	
