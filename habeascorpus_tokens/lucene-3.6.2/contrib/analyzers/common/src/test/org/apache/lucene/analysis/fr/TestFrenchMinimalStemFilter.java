...
*	TokenNameMULTIPLY	
;	TokenNameSEMICOLON	
/** * Simple tests for {@link FrenchMinimalStemFilter} */	TokenNameCOMMENT_JAVADOC	 Simple tests for {@link FrenchMinimalStemFilter} 
public	TokenNamepublic	
class	TokenNameclass	
TestFrenchMinimalStemFilter	TokenNameIdentifier	 Test French Minimal Stem Filter
...
,	TokenNameCOMMA	
new	TokenNamenew	
FrenchMinimalStemFilter	TokenNameIdentifier	 French Minimal Stem Filter
(	TokenNameLPAREN	
source	TokenNameIdentifier	 source
)	TokenNameRPAREN	
)	TokenNameRPAREN	
...
(	TokenNameLPAREN	
"frminimaltestdata.zip"	TokenNameStringLiteral	frminimaltestdata.zip
)	TokenNameRPAREN	
,	TokenNameCOMMA	
"frminimal.txt"	TokenNameStringLiteral	frminimal.txt
)	TokenNameRPAREN	
;	TokenNameSEMICOLON	
}	TokenNameRBRACE	
