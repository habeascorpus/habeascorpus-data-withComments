...
;	TokenNameSEMICOLON	
/** * This implementation of the abstract AbstractImageHandlerEncoder * class creates PNG images in the image directory and sets the * url pointing to that file in the xlink:href attributes of the * image elements it handles. * * @author <a href="mailto:vincent.hardy@eng.sun.com">Vincent Hardy</a> * @version $Id: ImageHandlerPNGEncoder.java 475477 2006-11-15 22:44:28Z cam $ * @see org.apache.batik.svggen.SVGGraphics2D * @see org.apache.batik.svggen.ImageHandlerJPEGEncoder * @see org.apache.batik.svggen.ImageHandlerPNGEncoder */	TokenNameCOMMENT_JAVADOC	 This implementation of the abstract AbstractImageHandlerEncoder class creates PNG images in the image directory and sets the url pointing to that file in the xlink:href attributes of the image elements it handles. * @author <a href="mailto:vincent.hardy@eng.sun.com">Vincent Hardy</a> @version $Id: ImageHandlerPNGEncoder.java 475477 2006-11-15 22:44:28Z cam $ @see org.apache.batik.svggen.SVGGraphics2D @see org.apache.batik.svggen.ImageHandlerJPEGEncoder @see org.apache.batik.svggen.ImageHandlerPNGEncoder 
public	TokenNamepublic	
class	TokenNameclass	
ImageHandlerPNGEncoder	TokenNameIdentifier	 Image Handler PNG Encoder
...
/** * @return the suffix used by this encoder. E.g., ".png" for * ImageHandlerPNGEncoder. */	TokenNameCOMMENT_JAVADOC	 @return the suffix used by this encoder. E.g., ".png" for ImageHandlerPNGEncoder. 
public	TokenNamepublic	
...
/** * @return the prefix used by this encoder. E.g., "pngImage" for * ImageHandlerPNGEncoder. */	TokenNameCOMMENT_JAVADOC	 @return the prefix used by this encoder. E.g., "pngImage" for ImageHandlerPNGEncoder. 
public	TokenNamepublic	
final	TokenNamefinal	
String	TokenNameIdentifier	 String
...
/** * This method creates a BufferedImage with an alpha channel, as this is * supported by PNG. */	TokenNameCOMMENT_JAVADOC	 This method creates a BufferedImage with an alpha channel, as this is supported by PNG. 
public	TokenNamepublic	
BufferedImage	TokenNameIdentifier	 Buffered Image
