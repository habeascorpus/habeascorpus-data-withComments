...
awt	TokenNameIdentifier	 awt
.	TokenNameDOT	
GraphicsConfiguration	TokenNameIdentifier	 Graphics Configuration
;	TokenNameSEMICOLON	
import	TokenNameimport	
java	TokenNameIdentifier	 java
.	TokenNameDOT	
...
;	TokenNameSEMICOLON	
/** * This concrete implementation of <tt>AbstractGraphics2D</tt> is a * simple help to programmers to get started with their own * implementation of <tt>Graphics2D</tt>. * <tt>DefaultGraphics2D</tt> implements all the abstract methods * is <tt>AbstractGraphics2D</tt> and makes it easy to start * implementing a <tt>Graphic2D</tt> piece-meal. * * @author <a href="mailto:vincent.hardy@eng.sun.com">Vincent Hardy</a> * @version $Id: DefaultGraphics2D.java 475477 2006-11-15 22:44:28Z cam $ * @see org.apache.batik.ext.awt.g2d.AbstractGraphics2D */	TokenNameCOMMENT_JAVADOC	 This concrete implementation of <tt>AbstractGraphics2D</tt> is a simple help to programmers to get started with their own implementation of <tt>Graphics2D</tt>. <tt>DefaultGraphics2D</tt> implements all the abstract methods is <tt>AbstractGraphics2D</tt> and makes it easy to start implementing a <tt>Graphic2D</tt> piece-meal. * @author <a href="mailto:vincent.hardy@eng.sun.com">Vincent Hardy</a> @version $Id: DefaultGraphics2D.java 475477 2006-11-15 22:44:28Z cam $ @see org.apache.batik.ext.awt.g2d.AbstractGraphics2D 
public	TokenNamepublic	
class	TokenNameclass	
DefaultGraphics2D	TokenNameIdentifier	 Default Graphics2 D
extends	TokenNameextends	
AbstractGraphics2D	TokenNameIdentifier	 Abstract Graphics2 D
{	TokenNameLBRACE	
...
textAsShapes	TokenNameIdentifier	 text As Shapes
)	TokenNameRPAREN	
{	TokenNameLBRACE	
...
/** * This constructor supports the create method */	TokenNameCOMMENT_JAVADOC	 This constructor supports the create method 
public	TokenNamepublic	
DefaultGraphics2D	TokenNameIdentifier	 Default Graphics2 D
(	TokenNameLPAREN	
DefaultGraphics2D	TokenNameIdentifier	 Default Graphics2 D
...
/** * Creates a new <code>Graphics</code> object that is * a copy of this <code>Graphics</code> object. * @return a new graphics context that is a copy of * this graphics context. */	TokenNameCOMMENT_JAVADOC	 Creates a new <code>Graphics</code> object that is a copy of this <code>Graphics</code> object. @return a new graphics context that is a copy of this graphics context. 
public	TokenNamepublic	
Graphics	TokenNameIdentifier	 Graphics
...
(	TokenNameLPAREN	
"drawImage"	TokenNameStringLiteral	drawImage
)	TokenNameRPAREN	
;	TokenNameSEMICOLON	
return	TokenNamereturn	
true	TokenNametrue	
...
/** * Strokes the outline of a <code>Shape</code> using the settings of the * current <code>Graphics2D</code> context. The rendering attributes * applied include the <code>Clip</code>, <code>Transform</code>, * <code>Paint</code>, <code>Composite</code> and * <code>Stroke</code> attributes. * @param s the <code>Shape</code> to be rendered * @see #setStroke(java.awt.Stroke) * @see #setPaint(java.awt.Paint) * @see java.awt.Graphics#setColor * @see #setTransform(AffineTransform) * @see #setClip(Shape) * @see #setComposite(java.awt.Composite) */	TokenNameCOMMENT_JAVADOC	 Strokes the outline of a <code>Shape</code> using the settings of the current <code>Graphics2D</code> context. The rendering attributes applied include the <code>Clip</code>, <code>Transform</code>, <code>Paint</code>, <code>Composite</code> and <code>Stroke</code> attributes. @param s the <code>Shape</code> to be rendered @see #setStroke(java.awt.Stroke) @see #setPaint(java.awt.Paint) @see java.awt.Graphics#setColor @see #setTransform(AffineTransform) @see #setClip(Shape) @see #setComposite(java.awt.Composite) 
public	TokenNamepublic	
void	TokenNamevoid	
...
println	TokenNameIdentifier	 println
(	TokenNameLPAREN	
"draw(Shape)"	TokenNameStringLiteral	draw(Shape)
)	TokenNameRPAREN	
;	TokenNameSEMICOLON	
}	TokenNameRBRACE	
/** * Renders a {@link RenderedImage}, * applying a transform from image * space into user space before drawing. * The transformation from user space into device space is done with * the current <code>Transform</code> in the <code>Graphics2D</code>. * The specified transformation is applied to the image before the * transform attribute in the <code>Graphics2D</code> context is applied. * The rendering attributes applied include the <code>Clip</code>, * <code>Transform</code>, and <code>Composite</code> attributes. Note * that no rendering is done if the specified transform is * noninvertible. * @param img the image to be rendered * @param xform the transformation from image space into user space * @see #setTransform(AffineTransform) * @see #setComposite(java.awt.Composite) * @see #setClip(Shape) */	TokenNameCOMMENT_JAVADOC	 Renders a {@link RenderedImage}, applying a transform from image space into user space before drawing. The transformation from user space into device space is done with the current <code>Transform</code> in the <code>Graphics2D</code>. The specified transformation is applied to the image before the transform attribute in the <code>Graphics2D</code> context is applied. The rendering attributes applied include the <code>Clip</code>, <code>Transform</code>, and <code>Composite</code> attributes. Note that no rendering is done if the specified transform is noninvertible. @param img the image to be rendered @param xform the transformation from image space into user space @see #setTransform(AffineTransform) @see #setComposite(java.awt.Composite) @see #setClip(Shape) 
public	TokenNamepublic	
void	TokenNamevoid	
...
println	TokenNameIdentifier	 println
(	TokenNameLPAREN	
"drawRenderedImage"	TokenNameStringLiteral	drawRenderedImage
)	TokenNameRPAREN	
;	TokenNameSEMICOLON	
}	TokenNameRBRACE	
/** * Renders a * {@link RenderableImage}, * applying a transform from image space into user space before drawing. * The transformation from user space into device space is done with * the current <code>Transform</code> in the <code>Graphics2D</code>. * The specified transformation is applied to the image before the * transform attribute in the <code>Graphics2D</code> context is applied. * The rendering attributes applied include the <code>Clip</code>, * <code>Transform</code>, and <code>Composite</code> attributes. Note * that no rendering is done if the specified transform is * noninvertible. *<p> * Rendering hints set on the <code>Graphics2D</code> object might * be used in rendering the <code>RenderableImage</code>. * If explicit control is required over specific hints recognized by a * specific <code>RenderableImage</code>, or if knowledge of which hints * are used is required, then a <code>RenderedImage</code> should be * obtained directly from the <code>RenderableImage</code> * and rendered using *{@link #drawRenderedImage(RenderedImage, AffineTransform) drawRenderedImage}. * @param img the image to be rendered * @param xform the transformation from image space into user space * @see #setTransform(AffineTransform) * @see #setComposite(java.awt.Composite) * @see #setClip(Shape) * @see #drawRenderedImage */	TokenNameCOMMENT_JAVADOC	 Renders a {@link RenderableImage}, applying a transform from image space into user space before drawing. The transformation from user space into device space is done with the current <code>Transform</code> in the <code>Graphics2D</code>. The specified transformation is applied to the image before the transform attribute in the <code>Graphics2D</code> context is applied. The rendering attributes applied include the <code>Clip</code>, <code>Transform</code>, and <code>Composite</code> attributes. Note that no rendering is done if the specified transform is noninvertible. *<p> Rendering hints set on the <code>Graphics2D</code> object might be used in rendering the <code>RenderableImage</code>. If explicit control is required over specific hints recognized by a specific <code>RenderableImage</code>, or if knowledge of which hints are used is required, then a <code>RenderedImage</code> should be obtained directly from the <code>RenderableImage</code> and rendered using *{@link #drawRenderedImage(RenderedImage, AffineTransform) drawRenderedImage}. @param img the image to be rendered @param xform the transformation from image space into user space @see #setTransform(AffineTransform) @see #setComposite(java.awt.Composite) @see #setClip(Shape) @see #drawRenderedImage 
public	TokenNamepublic	
void	TokenNamevoid	
...
println	TokenNameIdentifier	 println
(	TokenNameLPAREN	
"drawString(AttributedCharacterIterator)"	TokenNameStringLiteral	drawString(AttributedCharacterIterator)
)	TokenNameRPAREN	
;	TokenNameSEMICOLON	
}	TokenNameRBRACE	
/** * Fills the interior of a <code>Shape</code> using the settings of the * <code>Graphics2D</code> context. The rendering attributes applied * include the <code>Clip</code>, <code>Transform</code>, * <code>Paint</code>, and <code>Composite</code>. * @param s the <code>Shape</code> to be filled * @see #setPaint(java.awt.Paint) * @see java.awt.Graphics#setColor * @see #setTransform(AffineTransform) * @see #setComposite(java.awt.Composite) * @see #setClip(Shape) */	TokenNameCOMMENT_JAVADOC	 Fills the interior of a <code>Shape</code> using the settings of the <code>Graphics2D</code> context. The rendering attributes applied include the <code>Clip</code>, <code>Transform</code>, <code>Paint</code>, and <code>Composite</code>. @param s the <code>Shape</code> to be filled @see #setPaint(java.awt.Paint) @see java.awt.Graphics#setColor @see #setTransform(AffineTransform) @see #setComposite(java.awt.Composite) @see #setClip(Shape) 
public	TokenNamepublic	
void	TokenNamevoid	
...
/** * Returns the device configuration associated with this * <code>Graphics2D</code>. */	TokenNameCOMMENT_JAVADOC	 Returns the device configuration associated with this <code>Graphics2D</code>. 
public	TokenNamepublic	
GraphicsConfiguration	TokenNameIdentifier	 Graphics Configuration
getDeviceConfiguration	TokenNameIdentifier	 get Device Configuration
(	TokenNameLPAREN	
)	TokenNameRPAREN	
{	TokenNameLBRACE	
System	TokenNameIdentifier	 System
...
println	TokenNameIdentifier	 println
(	TokenNameLPAREN	
"getDeviceConviguration"	TokenNameStringLiteral	getDeviceConviguration
)	TokenNameRPAREN	
;	TokenNameSEMICOLON	
return	TokenNamereturn	
null	TokenNamenull	
...
/** * Used to create proper font metrics */	TokenNameCOMMENT_JAVADOC	 Used to create proper font metrics 
private	TokenNameprivate	
Graphics2D	TokenNameIdentifier	 Graphics2 D
fmg	TokenNameIdentifier	 fmg
;	TokenNameSEMICOLON	
{	TokenNameLBRACE	
BufferedImage	TokenNameIdentifier	 Buffered Image
...
/** * Gets the font metrics for the specified font. * @return the font metrics for the specified font. * @param f the specified font * @see java.awt.Graphics#getFont * @see java.awt.FontMetrics * @see java.awt.Graphics#getFontMetrics() */	TokenNameCOMMENT_JAVADOC	 Gets the font metrics for the specified font. @return the font metrics for the specified font. @param f the specified font @see java.awt.Graphics#getFont @see java.awt.FontMetrics @see java.awt.Graphics#getFontMetrics() 
public	TokenNamepublic	
FontMetrics	TokenNameIdentifier	 Font Metrics
...
println	TokenNameIdentifier	 println
(	TokenNameLPAREN	
"copyArea"	TokenNameStringLiteral	copyArea
)	TokenNameRPAREN	
;	TokenNameSEMICOLON	
}	TokenNameRBRACE	
}	TokenNameRBRACE	
