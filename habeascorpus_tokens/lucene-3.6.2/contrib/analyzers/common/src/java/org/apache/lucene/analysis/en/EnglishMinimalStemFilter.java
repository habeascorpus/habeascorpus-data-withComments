...
;	TokenNameSEMICOLON	
/** * A {@link TokenFilter} that applies {@link EnglishMinimalStemmer} to stem * English words. * <p> * To prevent terms from being stemmed use an instance of * {@link KeywordMarkerFilter} or a custom {@link TokenFilter} that sets * the {@link KeywordAttribute} before this {@link TokenStream}. * </p> */	TokenNameCOMMENT_JAVADOC	 A {@link TokenFilter} that applies {@link EnglishMinimalStemmer} to stem English words. <p> To prevent terms from being stemmed use an instance of {@link KeywordMarkerFilter} or a custom {@link TokenFilter} that sets the {@link KeywordAttribute} before this {@link TokenStream}. </p> 
public	TokenNamepublic	
final	TokenNamefinal	
class	TokenNameclass	
EnglishMinimalStemFilter	TokenNameIdentifier	 English Minimal Stem Filter
