...
/* public void testCreateCFS() throws IOException { createIndex("index.cfs", true, false); } public void testCreateNoCFS() throws IOException { createIndex("index.nocfs", false, false); } public void testCreateSurrogates() throws IOException { createSurrogatesIndex("index.surrogates"); } */	TokenNameCOMMENT_BLOCK	 public void testCreateCFS() throws IOException { createIndex("index.cfs", true, false); } public void testCreateNoCFS() throws IOException { createIndex("index.nocfs", false, false); } public void testCreateSurrogates() throws IOException { createSurrogatesIndex("index.surrogates"); } 
...
// creates an index to check term order for 4.x's TestBackwardsCompatibility 	TokenNameCOMMENT_LINE	creates an index to check term order for 4.x's TestBackwardsCompatibility 
public	TokenNamepublic	
File	TokenNameIdentifier	 File
createSurrogatesIndex	TokenNameIdentifier	 create Surrogates Index
(	TokenNameLPAREN	
String	TokenNameIdentifier	 String
dirName	TokenNameIdentifier	 dir Name
)	TokenNameRPAREN	
...
"a"	TokenNameStringLiteral	a
,	TokenNameCOMMA	
"𝐁"	TokenNameStringLiteral	𝐁
,	TokenNameCOMMA	
"𝐛"	TokenNameStringLiteral	𝐛
,	TokenNameCOMMA	
"𝐂"	TokenNameStringLiteral	𝐂
,	TokenNameCOMMA	
"𝐜"	TokenNameStringLiteral	𝐜
,	TokenNameCOMMA	
...
Integer	TokenNameIdentifier	 Integer
.	TokenNameDOT	
toOctalString	TokenNameIdentifier	 to Octal String
(	TokenNameLPAREN	
i	TokenNameIdentifier	 i
)	TokenNameRPAREN	
;	TokenNameSEMICOLON	
...
;	TokenNameSEMICOLON	
// big string of surrogates 	TokenNameCOMMENT_LINE	big string of surrogates 
doc	TokenNameIdentifier	 doc
.	TokenNameDOT	
add	TokenNameIdentifier	 add
(	TokenNameLPAREN	
