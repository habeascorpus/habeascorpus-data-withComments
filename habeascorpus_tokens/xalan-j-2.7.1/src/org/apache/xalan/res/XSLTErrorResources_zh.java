...
/* * $Id: XSLTErrorResources_zh.java 338081 2004-12-15 17:35:58Z jycli $ */	TokenNameCOMMENT_BLOCK	 $Id: XSLTErrorResources_zh.java 338081 2004-12-15 17:35:58Z jycli $ 
...
XSLTErrorResources_zh	TokenNameIdentifier	 XSLT Error Resources zh
...
ER_NULL_SOURCENODE_APPLYIMPORTS	TokenNameIdentifier	 ER  NULL  SOURCENODE  APPLYIMPORTS
,	TokenNameCOMMA	
"sourceNode ? xsl:apply-imports ????"	TokenNameStringLiteral	sourceNode ? xsl:apply-imports ????
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_CANNOT_ADD	TokenNameIdentifier	 ER  CANNOT  ADD
...
ER_NULL_SOURCENODE_HANDLEAPPLYTEMPLATES	TokenNameIdentifier	 ER  NULL  SOURCENODE  HANDLEAPPLYTEMPLATES
,	TokenNameCOMMA	
"sourceNode ? handleApplyTemplatesInstruction ????"	TokenNameStringLiteral	sourceNode ? handleApplyTemplatesInstruction ????
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_NO_NAME_ATTRIB	TokenNameIdentifier	 ER  NO  NAME  ATTRIB
,	TokenNameCOMMA	
"“{0}”??? name ???"	TokenNameStringLiteral	“{0}”??? name ???
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_TEMPLATE_NOT_FOUND	TokenNameIdentifier	 ER  TEMPLATE  NOT  FOUND
...
ER_NEED_MATCH_ATTRIB	TokenNameIdentifier	 ER  NEED  MATCH  ATTRIB
,	TokenNameCOMMA	
"“{0}”???????????? match ???"	TokenNameStringLiteral	“{0}”???????????? match ???
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_NEED_NAME_OR_MATCH_ATTRIB	TokenNameIdentifier	 ER  NEED  NAME  OR  MATCH  ATTRIB
,	TokenNameCOMMA	
"“{0}”?? name ??? match ???"	TokenNameStringLiteral	“{0}”?? name ??? match ???
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_CANT_RESOLVE_NSPREFIX	TokenNameIdentifier	 ER  CANT  RESOLVE  NSPREFIX
...
ER_COULD_NOT_CREATE_XML_PROC_LIAISON	TokenNameIdentifier	 ER  COULD  NOT  CREATE  XML  PROC  LIAISON
,	TokenNameCOMMA	
"???? XML TransformerFactory ???{0}"	TokenNameStringLiteral	???? XML TransformerFactory ???{0}
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_PROCESS_NOT_SUCCESSFUL	TokenNameIdentifier	 ER  PROCESS  NOT  SUCCESSFUL
,	TokenNameCOMMA	
"Xalan: Process ????"	TokenNameStringLiteral	Xalan: Process ????
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_NOT_SUCCESSFUL	TokenNameIdentifier	 ER  NOT  SUCCESSFUL
...
ER_IOEXCEPTION	TokenNameIdentifier	 ER  IOEXCEPTION
,	TokenNameCOMMA	
"??????? IO ???{0}"	TokenNameStringLiteral	??????? IO ???{0}
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_NO_HREF_ATTRIB	TokenNameIdentifier	 ER  NO  HREF  ATTRIB
...
ER_NO_SELECT_EXPRESSION	TokenNameIdentifier	 ER  NO  SELECT  EXPRESSION
,	TokenNameCOMMA	
"?????? xpath ??????-select??"	TokenNameStringLiteral	?????? xpath ??????-select??
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_CANNOT_SERIALIZE_XSLPROCESSOR	TokenNameIdentifier	 ER  CANNOT  SERIALIZE  XSLPROCESSOR
...
ER_XSLWHEN_NOT_PARENTED_BY_XSLCHOOSE	TokenNameIdentifier	 ER  XSLWHEN  NOT  PARENTED  BY  XSLCHOOSE
,	TokenNameCOMMA	
"?StylesheetHandler?xsl:choose ?? xsl:when ????"	TokenNameStringLiteral	?StylesheetHandler?xsl:choose ?? xsl:when ????
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_MISPLACED_XSLOTHERWISE	TokenNameIdentifier	 ER  MISPLACED  XSLOTHERWISE
...
ER_XSLOTHERWISE_NOT_PARENTED_BY_XSLCHOOSE	TokenNameIdentifier	 ER  XSLOTHERWISE  NOT  PARENTED  BY  XSLCHOOSE
,	TokenNameCOMMA	
"?StylesheetHandler?xsl:choose ?? xsl:otherwise ????"	TokenNameStringLiteral	?StylesheetHandler?xsl:choose ?? xsl:otherwise ????
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_NOT_ALLOWED_INSIDE_TEMPLATE	TokenNameIdentifier	 ER  NOT  ALLOWED  INSIDE  TEMPLATE
...
ER_NO_APPLY_IMPORT_IN_FOR_EACH	TokenNameIdentifier	 ER  NO  APPLY  IMPORT  IN  FOR  EACH
,	TokenNameCOMMA	
"xsl:for-each ????? xsl:apply-imports"	TokenNameStringLiteral	xsl:for-each ????? xsl:apply-imports
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_CANT_USE_DTM_FOR_OUTPUT	TokenNameIdentifier	 ER  CANT  USE  DTM  FOR  OUTPUT
,	TokenNameCOMMA	
"??? DTMLiaison ???? DOM ??... ???? org.apache.xpath.DOM2Helper?"	TokenNameStringLiteral	??? DTMLiaison ???? DOM ??... ???? org.apache.xpath.DOM2Helper?
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_CANT_USE_DTM_FOR_INPUT	TokenNameIdentifier	 ER  CANT  USE  DTM  FOR  INPUT
...
ER_ELEMENT_NAME_METHOD_STATIC	TokenNameIdentifier	 ER  ELEMENT  NAME  METHOD  STATIC
,	TokenNameCOMMA	
"????????? static {0}"	TokenNameStringLiteral	????????? static {0}
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_EXTENSION_FUNC_UNKNOWN	TokenNameIdentifier	 ER  EXTENSION  FUNC  UNKNOWN
...
ER_MORE_MATCH_ELEMENT	TokenNameIdentifier	 ER  MORE  MATCH  ELEMENT
,	TokenNameCOMMA	
"element ?? {0} ???????"	TokenNameStringLiteral	element ?? {0} ???????
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_INVALID_CONTEXT_PASSED	TokenNameIdentifier	 ER  INVALID  CONTEXT  PASSED
...
ER_CANNOT_CALL_PARSE	TokenNameIdentifier	 ER  CANNOT  CALL  PARSE
,	TokenNameCOMMA	
"?????? ContentHandler????????"	TokenNameStringLiteral	?????? ContentHandler????????
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_NO_PARENT_FOR_FILTER	TokenNameIdentifier	 ER  NO  PARENT  FOR  FILTER
...
INVALID_TCHAR	TokenNameIdentifier	 INVALID  TCHAR
,	TokenNameCOMMA	
"?? CHAR ?? {0} ?? {1} ????? CHAR ??????? 1 ????"	TokenNameStringLiteral	?? CHAR ?? {0} ?? {1} ????? CHAR ??????? 1 ????
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
ER_TEMPLATE_NAME_MATCH	TokenNameIdentifier	 ER  TEMPLATE  NAME  MATCH
,	TokenNameCOMMA	
"xsl:template ????? name ? match ?????????"	TokenNameStringLiteral	xsl:template ????? name ? match ?????????
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
,	TokenNameCOMMA	
"[-CR ??????????? {???? CR/LF}?]"	TokenNameStringLiteral	[-CR ??????????? {???? CR/LF}?]
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
...
,	TokenNameCOMMA	
"[-EDUMP {?????} ????????????]"	TokenNameStringLiteral	[-EDUMP {?????} ????????????]
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
...
,	TokenNameCOMMA	
"[-PARAM name expression ?????????]"	TokenNameStringLiteral	[-PARAM name expression ?????????]
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
...
,	TokenNameCOMMA	
"[-URIRESOLVER full class name ??? URIResolver ?? URI?]"	TokenNameStringLiteral	[-URIRESOLVER full class name ??? URIResolver ?? URI?]
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
"optionENTITYRESOLVER"	TokenNameStringLiteral	optionENTITYRESOLVER
,	TokenNameCOMMA	
"[-ENTITYRESOLVER full class name ??? EntityResolver ?????]"	TokenNameStringLiteral	[-ENTITYRESOLVER full class name ??? EntityResolver ?????]
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
"optionCONTENTHANDLER"	TokenNameStringLiteral	optionCONTENTHANDLER
,	TokenNameCOMMA	
"[-CONTENTHANDLER full class name ??? ContentHandler ??????]"	TokenNameStringLiteral	[-CONTENTHANDLER full class name ??? ContentHandler ??????]
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
...
,	TokenNameCOMMA	
" [-MEDIA mediaType ??? media ???????????????]"	TokenNameStringLiteral	 [-MEDIA mediaType ??? media ???????????????]
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
