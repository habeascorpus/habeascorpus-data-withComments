...
;	TokenNameSEMICOLON	
/** * Represents an actual value of a simple type. */	TokenNameCOMMENT_JAVADOC	 Represents an actual value of a simple type. 
public	TokenNamepublic	
interface	TokenNameinterface	
XSValue	TokenNameIdentifier	 XS Value
{	TokenNameLBRACE	
/** * The schema normalized value. */	TokenNameCOMMENT_JAVADOC	 The schema normalized value. 
public	TokenNamepublic	
...
;	TokenNameSEMICOLON	
/** * The actual value. <code>null</code> if the value is in error. */	TokenNameCOMMENT_JAVADOC	 The actual value. <code>null</code> if the value is in error. 
public	TokenNamepublic	
...
;	TokenNameSEMICOLON	
/** * The declared simple type definition used to validate this value. * It can be a union type. */	TokenNameCOMMENT_JAVADOC	 The declared simple type definition used to validate this value. It can be a union type. 
public	TokenNamepublic	
...
;	TokenNameSEMICOLON	
/** * If the declared simple type definition is a union, return the member * type actually used to validate the value. Otherwise null. */	TokenNameCOMMENT_JAVADOC	 If the declared simple type definition is a union, return the member type actually used to validate the value. Otherwise null. 
public	TokenNamepublic	
XSSimpleTypeDefinition	TokenNameIdentifier	 XS Simple Type Definition
...
;	TokenNameSEMICOLON	
/** * If <code>getTypeDefinition()</code> returns a list type whose item type * is a union type, then this method returns a list with the same length * as the value list, for simple types that actually validated * the corresponding item in the value. */	TokenNameCOMMENT_JAVADOC	 If <code>getTypeDefinition()</code> returns a list type whose item type is a union type, then this method returns a list with the same length as the value list, for simple types that actually validated the corresponding item in the value. 
public	TokenNamepublic	
