...
Serializable	TokenNameIdentifier	 Serializable
{	TokenNameLBRACE	
// NOTE: this static code must precede setting the static defaultImpl: 	TokenNameCOMMENT_LINE	NOTE: this static code must precede setting the static defaultImpl: 
...
Similarity	TokenNameIdentifier	 Similarity
>	TokenNameGREATER	
withoutDocFreqMethod	TokenNameIdentifier	 without Doc Freq Method
=	TokenNameEQUAL	
new	TokenNamenew	
VirtualMethod	TokenNameIdentifier	 Virtual Method
<	TokenNameLESS	
...
class	TokenNameclass	
,	TokenNameCOMMA	
"idfExplain"	TokenNameStringLiteral	idfExplain
,	TokenNameCOMMA	
Term	TokenNameIdentifier	 Term
.	TokenNameDOT	
class	TokenNameclass	
...
Similarity	TokenNameIdentifier	 Similarity
>	TokenNameGREATER	
withDocFreqMethod	TokenNameIdentifier	 with Doc Freq Method
=	TokenNameEQUAL	
new	TokenNamenew	
VirtualMethod	TokenNameIdentifier	 Virtual Method
<	TokenNameLESS	
...
hasIDFExplainWithDocFreqAPI	TokenNameIdentifier	 has IDF Explain With Doc Freq API
=	TokenNameEQUAL	
VirtualMethod	TokenNameIdentifier	 Virtual Method
.	TokenNameDOT	
...
/** * The Similarity implementation used by default. **/	TokenNameCOMMENT_JAVADOC	 The Similarity implementation used by default. *
private	TokenNameprivate	
static	TokenNamestatic	
Similarity	TokenNameIdentifier	 Similarity
defaultImpl	TokenNameIdentifier	 default Impl
=	TokenNameEQUAL	
new	TokenNamenew	
...
final	TokenNamefinal	
int	TokenNameint	
NO_DOC_ID_PROVIDED	TokenNameIdentifier	 NO  DOC  ID  PROVIDED
=	TokenNameEQUAL	
-	TokenNameMINUS	
1	TokenNameIntegerLiteral	
;	TokenNameSEMICOLON	
/** Set the default Similarity implementation used by indexing and search * code. * * @see Searcher#setSimilarity(Similarity) * @see org.apache.lucene.index.IndexWriter#setSimilarity(Similarity) */	TokenNameCOMMENT_JAVADOC	 Set the default Similarity implementation used by indexing and search code. * @see Searcher#setSimilarity(Similarity) @see org.apache.lucene.index.IndexWriter#setSimilarity(Similarity) 
public	TokenNamepublic	
static	TokenNamestatic	
void	TokenNamevoid	
...
/** Return the default Similarity implementation used by indexing and search * code. * * <p>This is initially an instance of {@link DefaultSimilarity}. * * @see Searcher#setSimilarity(Similarity) * @see org.apache.lucene.index.IndexWriter#setSimilarity(Similarity) */	TokenNameCOMMENT_JAVADOC	 Return the default Similarity implementation used by indexing and search code. * <p>This is initially an instance of {@link DefaultSimilarity}. * @see Searcher#setSimilarity(Similarity) @see org.apache.lucene.index.IndexWriter#setSimilarity(Similarity) 
public	TokenNamepublic	
static	TokenNamestatic	
Similarity	TokenNameIdentifier	 Similarity
...
/** Cache of decoded bytes. */	TokenNameCOMMENT_JAVADOC	 Cache of decoded bytes. 
private	TokenNameprivate	
static	TokenNamestatic	
final	TokenNamefinal	
...
NORM_TABLE	TokenNameIdentifier	 NORM  TABLE
=	TokenNameEQUAL	
new	TokenNamenew	
float	TokenNamefloat	
[	TokenNameLBRACKET	
...
/** * Decodes a normalization factor stored in an index. * @see #decodeNormValue(byte) * @deprecated Use {@link #decodeNormValue} instead. */	TokenNameCOMMENT_JAVADOC	 Decodes a normalization factor stored in an index. @see #decodeNormValue(byte) @deprecated Use {@link #decodeNormValue} instead. 
@	TokenNameAT	
Deprecated	TokenNameIdentifier	 Deprecated
public	TokenNamepublic	
static	TokenNamestatic	
float	TokenNamefloat	
decodeNorm	TokenNameIdentifier	 decode Norm
(	TokenNameLPAREN	
byte	TokenNamebyte	
...
;	TokenNameSEMICOLON	
// & 0xFF maps negative bytes to positive above 127 	TokenNameCOMMENT_LINE	& 0xFF maps negative bytes to positive above 127 
}	TokenNameRBRACE	
/** Decodes a normalization factor stored in an index. * <p> * <b>WARNING: If you override this method, you should change the default * Similarity to your implementation with {@link Similarity#setDefault(Similarity)}. * Otherwise, your method may not always be called, especially if you omit norms * for some fields.</b> * @see #encodeNormValue(float) */	TokenNameCOMMENT_JAVADOC	 Decodes a normalization factor stored in an index. <p> <b>WARNING: If you override this method, you should change the default Similarity to your implementation with {@link Similarity#setDefault(Similarity)}. Otherwise, your method may not always be called, especially if you omit norms for some fields.</b> @see #encodeNormValue(float) 
public	TokenNamepublic	
float	TokenNamefloat	
...
/** Returns a table for decoding normalization bytes. * @see #encodeNormValue(float) * @see #decodeNormValue(byte) * * @deprecated Use instance methods for encoding/decoding norm values to enable customization. */	TokenNameCOMMENT_JAVADOC	 Returns a table for decoding normalization bytes. @see #encodeNormValue(float) @see #decodeNormValue(byte) * @deprecated Use instance methods for encoding/decoding norm values to enable customization. 
@	TokenNameAT	
Deprecated	TokenNameIdentifier	 Deprecated
public	TokenNamepublic	
static	TokenNamestatic	
...
getNormDecoder	TokenNameIdentifier	 get Norm Decoder
(	TokenNameLPAREN	
)	TokenNameRPAREN	
{	TokenNameLBRACE	
return	TokenNamereturn	
...
(	TokenNameLPAREN	
"please use computeNorm instead"	TokenNameStringLiteral	please use computeNorm instead
)	TokenNameRPAREN	
;	TokenNameSEMICOLON	
}	TokenNameRBRACE	
/** Computes the normalization value for a query given the sum of the squared * weights of each of the query terms. This value is multiplied into the * weight of each query term. While the classic query normalization factor is * computed as 1/sqrt(sumOfSquaredWeights), other implementations might * completely ignore sumOfSquaredWeights (ie return 1). * * <p>This does not affect ranking, but the default implementation does make scores * from different queries more comparable than they would be by eliminating the * magnitude of the Query vector as a factor in the score. * * @param sumOfSquaredWeights the sum of the squares of query term weights * @return a normalization factor for query weights */	TokenNameCOMMENT_JAVADOC	 Computes the normalization value for a query given the sum of the squared weights of each of the query terms. This value is multiplied into the weight of each query term. While the classic query normalization factor is computed as 1/sqrt(sumOfSquaredWeights), other implementations might completely ignore sumOfSquaredWeights (ie return 1). * <p>This does not affect ranking, but the default implementation does make scores from different queries more comparable than they would be by eliminating the magnitude of the Query vector as a factor in the score. * @param sumOfSquaredWeights the sum of the squares of query term weights @return a normalization factor for query weights 
public	TokenNamepublic	
abstract	TokenNameabstract	
float	TokenNamefloat	
...
/** * Static accessor kept for backwards compability reason, use encodeNormValue instead. * @param f norm-value to encode * @return byte representing the given float * @deprecated Use {@link #encodeNormValue} instead. * * @see #encodeNormValue(float) */	TokenNameCOMMENT_JAVADOC	 Static accessor kept for backwards compability reason, use encodeNormValue instead. @param f norm-value to encode @return byte representing the given float @deprecated Use {@link #encodeNormValue} instead. * @see #encodeNormValue(float) 
@	TokenNameAT	
Deprecated	TokenNameIdentifier	 Deprecated
public	TokenNamepublic	
static	TokenNamestatic	
...
;	TokenNameSEMICOLON	
/** Computes a score factor based on a term or phrase's frequency in a * document. This value is multiplied by the {@link #idf(int, int)} * factor for each term in the query and these products are then summed to * form the initial score for a document. * * <p>Terms and phrases repeated in a document indicate the topic of the * document, so implementations of this method usually return larger values * when <code>freq</code> is large, and smaller values when <code>freq</code> * is small. * * @param freq the frequency of a term within a document * @return a score factor based on a term's within-document frequency */	TokenNameCOMMENT_JAVADOC	 Computes a score factor based on a term or phrase's frequency in a document. This value is multiplied by the {@link #idf(int, int)} factor for each term in the query and these products are then summed to form the initial score for a document. * <p>Terms and phrases repeated in a document indicate the topic of the document, so implementations of this method usually return larger values when <code>freq</code> is large, and smaller values when <code>freq</code> is small. * @param freq the frequency of a term within a document @return a score factor based on a term's within-document frequency 
public	TokenNamepublic	
abstract	TokenNameabstract	
float	TokenNamefloat	
tf	TokenNameIdentifier	 tf
...
;	TokenNameSEMICOLON	
/** * Computes a score factor for a simple term and returns an explanation * for that score factor. * * <p> * The default implementation uses: * * <pre> * idf(searcher.docFreq(term), searcher.maxDoc()); * </pre> * * Note that {@link Searcher#maxDoc()} is used instead of * {@link org.apache.lucene.index.IndexReader#numDocs() IndexReader#numDocs()} because also * {@link Searcher#docFreq(Term)} is used, and when the latter * is inaccurate, so is {@link Searcher#maxDoc()}, and in the same direction. * In addition, {@link Searcher#maxDoc()} is more efficient to compute * * @param term the term in question * @param searcher the document collection being searched * @return an IDFExplain object that includes both an idf score factor and an explanation for the term. * @throws IOException */	TokenNameCOMMENT_JAVADOC	 Computes a score factor for a simple term and returns an explanation for that score factor. * <p> The default implementation uses: * <pre> idf(searcher.docFreq(term), searcher.maxDoc()); </pre> * Note that {@link Searcher#maxDoc()} is used instead of {@link org.apache.lucene.index.IndexReader#numDocs() IndexReader#numDocs()} because also {@link Searcher#docFreq(Term)} is used, and when the latter is inaccurate, so is {@link Searcher#maxDoc()}, and in the same direction. In addition, {@link Searcher#maxDoc()} is more efficient to compute * @param term the term in question @param searcher the document collection being searched @return an IDFExplain object that includes both an idf score factor and an explanation for the term. @throws IOException 
public	TokenNamepublic	
IDFExplanation	TokenNameIdentifier	 IDF Explanation
...
{	TokenNameLBRACE	
// Fallback to slow impl 	TokenNameCOMMENT_LINE	Fallback to slow impl 
return	TokenNamereturn	
idfExplain	TokenNameIdentifier	 idf Explain
(	TokenNameLPAREN	
term	TokenNameIdentifier	 term
...
{	TokenNameLBRACE	
return	TokenNamereturn	
"idf(docFreq="	TokenNameStringLiteral	idf(docFreq=
+	TokenNamePLUS	
df	TokenNameIdentifier	 df
+	TokenNamePLUS	
", maxDocs="	TokenNameStringLiteral	, maxDocs=
+	TokenNamePLUS	
max	TokenNameIdentifier	 max
+	TokenNamePLUS	
...
/** * This method forwards to {@link * #idfExplain(Term,Searcher,int)} by passing * <code>searcher.docFreq(term)</code> as the docFreq. * * WARNING: if you subclass Similariary and override this * method then you may hit a peformance hit for certain * queries. Better to override {@link * #idfExplain(Term,Searcher,int)} instead. */	TokenNameCOMMENT_JAVADOC	 This method forwards to {@link #idfExplain(Term,Searcher,int)} by passing <code>searcher.docFreq(term)</code> as the docFreq. * WARNING: if you subclass Similariary and override this method then you may hit a peformance hit for certain queries. Better to override {@link #idfExplain(Term,Searcher,int)} instead. 
public	TokenNamepublic	
IDFExplanation	TokenNameIdentifier	 IDF Explanation
idfExplain	TokenNameIdentifier	 idf Explain
(	TokenNameLPAREN	
...
/** * Computes a score factor for a phrase. * * <p> * The default implementation sums the idf factor for * each term in the phrase. * * @param terms the terms in the phrase * @param searcher the document collection being searched * @return an IDFExplain object that includes both an idf * score factor for the phrase and an explanation * for each term. * @throws IOException */	TokenNameCOMMENT_JAVADOC	 Computes a score factor for a phrase. * <p> The default implementation sums the idf factor for each term in the phrase. * @param terms the terms in the phrase @param searcher the document collection being searched @return an IDFExplain object that includes both an idf score factor for the phrase and an explanation for each term. @throws IOException 
public	TokenNamepublic	
IDFExplanation	TokenNameIdentifier	 IDF Explanation
idfExplain	TokenNameIdentifier	 idf Explain
(	TokenNameLPAREN	
...
final	TokenNamefinal	
float	TokenNamefloat	
fIdf	TokenNameIdentifier	 f Idf
=	TokenNameEQUAL	
idf	TokenNameIdentifier	 idf
;	TokenNameSEMICOLON	
return	TokenNamereturn	
