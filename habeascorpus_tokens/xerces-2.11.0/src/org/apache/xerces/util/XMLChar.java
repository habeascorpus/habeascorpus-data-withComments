...
/** * Trims space characters as defined by production [3] in * the XML 1.0 specification from both ends of the given string. * * @param value the string to be trimmed * @return the given string with the space characters trimmed * from both ends */	TokenNameCOMMENT_JAVADOC	 Trims space characters as defined by production [3] in the XML 1.0 specification from both ends of the given string. * @param value the string to be trimmed @return the given string with the space characters trimmed from both ends 
public	TokenNamepublic	
static	TokenNamestatic	
String	TokenNameIdentifier	 String
...
final	TokenNamefinal	
int	TokenNameint	
lengthMinusOne	TokenNameIdentifier	 length Minus One
=	TokenNameEQUAL	
value	TokenNameIdentifier	 value
.	TokenNameDOT	
length	TokenNameIdentifier	 length
...
// trim(String):String 	TokenNameCOMMENT_LINE	trim(String):String 
}	TokenNameRBRACE	
