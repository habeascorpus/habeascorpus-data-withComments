...
;	TokenNameSEMICOLON	
/** * A {@link TokenFilter} that applies {@link PortugueseStemmer} to stem * Portuguese words. * <p> * To prevent terms from being stemmed use an instance of * {@link KeywordMarkerFilter} or a custom {@link TokenFilter} that sets * the {@link KeywordAttribute} before this {@link TokenStream}. * </p> */	TokenNameCOMMENT_JAVADOC	 A {@link TokenFilter} that applies {@link PortugueseStemmer} to stem Portuguese words. <p> To prevent terms from being stemmed use an instance of {@link KeywordMarkerFilter} or a custom {@link TokenFilter} that sets the {@link KeywordAttribute} before this {@link TokenStream}. </p> 
...
{	TokenNameLBRACE	
// this stemmer increases word length by 1: worst case '*ã' -> '*ão' 	TokenNameCOMMENT_LINE	this stemmer increases word length by 1: worst case '*ã' -> '*ão' 
final	TokenNamefinal	
int	TokenNameint	
