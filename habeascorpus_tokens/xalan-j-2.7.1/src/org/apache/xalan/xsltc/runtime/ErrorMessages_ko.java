...
/* * $Id: ErrorMessages_ko.java 468652 2006-10-28 07:05:17Z minchau $ */	TokenNameCOMMENT_BLOCK	 $Id: ErrorMessages_ko.java 468652 2006-10-28 07:05:17Z minchau $ 
...
,	TokenNameCOMMA	
"<xsl:copy> ??? ??? ??? ??????."	TokenNameStringLiteral	<xsl:copy> ??? ??? ??? ??????.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
,	TokenNameCOMMA	
"?? DOM? ???? ?? ??? ???? DOMAdapter? ???????."	TokenNameStringLiteral	?? DOM? ???? ?? ??? ???? DOMAdapter? ???????.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
,	TokenNameCOMMA	
"?? ?? SAX ?? ???? DTD ?? ???? ???? ????."	TokenNameStringLiteral	?? ?? SAX ?? ???? DTD ?? ???? ???? ????.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
,	TokenNameCOMMA	
"?? ?? SAX ?? ???? XML ?? ??? ???? ????."	TokenNameStringLiteral	?? ?? SAX ?? ???? XML ?? ??? ???? ????.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
,	TokenNameCOMMA	
"?? ?? XSLTC ??? ???? ? ??? XSLTC ??? ???? ??? ''{0}'' Translet? ??????. ? Translet? ????? ?????? ?? ?????? ? ??? XSLTC ??? ???? ???. "	TokenNameStringLiteral	?? ?? XSLTC ??? ???? ? ??? XSLTC ??? ???? ??? ''{0}'' Translet? ??????. ? Translet? ????? ?????? ?? ?????? ? ??? XSLTC ??? ???? ???. 
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
,	TokenNameCOMMA	
"?? QName??? ?? ??? ''{0}'' ?? ????."	TokenNameStringLiteral	?? QName??? ?? ??? ''{0}'' ?? ????.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
