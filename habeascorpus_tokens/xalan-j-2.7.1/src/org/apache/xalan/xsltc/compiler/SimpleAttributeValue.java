...
/* * $Id: SimpleAttributeValue.java 468650 2006-10-28 07:03:30Z minchau $ */	TokenNameCOMMENT_BLOCK	 $Id: SimpleAttributeValue.java 468650 2006-10-28 07:03:30Z minchau $ 
...
;	TokenNameSEMICOLON	
// The attributes value (literate string). 	TokenNameCOMMENT_LINE	The attributes value (literate string). 
/** * Creates a new simple attribute value. * @param value the attribute value. */	TokenNameCOMMENT_JAVADOC	 Creates a new simple attribute value. @param value the attribute value. 
...
/** * Returns this attribute value's type (String). * @param stable The compiler/parser's symbol table */	TokenNameCOMMENT_JAVADOC	 Returns this attribute value's type (String). @param stable The compiler/parser's symbol table 
public	TokenNamepublic	
Type	TokenNameIdentifier	 Type
...
/** * Translate this attribute value into JVM bytecodes that pushes the * attribute value onto the JVM's stack. * @param classGen BCEL Java class generator * @param methodGen BCEL Java method generator */	TokenNameCOMMENT_JAVADOC	 Translate this attribute value into JVM bytecodes that pushes the attribute value onto the JVM's stack. @param classGen BCEL Java class generator @param methodGen BCEL Java method generator 
public	TokenNamepublic	
void	TokenNamevoid	
