...
/** * Decodes data which was encoded by {@link EightFlagsIntEncoder}. Scans * the <code>indicator</code>, one flag (1-bits) at a time, and decodes extra * data using {@link VInt8IntDecoder}. * * @see EightFlagsIntEncoder * @lucene.experimental */	TokenNameCOMMENT_JAVADOC	 Decodes data which was encoded by {@link EightFlagsIntEncoder}. Scans the <code>indicator</code>, one flag (1-bits) at a time, and decodes extra data using {@link VInt8IntDecoder}. * @see EightFlagsIntEncoder @lucene.experimental 
...
;	TokenNameSEMICOLON	
/** The indicator for decoding a chunk of 8 integers. */	TokenNameCOMMENT_JAVADOC	 The indicator for decoding a chunk of 8 integers. 
private	TokenNameprivate	
int	TokenNameint	
indicator	TokenNameIdentifier	 indicator
;	TokenNameSEMICOLON	
/** Used as an ordinal of 0 - 7, as the decoder decodes chunks of 8 integers. */	TokenNameCOMMENT_JAVADOC	 Used as an ordinal of 0 - 7, as the decoder decodes chunks of 8 integers. 
private	TokenNameprivate	
int	TokenNameint	
...
{	TokenNameLBRACE	
return	TokenNamereturn	
"EightFlags (VInt8)"	TokenNameStringLiteral	EightFlags (VInt8)
;	TokenNameSEMICOLON	
}	TokenNameRBRACE	
}	TokenNameRBRACE	
