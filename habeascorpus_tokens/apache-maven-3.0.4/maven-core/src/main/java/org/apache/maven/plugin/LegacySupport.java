...
;	TokenNameSEMICOLON	
/** * Gets the currently active session. * * @return The currently active session or {@code null} if none. */	TokenNameCOMMENT_JAVADOC	 Gets the currently active session. * @return The currently active session or {@code null} if none. 
MavenSession	TokenNameIdentifier	 Maven Session
getSession	TokenNameIdentifier	 get Session
(	TokenNameLPAREN	
)	TokenNameRPAREN	
;	TokenNameSEMICOLON	
/** * Gets the currently active repository session. * * @return The currently active repository session or {@code null} if none. */	TokenNameCOMMENT_JAVADOC	 Gets the currently active repository session. * @return The currently active repository session or {@code null} if none. 
RepositorySystemSession	TokenNameIdentifier	 Repository System Session
