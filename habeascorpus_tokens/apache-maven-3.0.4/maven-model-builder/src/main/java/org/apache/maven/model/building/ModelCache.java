...
;	TokenNameSEMICOLON	
/** * Gets the specified data from the cache. * * @param groupId The group id of the cache record, must not be {@code null}. * @param artifactId The artifact id of the cache record, must not be {@code null}. * @param version The version of the cache record, must not be {@code null}. * @param tag The tag of the cache record, must not be {@code null}. * @return The requested data or {@code null} if none was present in the cache. */	TokenNameCOMMENT_JAVADOC	 Gets the specified data from the cache. * @param groupId The group id of the cache record, must not be {@code null}. @param artifactId The artifact id of the cache record, must not be {@code null}. @param version The version of the cache record, must not be {@code null}. @param tag The tag of the cache record, must not be {@code null}. @return The requested data or {@code null} if none was present in the cache. 
Object	TokenNameIdentifier	 Object
