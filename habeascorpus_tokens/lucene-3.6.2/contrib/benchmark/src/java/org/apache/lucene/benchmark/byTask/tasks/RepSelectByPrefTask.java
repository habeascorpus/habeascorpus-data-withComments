...
;	TokenNameSEMICOLON	
/** * Report by-name-prefix statistics with no aggregations. * <br>Other side effects: None. */	TokenNameCOMMENT_JAVADOC	 Report by-name-prefix statistics with no aggregations. <br>Other side effects: None. 
public	TokenNamepublic	
class	TokenNameclass	
RepSelectByPrefTask	TokenNameIdentifier	 Rep Select By Pref Task
...
=	TokenNameEQUAL	
reportSelectByPrefix	TokenNameIdentifier	 report Select By Prefix
(	TokenNameLPAREN	
...
println	TokenNameIdentifier	 println
(	TokenNameLPAREN	
"------------> Report Select By Prefix ("	TokenNameStringLiteral	------------> Report Select By Prefix (
+	TokenNamePLUS	
