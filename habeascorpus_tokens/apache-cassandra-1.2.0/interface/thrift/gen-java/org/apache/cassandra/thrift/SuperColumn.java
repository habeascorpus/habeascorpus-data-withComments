...
;	TokenNameSEMICOLON	
/** * A named list of columns. * @param name. see Column.name. * @param columns. A collection of standard Columns. The columns within a super column are defined in an adhoc manner. * Columns within a super column do not have to have matching structures (similarly named child columns). */	TokenNameCOMMENT_JAVADOC	 A named list of columns. @param name. see Column.name. @param columns. A collection of standard Columns. The columns within a super column are defined in an adhoc manner. Columns within a super column do not have to have matching structures (similarly named child columns). 
...
_list0	TokenNameIdentifier	 list0
=	TokenNameEQUAL	
iprot	TokenNameIdentifier	 iprot
.	TokenNameDOT	
...
{	TokenNameLBRACE	
Column	TokenNameIdentifier	 Column
_elem2	TokenNameIdentifier	 elem2
;	TokenNameSEMICOLON	
// required 	TokenNameCOMMENT_LINE	required 
_elem2	TokenNameIdentifier	 elem2
=	TokenNameEQUAL	
...
(	TokenNameLPAREN	
Column	TokenNameIdentifier	 Column
_iter3	TokenNameIdentifier	 iter3
:	TokenNameCOLON	
this	TokenNamethis	
.	TokenNameDOT	
columns	TokenNameIdentifier	 columns
