...
Component	TokenNameIdentifier	 Component
;	TokenNameSEMICOLON	
/** * Resolves conflicting artifacts by always selecting the <em>nearest</em> declaration. Nearest is defined as the * declaration that has the least transitive steps away from the project being built. * * @author <a href="mailto:jason@maven.org">Jason van Zyl</a> * @author <a href="mailto:markhobson@gmail.com">Mark Hobson</a> * @since 3.0 */	TokenNameCOMMENT_JAVADOC	 Resolves conflicting artifacts by always selecting the <em>nearest</em> declaration. Nearest is defined as the declaration that has the least transitive steps away from the project being built. * @author <a href="mailto:jason@maven.org">Jason van Zyl</a> @author <a href="mailto:markhobson@gmail.com">Mark Hobson</a> @since 3.0 
@	TokenNameAT	
Component	TokenNameIdentifier	 Component
(	TokenNameLPAREN	
