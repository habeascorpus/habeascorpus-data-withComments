...
DeltreeTest	TokenNameIdentifier	 Deltree Test
...
(	TokenNameLPAREN	
"src/etc/testcases/taskdefs/deltree.xml"	TokenNameStringLiteral	src/etc/testcases/taskdefs/deltree.xml
)	TokenNameRPAREN	
;	TokenNameSEMICOLON	
}	TokenNameRBRACE	
public	TokenNamepublic	
...
{	TokenNameLBRACE	
// We try to delete the directory created in CopydirTest 	TokenNameCOMMENT_LINE	We try to delete the directory created in CopydirTest 
