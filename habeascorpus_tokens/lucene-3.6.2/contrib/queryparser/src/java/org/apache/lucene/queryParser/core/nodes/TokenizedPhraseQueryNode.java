...
;	TokenNameSEMICOLON	
/** * A {@link TokenizedPhraseQueryNode} represents a node created by a code that * tokenizes/lemmatizes/analyzes. */	TokenNameCOMMENT_JAVADOC	 A {@link TokenizedPhraseQueryNode} represents a node created by a code that tokenizes/lemmatizes/analyzes. 
...
"<tokenizedphrase/>"	TokenNameStringLiteral	<tokenizedphrase/>
;	TokenNameSEMICOLON	
...
(	TokenNameLPAREN	
"<tokenizedtphrase>"	TokenNameStringLiteral	<tokenizedtphrase>
)	TokenNameRPAREN	
;	TokenNameSEMICOLON	
for	TokenNamefor	
(	TokenNameLPAREN	
...
// This text representation is not re-parseable 	TokenNameCOMMENT_LINE	This text representation is not re-parseable 
public	TokenNamepublic	
...
// end class MultitermQueryNode 	TokenNameCOMMENT_LINE	end class MultitermQueryNode 
