...
/* * $Id: XSLTErrorResources_ru.java 468641 2006-10-28 06:54:42Z minchau $ */	TokenNameCOMMENT_BLOCK	 $Id: XSLTErrorResources_ru.java 468641 2006-10-28 06:54:42Z minchau $ 
...
XSLTErrorResources_ru	TokenNameIdentifier	 XSLT Error Resources ru
...
ER_CANT_RESOLVE_NAME_AVT	TokenNameIdentifier	 ER  CANT  RESOLVE  NAME  AVT
,	TokenNameCOMMA	
"?? ??????? ????????????? ??? AVT ? xsl:call-template."	TokenNameStringLiteral	?? ??????? ????????????? ??? AVT ? xsl:call-template.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_REQUIRES_ATTRIB	TokenNameIdentifier	 ER  REQUIRES  ATTRIB
...
ER_NO_HREF_ATTRIB	TokenNameIdentifier	 ER  NO  HREF  ATTRIB
,	TokenNameCOMMA	
"(StylesheetHandler) ?? ?????? ??????? href ??? {0}"	TokenNameStringLiteral	(StylesheetHandler) ?? ?????? ??????? href ??? {0}
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_STYLESHEET_INCLUDES_ITSELF	TokenNameIdentifier	 ER  STYLESHEET  INCLUDES  ITSELF
...
ER_XMLSPACE_ILLEGAL_VALUE	TokenNameIdentifier	 ER  XMLSPACE  ILLEGAL  VALUE
,	TokenNameCOMMA	
"?????? ???????????? ???????? xml:space ? ???????? XML: {0}"	TokenNameStringLiteral	?????? ???????????? ???????? xml:space ? ???????? XML: {0}
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_NO_XSLKEY_DECLARATION	TokenNameIdentifier	 ER  NO  XSLKEY  DECLARATION
,	TokenNameCOMMA	
"??????????? ?????????? xsl:key ??? {0}!"	TokenNameStringLiteral	??????????? ?????????? xsl:key ??? {0}!
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_CANT_CREATE_URL	TokenNameIdentifier	 ER  CANT  CREATE  URL
...
ER_UNKNOWN_EXT_NS_PREFIX	TokenNameIdentifier	 ER  UNKNOWN  EXT  NS  PREFIX
,	TokenNameCOMMA	
"(StylesheetHandler) ??????????? ??????? {1} ???????????? ???? ?????????? {0}"	TokenNameStringLiteral	(StylesheetHandler) ??????????? ??????? {1} ???????????? ???? ?????????? {0}
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_IMPORTS_AS_FIRST_ELEM	TokenNameIdentifier	 ER  IMPORTS  AS  FIRST  ELEM
...
ER_CANT_RESOLVE_PREFIX_OF_NON_PREFIX_RESOLVER	TokenNameIdentifier	 ER  CANT  RESOLVE  PREFIX  OF  NON  PREFIX  RESOLVER
,	TokenNameCOMMA	
"?? ??????? ????????????? ??????? ??????????????? non-Prefix!"	TokenNameStringLiteral	?? ??????? ????????????? ??????? ??????????????? non-Prefix!
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_REDIRECT_COULDNT_GET_FILENAME	TokenNameIdentifier	 ER  REDIRECT  COULDNT  GET  FILENAME
...
ER_ILLEGAL_DOMSOURCE_INPUT	TokenNameIdentifier	 ER  ILLEGAL  DOMSOURCE  INPUT
,	TokenNameCOMMA	
"??? DOMSource ? newTemplates ???? ????? ?? ????? ???? ??????!"	TokenNameStringLiteral	??? DOMSource ? newTemplates ???? ????? ?? ????? ???? ??????!
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_CLASS_NOT_FOUND_FOR_OPTION	TokenNameIdentifier	 ER  CLASS  NOT  FOUND  FOR  OPTION
...
ER_ELEMENT_NAME_METHOD_STATIC	TokenNameIdentifier	 ER  ELEMENT  NAME  METHOD  STATIC
,	TokenNameCOMMA	
"????? name ???????? ?????? ???? ??????????? {0}"	TokenNameStringLiteral	????? name ???????? ?????? ???? ??????????? {0}
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_EXTENSION_FUNC_UNKNOWN	TokenNameIdentifier	 ER  EXTENSION  FUNC  UNKNOWN
...
ER_NO_STYLESHEET_PI	TokenNameIdentifier	 ER  NO  STYLESHEET  PI
,	TokenNameCOMMA	
"?? ?????? PI xml-stylesheet ? {0}"	TokenNameStringLiteral	?? ?????? PI xml-stylesheet ? {0}
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_NOT_SUPPORTED	TokenNameIdentifier	 ER  NOT  SUPPORTED
...
ER_NUMBER_TOO_BIG	TokenNameIdentifier	 ER  NUMBER  TOO  BIG
,	TokenNameCOMMA	
"??????? ??????????????? ????? ?????? ??????????? ??????????? LongInteger"	TokenNameStringLiteral	??????? ??????????????? ????? ?????? ??????????? ??????????? LongInteger
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_CANNOT_FIND_SAX1_DRIVER	TokenNameIdentifier	 ER  CANNOT  FIND  SA X1  DRIVER
...
ER_INVALID_NAMESPACE_URI_VALUE_FOR_RESULT_PREFIX_FOR_DEFAULT	TokenNameIdentifier	 ER  INVALID  NAMESPACE  URI  VALUE  FOR  RESULT  PREFIX  FOR  DEFAULT
,	TokenNameCOMMA	
"??????? result-prefix ???????? xsl:namespace-alias ???????? ???????? '#default', ?? ?????????? ???????????? ???? ?? ????????? ? ??????? ??? ??????? ???????? ?? ???????"	TokenNameStringLiteral	??????? result-prefix ???????? xsl:namespace-alias ???????? ???????? '#default', ?? ?????????? ???????????? ???? ?? ????????? ? ??????? ??? ??????? ???????? ?? ???????
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_INVALID_NAMESPACE_URI_VALUE_FOR_RESULT_PREFIX	TokenNameIdentifier	 ER  INVALID  NAMESPACE  URI  VALUE  FOR  RESULT  PREFIX
,	TokenNameCOMMA	
"??????? result-prefix ???????? xsl:namespace-alias ???????? ???????? ''{0}'', ?? ?????????? ???????????? ???? ??? ???????? ''{0}'' ? ??????? ??????? ???????? ?? ???????. "	TokenNameStringLiteral	??????? result-prefix ???????? xsl:namespace-alias ???????? ???????? ''{0}'', ?? ?????????? ???????????? ???? ??? ???????? ''{0}'' ? ??????? ??????? ???????? ?? ???????. 
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_SET_FEATURE_NULL_NAME	TokenNameIdentifier	 ER  SET  FEATURE  NULL  NAME
,	TokenNameCOMMA	
"??? ??????? ?? ????? ???? ?????? ? TransformerFactory.setFeature(??? ??????, ????????? ????????). "	TokenNameStringLiteral	??? ??????? ?? ????? ???? ?????? ? TransformerFactory.setFeature(??? ??????, ????????? ????????). 
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_GET_FEATURE_NULL_NAME	TokenNameIdentifier	 ER  GET  FEATURE  NULL  NAME
...
WG_CANNOT_FIND_COLLATOR	TokenNameIdentifier	 WG  CANNOT  FIND  COLLATOR
,	TokenNameCOMMA	
"?? ??????? ????? Collator ??? <sort xml:lang={0}"	TokenNameStringLiteral	?? ??????? ????? Collator ??? <sort xml:lang={0}
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
WG_FUNCTIONS_SHOULD_USE_URL	TokenNameIdentifier	 WG  FUNCTIONS  SHOULD  USE  URL
,	TokenNameCOMMA	
"?????? ?????????: ? ?????????? functions ?? ??????? ????????? url {0}"	TokenNameStringLiteral	?????? ?????????: ? ?????????? functions ?? ??????? ????????? url {0}
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
WG_ENCODING_NOT_SUPPORTED_USING_UTF8	TokenNameIdentifier	 WG  ENCODING  NOT  SUPPORTED  USING  UT F8
...
WG_PROCESSINGINSTRUCTION_NAME_CANT_BE_XML	TokenNameIdentifier	 WG  PROCESSINGINSTRUCTION  NAME  CANT  BE  XML
,	TokenNameCOMMA	
"???????? ???????? 'name' ? ????? xsl:processing-instruction ?? ?????? ???? ????? 'xml'"	TokenNameStringLiteral	???????? ???????? 'name' ? ????? xsl:processing-instruction ?? ?????? ???? ????? 'xml'
}	TokenNameRBRACE	
,	TokenNameCOMMA	
// Note to translators: "name" and "xsl:processing-instruction" are keywords 	TokenNameCOMMENT_LINE	Note to translators: "name" and "xsl:processing-instruction" are keywords 
...
WG_PROCESSINGINSTRUCTION_NOTVALID_NCNAME	TokenNameIdentifier	 WG  PROCESSINGINSTRUCTION  NOTVALID  NCNAME
,	TokenNameCOMMA	
"???????? ???????? ''name'' ? xsl:processing-instruction ?????? ???? ?????????? ?????? NCName: {0}"	TokenNameStringLiteral	???????? ???????? ''name'' ? xsl:processing-instruction ?????? ???? ?????????? ?????? NCName: {0}
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
,	TokenNameCOMMA	
" [-E (?? ????????????? ?????? ?? ??????? entity)]"	TokenNameStringLiteral	 [-E (?? ????????????? ?????? ?? ??????? entity)]
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
...
,	TokenNameCOMMA	
" [-ESCAPE (???????, ????????? Esc-??????????????????? {?? ????????? - <>&"'\r\n}]"	TokenNameStringLiteral	 [-ESCAPE (???????, ????????? Esc-??????????????????? {?? ????????? - <>&"'\r\n}]
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
...
,	TokenNameCOMMA	
" [-URIRESOLVER ??? ?????? (URIResolver ??? ?????????????? URL)]"	TokenNameStringLiteral	 [-URIRESOLVER ??? ?????? (URIResolver ??? ?????????????? URL)]
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
...
,	TokenNameCOMMA	
" [-FLAVOR ???-?????????????? (???? ??????? s2s=SAX ??? d2d=DOM.)] "	TokenNameStringLiteral	 [-FLAVOR ???-?????????????? (???? ??????? s2s=SAX ??? d2d=DOM.)] 
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
,	TokenNameCOMMA	
" [-INCREMENTAL (????????? ??????????? ?????? DTM ? ??????? ???????? http://xml.apache.org/xalan/features/incremental true.)]"	TokenNameStringLiteral	 [-INCREMENTAL (????????? ??????????? ?????? DTM ? ??????? ???????? http://xml.apache.org/xalan/features/incremental true.)]
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
...
,	TokenNameCOMMA	
" [-XJ ????-jar (??????????? ?????? ????????? ?????????????? ? <????-jar>)]"	TokenNameStringLiteral	 [-XJ ????-jar (??????????? ?????? ????????? ?????????????? ? <????-jar>)]
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
"optionXP"	TokenNameStringLiteral	optionXP
,	TokenNameCOMMA	
" [-XP ????? (??????? ????? ?????? ??? ???? ????????? ??????? translet)]"	TokenNameStringLiteral	 [-XP ????? (??????? ????? ?????? ??? ???? ????????? ??????? translet)]
}	TokenNameRBRACE	
,	TokenNameCOMMA	
