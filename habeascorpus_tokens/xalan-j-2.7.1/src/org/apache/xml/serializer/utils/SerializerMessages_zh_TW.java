...
/* * $Id: SerializerMessages_zh_TW.java 471981 2006-11-07 04:28:00Z minchau $ */	TokenNameCOMMENT_BLOCK	 $Id: SerializerMessages_zh_TW.java 471981 2006-11-07 04:28:00Z minchau $ 
...
SerializerMessages_zh_TW	TokenNameIdentifier	 Serializer Messages zh  TW
...
,	TokenNameCOMMA	
"Serializer ?? ''{0}'' ??? org.xml.sax.ContentHandler?"	TokenNameStringLiteral	Serializer ?? ''{0}'' ??? org.xml.sax.ContentHandler?
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
MsgKey	TokenNameIdentifier	 Msg Key
...
,	TokenNameCOMMA	
"???????? ''{1}''??? CLASSPATH????? ''{0}''"	TokenNameStringLiteral	???????? ''{1}''??? CLASSPATH????? ''{0}''
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
MsgKey	TokenNameIdentifier	 Msg Key
...
,	TokenNameCOMMA	
"???? conformant?"	TokenNameStringLiteral	???? conformant?
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
MsgKey	TokenNameIdentifier	 Msg Key
...
,	TokenNameCOMMA	
"??? SerializerFactory ? Properties ???? ''{0}'' ???"	TokenNameStringLiteral	??? SerializerFactory ? Properties ???? ''{0}'' ???
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
MsgKey	TokenNameIdentifier	 Msg Key
...
,	TokenNameCOMMA	
"??????????????????Well-formed ????? true?????????????"	TokenNameStringLiteral	??????????????????Well-formed ????? true?????????????
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
MsgKey	TokenNameIdentifier	 Msg Key
...
,	TokenNameCOMMA	
"????? instructiondata ?????? XML ?? (Unicode: 0x{0})?"	TokenNameStringLiteral	????? instructiondata ?????? XML ?? (Unicode: 0x{0})?
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
MsgKey	TokenNameIdentifier	 Msg Key
...
,	TokenNameCOMMA	
"? CDATASection ????????? XML ?? (Unicode: 0x{0})?"	TokenNameStringLiteral	? CDATASection ????????? XML ?? (Unicode: 0x{0})?
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
MsgKey	TokenNameIdentifier	 Msg Key
...
,	TokenNameCOMMA	
"??? ''{1}'' ? ''{0}'' ?????? XML ???"	TokenNameStringLiteral	??? ''{1}'' ? ''{0}'' ?????? XML ???
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
MsgKey	TokenNameIdentifier	 Msg Key
...
,	TokenNameCOMMA	
"???? "{0}" ???????????????? "{2}" ????? "{1}"?"	TokenNameStringLiteral	???? "{0}" ???????????????? "{2}" ????? "{1}"?
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
MsgKey	TokenNameIdentifier	 Msg Key
