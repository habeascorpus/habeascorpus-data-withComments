...
/* * $Id: ErrorMessages_de.java 468652 2006-10-28 07:05:17Z minchau $ */	TokenNameCOMMENT_BLOCK	 $Id: ErrorMessages_de.java 468652 2006-10-28 07:05:17Z minchau $ 
...
,	TokenNameCOMMA	
"Interner Fehler bei der Ausführung in ''{0}''"	TokenNameStringLiteral	Interner Fehler bei der Ausführung in ''{0}''
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
,	TokenNameCOMMA	
"Fehler bei der Ausführung von <xsl:copy>."	TokenNameStringLiteral	Fehler bei der Ausführung von <xsl:copy>.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
,	TokenNameCOMMA	
"Ungültige Konvertierung von ''{0}'' in ''{1}''."	TokenNameStringLiteral	Ungültige Konvertierung von ''{0}'' in ''{1}''.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
,	TokenNameCOMMA	
"Die externe Funktion ''{0}'' wird nicht von XSLTC unterstützt."	TokenNameStringLiteral	Die externe Funktion ''{0}'' wird nicht von XSLTC unterstützt.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
,	TokenNameCOMMA	
"Unbekannter Argumenttyp in Gleichheitsausdruck."	TokenNameStringLiteral	Unbekannter Argumenttyp in Gleichheitsausdruck.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
,	TokenNameCOMMA	
"Ungültiger Argumenttyp ''{0}'' in Aufruf von ''{1}''"	TokenNameStringLiteral	Ungültiger Argumenttyp ''{0}'' in Aufruf von ''{1}''
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
,	TokenNameCOMMA	
"Es wird versucht, Nummer ''{0}'' mit Muster ''{1}'' zu formatieren."	TokenNameStringLiteral	Es wird versucht, Nummer ''{0}'' mit Muster ''{1}'' zu formatieren.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
,	TokenNameCOMMA	
"Iterator ''{0}'' kann nicht geklont werden."	TokenNameStringLiteral	Iterator ''{0}'' kann nicht geklont werden.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
,	TokenNameCOMMA	
"Iterator für Achse ''{0}'' wird nicht unterstützt."	TokenNameStringLiteral	Iterator für Achse ''{0}'' wird nicht unterstützt.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
/* * Note to translators: The following represents an internal error * situation in XSLTC. The processor attempted to create an iterator * for a particular axis (see definition above) that it does not * support. */	TokenNameCOMMENT_BLOCK	 Note to translators: The following represents an internal error situation in XSLTC. The processor attempted to create an iterator for a particular axis (see definition above) that it does not support. 
{	TokenNameLBRACE	
...
,	TokenNameCOMMA	
"Iterator für Achse ''{0}'' mit Typangabe wird nicht unterstützt."	TokenNameStringLiteral	Iterator für Achse ''{0}'' mit Typangabe wird nicht unterstützt.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
,	TokenNameCOMMA	
"Namensbereichdeklaration ''{0}''=''{1}'' befindet sich nicht in einem Element."	TokenNameStringLiteral	Namensbereichdeklaration ''{0}''=''{1}'' befindet sich nicht in einem Element.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
,	TokenNameCOMMA	
"Der Namensbereich für Präfix ''{0}'' wurde nicht deklariert."	TokenNameStringLiteral	Der Namensbereich für Präfix ''{0}'' wurde nicht deklariert.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
,	TokenNameCOMMA	
"DOMAdapter wurde mit dem falschen Typ für das Dokumentobjektmodell der Quelle erstellt."	TokenNameStringLiteral	DOMAdapter wurde mit dem falschen Typ für das Dokumentobjektmodell der Quelle erstellt.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
,	TokenNameCOMMA	
"Der von Ihnen verwendete SAX-Parser bearbeitet keine DTD-Deklarationsereignisse."	TokenNameStringLiteral	Der von Ihnen verwendete SAX-Parser bearbeitet keine DTD-Deklarationsereignisse.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
,	TokenNameCOMMA	
"Der von Ihnen verwendete SAX-Parser unterstützt keine XML-Namensbereiche."	TokenNameStringLiteral	Der von Ihnen verwendete SAX-Parser unterstützt keine XML-Namensbereiche.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
,	TokenNameCOMMA	
"Der URI-Verweis ''{0}'' konnte nicht aufgelöst werden."	TokenNameStringLiteral	Der URI-Verweis ''{0}'' konnte nicht aufgelöst werden.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
,	TokenNameCOMMA	
"Das angegebene Translet ''{0}'' wurde mit einer neueren XSLTC-Version erstellt als die verwendete Version der XSLTC-Laufzeitsoftware. Sie müssen die Formatvorlage erneut kompilieren oder eine neuere XSLTC-Version zum Ausführen dieses Translets verwenden."	TokenNameStringLiteral	Das angegebene Translet ''{0}'' wurde mit einer neueren XSLTC-Version erstellt als die verwendete Version der XSLTC-Laufzeitsoftware. Sie müssen die Formatvorlage erneut kompilieren oder eine neuere XSLTC-Version zum Ausführen dieses Translets verwenden.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
,	TokenNameCOMMA	
"Ein Attribut, dessen Wert ein QName sein muss, hatte den Wert ''{0}''."	TokenNameStringLiteral	Ein Attribut, dessen Wert ein QName sein muss, hatte den Wert ''{0}''.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
,	TokenNameCOMMA	
"Die Verwendung des Erweiterungselements ''{0}'' ist nicht zulässig, wenn für die Funktion zur sicheren Verarbeitung der Wert ''true'' festgelegt wurde."	TokenNameStringLiteral	Die Verwendung des Erweiterungselements ''{0}'' ist nicht zulässig, wenn für die Funktion zur sicheren Verarbeitung der Wert ''true'' festgelegt wurde.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
}	TokenNameRBRACE	
;	TokenNameSEMICOLON	
