...
;	TokenNameSEMICOLON	
/** Test BooleanQuery2 against BooleanQuery by overriding the standard query parser. * This also tests the scoring order of BooleanQuery. */	TokenNameCOMMENT_JAVADOC	 Test BooleanQuery2 against BooleanQuery by overriding the standard query parser. This also tests the scoring order of BooleanQuery. 
...
static	TokenNamestatic	
IndexSearcher	TokenNameIdentifier	 Index Searcher
bigSearcher	TokenNameIdentifier	 big Searcher
;	TokenNameSEMICOLON	
private	TokenNameprivate	
static	TokenNamestatic	
IndexReader	TokenNameIdentifier	 Index Reader
...
static	TokenNamestatic	
IndexReader	TokenNameIdentifier	 Index Reader
littleReader	TokenNameIdentifier	 little Reader
;	TokenNameSEMICOLON	
private	TokenNameprivate	
static	TokenNamestatic	
int	TokenNameint	
NUM_EXTRA_DOCS	TokenNameIdentifier	 NUM  EXTRA  DOCS
=	TokenNameEQUAL	
...
static	TokenNamestatic	
int	TokenNameint	
mulFactor	TokenNameIdentifier	 mul Factor
;	TokenNameSEMICOLON	
@	TokenNameAT	
BeforeClass	TokenNameIdentifier	 Before Class
public	TokenNamepublic	
...
;	TokenNameSEMICOLON	
// Make big index 	TokenNameCOMMENT_LINE	Make big index 
dir2	TokenNameIdentifier	 dir2
=	TokenNameEQUAL	
new	TokenNamenew	
MockDirectoryWrapper	TokenNameIdentifier	 Mock Directory Wrapper
...
;	TokenNameSEMICOLON	
// First multiply small test index: 	TokenNameCOMMENT_LINE	First multiply small test index: 
mulFactor	TokenNameIdentifier	 mul Factor
=	TokenNameEQUAL	
...
"field2"	TokenNameStringLiteral	field2
,	TokenNameCOMMA	
"big bad bug"	TokenNameStringLiteral	big bad bug
,	TokenNameCOMMA	
Field	TokenNameIdentifier	 Field
.	TokenNameDOT	
Store	TokenNameIdentifier	 Store
...
public	TokenNamepublic	
void	TokenNamevoid	
queriesTest	TokenNameIdentifier	 queries Test
(	TokenNameLPAREN	
String	TokenNameIdentifier	 String
queryText	TokenNameIdentifier	 query Text
,	TokenNameCOMMA	
...
//System.out.println("Query: " + queryText); 	TokenNameCOMMENT_LINE	System.out.println("Query: " + queryText); 
Query	TokenNameIdentifier	 Query
query	TokenNameIdentifier	 query
=	TokenNameEQUAL	
makeQuery	TokenNameIdentifier	 make Query
...
public	TokenNamepublic	
void	TokenNamevoid	
testQueries01	TokenNameIdentifier	 test Queries01
(	TokenNameLPAREN	
)	TokenNameRPAREN	
throws	TokenNamethrows	
Exception	TokenNameIdentifier	 Exception
...
queryText	TokenNameIdentifier	 query Text
=	TokenNameEQUAL	
"+w3 +xx"	TokenNameStringLiteral	+w3 +xx
;	TokenNameSEMICOLON	
int	TokenNameint	
[	TokenNameLBRACKET	
]	TokenNameRBRACKET	
...
public	TokenNamepublic	
void	TokenNamevoid	
testQueries02	TokenNameIdentifier	 test Queries02
(	TokenNameLPAREN	
)	TokenNameRPAREN	
throws	TokenNamethrows	
Exception	TokenNameIdentifier	 Exception
...
public	TokenNamepublic	
void	TokenNamevoid	
testQueries03	TokenNameIdentifier	 test Queries03
(	TokenNameLPAREN	
)	TokenNameRPAREN	
throws	TokenNamethrows	
Exception	TokenNameIdentifier	 Exception
...
public	TokenNamepublic	
void	TokenNamevoid	
testQueries04	TokenNameIdentifier	 test Queries04
(	TokenNameLPAREN	
)	TokenNameRPAREN	
throws	TokenNamethrows	
Exception	TokenNameIdentifier	 Exception
...
public	TokenNamepublic	
void	TokenNamevoid	
testQueries05	TokenNameIdentifier	 test Queries05
(	TokenNameLPAREN	
)	TokenNameRPAREN	
throws	TokenNamethrows	
Exception	TokenNameIdentifier	 Exception
...
public	TokenNamepublic	
void	TokenNamevoid	
testQueries06	TokenNameIdentifier	 test Queries06
(	TokenNameLPAREN	
)	TokenNameRPAREN	
throws	TokenNamethrows	
Exception	TokenNameIdentifier	 Exception
...
queryText	TokenNameIdentifier	 query Text
=	TokenNameEQUAL	
"+w3 -xx -w5"	TokenNameStringLiteral	+w3 -xx -w5
;	TokenNameSEMICOLON	
int	TokenNameint	
[	TokenNameLBRACKET	
]	TokenNameRBRACKET	
...
public	TokenNamepublic	
void	TokenNamevoid	
testQueries07	TokenNameIdentifier	 test Queries07
(	TokenNameLPAREN	
)	TokenNameRPAREN	
throws	TokenNamethrows	
Exception	TokenNameIdentifier	 Exception
...
public	TokenNamepublic	
void	TokenNamevoid	
testQueries08	TokenNameIdentifier	 test Queries08
(	TokenNameLPAREN	
)	TokenNameRPAREN	
throws	TokenNamethrows	
Exception	TokenNameIdentifier	 Exception
...
public	TokenNamepublic	
void	TokenNamevoid	
testQueries09	TokenNameIdentifier	 test Queries09
(	TokenNameLPAREN	
)	TokenNameRPAREN	
throws	TokenNamethrows	
Exception	TokenNameIdentifier	 Exception
...
queryText	TokenNameIdentifier	 query Text
=	TokenNameEQUAL	
"+w3 +xx +w2 zz"	TokenNameStringLiteral	+w3 +xx +w2 zz
;	TokenNameSEMICOLON	
int	TokenNameint	
[	TokenNameLBRACKET	
]	TokenNameRBRACKET	
...
public	TokenNamepublic	
void	TokenNamevoid	
testQueries10	TokenNameIdentifier	 test Queries10
(	TokenNameLPAREN	
)	TokenNameRPAREN	
throws	TokenNamethrows	
Exception	TokenNameIdentifier	 Exception
...
oldSimilarity	TokenNameIdentifier	 old Similarity
=	TokenNameEQUAL	
searcher	TokenNameIdentifier	 searcher
.	TokenNameDOT	
...
// die serialization, die 	TokenNameCOMMENT_LINE	die serialization, die 
static	TokenNamestatic	
class	TokenNameclass	
FunkySimilarity	TokenNameIdentifier	 Funky Similarity
extends	TokenNameextends	
DefaultSimilarity	TokenNameIdentifier	 Default Similarity
{	TokenNameLBRACE	
@	TokenNameAT	
...
;	TokenNameSEMICOLON	
// Can't sort by relevance since floating point numbers may not quite 	TokenNameCOMMENT_LINE	Can't sort by relevance since floating point numbers may not quite 
// match up. 	TokenNameCOMMENT_LINE	match up. 
...
final	TokenNamefinal	
Similarity	TokenNameIdentifier	 Similarity
oldSim	TokenNameIdentifier	 old Sim
=	TokenNameEQUAL	
searcher	TokenNameIdentifier	 searcher
.	TokenNameDOT	
getSimilarity	TokenNameIdentifier	 get Similarity
...
;	TokenNameSEMICOLON	
TopDocs	TokenNameIdentifier	 Top Docs
hits4	TokenNameIdentifier	 hits4
=	TokenNameEQUAL	
bigSearcher	TokenNameIdentifier	 big Searcher
.	TokenNameDOT	
search	TokenNameIdentifier	 search
...
{	TokenNameLBRACE	
// For easier debugging 	TokenNameCOMMENT_LINE	For easier debugging 
...
(	TokenNameLPAREN	
"failed query: "	TokenNameStringLiteral	failed query: 
+	TokenNamePLUS	
q1	TokenNameIdentifier	 q1
)	TokenNameRPAREN	
;	TokenNameSEMICOLON	
...
// used to set properties or change every BooleanQuery 	TokenNameCOMMENT_LINE	used to set properties or change every BooleanQuery 
// generated from randBoolQuery. 	TokenNameCOMMENT_LINE	generated from randBoolQuery. 
public	TokenNamepublic	
static	TokenNamestatic	
...
// Random rnd is passed in so that the exact same random query may be created 	TokenNameCOMMENT_LINE	Random rnd is passed in so that the exact same random query may be created 
...
allowMust	TokenNameIdentifier	 allow Must
,	TokenNameCOMMA	
int	TokenNameint	
level	TokenNameIdentifier	 level
,	TokenNameCOMMA	
...
{	TokenNameLBRACE	
int	TokenNameint	
qType	TokenNameIdentifier	 q Type
=	TokenNameEQUAL	
0	TokenNameIntegerLiteral	
;	TokenNameSEMICOLON	
// term query 	TokenNameCOMMENT_LINE	term query 
if	TokenNameif	
(	TokenNameLPAREN	
level	TokenNameIdentifier	 level
>	TokenNameGREATER	
