...
,	TokenNameCOMMA	
"W jednym pliku zdefiniowano wi?cej ni? jeden arkusz styl—w."	TokenNameStringLiteral	W jednym pliku zdefiniowano wi?cej ni? jeden arkusz styl—w.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
,	TokenNameCOMMA	
"Szablon ''{0}'' zosta? ju? zdefiniowany w tym arkuszu styl—w."	TokenNameStringLiteral	Szablon ''{0}'' zosta? ju? zdefiniowany w tym arkuszu styl—w.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
,	TokenNameCOMMA	
"Szablon ''{0}'' nie zosta? zdefiniowany w tym arkuszu styl—w."	TokenNameStringLiteral	Szablon ''{0}'' nie zosta? zdefiniowany w tym arkuszu styl—w.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
,	TokenNameCOMMA	
"Cykliczny import/include. Arkusz styl—w ''{0}'' zosta? ju? za?adowany."	TokenNameStringLiteral	Cykliczny import/include. Arkusz styl—w ''{0}'' zosta? ju? za?adowany.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
,	TokenNameCOMMA	
"Nie mo?na posortowa? fragment—w drzewa rezultat—w (elementy <xsl:sort> s? ignorowane). Trzeba sortowa? w?z?y podczas tworzenia drzewa rezultat—w."	TokenNameStringLiteral	Nie mo?na posortowa? fragment—w drzewa rezultat—w (elementy <xsl:sort> s? ignorowane). Trzeba sortowa? w?z?y podczas tworzenia drzewa rezultat—w.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
,	TokenNameCOMMA	
"Drugim argumentem funkcji document() musi by? zbi—r w?z?—w."	TokenNameStringLiteral	Drugim argumentem funkcji document() musi by? zbi—r w?z?—w.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
,	TokenNameCOMMA	
"Dokument wej?ciowy nie jest arkuszem styl—w (przestrze? nazw XSL nie zosta?a zadeklarowana w elemencie g?—wnym)."	TokenNameStringLiteral	Dokument wej?ciowy nie jest arkuszem styl—w (przestrze? nazw XSL nie zosta?a zadeklarowana w elemencie g?—wnym).
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
,	TokenNameCOMMA	
"Nie mo?na znale?? elementu docelowego ''{0}'' arkusza styl—w."	TokenNameStringLiteral	Nie mo?na znale?? elementu docelowego ''{0}'' arkusza styl—w.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
,	TokenNameCOMMA	
"Dokument wej?ciowy nie zawiera arkusza styl—w XSL."	TokenNameStringLiteral	Dokument wej?ciowy nie zawiera arkusza styl—w XSL.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
,	TokenNameCOMMA	
"Pr—ba u?ycia nieistniej?cego zbioru atrybut—w ''{0}''."	TokenNameStringLiteral	Pr—ba u?ycia nieistniej?cego zbioru atrybut—w ''{0}''.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
,	TokenNameCOMMA	
"Pr—ba ustawienia obiektu ErrorListener klasy ''{0}'' na warto?? null"	TokenNameStringLiteral	Pr—ba ustawienia obiektu ErrorListener klasy ''{0}'' na warto?? null
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
,	TokenNameCOMMA	
"Nie mo?na skompilowa? arkusza styl—w."	TokenNameStringLiteral	Nie mo?na skompilowa? arkusza styl—w.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
,	TokenNameCOMMA	
"Nie zdefiniowano procedury obs?ugi wyj?cia rezultat—w transformacji."	TokenNameStringLiteral	Nie zdefiniowano procedury obs?ugi wyj?cia rezultat—w transformacji.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
,	TokenNameCOMMA	
"Pr—ba dost?pu do niepoprawnej w?a?ciwo?ci interfejsu Transformer ''{0}''."	TokenNameStringLiteral	Pr—ba dost?pu do niepoprawnej w?a?ciwo?ci interfejsu Transformer ''{0}''.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
,	TokenNameCOMMA	
"SK?ADNIA java org.apache.xalan.xsltc.cmdline.Compile [-o <wyj?cie>] [-d <katalog>] [-j <plik_jar>] [-p <pakiet>] [-n] [-x] [-u] [-v] [-h] { <arkusz_styl—w> | -i } OPCJE -o <wyj?cie> przypisanie nazwy <wyj?cie> do wygenerowanego transletu. Domy?lnie nazwa transletu pochodzi od nazwy <arkusza_styl—w>. Opcja ta jest ignorowana w przypadku kompilowania wielu arkuszy styl—w. -d <katalog> Okre?lenie katalogu docelowego transletu. -j <plik_jar> Pakowanie klas transletu do pliku jar o nazwie okre?lonej jako <plik_jar>. -p <pakiet> Okre?lenie przedrostka nazwy pakietu dla wszystkich wygenerowanych klas translet—w. -n W??czenie wstawiania szablon—w (zachowanie domy?lne zwykle lepsze). -x W??czenie wypisywania dodatkowych komunikat—w debugowania. -u Interpretowanie argument—w <arkusz_styl—w> jako adres—w URL. -i Wymuszenie odczytywania przez kompilator arkusza styl—w ze standardowego wej?cia (stdin). -v Wypisanie wersji kompilatora. -h Wypisanie informacji o sk?adni. "	TokenNameStringLiteral	SK?ADNIA java org.apache.xalan.xsltc.cmdline.Compile [-o <wyj?cie>] [-d <katalog>] [-j <plik_jar>] [-p <pakiet>] [-n] [-x] [-u] [-v] [-h] { <arkusz_styl—w> | -i } OPCJE -o <wyj?cie> przypisanie nazwy <wyj?cie> do wygenerowanego transletu. Domy?lnie nazwa transletu pochodzi od nazwy <arkusza_styl—w>. Opcja ta jest ignorowana w przypadku kompilowania wielu arkuszy styl—w. -d <katalog> Okre?lenie katalogu docelowego transletu. -j <plik_jar> Pakowanie klas transletu do pliku jar o nazwie okre?lonej jako <plik_jar>. -p <pakiet> Okre?lenie przedrostka nazwy pakietu dla wszystkich wygenerowanych klas translet—w. -n W??czenie wstawiania szablon—w (zachowanie domy?lne zwykle lepsze). -x W??czenie wypisywania dodatkowych komunikat—w debugowania. -u Interpretowanie argument—w <arkusz_styl—w> jako adres—w URL. -i Wymuszenie odczytywania przez kompilator arkusza styl—w ze standardowego wej?cia (stdin). -v Wypisanie wersji kompilatora. -h Wypisanie informacji o sk?adni. 
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
,	TokenNameCOMMA	
"Nazwy ''{0}'' nie mo?na u?y? jako nazwy klasy transletu, poniewa? zawiera ona znaki, kt—re s? niedozwolone w nazwach klas j?zyka Java. Zamiast niej u?yto nazwy ''{1}''."	TokenNameStringLiteral	Nazwy ''{0}'' nie mo?na u?y? jako nazwy klasy transletu, poniewa? zawiera ona znaki, kt—re s? niedozwolone w nazwach klas j?zyka Java. Zamiast niej u?yto nazwy ''{1}''.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
,	TokenNameCOMMA	
"Atrybut, kt—rego warto?ci? musi by? nazwa QName lub lista rozdzielonych odst?pami nazw QName, mia? warto?? ''{0}''"	TokenNameStringLiteral	Atrybut, kt—rego warto?ci? musi by? nazwa QName lub lista rozdzielonych odst?pami nazw QName, mia? warto?? ''{0}''
}	TokenNameRBRACE	
,	TokenNameCOMMA	
