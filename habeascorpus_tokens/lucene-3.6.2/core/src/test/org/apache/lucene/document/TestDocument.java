...
;	TokenNameSEMICOLON	
// add an 'ok' document 	TokenNameCOMMENT_LINE	add an 'ok' document 
try	TokenNametry	
{	TokenNameLBRACE	
doc	TokenNameIdentifier	 doc
=	TokenNameEQUAL	
...
;	TokenNameSEMICOLON	
// try to boost with norms omitted 	TokenNameCOMMENT_LINE	try to boost with norms omitted 
Field	TokenNameIdentifier	 Field
field	TokenNameIdentifier	 field
=	TokenNameEQUAL	
new	TokenNamenew	
...
fail	TokenNameIdentifier	 fail
(	TokenNameLPAREN	
"didn't get any exception, boost silently discarded"	TokenNameStringLiteral	didn't get any exception, boost silently discarded
)	TokenNameRPAREN	
;	TokenNameSEMICOLON	
}	TokenNameRBRACE	
catch	TokenNamecatch	
