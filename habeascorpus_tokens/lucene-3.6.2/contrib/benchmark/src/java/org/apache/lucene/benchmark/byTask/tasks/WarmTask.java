...
;	TokenNameSEMICOLON	
/** * Warm reader task: retrieve all reader documents. * * <p>Note: This task reuses the reader if it is already open. * Otherwise a reader is opened at start and closed at the end. * </p> * * <p>Other side effects: counts additional 1 (record) for each * retrieved (non null) document.</p> */	TokenNameCOMMENT_JAVADOC	 Warm reader task: retrieve all reader documents. * <p>Note: This task reuses the reader if it is already open. Otherwise a reader is opened at start and closed at the end. </p> * <p>Other side effects: counts additional 1 (record) for each retrieved (non null) document.</p> 
public	TokenNamepublic	
class	TokenNameclass	
WarmTask	TokenNameIdentifier	 Warm Task
...
null	TokenNamenull	
;	TokenNameSEMICOLON	
// not required for this task. 	TokenNameCOMMENT_LINE	not required for this task. 
}	TokenNameRBRACE	
}	TokenNameRBRACE	
