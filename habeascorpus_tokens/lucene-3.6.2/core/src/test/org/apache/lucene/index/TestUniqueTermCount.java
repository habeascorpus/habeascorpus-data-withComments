...
;	TokenNameSEMICOLON	
/** * Tests the uniqueTermCount statistic in FieldInvertState */	TokenNameCOMMENT_JAVADOC	 Tests the uniqueTermCount statistic in FieldInvertState 
...
;	TokenNameSEMICOLON	
/* expected uniqueTermCount values for our documents */	TokenNameCOMMENT_BLOCK	 expected uniqueTermCount values for our documents 
ArrayList	TokenNameIdentifier	 Array List
<	TokenNameLESS	
...
/** * Makes a bunch of single-char tokens (the max # unique terms will at most be 26). * puts the # unique terms into expected, to be checked against the norm. */	TokenNameCOMMENT_JAVADOC	 Makes a bunch of single-char tokens (the max # unique terms will at most be 26). puts the # unique terms into expected, to be checked against the norm. 
