...
;	TokenNameSEMICOLON	
/** * Bridge class for a star element. * * @author <a href="mailto:thomas.deweese@kodak.com">Thomas Deweese</a> * @version $Id: BatikStarElementBridge.java 501922 2007-01-31 17:47:47Z dvholten $ */	TokenNameCOMMENT_JAVADOC	 Bridge class for a star element. * @author <a href="mailto:thomas.deweese@kodak.com">Thomas Deweese</a> @version $Id: BatikStarElementBridge.java 501922 2007-01-31 17:47:47Z dvholten $ 
...
/** * Constructs a star polygone according to the specified parameters. * * @param ctx the bridge context to use * @param e the element that describes a rect element * @param shapeNode the shape node to initialize */	TokenNameCOMMENT_JAVADOC	 Constructs a star polygone according to the specified parameters. * @param ctx the bridge context to use @param e the element that describes a rect element @param shapeNode the shape node to initialize 
...
;	TokenNameSEMICOLON	
// 'ir' attribute - required 	TokenNameCOMMENT_LINE	'ir' attribute - required 
s	TokenNameIdentifier	 s
=	TokenNameEQUAL	
e	TokenNameIdentifier	 e
.	TokenNameDOT	
...
null	TokenNamenull	
,	TokenNameCOMMA	
BATIK_EXT_IR_ATTRIBUTE	TokenNameIdentifier	 BATIK  EXT  IR  ATTRIBUTE
)	TokenNameRPAREN	
;	TokenNameSEMICOLON	
float	TokenNamefloat	
...
final	TokenNamefinal	
double	TokenNamedouble	
HALF_PI	TokenNameIdentifier	 HALF  PI
=	TokenNameEQUAL	
Math	TokenNameIdentifier	 Math
.	TokenNameDOT	
PI	TokenNameIdentifier	 PI
