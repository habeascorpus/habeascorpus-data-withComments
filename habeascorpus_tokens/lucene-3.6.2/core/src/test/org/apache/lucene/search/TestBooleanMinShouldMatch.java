...
{	TokenNameLBRACE	
// also add a random negation 	TokenNameCOMMENT_LINE	also add a random negation 
Term	TokenNameIdentifier	 Term
...
assertSubsetOfSameScores	TokenNameIdentifier	 assert Subset Of Same Scores
(	TokenNameLPAREN	
q2	TokenNameIdentifier	 q2
,	TokenNameCOMMA	
top1	TokenNameIdentifier	 top1
...
// should be a subset to the unconstrained query. 	TokenNameCOMMENT_LINE	should be a subset to the unconstrained query. 
if	TokenNameif	
(	TokenNameLPAREN	
top2	TokenNameIdentifier	 top2
.	TokenNameDOT	
...
public	TokenNamepublic	
void	TokenNamevoid	
testRewriteCoord1	TokenNameIdentifier	 test Rewrite Coord1
(	TokenNameLPAREN	
)	TokenNameRPAREN	
throws	TokenNamethrows	
Exception	TokenNameIdentifier	 Exception
...
public	TokenNamepublic	
void	TokenNamevoid	
testRewriteNegate	TokenNameIdentifier	 test Rewrite Negate
(	TokenNameLPAREN	
)	TokenNameRPAREN	
throws	TokenNamethrows	
Exception	TokenNameIdentifier	 Exception
