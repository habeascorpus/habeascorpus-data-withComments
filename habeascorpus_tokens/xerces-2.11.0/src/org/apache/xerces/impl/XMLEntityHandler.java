...
;	TokenNameSEMICOLON	
/** * The entity handler interface defines methods to report information * about the start and end of entities. * * @xerces.internal * * @see org.apache.xerces.impl.XMLEntityScanner * * @author Andy Clark, IBM * * @version $Id: XMLEntityHandler.java 446761 2006-09-15 21:59:29Z mrglavas $ */	TokenNameCOMMENT_JAVADOC	 The entity handler interface defines methods to report information about the start and end of entities. * @xerces.internal * @see org.apache.xerces.impl.XMLEntityScanner * @author Andy Clark, IBM * @version $Id: XMLEntityHandler.java 446761 2006-09-15 21:59:29Z mrglavas $ 
...
// interface XMLEntityHandler 	TokenNameCOMMENT_LINE	interface XMLEntityHandler 
