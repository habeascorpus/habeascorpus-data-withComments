...
;	TokenNameSEMICOLON	
/** * This class provides a manager for the 'shape-rendering' property values. * * @author <a href="mailto:stephane@hillion.org">Stephane Hillion</a> * @version $Id: ShapeRenderingManager.java 478283 2006-11-22 18:53:40Z dvholten $ */	TokenNameCOMMENT_JAVADOC	 This class provides a manager for the 'shape-rendering' property values. * @author <a href="mailto:stephane@hillion.org">Stephane Hillion</a> @version $Id: ShapeRenderingManager.java 478283 2006-11-22 18:53:40Z dvholten $ 
public	TokenNamepublic	
class	TokenNameclass	
ShapeRenderingManager	TokenNameIdentifier	 Shape Rendering Manager
...
CSSConstants	TokenNameIdentifier	 CSS Constants
.	TokenNameDOT	
CSS_CRISPEDGES_VALUE	TokenNameIdentifier	 CSS  CRISPEDGES  VALUE
,	TokenNameCOMMA	
SVGValueConstants	TokenNameIdentifier	 SVG Value Constants
.	TokenNameDOT	
CRISPEDGES_VALUE	TokenNameIdentifier	 CRISPEDGES  VALUE
)	TokenNameRPAREN	
;	TokenNameSEMICOLON	
values	TokenNameIdentifier	 values
.	TokenNameDOT	
...
CSSConstants	TokenNameIdentifier	 CSS Constants
.	TokenNameDOT	
CSS_GEOMETRICPRECISION_VALUE	TokenNameIdentifier	 CSS  GEOMETRICPRECISION  VALUE
,	TokenNameCOMMA	
SVGValueConstants	TokenNameIdentifier	 SVG Value Constants
.	TokenNameDOT	
GEOMETRICPRECISION_VALUE	TokenNameIdentifier	 GEOMETRICPRECISION  VALUE
)	TokenNameRPAREN	
;	TokenNameSEMICOLON	
values	TokenNameIdentifier	 values
.	TokenNameDOT	
...
CSSConstants	TokenNameIdentifier	 CSS Constants
.	TokenNameDOT	
CSS_OPTIMIZESPEED_VALUE	TokenNameIdentifier	 CSS  OPTIMIZESPEED  VALUE
,	TokenNameCOMMA	
SVGValueConstants	TokenNameIdentifier	 SVG Value Constants
.	TokenNameDOT	
OPTIMIZESPEED_VALUE	TokenNameIdentifier	 OPTIMIZESPEED  VALUE
)	TokenNameRPAREN	
;	TokenNameSEMICOLON	
}	TokenNameRBRACE	
