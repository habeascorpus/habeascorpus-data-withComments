...
;	TokenNameSEMICOLON	
/** * The <code>XSObjectList</code> interface provides the abstraction of an * immutable ordered collection of <code>XSObject</code>s, without defining * or constraining how this collection is implemented. */	TokenNameCOMMENT_JAVADOC	 The <code>XSObjectList</code> interface provides the abstraction of an immutable ordered collection of <code>XSObject</code>s, without defining or constraining how this collection is implemented. 
...
List	TokenNameIdentifier	 List
{	TokenNameLBRACE	
/** * The number of <code>XSObjects</code> in the list. The range of valid * child object indices is 0 to <code>length-1</code> inclusive. */	TokenNameCOMMENT_JAVADOC	 The number of <code>XSObjects</code> in the list. The range of valid child object indices is 0 to <code>length-1</code> inclusive. 
public	TokenNamepublic	
int	TokenNameint	
