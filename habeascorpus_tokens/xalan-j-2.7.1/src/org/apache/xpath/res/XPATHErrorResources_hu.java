...
/* * $Id: XPATHErrorResources_hu.java 468655 2006-10-28 07:12:06Z minchau $ */	TokenNameCOMMENT_BLOCK	 $Id: XPATHErrorResources_hu.java 468655 2006-10-28 07:12:06Z minchau $ 
...
XPATHErrorResources_hu	TokenNameIdentifier	 XPATH Error Resources hu
...
ER_CURRENT_NOT_ALLOWED_IN_MATCH	TokenNameIdentifier	 ER  CURRENT  NOT  ALLOWED  IN  MATCH
,	TokenNameCOMMA	
"A current() függvény nem megengedett az illesztési mintában!"	TokenNameStringLiteral	A current() függvény nem megengedett az illesztési mintában!
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_CURRENT_TAKES_NO_ARGS	TokenNameIdentifier	 ER  CURRENT  TAKES  NO  ARGS
,	TokenNameCOMMA	
"A current() függvény nem fogad el argumentumokat!"	TokenNameStringLiteral	A current() függvény nem fogad el argumentumokat!
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_DOCUMENT_REPLACED	TokenNameIdentifier	 ER  DOCUMENT  REPLACED
,	TokenNameCOMMA	
"A document() függvény megvalósítását lecserélte az org.apache.xalan.xslt.FuncDocument!"	TokenNameStringLiteral	A document() függvény megvalósítását lecserélte az org.apache.xalan.xslt.FuncDocument!
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_CONTEXT_HAS_NO_OWNERDOC	TokenNameIdentifier	 ER  CONTEXT  HAS  NO  OWNERDOC
...
ER_LOCALNAME_HAS_TOO_MANY_ARGS	TokenNameIdentifier	 ER  LOCALNAME  HAS  TOO  MANY  ARGS
,	TokenNameCOMMA	
"A local-name()-nek túl sok argumentuma van."	TokenNameStringLiteral	A local-name()-nek túl sok argumentuma van.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_NAMESPACEURI_HAS_TOO_MANY_ARGS	TokenNameIdentifier	 ER  NAMESPACEURI  HAS  TOO  MANY  ARGS
,	TokenNameCOMMA	
"A namespace-uri()-nek túl sok argumentuma van."	TokenNameStringLiteral	A namespace-uri()-nek túl sok argumentuma van.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_NORMALIZESPACE_HAS_TOO_MANY_ARGS	TokenNameIdentifier	 ER  NORMALIZESPACE  HAS  TOO  MANY  ARGS
,	TokenNameCOMMA	
"A normalize-space()-nek túl sok argumentuma van."	TokenNameStringLiteral	A normalize-space()-nek túl sok argumentuma van.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_NUMBER_HAS_TOO_MANY_ARGS	TokenNameIdentifier	 ER  NUMBER  HAS  TOO  MANY  ARGS
,	TokenNameCOMMA	
"A number()-nek túl sok argumentuma van."	TokenNameStringLiteral	A number()-nek túl sok argumentuma van.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_NAME_HAS_TOO_MANY_ARGS	TokenNameIdentifier	 ER  NAME  HAS  TOO  MANY  ARGS
,	TokenNameCOMMA	
"A name()-nek túl sok argumentuma van."	TokenNameStringLiteral	A name()-nek túl sok argumentuma van.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_STRING_HAS_TOO_MANY_ARGS	TokenNameIdentifier	 ER  STRING  HAS  TOO  MANY  ARGS
,	TokenNameCOMMA	
"A string()-nek túl sok argumentuma van."	TokenNameStringLiteral	A string()-nek túl sok argumentuma van.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_STRINGLENGTH_HAS_TOO_MANY_ARGS	TokenNameIdentifier	 ER  STRINGLENGTH  HAS  TOO  MANY  ARGS
,	TokenNameCOMMA	
"A string-length()-nek túl sok argumentuma van."	TokenNameStringLiteral	A string-length()-nek túl sok argumentuma van.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_TRANSLATE_TAKES_3_ARGS	TokenNameIdentifier	 ER  TRANSLATE  TAKES 3  ARGS
,	TokenNameCOMMA	
"A translate() függvény három argumentumot kér!"	TokenNameStringLiteral	A translate() függvény három argumentumot kér!
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_UNPARSEDENTITYURI_TAKES_1_ARG	TokenNameIdentifier	 ER  UNPARSEDENTITYURI  TAKES 1  ARG
,	TokenNameCOMMA	
"Az unparsed-entity-uri függvényhez egy argumentum szükséges!"	TokenNameStringLiteral	Az unparsed-entity-uri függvényhez egy argumentum szükséges!
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_NAMESPACEAXIS_NOT_IMPLEMENTED	TokenNameIdentifier	 ER  NAMESPACEAXIS  NOT  IMPLEMENTED
,	TokenNameCOMMA	
"A névtér tengely még nincs magvalósítva!"	TokenNameStringLiteral	A névtér tengely még nincs magvalósítva!
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_UNKNOWN_AXIS	TokenNameIdentifier	 ER  UNKNOWN  AXIS
,	TokenNameCOMMA	
"Ismeretlen tengely: {0}"	TokenNameStringLiteral	Ismeretlen tengely: {0}
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_UNKNOWN_MATCH_OPERATION	TokenNameIdentifier	 ER  UNKNOWN  MATCH  OPERATION
,	TokenNameCOMMA	
"ismeretlen illesztési m?velet!"	TokenNameStringLiteral	ismeretlen illesztési m?velet!
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_INCORRECT_ARG_LENGTH	TokenNameIdentifier	 ER  INCORRECT  ARG  LENGTH
,	TokenNameCOMMA	
"A processing-instruction() csomópont teszt argumentumának hossza helytelen!"	TokenNameStringLiteral	A processing-instruction() csomópont teszt argumentumának hossza helytelen!
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_CANT_CONVERT_TO_NUMBER	TokenNameIdentifier	 ER  CANT  CONVERT  TO  NUMBER
,	TokenNameCOMMA	
"A(z) {0} nem konvertálható számmá"	TokenNameStringLiteral	A(z) {0} nem konvertálható számmá
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_CANT_CONVERT_TO_NODELIST	TokenNameIdentifier	 ER  CANT  CONVERT  TO  NODELIST
,	TokenNameCOMMA	
"A(z) {0} nem konvertálható NodeList-té!"	TokenNameStringLiteral	A(z) {0} nem konvertálható NodeList-té!
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_CANT_CONVERT_TO_MUTABLENODELIST	TokenNameIdentifier	 ER  CANT  CONVERT  TO  MUTABLENODELIST
,	TokenNameCOMMA	
"A(z) {0} nem konvertálható NodeSetDTM-mé!"	TokenNameStringLiteral	A(z) {0} nem konvertálható NodeSetDTM-mé!
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_CANT_CONVERT_TO_TYPE	TokenNameIdentifier	 ER  CANT  CONVERT  TO  TYPE
,	TokenNameCOMMA	
"{0} nem konvertálható type#{1} típussá"	TokenNameStringLiteral	{0} nem konvertálható type#{1} típussá
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_EXPECTED_MATCH_PATTERN	TokenNameIdentifier	 ER  EXPECTED  MATCH  PATTERN
,	TokenNameCOMMA	
"Illesztési mintát vártunk a getMatchScore-ban!"	TokenNameStringLiteral	Illesztési mintát vártunk a getMatchScore-ban!
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_COULDNOT_GET_VAR_NAMED	TokenNameIdentifier	 ER  COULDNOT  GET  VAR  NAMED
,	TokenNameCOMMA	
"Nem lehet lekérni a(z) {0} nev? változót"	TokenNameStringLiteral	Nem lehet lekérni a(z) {0} nev? változót
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_UNKNOWN_OPCODE	TokenNameIdentifier	 ER  UNKNOWN  OPCODE
,	TokenNameCOMMA	
"HIBA! Ismeretlen opkód: {0}"	TokenNameStringLiteral	HIBA! Ismeretlen opkód: {0}
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_EXTRA_ILLEGAL_TOKENS	TokenNameIdentifier	 ER  EXTRA  ILLEGAL  TOKENS
,	TokenNameCOMMA	
"Extra tiltott tokenek: {0}"	TokenNameStringLiteral	Extra tiltott tokenek: {0}
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_EXPECTED_DOUBLE_QUOTE	TokenNameIdentifier	 ER  EXPECTED  DOUBLE  QUOTE
,	TokenNameCOMMA	
"rosszul idézett literál... dupla idéz?jelet vártunk!"	TokenNameStringLiteral	rosszul idézett literál... dupla idéz?jelet vártunk!
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_EXPECTED_SINGLE_QUOTE	TokenNameIdentifier	 ER  EXPECTED  SINGLE  QUOTE
,	TokenNameCOMMA	
"rosszul idézett literál... szimpla idéz?jelet vártunk!"	TokenNameStringLiteral	rosszul idézett literál... szimpla idéz?jelet vártunk!
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_EMPTY_EXPRESSION	TokenNameIdentifier	 ER  EMPTY  EXPRESSION
,	TokenNameCOMMA	
"Üres kifejezés!"	TokenNameStringLiteral	Üres kifejezés!
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_EXPECTED_BUT_FOUND	TokenNameIdentifier	 ER  EXPECTED  BUT  FOUND
,	TokenNameCOMMA	
"{0}-t vártunk, de ezt találtuk: {1}"	TokenNameStringLiteral	{0}-t vártunk, de ezt találtuk: {1}
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_INCORRECT_PROGRAMMER_ASSERTION	TokenNameIdentifier	 ER  INCORRECT  PROGRAMMER  ASSERTION
,	TokenNameCOMMA	
"A programozó feltevése hibás! - {0}"	TokenNameStringLiteral	A programozó feltevése hibás! - {0}
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_BOOLEAN_ARG_NO_LONGER_OPTIONAL	TokenNameIdentifier	 ER  BOOLEAN  ARG  NO  LONGER  OPTIONAL
,	TokenNameCOMMA	
"A boolean(...) argumentuma többé nem opcionális az 19990709 XPath vázlat szerint."	TokenNameStringLiteral	A boolean(...) argumentuma többé nem opcionális az 19990709 XPath vázlat szerint.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_FOUND_COMMA_BUT_NO_PRECEDING_ARG	TokenNameIdentifier	 ER  FOUND  COMMA  BUT  NO  PRECEDING  ARG
,	TokenNameCOMMA	
"','-t találtunk, de nincs el?tte argumentum!"	TokenNameStringLiteral	','-t találtunk, de nincs el?tte argumentum!
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_FOUND_COMMA_BUT_NO_FOLLOWING_ARG	TokenNameIdentifier	 ER  FOUND  COMMA  BUT  NO  FOLLOWING  ARG
,	TokenNameCOMMA	
"','-t találtunk, de nincs utána argumentum!"	TokenNameStringLiteral	','-t találtunk, de nincs utána argumentum!
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_PREDICATE_ILLEGAL_SYNTAX	TokenNameIdentifier	 ER  PREDICATE  ILLEGAL  SYNTAX
,	TokenNameCOMMA	
"A '..[feltétel]' vagy '.[feltétel]' szintaktika tiltott. Használja inkább a 'self::node()[predicate]' definíciót."	TokenNameStringLiteral	A '..[feltétel]' vagy '.[feltétel]' szintaktika tiltott. Használja inkább a 'self::node()[predicate]' definíciót.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_ILLEGAL_AXIS_NAME	TokenNameIdentifier	 ER  ILLEGAL  AXIS  NAME
,	TokenNameCOMMA	
"Tiltott tengelynév: {0}"	TokenNameStringLiteral	Tiltott tengelynév: {0}
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_UNKNOWN_NODETYPE	TokenNameIdentifier	 ER  UNKNOWN  NODETYPE
,	TokenNameCOMMA	
"Ismeretlen node-típus: {0}"	TokenNameStringLiteral	Ismeretlen node-típus: {0}
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_PATTERN_LITERAL_NEEDS_BE_QUOTED	TokenNameIdentifier	 ER  PATTERN  LITERAL  NEEDS  BE  QUOTED
,	TokenNameCOMMA	
"A minta-literált ({0}) idéz?jelek közé kell tenni!"	TokenNameStringLiteral	A minta-literált ({0}) idéz?jelek közé kell tenni!
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_COULDNOT_BE_FORMATTED_TO_NUMBER	TokenNameIdentifier	 ER  COULDNOT  BE  FORMATTED  TO  NUMBER
,	TokenNameCOMMA	
"A(z) {0} nem formázható számmá!"	TokenNameStringLiteral	A(z) {0} nem formázható számmá!
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_COULDNOT_CREATE_XMLPROCESSORLIAISON	TokenNameIdentifier	 ER  COULDNOT  CREATE  XMLPROCESSORLIAISON
...
ER_COULDNOT_FIND_ENDOP_AFTER_OPLOCATIONPATH	TokenNameIdentifier	 ER  COULDNOT  FIND  ENDOP  AFTER  OPLOCATIONPATH
,	TokenNameCOMMA	
"HIBA! Nem található ENDOP az OP_LOCATIONPATH után"	TokenNameStringLiteral	HIBA! Nem található ENDOP az OP_LOCATIONPATH után
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_ERROR_OCCURED	TokenNameIdentifier	 ER  ERROR  OCCURED
,	TokenNameCOMMA	
"Hiba történt!"	TokenNameStringLiteral	Hiba történt!
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_ILLEGAL_VARIABLE_REFERENCE	TokenNameIdentifier	 ER  ILLEGAL  VARIABLE  REFERENCE
,	TokenNameCOMMA	
"A változóra adott VariableReference (változóhivatkozás) kívül van a környezeten vagy nincs definíciója! Név = {0}"	TokenNameStringLiteral	A változóra adott VariableReference (változóhivatkozás) kívül van a környezeten vagy nincs definíciója! Név = {0}
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_AXES_NOT_ALLOWED	TokenNameIdentifier	 ER  AXES  NOT  ALLOWED
,	TokenNameCOMMA	
"Csak a child:: és az attribute:: tengelyek illeszkedhetnek mintákra. Zavaró tengelyek = {0}"	TokenNameStringLiteral	Csak a child:: és az attribute:: tengelyek illeszkedhetnek mintákra. Zavaró tengelyek = {0}
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_KEY_HAS_TOO_MANY_ARGS	TokenNameIdentifier	 ER  KEY  HAS  TOO  MANY  ARGS
,	TokenNameCOMMA	
"A key()-nek nem megfelel? számú argumentuma van."	TokenNameStringLiteral	A key()-nek nem megfelel? számú argumentuma van.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_COUNT_TAKES_1_ARG	TokenNameIdentifier	 ER  COUNT  TAKES 1  ARG
,	TokenNameCOMMA	
"A count függvényhez csak egy argumentumot lehet megadni!"	TokenNameStringLiteral	A count függvényhez csak egy argumentumot lehet megadni!
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_COULDNOT_FIND_FUNCTION	TokenNameIdentifier	 ER  COULDNOT  FIND  FUNCTION
,	TokenNameCOMMA	
"Nem található a függvény: {0}"	TokenNameStringLiteral	Nem található a függvény: {0}
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_UNSUPPORTED_ENCODING	TokenNameIdentifier	 ER  UNSUPPORTED  ENCODING
,	TokenNameCOMMA	
"Nem támogatott kódolás: {0}"	TokenNameStringLiteral	Nem támogatott kódolás: {0}
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_PROBLEM_IN_DTM_NEXTSIBLING	TokenNameIdentifier	 ER  PROBLEM  IN  DTM  NEXTSIBLING
,	TokenNameCOMMA	
"Probléma merült fel a DTM-ben a getNextSibling-ben... megpróbáljuk helyrehozni"	TokenNameStringLiteral	Probléma merült fel a DTM-ben a getNextSibling-ben... megpróbáljuk helyrehozni
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_CANNOT_WRITE_TO_EMPTYNODELISTIMPL	TokenNameIdentifier	 ER  CANNOT  WRITE  TO  EMPTYNODELISTIMPL
,	TokenNameCOMMA	
"Programozói hiba: az EmptyNodeList-be (üres csomópontlistába) nem lehet írni."	TokenNameStringLiteral	Programozói hiba: az EmptyNodeList-be (üres csomópontlistába) nem lehet írni.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_SETDOMFACTORY_NOT_SUPPORTED	TokenNameIdentifier	 ER  SETDOMFACTORY  NOT  SUPPORTED
,	TokenNameCOMMA	
"A setDOMFactory-t nem támogatja az XPathContext!"	TokenNameStringLiteral	A setDOMFactory-t nem támogatja az XPathContext!
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_PREFIX_MUST_RESOLVE	TokenNameIdentifier	 ER  PREFIX  MUST  RESOLVE
...
ER_PARSE_NOT_SUPPORTED	TokenNameIdentifier	 ER  PARSE  NOT  SUPPORTED
,	TokenNameCOMMA	
"Az elemés (InputSource forrás) nem támogatott az XPathContext-ben! Nem lehet megnyitni a(z) {0}-t"	TokenNameStringLiteral	Az elemés (InputSource forrás) nem támogatott az XPathContext-ben! Nem lehet megnyitni a(z) {0}-t
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_SAX_API_NOT_HANDLED	TokenNameIdentifier	 ER  SAX  API  NOT  HANDLED
,	TokenNameCOMMA	
"SAX API characters(char ch[]... függvényt nem kezeli a DTM!"	TokenNameStringLiteral	SAX API characters(char ch[]... függvényt nem kezeli a DTM!
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_IGNORABLE_WHITESPACE_NOT_HANDLED	TokenNameIdentifier	 ER  IGNORABLE  WHITESPACE  NOT  HANDLED
,	TokenNameCOMMA	
"Az ignorableWhitespace(char ch[]... függvényt nem kezeli a DTM!"	TokenNameStringLiteral	Az ignorableWhitespace(char ch[]... függvényt nem kezeli a DTM!
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_DTM_CANNOT_HANDLE_NODES	TokenNameIdentifier	 ER  DTM  CANNOT  HANDLE  NODES
,	TokenNameCOMMA	
"A DTMLiaison nem tud {0} típusú csomópontokat kezelni"	TokenNameStringLiteral	A DTMLiaison nem tud {0} típusú csomópontokat kezelni
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_XERCES_CANNOT_HANDLE_NODES	TokenNameIdentifier	 ER  XERCES  CANNOT  HANDLE  NODES
,	TokenNameCOMMA	
"A DOM2Helper nem tud {0} típusú csomópontokat kezelni"	TokenNameStringLiteral	A DOM2Helper nem tud {0} típusú csomópontokat kezelni
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_XERCES_PARSE_ERROR_DETAILS	TokenNameIdentifier	 ER  XERCES  PARSE  ERROR  DETAILS
,	TokenNameCOMMA	
"DOM2Helper.parse hiba: SystemID - {0} sor - {1}"	TokenNameStringLiteral	DOM2Helper.parse hiba: SystemID - {0} sor - {1}
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_XERCES_PARSE_ERROR	TokenNameIdentifier	 ER  XERCES  PARSE  ERROR
,	TokenNameCOMMA	
"DOM2Helper.parse hiba"	TokenNameStringLiteral	DOM2Helper.parse hiba
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_INVALID_UTF16_SURROGATE	TokenNameIdentifier	 ER  INVALID  UT F16  SURROGATE
...
ER_CANNOT_CREATE_URL	TokenNameIdentifier	 ER  CANNOT  CREATE  URL
,	TokenNameCOMMA	
"Nem lehet URL-t létrehozni ehhez: {0}"	TokenNameStringLiteral	Nem lehet URL-t létrehozni ehhez: {0}
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_XPATH_READOBJECT	TokenNameIdentifier	 ER  XPATH  READOBJECT
,	TokenNameCOMMA	
"A XPath.readObject metódusban: {0}"	TokenNameStringLiteral	A XPath.readObject metódusban: {0}
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_FUNCTION_TOKEN_NOT_FOUND	TokenNameIdentifier	 ER  FUNCTION  TOKEN  NOT  FOUND
,	TokenNameCOMMA	
"A függvény jelsor nem található."	TokenNameStringLiteral	A függvény jelsor nem található.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_CANNOT_DEAL_XPATH_TYPE	TokenNameIdentifier	 ER  CANNOT  DEAL  XPATH  TYPE
,	TokenNameCOMMA	
"Nem lehet megbirkózni az XPath típussal: {0}"	TokenNameStringLiteral	Nem lehet megbirkózni az XPath típussal: {0}
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_NODESET_NOT_MUTABLE	TokenNameIdentifier	 ER  NODESET  NOT  MUTABLE
,	TokenNameCOMMA	
"Ez a NodeSet nem illeszthet? be"	TokenNameStringLiteral	Ez a NodeSet nem illeszthet? be
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_NODESETDTM_NOT_MUTABLE	TokenNameIdentifier	 ER  NODESETDTM  NOT  MUTABLE
,	TokenNameCOMMA	
"Ez a NodeSetDTM nem illeszthet? be"	TokenNameStringLiteral	Ez a NodeSetDTM nem illeszthet? be
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_VAR_NOT_RESOLVABLE	TokenNameIdentifier	 ER  VAR  NOT  RESOLVABLE
,	TokenNameCOMMA	
"A változó nem oldható fel: {0}"	TokenNameStringLiteral	A változó nem oldható fel: {0}
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_NULL_ERROR_HANDLER	TokenNameIdentifier	 ER  NULL  ERROR  HANDLER
...
ER_PROG_ASSERT_UNKNOWN_OPCODE	TokenNameIdentifier	 ER  PROG  ASSERT  UNKNOWN  OPCODE
,	TokenNameCOMMA	
"Programozói értesítés: ismeretlen m?veletkód: {0} "	TokenNameStringLiteral	Programozói értesítés: ismeretlen m?veletkód: {0} 
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_ZERO_OR_ONE	TokenNameIdentifier	 ER  ZERO  OR  ONE
,	TokenNameCOMMA	
"0 vagy 1"	TokenNameStringLiteral	0 vagy 1
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_RTF_NOT_SUPPORTED_XRTREEFRAGSELECTWRAPPER	TokenNameIdentifier	 ER  RTF  NOT  SUPPORTED  XRTREEFRAGSELECTWRAPPER
,	TokenNameCOMMA	
"Az rtf()-et nem támogatja az XRTreeFragSelectWrapper"	TokenNameStringLiteral	Az rtf()-et nem támogatja az XRTreeFragSelectWrapper
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_RTF_NOT_SUPPORTED_XRTREEFRAGSELECTWRAPPER	TokenNameIdentifier	 ER  RTF  NOT  SUPPORTED  XRTREEFRAGSELECTWRAPPER
,	TokenNameCOMMA	
"Az asNodeIterator()-t nem támogatja az XRTreeFragSelectWrapper"	TokenNameStringLiteral	Az asNodeIterator()-t nem támogatja az XRTreeFragSelectWrapper
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_DETACH_NOT_SUPPORTED_XRTREEFRAGSELECTWRAPPER	TokenNameIdentifier	 ER  DETACH  NOT  SUPPORTED  XRTREEFRAGSELECTWRAPPER
,	TokenNameCOMMA	
"A detach() függvényt nem támogatja az XRTreeFragSelectWrapper"	TokenNameStringLiteral	A detach() függvényt nem támogatja az XRTreeFragSelectWrapper
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_NUM_NOT_SUPPORTED_XRTREEFRAGSELECTWRAPPER	TokenNameIdentifier	 ER  NUM  NOT  SUPPORTED  XRTREEFRAGSELECTWRAPPER
,	TokenNameCOMMA	
"A num() függvényt nem támogatja az XRTreeFragSelectWrapper"	TokenNameStringLiteral	A num() függvényt nem támogatja az XRTreeFragSelectWrapper
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_XSTR_NOT_SUPPORTED_XRTREEFRAGSELECTWRAPPER	TokenNameIdentifier	 ER  XSTR  NOT  SUPPORTED  XRTREEFRAGSELECTWRAPPER
,	TokenNameCOMMA	
"A xstr() függvényt nem támogatja az XRTreeFragSelectWrapper"	TokenNameStringLiteral	A xstr() függvényt nem támogatja az XRTreeFragSelectWrapper
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_STR_NOT_SUPPORTED_XRTREEFRAGSELECTWRAPPER	TokenNameIdentifier	 ER  STR  NOT  SUPPORTED  XRTREEFRAGSELECTWRAPPER
,	TokenNameCOMMA	
"A str() függvényt nem támogatja az XRTreeFragSelectWrapper"	TokenNameStringLiteral	A str() függvényt nem támogatja az XRTreeFragSelectWrapper
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_FSB_NOT_SUPPORTED_XSTRINGFORCHARS	TokenNameIdentifier	 ER  FSB  NOT  SUPPORTED  XSTRINGFORCHARS
,	TokenNameCOMMA	
"Az fsb() nem támogatott az XStringForChars-nál"	TokenNameStringLiteral	Az fsb() nem támogatott az XStringForChars-nál
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_COULD_NOT_FIND_VAR	TokenNameIdentifier	 ER  COULD  NOT  FIND  VAR
,	TokenNameCOMMA	
"Nem található {0} nev? változó"	TokenNameStringLiteral	Nem található {0} nev? változó
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_XSTRINGFORCHARS_CANNOT_TAKE_STRING	TokenNameIdentifier	 ER  XSTRINGFORCHARS  CANNOT  TAKE  STRING
,	TokenNameCOMMA	
"Az XStringForChars-nak nem adhat meg karakterlánc argumentumot"	TokenNameStringLiteral	Az XStringForChars-nak nem adhat meg karakterlánc argumentumot
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_FASTSTRINGBUFFER_CANNOT_BE_NULL	TokenNameIdentifier	 ER  FASTSTRINGBUFFER  CANNOT  BE  NULL
,	TokenNameCOMMA	
"A FastStringBuffer argumentum nem lehet null"	TokenNameStringLiteral	A FastStringBuffer argumentum nem lehet null
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_TWO_OR_THREE	TokenNameIdentifier	 ER  TWO  OR  THREE
...
ER_VARIABLE_ACCESSED_BEFORE_BIND	TokenNameIdentifier	 ER  VARIABLE  ACCESSED  BEFORE  BIND
,	TokenNameCOMMA	
"Változóelérés értékadás el?tt!"	TokenNameStringLiteral	Változóelérés értékadás el?tt!
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_FSB_CANNOT_TAKE_STRING	TokenNameIdentifier	 ER  FSB  CANNOT  TAKE  STRING
,	TokenNameCOMMA	
"XStringForFSB nem kaphat sztring argumentumot!"	TokenNameStringLiteral	XStringForFSB nem kaphat sztring argumentumot!
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_SETTING_WALKER_ROOT_TO_NULL	TokenNameIdentifier	 ER  SETTING  WALKER  ROOT  TO  NULL
,	TokenNameCOMMA	
" !!!! Hiba! A bejáró gyökerét null-ra állította!!!"	TokenNameStringLiteral	 !!!! Hiba! A bejáró gyökerét null-ra állította!!!
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_NODESETDTM_CANNOT_ITERATE	TokenNameIdentifier	 ER  NODESETDTM  CANNOT  ITERATE
,	TokenNameCOMMA	
"Ez a NodeSetDTM nem iterálhat egy korábbi node-ra!"	TokenNameStringLiteral	Ez a NodeSetDTM nem iterálhat egy korábbi node-ra!
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_NODESET_CANNOT_ITERATE	TokenNameIdentifier	 ER  NODESET  CANNOT  ITERATE
,	TokenNameCOMMA	
"Ez a NodeSet nem iterálhat egy korábbi node-ra!"	TokenNameStringLiteral	Ez a NodeSet nem iterálhat egy korábbi node-ra!
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_NODESETDTM_CANNOT_INDEX	TokenNameIdentifier	 ER  NODESETDTM  CANNOT  INDEX
,	TokenNameCOMMA	
"Ez a NodeSetDTM nem indexelhet és nem számlálhatja a funkciókat!"	TokenNameStringLiteral	Ez a NodeSetDTM nem indexelhet és nem számlálhatja a funkciókat!
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_NODESET_CANNOT_INDEX	TokenNameIdentifier	 ER  NODESET  CANNOT  INDEX
,	TokenNameCOMMA	
"Ez a NodeSet nem indexelhet és nem számlálhatja a funkciókat!"	TokenNameStringLiteral	Ez a NodeSet nem indexelhet és nem számlálhatja a funkciókat!
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_CANNOT_CALL_SETSHOULDCACHENODE	TokenNameIdentifier	 ER  CANNOT  CALL  SETSHOULDCACHENODE
,	TokenNameCOMMA	
"Nem hívható setShouldCacheNodes nextNode hívása után!"	TokenNameStringLiteral	Nem hívható setShouldCacheNodes nextNode hívása után!
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_ONLY_ALLOWS	TokenNameIdentifier	 ER  ONLY  ALLOWS
,	TokenNameCOMMA	
"{0} csak {1} argumentumot engedélyez"	TokenNameStringLiteral	{0} csak {1} argumentumot engedélyez
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_UNKNOWN_STEP	TokenNameIdentifier	 ER  UNKNOWN  STEP
,	TokenNameCOMMA	
"Programozói értesítés getNextStepPos hívásban: ismeretlen stepType: {0} "	TokenNameStringLiteral	Programozói értesítés getNextStepPos hívásban: ismeretlen stepType: {0} 
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
ER_EXPECTED_REL_LOC_PATH	TokenNameIdentifier	 ER  EXPECTED  REL  LOC  PATH
,	TokenNameCOMMA	
"Egy relatív elhelyezési útvonalat vártunk a '/' vagy '//' token után."	TokenNameStringLiteral	Egy relatív elhelyezési útvonalat vártunk a '/' vagy '//' token után.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
ER_EXPECTED_LOC_PATH	TokenNameIdentifier	 ER  EXPECTED  LOC  PATH
,	TokenNameCOMMA	
"Egy hely útvonalat vártam, de a következ? tokent találtam: {0}"	TokenNameStringLiteral	Egy hely útvonalat vártam, de a következ? tokent találtam: {0}
}	TokenNameRBRACE	
,	TokenNameCOMMA	
// Note to translators: A location path is a form of XPath expression. 	TokenNameCOMMENT_LINE	Note to translators: A location path is a form of XPath expression. 
...
ER_EXPECTED_LOC_PATH_AT_END_EXPR	TokenNameIdentifier	 ER  EXPECTED  LOC  PATH  AT  END  EXPR
,	TokenNameCOMMA	
"A rendszer hely útvonalat várt, de helyette az XPath kifejezés végébe ütközött."	TokenNameStringLiteral	A rendszer hely útvonalat várt, de helyette az XPath kifejezés végébe ütközött.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
ER_EXPECTED_LOC_STEP	TokenNameIdentifier	 ER  EXPECTED  LOC  STEP
,	TokenNameCOMMA	
"Egy elhelyezési lépést vártunk a '/' vagy '//' token után."	TokenNameStringLiteral	Egy elhelyezési lépést vártunk a '/' vagy '//' token után.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
ER_EXPECTED_NODE_TEST	TokenNameIdentifier	 ER  EXPECTED  NODE  TEST
,	TokenNameCOMMA	
"Egy olyan node-tesztet vártunk, ami vagy az NCName:*-ra vagy a QName-re illeszkedik."	TokenNameStringLiteral	Egy olyan node-tesztet vártunk, ami vagy az NCName:*-ra vagy a QName-re illeszkedik.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
ER_EXPECTED_STEP_PATTERN	TokenNameIdentifier	 ER  EXPECTED  STEP  PATTERN
,	TokenNameCOMMA	
"Egy lépésmintát vártunk, de '/' szerepelt."	TokenNameStringLiteral	Egy lépésmintát vártunk, de '/' szerepelt.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
ER_EXPECTED_REL_PATH_PATTERN	TokenNameIdentifier	 ER  EXPECTED  REL  PATH  PATTERN
,	TokenNameCOMMA	
"Relatív útvonalat vártunk."	TokenNameStringLiteral	Relatív útvonalat vártunk.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
ER_CANT_CONVERT_TO_BOOLEAN	TokenNameIdentifier	 ER  CANT  CONVERT  TO  BOOLEAN
,	TokenNameCOMMA	
"A(z) ''{0}'' XPath kifejezés XPathResult elemének XPathResultType értéke {1}, ami nem alakítható át logikai típussá."	TokenNameStringLiteral	A(z) ''{0}'' XPath kifejezés XPathResult elemének XPathResultType értéke {1}, ami nem alakítható át logikai típussá.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
ER_CANT_CONVERT_TO_SINGLENODE	TokenNameIdentifier	 ER  CANT  CONVERT  TO  SINGLENODE
,	TokenNameCOMMA	
"A(z) ''{0}'' XPath kifejezés XPathResult elemének XPathResultType értéke {1}, ami nem alakítható át egyetlen csomóponttá. A getSingleNodeValue metódus csak az ANY_UNORDERED_NODE_TYPE és a FIRST_ORDERED_NODE_TYPE típusra alkalmazható. "	TokenNameStringLiteral	A(z) ''{0}'' XPath kifejezés XPathResult elemének XPathResultType értéke {1}, ami nem alakítható át egyetlen csomóponttá. A getSingleNodeValue metódus csak az ANY_UNORDERED_NODE_TYPE és a FIRST_ORDERED_NODE_TYPE típusra alkalmazható. 
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
ER_CANT_GET_SNAPSHOT_LENGTH	TokenNameIdentifier	 ER  CANT  GET  SNAPSHOT  LENGTH
,	TokenNameCOMMA	
"A getSnapshotLength metódus nem hívható meg a(z) ''{0}'' XPath kifejezés XPathResult értékére, mert az XPathResultType értéke {1}. Ez a metódus csak UNORDERED_NODE_SNAPSHOT_TYPE és ORDERED_NODE_SNAPSHOT_TYPE típusokra alkalmazható."	TokenNameStringLiteral	A getSnapshotLength metódus nem hívható meg a(z) ''{0}'' XPath kifejezés XPathResult értékére, mert az XPathResultType értéke {1}. Ez a metódus csak UNORDERED_NODE_SNAPSHOT_TYPE és ORDERED_NODE_SNAPSHOT_TYPE típusokra alkalmazható.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_NON_ITERATOR_TYPE	TokenNameIdentifier	 ER  NON  ITERATOR  TYPE
,	TokenNameCOMMA	
"Az iterateNext metódus nem hívható meg a(z) ''{0}'' XPath kifejezés XPathResult értékére, mert az XPathResultType értéke {1}. Ez a metódus csak UNORDERED_NODE_ITERATOR_TYPE és ORDERED_NODE_ITERATOR_TYPE típusokra alkalmazható."	TokenNameStringLiteral	Az iterateNext metódus nem hívható meg a(z) ''{0}'' XPath kifejezés XPathResult értékére, mert az XPathResultType értéke {1}. Ez a metódus csak UNORDERED_NODE_ITERATOR_TYPE és ORDERED_NODE_ITERATOR_TYPE típusokra alkalmazható.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
ER_DOC_MUTATED	TokenNameIdentifier	 ER  DOC  MUTATED
,	TokenNameCOMMA	
"A dokumentum megváltozott, mióta az eredmény visszatért. Az iterátor érvénytelen."	TokenNameStringLiteral	A dokumentum megváltozott, mióta az eredmény visszatért. Az iterátor érvénytelen.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_INVALID_XPATH_TYPE	TokenNameIdentifier	 ER  INVALID  XPATH  TYPE
,	TokenNameCOMMA	
"Érvénytelen XPath típus-argumentum: {0}"	TokenNameStringLiteral	Érvénytelen XPath típus-argumentum: {0}
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_EMPTY_XPATH_RESULT	TokenNameIdentifier	 ER  EMPTY  XPATH  RESULT
,	TokenNameCOMMA	
"Üres XPath eredményobjektum"	TokenNameStringLiteral	Üres XPath eredményobjektum
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_INCOMPATIBLE_TYPES	TokenNameIdentifier	 ER  INCOMPATIBLE  TYPES
,	TokenNameCOMMA	
"A(z) ''{0}'' XPath kifejezés XPathResult elemének XPathResultType értéke {1}, ami nem helyezhet? el a megadott {2} XPathResultType típusban. "	TokenNameStringLiteral	A(z) ''{0}'' XPath kifejezés XPathResult elemének XPathResultType értéke {1}, ami nem helyezhet? el a megadott {2} XPathResultType típusban. 
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_NULL_RESOLVER	TokenNameIdentifier	 ER  NULL  RESOLVER
,	TokenNameCOMMA	
"Nem lehet feloldani a prefixet null prefix-feloldóval."	TokenNameStringLiteral	Nem lehet feloldani a prefixet null prefix-feloldóval.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
// Note to translators: The substitution text is the name of a data type. The 	TokenNameCOMMENT_LINE	Note to translators: The substitution text is the name of a data type. The 
// message indicates that a value of a particular type could not be converted 	TokenNameCOMMENT_LINE	message indicates that a value of a particular type could not be converted 
...
ER_CANT_CONVERT_TO_STRING	TokenNameIdentifier	 ER  CANT  CONVERT  TO  STRING
,	TokenNameCOMMA	
"A(z) ''{0}'' XPath kifejezés XPathResult elemének XPathResultType értéke {1}, ami nem alakítható át karaktersorozattá. "	TokenNameStringLiteral	A(z) ''{0}'' XPath kifejezés XPathResult elemének XPathResultType értéke {1}, ami nem alakítható át karaktersorozattá. 
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
ER_NON_SNAPSHOT_TYPE	TokenNameIdentifier	 ER  NON  SNAPSHOT  TYPE
,	TokenNameCOMMA	
"A snapshotItem metódus nem hívható meg a(z) ''{0}'' XPath kifejezés XPathResult értékére, mert az XPathResultType értéke {1}. Ez a metódus csak UNORDERED_NODE_SNAPSHOT_TYPE és ORDERED_NODE_SNAPSHOT_TYPE típusokra alkalmazható."	TokenNameStringLiteral	A snapshotItem metódus nem hívható meg a(z) ''{0}'' XPath kifejezés XPathResult értékére, mert az XPathResultType értéke {1}. Ez a metódus csak UNORDERED_NODE_SNAPSHOT_TYPE és ORDERED_NODE_SNAPSHOT_TYPE típusokra alkalmazható.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
ER_WRONG_DOCUMENT	TokenNameIdentifier	 ER  WRONG  DOCUMENT
,	TokenNameCOMMA	
"A környezeti node nem az XPathEvaluator-hoz tartozó dokumentumhoz tartozik."	TokenNameStringLiteral	A környezeti node nem az XPathEvaluator-hoz tartozó dokumentumhoz tartozik.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
ER_WRONG_NODETYPE	TokenNameIdentifier	 ER  WRONG  NODETYPE
,	TokenNameCOMMA	
"A környezeti node típusa nem támogatott."	TokenNameStringLiteral	A környezeti node típusa nem támogatott.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_XPATH_ERROR	TokenNameIdentifier	 ER  XPATH  ERROR
,	TokenNameCOMMA	
"Ismeretlen hiba az XPath-ban."	TokenNameStringLiteral	Ismeretlen hiba az XPath-ban.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_CANT_CONVERT_XPATHRESULTTYPE_TO_NUMBER	TokenNameIdentifier	 ER  CANT  CONVERT  XPATHRESULTTYPE  TO  NUMBER
,	TokenNameCOMMA	
"A(z) ''{0}'' XPath kifejezés XPathResult elemének XPathResultType értéke {1}, ami nem alakítható át számmá. "	TokenNameStringLiteral	A(z) ''{0}'' XPath kifejezés XPathResult elemének XPathResultType értéke {1}, ami nem alakítható át számmá. 
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
ER_EXTENSION_FUNCTION_CANNOT_BE_INVOKED	TokenNameIdentifier	 ER  EXTENSION  FUNCTION  CANNOT  BE  INVOKED
,	TokenNameCOMMA	
"A(z) ''{0}'' b?vít? függvény nem hívható meg, amikor az XMLConstants.FEATURE_SECURE_PROCESSING szolgáltatás igazra van állítva. "	TokenNameStringLiteral	A(z) ''{0}'' b?vít? függvény nem hívható meg, amikor az XMLConstants.FEATURE_SECURE_PROCESSING szolgáltatás igazra van állítva. 
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
ER_RESOLVE_VARIABLE_RETURNS_NULL	TokenNameIdentifier	 ER  RESOLVE  VARIABLE  RETURNS  NULL
,	TokenNameCOMMA	
"A resolveVariable nullértéket adott vissza a(z) {0} változóra"	TokenNameStringLiteral	A resolveVariable nullértéket adott vissza a(z) {0} változóra
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
ER_UNSUPPORTED_RETURN_TYPE	TokenNameIdentifier	 ER  UNSUPPORTED  RETURN  TYPE
,	TokenNameCOMMA	
"Nem támogatott visszatérési típus: {0}"	TokenNameStringLiteral	Nem támogatott visszatérési típus: {0}
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
ER_SOURCE_RETURN_TYPE_CANNOT_BE_NULL	TokenNameIdentifier	 ER  SOURCE  RETURN  TYPE  CANNOT  BE  NULL
,	TokenNameCOMMA	
"A forrás és/vagy a visszatérési típus nem lehet null. "	TokenNameStringLiteral	A forrás és/vagy a visszatérési típus nem lehet null. 
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
ER_ARG_CANNOT_BE_NULL	TokenNameIdentifier	 ER  ARG  CANNOT  BE  NULL
,	TokenNameCOMMA	
"A(z) {0} argumentum nem lehet null"	TokenNameStringLiteral	A(z) {0} argumentum nem lehet null
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
ER_OBJECT_MODEL_NULL	TokenNameIdentifier	 ER  OBJECT  MODEL  NULL
,	TokenNameCOMMA	
"{0}#isObjectModelSupported( String objectModel ) nem hívható meg objectModel == null értékkel "	TokenNameStringLiteral	{0}#isObjectModelSupported( String objectModel ) nem hívható meg objectModel == null értékkel 
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
ER_OBJECT_MODEL_EMPTY	TokenNameIdentifier	 ER  OBJECT  MODEL  EMPTY
,	TokenNameCOMMA	
"{0}#isObjectModelSupported( String objectModel ) nem hívható meg objectModel == "" értékkel "	TokenNameStringLiteral	{0}#isObjectModelSupported( String objectModel ) nem hívható meg objectModel == "" értékkel 
}	TokenNameRBRACE	
,	TokenNameCOMMA	
/** Field ER_OBJECT_MODEL_EMPTY */	TokenNameCOMMENT_JAVADOC	 Field ER_OBJECT_MODEL_EMPTY 
{	TokenNameLBRACE	
ER_FEATURE_NAME_NULL	TokenNameIdentifier	 ER  FEATURE  NAME  NULL
,	TokenNameCOMMA	
"Próbálkozás egy szolgáltatás beállítására null névvel: {0}#setFeature( null, {1})"	TokenNameStringLiteral	Próbálkozás egy szolgáltatás beállítására null névvel: {0}#setFeature( null, {1})
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
ER_FEATURE_UNKNOWN	TokenNameIdentifier	 ER  FEATURE  UNKNOWN
,	TokenNameCOMMA	
"Próbálkozás az ismeretlen "{0}" szolgáltatás beállítására:{1}#setFeature({0},{2})"	TokenNameStringLiteral	Próbálkozás az ismeretlen "{0}" szolgáltatás beállítására:{1}#setFeature({0},{2})
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
ER_GETTING_NULL_FEATURE	TokenNameIdentifier	 ER  GETTING  NULL  FEATURE
,	TokenNameCOMMA	
"Null nev? szolgáltatást próbált meg beolvasni: {0}#getFeature(null)"	TokenNameStringLiteral	Null nev? szolgáltatást próbált meg beolvasni: {0}#getFeature(null)
}	TokenNameRBRACE	
,	TokenNameCOMMA	
/** Field ER_GETTING_NULL_FEATURE */	TokenNameCOMMENT_JAVADOC	 Field ER_GETTING_NULL_FEATURE 
{	TokenNameLBRACE	
ER_GETTING_UNKNOWN_FEATURE	TokenNameIdentifier	 ER  GETTING  UNKNOWN  FEATURE
,	TokenNameCOMMA	
"Próbálkozás az ismeretlen "{0}" szolgáltatás beolvasására:{1}#getFeature({0})"	TokenNameStringLiteral	Próbálkozás az ismeretlen "{0}" szolgáltatás beolvasására:{1}#getFeature({0})
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
ER_NULL_XPATH_FUNCTION_RESOLVER	TokenNameIdentifier	 ER  NULL  XPATH  FUNCTION  RESOLVER
,	TokenNameCOMMA	
"Null XPathFunctionResolver értéket próbált meg beállítani:{0}#setXPathFunctionResolver(null)"	TokenNameStringLiteral	Null XPathFunctionResolver értéket próbált meg beállítani:{0}#setXPathFunctionResolver(null)
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
ER_NULL_XPATH_VARIABLE_RESOLVER	TokenNameIdentifier	 ER  NULL  XPATH  VARIABLE  RESOLVER
,	TokenNameCOMMA	
"Null XPathVariableResolver értéket próbált meg beállítani:{0}#setXPathVariableResolver(null)"	TokenNameStringLiteral	Null XPathVariableResolver értéket próbált meg beállítani:{0}#setXPathVariableResolver(null)
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
WG_LOCALE_NAME_NOT_HANDLED	TokenNameIdentifier	 WG  LOCALE  NAME  NOT  HANDLED
,	TokenNameCOMMA	
"A locale-név a format-number függvényben még nincs kezelve!"	TokenNameStringLiteral	A locale-név a format-number függvényben még nincs kezelve!
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
WG_PROPERTY_NOT_SUPPORTED	TokenNameIdentifier	 WG  PROPERTY  NOT  SUPPORTED
,	TokenNameCOMMA	
"Az XSL tulajdonság nem támogatott: {0}"	TokenNameStringLiteral	Az XSL tulajdonság nem támogatott: {0}
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
WG_DONT_DO_ANYTHING_WITH_NS	TokenNameIdentifier	 WG  DONT  DO  ANYTHING  WITH  NS
,	TokenNameCOMMA	
"Jelenleg ne tegyen semmit a(z) {0} névtérrel a tulajdonságban: {1}"	TokenNameStringLiteral	Jelenleg ne tegyen semmit a(z) {0} névtérrel a tulajdonságban: {1}
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
WG_SECURITY_EXCEPTION	TokenNameIdentifier	 WG  SECURITY  EXCEPTION
,	TokenNameCOMMA	
"SecurityException az XSL rendszertulajdonság elérésénél: {0}"	TokenNameStringLiteral	SecurityException az XSL rendszertulajdonság elérésénél: {0}
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
WG_QUO_NO_LONGER_DEFINED	TokenNameIdentifier	 WG  QUO  NO  LONGER  DEFINED
,	TokenNameCOMMA	
"A régi szintaktika: quo(...) többé nincs definiálva az XPath-ban."	TokenNameStringLiteral	A régi szintaktika: quo(...) többé nincs definiálva az XPath-ban.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
WG_NEED_DERIVED_OBJECT_TO_IMPLEMENT_NODETEST	TokenNameIdentifier	 WG  NEED  DERIVED  OBJECT  TO  IMPLEMENT  NODETEST
,	TokenNameCOMMA	
"Az XPath-nak kell egy származtatott objektum a nodeTest-hez!"	TokenNameStringLiteral	Az XPath-nak kell egy származtatott objektum a nodeTest-hez!
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
WG_FUNCTION_TOKEN_NOT_FOUND	TokenNameIdentifier	 WG  FUNCTION  TOKEN  NOT  FOUND
...
WG_EXPAND_ENTITIES_NOT_SUPPORTED	TokenNameIdentifier	 WG  EXPAND  ENTITIES  NOT  SUPPORTED
,	TokenNameCOMMA	
"A -E opció nem támogatott a DTM értelmez?höz"	TokenNameStringLiteral	A -E opció nem támogatott a DTM értelmez?höz
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
WG_ILLEGAL_VARIABLE_REFERENCE	TokenNameIdentifier	 WG  ILLEGAL  VARIABLE  REFERENCE
...
,	TokenNameCOMMA	
"xpath opciói: "	TokenNameStringLiteral	xpath opciói: 
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
...
,	TokenNameCOMMA	
" [-select xpath kifejezés]"	TokenNameStringLiteral	 [-select xpath kifejezés]
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
"optionMatch"	TokenNameStringLiteral	optionMatch
,	TokenNameCOMMA	
" [-match illesztési minta (az illesztési diagnosztikához)]"	TokenNameStringLiteral	 [-match illesztési minta (az illesztési diagnosztikához)]
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
"optionAnyExpr"	TokenNameStringLiteral	optionAnyExpr
,	TokenNameCOMMA	
"Vagy csak egy xpath kifejezés megcsinál egy diagnosztikai dump-ot"	TokenNameStringLiteral	Vagy csak egy xpath kifejezés megcsinál egy diagnosztikai dump-ot
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
...
,	TokenNameCOMMA	
"IBM AlphaWorks weblapról: http://www.alphaworks.ibm.com/formula/xml"	TokenNameStringLiteral	IBM AlphaWorks weblapról: http://www.alphaworks.ibm.com/formula/xml
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
