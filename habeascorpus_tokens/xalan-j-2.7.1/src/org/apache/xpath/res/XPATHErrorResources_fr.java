...
ER_DOCUMENT_REPLACED	TokenNameIdentifier	 ER  DOCUMENT  REPLACED
,	TokenNameCOMMA	
"L'implŽmentation de la fonction document() a ŽtŽ remplacŽe par org.apache.xalan.xslt.FuncDocument !"	TokenNameStringLiteral	L'implŽmentation de la fonction document() a ŽtŽ remplacŽe par org.apache.xalan.xslt.FuncDocument !
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_CONTEXT_HAS_NO_OWNERDOC	TokenNameIdentifier	 ER  CONTEXT  HAS  NO  OWNERDOC
,	TokenNameCOMMA	
"Le contexte ne possde pas de document propriŽtaire !"	TokenNameStringLiteral	Le contexte ne possde pas de document propriŽtaire !
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_LOCALNAME_HAS_TOO_MANY_ARGS	TokenNameIdentifier	 ER  LOCALNAME  HAS  TOO  MANY  ARGS
...
ER_UNPARSEDENTITYURI_TAKES_1_ARG	TokenNameIdentifier	 ER  UNPARSEDENTITYURI  TAKES 1  ARG
,	TokenNameCOMMA	
"Un argument doit tre fournie ˆ la fonction unparsed-entity-uri !"	TokenNameStringLiteral	Un argument doit tre fournie ˆ la fonction unparsed-entity-uri !
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_NAMESPACEAXIS_NOT_IMPLEMENTED	TokenNameIdentifier	 ER  NAMESPACEAXIS  NOT  IMPLEMENTED
,	TokenNameCOMMA	
"L'axe de l'espace de noms n'est pas implŽmentŽ !"	TokenNameStringLiteral	L'axe de l'espace de noms n'est pas implŽmentŽ !
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_UNKNOWN_AXIS	TokenNameIdentifier	 ER  UNKNOWN  AXIS
...
ER_UNKNOWN_MATCH_OPERATION	TokenNameIdentifier	 ER  UNKNOWN  MATCH  OPERATION
,	TokenNameCOMMA	
"opŽration de correspondance inconnue !"	TokenNameStringLiteral	opŽration de correspondance inconnue !
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_INCORRECT_ARG_LENGTH	TokenNameIdentifier	 ER  INCORRECT  ARG  LENGTH
...
ER_UNKNOWN_OPCODE	TokenNameIdentifier	 ER  UNKNOWN  OPCODE
,	TokenNameCOMMA	
"ERREUR ! Code opŽration inconnu : {0}"	TokenNameStringLiteral	ERREUR ! Code opŽration inconnu : {0}
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_EXTRA_ILLEGAL_TOKENS	TokenNameIdentifier	 ER  EXTRA  ILLEGAL  TOKENS
,	TokenNameCOMMA	
"Jetons incorrects supplŽmentaires : {0}"	TokenNameStringLiteral	Jetons incorrects supplŽmentaires : {0}
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_EXPECTED_DOUBLE_QUOTE	TokenNameIdentifier	 ER  EXPECTED  DOUBLE  QUOTE
,	TokenNameCOMMA	
"Erreur de guillemets dans un littŽral... Guillemet double obligatoire !"	TokenNameStringLiteral	Erreur de guillemets dans un littŽral... Guillemet double obligatoire !
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_EXPECTED_SINGLE_QUOTE	TokenNameIdentifier	 ER  EXPECTED  SINGLE  QUOTE
,	TokenNameCOMMA	
"Erreur de guillemets dans un littŽral... Guillemet simple obligatoire !"	TokenNameStringLiteral	Erreur de guillemets dans un littŽral... Guillemet simple obligatoire !
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_EMPTY_EXPRESSION	TokenNameIdentifier	 ER  EMPTY  EXPRESSION
...
ER_EXPECTED_BUT_FOUND	TokenNameIdentifier	 ER  EXPECTED  BUT  FOUND
,	TokenNameCOMMA	
"{1} a ŽtŽ trouvŽ alors que {0} Žtait attendu :"	TokenNameStringLiteral	{1} a ŽtŽ trouvŽ alors que {0} Žtait attendu :
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_INCORRECT_PROGRAMMER_ASSERTION	TokenNameIdentifier	 ER  INCORRECT  PROGRAMMER  ASSERTION
...
ER_BOOLEAN_ARG_NO_LONGER_OPTIONAL	TokenNameIdentifier	 ER  BOOLEAN  ARG  NO  LONGER  OPTIONAL
,	TokenNameCOMMA	
"L'argument boolŽen(...) n'est plus optionnel avec le document de normalisation XPath 19990709."	TokenNameStringLiteral	L'argument boolŽen(...) n'est plus optionnel avec le document de normalisation XPath 19990709.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_FOUND_COMMA_BUT_NO_PRECEDING_ARG	TokenNameIdentifier	 ER  FOUND  COMMA  BUT  NO  PRECEDING  ARG
,	TokenNameCOMMA	
"Virgule trouvŽe sans argument qui la prŽcde !"	TokenNameStringLiteral	Virgule trouvŽe sans argument qui la prŽcde !
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_FOUND_COMMA_BUT_NO_FOLLOWING_ARG	TokenNameIdentifier	 ER  FOUND  COMMA  BUT  NO  FOLLOWING  ARG
,	TokenNameCOMMA	
"Virgule trouvŽe sans argument qui la suit !"	TokenNameStringLiteral	Virgule trouvŽe sans argument qui la suit !
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_PREDICATE_ILLEGAL_SYNTAX	TokenNameIdentifier	 ER  PREDICATE  ILLEGAL  SYNTAX
,	TokenNameCOMMA	
"La syntaxe '[prŽdicat]' ou '.[prŽdicat]' est incorrecte. PrŽfŽrez 'self::node()[prŽdicat]'."	TokenNameStringLiteral	La syntaxe '[prŽdicat]' ou '.[prŽdicat]' est incorrecte. PrŽfŽrez 'self::node()[prŽdicat]'.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_ILLEGAL_AXIS_NAME	TokenNameIdentifier	 ER  ILLEGAL  AXIS  NAME
...
ER_PATTERN_LITERAL_NEEDS_BE_QUOTED	TokenNameIdentifier	 ER  PATTERN  LITERAL  NEEDS  BE  QUOTED
,	TokenNameCOMMA	
"Le littŽral de motif ({0}) doit figurer entre guillemets !"	TokenNameStringLiteral	Le littŽral de motif ({0}) doit figurer entre guillemets !
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_COULDNOT_BE_FORMATTED_TO_NUMBER	TokenNameIdentifier	 ER  COULDNOT  BE  FORMATTED  TO  NUMBER
,	TokenNameCOMMA	
"{0} ne peut tre formatŽe sous forme numŽrique !"	TokenNameStringLiteral	{0} ne peut tre formatŽe sous forme numŽrique !
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_COULDNOT_CREATE_XMLPROCESSORLIAISON	TokenNameIdentifier	 ER  COULDNOT  CREATE  XMLPROCESSORLIAISON
,	TokenNameCOMMA	
"Impossible de crŽer XML TransformerFactory Liaison : {0}"	TokenNameStringLiteral	Impossible de crŽer XML TransformerFactory Liaison : {0}
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_DIDNOT_FIND_XPATH_SELECT_EXP	TokenNameIdentifier	 ER  DIDNOT  FIND  XPATH  SELECT  EXP
,	TokenNameCOMMA	
"Erreur ! Impossible de trouver l'expression de sŽlection xpath (-select)."	TokenNameStringLiteral	Erreur ! Impossible de trouver l'expression de sŽlection xpath (-select).
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_COULDNOT_FIND_ENDOP_AFTER_OPLOCATIONPATH	TokenNameIdentifier	 ER  COULDNOT  FIND  ENDOP  AFTER  OPLOCATIONPATH
...
ER_ILLEGAL_VARIABLE_REFERENCE	TokenNameIdentifier	 ER  ILLEGAL  VARIABLE  REFERENCE
,	TokenNameCOMMA	
"RŽfŽrence de la variable hors contexte ou sans dŽfinition ! Nom = {0}"	TokenNameStringLiteral	RŽfŽrence de la variable hors contexte ou sans dŽfinition ! Nom = {0}
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_AXES_NOT_ALLOWED	TokenNameIdentifier	 ER  AXES  NOT  ALLOWED
,	TokenNameCOMMA	
"Seuls les axes child:: et attribute:: sont autorisŽs dans des motifs de correspondance ! Axes incorrects= {0}"	TokenNameStringLiteral	Seuls les axes child:: et attribute:: sont autorisŽs dans des motifs de correspondance ! Axes incorrects= {0}
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_KEY_HAS_TOO_MANY_ARGS	TokenNameIdentifier	 ER  KEY  HAS  TOO  MANY  ARGS
...
ER_COUNT_TAKES_1_ARG	TokenNameIdentifier	 ER  COUNT  TAKES 1  ARG
,	TokenNameCOMMA	
"Un seul argument doit tre fourni ˆ la fonction count !"	TokenNameStringLiteral	Un seul argument doit tre fourni ˆ la fonction count !
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_COULDNOT_FIND_FUNCTION	TokenNameIdentifier	 ER  COULDNOT  FIND  FUNCTION
...
ER_PREFIX_MUST_RESOLVE	TokenNameIdentifier	 ER  PREFIX  MUST  RESOLVE
,	TokenNameCOMMA	
"Le prŽfixe doit se convertir en espace de noms : {0}"	TokenNameStringLiteral	Le prŽfixe doit se convertir en espace de noms : {0}
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_PARSE_NOT_SUPPORTED	TokenNameIdentifier	 ER  PARSE  NOT  SUPPORTED
...
ER_INVALID_UTF16_SURROGATE	TokenNameIdentifier	 ER  INVALID  UT F16  SURROGATE
,	TokenNameCOMMA	
"Substitut UTF-16 non valide dŽtectŽ : {0} ?"	TokenNameStringLiteral	Substitut UTF-16 non valide dŽtectŽ : {0} ?
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_OIERROR	TokenNameIdentifier	 ER  OIERROR
...
ER_CANNOT_CREATE_URL	TokenNameIdentifier	 ER  CANNOT  CREATE  URL
,	TokenNameCOMMA	
"Impossible de crŽer une URL pour : {0}"	TokenNameStringLiteral	Impossible de crŽer une URL pour : {0}
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_XPATH_READOBJECT	TokenNameIdentifier	 ER  XPATH  READOBJECT
...
ER_VAR_NOT_RESOLVABLE	TokenNameIdentifier	 ER  VAR  NOT  RESOLVABLE
,	TokenNameCOMMA	
"Impossible de rŽsoudre la variable : {0}"	TokenNameStringLiteral	Impossible de rŽsoudre la variable : {0}
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_NULL_ERROR_HANDLER	TokenNameIdentifier	 ER  NULL  ERROR  HANDLER
...
ER_PROG_ASSERT_UNKNOWN_OPCODE	TokenNameIdentifier	 ER  PROG  ASSERT  UNKNOWN  OPCODE
,	TokenNameCOMMA	
"Assertion de programme : code opŽration inconnu : {0}"	TokenNameStringLiteral	Assertion de programme : code opŽration inconnu : {0}
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_ZERO_OR_ONE	TokenNameIdentifier	 ER  ZERO  OR  ONE
...
ER_VARIABLE_ACCESSED_BEFORE_BIND	TokenNameIdentifier	 ER  VARIABLE  ACCESSED  BEFORE  BIND
,	TokenNameCOMMA	
"L'accs ˆ la variable a prŽcŽdŽ la liaison de celle-ci !"	TokenNameStringLiteral	L'accs ˆ la variable a prŽcŽdŽ la liaison de celle-ci !
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_FSB_CANNOT_TAKE_STRING	TokenNameIdentifier	 ER  FSB  CANNOT  TAKE  STRING
...
ER_SETTING_WALKER_ROOT_TO_NULL	TokenNameIdentifier	 ER  SETTING  WALKER  ROOT  TO  NULL
,	TokenNameCOMMA	
" !!!! Erreur ! DŽfinition d'une valeur nulle pour la racine d'un ŽlŽment walker !!!"	TokenNameStringLiteral	 !!!! Erreur ! DŽfinition d'une valeur nulle pour la racine d'un ŽlŽment walker !!!
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_NODESETDTM_CANNOT_ITERATE	TokenNameIdentifier	 ER  NODESETDTM  CANNOT  ITERATE
,	TokenNameCOMMA	
"Ce NodeSetDTM ne permet pas d'itŽration vers un noeud prŽcŽdent !"	TokenNameStringLiteral	Ce NodeSetDTM ne permet pas d'itŽration vers un noeud prŽcŽdent !
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_NODESET_CANNOT_ITERATE	TokenNameIdentifier	 ER  NODESET  CANNOT  ITERATE
,	TokenNameCOMMA	
"Ce NodeSet ne permet pas d'itŽration vers un noeud prŽcŽdent !"	TokenNameStringLiteral	Ce NodeSet ne permet pas d'itŽration vers un noeud prŽcŽdent !
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_NODESETDTM_CANNOT_INDEX	TokenNameIdentifier	 ER  NODESETDTM  CANNOT  INDEX
,	TokenNameCOMMA	
"Ce NodeSetDTM ne peut pas effectuer de fonctions d'indexage ou de dŽnombrement !"	TokenNameStringLiteral	Ce NodeSetDTM ne peut pas effectuer de fonctions d'indexage ou de dŽnombrement !
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_NODESET_CANNOT_INDEX	TokenNameIdentifier	 ER  NODESET  CANNOT  INDEX
,	TokenNameCOMMA	
"Ce NodeSet ne peut pas effectuer de fonctions d'indexage ou de dŽnombrement !"	TokenNameStringLiteral	Ce NodeSet ne peut pas effectuer de fonctions d'indexage ou de dŽnombrement !
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_CANNOT_CALL_SETSHOULDCACHENODE	TokenNameIdentifier	 ER  CANNOT  CALL  SETSHOULDCACHENODE
...
ER_EXPECTED_REL_LOC_PATH	TokenNameIdentifier	 ER  EXPECTED  REL  LOC  PATH
,	TokenNameCOMMA	
"Un chemin d'emplacement relatif Žtait attendu aprs le jeton '/' ou '//'."	TokenNameStringLiteral	Un chemin d'emplacement relatif Žtait attendu aprs le jeton '/' ou '//'.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
ER_EXPECTED_LOC_PATH	TokenNameIdentifier	 ER  EXPECTED  LOC  PATH
,	TokenNameCOMMA	
"Un chemin d''emplacement Žtait attendu, mais le jeton suivant a ŽtŽ dŽtectŽ : {0}"	TokenNameStringLiteral	Un chemin d''emplacement Žtait attendu, mais le jeton suivant a ŽtŽ dŽtectŽ : {0}
}	TokenNameRBRACE	
,	TokenNameCOMMA	
// Note to translators: A location path is a form of XPath expression. 	TokenNameCOMMENT_LINE	Note to translators: A location path is a form of XPath expression. 
...
ER_EXPECTED_LOC_PATH_AT_END_EXPR	TokenNameIdentifier	 ER  EXPECTED  LOC  PATH  AT  END  EXPR
,	TokenNameCOMMA	
"Un chemin d'emplacement Žtait attendu mais la fin de l'expression XPath a ŽtŽ dŽtectŽe."	TokenNameStringLiteral	Un chemin d'emplacement Žtait attendu mais la fin de l'expression XPath a ŽtŽ dŽtectŽe.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
ER_EXPECTED_LOC_STEP	TokenNameIdentifier	 ER  EXPECTED  LOC  STEP
,	TokenNameCOMMA	
"Une Žtape d'emplacement Žtait attendue aprs le jeton '/' ou '//'."	TokenNameStringLiteral	Une Žtape d'emplacement Žtait attendue aprs le jeton '/' ou '//'.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
ER_EXPECTED_NODE_TEST	TokenNameIdentifier	 ER  EXPECTED  NODE  TEST
,	TokenNameCOMMA	
"Un test de noeud correspondant ˆ NCName:* ou QName Žtait attendu."	TokenNameStringLiteral	Un test de noeud correspondant ˆ NCName:* ou QName Žtait attendu.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
ER_EXPECTED_STEP_PATTERN	TokenNameIdentifier	 ER  EXPECTED  STEP  PATTERN
,	TokenNameCOMMA	
"Un modle d'Žtape Žtait attendu, mais '/' a ŽtŽ dŽtectŽ."	TokenNameStringLiteral	Un modle d'Žtape Žtait attendu, mais '/' a ŽtŽ dŽtectŽ.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
ER_EXPECTED_REL_PATH_PATTERN	TokenNameIdentifier	 ER  EXPECTED  REL  PATH  PATTERN
,	TokenNameCOMMA	
"Un modle de chemin relatif Žtait attendu."	TokenNameStringLiteral	Un modle de chemin relatif Žtait attendu.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
ER_CANT_CONVERT_TO_BOOLEAN	TokenNameIdentifier	 ER  CANT  CONVERT  TO  BOOLEAN
,	TokenNameCOMMA	
"Le rŽsultat XPathResult de l''expression XPath ''{0}'' a un type XPathResultType de {1} qui ne peut pas tre converti en valeur boolŽenne."	TokenNameStringLiteral	Le rŽsultat XPathResult de l''expression XPath ''{0}'' a un type XPathResultType de {1} qui ne peut pas tre converti en valeur boolŽenne.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
ER_CANT_CONVERT_TO_SINGLENODE	TokenNameIdentifier	 ER  CANT  CONVERT  TO  SINGLENODE
,	TokenNameCOMMA	
"Le rŽsultat XPathResult de l''expression XPath ''{0}'' a un type XPathResultType de {1} qui ne peut pas tre converti en noeud unique. La mŽthode getSingleNodeValue s''applique uniquement aux types ANY_UNORDERED_NODE_TYPE et FIRST_ORDERED_NODE_TYPE."	TokenNameStringLiteral	Le rŽsultat XPathResult de l''expression XPath ''{0}'' a un type XPathResultType de {1} qui ne peut pas tre converti en noeud unique. La mŽthode getSingleNodeValue s''applique uniquement aux types ANY_UNORDERED_NODE_TYPE et FIRST_ORDERED_NODE_TYPE.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
ER_CANT_GET_SNAPSHOT_LENGTH	TokenNameIdentifier	 ER  CANT  GET  SNAPSHOT  LENGTH
,	TokenNameCOMMA	
"La mŽthode getSnapshotLength ne peut pas tre appelŽe sur le rŽsultat XPathResult de l''expression XPath ''{0}'' car son type XPathResultType est {1}. Cette mŽthode s''applique uniquement aux types UNORDERED_NODE_SNAPSHOT_TYPE et ORDERED_NODE_SNAPSHOT_TYPE."	TokenNameStringLiteral	La mŽthode getSnapshotLength ne peut pas tre appelŽe sur le rŽsultat XPathResult de l''expression XPath ''{0}'' car son type XPathResultType est {1}. Cette mŽthode s''applique uniquement aux types UNORDERED_NODE_SNAPSHOT_TYPE et ORDERED_NODE_SNAPSHOT_TYPE.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_NON_ITERATOR_TYPE	TokenNameIdentifier	 ER  NON  ITERATOR  TYPE
,	TokenNameCOMMA	
"La mŽthode iterateNext ne peut pas tre appelŽe sur le rŽsultat XPathResult de l''expression XPath ''{0}'' car son type XPathResultType est {1}. Cette mŽthode s''applique uniquement aux types UNORDERED_NODE_ITERATOR_TYPE et ORDERED_NODE_ITERATOR_TYPE."	TokenNameStringLiteral	La mŽthode iterateNext ne peut pas tre appelŽe sur le rŽsultat XPathResult de l''expression XPath ''{0}'' car son type XPathResultType est {1}. Cette mŽthode s''applique uniquement aux types UNORDERED_NODE_ITERATOR_TYPE et ORDERED_NODE_ITERATOR_TYPE.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
ER_DOC_MUTATED	TokenNameIdentifier	 ER  DOC  MUTATED
,	TokenNameCOMMA	
"Mutation du document depuis le renvoi du rŽsultat. L'itŽrateur est incorrect."	TokenNameStringLiteral	Mutation du document depuis le renvoi du rŽsultat. L'itŽrateur est incorrect.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_INVALID_XPATH_TYPE	TokenNameIdentifier	 ER  INVALID  XPATH  TYPE
...
ER_EMPTY_XPATH_RESULT	TokenNameIdentifier	 ER  EMPTY  XPATH  RESULT
,	TokenNameCOMMA	
"Objet rŽsultat XPath vide"	TokenNameStringLiteral	Objet rŽsultat XPath vide
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_INCOMPATIBLE_TYPES	TokenNameIdentifier	 ER  INCOMPATIBLE  TYPES
,	TokenNameCOMMA	
"Le rŽsultat XPathResult de l''expression XPath ''{0}'' a un type XPathResultType de {1} qui ne peut pas tre forcŽ dans le type XPathResultType indiquŽ de {2}."	TokenNameStringLiteral	Le rŽsultat XPathResult de l''expression XPath ''{0}'' a un type XPathResultType de {1} qui ne peut pas tre forcŽ dans le type XPathResultType indiquŽ de {2}.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_NULL_RESOLVER	TokenNameIdentifier	 ER  NULL  RESOLVER
,	TokenNameCOMMA	
"Conversion impossible du prŽfixe avec un programme de rŽsolution de prŽfixe de valeur nulle."	TokenNameStringLiteral	Conversion impossible du prŽfixe avec un programme de rŽsolution de prŽfixe de valeur nulle.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
// Note to translators: The substitution text is the name of a data type. The 	TokenNameCOMMENT_LINE	Note to translators: The substitution text is the name of a data type. The 
// message indicates that a value of a particular type could not be converted 	TokenNameCOMMENT_LINE	message indicates that a value of a particular type could not be converted 
...
ER_CANT_CONVERT_TO_STRING	TokenNameIdentifier	 ER  CANT  CONVERT  TO  STRING
,	TokenNameCOMMA	
"Le rŽsultat XPathResult de l''expression XPath ''{0}'' a un type XPathResultType de {1} qui ne peut pas tre converti en cha”ne."	TokenNameStringLiteral	Le rŽsultat XPathResult de l''expression XPath ''{0}'' a un type XPathResultType de {1} qui ne peut pas tre converti en cha”ne.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
ER_NON_SNAPSHOT_TYPE	TokenNameIdentifier	 ER  NON  SNAPSHOT  TYPE
,	TokenNameCOMMA	
"La mŽthode snapshotItem ne peut pas tre appelŽe sur le rŽsultat XPathResult de l''expression XPath ''{0}'' car son type XPathResultType est {1}. Cette mŽthode s''applique uniquement aux types UNORDERED_NODE_SNAPSHOT_TYPE et ORDERED_NODE_SNAPSHOT_TYPE."	TokenNameStringLiteral	La mŽthode snapshotItem ne peut pas tre appelŽe sur le rŽsultat XPathResult de l''expression XPath ''{0}'' car son type XPathResultType est {1}. Cette mŽthode s''applique uniquement aux types UNORDERED_NODE_SNAPSHOT_TYPE et ORDERED_NODE_SNAPSHOT_TYPE.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
ER_WRONG_DOCUMENT	TokenNameIdentifier	 ER  WRONG  DOCUMENT
,	TokenNameCOMMA	
"Le noeud de contexte n'appartient pas au document liŽ ˆ ce XPathEvaluator."	TokenNameStringLiteral	Le noeud de contexte n'appartient pas au document liŽ ˆ ce XPathEvaluator.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
ER_XPATH_ERROR	TokenNameIdentifier	 ER  XPATH  ERROR
,	TokenNameCOMMA	
"Erreur inconnue dŽtectŽe dans XPath."	TokenNameStringLiteral	Erreur inconnue dŽtectŽe dans XPath.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
ER_CANT_CONVERT_XPATHRESULTTYPE_TO_NUMBER	TokenNameIdentifier	 ER  CANT  CONVERT  XPATHRESULTTYPE  TO  NUMBER
,	TokenNameCOMMA	
"Le rŽsultat XPathResult de l''expression XPath ''{0}'' a un type XPathResultType de {1} qui ne peut pas tre converti en un nombre."	TokenNameStringLiteral	Le rŽsultat XPathResult de l''expression XPath ''{0}'' a un type XPathResultType de {1} qui ne peut pas tre converti en un nombre.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
ER_EXTENSION_FUNCTION_CANNOT_BE_INVOKED	TokenNameIdentifier	 ER  EXTENSION  FUNCTION  CANNOT  BE  INVOKED
,	TokenNameCOMMA	
"La fonction d''extension : ''{0}'' ne peut pas tre appelŽe lorsque la fonction XMLConstants.FEATURE_SECURE_PROCESSING a la valeur true."	TokenNameStringLiteral	La fonction d''extension : ''{0}'' ne peut pas tre appelŽe lorsque la fonction XMLConstants.FEATURE_SECURE_PROCESSING a la valeur true.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
ER_OBJECT_MODEL_NULL	TokenNameIdentifier	 ER  OBJECT  MODEL  NULL
,	TokenNameCOMMA	
"{0}#isObjectModelSupported( Cha”ne objectModel ) ne peut pas tre appelŽ avec objectModel == null"	TokenNameStringLiteral	{0}#isObjectModelSupported( Cha”ne objectModel ) ne peut pas tre appelŽ avec objectModel == null
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
ER_OBJECT_MODEL_EMPTY	TokenNameIdentifier	 ER  OBJECT  MODEL  EMPTY
,	TokenNameCOMMA	
"{0}#isObjectModelSupported( Cha”ne objectModel ) ne peut pas tre appelŽ avec objectModel == """	TokenNameStringLiteral	{0}#isObjectModelSupported( Cha”ne objectModel ) ne peut pas tre appelŽ avec objectModel == ""
}	TokenNameRBRACE	
,	TokenNameCOMMA	
/** Field ER_OBJECT_MODEL_EMPTY */	TokenNameCOMMENT_JAVADOC	 Field ER_OBJECT_MODEL_EMPTY 
{	TokenNameLBRACE	
ER_FEATURE_NAME_NULL	TokenNameIdentifier	 ER  FEATURE  NAME  NULL
,	TokenNameCOMMA	
"Tentative de dŽfinition d''une fonction ayant un nom null : {0}#setFeature( null, {1})"	TokenNameStringLiteral	Tentative de dŽfinition d''une fonction ayant un nom null : {0}#setFeature( null, {1})
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
ER_FEATURE_UNKNOWN	TokenNameIdentifier	 ER  FEATURE  UNKNOWN
,	TokenNameCOMMA	
"Tentative de dŽfinition d''une fonction inconnue "{0}":{1}#setFeature({0},{2})"	TokenNameStringLiteral	Tentative de dŽfinition d''une fonction inconnue "{0}":{1}#setFeature({0},{2})
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
ER_GETTING_NULL_FEATURE	TokenNameIdentifier	 ER  GETTING  NULL  FEATURE
,	TokenNameCOMMA	
"Tentative de dŽfinition d''une fonction ayant un nom null : {0}#getFeature(null)"	TokenNameStringLiteral	Tentative de dŽfinition d''une fonction ayant un nom null : {0}#getFeature(null)
}	TokenNameRBRACE	
,	TokenNameCOMMA	
/** Field ER_GETTING_NULL_FEATURE */	TokenNameCOMMENT_JAVADOC	 Field ER_GETTING_NULL_FEATURE 
{	TokenNameLBRACE	
...
ER_NULL_XPATH_FUNCTION_RESOLVER	TokenNameIdentifier	 ER  NULL  XPATH  FUNCTION  RESOLVER
,	TokenNameCOMMA	
"Tentative de dŽfinition d''un ŽlŽment XPathFunctionResolver null : {0}#setXPathFunctionResolver(null)"	TokenNameStringLiteral	Tentative de dŽfinition d''un ŽlŽment XPathFunctionResolver null : {0}#setXPathFunctionResolver(null)
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
ER_NULL_XPATH_VARIABLE_RESOLVER	TokenNameIdentifier	 ER  NULL  XPATH  VARIABLE  RESOLVER
,	TokenNameCOMMA	
"Tentative de dŽfinition d''un ŽlŽment XPathVariableResolver null : {0}#setXPathVariableResolver(null)"	TokenNameStringLiteral	Tentative de dŽfinition d''un ŽlŽment XPathVariableResolver null : {0}#setXPathVariableResolver(null)
}	TokenNameRBRACE	
,	TokenNameCOMMA	
...
WG_PROPERTY_NOT_SUPPORTED	TokenNameIdentifier	 WG  PROPERTY  NOT  SUPPORTED
,	TokenNameCOMMA	
"PropriŽtŽ XSL non prise en charge : {0}"	TokenNameStringLiteral	PropriŽtŽ XSL non prise en charge : {0}
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
WG_DONT_DO_ANYTHING_WITH_NS	TokenNameIdentifier	 WG  DONT  DO  ANYTHING  WITH  NS
,	TokenNameCOMMA	
"Espace de noms {0} inexploitable dans la propriŽtŽ : {1}"	TokenNameStringLiteral	Espace de noms {0} inexploitable dans la propriŽtŽ : {1}
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
WG_SECURITY_EXCEPTION	TokenNameIdentifier	 WG  SECURITY  EXCEPTION
,	TokenNameCOMMA	
"Une exception de sŽcuritŽ s''est produite lors de l''accs ˆ la propriŽtŽ : {0}"	TokenNameStringLiteral	Une exception de sŽcuritŽ s''est produite lors de l''accs ˆ la propriŽtŽ : {0}
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
WG_QUO_NO_LONGER_DEFINED	TokenNameIdentifier	 WG  QUO  NO  LONGER  DEFINED
,	TokenNameCOMMA	
"L'ancienne syntaxe : quo(...) n'est plus dŽfinie dans XPath."	TokenNameStringLiteral	L'ancienne syntaxe : quo(...) n'est plus dŽfinie dans XPath.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
WG_NEED_DERIVED_OBJECT_TO_IMPLEMENT_NODETEST	TokenNameIdentifier	 WG  NEED  DERIVED  OBJECT  TO  IMPLEMENT  NODETEST
,	TokenNameCOMMA	
"XPath requiert un objet dŽrivŽ pour implŽmenter nodeTest !"	TokenNameStringLiteral	XPath requiert un objet dŽrivŽ pour implŽmenter nodeTest !
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
WG_FUNCTION_TOKEN_NOT_FOUND	TokenNameIdentifier	 WG  FUNCTION  TOKEN  NOT  FOUND
...
WG_CANNOT_MAKE_URL_FROM	TokenNameIdentifier	 WG  CANNOT  MAKE  URL  FROM
,	TokenNameCOMMA	
"Impossible de crŽer l''URL ˆ partir de : {0}"	TokenNameStringLiteral	Impossible de crŽer l''URL ˆ partir de : {0}
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
WG_EXPAND_ENTITIES_NOT_SUPPORTED	TokenNameIdentifier	 WG  EXPAND  ENTITIES  NOT  SUPPORTED
...
,	TokenNameCOMMA	
"Exception soulevŽe lors de l'appel de messageFormat"	TokenNameStringLiteral	Exception soulevŽe lors de l'appel de messageFormat
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
...
,	TokenNameCOMMA	
"XSLProcessor : terminŽ"	TokenNameStringLiteral	XSLProcessor : terminŽ
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
...
,	TokenNameCOMMA	
" [-in URLXMLentrŽe]"	TokenNameStringLiteral	 [-in URLXMLentrŽe]
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
...
,	TokenNameCOMMA	
"VŽrifiez le chemin d'accs des classes."	TokenNameStringLiteral	VŽrifiez le chemin d'accs des classes.
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
"noParsermsg4"	TokenNameStringLiteral	noParsermsg4
,	TokenNameCOMMA	
"XML Parser for Java disponible en tŽlŽchargement sur le site"	TokenNameStringLiteral	XML Parser for Java disponible en tŽlŽchargement sur le site
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
