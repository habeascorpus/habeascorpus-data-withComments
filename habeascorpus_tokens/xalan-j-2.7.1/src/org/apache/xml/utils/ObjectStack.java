...
;	TokenNameSEMICOLON	
/** * Implement a stack of simple integers. * * %OPT% * This is currently based on ObjectVector, which permits fast acess but pays a * heavy recopying penalty if/when its size is increased. If we expect deep * stacks, we should consider a version based on ChunkedObjectVector. * @xsl.usage internal */	TokenNameCOMMENT_JAVADOC	 Implement a stack of simple integers. * %OPT% This is currently based on ObjectVector, which permits fast acess but pays a heavy recopying penalty if/when its size is increased. If we expect deep stacks, we should consider a version based on ChunkedObjectVector. @xsl.usage internal 
...
/** * Construct a ObjectVector, using the given block size. * * @param blocksize Size of block to allocate */	TokenNameCOMMENT_JAVADOC	 Construct a ObjectVector, using the given block size. * @param blocksize Size of block to allocate 
public	TokenNamepublic	
ObjectStack	TokenNameIdentifier	 Object Stack
(	TokenNameLPAREN	
int	TokenNameint	
...
/** * Copy constructor for ObjectStack * * @param v ObjectStack to copy */	TokenNameCOMMENT_JAVADOC	 Copy constructor for ObjectStack * @param v ObjectStack to copy 
public	TokenNamepublic	
ObjectStack	TokenNameIdentifier	 Object Stack
(	TokenNameLPAREN	
ObjectStack	TokenNameIdentifier	 Object Stack
...
/** * Returns clone of current ObjectStack * * @return clone of current ObjectStack */	TokenNameCOMMENT_JAVADOC	 Returns clone of current ObjectStack * @return clone of current ObjectStack 
public	TokenNamepublic	
Object	TokenNameIdentifier	 Object
