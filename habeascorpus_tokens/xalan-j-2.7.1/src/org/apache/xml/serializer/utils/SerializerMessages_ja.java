...
/* * $Id: SerializerMessages_ja.java 471981 2006-11-07 04:28:00Z minchau $ */	TokenNameCOMMENT_BLOCK	 $Id: SerializerMessages_ja.java 471981 2006-11-07 04:28:00Z minchau $ 
...
SerializerMessages_ja	TokenNameIdentifier	 Serializer Messages ja
...
,	TokenNameCOMMA	
"?????? ''{1}'' ???????????? ''{0}'' ???????????? (CLASSPATH ?????????)"	TokenNameStringLiteral	?????? ''{1}'' ???????????? ''{0}'' ???????????? (CLASSPATH ?????????)
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
MsgKey	TokenNameIdentifier	 Msg Key
...
,	TokenNameCOMMA	
"CDATA ?????? 1 ?????????? ']]>' ?????????"	TokenNameStringLiteral	CDATA ?????? 1 ?????????? ']]>' ?????????
}	TokenNameRBRACE	
,	TokenNameCOMMA	
{	TokenNameLBRACE	
MsgKey	TokenNameIdentifier	 Msg Key
