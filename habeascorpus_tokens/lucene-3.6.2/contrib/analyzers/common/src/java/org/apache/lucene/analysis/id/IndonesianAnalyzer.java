...
;	TokenNameSEMICOLON	
/** * Analyzer for Indonesian (Bahasa) */	TokenNameCOMMENT_JAVADOC	 Analyzer for Indonesian (Bahasa) 
...
StopwordAnalyzerBase	TokenNameIdentifier	 Stopword Analyzer Base
{	TokenNameLBRACE	
/** File containing default Indonesian stopwords. */	TokenNameCOMMENT_JAVADOC	 File containing default Indonesian stopwords. 
public	TokenNamepublic	
final	TokenNamefinal	
...
/** * Builds an analyzer with the given stop word. If a none-empty stem exclusion set is * provided this analyzer will add a {@link KeywordMarkerFilter} before * {@link IndonesianStemFilter}. * * @param matchVersion * lucene compatibility version * @param stopwords * a stopword set * @param stemExclusionSet * a set of terms not to be stemmed */	TokenNameCOMMENT_JAVADOC	 Builds an analyzer with the given stop word. If a none-empty stem exclusion set is provided this analyzer will add a {@link KeywordMarkerFilter} before {@link IndonesianStemFilter}. * @param matchVersion lucene compatibility version @param stopwords a stopword set @param stemExclusionSet a set of terms not to be stemmed 
public	TokenNamepublic	
IndonesianAnalyzer	TokenNameIdentifier	 Indonesian Analyzer
(	TokenNameLPAREN	
Version	TokenNameIdentifier	 Version
