...
/* * $Id: XSLTVisitable.java 468643 2006-10-28 06:56:03Z minchau $ */	TokenNameCOMMENT_BLOCK	 $Id: XSLTVisitable.java 468643 2006-10-28 06:56:03Z minchau $ 
...
;	TokenNameSEMICOLON	
/** * A class that implements this interface will call a XSLTVisitor * for itself and members within it's heararchy. If the XSLTVistor's * method returns false, the sub-member heararchy will not be * traversed. */	TokenNameCOMMENT_JAVADOC	 A class that implements this interface will call a XSLTVisitor for itself and members within it's heararchy. If the XSLTVistor's method returns false, the sub-member heararchy will not be traversed. 
