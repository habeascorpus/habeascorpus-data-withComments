...
;	TokenNameSEMICOLON	
/** * {@link Analyzer} for English. */	TokenNameCOMMENT_JAVADOC	 {@link Analyzer} for English. 
...
/** * Builds an analyzer with the default stop words: {@link #getDefaultStopSet}. */	TokenNameCOMMENT_JAVADOC	 Builds an analyzer with the default stop words: {@link #getDefaultStopSet}. 
public	TokenNamepublic	
EnglishAnalyzer	TokenNameIdentifier	 English Analyzer
(	TokenNameLPAREN	
Version	TokenNameIdentifier	 Version
...
;	TokenNameSEMICOLON	
// prior to this we get the classic behavior, standardfilter does it for us. 	TokenNameCOMMENT_LINE	prior to this we get the classic behavior, standardfilter does it for us. 
if	TokenNameif	
(	TokenNameLPAREN	
matchVersion	TokenNameIdentifier	 match Version
.	TokenNameDOT	
