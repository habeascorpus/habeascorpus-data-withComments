...
;	TokenNameSEMICOLON	
/** * Signals a failure to parse the metadata due to invalid syntax (e.g. non-wellformed XML or unknown elements). * * @author Benjamin Bentmann */	TokenNameCOMMENT_JAVADOC	 Signals a failure to parse the metadata due to invalid syntax (e.g. non-wellformed XML or unknown elements). * @author Benjamin Bentmann 
