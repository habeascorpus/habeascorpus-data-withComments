...
;	TokenNameSEMICOLON	
/** * Concrete version of {@link org.apache.batik.swing.gvt.AbstractJGVTComponent}. * * This class is used for JDKs &lt; 1.4, which don't have MouseWheelEvent * support. For JDKs &gt;= 1.4, the file * sources-1.4/org/apache/batik/swing/gvt/JGVTComponent defines a * version of this class that does support MouseWheelEvents. * * @author <a href="mailto:cam%40mcc%2eid%2eau">Cameron McCormack</a> * @version $Id: JGVTComponent.java 475477 2006-11-15 22:44:28Z cam $ */	TokenNameCOMMENT_JAVADOC	 Concrete version of {@link org.apache.batik.swing.gvt.AbstractJGVTComponent}. * This class is used for JDKs &lt; 1.4, which don't have MouseWheelEvent support. For JDKs &gt;= 1.4, the file sources-1.4/org/apache/batik/swing/gvt/JGVTComponent defines a version of this class that does support MouseWheelEvents. * @author <a href="mailto:cam%40mcc%2eid%2eau">Cameron McCormack</a> @version $Id: JGVTComponent.java 475477 2006-11-15 22:44:28Z cam $ 
...
/** * Creates a new JGVTComponent. * @param eventEnabled Whether the GVT tree should be reactive * to mouse and key events. * @param selectableText Whether the text should be selectable. * if eventEnabled is false, this flag is ignored. */	TokenNameCOMMENT_JAVADOC	 Creates a new JGVTComponent. @param eventEnabled Whether the GVT tree should be reactive to mouse and key events. @param selectableText Whether the text should be selectable. if eventEnabled is false, this flag is ignored. 
public	TokenNamepublic	
JGVTComponent	TokenNameIdentifier	 JGVT Component
(	TokenNameLPAREN	
